...
public class ExamplesPage extends AbstractXdocBaseWebsite {
  ...
  private final AbstractSection rootSection;
  
  private final Document document;
  
  public ExamplesPage(final Document document, final AbstractSection rootSection) {
  ...
  public String path() {
    String _targetPath = this._targetPaths.getTargetPath(this.rootSection);
    return _targetPath;
  }
  ...
  public CharSequence navbarDropdown() {
    ...
    _builder.newLine();
    {
      List<? extends AbstractSection> _targetRoots = this._targetPaths.getTargetRoots(this.document);
      for(final AbstractSection rootSection : _targetRoots) {
        _builder.append("\t\t");
        _builder.append("<li><a href=\"");
        String _href = this._htmlExtensions.href(rootSection);
        _builder.append(_href, "		");
        _builder.append("\">");
        TextOrMarkup _title = rootSection.getTitle();
  ...
  public CharSequence contents() {
    ...
    _builder.newLine();
    _builder.append("\t\t");
    CharSequence _body = this._body.body(this.rootSection);
