...
public class SevenLanguages extends AbstractWebsite {
  ...
  public CharSequence contents() {
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t\t");
    _builder.append("Xtext provides a very powerful API for this.");
    _builder.newLine();
    _builder.append("\t\t\t\t\t");
    _builder.append("The new API lets you easily integrate statically typed expressions,");
    _builder.newLine();
    _builder.append("\t\t\t\t\t");
    _builder.append("Java\'s type references and annotations anywhere in your language.");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("</p>");
    _builder.newLine();
