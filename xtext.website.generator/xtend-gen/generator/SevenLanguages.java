...
public class SevenLanguages extends AbstractWebsite {
  ...
  public CharSequence contents() {
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("<h1>7 Languages For The JVM<small>- Learn By Example</small></h1>");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("<hr />");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t\t");
    _builder.append("If your DSL is targeting the Java Virtual Machine (JVM) you are lucky, because");
    _builder.newLine();
    _builder.append("\t\t\t\t\t");
    _builder.append("Xtext provides a new very powerful API for this.");
    _builder.newLine();
    _builder.append("\t\t\t\t\t");
    _builder.append("The new API let\'s you easily intergrate statically typed expressions,");
    _builder.newLine();
    _builder.append("\t\t\t\t\t");
    _builder.append("Java type references and annotations anywhere in your language.");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("</p>");
    _builder.newLine();
    ...
    _builder_4.append("This language lets you declare Google Guice modules in a more readable and declarative way, such that many of the runtime checks can");
    _builder_4.newLine();
