...
public class Community extends AbstractWebsite {
  ...
  public CharSequence contents() {
    ...
    _builder.newLine();
    _builder.append("\t        ");
    _builder.append("<h2>Sponsors</h2>");
    _builder.newLine();
    _builder.append("\t        ");
    _builder.append("<hr>");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t      ");
    _builder.append("<p><b>Itemis</b> is the company behind Xtext, Xtend and many other Eclipse projects. Itemis offers professional ");
    _builder.newLine();
    _builder.append("\t\t      ");
    _builder.append("services such as trainings, on site consulting and full product development based on these technologies.");
    _builder.newLine();
    _builder.append("\t\t      ");
    _builder.append("Learn more at <a href=\"http://www.itemis.com\">itemis.com</a>. ");
    _builder.newLine();
    _builder.append("\t\t      ");
    _builder.append("</div>");
    _builder.newLine();
    _builder.append("\t\t      ");
    _builder.append("<div class=\"span4\"><img src=\"http://www.itemis.com/binary.ashx/element=E0E0E0/~image.attribute/97/image.gif\"></img></div>");
    _builder.newLine();
    _builder.append("\t\t    ");
    _builder.append("</div>");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t      ");
    _builder.append("<p><b>YourKit</b> is kindly supporting open source projects with its full-featured Java Profiler.</p>");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("<p>YourKit, LLC is the creator of innovative and intelligent tools for profiling Java and .NET applications. ");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("Take a look at YourKit\'s leading software products: <a href=\"http://www.yourkit.com/java/profiler/index.jsp\">YourKit Java Profiler</a> and <a href=\"http://www.yourkit.com/.net/profiler/index.jsp\">YourKit .NET Profiler</a>. ");
    _builder.newLine();
    _builder.append("\t\t      ");
    _builder.append("</div>");
    _builder.newLine();
  ...
  public CharSequence zoo() {
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("<td><a href=\"http://sculptorgenerator.orgorg\">Sculptor</a></td>");
    _builder.newLine();
    _builder.append("        ");
    ...
    _builder.newLine();
    _builder.append("       ");
    _builder.append("<td><a href=\"http://community.jaspersoft.com/project/jaspersoft-studio\">Jaspersoft Studio, Report Designer for JasperReports</a></td>");
    _builder.newLine();
    _builder.append("       ");
    _builder.append("<td>The Expression Editor allows to compose Java-like expressions enriched with JasperReports specific tokens. ");
    _builder.newLine();
    _builder.append("The SQL Query Designer, in text mode, allows to edit simple and advanced SQL expressions.</td>");
    _builder.newLine();
    _builder.append("       ");
    _builder.append("<td>EPL</td>");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("<td><a href=\"http://sourceforge.net/projects/rng-eclipse/\">SARL</a></td>");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("<td>SARL is a general-purpose agent-oriented language. It aims at providing the fundamental abstractions for ");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("dealing with concurrency, distribution, interaction, decentralization, reactivity, autonomy and dynamic ");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("reconfiguration. The language is platform- and architecture-independent. ");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("The default execution environment is the <a href=\"http://www.janusproject.io\">Janus platform</a>.</td>");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("<td>Apache 2 License</td>");
    _builder.newLine();
