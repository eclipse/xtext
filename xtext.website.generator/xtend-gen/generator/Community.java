...
public class Community extends AbstractWebsite {
  ...
  public CharSequence contents() {
    ...
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("<div class=\"page-heading\"><h1>Resources</h1></div>");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("</div>");
    _builder.newLine();
  ...
  public CharSequence zoo() {
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("<td><a href=\"http://aranea.origo.ethz.ch\">Aranea</a></td>");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("<td>Messaging and infrastructure layer that uses Xtext for generating the message");
    _builder.newLine();
    _builder.append("and support classes.</td>");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("<td>MIT</td>");
    _builder.newLine();
    _builder.append("    ");
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("<td>Patrick Ruckstuhl</td>");
    _builder.newLine();
    _builder.append("  ");
    _builder.append("</tr>");
    _builder.newLine();
