...
public class ReleaseNotes extends AbstractWebsite {
  ...
  public CharSequence contents() {
    ...
    _builder.append("\t\t");
    CharSequence _headline = this.headline("");
    ...
    _builder.newLine();
    _builder.append("\t    ");
    _builder.append("<h2>Xtext 2.7.0 Release Notes (September 2nd, 2014)</h2>");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("<hr>");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("              ");
    _builder.append("Version 2.7 got many new features, bug fixes and performance improvements (<a href=\"https://bugs.eclipse.org/bugs/buglist.cgi?bug_status=RESOLVED&bug_status=VERIFIED&bug_status=CLOSED&status_whiteboard=v2.7\">full bugzilla list</a>). The most noteworthy changes are :");
    _builder.newLine();
    _builder.append("            ");
    _builder.append("</p>");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("            ");
    _builder.append("<section id=\"inferrer_api\" style=\"padding-top: 68px; margin-top: -68px;\">");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("<h2>Published Inferrer API of Xbase</h2>");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("<p>");
    _builder.newLine();
    _builder.append("\t\t\t\t   ");
    _builder.append("The JVM model inferrer API, which is the heart of Xbase, has been finalized and is now public. We took the opportunity to simplify it in some places. Have a look at the <a href=\"https://github.com/xtext-dev/seven-languages-xtext/tree/xtext_2.7\">updated seven languages example</a> for idiomatic usage of the API.");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("</p>");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("<section id=\"xtext_performance_2_7\" style=\"padding-top: 68px; margin-top: -68px;\">");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("<h2>Performance Improvements</h2>");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("<p>");
    _builder.newLine();
    _builder.append("\t\t\t\t   ");
    _builder.append("Xtext is now able to cancel many jobs (like refreshing the outline view) when the user starts typing, greatly improving responsiveness. Also, many UI actions can now be cancelled by hitting the \"Stop\" button.");
    _builder.newLine();
    _builder.append("\t\t\t\t   ");
    _builder.append("Resource clustering is now supported in the builder participant and standalone builder, reducing the memory footprint for large projects. There is a new parallel builder participant that can be used for even more performance gains.");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("</p>");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t   ");
    _builder.append("Better Integration with Xcore");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("</h2>");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t   ");
    _builder.append("The \"New Xtext Project\" wizard now supports Xcore models and adding them to an existing mwe2 workflow is as simple as specifying them as a <code>loadedResource</code>. Xcore itself has undergone some serious performance improvements, making it suitable even for large models.");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("</p>");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("<img class=\"image_between_p\" src=\"images/releasenotes/2_7_xtext-xcore-wizard.png\"/>");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("</section>");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("<h2>Debugging</h2>");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("<p>");
    _builder.newLine();
    _builder.append("\t\t\t\t   ");
    _builder.append("Breakpoints can now be toggled, enabled/disabled and inspected via the ruler context menu. Partial support for conditional breakpoints was added. Content assist in the condition editor will be added in version 2.8.");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("</p>");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("<img class=\"image_between_p\" src=\"images/releasenotes/2_7_xtext-breakpoint-toggle.png\"/>");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("</section>");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t   ");
    _builder.append("Find References improved");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("</h2>");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t   ");
    _builder.append("The find references API is now available in the runtime plugin and has undergone some performance improvements.");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("</p>");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t   ");
    _builder.append("Cross Plattform Improvements");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("</h2>");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t   ");
    _builder.append("All Xtext generator fragments now accept an explicit line delimiter, so heterogeneous teams get the same results when generating the language infrastructure.");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("</p>");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t   ");
    _builder.append("It is now allowed to leave out parameter declarations for all lambda expressions using a positional syntax.");
    _builder.newLine();
    _builder.append("<pre class=\"prettyprint lang-xtend linenums\">");
    _builder.newLine();
    _builder.append("#[1, 2, 3].reduce[$0 + $1]");
    _builder.newLine();
    _builder.append("</pre>");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("Enum constants in annotations can be referenced without their type name.");
    _builder.newLine();
    _builder.append("<pre class=\"prettyprint lang-xtend linenums\">");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("Type inference for parameterized inner classes was improved and supports types like");
    _builder.newLine();
    _builder.append("<pre class=\"prettyprint lang-xtend linenums\">");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("The validator will now detect use of deprecated API and is much better at finding dead code. Would you have spotted the following?");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("</p>");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("<img class=\"image_between_p\" src=\"images/releasenotes/2_7_xtend-dead-code-analysis.png\"/>");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("<img>");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t   ");
    _builder.append("The standard library has new extension methods for <code>Iterables</code>, including <code>min</code>/<code>max</code>, <code>groupBy</code> and <code>indexed</code>.");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("</p>");
    _builder.newLine();
    _builder.append("<pre class=\"prettyprint lang-xtend linenums\">");
    _builder.newLine();
    _builder.append("#[\"Xtend\", \"Java\", \"Eclipse\"].maxBy[length]");
    _builder.newLine();
    _builder.append("</pre>");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    ...
    _builder.newLine();
    _builder.append("   ");
    _builder.append("def void m3()");
    _builder.newLine();
    _builder.append("}");
    _builder.newLine();
    _builder.append("class A implements I {");
    _builder.newLine();
    _builder.append("   ");
    _builder.append("override m1() {}");
    _builder.newLine();
    _builder.append("   ");
    _builder.append("override m2() {}");
    _builder.newLine();
    _builder.append("   ");
    ...
    _builder.append("}");
    _builder.newLine();
    _builder.append("class B implements I {");
    _builder.newLine();
    _builder.append("   ");
    _builder.append("//all methods automatically implemented");
    _builder.newLine();
    _builder.append("   ");
    _builder.append("@Delegate A delegate = new A");
    _builder.newLine();
    _builder.append("}");
    _builder.newLine();
    _builder.append("</pre>");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("<p>Other additions include <code>@ToString</code>, <code>@EqualsHashCode</code>, <code>@FinalFieldsConstructor</code> and a new <code>@Data</code> (the old one is now deprecated as well as <code>@Property</code>).</p>");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    ...
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("<h2>IDE Features</h2>");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("</section>");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t   ");
    _builder.append("Xtend breakpoints can now have conditions. Conditions are written in Java, so you get full access even to synthetic variables inserted by the Xtend compiler. Of course you also get content assist in the condition editor.");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("</p>");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("<img class=\"image_between_p\" src=\"images/releasenotes/2_7_xtend-conditional-breakpoint.png\"/>");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("<p>");
    _builder.newLine();
    _builder.append("\t\t\t\t   ");
    _builder.append("Breakpoints can now be toggled, enabled/disabled and inspected via the ruler context menu.");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("</p>");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t   ");
    _builder.append("Content Assist");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("</h3>");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t   ");
    _builder.append("Content Assist has become a lot faster and more accurate at the same time. It will now also retain the \"is\"-prefix of boolean properties.");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("</p>");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t   ");
    _builder.append("Performance Improvements");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("</h3>");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t   ");
    _builder.append("Performance has reached a new level with big improvements to Content Assist, parallel code generation and lots of fine tuning. Also, Xtend will now cancel jobs (like outline refreshing) when you start typing again, making the editor much more responsive.");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("</p>");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t   ");
    _builder.append("Outline with Java-Mode");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("</h3>");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t   ");
    _builder.append("The outline view now supports two modes: One shows the original Xtend AST, the other one shows the resulting Java AST. This is very useful in the presence of Active Annotations that add a lot of new members to a class.");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("</p>");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("<img class=\"image_between_p\" src=\"images/releasenotes/2_7_xtend-outline-normal.png\"/>");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("<img class=\"image_between_p\" src=\"images/releasenotes/2_7_xtend-outline-jvm.png\"/>");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("</section>");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t   ");
    _builder.append("Organize imports on packages");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("</h3>");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t   ");
    _builder.append("You can now use \"Organize Xtend Imports\" on whole packages via the \"Source\" context menu.");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("</p>");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("<img class=\"image_between_p\" src=\"images/releasenotes/2_7_xtend-organize-imports.png\"/>");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("</section>");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t   ");
    _builder.append("Template proposals support import");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("</h3>");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t   ");
    _builder.append("A new type of template variable was added. It adds an import to an Xtend file when the template is inserted. This greatly reduces the need for qualified type names in templates.");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("</p>");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("<img class=\"image_between_p\" src=\"images/releasenotes/2_7_xtend-templates-import.png\"/>");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("</section>");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t   ");
    _builder.append("Open return type");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("</h3>");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t   ");
    _builder.append("Ever wondered what you can do with the type of a variable or the return type of a method? You can now CTRL-Click on feature calls and open the declaration of the return type of that call.");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("</p>");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t   ");
    _builder.append("Show errors from derived Java files");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("</h3>");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t   ");
    _builder.append("By using black box Java code within active annotations the generated Java source could sometimes have errors while the Xtend code is fine. In those cases, the errors are now shown at the appropriate locations in Xtend as well.");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("</p>");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("<h3>Maven and Java 8</h3>");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("<p>");
    _builder.newLine();
    _builder.append("\t\t\t\t   ");
    _builder.append("The Xtend Maven plugin is now toolchain-aware. Using this, you can for instance run Maven on Java 8, but compile against a JDK 6.");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("</p>");
    _builder.newLine();
