...
class News extends AbstractWebsite {
	...
	override jsOnLoad() {
		'''
		var feed = new google.feeds.Feed("http://xtextnews.blogspot.com/feeds/posts/default?orderby=published&foo="+new Date().getTime());
