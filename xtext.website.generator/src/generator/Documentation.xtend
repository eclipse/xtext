...
class Documentation extends AbstractXdocBaseWebsite {
	...
	def additionalLinks() '''
		...
		<li><a href="documentation/2.6.0/Xtext%20Documentation.pdf">Documentation <img src="images/pdf_icon.gif"></a>
		<li><a href="http://download.eclipse.org/modeling/tmf/xtext/javadoc/2.6/">API Documentation (JavaDoc)</a>
	'''
