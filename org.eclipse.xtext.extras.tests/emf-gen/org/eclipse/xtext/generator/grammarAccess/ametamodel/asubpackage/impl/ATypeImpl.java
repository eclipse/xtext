 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.xtext.generator.grammarAccess.ametamodel.asubpackage.impl.ATypeImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ATypeImpl extends EObjectImpl implements AType {
	...
	protected EClass eStaticClass() {
		return AsubpackagePackage.Literals.ATYPE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AsubpackagePackage.ATYPE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AsubpackagePackage.ATYPE__NAME:
				return getName();
		}
