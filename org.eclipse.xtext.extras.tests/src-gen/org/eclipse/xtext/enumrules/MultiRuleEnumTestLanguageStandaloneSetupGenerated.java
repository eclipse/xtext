...
public class MultiRuleEnumTestLanguageStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new MultiRuleEnumTestLanguageRuntimeModule());
	}
