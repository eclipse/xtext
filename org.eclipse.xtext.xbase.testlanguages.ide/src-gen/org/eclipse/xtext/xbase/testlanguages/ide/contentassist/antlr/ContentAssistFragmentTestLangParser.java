...
public class ContentAssistFragmentTestLangParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, ContentAssistFragmentTestLangGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getContentAssistFragmentTestLanguageRootAccess().getGroup(), "rule__ContentAssistFragmentTestLanguageRoot__Group__0");
			...
			builder.put(grammarAccess.getContentAssistFragmentTestLanguageRootAccess().getExpressionAssignment_0(), "rule__ContentAssistFragmentTestLanguageRoot__ExpressionAssignment_0");
			builder.put(grammarAccess.getContentAssistFragmentTestLanguageRootAccess().getEntitiesAssignment_1(), "rule__ContentAssistFragmentTestLanguageRoot__EntitiesAssignment_1");
