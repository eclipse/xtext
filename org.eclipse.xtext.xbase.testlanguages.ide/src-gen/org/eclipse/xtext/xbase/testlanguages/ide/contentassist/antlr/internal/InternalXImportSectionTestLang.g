 ...
 *******************************************************************************/
grammar InternalXImportSectionTestLang;
...
// Entry rule entryRuleImportSectionTestLanguageRoot
entryRuleImportSectionTestLanguageRoot
:
{ before(grammarAccess.getImportSectionTestLanguageRootRule()); }
	 ruleImportSectionTestLanguageRoot
{ after(grammarAccess.getImportSectionTestLanguageRootRule()); } 
	 EOF 
;

// Rule ImportSectionTestLanguageRoot
ruleImportSectionTestLanguageRoot 
	@init {
	...
	:
	(
		{ before(grammarAccess.getImportSectionTestLanguageRootAccess().getGroup()); }
		(rule__ImportSectionTestLanguageRoot__Group__0)
		{ after(grammarAccess.getImportSectionTestLanguageRootAccess().getGroup()); }
	)
;
finally {
...
:
	rule__ImportSectionTestLanguageRoot__Group__0__Impl
	rule__ImportSectionTestLanguageRoot__Group__1
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
	{ before(grammarAccess.getImportSectionTestLanguageRootAccess().getSomeKeyword_0()); }
	'some'
	{ after(grammarAccess.getImportSectionTestLanguageRootAccess().getSomeKeyword_0()); }
)
;
finally {
	restoreStackSize(stackSize);
...
:
	rule__ImportSectionTestLanguageRoot__Group__1__Impl
	rule__ImportSectionTestLanguageRoot__Group__2
;
finally {
	restoreStackSize(stackSize);
}
...
:
(
	{ before(grammarAccess.getImportSectionTestLanguageRootAccess().getTokenKeyword_1()); }
	'token'
	{ after(grammarAccess.getImportSectionTestLanguageRootAccess().getTokenKeyword_1()); }
)
;
finally {
	restoreStackSize(stackSize);
