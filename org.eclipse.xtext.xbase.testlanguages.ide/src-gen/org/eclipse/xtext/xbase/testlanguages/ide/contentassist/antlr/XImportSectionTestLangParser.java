		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getImportSectionTestLanguageRootAccess().getGroup(), "rule__ImportSectionTestLanguageRoot__Group__0");
					...
					put(grammarAccess.getImportSectionTestLanguageRootAccess().getImportSectionAssignment_2(), "rule__ImportSectionTestLanguageRoot__ImportSectionAssignment_2");
