...
import org.eclipse.xtext.xbase.testlanguages.ide.contentassist.antlr.internal.InternalXImportSectionTestLangParser;
import org.eclipse.xtext.xbase.testlanguages.services.XImportSectionTestLangGrammarAccess;

public class XImportSectionTestLangParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(XImportSectionTestLangGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, XImportSectionTestLangGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getImportSectionTestLanguageRootAccess().getGroup(), "rule__ImportSectionTestLanguageRoot__Group__0");
	...
	@Override
	protected InternalXImportSectionTestLangParser createParser() {
		InternalXImportSectionTestLangParser result = new InternalXImportSectionTestLangParser(null);
