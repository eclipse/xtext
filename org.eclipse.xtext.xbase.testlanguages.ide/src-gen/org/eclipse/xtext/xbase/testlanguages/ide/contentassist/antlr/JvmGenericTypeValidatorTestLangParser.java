...
public class JvmGenericTypeValidatorTestLangParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, JvmGenericTypeValidatorTestLangGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getMyMemberAccess().getGroup_2_4(), "rule__MyMember__Group_2_4__0");
			builder.put(grammarAccess.getMyMemberAccess().getGroup_2_4_2(), "rule__MyMember__Group_2_4_2__0");
			builder.put(grammarAccess.getMyMemberAccess().getGroup_2_8(), "rule__MyMember__Group_2_8__0");
			builder.put(grammarAccess.getMyMemberAccess().getGroup_2_8_1(), "rule__MyMember__Group_2_8_1__0");
			builder.put(grammarAccess.getMyMemberAccess().getGroup_2_10(), "rule__MyMember__Group_2_10__0");
			builder.put(grammarAccess.getMyMemberAccess().getGroup_2_10_2(), "rule__MyMember__Group_2_10_2__0");
			...
			builder.put(grammarAccess.getMyMemberAccess().getTypeParametersAssignment_2_4_1(), "rule__MyMember__TypeParametersAssignment_2_4_1");
			builder.put(grammarAccess.getMyMemberAccess().getTypeParametersAssignment_2_4_2_1(), "rule__MyMember__TypeParametersAssignment_2_4_2_1");
			builder.put(grammarAccess.getMyMemberAccess().getTypeAssignment_2_5(), "rule__MyMember__TypeAssignment_2_5");
			builder.put(grammarAccess.getMyMemberAccess().getNameAssignment_2_6(), "rule__MyMember__NameAssignment_2_6");
			builder.put(grammarAccess.getMyMemberAccess().getParametersAssignment_2_8_0(), "rule__MyMember__ParametersAssignment_2_8_0");
			builder.put(grammarAccess.getMyMemberAccess().getParametersAssignment_2_8_1_1(), "rule__MyMember__ParametersAssignment_2_8_1_1");
			builder.put(grammarAccess.getMyMemberAccess().getExceptionsAssignment_2_10_1(), "rule__MyMember__ExceptionsAssignment_2_10_1");
			builder.put(grammarAccess.getMyMemberAccess().getExceptionsAssignment_2_10_2_1(), "rule__MyMember__ExceptionsAssignment_2_10_2_1");
			builder.put(grammarAccess.getMyMemberAccess().getExpressionAssignment_2_11(), "rule__MyMember__ExpressionAssignment_2_11");
