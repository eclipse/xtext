 ...
 *******************************************************************************/
package org.eclipse.xtext.xbase.testlanguages.ide.contentassist.antlr;
...
import org.eclipse.xtext.xbase.testlanguages.ide.contentassist.antlr.internal.InternalJvmGenericTypeValidatorTestLangParser;
import org.eclipse.xtext.xbase.testlanguages.services.JvmGenericTypeValidatorTestLangGrammarAccess;

public class JvmGenericTypeValidatorTestLangParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(JvmGenericTypeValidatorTestLangGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, JvmGenericTypeValidatorTestLangGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getJvmGenericTypeValidatorTestLangModelAccess().getGroup(), "rule__JvmGenericTypeValidatorTestLangModel__Group__0");
			builder.put(grammarAccess.getJvmGenericTypeValidatorTestLangModelAccess().getGroup_0(), "rule__JvmGenericTypeValidatorTestLangModel__Group_0__0");
			builder.put(grammarAccess.getMyClassAccess().getGroup(), "rule__MyClass__Group__0");
			builder.put(grammarAccess.getMyClassAccess().getGroup_3(), "rule__MyClass__Group_3__0");
			builder.put(grammarAccess.getMyClassAccess().getGroup_4(), "rule__MyClass__Group_4__0");
			builder.put(grammarAccess.getMyClassAccess().getGroup_4_2(), "rule__MyClass__Group_4_2__0");
			builder.put(grammarAccess.getMyInterfaceAccess().getGroup(), "rule__MyInterface__Group__0");
			builder.put(grammarAccess.getMyInterfaceAccess().getGroup_2(), "rule__MyInterface__Group_2__0");
			...
			builder.put(grammarAccess.getMyMemberAccess().getGroup_0_5(), "rule__MyMember__Group_0_5__0");
			builder.put(grammarAccess.getMyMemberAccess().getGroup_0_5_2(), "rule__MyMember__Group_0_5_2__0");
			builder.put(grammarAccess.getMyMemberAccess().getGroup_1(), "rule__MyMember__Group_1__0");
			builder.put(grammarAccess.getMyMemberAccess().getGroup_2(), "rule__MyMember__Group_2__0");
			builder.put(grammarAccess.getMyMemberAccess().getGroup_2_5(), "rule__MyMember__Group_2_5__0");
			builder.put(grammarAccess.getMyMemberAccess().getGroup_2_5_2(), "rule__MyMember__Group_2_5_2__0");
			builder.put(grammarAccess.getMyMemberAccess().getGroup_2_9(), "rule__MyMember__Group_2_9__0");
			builder.put(grammarAccess.getMyMemberAccess().getGroup_2_9_1(), "rule__MyMember__Group_2_9_1__0");
			builder.put(grammarAccess.getMyMemberAccess().getGroup_2_11(), "rule__MyMember__Group_2_11__0");
			builder.put(grammarAccess.getMyMemberAccess().getGroup_2_11_2(), "rule__MyMember__Group_2_11_2__0");
			...
			builder.put(grammarAccess.getJvmGenericTypeValidatorTestLangModelAccess().getPackageAssignment_0_1(), "rule__JvmGenericTypeValidatorTestLangModel__PackageAssignment_0_1");
			builder.put(grammarAccess.getJvmGenericTypeValidatorTestLangModelAccess().getImportSectionAssignment_1(), "rule__JvmGenericTypeValidatorTestLangModel__ImportSectionAssignment_1");
			builder.put(grammarAccess.getJvmGenericTypeValidatorTestLangModelAccess().getModelTypesAssignment_2(), "rule__JvmGenericTypeValidatorTestLangModel__ModelTypesAssignment_2");
			builder.put(grammarAccess.getMyClassAccess().getAbstractAssignment_0(), "rule__MyClass__AbstractAssignment_0");
			builder.put(grammarAccess.getMyClassAccess().getNameAssignment_2(), "rule__MyClass__NameAssignment_2");
			builder.put(grammarAccess.getMyClassAccess().getExtendsAssignment_3_1(), "rule__MyClass__ExtendsAssignment_3_1");
			builder.put(grammarAccess.getMyClassAccess().getImplementsAssignment_4_1(), "rule__MyClass__ImplementsAssignment_4_1");
			builder.put(grammarAccess.getMyClassAccess().getImplementsAssignment_4_2_1(), "rule__MyClass__ImplementsAssignment_4_2_1");
			builder.put(grammarAccess.getMyClassAccess().getMembersAssignment_6(), "rule__MyClass__MembersAssignment_6");
			...
			builder.put(grammarAccess.getMyMemberAccess().getExceptionsAssignment_0_5_2_1(), "rule__MyMember__ExceptionsAssignment_0_5_2_1");
			builder.put(grammarAccess.getMyMemberAccess().getExpressionAssignment_0_6(), "rule__MyMember__ExpressionAssignment_0_6");
			...
			builder.put(grammarAccess.getMyMemberAccess().getStaticAssignment_2_2(), "rule__MyMember__StaticAssignment_2_2");
			builder.put(grammarAccess.getMyMemberAccess().getPrivateAssignment_2_3(), "rule__MyMember__PrivateAssignment_2_3");
			builder.put(grammarAccess.getMyMemberAccess().getSynchronizedAssignment_2_4(), "rule__MyMember__SynchronizedAssignment_2_4");
			builder.put(grammarAccess.getMyMemberAccess().getTypeParametersAssignment_2_5_1(), "rule__MyMember__TypeParametersAssignment_2_5_1");
			builder.put(grammarAccess.getMyMemberAccess().getTypeParametersAssignment_2_5_2_1(), "rule__MyMember__TypeParametersAssignment_2_5_2_1");
			builder.put(grammarAccess.getMyMemberAccess().getTypeAssignment_2_6(), "rule__MyMember__TypeAssignment_2_6");
			builder.put(grammarAccess.getMyMemberAccess().getNameAssignment_2_7(), "rule__MyMember__NameAssignment_2_7");
			builder.put(grammarAccess.getMyMemberAccess().getParametersAssignment_2_9_0(), "rule__MyMember__ParametersAssignment_2_9_0");
			builder.put(grammarAccess.getMyMemberAccess().getParametersAssignment_2_9_1_1(), "rule__MyMember__ParametersAssignment_2_9_1_1");
			builder.put(grammarAccess.getMyMemberAccess().getExceptionsAssignment_2_11_1(), "rule__MyMember__ExceptionsAssignment_2_11_1");
			builder.put(grammarAccess.getMyMemberAccess().getExceptionsAssignment_2_11_2_1(), "rule__MyMember__ExceptionsAssignment_2_11_2_1");
			builder.put(grammarAccess.getMyMemberAccess().getExpressionAssignment_2_12(), "rule__MyMember__ExpressionAssignment_2_12");
	...
	@Override
	protected InternalJvmGenericTypeValidatorTestLangParser createParser() {
		InternalJvmGenericTypeValidatorTestLangParser result = new InternalJvmGenericTypeValidatorTestLangParser(null);
