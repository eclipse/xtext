 ...
 *******************************************************************************/
package org.eclipse.xtext.xbase.testlanguages.bug462047.ide.contentassist.antlr;
...
import org.eclipse.xtext.xbase.testlanguages.bug462047.ide.contentassist.antlr.internal.InternalBug462047LangParser;
...
public class Bug462047LangParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(Bug462047LangGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, Bug462047LangGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getBug462047ElementAccess().getGroup(), "rule__Bug462047Element__Group__0");
			builder.put(grammarAccess.getBug462047ElementAccess().getGroup_2(), "rule__Bug462047Element__Group_2__0");
			...
			builder.put(grammarAccess.getBug462047RootAccess().getElementsAssignment(), "rule__Bug462047Root__ElementsAssignment");
			builder.put(grammarAccess.getBug462047ElementAccess().getNameAssignment_1(), "rule__Bug462047Element__NameAssignment_1");
			builder.put(grammarAccess.getBug462047ElementAccess().getRefAssignment_2_1(), "rule__Bug462047Element__RefAssignment_2_1");
	...
	@Override
	protected InternalBug462047LangParser createParser() {
		InternalBug462047LangParser result = new InternalBug462047LangParser(null);
