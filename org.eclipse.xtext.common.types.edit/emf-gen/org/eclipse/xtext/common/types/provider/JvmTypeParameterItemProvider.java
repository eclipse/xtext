...
/**
 * This is the item provider adapter for a {@link org.eclipse.xtext.common.types.JvmTypeParameter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class JvmTypeParameterItemProvider extends JvmComponentTypeItemProvider
{
	 ...
	 * @generated
	 */
	public JvmTypeParameterItemProvider(AdapterFactory adapterFactory)
	{
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_JvmTypeParameter_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_JvmTypeParameter_name_feature", "_UI_JvmTypeParameter_type"),
	...
	{
		return overlayImage(object, getResourceLocator().getImage("full/obj16/JvmTypeParameter"));
	}
	...
	{
		String label = ((JvmTypeParameter)object).getName();
	...
	public void notifyChanged(Notification notification)
	{
		...
		switch (notification.getFeatureID(JvmTypeParameter.class))
		{
