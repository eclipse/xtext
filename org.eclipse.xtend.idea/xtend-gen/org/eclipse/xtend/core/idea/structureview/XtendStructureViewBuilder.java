...
public class XtendStructureViewBuilder implements XtextFileAwareStructureViewBuilder {
  ...
  public StructureView createStructureView(final FileEditor fileEditor, final Project project) {
    StructureViewComposite _xblockexpression = null;
    {
      ...
      final Procedure1<XtendSourceStructureViewBuilder> _function = (XtendSourceStructureViewBuilder builder) -> {
        builder.setXtextFile(this.xtextFile);
      };
      ...
      final Procedure1<XtendJvmStructureViewBuilder> _function_1 = (XtendJvmStructureViewBuilder builder) -> {
        builder.setXtextFile(this.xtextFile);
      };
