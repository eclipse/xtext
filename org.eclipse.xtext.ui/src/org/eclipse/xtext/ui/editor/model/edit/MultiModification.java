...
public class MultiModification implements IModification, IMultiModification {
	
	public static class Wrapper implements IModification, IMultiModification {
	...
	public MultiModification(URI uri, IMultiModificationWithContext modification) {
	...
	public void apply(EObject element) {
		...
		IMultiModification modification = context.getModification();
		if (modification == null) {
			throw new IllegalStateException("Call setModification() before applying the modification");
		}
		modification.apply(context.getElement());
	}
