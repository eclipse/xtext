 ...
 * @since 2.35
 */
public abstract class DetachableParseResultBase<NMR extends NodeModelReference, Serialized> extends AbstractParseResult {
	
	private static final Logger logger = Logger.getLogger(DetachableParseResultBase.class);
	...
	protected DetachableParseResultBase(GrammarElementLookup grammarElementLookup) {
		this(grammarElementLookup, Duration.ofSeconds(5));
	}
	
	protected DetachableParseResultBase(GrammarElementLookup grammarElementLookup, Duration timeout) {
		super(null, false);
