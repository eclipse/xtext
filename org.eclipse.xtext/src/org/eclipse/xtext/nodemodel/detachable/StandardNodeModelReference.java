...
public class StandardNodeModelReference extends NodeModelReference {
	...
	protected final DetachableParseResultBase<StandardNodeModelReference, ?> parseResult;

	public StandardNodeModelReference(DetachableParseResultBase<StandardNodeModelReference, ?> parseResult, RootNode rootNode, Map<EObject, CompositeNodeWithSemanticElement> associations) {
	...
	protected <Serialized> void serializeAndDetachFrom(DetachableParseResultBase<StandardNodeModelReference, Serialized> parseResult) {
		try {
