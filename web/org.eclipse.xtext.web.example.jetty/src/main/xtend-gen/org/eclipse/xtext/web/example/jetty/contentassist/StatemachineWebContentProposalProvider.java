  ...
  protected void _createProposals(final Assignment assignment, final ContentAssistContext context, final IAcceptor<ContentAssistResult.Entry> acceptor) {
    ...
    if (!_matched) {
      ...
      if (Objects.equal(assignment, _signalAssignment_1)) {
        ...
        final Function1<IEObjectDescription, Boolean> _function_2 = new Function1<IEObjectDescription, Boolean>() {
          @Override
          public Boolean apply(final IEObjectDescription it) {
            EClass _eClass = it.getEClass();
        ...
        Iterable<IEObjectDescription> _filter_1 = IterableExtensions.<IEObjectDescription>filter(_allElements_1, _function_2);
        for (final IEObjectDescription description_1 : _filter_1) {
          String _prefix_1 = context.getPrefix();
          ContentAssistResult.Entry _entry_1 = new ContentAssistResult.Entry(ContentAssistResult.CROSSREF, _prefix_1);
          final Procedure1<ContentAssistResult.Entry> _function_3 = new Procedure1<ContentAssistResult.Entry>() {
            @Override
            public void apply(final ContentAssistResult.Entry it) {
          ...
          ContentAssistResult.Entry _doubleArrow_1 = ObjectExtensions.<ContentAssistResult.Entry>operator_doubleArrow(_entry_1, _function_3);
          acceptor.accept(_doubleArrow_1);
        }
      }
    }
