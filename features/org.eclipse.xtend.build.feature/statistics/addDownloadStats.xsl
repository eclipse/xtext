<xsl:stylesheet xmlns:xsl='http://www.w3.org/1999/XSL/Transform' version="1.0">
	...
	<xsl:template match="repository/properties">
		<properties size='{@size+1}'>
			...
			<property name='p2.statsURI' value='http://download.eclipse.org/stats/xtend' />
		</properties>
	</xsl:template>

	<xsl:template match="artifact[@classifier='org.eclipse.update.feature' and @id='org.eclipse.xtend.sdk']/properties">
