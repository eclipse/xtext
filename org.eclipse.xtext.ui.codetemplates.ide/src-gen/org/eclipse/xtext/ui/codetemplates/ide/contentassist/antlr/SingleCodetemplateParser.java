...
public class SingleCodetemplateParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(Map<AbstractElement, String> mappings, SingleCodetemplateGrammarAccess grammarAccess) {
			mappings.put(grammarAccess.getCodetemplateAccess().getAlternatives_2(), "rule__Codetemplate__Alternatives_2");
			...
			mappings.put(grammarAccess.getCodetemplatesAccess().getTemplatesAssignment_3(), "rule__Codetemplates__TemplatesAssignment_3");
			mappings.put(grammarAccess.getCodetemplateAccess().getNameAssignment_0(), "rule__Codetemplate__NameAssignment_0");
			mappings.put(grammarAccess.getCodetemplateAccess().getContextAssignment_2_0(), "rule__Codetemplate__ContextAssignment_2_0");
			mappings.put(grammarAccess.getCodetemplateAccess().getKeywordContextAssignment_2_1(), "rule__Codetemplate__KeywordContextAssignment_2_1");
			mappings.put(grammarAccess.getCodetemplateAccess().getBodyAssignment_3(), "rule__Codetemplate__BodyAssignment_3");
