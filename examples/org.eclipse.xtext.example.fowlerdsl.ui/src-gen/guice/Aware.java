...
public class Aware implements IExecutableExtensionFactory, IExecutableExtension {
	...
	public Object create() throws CoreException {
		Bundle bundle = org.eclipse.xtext.example.ui.internal.FowlerDslActivator.getInstance().getBundle();
		try {
			Class<?> class1 = bundle.loadClass(clazzName);
			return org.eclipse.xtext.example.ui.internal.FowlerDslActivator.getInstance().getInjector().getInstance(class1);
		} catch (Exception e) {
			log.error(e);
