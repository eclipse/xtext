 ...
 */
public class FowlerDslXtendContentAssistInvoker extends AbstractXtendService implements IContentAssistInvocationHandler {

	private static final Logger log = Logger.getLogger(FowlerDslXtendContentAssistInvoker.class);
	...
	protected String getMasterXtendFileName() {
		...
		return "org::eclipse::xtext::example::FowlerDslProposalProvider";
	}
