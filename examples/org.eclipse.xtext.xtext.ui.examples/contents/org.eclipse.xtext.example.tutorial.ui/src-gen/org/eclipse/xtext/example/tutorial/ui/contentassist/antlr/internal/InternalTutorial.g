...
:
(
{ before(grammarAccess.getOpMultiAssignAccess().getLessThanSignEqualsSignKeyword_8_1()); }

	'<=' 

{ after(grammarAccess.getOpMultiAssignAccess().getLessThanSignEqualsSignKeyword_8_1()); }
)
