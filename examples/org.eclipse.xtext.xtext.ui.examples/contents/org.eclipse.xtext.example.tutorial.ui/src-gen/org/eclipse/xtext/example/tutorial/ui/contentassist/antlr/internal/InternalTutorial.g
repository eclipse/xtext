...
:
(
{ before(grammarAccess.getOpMultiAssignAccess().getLessThanSignEqualsSignKeyword_5_1()); }

	'<=' 

{ after(grammarAccess.getOpMultiAssignAccess().getLessThanSignEqualsSignKeyword_5_1()); }
)
