...
public abstract class AbstractDomainmodelRuntimeModule extends DefaultRuntimeModule {
	...
	public void configureFormatterPreferences(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.preferences.IPreferenceValuesProvider.class).annotatedWith(org.eclipse.xtext.formatting2.FormatterPreferences.class).to(org.eclipse.xtext.formatting2.impl.FormatterPreferenceValuesProvider.class);
	}
