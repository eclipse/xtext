 ...
 * <ul>
 *   <li>{@link org.eclipse.xtext.example.domainmodel.domainmodel.Entity#getName <em>Name</em>}</li>
...
public interface Entity extends AbstractElement
{
   ...
   * @see #setName(String)
   * @see org.eclipse.xtext.example.domainmodel.domainmodel.DomainmodelPackage#getEntity_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link org.eclipse.xtext.example.domainmodel.domainmodel.Entity#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
