 ...
 *   <li>{@link org.eclipse.xtext.example.domainmodel.Operation#getBody <em>Body</em>}</li>
 * </ul>
 * </p>
 *
...
public interface Operation extends Feature
{
   ...
   * @see org.eclipse.xtext.example.domainmodel.DomainmodelPackage#getOperation_Body()
   * @model containment="true"
   * @generated
   */
  XExpression getBody();
  ...
  /**
   * Sets the value of the '{@link org.eclipse.xtext.example.domainmodel.Operation#getBody <em>Body</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
