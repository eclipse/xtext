 ...
 * <ul>
 *   <li>{@link xbase.XConstructorCall#getConstructor <em>Constructor</em>}</li>
 *   <li>{@link xbase.XConstructorCall#getArguments <em>Arguments</em>}</li>
 *   <li>{@link xbase.XConstructorCall#getTypeArguments <em>Type Arguments</em>}</li>
 *   <li>{@link xbase.XConstructorCall#getInvalidFeatureIssueCode <em>Invalid Feature Issue Code</em>}</li>
 *   <li>{@link xbase.XConstructorCall#isValidFeature <em>Valid Feature</em>}</li>
 * </ul>
 * </p>
 *
 * @see xbase.XbasePackage#getXConstructorCall()
 * @model
 * @generated
 */
public interface XConstructorCall extends XExpression
{
   ...
   * @see xbase.XbasePackage#getXConstructorCall_Constructor()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link xbase.XConstructorCall#getConstructor <em>Constructor</em>}' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see xbase.XbasePackage#getXConstructorCall_Arguments()
   ...
   * @see xbase.XbasePackage#getXConstructorCall_TypeArguments()
   * @model containment="true"
   * @generated
   */
   ...
   * @see xbase.XbasePackage#getXConstructorCall_InvalidFeatureIssueCode()
  ...
  /**
   * Sets the value of the '{@link xbase.XConstructorCall#getInvalidFeatureIssueCode <em>Invalid Feature Issue Code</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see xbase.XbasePackage#getXConstructorCall_ValidFeature()
