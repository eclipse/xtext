 ...
 * <ul>
 *   <li>{@link xbase.XCasePart#getCase <em>Case</em>}</li>
 *   <li>{@link xbase.XCasePart#getThen <em>Then</em>}</li>
 *   <li>{@link xbase.XCasePart#getTypeGuard <em>Type Guard</em>}</li>
 * </ul>
 * </p>
 *
...
public interface XCasePart extends JvmIdentifiableElement
{
  ...
  /**
   * Sets the value of the '{@link xbase.XCasePart#getCase <em>Case</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Sets the value of the '{@link xbase.XCasePart#getThen <em>Then</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Sets the value of the '{@link xbase.XCasePart#getTypeGuard <em>Type Guard</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
