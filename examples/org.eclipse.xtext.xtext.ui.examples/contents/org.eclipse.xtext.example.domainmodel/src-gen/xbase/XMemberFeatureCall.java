 ...
 * <ul>
 *   <li>{@link xbase.XMemberFeatureCall#getMemberCallTarget <em>Member Call Target</em>}</li>
 *   <li>{@link xbase.XMemberFeatureCall#getMemberCallArguments <em>Member Call Arguments</em>}</li>
 *   <li>{@link xbase.XMemberFeatureCall#isExplicitOperationCall <em>Explicit Operation Call</em>}</li>
 *   <li>{@link xbase.XMemberFeatureCall#isSpreading <em>Spreading</em>}</li>
 *   <li>{@link xbase.XMemberFeatureCall#isNullSafe <em>Null Safe</em>}</li>
 * </ul>
 * </p>
 *
...
public interface XMemberFeatureCall extends XAbstractFeatureCall
{
  ...
  /**
   * Sets the value of the '{@link xbase.XMemberFeatureCall#getMemberCallTarget <em>Member Call Target</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Sets the value of the '{@link xbase.XMemberFeatureCall#isExplicitOperationCall <em>Explicit Operation Call</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see xbase.XbasePackage#getXMemberFeatureCall_Spreading()
   * @model
   * @generated
   */
  boolean isSpreading();
  ...
  /**
   * Sets the value of the '{@link xbase.XMemberFeatureCall#isSpreading <em>Spreading</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Sets the value of the '{@link xbase.XMemberFeatureCall#isNullSafe <em>Null Safe</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
