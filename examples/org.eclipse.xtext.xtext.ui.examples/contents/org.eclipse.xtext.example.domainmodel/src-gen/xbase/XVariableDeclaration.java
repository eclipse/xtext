 ...
 * <ul>
 *   <li>{@link xbase.XVariableDeclaration#getType <em>Type</em>}</li>
 *   <li>{@link xbase.XVariableDeclaration#getName <em>Name</em>}</li>
 *   <li>{@link xbase.XVariableDeclaration#getRight <em>Right</em>}</li>
 *   <li>{@link xbase.XVariableDeclaration#isWriteable <em>Writeable</em>}</li>
 * </ul>
 * </p>
 *
...
public interface XVariableDeclaration extends XExpression, JvmIdentifiableElement
{
  ...
  /**
   * Sets the value of the '{@link xbase.XVariableDeclaration#getType <em>Type</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Sets the value of the '{@link xbase.XVariableDeclaration#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Sets the value of the '{@link xbase.XVariableDeclaration#getRight <em>Right</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
  ...
  /**
   * Sets the value of the '{@link xbase.XVariableDeclaration#isWriteable <em>Writeable</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
