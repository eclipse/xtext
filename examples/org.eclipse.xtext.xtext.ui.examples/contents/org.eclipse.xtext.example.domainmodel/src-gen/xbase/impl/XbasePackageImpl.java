...
import xbase.XAbstractWhileExpression;
import xbase.XAssignment;
import xbase.XBinaryOperation;
import xbase.XBlockExpression;
import xbase.XBooleanLiteral;
import xbase.XCasePart;
import xbase.XCastedExpression;
import xbase.XCatchClause;
import xbase.XClosure;
import xbase.XConstructorCall;
import xbase.XDoWhileExpression;
import xbase.XExpression;
import xbase.XFeatureCall;
import xbase.XForLoopExpression;
import xbase.XIfExpression;
import xbase.XInstanceOfExpression;
import xbase.XIntLiteral;
import xbase.XMemberFeatureCall;
import xbase.XNullLiteral;
import xbase.XReturnExpression;
import xbase.XStringLiteral;
import xbase.XSwitchExpression;
import xbase.XThrowExpression;
import xbase.XTryCatchFinallyExpression;
import xbase.XTypeLiteral;
import xbase.XUnaryOperation;
import xbase.XVariableDeclaration;
import xbase.XWhileExpression;
import xbase.XbaseFactory;
...
public class XbasePackageImpl extends EPackageImpl implements XbasePackage
{
   ...
   * @see xbase.XbasePackage#eNS_URI
   * @see #init()
   * @generated
   */
   ...
   * @generated
   */
  public EAttribute getXMemberFeatureCall_Spreading()
  {
  ...
  public void createPackageContents()
  {
    ...
    createEAttribute(xMemberFeatureCallEClass, XMEMBER_FEATURE_CALL__SPREADING);
  ...
  public void initializePackageContents()
  {
    ...
    initEReference(getXAbstractFeatureCall_ImplicitReceiver(), this.getXFeatureCall(), null, "implicitReceiver", null, 0, 1, XAbstractFeatureCall.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getXMemberFeatureCall_Spreading(), ecorePackage.getEBoolean(), "spreading", null, 0, 1, XMemberFeatureCall.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
