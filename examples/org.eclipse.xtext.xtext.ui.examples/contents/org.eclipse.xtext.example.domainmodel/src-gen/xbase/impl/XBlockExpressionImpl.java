 ...
 * <ul>
 *   <li>{@link xbase.impl.XBlockExpressionImpl#getExpressions <em>Expressions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class XBlockExpressionImpl extends XExpressionImpl implements XBlockExpression
{
  ...
  public EList<XExpression> getExpressions()
  {
    if (expressions == null)
    {
      expressions = new EObjectContainmentEList<XExpression>(XExpression.class, this, XbasePackage.XBLOCK_EXPRESSION__EXPRESSIONS);
    }
    return expressions;
  }
