 ...
 * <ul>
 *   <li>{@link xbase.impl.XMemberFeatureCallImpl#getMemberCallTarget <em>Member Call Target</em>}</li>
 *   <li>{@link xbase.impl.XMemberFeatureCallImpl#getMemberCallArguments <em>Member Call Arguments</em>}</li>
 *   <li>{@link xbase.impl.XMemberFeatureCallImpl#isExplicitOperationCall <em>Explicit Operation Call</em>}</li>
 *   <li>{@link xbase.impl.XMemberFeatureCallImpl#isSpreading <em>Spreading</em>}</li>
 *   <li>{@link xbase.impl.XMemberFeatureCallImpl#isNullSafe <em>Null Safe</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class XMemberFeatureCallImpl extends XAbstractFeatureCallImpl implements XMemberFeatureCall
{
  /**
