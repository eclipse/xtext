...
@header {
package org.eclipse.xtext.example.homeautomation.ui.contentassist.antlr.internal; 
...
{ before(grammarAccess.getDeviceAccess().getStatesStateParserRuleCall_4_0_0()); }
	ruleState{ after(grammarAccess.getDeviceAccess().getStatesStateParserRuleCall_4_0_0()); }
)
...
{ before(grammarAccess.getDeviceAccess().getStatesStateParserRuleCall_4_1_1_0()); }
	ruleState{ after(grammarAccess.getDeviceAccess().getStatesStateParserRuleCall_4_1_1_0()); }
)
...
{ before(grammarAccess.getRuleAccess().getDescriptionSTRINGTerminalRuleCall_1_0()); }
	RULE_STRING{ after(grammarAccess.getRuleAccess().getDescriptionSTRINGTerminalRuleCall_1_0()); }
)
...
{ before(grammarAccess.getRuleAccess().getDeviceStateStateQualifiedNameParserRuleCall_3_0_1()); }
	ruleQualifiedName{ after(grammarAccess.getRuleAccess().getDeviceStateStateQualifiedNameParserRuleCall_3_0_1()); }
)
...
{ before(grammarAccess.getRuleAccess().getThenPartXBlockExpressionParserRuleCall_5_0()); }
	ruleXBlockExpression{ after(grammarAccess.getRuleAccess().getThenPartXBlockExpressionParserRuleCall_5_0()); }
)
