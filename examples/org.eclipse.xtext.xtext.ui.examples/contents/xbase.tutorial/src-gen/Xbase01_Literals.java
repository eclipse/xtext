...
public class Xbase01_Literals {
  public static void main(final String[] args) {
    try {
      /*null*/;/*"Hello World"*/;/*42*/;/*0.42e2*/;/*true*/;/*false*/;/*java.lang.String.class*/;
        ...
        CollectionLiterals.<Integer, String>newHashMap(_operator_mappedTo, _operator_mappedTo_1, _operator_mappedTo_2);/*new BigInteger("beefbeefbeefbeefbeef", 16)*/;/*new BigDecimal("0.123456789123456789123456789123456789e4242")*/;
    } catch (Throwable t) {}
  }
}
