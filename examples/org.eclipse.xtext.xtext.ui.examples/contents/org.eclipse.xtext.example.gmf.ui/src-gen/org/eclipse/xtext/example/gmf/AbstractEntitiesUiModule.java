...
/**
 * Manual modifications go to {org.eclipse.xtext.example.gmf.EntitiesUiModule}
 */
public abstract class AbstractEntitiesUiModule extends EntitiesRuntimeModule {
	...
	public void configureHighlightingLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.ui.core.LexerUIBindings.HIGHLIGHTING)).to(org.eclipse.xtext.example.gmf.parser.antlr.internal.InternalEntitiesLexer.class);
	}
	...
	public Class<? extends org.eclipse.xtext.ui.common.editor.outline.transformer.ISemanticModelTransformer> bindISemanticModelTransformer() {
		return org.eclipse.xtext.example.gmf.outline.EntitiesTransformer.class;
	}
	...
	public Class<? extends org.eclipse.xtext.ui.common.editor.outline.actions.IContentOutlineNodeAdapterFactory> bindIContentOutlineNodeAdapterFactory() {
		return org.eclipse.xtext.example.gmf.outline.EntitiesOutlineNodeAdapterFactory.class;
	}
	...
	public Class<? extends org.eclipse.xtext.ui.core.editor.contentassist.IContentProposalProvider> bindIContentProposalProvider() {
		return org.eclipse.xtext.example.gmf.contentassist.EntitiesProposalProvider.class;
	}
	...
	public void configureContentAssistLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.ui.common.editor.contentassist.antlr.internal.Lexer.class).annotatedWith(com.google.inject.name.Names.named(org.eclipse.xtext.ui.core.LexerUIBindings.CONTENT_ASSIST)).to(org.eclipse.xtext.example.gmf.contentassist.antlr.internal.InternalEntitiesLexer.class);
	}
