...
{ after(grammarAccess.getXPrimaryExpressionAccess().getXSwitchExpressionParserRuleCall_9()); }
    ...
    |(
{ before(grammarAccess.getXPrimaryExpressionAccess().getXSimpleFeatureCallParserRuleCall_10()); }
	ruleXSimpleFeatureCall
{ after(grammarAccess.getXPrimaryExpressionAccess().getXSimpleFeatureCallParserRuleCall_10()); }
)
