	...
	public EditPart createEditPart(EditPart context, Object model) {
		if (model instanceof View) {
			...
			case SimpleTypeEditPart.VISUAL_ID:
				return new SimpleTypeEditPart(view);

			case SimpleTypeNameEditPart.VISUAL_ID:
				return new SimpleTypeNameEditPart(view);

			case SimplePropertyEditPart.VISUAL_ID:
				return new SimplePropertyEditPart(view);

			case EntitySimpleNameCompartmentEditPart.VISUAL_ID:
				return new EntitySimpleNameCompartmentEditPart(view);
