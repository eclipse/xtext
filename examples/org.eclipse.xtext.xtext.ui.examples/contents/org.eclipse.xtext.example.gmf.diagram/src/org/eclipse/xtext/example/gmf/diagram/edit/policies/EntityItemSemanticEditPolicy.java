...
import org.eclipse.xtext.example.gmf.diagram.edit.commands.EntityExtendsCreateCommand;
import org.eclipse.xtext.example.gmf.diagram.edit.commands.EntityExtendsReorientCommand;
import org.eclipse.xtext.example.gmf.diagram.edit.commands.ReferenceCreateCommand;
import org.eclipse.xtext.example.gmf.diagram.edit.commands.ReferenceReorientCommand;
...
public class EntityItemSemanticEditPolicy extends
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (EntitiesVisualIDRegistry.getVisualID(incomingLink) == EntityExtendsEditPart.VISUAL_ID) {
		...
		for (Iterator it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (EntitiesVisualIDRegistry.getVisualID(outgoingLink) == EntityExtendsEditPart.VISUAL_ID) {
				DestroyReferenceRequest r = new DestroyReferenceRequest(
	...
	protected Command getReorientReferenceRelationshipCommand(
		...
		case EntityExtendsEditPart.VISUAL_ID:
			return getGEFWrapper(new EntityExtendsReorientCommand(req));
		}
