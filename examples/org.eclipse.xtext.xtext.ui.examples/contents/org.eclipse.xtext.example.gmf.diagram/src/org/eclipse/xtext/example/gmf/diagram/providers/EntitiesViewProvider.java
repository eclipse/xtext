 ...
 * @generated
 */
public class EntitiesViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = EntitiesVisualIDRegistry.getNodeVisualID(op
					.getContainerView(), domainElement);
		} else {
			visualID = EntitiesVisualIDRegistry.getVisualID(op
					.getSemanticHint());
			if (elementType != null) {
				if (!EntitiesElementTypes.isKnownElementType(elementType)
				...
				if (domainElement != null
						&& visualID != EntitiesVisualIDRegistry
		...
		return EntityEditPart.VISUAL_ID == visualID
				|| SimpleTypeEditPart.VISUAL_ID == visualID
				|| SimplePropertyEditPart.VISUAL_ID == visualID;
	}
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = EntitiesVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != EntitiesVisualIDRegistry
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			visualID = EntitiesVisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		} else {
			visualID = EntitiesVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case EntityEditPart.VISUAL_ID:
			return createEntity_1001(domainElement, containerView, index,
					persisted, preferencesHint);
		case SimpleTypeEditPart.VISUAL_ID:
			return createSimpleType_1002(domainElement, containerView, index,
					persisted, preferencesHint);
		case SimplePropertyEditPart.VISUAL_ID:
			return createSimpleProperty_2001(domainElement, containerView,
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (EntitiesVisualIDRegistry.getVisualID(elementTypeHint)) {
		case ReferenceEditPart.VISUAL_ID:
			return createReference_3001(getSemanticElement(semanticAdapter),
					containerView, index, persisted, preferencesHint);
		case EntityExtendsEditPart.VISUAL_ID:
			return createEntityExtends_3002(containerView, index, persisted,
					preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Node createEntity_1001(EObject domainElement, View containerView,
		...
		node
				.setType(EntitiesVisualIDRegistry
		...
		Node label4001 = createLabel(node, EntitiesVisualIDRegistry
				.getType(EntityNameEditPart.VISUAL_ID));
		createCompartment(node, EntitiesVisualIDRegistry
				.getType(EntitySimpleNameCompartmentEditPart.VISUAL_ID), true,
				false, true, true);
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createSimpleType_1002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EntitiesVisualIDRegistry
		...
		Node label4002 = createLabel(node, EntitiesVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createSimpleProperty_2001(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
	 ...
	 * @generated
	 */
	public Edge createReference_3001(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		...
		edge.setType(EntitiesVisualIDRegistry
		...
		Node label4003 = createLabel(edge, EntitiesVisualIDRegistry
	 ...
	 * @generated
	 */
	public Edge createEntityExtends_3002(View containerView, int index,
