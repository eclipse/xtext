...
import org.eclipse.xtext.example.gmf.diagram.edit.policies.EntitiesTextNonResizableEditPolicy;
import org.eclipse.xtext.example.gmf.diagram.edit.policies.EntitiesTextSelectionEditPolicy;
import org.eclipse.xtext.example.gmf.diagram.edit.policies.SimplePropertyItemSemanticEditPolicy;
 ...
 * @generated
 */
public class SimplePropertyEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public SimplePropertyEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new SimplePropertyItemSemanticEditPolicy());
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new EntitiesTextNonResizableEditPolicy());
			...
			parser = EntitiesParserProvider
					.getParser(
							...
							EntitiesVisualIDRegistry
									.getType(org.eclipse.xtext.example.gmf.diagram.edit.parts.SimplePropertyEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, TextDirectEditManager
					.getTextCellEditorClass(this), EntitiesEditPartFactory
	...
	protected IFigure createFigurePrim() {
		return new SimplePropertyFigure();
	}

	/**
	 * @generated
	 */
	public class SimplePropertyFigure extends WrappingLabel {

		/**
		 * @generated
		 */
		public SimplePropertyFigure() {
			this.setText("<...>");
		}
