 ...
 * @generated
 */
public class SimplePropertyCreateCommand extends EditElementCommand {

	/**
	 * @generated
	 */
	public SimplePropertyCreateCommand(CreateElementRequest req) {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor,
		...
		SimpleProperty newElement = EntitiesFactory.eINSTANCE
				.createSimpleProperty();

		Entity owner = (Entity) getElementToEdit();
		owner.getProperties().add(newElement);

		ElementInitializers.getInstance().init_SimpleProperty_2001(newElement);
	 ...
	 * @generated
	 */
	protected void doConfigure(SimpleProperty newElement,
