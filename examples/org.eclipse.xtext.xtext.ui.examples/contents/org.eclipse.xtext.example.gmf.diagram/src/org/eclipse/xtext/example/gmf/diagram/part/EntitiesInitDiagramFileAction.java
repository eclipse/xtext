 ...
 * @generated
 */
public class EntitiesInitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new EntitiesNewDiagramFileWizard(domainModelURI,
				diagramRoot, editingDomain);
		wizard.setWindowTitle(NLS.bind(Messages.InitDiagramFile_WizardTitle,
				ModelEditPart.MODEL_ID));
		EntitiesDiagramEditorUtil.runWizard(getShell(), wizard,
