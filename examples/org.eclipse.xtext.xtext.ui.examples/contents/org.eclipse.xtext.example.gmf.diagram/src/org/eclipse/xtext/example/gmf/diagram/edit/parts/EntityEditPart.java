...
import org.eclipse.xtext.example.gmf.diagram.edit.policies.EntityItemSemanticEditPolicy;
...
public class EntityEditPart extends ShapeNodeEditPart {
			...
			protected EditPolicy createChildEditPolicy(EditPart child) {
				if (child.getEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE) == null) {
					if (child instanceof ITextAwareEditPart) {
						return new EntitiesTextSelectionEditPolicy();
					}
				}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof EntitySimpleNameCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureSimplePropertyCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((EntitySimpleNameCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof EntitySimpleNameCompartmentEditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureSimplePropertyCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.remove(((EntitySimpleNameCompartmentEditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof EntitySimpleNameCompartmentEditPart) {
			return getPrimaryShape().getFigureSimplePropertyCompartmentFigure();
		}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(EntitiesVisualIDRegistry
	...
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == EntitiesElementTypes.SimpleProperty_2001) {
				return getChildBySemanticHint(EntitiesVisualIDRegistry
						.getType(EntitySimpleNameCompartmentEditPart.VISUAL_ID));
			}
		}
	...
	public class EntityFigure extends RectangleFigure {
		 ...
		 * @generated
		 */
		private RectangleFigure fFigureSimplePropertyCompartmentFigure;
		...
		private void createContents() {
			...
			fFigureSimplePropertyCompartmentFigure = new RectangleFigure();
			fFigureSimplePropertyCompartmentFigure.setOutline(false);
			fFigureSimplePropertyCompartmentFigure.setLineWidth(1);

			this.add(fFigureSimplePropertyCompartmentFigure);
		 ...
		 * @generated
		 */
		public RectangleFigure getFigureSimplePropertyCompartmentFigure() {
			return fFigureSimplePropertyCompartmentFigure;
		}
