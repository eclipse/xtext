 ...
 * @generated
 */
public class EntitiesBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	 ...
	 * @generated
	 */
	protected EntitiesBaseItemSemanticEditPolicy(IElementType elementType) {
	...
	private Command getEditHelperCommand(IEditCommandRequest request,
		...
		request.setParameter(EntitiesBaseEditHelper.CONTEXT_ELEMENT_TYPE,
				requestContextElementType);
		ICommand command = requestContextElementType.getEditCommand(request);
		request.setParameter(EntitiesBaseEditHelper.EDIT_POLICY_COMMAND, null);
		request.setParameter(EntitiesBaseEditHelper.CONTEXT_ELEMENT_TYPE, null);
		if (command != null) {
	...
	private IElementType getContextElementType(IEditCommandRequest request) {
		IElementType requestContextElementType = EntitiesElementTypes
	...
	public static class LinkConstraints {
		...
		public static boolean canCreateEntityExtends_3002(Entity source,
			...
			return canExistEntityExtends_3002(source, target);
		}
