 ...
 * @generated
 */
public class EntityExtendsReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public EntityExtendsReorientCommand(
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setExtends(null);
		getNewSource().setExtends(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setExtends(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
