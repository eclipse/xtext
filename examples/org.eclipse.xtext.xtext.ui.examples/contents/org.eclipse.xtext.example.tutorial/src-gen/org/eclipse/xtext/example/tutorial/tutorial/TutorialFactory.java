...
public interface TutorialFactory extends EFactory
{
  ...
  /**
   * Returns a new object of class '<em>Domain Model Tutorial</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Domain Model Tutorial</em>'.
   * @generated
   */
  DomainModelTutorial createDomainModelTutorial();
