...
public class RuleEngineStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new org.eclipse.xtext.example.homeautomation.RuleEngineRuntimeModule());
	}
	
	public void register(Injector injector) {
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.eclipse.org/Xtext/example/RuleEngine")) {
		EPackage.Registry.INSTANCE.put("http://www.eclipse.org/Xtext/example/RuleEngine", org.eclipse.xtext.example.homeautomation.ruleEngine.RuleEnginePackage.eINSTANCE);
	}
