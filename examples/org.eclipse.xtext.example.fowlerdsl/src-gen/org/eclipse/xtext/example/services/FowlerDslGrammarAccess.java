...
public class FowlerDslGrammarAccess extends BaseEPackageAccess implements IGrammarAccess {
	...
	private static final String FOWLERDSL_GRAMMAR_CP_URI = "classpath:/org/eclipse/xtext/example/FowlerDsl.xmi";
	...
	public ParserRule pr_Statemachine() {
		return (ParserRule) getGrammar().eResource().getResourceSet().getEObject(URI.createURI("classpath:/org/eclipse/xtext/example/FowlerDsl.xmi#//@rules.0"),true); 
	}

	public ParserRule pr_Event() {
		return (ParserRule) getGrammar().eResource().getResourceSet().getEObject(URI.createURI("classpath:/org/eclipse/xtext/example/FowlerDsl.xmi#//@rules.1"),true); 
	}

	public ParserRule pr_Command() {
		return (ParserRule) getGrammar().eResource().getResourceSet().getEObject(URI.createURI("classpath:/org/eclipse/xtext/example/FowlerDsl.xmi#//@rules.2"),true); 
	}

	public ParserRule pr_State() {
		return (ParserRule) getGrammar().eResource().getResourceSet().getEObject(URI.createURI("classpath:/org/eclipse/xtext/example/FowlerDsl.xmi#//@rules.3"),true); 
	}

	public ParserRule pr_Transition() {
		return (ParserRule) getGrammar().eResource().getResourceSet().getEObject(URI.createURI("classpath:/org/eclipse/xtext/example/FowlerDsl.xmi#//@rules.4"),true); 
	}
