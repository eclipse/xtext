...
public final class DomainmodelDataTypeConsumer extends NonTerminalConsumer {
	...
	public DomainmodelDataTypeConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	// DomainmodelGrammarAccess.INSTANCE.prDataType()
		return rule;
	}
