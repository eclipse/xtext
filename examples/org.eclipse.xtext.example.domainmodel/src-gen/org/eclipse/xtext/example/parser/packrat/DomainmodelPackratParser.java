...
public class DomainmodelPackratParser extends AbstractPackratParser {
	...
	@Override
	protected org.eclipse.xtext.example.parser.packrat.DomainmodelParserConfiguration createParserConfiguration(IInternalParserConfiguration configuration) {
		return new org.eclipse.xtext.example.parser.packrat.DomainmodelParserConfiguration(configuration, getGrammarAccess());
	}
