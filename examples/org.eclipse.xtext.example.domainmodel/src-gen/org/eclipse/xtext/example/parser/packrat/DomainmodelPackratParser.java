...
public class DomainmodelPackratParser extends AbstractPackratParser {
	...
	@Override
	protected DomainmodelParserConfiguration createParserConfiguration(ICharSequenceWithOffset input,
		...
		return new DomainmodelParserConfiguration(input, markerFactory, tokenAcceptor, hiddenTokenHandler, consumerUtil);
	}
