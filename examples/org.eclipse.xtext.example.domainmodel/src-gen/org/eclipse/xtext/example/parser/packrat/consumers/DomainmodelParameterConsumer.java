...
public final class DomainmodelParameterConsumer extends NonTerminalConsumer {
	...
	public void setRule(ParameterElements rule) {
		...
		assignment$4$Consumer = new Assignment$4$Consumer(rule.getTypeAssignment_1());
		ruleCall$5$Consumer = new RuleCall$5$Consumer(rule.getTypeTypeRefParserRuleCall_1_0());
	}
