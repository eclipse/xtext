...
public final class DomainmodelImportConsumer extends NonTerminalConsumer {
	...
	public DomainmodelImportConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	// DomainmodelGrammarAccess.INSTANCE.prImport()
		return rule;
	}
