...
public final class DomainmodelTypeConsumer extends NonTerminalConsumer {
	...
	public void setRule(TypeElements rule) {
		...
		ruleCall$2$Consumer = new RuleCall$2$Consumer(rule.getEntityParserRuleCall_0());
		ruleCall$3$Consumer = new RuleCall$3$Consumer(rule.getDataTypeParserRuleCall_1());
	}
