...
public class DomainmodelParserConfiguration extends AbstractParserConfiguration {
	...
	public void configureConsumers() {
		...
		getPackageConsumer().setKeyword$5$Delimiter(org.eclipse.xtext.example.parser.packrat.DomainmodelDelimiters.keyword$12$Delimiter);
		getPackageConsumer().setKeyword$8$Delimiter(org.eclipse.xtext.example.parser.packrat.DomainmodelDelimiters.keyword$29$Delimiter);
		getPackageConsumer().setKeyword$11$Delimiter(org.eclipse.xtext.example.parser.packrat.DomainmodelDelimiters.keyword$29$Delimiter);
		...
		getDataTypeConsumer().setRuleCall$4$Delimiter(org.eclipse.xtext.example.parser.packrat.DomainmodelDelimiters.ruleCall$43$Delimiter);
		getEntityConsumer().setCrossReference$12$Delimiter(org.eclipse.xtext.example.parser.packrat.DomainmodelDelimiters.ruleCall$43$Delimiter);
		...
		getEntityConsumer().setKeyword$10$Delimiter(org.eclipse.xtext.example.parser.packrat.DomainmodelDelimiters.keyword$12$Delimiter);
		getEntityConsumer().setKeyword$14$Delimiter(org.eclipse.xtext.example.parser.packrat.DomainmodelDelimiters.keyword$29$Delimiter);
		getEntityConsumer().setKeyword$17$Delimiter(org.eclipse.xtext.example.parser.packrat.DomainmodelDelimiters.keyword$29$Delimiter);
		getEntityConsumer().setRuleCall$8$Delimiter(org.eclipse.xtext.example.parser.packrat.DomainmodelDelimiters.ruleCall$43$Delimiter);
		getAttributeConsumer().setKeyword$4$Delimiter(org.eclipse.xtext.example.parser.packrat.DomainmodelDelimiters.keyword$12$Delimiter);
		getAttributeConsumer().setKeyword$7$Delimiter(org.eclipse.xtext.example.parser.packrat.DomainmodelDelimiters.keyword$29$Delimiter);
		getAttributeConsumer().setRuleCall$6$Delimiter(org.eclipse.xtext.example.parser.packrat.DomainmodelDelimiters.ruleCall$43$Delimiter);
		getReferenceConsumer().setCrossReference$14$Delimiter(org.eclipse.xtext.example.parser.packrat.DomainmodelDelimiters.ruleCall$43$Delimiter);
		getReferenceConsumer().setKeyword$5$Delimiter(org.eclipse.xtext.example.parser.packrat.DomainmodelDelimiters.keyword$12$Delimiter);
		getReferenceConsumer().setKeyword$8$Delimiter(org.eclipse.xtext.example.parser.packrat.DomainmodelDelimiters.keyword$29$Delimiter);
		getReferenceConsumer().setKeyword$12$Delimiter(org.eclipse.xtext.example.parser.packrat.DomainmodelDelimiters.keyword$12$Delimiter);
		getReferenceConsumer().setRuleCall$7$Delimiter(org.eclipse.xtext.example.parser.packrat.DomainmodelDelimiters.ruleCall$43$Delimiter);
		getOperationConsumer().setKeyword$7$Delimiter(org.eclipse.xtext.example.parser.packrat.DomainmodelDelimiters.keyword$12$Delimiter);
		getOperationConsumer().setKeyword$10$Delimiter(org.eclipse.xtext.example.parser.packrat.DomainmodelDelimiters.keyword$29$Delimiter);
		getOperationConsumer().setKeyword$15$Delimiter(org.eclipse.xtext.example.parser.packrat.DomainmodelDelimiters.keyword$29$Delimiter);
		getOperationConsumer().setKeyword$18$Delimiter(org.eclipse.xtext.example.parser.packrat.DomainmodelDelimiters.keyword$29$Delimiter);
		getOperationConsumer().setKeyword$19$Delimiter(org.eclipse.xtext.example.parser.packrat.DomainmodelDelimiters.keyword$29$Delimiter);
		getOperationConsumer().setRuleCall$9$Delimiter(org.eclipse.xtext.example.parser.packrat.DomainmodelDelimiters.ruleCall$43$Delimiter);
		getParameterConsumer().setRuleCall$3$Delimiter(org.eclipse.xtext.example.parser.packrat.DomainmodelDelimiters.ruleCall$43$Delimiter);
		getTypeRefConsumer().setCrossReference$2$Delimiter(org.eclipse.xtext.example.parser.packrat.DomainmodelDelimiters.ruleCall$43$Delimiter);
		getQualifiedNameConsumer().setKeyword$4$Delimiter(org.eclipse.xtext.example.parser.packrat.DomainmodelDelimiters.keyword$29$Delimiter);
		getQualifiedNameConsumer().setRuleCall$2$Delimiter(org.eclipse.xtext.example.parser.packrat.DomainmodelDelimiters.ruleCall$43$Delimiter);
