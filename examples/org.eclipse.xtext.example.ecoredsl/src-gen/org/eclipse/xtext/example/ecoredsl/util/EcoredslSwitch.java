 ...
 * </copyright>
 *
 * $Id: EcoredslSwitch.java,v 1.3 2009/02/19 08:18:41 sefftinge Exp $
 */
...
public class EcoredslSwitch<T>
{
   ...
   * @generated
   */
  protected static EcoredslPackage modelPackage;
   ...
   * @generated
   */
  public EcoredslSwitch()
  {
    if (modelPackage == null)
    {
      modelPackage = EcoredslPackage.eINSTANCE;
    }
  }
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      case EcoredslPackage.ECORE_DSL:
      {
        EcoreDsl ecoreDsl = (EcoreDsl)theEObject;
        T result = caseEcoreDsl(ecoreDsl);
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Ecore Dsl</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Ecore Dsl</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseEcoreDsl(EcoreDsl object)
  {
    return null;
  }
