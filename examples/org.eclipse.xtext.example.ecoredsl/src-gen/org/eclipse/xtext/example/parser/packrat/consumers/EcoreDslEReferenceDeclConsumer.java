...
public final class EcoreDslEReferenceDeclConsumer extends NonTerminalConsumer {
	...
	protected int consumeAssignment$17(int entryPoint) throws Exception {
		...
		int tempResult;
		announceNextLevel();
		tempResult = consumeKeyword(getRule().ele000000100000000KeywordLocal(), "resolveProxies", false, true, getKeyword$18$Delimiter()); 
		if (tempResult == ConsumeResult.SUCCESS) {
			announceLevelFinished();
			return tempResult;
		}
	...
	protected int consumeAssignment$19(int entryPoint) throws Exception {
		...
		int tempResult;
		announceNextLevel();
		tempResult = consumeKeyword(getRule().ele000000100000010KeywordBag(), "unique", false, true, getKeyword$20$Delimiter()); 
		if (tempResult == ConsumeResult.SUCCESS) {
			announceLevelFinished();
			return tempResult;
		}
	...
	protected int consumeAssignment$21(int entryPoint) throws Exception {
		...
		int tempResult;
		announceNextLevel();
		tempResult = consumeKeyword(getRule().ele00000010000010KeywordRandom(), "ordered", false, true, getKeyword$22$Delimiter()); 
		if (tempResult == ConsumeResult.SUCCESS) {
			announceLevelFinished();
			return tempResult;
		}
	...
	protected int consumeAssignment$23(int entryPoint) throws Exception {
		...
		int tempResult;
		announceNextLevel();
		tempResult = consumeKeyword(getRule().ele0000001000010KeywordReadonly(), "changeable", false, true, getKeyword$24$Delimiter()); 
		if (tempResult == ConsumeResult.SUCCESS) {
			announceLevelFinished();
			return tempResult;
		}
	...
	protected int consumeAssignment$25(int entryPoint) throws Exception {
		...
		int tempResult;
		announceNextLevel();
		tempResult = consumeKeyword(getRule().ele000000100010KeywordVolatile(), "volatile", false, true, getKeyword$26$Delimiter()); 
		if (tempResult == ConsumeResult.SUCCESS) {
			announceLevelFinished();
			return tempResult;
		}
	...
	protected int consumeAssignment$27(int entryPoint) throws Exception {
		...
		int tempResult;
		announceNextLevel();
		tempResult = consumeKeyword(getRule().ele00000010010KeywordTransient(), "transient", false, true, getKeyword$28$Delimiter()); 
		if (tempResult == ConsumeResult.SUCCESS) {
			announceLevelFinished();
			return tempResult;
		}
	...
	protected int consumeAssignment$29(int entryPoint) throws Exception {
		...
		int tempResult;
		announceNextLevel();
		tempResult = consumeKeyword(getRule().ele0000001010KeywordUnsettable(), "unsettable", false, true, getKeyword$30$Delimiter()); 
		if (tempResult == ConsumeResult.SUCCESS) {
			announceLevelFinished();
			return tempResult;
		}
	...
	protected int consumeAssignment$31(int entryPoint) throws Exception {
		...
		int tempResult;
		announceNextLevel();
		tempResult = consumeKeyword(getRule().ele000000110KeywordDerived(), "derived", false, true, getKeyword$32$Delimiter()); 
		if (tempResult == ConsumeResult.SUCCESS) {
			announceLevelFinished();
			return tempResult;
		}
	...
	protected int consumeAssignment$34(int entryPoint) throws Exception {
		...
		int tempResult;
		announceNextLevel();
		tempResult = consumeKeyword(getRule().ele00000100KeywordVal(), "containment", false, true, getKeyword$35$Delimiter()); 
		if (tempResult == ConsumeResult.SUCCESS) {
			announceLevelFinished();
			return tempResult;
		}
	...
	protected int consumeAssignment$43(int entryPoint) throws Exception {
		...
		int tempResult;
		announceNextLevel();
		tempResult = consumeTerminal(intConsumer, "lowerBound", false, false, getRule().ele00010010LexerRuleCallINT(), getRuleCall$44$Delimiter());
		if (tempResult == ConsumeResult.SUCCESS) {
			announceLevelFinished();
			return tempResult;
		}
	...
	protected int consumeAssignment$52(int entryPoint) throws Exception {
		...
		int tempResult;
		announceNextLevel();
		tempResult = consumeTerminal(idConsumer, "eOpposite", false, false, getRule().ele00110CrossReferenceEStringEReference(), getCrossReference$53$Delimiter());
		if (tempResult == ConsumeResult.SUCCESS) {
			announceLevelFinished();
			return tempResult;
		}
	...
	protected int consumeAssignment$55(int entryPoint) throws Exception {
		...
		int tempResult;
		announceNextLevel();
		tempResult = consumeTerminal(idConsumer, "name", false, false, getRule().ele010LexerRuleCallID(), getRuleCall$56$Delimiter());
		if (tempResult == ConsumeResult.SUCCESS) {
			announceLevelFinished();
			return tempResult;
		}
	...
	public EReferenceDeclElements getRule() {
		return EcoreDslGrammarAccess.INSTANCE.prEReferenceDecl();
	}
	...
	public void setSintConsumer(EcoreDslSINTConsumer sintConsumer) {
