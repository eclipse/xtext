...
public final class EcoreDslEAttributeDeclConsumer extends NonTerminalConsumer {
	...
	public void setRule(EAttributeDeclElements rule) {
		...
		assignment$5$Consumer = new Assignment$5$Consumer(rule.getIDAssignment_1_0());
		keyword$6$Consumer = new Keyword$6$Consumer(rule.getIDIDKeyword_1_0_0());
		...
		keyword$21$Consumer = new Keyword$21$Consumer(rule.getAttrKeyword_2());
		assignment$22$Consumer = new Assignment$22$Consumer(rule.getEGenericTypeAssignment_3());
		ruleCall$23$Consumer = new RuleCall$23$Consumer(rule.getEGenericTypeEGenericTypeReferenceDeclParserRuleCall_3_0());
		group$24$Consumer = new Group$24$Consumer(rule.getGroup_4());
		keyword$25$Consumer = new Keyword$25$Consumer(rule.getLeftSquareBracketKeyword_4_0());
		assignment$26$Consumer = new Assignment$26$Consumer(rule.getLowerBoundAssignment_4_1());
		ruleCall$27$Consumer = new RuleCall$27$Consumer(rule.getLowerBoundINTTerminalRuleCall_4_1_0());
		group$28$Consumer = new Group$28$Consumer(rule.getGroup_4_2());
		keyword$29$Consumer = new Keyword$29$Consumer(rule.getFullStopFullStopKeyword_4_2_0());
		assignment$30$Consumer = new Assignment$30$Consumer(rule.getUpperBoundAssignment_4_2_1());
		ruleCall$31$Consumer = new RuleCall$31$Consumer(rule.getUpperBoundSINTParserRuleCall_4_2_1_0());
		keyword$32$Consumer = new Keyword$32$Consumer(rule.getRightSquareBracketKeyword_4_3());
		assignment$33$Consumer = new Assignment$33$Consumer(rule.getNameAssignment_5());
		ruleCall$34$Consumer = new RuleCall$34$Consumer(rule.getNameIDTerminalRuleCall_5_0());
		group$35$Consumer = new Group$35$Consumer(rule.getGroup_6());
		keyword$36$Consumer = new Keyword$36$Consumer(rule.getEqualsSignKeyword_6_0());
		assignment$37$Consumer = new Assignment$37$Consumer(rule.getDefaultValueLiteralAssignment_6_1());
		ruleCall$38$Consumer = new RuleCall$38$Consumer(rule.getDefaultValueLiteralSTRINGTerminalRuleCall_6_1_0());
		keyword$39$Consumer = new Keyword$39$Consumer(rule.getSemicolonKeyword_7());
	}
