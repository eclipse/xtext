...
public interface IEcoreDsl extends ILanguage {
	 ...
	 */
	public static final String ID = "org.eclipse.xtext.example.EcoreDsl";
	public static final String NAME = "EcoreDsl";
	public static final String NAMESPACE = "org.eclipse.xtext.example";
	public static final String[] FILE_EXTENSIONS = new String[]{"ecoredsl"};
