 ...
 *******************************************************************************/
package org.eclipse.xtext.ui.tests.quickfix.tests;
...
public class QuickfixCrossrefTestLanguageInjectorProvider implements IInjectorProvider, IRegistryConfigurator {
	...
	protected Injector internalCreateInjector() {
		return new QuickfixCrossrefTestLanguageStandaloneSetup() {
			@Override
	...
	protected QuickfixCrossrefTestLanguageRuntimeModule createRuntimeModule() {
		...
		return new QuickfixCrossrefTestLanguageRuntimeModule() {
			...
			public ClassLoader bindClassLoaderToInstance() {
				return QuickfixCrossrefTestLanguageInjectorProvider.this.getClass()
						.getClassLoader();
			}
		};
	}
