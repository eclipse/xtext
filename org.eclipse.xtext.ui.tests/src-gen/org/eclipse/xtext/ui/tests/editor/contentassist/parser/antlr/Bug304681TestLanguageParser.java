...
import org.eclipse.xtext.ui.tests.editor.contentassist.parser.antlr.internal.InternalBug304681TestLanguageParser;
import org.eclipse.xtext.ui.tests.editor.contentassist.services.Bug304681TestLanguageGrammarAccess;

public class Bug304681TestLanguageParser extends AbstractAntlrParser {
	...
	@Override
	protected InternalBug304681TestLanguageParser createParser(XtextTokenStream stream) {
		return new InternalBug304681TestLanguageParser(stream, getGrammarAccess());
	}
