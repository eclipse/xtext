...
public class TypeDescriptionImpl extends MinimalEObjectImpl.Container implements TypeDescription
{
  ...
  {
    return Bug332217TestLanguagePackage.Literals.TYPE_DESCRIPTION;
  }
  ...
  public void setType(String newType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Bug332217TestLanguagePackage.TYPE_DESCRIPTION__TYPE, oldType, type));
  }
  ...
  public void setMany(boolean newMany)
  {
    ...
    many = newMany;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Bug332217TestLanguagePackage.TYPE_DESCRIPTION__MANY, oldMany, many));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case Bug332217TestLanguagePackage.TYPE_DESCRIPTION__TYPE:
        return getType();
      case Bug332217TestLanguagePackage.TYPE_DESCRIPTION__MANY:
        return isMany();
    }
