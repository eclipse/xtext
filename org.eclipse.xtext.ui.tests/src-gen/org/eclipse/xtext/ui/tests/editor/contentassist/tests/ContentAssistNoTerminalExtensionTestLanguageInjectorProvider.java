...
public class ContentAssistNoTerminalExtensionTestLanguageInjectorProvider implements IInjectorProvider, IRegistryConfigurator {
	...
	protected Injector internalCreateInjector() {
		return new ContentAssistNoTerminalExtensionTestLanguageStandaloneSetup() {
			@Override
	...
	protected ContentAssistNoTerminalExtensionTestLanguageRuntimeModule createRuntimeModule() {
		...
		return new ContentAssistNoTerminalExtensionTestLanguageRuntimeModule() {
			...
			public ClassLoader bindClassLoaderToInstance() {
				return ContentAssistNoTerminalExtensionTestLanguageInjectorProvider.this.getClass()
						.getClassLoader();
			}
		};
	}
