...
public class LookAheadContentAssistTestLanguageInjectorProvider implements IInjectorProvider, IRegistryConfigurator {
	...
	protected LookAheadContentAssistTestLanguageRuntimeModule createRuntimeModule() {
		...
		return new LookAheadContentAssistTestLanguageRuntimeModule() {
			...
			public ClassLoader bindClassLoaderToInstance() {
				return LookAheadContentAssistTestLanguageInjectorProvider.this.getClass()
						.getClassLoader();
			}
		};
	}
