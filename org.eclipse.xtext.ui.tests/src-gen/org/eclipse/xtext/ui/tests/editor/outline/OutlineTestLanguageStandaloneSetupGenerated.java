...
public class OutlineTestLanguageStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new OutlineTestLanguageRuntimeModule());
	}
	
	public void register(Injector injector) {
		if (!EPackage.Registry.INSTANCE.containsKey("http://www.eclipse.org/2010/tmf/xtext/outline/OutlineTest")) {
			EPackage.Registry.INSTANCE.put("http://www.eclipse.org/2010/tmf/xtext/outline/OutlineTest", OutlineTestPackage.eINSTANCE);
		}
		...
		IResourceServiceProvider.Registry.INSTANCE.getExtensionToFactoryMap().put("outlinetestlanguage", serviceProvider);
	}
}
