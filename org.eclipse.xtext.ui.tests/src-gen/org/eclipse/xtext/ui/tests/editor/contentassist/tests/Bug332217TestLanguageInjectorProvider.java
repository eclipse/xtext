...
public class Bug332217TestLanguageInjectorProvider implements IInjectorProvider, IRegistryConfigurator {
	...
	protected Bug332217TestLanguageRuntimeModule createRuntimeModule() {
		...
		return new Bug332217TestLanguageRuntimeModule() {
			...
			public ClassLoader bindClassLoaderToInstance() {
				return Bug332217TestLanguageInjectorProvider.this.getClass()
						.getClassLoader();
			}
		};
	}
