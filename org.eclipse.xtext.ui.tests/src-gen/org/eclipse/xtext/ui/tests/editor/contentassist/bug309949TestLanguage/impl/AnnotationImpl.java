...
public class AnnotationImpl extends MinimalEObjectImpl.Container implements Annotation
{
  ...
  {
    return Bug309949TestLanguagePackage.Literals.ANNOTATION;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Bug309949TestLanguagePackage.ANNOTATION__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case Bug309949TestLanguagePackage.ANNOTATION__NAME:
        return getName();
    }
