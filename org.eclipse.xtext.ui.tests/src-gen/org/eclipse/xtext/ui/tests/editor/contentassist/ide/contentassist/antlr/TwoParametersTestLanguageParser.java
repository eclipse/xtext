...
public class TwoParametersTestLanguageParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(Map<AbstractElement, String> mappings, TwoParametersTestLanguageGrammarAccess grammarAccess) {
			...
			mappings.put(grammarAccess.getScenario8Access().getAlternatives(), "rule__Scenario8__Alternatives");
			mappings.put(grammarAccess.getScenario10Access().getAlternatives(), "rule__Scenario10__Alternatives");
			mappings.put(grammarAccess.getIdOrKeyword2Access().getAlternatives(), "rule__IdOrKeyword2__Alternatives");
			...
			mappings.put(grammarAccess.getScenario9Access().getGroup(), "rule__Scenario9__Group__0");
			mappings.put(grammarAccess.getScenario10Access().getGroup_1(), "rule__Scenario10__Group_1__0");
			mappings.put(grammarAccess.getScenario10Access().getGroup_2(), "rule__Scenario10__Group_2__0");
			mappings.put(grammarAccess.getScenario10Access().getGroup_3(), "rule__Scenario10__Group_3__0");
			mappings.put(grammarAccess.getScenario10Access().getGroup_0(), "rule__Scenario10__Group_0__0");
			...
			mappings.put(grammarAccess.getScenario6Access().getSecondAssignment_1_0(), "rule__Scenario6__SecondAssignment_1_0");
			mappings.put(grammarAccess.getScenario6Access().getFirstAssignment_0_0(), "rule__Scenario6__FirstAssignment_0_0");
			mappings.put(grammarAccess.getScenario7Access().getFirstAssignment(), "rule__Scenario7__FirstAssignment");
			mappings.put(grammarAccess.getScenario8Access().getFirstAssignment_0(), "rule__Scenario8__FirstAssignment_0");
			mappings.put(grammarAccess.getScenario8Access().getSecondAssignment_1(), "rule__Scenario8__SecondAssignment_1");
			mappings.put(grammarAccess.getScenario9Access().getSecondAssignment_0(), "rule__Scenario9__SecondAssignment_0");
			mappings.put(grammarAccess.getScenario10Access().getFirstAssignment_2_3(), "rule__Scenario10__FirstAssignment_2_3");
			mappings.put(grammarAccess.getScenario10Access().getSecondAssignment_2_4(), "rule__Scenario10__SecondAssignment_2_4");
