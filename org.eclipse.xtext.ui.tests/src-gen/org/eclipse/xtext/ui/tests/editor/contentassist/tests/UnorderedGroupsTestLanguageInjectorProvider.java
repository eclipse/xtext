...
public class UnorderedGroupsTestLanguageInjectorProvider implements IInjectorProvider, IRegistryConfigurator {
	...
	protected UnorderedGroupsTestLanguageRuntimeModule createRuntimeModule() {
		...
		return new UnorderedGroupsTestLanguageRuntimeModule() {
			...
			public ClassLoader bindClassLoaderToInstance() {
				return UnorderedGroupsTestLanguageInjectorProvider.this.getClass()
						.getClassLoader();
			}
		};
	}
