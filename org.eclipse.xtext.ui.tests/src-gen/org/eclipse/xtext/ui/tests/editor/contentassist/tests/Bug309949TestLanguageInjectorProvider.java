...
public class Bug309949TestLanguageInjectorProvider implements IInjectorProvider, IRegistryConfigurator {
	...
	protected Bug309949TestLanguageRuntimeModule createRuntimeModule() {
		...
		return new Bug309949TestLanguageRuntimeModule() {
			...
			public ClassLoader bindClassLoaderToInstance() {
				return Bug309949TestLanguageInjectorProvider.this.getClass()
						.getClassLoader();
			}
		};
	}
