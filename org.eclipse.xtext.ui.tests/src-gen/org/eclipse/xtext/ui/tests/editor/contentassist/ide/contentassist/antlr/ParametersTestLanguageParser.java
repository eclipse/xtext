...
public class ParametersTestLanguageParser extends AbstractContentAssistParser {
	...
	@Override
	protected InternalParametersTestLanguageParser createParser() {
		InternalParametersTestLanguageParser result = new InternalParametersTestLanguageParser(null);
