...
public class Bug360834TestLanguageInjectorProvider implements IInjectorProvider, IRegistryConfigurator {
	...
	protected Bug360834TestLanguageRuntimeModule createRuntimeModule() {
		...
		return new Bug360834TestLanguageRuntimeModule() {
			...
			public ClassLoader bindClassLoaderToInstance() {
				return Bug360834TestLanguageInjectorProvider.this.getClass()
						.getClassLoader();
			}
		};
	}
