...
public class Bug348199TestLanguageInjectorProvider implements IInjectorProvider, IRegistryConfigurator {
	...
	protected Bug348199TestLanguageRuntimeModule createRuntimeModule() {
		...
		return new Bug348199TestLanguageRuntimeModule() {
			...
			public ClassLoader bindClassLoaderToInstance() {
				return Bug348199TestLanguageInjectorProvider.this.getClass()
						.getClassLoader();
			}
		};
	}
