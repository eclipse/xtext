...
public class InternalBug347012TestLanguageLexer extends Lexer {
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBug347012TestLanguage.g:2207:9: ( RULE_IDPLAINCHAR ( RULE_IDPLAINCHAR | RULE_DIGIT )* )
            // InternalBug347012TestLanguage.g:2207:11: RULE_IDPLAINCHAR ( RULE_IDPLAINCHAR | RULE_DIGIT )*
            {
            mRULE_IDPLAINCHAR(); 
            // InternalBug347012TestLanguage.g:2207:28: ( RULE_IDPLAINCHAR | RULE_DIGIT )*
            loop1:
            do {
                int alt1=2;
    ...
    public final void mRULE_LT() throws RecognitionException {
        try {
            int _type = RULE_LT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBug347012TestLanguage.g:2209:9: ( ( '\\r' '\\n' | '\\r' | '\\n' ) )
            // InternalBug347012TestLanguage.g:2209:11: ( '\\r' '\\n' | '\\r' | '\\n' )
            {
            // InternalBug347012TestLanguage.g:2209:11: ( '\\r' '\\n' | '\\r' | '\\n' )
            int alt2=3;
            ...
            switch (alt2) {
                case 1 :
                    // InternalBug347012TestLanguage.g:2209:12: '\\r' '\\n'
                    {
                    match('\r'); 
                    match('\n'); 
                    ...
                    break;
                case 2 :
                    // InternalBug347012TestLanguage.g:2209:22: '\\r'
                    {
                    match('\r'); 
                    ...
                    break;
                case 3 :
                    // InternalBug347012TestLanguage.g:2209:27: '\\n'
                    {
                    match('\n'); 
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBug347012TestLanguage.g:2211:9: ( ( ' ' | '\\t' )+ )
            // InternalBug347012TestLanguage.g:2211:11: ( ' ' | '\\t' )+
            {
            // InternalBug347012TestLanguage.g:2211:11: ( ' ' | '\\t' )+
            int cnt3=0;
            loop3:
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBug347012TestLanguage.g:2213:13: ( '\"' ( '\\\\' RULE_ESCAPE | ~ ( ( '\\\\' | '\"' ) ) )* '\"' )
            // InternalBug347012TestLanguage.g:2213:15: '\"' ( '\\\\' RULE_ESCAPE | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
            {
            match('\"'); 
            // InternalBug347012TestLanguage.g:2213:19: ( '\\\\' RULE_ESCAPE | ~ ( ( '\\\\' | '\"' ) ) )*
            loop4:
            do {
                int alt4=3;
                ...
                switch (alt4) {
            	case 1 :
            	    // InternalBug347012TestLanguage.g:2213:20: '\\\\' RULE_ESCAPE
            	    {
            	    match('\\'); 
            	    mRULE_ESCAPE(); 
            	    ...
            	    break;
            	case 2 :
            	    // InternalBug347012TestLanguage.g:2213:37: ~ ( ( '\\\\' | '\"' ) )
            	    {
    ...
    public final void mRULE_NUMBER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalBug347012TestLanguage.g:2215:13: ( ( ( RULE_DIGIT )+ ( '.' ( RULE_DIGIT )+ )? | '.' ( RULE_DIGIT )+ ) )
            // InternalBug347012TestLanguage.g:2215:15: ( ( RULE_DIGIT )+ ( '.' ( RULE_DIGIT )+ )? | '.' ( RULE_DIGIT )+ )
            {
            // InternalBug347012TestLanguage.g:2215:15: ( ( RULE_DIGIT )+ ( '.' ( RULE_DIGIT )+ )? | '.' ( RULE_DIGIT )+ )
            int alt9=2;
            ...
            switch (alt9) {
                case 1 :
                    // InternalBug347012TestLanguage.g:2215:16: ( RULE_DIGIT )+ ( '.' ( RULE_DIGIT )+ )?
                    {
                    // InternalBug347012TestLanguage.g:2215:16: ( RULE_DIGIT )+
                    int cnt5=0;
                    loop5:
                    do {
                        int alt5=2;
                    ...
                    // InternalBug347012TestLanguage.g:2215:28: ( '.' ( RULE_DIGIT )+ )?
                    int alt7=2;
                    ...
                    switch (alt7) {
                        case 1 :
                            // InternalBug347012TestLanguage.g:2215:29: '.' ( RULE_DIGIT )+
                            {
                            match('.'); 
                            // InternalBug347012TestLanguage.g:2215:33: ( RULE_DIGIT )+
                            int cnt6=0;
                            loop6:
                            do {
                                int alt6=2;
                    ...
                    break;
                case 2 :
                    // InternalBug347012TestLanguage.g:2215:47: '.' ( RULE_DIGIT )+
                    {
                    match('.'); 
                    // InternalBug347012TestLanguage.g:2215:51: ( RULE_DIGIT )+
                    int cnt8=0;
                    loop8:
                    do {
                        int alt8=2;
    ...
    public final void mRULE_DIGIT() throws RecognitionException {
        try {
            // InternalBug347012TestLanguage.g:2217:21: ( '0' .. '9' )
            // InternalBug347012TestLanguage.g:2217:23: '0' .. '9'
            {
            matchRange('0','9'); 
    ...
    public final void mRULE_HEX() throws RecognitionException {
        try {
            // InternalBug347012TestLanguage.g:2219:19: ( ( RULE_DIGIT | 'A' .. 'F' | 'a' .. 'f' ) )
            // InternalBug347012TestLanguage.g:2219:21: ( RULE_DIGIT | 'A' .. 'F' | 'a' .. 'f' )
            {
    ...
    public final void mRULE_ESCAPE() throws RecognitionException {
        try {
            // InternalBug347012TestLanguage.g:2221:22: ( ( 'b' | 't' | 'n' | 'f' | 'v' | 'r' | '\"' | '\\'' | '\\\\' | 'u' RULE_HEX RULE_HEX RULE_HEX RULE_HEX ) )
            // InternalBug347012TestLanguage.g:2221:24: ( 'b' | 't' | 'n' | 'f' | 'v' | 'r' | '\"' | '\\'' | '\\\\' | 'u' RULE_HEX RULE_HEX RULE_HEX RULE_HEX )
            {
            // InternalBug347012TestLanguage.g:2221:24: ( 'b' | 't' | 'n' | 'f' | 'v' | 'r' | '\"' | '\\'' | '\\\\' | 'u' RULE_HEX RULE_HEX RULE_HEX RULE_HEX )
            int alt10=10;
            switch ( input.LA(1) ) {
            ...
            switch (alt10) {
                case 1 :
                    // InternalBug347012TestLanguage.g:2221:25: 'b'
                    {
                    match('b'); 
                    ...
                    break;
                case 2 :
                    // InternalBug347012TestLanguage.g:2221:29: 't'
                    {
                    match('t'); 
                    ...
                    break;
                case 3 :
                    // InternalBug347012TestLanguage.g:2221:33: 'n'
                    {
                    match('n'); 
                    ...
                    break;
                case 4 :
                    // InternalBug347012TestLanguage.g:2221:37: 'f'
                    {
                    match('f'); 
                    ...
                    break;
                case 5 :
                    // InternalBug347012TestLanguage.g:2221:41: 'v'
                    {
                    match('v'); 
                    ...
                    break;
                case 6 :
                    // InternalBug347012TestLanguage.g:2221:45: 'r'
                    {
                    match('r'); 
                    ...
                    break;
                case 7 :
                    // InternalBug347012TestLanguage.g:2221:49: '\"'
                    {
                    match('\"'); 
                    ...
                    break;
                case 8 :
                    // InternalBug347012TestLanguage.g:2221:53: '\\''
                    {
                    match('\''); 
                    ...
                    break;
                case 9 :
                    // InternalBug347012TestLanguage.g:2221:58: '\\\\'
                    {
                    match('\\'); 
                    ...
                    break;
                case 10 :
                    // InternalBug347012TestLanguage.g:2221:63: 'u' RULE_HEX RULE_HEX RULE_HEX RULE_HEX
                    {
                    match('u'); 
                    mRULE_HEX(); 
                    mRULE_HEX(); 
    ...
    public final void mRULE_IDPLAINCHAR() throws RecognitionException {
        try {
            // InternalBug347012TestLanguage.g:2223:27: ( ( '$' | 'A' .. 'Z' | '_' | 'a' .. 'z' ) )
            // InternalBug347012TestLanguage.g:2223:29: ( '$' | 'A' .. 'Z' | '_' | 'a' .. 'z' )
            {
