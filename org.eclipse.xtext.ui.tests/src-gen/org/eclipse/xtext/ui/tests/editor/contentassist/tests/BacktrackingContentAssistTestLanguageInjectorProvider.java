...
public class BacktrackingContentAssistTestLanguageInjectorProvider implements IInjectorProvider, IRegistryConfigurator {
	...
	protected BacktrackingContentAssistTestLanguageRuntimeModule createRuntimeModule() {
		...
		return new BacktrackingContentAssistTestLanguageRuntimeModule() {
			...
			public ClassLoader bindClassLoaderToInstance() {
				return BacktrackingContentAssistTestLanguageInjectorProvider.this.getClass()
						.getClassLoader();
			}
		};
	}
