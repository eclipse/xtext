...
public class AttributeImpl extends MinimalEObjectImpl.Container implements Attribute
{
  ...
  {
    return Bug288760TestLanguagePackage.Literals.ATTRIBUTE;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Bug288760TestLanguagePackage.ATTRIBUTE__NAME, oldName, name));
  }
  ...
  public void setValue(String newValue)
  {
    ...
    value = newValue;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Bug288760TestLanguagePackage.ATTRIBUTE__VALUE, oldValue, value));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case Bug288760TestLanguagePackage.ATTRIBUTE__NAME:
        return getName();
      case Bug288760TestLanguagePackage.ATTRIBUTE__VALUE:
        return getValue();
    }
