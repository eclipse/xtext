 ...
 * @generated
 */
public interface Bug303200TestLanguageFactory extends EFactory
{
  /**
   ...
   * @generated
   */
  Bug303200TestLanguageFactory eINSTANCE = org.eclipse.xtext.ui.tests.editor.contentassist.bug303200TestLanguage.impl.Bug303200TestLanguageFactoryImpl.init();
  ...
  /**
   * Returns a new object of class '<em>Program Directive</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Program Directive</em>'.
   * @generated
   */
  ProgramDirective createProgramDirective();
  ...
  /**
   * Returns a new object of class '<em>Bracket Attribute</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Bracket Attribute</em>'.
   * @generated
   */
  BracketAttribute createBracketAttribute();
   ...
   * @generated
   */
  Bug303200TestLanguagePackage getBug303200TestLanguagePackage();

} //Bug303200TestLanguageFactory
