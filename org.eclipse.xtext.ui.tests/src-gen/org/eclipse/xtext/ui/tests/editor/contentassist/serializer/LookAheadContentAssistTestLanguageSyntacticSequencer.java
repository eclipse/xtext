...
public class LookAheadContentAssistTestLanguageSyntacticSequencer extends AbstractSyntacticSequencer {

	protected LookAheadContentAssistTestLanguageGrammarAccess grammarAccess;
	
	@Inject
	protected void init(IGrammarAccess access) {
		grammarAccess = (LookAheadContentAssistTestLanguageGrammarAccess) access;
	}
