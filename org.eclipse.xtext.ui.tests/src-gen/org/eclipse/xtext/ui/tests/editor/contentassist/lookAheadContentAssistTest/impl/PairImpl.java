...
public class PairImpl extends MinimalEObjectImpl.Container implements Pair
{
  ...
  {
    return LookAheadContentAssistTestPackage.Literals.PAIR;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LookAheadContentAssistTestPackage.PAIR__NAME, oldName, name));
  }
  ...
  public void setValue(String newValue)
  {
    ...
    value = newValue;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LookAheadContentAssistTestPackage.PAIR__VALUE, oldValue, value));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case LookAheadContentAssistTestPackage.PAIR__NAME:
        return getName();
      case LookAheadContentAssistTestPackage.PAIR__VALUE:
        return getValue();
    }
