...
public class TwoContextsTestLanguageInjectorProvider implements IInjectorProvider, IRegistryConfigurator {
	...
	protected TwoContextsTestLanguageRuntimeModule createRuntimeModule() {
		...
		return new TwoContextsTestLanguageRuntimeModule() {
			...
			public ClassLoader bindClassLoaderToInstance() {
				return TwoContextsTestLanguageInjectorProvider.this.getClass()
						.getClassLoader();
			}
		};
	}
