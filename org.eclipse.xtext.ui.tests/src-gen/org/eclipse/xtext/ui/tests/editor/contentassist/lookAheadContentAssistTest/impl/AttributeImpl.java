...
public class AttributeImpl extends MinimalEObjectImpl.Container implements Attribute
{
  ...
  {
    return LookAheadContentAssistTestPackage.Literals.ATTRIBUTE;
  }
  ...
  public void setValue(String newValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LookAheadContentAssistTestPackage.ATTRIBUTE__VALUE, oldValue, value));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case LookAheadContentAssistTestPackage.ATTRIBUTE__VALUE:
        return getValue();
    }
