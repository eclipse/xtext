 ...
 *******************************************************************************/
package org.eclipse.xtext.ui.tests.editor.outline.tests;
...
public class OutlineTestLanguageInjectorProvider implements IInjectorProvider, IRegistryConfigurator {
	...
	protected Injector internalCreateInjector() {
		return new OutlineTestLanguageStandaloneSetup() {
			@Override
	...
	protected OutlineTestLanguageRuntimeModule createRuntimeModule() {
		...
		return new OutlineTestLanguageRuntimeModule() {
			...
			public ClassLoader bindClassLoaderToInstance() {
				return OutlineTestLanguageInjectorProvider.this.getClass()
						.getClassLoader();
			}
		};
	}
