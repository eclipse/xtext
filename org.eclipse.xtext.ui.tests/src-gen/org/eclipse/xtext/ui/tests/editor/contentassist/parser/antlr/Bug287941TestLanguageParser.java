...
import org.eclipse.xtext.ui.tests.editor.contentassist.parser.antlr.internal.InternalBug287941TestLanguageParser;
import org.eclipse.xtext.ui.tests.editor.contentassist.services.Bug287941TestLanguageGrammarAccess;

public class Bug287941TestLanguageParser extends AbstractAntlrParser {
	...
	@Override
	protected InternalBug287941TestLanguageParser createParser(XtextTokenStream stream) {
		return new InternalBug287941TestLanguageParser(stream, getGrammarAccess());
	}
