...
public class InternalParameterizedExpressionsTestLanguageLexer extends Lexer {
    ...
    public final void mT__12() throws RecognitionException {
        try {
            int _type = T__12;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalParameterizedExpressionsTestLanguage.g:12:7: ( '<<' )
            // InternalParameterizedExpressionsTestLanguage.g:12:9: '<<'
            {
            match("<<"); 
    ...
    public final void mT__17() throws RecognitionException {
        try {
            int _type = T__17;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalParameterizedExpressionsTestLanguage.g:17:7: ( 'instanceof' )
            // InternalParameterizedExpressionsTestLanguage.g:17:9: 'instanceof'
            {
            match("instanceof"); 
    ...
    public final void mT__18() throws RecognitionException {
        try {
            int _type = T__18;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalParameterizedExpressionsTestLanguage.g:18:7: ( 'in' )
            // InternalParameterizedExpressionsTestLanguage.g:18:9: 'in'
            {
            match("in"); 
    ...
    public final void mT__19() throws RecognitionException {
        try {
            int _type = T__19;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalParameterizedExpressionsTestLanguage.g:19:7: ( 'yield' )
            // InternalParameterizedExpressionsTestLanguage.g:19:9: 'yield'
            {
            match("yield"); 
    ...
    public final void mT__21() throws RecognitionException {
        try {
            int _type = T__21;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalParameterizedExpressionsTestLanguage.g:21:7: ( 'function' )
            // InternalParameterizedExpressionsTestLanguage.g:21:9: 'function'
            {
            match("function"); 
    ...
    public final void mT__28() throws RecognitionException {
        try {
            int _type = T__28;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalParameterizedExpressionsTestLanguage.g:28:7: ( ']' )
            // InternalParameterizedExpressionsTestLanguage.g:28:9: ']'
            {
            match(']'); 
    ...
    public final void mT__29() throws RecognitionException {
        try {
            int _type = T__29;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalParameterizedExpressionsTestLanguage.g:29:7: ( '.' )
            // InternalParameterizedExpressionsTestLanguage.g:29:9: '.'
            {
            match('.'); 
    ...
    public final void mT__31() throws RecognitionException {
        try {
            int _type = T__31;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalParameterizedExpressionsTestLanguage.g:31:7: ( '*' )
            // InternalParameterizedExpressionsTestLanguage.g:31:9: '*'
            {
            match('*'); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalParameterizedExpressionsTestLanguage.g:6965:9: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // InternalParameterizedExpressionsTestLanguage.g:6965:11: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // InternalParameterizedExpressionsTestLanguage.g:6965:11: ( '^' )?
            int alt1=2;
            ...
            // InternalParameterizedExpressionsTestLanguage.g:6965:40: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop2:
            do {
                int alt2=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalParameterizedExpressionsTestLanguage.g:6967:10: ( ( '0' .. '9' )+ )
            // InternalParameterizedExpressionsTestLanguage.g:6967:12: ( '0' .. '9' )+
            {
            // InternalParameterizedExpressionsTestLanguage.g:6967:12: ( '0' .. '9' )+
            int cnt3=0;
            loop3:
            do {
                ...
                switch (alt3) {
            	case 1 :
            	    // InternalParameterizedExpressionsTestLanguage.g:6967:13: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalParameterizedExpressionsTestLanguage.g:6969:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalParameterizedExpressionsTestLanguage.g:6969:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalParameterizedExpressionsTestLanguage.g:6969:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt6=2;
            ...
            switch (alt6) {
                case 1 :
                    // InternalParameterizedExpressionsTestLanguage.g:6969:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalParameterizedExpressionsTestLanguage.g:6969:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop4:
                    do {
                        int alt4=3;
                        ...
                        switch (alt4) {
                    	case 1 :
                    	    // InternalParameterizedExpressionsTestLanguage.g:6969:21: '\\\\' .
                    	    {
                    	    match('\\'); 
                    	    matchAny(); 
                    	    ...
                    	    break;
                    	case 2 :
                    	    // InternalParameterizedExpressionsTestLanguage.g:6969:28: ~ ( ( '\\\\' | '\"' ) )
                    	    {
                    ...
                    break;
                case 2 :
                    // InternalParameterizedExpressionsTestLanguage.g:6969:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalParameterizedExpressionsTestLanguage.g:6969:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop5:
                    do {
                        int alt5=3;
                        ...
                        switch (alt5) {
                    	case 1 :
                    	    // InternalParameterizedExpressionsTestLanguage.g:6969:54: '\\\\' .
                    	    {
                    	    match('\\'); 
                    	    matchAny(); 
                    	    ...
                    	    break;
                    	case 2 :
                    	    // InternalParameterizedExpressionsTestLanguage.g:6969:61: ~ ( ( '\\\\' | '\\'' ) )
                    	    {
                    	    if ( (input.LA(1)>='\u0000' && input.LA(1)<='&')||(input.LA(1)>='(' && input.LA(1)<='[')||(input.LA(1)>=']' && input.LA(1)<='\uFFFF') ) {
                    	        input.consume();
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalParameterizedExpressionsTestLanguage.g:6971:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // Intern