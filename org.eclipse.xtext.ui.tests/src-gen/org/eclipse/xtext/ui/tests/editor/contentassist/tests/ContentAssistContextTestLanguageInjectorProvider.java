...
public class ContentAssistContextTestLanguageInjectorProvider implements IInjectorProvider, IRegistryConfigurator {
	...
	protected ContentAssistContextTestLanguageRuntimeModule createRuntimeModule() {
		...
		return new ContentAssistContextTestLanguageRuntimeModule() {
			...
			public ClassLoader bindClassLoaderToInstance() {
				return ContentAssistContextTestLanguageInjectorProvider.this.getClass()
						.getClassLoader();
			}
		};
	}
