...
import org.eclipse.xtext.ui.tests.editor.encoding.ui.contentassist.EncodingUiTestLanguageProposalProvider;

/**
 * Manual modifications go to {@link EncodingUiTestLanguageUiModule}.
 */
...
public abstract class AbstractEncodingUiTestLanguageUiModule extends DefaultUiModule {
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(org.eclipse.xtext.ui.tests.editor.encoding.parser.antlr.internal.InternalEncodingUiTestLanguageLexer.class);
	}
	...
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalEncodingUiTestLanguageLexer.class).toProvider(LexerProvider.create(InternalEncodingUiTestLanguageLexer.class));
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.contentAssist.ContentAssistFragment2
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return EncodingUiTestLanguageProposalProvider.class;
	}
