...
public class Bug307519TestLanguageInjectorProvider implements IInjectorProvider, IRegistryConfigurator {
	...
	protected Bug307519TestLanguageRuntimeModule createRuntimeModule() {
		...
		return new Bug307519TestLanguageRuntimeModule() {
			...
			public ClassLoader bindClassLoaderToInstance() {
				return Bug307519TestLanguageInjectorProvider.this.getClass()
						.getClassLoader();
			}
		};
	}
