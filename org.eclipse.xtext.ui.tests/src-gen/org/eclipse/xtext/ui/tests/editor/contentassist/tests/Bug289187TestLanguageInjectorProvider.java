...
public class Bug289187TestLanguageInjectorProvider implements IInjectorProvider, IRegistryConfigurator {
	...
	protected Bug289187TestLanguageRuntimeModule createRuntimeModule() {
		...
		return new Bug289187TestLanguageRuntimeModule() {
			...
			public ClassLoader bindClassLoaderToInstance() {
				return Bug289187TestLanguageInjectorProvider.this.getClass()
						.getClassLoader();
			}
		};
	}
