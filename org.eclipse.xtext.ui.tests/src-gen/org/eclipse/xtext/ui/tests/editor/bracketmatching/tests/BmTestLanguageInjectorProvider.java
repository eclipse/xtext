 ...
 *******************************************************************************/
package org.eclipse.xtext.ui.tests.editor.bracketmatching.tests;
...
public class BmTestLanguageInjectorProvider implements IInjectorProvider, IRegistryConfigurator {
	...
	protected Injector internalCreateInjector() {
		return new BmTestLanguageStandaloneSetup() {
			@Override
	...
	protected BmTestLanguageRuntimeModule createRuntimeModule() {
		...
		return new BmTestLanguageRuntimeModule() {
			...
			public ClassLoader bindClassLoaderToInstance() {
				return BmTestLanguageInjectorProvider.this.getClass()
						.getClassLoader();
			}
		};
	}
