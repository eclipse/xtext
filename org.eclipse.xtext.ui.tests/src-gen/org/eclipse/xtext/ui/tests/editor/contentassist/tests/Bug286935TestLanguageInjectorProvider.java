...
public class Bug286935TestLanguageInjectorProvider implements IInjectorProvider, IRegistryConfigurator {
	...
	protected Bug286935TestLanguageRuntimeModule createRuntimeModule() {
		...
		return new Bug286935TestLanguageRuntimeModule() {
			...
			public ClassLoader bindClassLoaderToInstance() {
				return Bug286935TestLanguageInjectorProvider.this.getClass()
						.getClassLoader();
			}
		};
	}
