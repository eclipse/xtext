...
public class ContentAssistCustomizingTestLanguageInjectorProvider implements IInjectorProvider, IRegistryConfigurator {
	...
	protected ContentAssistCustomizingTestLanguageRuntimeModule createRuntimeModule() {
		// make it work also with Maven/Tycho and OSGI
		// see https://bugs.eclipse.org/bugs/show_bug.cgi?id=493672
		return new ContentAssistCustomizingTestLanguageRuntimeModule() {
			@Override
			public ClassLoader bindClassLoaderToInstance() {
				return ContentAssistCustomizingTestLanguageInjectorProvider.class
						.getClassLoader();
			}
		};
	}
