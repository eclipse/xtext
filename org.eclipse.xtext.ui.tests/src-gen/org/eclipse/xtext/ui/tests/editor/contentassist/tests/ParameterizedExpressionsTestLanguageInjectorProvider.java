...
public class ParameterizedExpressionsTestLanguageInjectorProvider implements IInjectorProvider, IRegistryConfigurator {
	...
	protected Injector internalCreateInjector() {
		return new ParameterizedExpressionsTestLanguageStandaloneSetup() {
			@Override
	...
	protected ParameterizedExpressionsTestLanguageRuntimeModule createRuntimeModule() {
		...
		return new ParameterizedExpressionsTestLanguageRuntimeModule() {
			...
			public ClassLoader bindClassLoaderToInstance() {
				return ParameterizedExpressionsTestLanguageInjectorProvider.this.getClass()
						.getClassLoader();
			}
		};
	}
