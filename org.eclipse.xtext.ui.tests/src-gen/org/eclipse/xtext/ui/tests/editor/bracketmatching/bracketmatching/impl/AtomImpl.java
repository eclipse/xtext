 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.xtext.ui.tests.editor.bracketmatching.bracketmatching.impl.AtomImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AtomImpl extends ExpressionImpl implements Atom
{
  ...
  {
    return BracketmatchingPackage.Literals.ATOM;
  }
  ...
  public void setValue(String newValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BracketmatchingPackage.ATOM__VALUE, oldValue, value));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case BracketmatchingPackage.ATOM__VALUE:
        return getValue();
    }
