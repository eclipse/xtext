 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.xtext.ui.tests.editor.contentassist.contentAssistCustomizingTest.impl.ModelImpl#getTypes <em>Types</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ModelImpl extends MinimalEObjectImpl.Container implements Model
{
  ...
  {
    return ContentAssistCustomizingTestPackage.Literals.MODEL;
  }
  ...
  public EList<Type> getTypes()
  {
    if (types == null)
    {
      types = new EObjectContainmentEList<Type>(Type.class, this, ContentAssistCustomizingTestPackage.MODEL__TYPES);
    }
    return types;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case ContentAssistCustomizingTestPackage.MODEL__TYPES:
