...
public class BmTestLanguageStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new BmTestLanguageRuntimeModule());
	}
	
	public void register(Injector injector) {
		if (!EPackage.Registry.INSTANCE.containsKey("http://xtext.org/ui/integartion/tests/bracketmatching")) {
			EPackage.Registry.INSTANCE.put("http://xtext.org/ui/integartion/tests/bracketmatching", BracketmatchingPackage.eINSTANCE);
		}
		...
		IResourceServiceProvider.Registry.INSTANCE.getExtensionToFactoryMap().put("bmtestlanguage", serviceProvider);
	}
}
