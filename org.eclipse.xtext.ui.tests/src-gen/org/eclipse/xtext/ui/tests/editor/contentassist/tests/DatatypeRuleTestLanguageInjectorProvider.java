...
public class DatatypeRuleTestLanguageInjectorProvider implements IInjectorProvider, IRegistryConfigurator {
	...
	protected DatatypeRuleTestLanguageRuntimeModule createRuntimeModule() {
		...
		return new DatatypeRuleTestLanguageRuntimeModule() {
			...
			public ClassLoader bindClassLoaderToInstance() {
				return DatatypeRuleTestLanguageInjectorProvider.this.getClass()
						.getClassLoader();
			}
		};
	}
