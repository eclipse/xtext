...
public class Bug348427TestLanguageInjectorProvider implements IInjectorProvider, IRegistryConfigurator {
	...
	protected Bug348427TestLanguageRuntimeModule createRuntimeModule() {
		...
		return new Bug348427TestLanguageRuntimeModule() {
			...
			public ClassLoader bindClassLoaderToInstance() {
				return Bug348427TestLanguageInjectorProvider.this.getClass()
						.getClassLoader();
			}
		};
	}
