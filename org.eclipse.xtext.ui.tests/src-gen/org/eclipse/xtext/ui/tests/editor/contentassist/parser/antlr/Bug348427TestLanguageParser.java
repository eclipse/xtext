...
import org.eclipse.xtext.ui.tests.editor.contentassist.parser.antlr.internal.InternalBug348427TestLanguageParser;
import org.eclipse.xtext.ui.tests.editor.contentassist.services.Bug348427TestLanguageGrammarAccess;

public class Bug348427TestLanguageParser extends AbstractAntlrParser {
	...
	@Override
	protected InternalBug348427TestLanguageParser createParser(XtextTokenStream stream) {
		return new InternalBug348427TestLanguageParser(stream, getGrammarAccess());
	}
