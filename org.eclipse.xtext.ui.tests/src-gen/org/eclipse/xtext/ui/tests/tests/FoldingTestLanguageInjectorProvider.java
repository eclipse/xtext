 ...
 *******************************************************************************/
package org.eclipse.xtext.ui.tests.tests;
...
public class FoldingTestLanguageInjectorProvider implements IInjectorProvider, IRegistryConfigurator {
	...
	protected Injector internalCreateInjector() {
		return new FoldingTestLanguageStandaloneSetup() {
			@Override
	...
	protected FoldingTestLanguageRuntimeModule createRuntimeModule() {
		...
		return new FoldingTestLanguageRuntimeModule() {
			...
			public ClassLoader bindClassLoaderToInstance() {
				return FoldingTestLanguageInjectorProvider.this.getClass()
						.getClassLoader();
			}
		};
	}
