 ...
 *******************************************************************************/
package org.eclipse.xtext.ui.tests.parser.keywords.tests;
...
public class KeywordsUiTestLanguageInjectorProvider implements IInjectorProvider, IRegistryConfigurator {
	...
	protected KeywordsUiTestLanguageRuntimeModule createRuntimeModule() {
		...
		return new KeywordsUiTestLanguageRuntimeModule() {
			...
			public ClassLoader bindClassLoaderToInstance() {
				return KeywordsUiTestLanguageInjectorProvider.this.getClass()
						.getClassLoader();
			}
		};
	}
