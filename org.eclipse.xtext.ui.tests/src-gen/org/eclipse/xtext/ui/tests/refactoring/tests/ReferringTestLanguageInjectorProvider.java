 ...
 *******************************************************************************/
package org.eclipse.xtext.ui.tests.refactoring.tests;
...
public class ReferringTestLanguageInjectorProvider implements IInjectorProvider, IRegistryConfigurator {
	...
	protected Injector internalCreateInjector() {
		return new ReferringTestLanguageStandaloneSetup() {
			@Override
	...
	protected ReferringTestLanguageRuntimeModule createRuntimeModule() {
		...
		return new ReferringTestLanguageRuntimeModule() {
			...
			public ClassLoader bindClassLoaderToInstance() {
				return ReferringTestLanguageInjectorProvider.this.getClass()
						.getClassLoader();
			}
		};
	}
