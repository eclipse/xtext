...
public class RefactoringTestLanguageInjectorProvider implements IInjectorProvider, IRegistryConfigurator {
	...
	protected Injector internalCreateInjector() {
		return new RefactoringTestLanguageStandaloneSetup() {
			@Override
	...
	protected RefactoringTestLanguageRuntimeModule createRuntimeModule() {
		...
		return new RefactoringTestLanguageRuntimeModule() {
			...
			public ClassLoader bindClassLoaderToInstance() {
				return RefactoringTestLanguageInjectorProvider.this.getClass()
						.getClassLoader();
			}
		};
	}
