 ...
 *******************************************************************************/
package org.eclipse.xtext.ui.tests.linking.tests;
...
public class ImportUriUiTestLanguageInjectorProvider implements IInjectorProvider, IRegistryConfigurator {
	...
	protected Injector internalCreateInjector() {
		return new ImportUriUiTestLanguageStandaloneSetup() {
			@Override
	...
	protected ImportUriUiTestLanguageRuntimeModule createRuntimeModule() {
		...
		return new ImportUriUiTestLanguageRuntimeModule() {
			...
			public ClassLoader bindClassLoaderToInstance() {
				return ImportUriUiTestLanguageInjectorProvider.this.getClass()
						.getClassLoader();
			}
		};
	}
