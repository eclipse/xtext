 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.xtext.ui.tests.xtextUiTest.impl.RuleCallImpl#getRule <em>Rule</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RuleCallImpl extends AbstractElementImpl implements RuleCall
{
  ...
  {
    return XtextUiTestPackage.Literals.RULE_CALL;
  }
    ...
    if (rule != null && rule.eIsProxy())
    {
      ...
      if (rule != oldRule)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, XtextUiTestPackage.RULE_CALL__RULE, oldRule, rule));
      }
    }
    return rule;
  }
  ...
  public void setRule(AbstractRule newRule)
  {
    ...
    rule = newRule;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XtextUiTestPackage.RULE_CALL__RULE, oldRule, rule));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case XtextUiTestPackage.RULE_CALL__RULE:
