 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.xtext.ui.tests.xtextUiTest.impl.AlternativesImpl#getGroups <em>Groups</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AlternativesImpl extends AbstractElementImpl implements Alternatives
{
  ...
  {
    return XtextUiTestPackage.Literals.ALTERNATIVES;
  }
  ...
  public EList<AbstractElement> getGroups()
  {
    if (groups == null)
    {
      groups = new EObjectContainmentEList<AbstractElement>(AbstractElement.class, this, XtextUiTestPackage.ALTERNATIVES__GROUPS);
    }
    return groups;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case XtextUiTestPackage.ALTERNATIVES__GROUPS:
