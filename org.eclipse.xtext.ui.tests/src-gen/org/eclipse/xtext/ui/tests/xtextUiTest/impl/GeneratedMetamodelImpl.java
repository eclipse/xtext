 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.xtext.ui.tests.xtextUiTest.impl.GeneratedMetamodelImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GeneratedMetamodelImpl extends AbstractMetamodelDeclarationImpl implements GeneratedMetamodel
{
  ...
  {
    return XtextUiTestPackage.Literals.GENERATED_METAMODEL;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XtextUiTestPackage.GENERATED_METAMODEL__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case XtextUiTestPackage.GENERATED_METAMODEL__NAME:
        return getName();
    }
