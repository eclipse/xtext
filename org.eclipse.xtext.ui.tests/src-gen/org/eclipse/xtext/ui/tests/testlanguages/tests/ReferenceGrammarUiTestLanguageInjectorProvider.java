...
public class ReferenceGrammarUiTestLanguageInjectorProvider implements IInjectorProvider, IRegistryConfigurator {
	...
	protected ReferenceGrammarUiTestLanguageRuntimeModule createRuntimeModule() {
		...
		return new ReferenceGrammarUiTestLanguageRuntimeModule() {
			...
			public ClassLoader bindClassLoaderToInstance() {
				return ReferenceGrammarUiTestLanguageInjectorProvider.this.getClass()
						.getClassLoader();
			}
		};
	}
