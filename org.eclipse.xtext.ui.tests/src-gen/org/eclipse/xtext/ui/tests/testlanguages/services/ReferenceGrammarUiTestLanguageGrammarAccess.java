...
@Singleton
public class ReferenceGrammarUiTestLanguageGrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	
	public class SpielplatzElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.xtext.ui.tests.testlanguages.ReferenceGrammarUiTestLanguage.Spielplatz");
	...
	public class PersonElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.xtext.ui.tests.testlanguages.ReferenceGrammarUiTestLanguage.Person");
	...
	public class KindElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.xtext.ui.tests.testlanguages.ReferenceGrammarUiTestLanguage.Kind");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ErwachsenerElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.xtext.ui.tests.testlanguages.ReferenceGrammarUiTestLanguage.Erwachsener");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class SpielzeugElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.xtext.ui.tests.testlanguages.ReferenceGrammarUiTestLanguage.Spielzeug");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class FarbeElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.xtext.ui.tests.testlanguages.ReferenceGrammarUiTestLanguage.Farbe");
	...
	public class FamilieElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.xtext.ui.tests.testlanguages.ReferenceGrammarUiTestLanguage.Familie");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("org.eclipse.xtext.ui.tests.testlanguages.ReferenceGrammarUiTestLanguage".equals(grammar.getName())) {
				return grammar;
			}
