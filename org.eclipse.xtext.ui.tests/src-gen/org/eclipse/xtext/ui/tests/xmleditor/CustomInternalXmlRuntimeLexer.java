...
public class CustomInternalXmlRuntimeLexer extends Lexer {
    ...
    public String getGrammarFileName() { return "CustomInternalXmlRuntimeLexer.g"; }
    ...
    public final void mRULE_TAG_START_OPEN() throws RecognitionException {
        try {
            ...
            // CustomInternalXmlRuntimeLexer.g:15:21: ( '<' )
            // CustomInternalXmlRuntimeLexer.g:15:23: '<'
            {
            match('<'); 
             tagMode = true; 
    ...
    public final void mRULE_TAG_END_OPEN() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // CustomInternalXmlRuntimeLexer.g:17:19: ( '</' )
            // CustomInternalXmlRuntimeLexer.g:17:21: '</'
            {
            match("</"); 
    ...
    public final void mRULE_TAG_CLOSE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // CustomInternalXmlRuntimeLexer.g:19:16: ({...}? => '>' )
            // CustomInternalXmlRuntimeLexer.g:19:18: {...}? => '>'
            {
            if ( !(( tagMode )) ) {
    ...
    public final void mRULE_TAG_EMPTY_CLOSE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // CustomInternalXmlRuntimeLexer.g:21:22: ({...}? => '/>' )
            // CustomInternalXmlRuntimeLexer.g:21:24: {...}? => '/>'
            {
            if ( !(( tagMode )) ) {
    ...
    public final void mRULE_ATTR_EQ() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // CustomInternalXmlRuntimeLexer.g:23:14: ({...}? => '=' )
            // CustomInternalXmlRuntimeLexer.g:23:16: {...}? => '='
            {
            if ( !(( tagMode )) ) {
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // CustomInternalXmlRuntimeLexer.g:25:9: ({...}? => ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // CustomInternalXmlRuntimeLexer.g:25:11: {...}? => ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            if ( !(( tagMode )) ) {
                throw new FailedPredicateException(input, "RULE_ID", " tagMode ");
            }
            // CustomInternalXmlRuntimeLexer.g:25:27: ( '^' )?
            int alt1=2;
            ...
            // CustomInternalXmlRuntimeLexer.g:25:56: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop2:
            do {
                int alt2=2;
                ...
                switch (alt2) {
            	case 1 :
            	    // CustomInternalXmlRuntimeLexer.g:
            	    {
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // CustomInternalXmlRuntimeLexer.g:27:13: ({...}? => ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // CustomInternalXmlRuntimeLexer.g:27:15: {...}? => ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            if ( !(( tagMode )) ) {
                throw new FailedPredicateException(input, "RULE_STRING", " tagMode ");
            }
            // CustomInternalXmlRuntimeLexer.g:27:31: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt5=2;
            ...
            switch (alt5) {
                case 1 :
                    // CustomInternalXmlRuntimeLexer.g:27:32: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // CustomInternalXmlRuntimeLexer.g:27:36: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop3:
                    do {
                        int alt3=3;
                        ...
                        switch (alt3) {
                    	case 1 :
                    	    // CustomInternalXmlRuntimeLexer.g:27:37: '\\\\' .
                    	    {
                    	    match('\\'); 
                    	    matchAny(); 
                    	    ...
                    	    break;
                    	case 2 :
                    	    // CustomInternalXmlRuntimeLexer.g:27:44: ~ ( ( '\\\\' | '\"' ) )
                    	    {
                    ...
                    break;
                case 2 :
                    // CustomInternalXmlRuntimeLexer.g:27:64: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // CustomInternalXmlRuntimeLexer.g:27:69: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop4:
                    do {
                        int alt4=3;
                        ...
                        switch (alt4) {
                    	case 1 :
                    	    // CustomInternalXmlRuntimeLexer.g:27:70: '\\\\' .
                    	    {
                    	    match('\\'); 
                    	    matchAny(); 
                    	    ...
                    	    break;
                    	case 2 :
                    	    // CustomInternalXmlRuntimeLexer.g:27:77: ~ ( ( '\\\\' | '\\'' ) )
                    	    {
                    	    if ( (input.LA(1)>='\u0000' && input.LA(1)<='&')||(input.LA(1)>='(' && input.LA(1)<='[')||(input.LA(1)>=']' && input.LA(1)<='\uFFFF') ) {
                    	        input.consume();
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // CustomInternalXmlRuntimeLexer.g:29:9: ({...}? => ( ' ' | '\\r' | '\\t' | '\\f' | '\\n' )+ )
            // CustomInternalXmlRuntimeLexer.g:29:11: {...}? => ( ' ' | '\\r' | '\\t' | '\\f' | '\\n' )+
            {
            if ( !(( tagMode )) ) {
                throw new FailedPredicateException(input, "RULE_WS", " tagMode ");
            }
            // CustomInternalXmlRuntimeLexer.g:29:27: ( ' ' | '\\r' | '\\t' | '\\f' | '\\n' )+
            int cnt6=0;
            loop6:
            do {
                int alt6=2;
    ...
    public final void mRULE_PCDATA() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // CustomInternalXmlRuntimeLexer.g:31:13: ({...}? => (~ ( '<' ) )+ )
            // CustomInternalXmlRuntimeLexer.g:31:15: {...}? => (~ ( '<' ) )+
            {
            if ( !(( !tagMode )) ) {
                throw new FailedPredicateException(input, "RULE_PCDATA", " !tagMode ");
            }
            // CustomInternalXmlRuntimeLexer.g:31:32: (~ ( '<' ) )+
            int cnt7=0;
            loop7:
            do {
                int alt7=2;
    ...
    public void mTokens() throws RecognitionException {
        // CustomInternalXmlRuntimeLexer.g:1:8: ( RULE_TAG_START_OPEN | RULE_TAG_END_OPEN | RULE_TAG_CLOSE | RULE_TAG_EMPTY_CLOSE | RULE_ATTR_EQ | RULE_ID | RULE_STRING | RULE_WS | RULE_PCDATA )
        int alt8=9;
        alt8 = dfa8.predict(input);
        switch (alt8) {
            case 1 :
                // CustomInternalXmlRuntimeLexer.g:1:10: RULE_TAG_START_OPEN
                {
                ...
                break;
            case 2 :
                // CustomInternalXmlRuntimeLexer.g:1:30: RULE_TAG_END_OPEN
                {
                mRULE_TAG_END_OPEN(); 
                ...
                break;
            case 3 :
                // CustomInternalXmlRuntimeLexer.g:1:48: RULE_TAG_CLOSE
                {
                mRULE_TAG_CLOSE(); 
                ...
                break;
            case 4 :
                // CustomInternalXmlRuntimeLexer.g:1:63: RULE_TAG_EMPTY_CLOSE
                {
                ...
                break;
            case 5 :
                // CustomInternalXmlRuntimeLexer.g:1:84: RULE_ATTR_EQ
                {
                mRULE_ATTR_EQ(); 
                ...
                break;
            case 6 :
                // CustomInternalXmlRuntimeLexer.g:1:97: RULE_ID
                {
                mRULE_ID(); 
                ...
                break;
            case 7 :
                // CustomInternalXmlRuntimeLexer.g:1:105: RULE_STRING
                {
                mRULE_STRING(); 
                ...
                break;
            case 8 :
                // CustomInternalXmlRuntimeLexer.g:1:117: RULE_WS
                {
                mRULE_WS(); 
                ...
                break;
            case 9 :
                // CustomInternalXmlRuntimeLexer.g:1:125: RULE_PCDATA
                {
                mRULE_PCDATA(); 
