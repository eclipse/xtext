...
public class CustomInternalXmlContentAssistLexer extends Lexer {
    ...
    public CustomInternalXmlContentAssistLexer() {;} 
    public CustomInternalXmlContentAssistLexer(CharStream input) {
        this(input, new RecognizerSharedState());
    }
    public CustomInternalXmlContentAssistLexer(CharStream input, RecognizerSharedState state) {
        super(input,state);
