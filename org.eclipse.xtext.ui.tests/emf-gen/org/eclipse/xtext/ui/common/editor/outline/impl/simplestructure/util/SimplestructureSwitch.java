 ...
 * </copyright>
 *
 * $Id: SimplestructureSwitch.java,v 1.1 2010/02/03 18:24:43 sefftinge Exp $
 */
...
public class SimplestructureSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SimplestructurePackage.A: {
				A a = (A)theEObject;
				T result = caseA(a);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SimplestructurePackage.B: {
				B b = (B)theEObject;
				T result = caseB(b);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SimplestructurePackage.ROOT: {
