...
public class ReferenceGrammarGrammarAccess extends BaseEPackageAccess implements IGrammarAccess {
	...
	public ParserRule pr_Spielplatz() {
		return (ParserRule) getGrammar().eResource().getResourceSet().getEObject(URI.createURI("classpath:/org/eclipse/xtext/reference/ReferenceGrammar.xmi#//@rules.0"),true); 
	}

	public ParserRule pr_Person() {
		return (ParserRule) getGrammar().eResource().getResourceSet().getEObject(URI.createURI("classpath:/org/eclipse/xtext/reference/ReferenceGrammar.xmi#//@rules.1"),true); 
	}

	public ParserRule pr_Kind() {
		return (ParserRule) getGrammar().eResource().getResourceSet().getEObject(URI.createURI("classpath:/org/eclipse/xtext/reference/ReferenceGrammar.xmi#//@rules.2"),true); 
	}

	public ParserRule pr_Erwachsener() {
		return (ParserRule) getGrammar().eResource().getResourceSet().getEObject(URI.createURI("classpath:/org/eclipse/xtext/reference/ReferenceGrammar.xmi#//@rules.3"),true); 
	}

	public ParserRule pr_Spielzeug() {
		return (ParserRule) getGrammar().eResource().getResourceSet().getEObject(URI.createURI("classpath:/org/eclipse/xtext/reference/ReferenceGrammar.xmi#//@rules.4"),true); 
	}

	public ParserRule pr_Familie() {
		return (ParserRule) getGrammar().eResource().getResourceSet().getEObject(URI.createURI("classpath:/org/eclipse/xtext/reference/ReferenceGrammar.xmi#//@rules.5"),true); 
	}

	public ParserRule pr_Farbe() {
		return (ParserRule) getGrammar().eResource().getResourceSet().getEObject(URI.createURI("classpath:/org/eclipse/xtext/reference/ReferenceGrammar.xmi#//@rules.6"),true); 
	}

	public ParserRule pr_CustomTypeParserRule() {
		return (ParserRule) getGrammar().eResource().getResourceSet().getEObject(URI.createURI("classpath:/org/eclipse/xtext/reference/ReferenceGrammar.xmi#//@rules.7"),true); 
	}
