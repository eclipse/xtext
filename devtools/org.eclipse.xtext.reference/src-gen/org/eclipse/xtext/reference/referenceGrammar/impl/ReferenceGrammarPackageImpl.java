 ...
 * </copyright>
 *
 * $Id: ReferenceGrammarPackageImpl.java,v 1.5 2009/02/19 21:08:18 sefftinge Exp $
 */
...
import org.eclipse.xtext.reference.referenceGrammar.Erwachsener;
import org.eclipse.xtext.reference.referenceGrammar.Familie;
import org.eclipse.xtext.reference.referenceGrammar.Farbe;
import org.eclipse.xtext.reference.referenceGrammar.Kind;
import org.eclipse.xtext.reference.referenceGrammar.Person;
import org.eclipse.xtext.reference.referenceGrammar.ReferenceGrammarFactory;
import org.eclipse.xtext.reference.referenceGrammar.ReferenceGrammarPackage;
import org.eclipse.xtext.reference.referenceGrammar.Spielplatz;
import org.eclipse.xtext.reference.referenceGrammar.Spielzeug;
...
public class ReferenceGrammarPackageImpl extends EPackageImpl implements ReferenceGrammarPackage
{
   ...
   * @see org.eclipse.xtext.reference.referenceGrammar.ReferenceGrammarPackage#eNS_URI
   * @see #init()
   * @generated
   */
  ...
  public static ReferenceGrammarPackage init()
  {
    ...
    ReferenceModelPackage.eINSTANCE.eClass();
   ...
   * @generated
   */
  public EReference getSpielplatz_Types()
  {
    return (EReference)spielplatzEClass.getEStructuralFeatures().get(6);
  }
  ...
  public void createPackageContents()
  {
    ...
    createEReference(spielplatzEClass, SPIELPLATZ__TYPES);
  ...
  public void initializePackageContents()
  {
    ...
    ReferenceModelPackage theReferenceModelPackage = (ReferenceModelPackage)EPackage.Registry.INSTANCE.getEPackage(ReferenceModelPackage.eNS_URI);
    ...
    initEReference(getSpielplatz_Types(), theReferenceModelPackage.getCustomType(), null, "types", null, 0, -1, Spielplatz.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
