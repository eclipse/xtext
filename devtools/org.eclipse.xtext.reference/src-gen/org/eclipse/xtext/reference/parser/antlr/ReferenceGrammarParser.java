...
public class ReferenceGrammarParser extends org.eclipse.xtext.parser.antlr.AbstractAntlrParser {
	...
	protected IParseResult parse(String ruleName, ANTLRInputStream in) {
		org.eclipse.xtext.reference.parser.antlr.internal.InternalReferenceGrammarLexer lexer = new org.eclipse.xtext.reference.parser.antlr.internal.InternalReferenceGrammarLexer(in);
		XtextTokenStream stream = new XtextTokenStream(lexer, antlrTokenDefProvider);
		stream.setInitialHiddenTokens("RULE_WS", "RULE_ML_COMMENT", "RULE_SL_COMMENT");
		org.eclipse.xtext.reference.parser.antlr.internal.InternalReferenceGrammarParser parser = new org.eclipse.xtext.reference.parser.antlr.internal.InternalReferenceGrammarParser(
