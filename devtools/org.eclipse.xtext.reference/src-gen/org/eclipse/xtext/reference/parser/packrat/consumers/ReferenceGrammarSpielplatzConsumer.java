...
public final class ReferenceGrammarSpielplatzConsumer extends NonTerminalConsumer {
	...
	public void setRule(SpielplatzElements rule) {
		...
		assignment$17$Consumer = new Assignment$17$Consumer(rule.getTypesAssignment_4_4());
		ruleCall$18$Consumer = new RuleCall$18$Consumer(rule.getTypesCustomTypeParserRuleParserRuleCall_4_4_0());
