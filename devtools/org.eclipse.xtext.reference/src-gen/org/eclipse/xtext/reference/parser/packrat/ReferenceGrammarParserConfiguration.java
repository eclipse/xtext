...
public class ReferenceGrammarParserConfiguration extends AbstractParserConfiguration {
	...
	public void configureConsumers() {
		...
		getFamilieConsumer().setKeyword$22$Delimiter(org.eclipse.xtext.reference.parser.packrat.ReferenceGrammarDelimiters.keyword$10$Delimiter);
		getFamilieConsumer().setKeyword$27$Delimiter(org.eclipse.xtext.reference.parser.packrat.ReferenceGrammarDelimiters.keyword$10$Delimiter);
		...
		getFamilieConsumer().setRuleCall$12$Delimiter(org.eclipse.xtext.reference.parser.packrat.ReferenceGrammarDelimiters.ruleCall$34$Delimiter);
		getFamilieConsumer().setRuleCall$16$Delimiter(org.eclipse.xtext.reference.parser.packrat.ReferenceGrammarDelimiters.ruleCall$34$Delimiter);
		getFamilieConsumer().setRuleCall$20$Delimiter(org.eclipse.xtext.reference.parser.packrat.ReferenceGrammarDelimiters.ruleCall$34$Delimiter);
		getFamilieConsumer().setRuleCall$26$Delimiter(org.eclipse.xtext.reference.parser.packrat.ReferenceGrammarDelimiters.ruleCall$34$Delimiter);
