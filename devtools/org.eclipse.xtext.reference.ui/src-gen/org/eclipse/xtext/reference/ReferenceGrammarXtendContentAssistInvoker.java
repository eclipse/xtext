 ...
 */
public class ReferenceGrammarXtendContentAssistInvoker extends AbstractXtendService implements IContentAssistInvocationHandler {

	private static final Logger log = Logger.getLogger(ReferenceGrammarXtendContentAssistInvoker.class);
