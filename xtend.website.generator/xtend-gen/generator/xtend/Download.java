...
public class Download extends AbstractXtendWebsite {
  ...
  public String getLink(final String platform) {
    ...
    String _plus = (("http://www.eclipse.org/downloads/download.php?file=/modeling/tmf/xtext/downloads/distros/eclipse-dsl-kepler-SR2-xtext-v2_6-" + platform) + _fileExtension);
    return (_plus + "&r=1");
  }
