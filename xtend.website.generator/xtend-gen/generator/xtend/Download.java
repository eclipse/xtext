...
public class Download extends AbstractXtendWebsite {
  ...
  public CharSequence contents() {
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t\t\t");
    _builder.append("The <a href=\"#library\">runtime library</a> is contained in the same Maven repository as the plug-in : <a href=\"http://build.eclipse.org/common/xtend/maven/\">http://build.eclipse.org/common/xtend/maven/</a>.");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t\t");
    _builder.append("</p>");
    _builder.newLine();
