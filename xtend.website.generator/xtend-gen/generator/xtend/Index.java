...
public class Index extends AbstractXtendWebsite {
	...
	public CharSequence contents() {
		...
		_builder_1.append("</p>");
		_builder_1.newLine();
		CharSequence _entry = this.entry("Less Noise", _builder_1.toString(), "images/icon-noise.png", "http://vimeo.com/12824833");
		...
		_builder_2.append("\t");
		_builder_2
				.append("Learn how to enhance existing Java APIs through <a href=\"documentation.html#extensionMethods\">extension methods</a> and <a href=\"documentation.html#lambdas\">lambda expressions</a>.");
		_builder_2.newLine();
		_builder_2.append("\t");
		_builder_2
				.append("Make use of <a href=\"documentation.html#operators\">operators</a> where you always wanted and <a href=\"documentation.html#switchExpression\">get rid of lengthy instanceof / casting orgies</a> in");
		_builder_2.newLine();
		_builder_2.append("\t");
		...
		_builder_2.append("</p>");
		_builder_2.newLine();
		CharSequence _entry_1 = this.entry("More Power", _builder_2.toString(), "images/icon-expressive.png", "http://vimeo.com/12824833");
		...
		_builder_3.append("\t");
		_builder_3
				.append("or cheap short-cuts. This guarantees that <strong>you won\'t run into any interoperability caveats</strong>. Integration with Java");
		_builder_3.newLine();
		_builder_3.append("\t");
		...
		_builder_3.append("</p>");
		_builder_3.newLine();
		CharSequence _entry_2 = this.entry("100% Java Compatible", _builder_3.toString(), "images/icon_interop.png",
		...
		_builder_4.append("\t");
		_builder_4
				.append("To ensure a great and holistic user experience, the IDE and the language have been designed side by side. And of course");
		_builder_4.newLine();
		_builder_4.append("\t");
		...
		_builder_4.append("</p>");
		_builder_4.newLine();
		CharSequence _entry_3 = this.entry("Better Tooling", _builder_4.toString(), "images/icon-tools.png", "http://vimeo.com/12824833");
		...
		_builder_5.append("</p>");
		_builder_5.newLine();
		CharSequence _entry_4 = this.entry("Easy to Learn", _builder_5.toString(), "images/icon_simple.png", "http://vimeo.com/12824833");
		...
		_builder_6.append("\t");
		_builder_6
				.append("Xtend not only resembles the type system to ensure 100% interoperability, it also generates comprehensible Java source code.");
		_builder_6.newLine();
		_builder_6.append("\t");
		_builder_6
				.append("This not only allows to run the code on platforms such as GWT, which doesn\'t understand bytecode, but also lets you see how certain language");
		_builder_6.newLine();
		_builder_6.append("\t");
		...
		_builder_6.append("</p>");
		_builder_6.newLine();
		CharSequence _entry_5 = this.entry("Still Java", _builder_6.toString(), "images/icon-java.png", "http://vimeo.com/12824833");
