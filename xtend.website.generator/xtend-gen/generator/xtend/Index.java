...
public class Index extends AbstractXtendWebsite {
  ...
  public CharSequence jsOnLoad() {
    ...
    _builder.newLine();
    _builder.append("var showNext = function (index) {");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("if (index >= elements.length) {");
    _builder.newLine();
    _builder.append("        ");
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("elements.hide().slice(index, index+1).fadeIn();");
    _builder.newLine();
    _builder.append("    ");
    _builder.append("setTimeout(function(){ showNext(index+1) }, 5000);");
    _builder.newLine();
    _builder.append("}");
    _builder.newLine();
    _builder.append("showNext(Math.floor((Math.random() * elements.length) + 1));");
    _builder.newLine();
  ...
  public CharSequence contents() {
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("<ul class=\"newsticker\">");
    _builder.newLine();
    _builder.append("\t\t      ");
    _builder.append("<li style=\"list-style-type: none;padding:20px;display:none;\"><a style=\"text-decoration:none; font-style: italic; font-size:18pt;\" href=\"http://dslmeinte.wordpress.com/2012/09/24/a-trick-for-speeding-up-xtend-building/\">&ldquo;I love Xtend and use it as much as possible.&rdquo; (Meinte Boersma)</a>");
    _builder.newLine();
    _builder.append("\t\t      ");
    ...
    _builder.newLine();
    _builder.append("\t\t      ");
    _builder.append("<li style=\"list-style-type: none;padding:20px;display:none;\"><a style=\"text-decoration:none; font-style: italic; font-size:18pt;\" href=\"https://groups.google.com/d/msg/xtend-lang/ABhngFZ4Qxg/cV76ZsFKUDEJ\">&ldquo;I am loving Xtend, and I wanted to say thanks.&rdquo; (Jacob Goodson)</a>");
    _builder.newLine();
    _builder.append("\t\t      ");
    _builder.append("<li style=\"list-style-type: none;padding:20px;display:none;\"><a style=\"text-decoration:none; font-style: italic; font-size:18pt;\" href=\"https://groups.google.com/d/msg/xtend-lang/ABhngFZ4Qxg/7sZbQy_inXYJ\">&ldquo;It&#39;s very comfortable to work with Xtend.&rdquo; (Ross Judson)</a>");
    _builder.newLine();
    _builder.append("\t\t      ");
    _builder.append("<li style=\"list-style-type: none;padding:20px;display:none;\"><a style=\"text-decoration:none; font-style: italic; font-size:18pt;\" href=\"https://groups.google.com/d/msg/xtend-lang/bdMs7kCBZSc/61jGMxH6ZmgJ\">&ldquo;Xtend rocks and I love using it :-)&rdquo; (Christian Vogel)</a>");
    _builder.newLine();
    _builder.append("\t\t      ");
    ...
    _builder.newLine();
    _builder.append("\t\t      ");
    _builder.append("<li style=\"list-style-type: none;padding:20px;display:none;\"><a style=\"text-decoration:none; font-style: italic; font-size:18pt;\" href=\"https://groups.google.com/d/msg/xtend-lang/En6rF8PTnG4/1mdU0QmJ3nYJ\">&ldquo;I love it!&rdquo; (Francois Green)</a>");
    _builder.newLine();
    _builder.append("\t\t      ");
    _builder.append("<li style=\"list-style-type: none;padding:20px;display:none;\"><a style=\"text-decoration:none; font-style: italic; font-size:18pt;\" href=\"https://groups.google.com/d/msg/xtend-lang/ABhngFZ4Qxg/7sZbQy_inXYJ\">&ldquo;Having idiomatic Java generated by the compiler is a great safety net.&rdquo; (Ross Judson)</a>");
    _builder.newLine();
    _builder.append("\t\t      ");
    _builder.append("<li style=\"list-style-type: none;padding:20px;display:none;\"><a style=\"text-decoration:none; font-style: italic; font-size:18pt;\" href=\"https://twitter.com/meinte37/status/507135731920556032\">&ldquo;Xtend could be described as &ldquo;Scala, the good parts&ldquo;.&rdquo; (Meinte Boersma)</a>");
    _builder.newLine();
    _builder.append("\t\t      ");
    _builder.append("<li style=\"list-style-type: none;padding:20px;\"><a style=\"text-decoration:none; font-style: italic; font-size:18pt;\" href=\"https://groups.google.com/d/msg/xtend-lang/mKAansrVhms/SzcfLEwZo_UJ\">&ldquo;Xtend is awesome for Android Programming!&rdquo; (Eugen)</a>");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("</ul>");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("<div class=\"span6 float feature\">");
    _builder.newLine();
    _builder.append("\t\t\t\t");
