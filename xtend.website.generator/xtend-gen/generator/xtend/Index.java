...
public class Index extends AbstractXtendWebsite {
  ...
  public CharSequence contents() {
    ...
    _builder.newLine();
    _builder.append("\t\t      ");
    _builder.append("<li style=\"list-style-type: none;padding:20px;display:none;\"><a style=\"text-decoration:none; font-style: italic; font-size:18pt;\" href=\"http://dslmeinte.wordpress.com/2012/09/24/a-trick-for-speeding-up-xtend-building/\">&ldquo;I love Xtend and use it as much as possible. (Meinte Boersma)&rdquo;</a>");
    _builder.newLine();
    _builder.append("\t\t      ");
