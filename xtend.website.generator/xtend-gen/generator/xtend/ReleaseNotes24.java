...
public class ReleaseNotes24 extends AbstractXtendWebsite {
  ...
  public CharSequence contents() {
    ...
    _builder.newLine();
    _builder.append("      ");
    _builder.append("the generate Java code can be customized arbitrarily. This doesn\'t break static typing ");
    _builder.newLine();
    _builder.append("      ");
    _builder.append("or the IDE! Any changes made in an active annotation are totally reflected by the environment");
    _builder.newLine();
    _builder.newLine();
    _builder.append("\t  ");
    ...
    _builder.newLine();
    _builder.append("      ");
    _builder.append("Extension methods is available in other language such as C# as well.");
    _builder.newLine();
    _builder.append("      ");
    _builder.append("The new \'extensions providers\' removes an important limitiation: In Xtend 2.4, fields, ");
    _builder.newLine();
    _builder.append("      ");
    ...
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("individually for a single project. They can either be set explicitly or delegate to what is");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("configured for the Java compiler.</p>");
    _builder.newLine();
    _builder.append("\t\t\t");
