...
public class FileImpl extends MinimalEObjectImpl.Container implements File
{
  ...
  {
    return SDomainPackage.Literals.FILE;
  }
  ...
  public EList<Element> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<Element>(Element.class, this, SDomainPackage.FILE__ELEMENTS);
    }
    return elements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SDomainPackage.FILE__ELEMENTS:
