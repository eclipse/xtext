...
public class NamespaceImpl extends ElementImpl implements Namespace
{
  ...
  {
    return SDomainPackage.Literals.NAMESPACE;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SDomainPackage.NAMESPACE__NAME, oldName, name));
  }
  ...
  public EList<Element> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<Element>(Element.class, this, SDomainPackage.NAMESPACE__ELEMENTS);
    }
    return elements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SDomainPackage.NAMESPACE__ELEMENTS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SDomainPackage.NAMESPACE__NAME:
        return getName();
      case SDomainPackage.NAMESPACE__ELEMENTS:
        return getElements();
    }
