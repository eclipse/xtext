...
@State(name = "org.eclipse.xtext.XtextGenerator", storages = {
		...
		@Storage(id = "prjDir", file = "${PROJECT_CONFIG_DIR$/org.eclipse.xtext.XtextGeneratorConfig.xml", scheme = StorageScheme.DIRECTORY_BASED)})
public class XtextFacetConfiguration extends AbstractFacetConfiguration {
	@Override
	protected String getTabTitle() {
		return "org.eclipse.xtext.Xtext facet";
	}
}
