...
@Singleton
public class SimpleBeeLangTestLanguageTokenTypeProvider implements TokenTypeProvider {
	...
	private static final TokenSet WHITESPACE_TOKENS = TokenSet.create(tokenTypes[PsiInternalSimpleBeeLangTestLanguageParser.RULE_WS]);
	private static final TokenSet COMMENT_TOKENS = TokenSet.create(tokenTypes[PsiInternalSimpleBeeLangTestLanguageParser.RULE_SL_COMMENT], tokenTypes[PsiInternalSimpleBeeLangTestLanguageParser.RULE_ML_COMMENT]);
