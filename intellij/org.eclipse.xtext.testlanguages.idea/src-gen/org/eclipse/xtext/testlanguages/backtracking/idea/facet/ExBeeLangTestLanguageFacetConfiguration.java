...
@State(name = "org.eclipse.xtext.testlanguages.backtracking.ExBeeLangTestLanguageGenerator", storages = {
		...
		@Storage(id = "prjDir", file = "${PROJECT_CONFIG_DIR$/org.eclipse.xtext.testlanguages.backtracking.ExBeeLangTestLanguageGeneratorConfig.xml", scheme = StorageScheme.DIRECTORY_BASED)})
public class ExBeeLangTestLanguageFacetConfiguration extends AbstractFacetConfiguration {
	@Override
	protected String getTabTitle() {
		return "org.eclipse.xtext.testlanguages.backtracking.ExBeeLangTestLanguage facet";
	}
}
