...
import org.eclipse.xtext.idea.generator.IdeaFileSystemAccess.IdeaFileSystemAccessProvider;
...
public class XtextModuleLevelBuilder extends ModuleLevelBuilder {
	...
	private static final Logger LOG = Logger.getInstance(XtextModuleLevelBuilder.class);
