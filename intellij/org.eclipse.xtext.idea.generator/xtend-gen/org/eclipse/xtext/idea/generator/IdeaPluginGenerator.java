...
public class IdeaPluginGenerator extends Xtend2GeneratorFragment {
  ...
  public CharSequence compileBuildProcessParametersProvider(final Grammar grammar) {
    ...
    _builder.newLine();
    _builder.append("import ");
    String _name_2 = BuildProcessParametersProvider.class.getName();
    _builder.append(_name_2, "");
    _builder.append(";");
    _builder.newLineIfNotEmpty();
    _builder.append("import ");
    String _name_3 = PluginManager.class.getName();
    _builder.append(_name_3, "");
    _builder.append(";");
    _builder.newLineIfNotEmpty();
    _builder.append("import ");
    String _name_4 = PluginId.class.getName();
  ...
  public CharSequence compileCodeBlockModificationListener(final Grammar grammar) {
    ...
    String _simpleName_2 = this._ideaPluginClassNames.toSimpleName(_codeBlockModificationListenerName_2);
    _builder.append(_simpleName_2, "\t");
    _builder.append("(");
    String _simpleName_3 = PsiModificationTracker.class.getSimpleName();
    ...
    _builder.newLine();
    {
      if (this.typesIntegrationRequired) {
        ...
        String _simpleName_5 = PsiTreeChangeEventImpl.class.getSimpleName();
  ...
  public CharSequence compileJvmTypesShortNamesCache(final Grammar grammar) {
    ...
    String _simpleName_2 = this._ideaPluginClassNames.toSimpleName(_jvmTypesShortNamesCacheName_2);
    _builder.append(_simpleName_2, "\t");
    _builder.append("(");
    String _simpleName_3 = Project.class.getSimpleName();
    _builder.append(_simpleName_3, "\t");
  ...
  public CharSequence compileJvmElementsReferencesSearch(final Grammar grammar) {
    ...
    String _simpleName_2 = this._ideaPluginClassNames.toSimpleName(_jvmElementsReferencesSearch_2);
    _builder.append(_simpleName_2, "\t");
    _builder.append("() {");
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t");
  ...
  public CharSequence compileJvmTypesElementFinder(final Grammar grammar) {
    ...
    String _simpleName_2 = this._ideaPluginClassNames.toSimpleName(_jvmTypesElementFinderName_2);
    _builder.append(_simpleName_2, "\t");
    _builder.append("(");
    String _simpleName_3 = Project.class.getSimpleName();
    _builder.append(_simpleName_3, "\t");
