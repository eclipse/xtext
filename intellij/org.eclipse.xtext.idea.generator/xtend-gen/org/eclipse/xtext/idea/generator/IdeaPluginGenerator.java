...
public class IdeaPluginGenerator extends Xtend2GeneratorFragment {
  ...
  public void generate(final Grammar grammar, final Xtend2ExecutionContext ctx) {
    ...
    ctx.writeFile(outlet_src, _javaPath_22, _compileColorSettingsPage);
  ...
  public CharSequence compileSyntaxHighlighter(final Grammar grammar) {
    ...
    boolean _doesUseXbase = XbaseGeneratorFragment.doesUseXbase(grammar);
    if (_doesUseXbase) {
      _xifexpression = "com.intellij.ide.highlighter.JavaHighlightingColors";
    } else {
      _xifexpression = "com.intellij.openapi.editor.DefaultLanguageHighlighterColors";
    }
    ...
    _builder.newLine();
    _builder.append("import ");
    _builder.append(colorsClass, "");
    _builder.append(";");
    _builder.newLineIfNotEmpty();
    _builder.append("import com.intellij.openapi.editor.HighlighterColors;");
    _builder.newLine();
    ...
    String _simpleName_1 = this._ideaPluginClassNames.toSimpleName(_languageName_1);
    _builder.append(_simpleName_1, "\t\t\t");
    _builder.append(".INSTANCE.getID() + HighlightingStyles.NUMBER_ID), ");
    String _simpleName_2 = this._ideaPluginClassNames.toSimpleName(colorsClass);
    _builder.append(_simpleName_2, "\t\t\t");
    _builder.append(".NUMBER);");
    _builder.newLineIfNotEmpty();
    _builder.newLine();
    _builder.append("\t");
    _builder.append("public final static TextAttributesKey KEYWORD = TextAttributesKey.createTextAttributesKey(");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("(");
    String _languageName_2 = this._ideaPluginClassNames.getLanguageName(grammar);
    ...
    _builder.append(_simpleName_3, "\t\t\t");
    _builder.append(".INSTANCE.getID() + HighlightingStyles.KEYWORD_ID),");
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t\t");
    String _simpleName_4 = this._ideaPluginClassNames.toSimpleName(colorsClass);
    _builder.append(_simpleName_4, "\t\t\t");
    _builder.append(".KEYWORD);");
    _builder.newLineIfNotEmpty();
    _builder.newLine();
    _builder.append("\t");
    _builder.append("public final static TextAttributesKey COMMENT = TextAttributesKey.createTextAttributesKey(");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("(");
    String _languageName_3 = this._ideaPluginClassNames.getLanguageName(grammar);
    ...
    _builder.append(_simpleName_5, "\t\t\t");
    _builder.append(".INSTANCE.getID() + HighlightingStyles.COMMENT_ID),");
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t\t");
    String _simpleName_6 = this._ideaPluginClassNames.toSimpleName(colorsClass);
    _builder.append(_simpleName_6, "\t\t\t");
    _builder.append(".LINE_COMMENT);");
    _builder.newLineIfNotEmpty();
    _builder.newLine();
    _builder.append("\t");
    _builder.append("public final static TextAttributesKey STRING = TextAttributesKey.createTextAttributesKey(");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("(");
    String _languageName_4 = this._ideaPluginClassNames.getLanguageName(grammar);
    String _simpleName_7 = this._ideaPluginClassNames.toSimpleName(_languageName_4);
    _builder.append(_simpleName_7, "\t\t\t");
    _builder.append(".INSTANCE.getID() + HighlightingStyles.STRING_ID), ");
    String _simpleName_8 = this._ideaPluginClassNames.toSimpleName(colorsClass);
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("TextAttributesKey _switchResult = null;");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("boolean _matched = false;");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("if (!_matched) {");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("if (Objects.equal(attribute, HighlightingStyles.NUMBER_ID)) {");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("_matched = true;");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("_switchResult = NUMBER;");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("if (Objects.equal(attribute, HighlightingStyles.KEYWORD_ID)) {");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("_matched = true;");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("_switchResult = KEYWORD;");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("if (Objects.equal(attribute, HighlightingStyles.STRING_ID)) {");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("_matched = true;");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("_switchResult = STRING;");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("if (Objects.equal(attribute, HighlightingStyles.COMMENT_ID)) {");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("_matched = true;");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("_switchResult = COMMENT;");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("_switchResult = HighlighterColors.TEXT;");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("}");
    _builder.newLine();
  ...
  public CharSequence compileDefaultColorSettingsPage(final Grammar grammar) {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("import com.intellij.openapi.options.colors.AttributesDescriptor;");
    _builder.newLine();
    _builder.newLine();
    _builder.append("public class ");
    ...
    _builder.newLineIfNotEmpty();
    _builder.append("\t");
    _builder.append("private AttributesDescriptor[] descriptors;");
    _builder.newLine();
    _builder.newLine();
    _builder.append("\t");
    _builder.append("public ");
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("public AttributesDescriptor[] getAttributeDescriptors() {");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("if (descriptors == null) {");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("this.descriptors = new AttributesDescriptor[] {");
    _builder.newLine();
    _builder.append("\t\t\t\t\t");
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("return this.descriptors;");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.append("return ");
    String _languageName_2 = this._ideaPluginClassNames.getLanguageName(grammar);
    String _simpleName_7 = this._ideaPluginClassNames.toSimpleName(_languageName_2);
    _builder.append(_simpleName_7, "\t\t");
