...
public class IdeaPluginGenerator extends Xtend2GeneratorFragment {
  ...
  public CharSequence compileBaseColorSettingsPage(final Grammar grammar) {
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("@Inject IHighlightingConfiguration highlightingConfiguration;");
    _builder.newLine();
    _builder.append("\t");
    _builder.newLine();
    _builder.append("\t");
    ...
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("Iterables.toArray(highlightingConfiguration.getAttributeDescriptors(), AttributesDescriptor.class);");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("}");
    _builder.newLine();
