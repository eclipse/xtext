...
public class IdeaPluginGenerator extends Xtend2GeneratorFragment {
  ...
  public void generate(final Grammar grammar, final Xtend2ExecutionContext ctx) {
    ...
    String _javaPath_21 = this._ideaPluginClassNames.toJavaPath(_highlightingConfiguration_1);
    CharSequence _compileHighlightingConfiguration = this.compileHighlightingConfiguration(grammar);
    ctx.writeFile(outlet_src_gen, _javaPath_21, _compileHighlightingConfiguration);
    String _baseColorSettingsPage = this._ideaPluginClassNames.baseColorSettingsPage(grammar);
    String _javaPath_22 = this._ideaPluginClassNames.toJavaPath(_baseColorSettingsPage);
    CharSequence _compileBaseColorSettingsPage = this.compileBaseColorSettingsPage(grammar);
    ctx.writeFile(outlet_src_gen, _javaPath_22, _compileBaseColorSettingsPage);
  ...
  public CharSequence compileHighlightingConfiguration(final Grammar grammar) {
    ...
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("return KEYWORD;");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("} else if (HighlightingStyles.STRING_ID.equals(attribute)) {");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("return STRING;");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("} else if (HighlightingStyles.COMMENT_ID.equals(attribute)) {");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("return COMMENT;");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("} else if (HighlightingStyles.NUMBER_ID.equals(attribute)) {");
    _builder.newLine();
    _builder.append("\t\t\t");
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("return HighlighterColors.TEXT;");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("}");
    _builder.newLine();
