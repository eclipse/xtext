...
public class IdeaParserExTest extends AbstractLanguageParsingTestCase {
  private IdeaParserExTestDelegate delegate;
  
  public IdeaParserExTest() {
    super(ExUnorderedGroupsTestLanguageFileType.INSTANCE);
    IdeaParserExTestDelegate _ideaParserExTestDelegate = new IdeaParserExTestDelegate(this);
    this.delegate = _ideaParserExTestDelegate;
  }
