...
class IdeaGrammarSerializerTest extends AbstractLanguageParsingTestCase {
	...
	IdeaGrammarSerializerTestDelegate delegate
	
	new() {
		super(XtextFileType.INSTANCE)
		delegate = new IdeaGrammarSerializerTestDelegate(this)
	}
...
class IdeaGrammarSerializerTestDelegate extends GrammarSerializerTest {
