...
@State(name = "org.eclipse.xtext.parser.indentation.IndentationAwareTestLanguageGenerator", storages = {
		...
		@Storage(id = "prjDir", file = "${PROJECT_CONFIG_DIR$/org.eclipse.xtext.parser.indentation.IndentationAwareTestLanguageGeneratorConfig.xml", scheme = StorageScheme.DIRECTORY_BASED)})
public class IndentationAwareTestLanguageFacetConfiguration extends AbstractFacetConfiguration {
	@Override
	protected String getTabTitle() {
		return "org.eclipse.xtext.parser.indentation.IndentationAwareTestLanguage facet";
	}
}
