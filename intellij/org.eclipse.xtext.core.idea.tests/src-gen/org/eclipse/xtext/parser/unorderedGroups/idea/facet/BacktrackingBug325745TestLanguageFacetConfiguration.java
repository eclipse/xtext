...
@State(name = "org.eclipse.xtext.parser.unorderedGroups.BacktrackingBug325745TestLanguageGenerator", storages = {
		...
		@Storage(id = "prjDir", file = "${PROJECT_CONFIG_DIR$/org.eclipse.xtext.parser.unorderedGroups.BacktrackingBug325745TestLanguageGeneratorConfig.xml", scheme = StorageScheme.DIRECTORY_BASED)})
public class BacktrackingBug325745TestLanguageFacetConfiguration extends AbstractFacetConfiguration {
	@Override
	protected String getTabTitle() {
		return "org.eclipse.xtext.parser.unorderedGroups.BacktrackingBug325745TestLanguage facet";
	}
}
