...
@State(name = "org.eclipse.xtext.parser.bug419429.Bug419429Generator", storages = {
		...
		@Storage(id = "dir", file = StoragePathMacros.PROJECT_CONFIG_DIR
				+ "/Bug419429GeneratorConfig.xml", scheme = StorageScheme.DIRECTORY_BASED)})
public class Bug419429FacetConfiguration extends AbstractFacetConfiguration<GeneratorConfigurationState> {
	@Override
