...
import static org.eclipse.xtext.parser.antlr.idea.parser.antlr.internal.PsiInternalBug301935ExTestLanguageParser.*;
...
@Singleton public class Bug301935ExTestLanguageTokenTypeProvider implements TokenTypeProvider {
	...
	static {
		for (int i = 0; i < tokenNames.length; i++) {
			tokenTypes[i] = new IndexedElementType(tokenNames[i], i, Bug301935ExTestLanguageLanguage.INSTANCE);
		}
	}
