...
public class Bug301935TestLanguageElementTypeProvider implements IElementTypeProvider {

	public static final IFileElementType FILE_TYPE = new XtextFileElementType<XtextFileStub<Bug301935TestLanguageFileImpl>>(Bug301935TestLanguageLanguage.INSTANCE);
	...
	private static final Bug301935TestLanguageGrammarAccess GRAMMAR_ACCESS = Bug301935TestLanguageLanguage.INSTANCE.getInstance(Bug301935TestLanguageGrammarAccess.class);

	private static class ModelFactory {
		public static IGrammarAwareElementType createModelElementType() {
			return new IGrammarAwareElementType("Model_ELEMENT_TYPE", Bug301935TestLanguageLanguage.INSTANCE, GRAMMAR_ACCESS.getModelRule());
		}
		public static IGrammarAwareElementType createModel_GroupElementType() {
			return new IGrammarAwareElementType("Model_Group_ELEMENT_TYPE", Bug301935TestLanguageLanguage.INSTANCE, GRAMMAR_ACCESS.getModelAccess().getGroup());
		}
		public static IGrammarAwareElementType createModel_NameAssignment_0ElementType() {
			return new IGrammarAwareElementType("Model_NameAssignment_0_ELEMENT_TYPE", Bug301935TestLanguageLanguage.INSTANCE, GRAMMAR_ACCESS.getModelAccess().getNameAssignment_0());
		}
		public static IGrammarAwareElementType createModel_NameIDTerminalRuleCall_0_0ElementType() {
			return new IGrammarAwareElementType("Model_NameIDTerminalRuleCall_0_0_ELEMENT_TYPE", Bug301935TestLanguageLanguage.INSTANCE, GRAMMAR_ACCESS.getModelAccess().getNameIDTerminalRuleCall_0_0());
		}
		public static IGrammarAwareElementType createModel_WSTerminalRuleCall_1ElementType() {
			return new IGrammarAwareElementType("Model_WSTerminalRuleCall_1_ELEMENT_TYPE", Bug301935TestLanguageLanguage.INSTANCE, GRAMMAR_ACCESS.getModelAccess().getWSTerminalRuleCall_1());
		}
		public static IGrammarAwareElementType createModel_ValueAssignment_2ElementType() {
			return new IGrammarAwareElementType("Model_ValueAssignment_2_ELEMENT_TYPE", Bug301935TestLanguageLanguage.INSTANCE, GRAMMAR_ACCESS.getModelAccess().getValueAssignment_2());
		}
		public static IGrammarAwareElementType createModel_ValueIDTerminalRuleCall_2_0ElementType() {
			return new IGrammarAwareElementType("Model_ValueIDTerminalRuleCall_2_0_ELEMENT_TYPE", Bug301935TestLanguageLanguage.INSTANCE, GRAMMAR_ACCESS.getModelAccess().getValueIDTerminalRuleCall_2_0());
		}
		public static IGrammarAwareElementType createModel_NLParserRuleCall_3ElementType() {
			return new IGrammarAwareElementType("Model_NLParserRuleCall_3_ELEMENT_TYPE", Bug301935TestLanguageLanguage.INSTANCE, GRAMMAR_ACCESS.getModelAccess().getNLParserRuleCall_3());
		}
		public static IGrammarAwareElementType createModel_Value2Assignment_4ElementType() {
			return new IGrammarAwareElementType("Model_Value2Assignment_4_ELEMENT_TYPE", Bug301935TestLanguageLanguage.INSTANCE, GRAMMAR_ACCESS.getModelAccess().getValue2Assignment_4());
		}
		public static IGrammarAwareElementType createModel_Value2IDTerminalRuleCall_4_0ElementType() {
			return new IGrammarAwareElementType("Model_Value2IDTerminalRuleCall_4_0_ELEMENT_TYPE", Bug301935TestLanguageLanguage.INSTANCE, GRAMMAR_ACCESS.getModelAccess().getValue2IDTerminalRuleCall_4_0());
		}
		public static IGrammarAwareElementType createModel_WSTerminalRuleCall_5ElementType() {
			return new IGrammarAwareElementType("Model_WSTerminalRuleCall_5_ELEMENT_TYPE", Bug301935TestLanguageLanguage.INSTANCE, GRAMMAR_ACCESS.getModelAccess().getWSTerminalRuleCall_5());
		}
	}
	...
	private static class NLFactory {
		public static IGrammarAwareElementType createNLElementType() {
			return new IGrammarAwareElementType("NL_ELEMENT_TYPE", Bug301935TestLanguageLanguage.INSTANCE, GRAMMAR_ACCESS.getNLRule());
		}
		public static IGrammarAwareElementType createNL_GroupElementType() {
			return new IGrammarAwareElementType("NL_Group_ELEMENT_TYPE", Bug301935TestLanguageLanguage.INSTANCE, GRAMMAR_ACCESS.getNLAccess().getGroup());
		}
		public static IGrammarAwareElementType createNL_WSTerminalRuleCall_0ElementType() {
			return new IGrammarAwareElementType("NL_WSTerminalRuleCall_0_ELEMENT_TYPE", Bug301935TestLanguageLanguage.INSTANCE, GRAMMAR_ACCESS.getNLAccess().getWSTerminalRuleCall_0());
		}
