...
import static org.eclipse.xtext.parser.antlr.idea.parser.antlr.internal.PsiInternalBug443221TestLanguageParser.*;
...
@Singleton public class Bug443221TestLanguageTokenTypeProvider implements TokenTypeProvider {

	private static final String[] TOKEN_NAMES = new PsiInternalBug443221TestLanguageParser(null).getTokenNames();

	private static final IElementType[] tokenTypes = new IElementType[TOKEN_NAMES.length];
	
	static {
		for (int i = 0; i < TOKEN_NAMES.length; i++) {
			tokenTypes[i] = new IndexedElementType(TOKEN_NAMES[i], i, Bug443221TestLanguageLanguage.INSTANCE);
		}
	}
