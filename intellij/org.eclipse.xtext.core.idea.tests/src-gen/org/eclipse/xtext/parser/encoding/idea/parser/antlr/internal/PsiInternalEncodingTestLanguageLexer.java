...
public class PsiInternalEncodingTestLanguageLexer extends Lexer {
    ...
    public final void mRULE_LEXEME() throws RecognitionException {
        try {
            ...
            // PsiInternalEncodingTestLanguage.g:107:13: ( ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '\\u00E4' | '\\u00F6' | '\\u00FC' | '\\u00DF' | '\\u00C4' | '\\u00D6' | '\\u00DC' )* )
            // PsiInternalEncodingTestLanguage.g:107:15: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '\\u00E4' | '\\u00F6' | '\\u00FC' | '\\u00DF' | '\\u00C4' | '\\u00D6' | '\\u00DC' )*
            {
            // PsiInternalEncodingTestLanguage.g:107:15: ( 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '\\u00E4' | '\\u00F6' | '\\u00FC' | '\\u00DF' | '\\u00C4' | '\\u00D6' | '\\u00DC' )*
            loop1:
            do {
                ...
                switch (alt1) {
            	case 1 :
            	    // PsiInternalEncodingTestLanguage.g:
            	    {
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // PsiInternalEncodingTestLanguage.g:109:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // PsiInternalEncodingTestLanguage.g:109:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // PsiInternalEncodingTestLanguage.g:109:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt2=0;
            loop2:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // PsiInternalEncodingTestLanguage.g:111:16: ( . )
            // PsiInternalEncodingTestLanguage.g:111:18: .
            {
            matchAny(); 
    ...
    public void mTokens() throws RecognitionException {
        // PsiInternalEncodingTestLanguage.g:1:8: ( RULE_LEXEME | RULE_WS | RULE_ANY_OTHER )
        int alt3=3;
        ...
        switch (alt3) {
            case 1 :
                // PsiInternalEncodingTestLanguage.g:1:10: RULE_LEXEME
                {
                mRULE_LEXEME(); 
                ...
                break;
            case 2 :
                // PsiInternalEncodingTestLanguage.g:1:22: RULE_WS
                {
                mRULE_WS(); 
                ...
                break;
            case 3 :
                // PsiInternalEncodingTestLanguage.g:1:30: RULE_ANY_OTHER
                {
                mRULE_ANY_OTHER(); 
