...
@State(name = "org.eclipse.xtext.parsetree.reconstr.PartialSerializationTestLanguageGenerator", storages = {
		...
		@Storage(id = "prjDir", file = "${PROJECT_CONFIG_DIR$/org.eclipse.xtext.parsetree.reconstr.PartialSerializationTestLanguageGeneratorConfig.xml", scheme = StorageScheme.DIRECTORY_BASED)})
public class PartialSerializationTestLanguageFacetConfiguration extends AbstractFacetConfiguration {
	@Override
	protected String getTabTitle() {
		return "org.eclipse.xtext.parsetree.reconstr.PartialSerializationTestLanguage facet";
	}
}
