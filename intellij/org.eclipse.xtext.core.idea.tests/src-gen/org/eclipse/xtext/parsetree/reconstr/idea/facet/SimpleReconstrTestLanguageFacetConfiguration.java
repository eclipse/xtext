...
@State(name = "org.eclipse.xtext.parsetree.reconstr.SimpleReconstrTestLanguageGenerator", storages = {
		...
		@Storage(id = "prjDir", file = "${PROJECT_CONFIG_DIR$/org.eclipse.xtext.parsetree.reconstr.SimpleReconstrTestLanguageGeneratorConfig.xml", scheme = StorageScheme.DIRECTORY_BASED)})
public class SimpleReconstrTestLanguageFacetConfiguration extends AbstractFacetConfiguration {
	@Override
	protected String getTabTitle() {
		return "org.eclipse.xtext.parsetree.reconstr.SimpleReconstrTestLanguage facet";
	}
}
