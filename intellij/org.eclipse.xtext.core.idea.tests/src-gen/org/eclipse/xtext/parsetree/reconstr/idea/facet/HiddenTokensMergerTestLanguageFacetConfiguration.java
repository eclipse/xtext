...
@State(name = "org.eclipse.xtext.parsetree.reconstr.HiddenTokensMergerTestLanguageGenerator", storages = {
		...
		@Storage(id = "prjDir", file = "${PROJECT_CONFIG_DIR$/org.eclipse.xtext.parsetree.reconstr.HiddenTokensMergerTestLanguageGeneratorConfig.xml", scheme = StorageScheme.DIRECTORY_BASED)})
public class HiddenTokensMergerTestLanguageFacetConfiguration extends AbstractFacetConfiguration {
	@Override
	protected String getTabTitle() {
		return "org.eclipse.xtext.parsetree.reconstr.HiddenTokensMergerTestLanguage facet";
	}
}
