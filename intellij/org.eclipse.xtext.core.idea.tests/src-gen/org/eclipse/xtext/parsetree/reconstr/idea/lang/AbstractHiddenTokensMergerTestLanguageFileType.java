...
public class AbstractHiddenTokensMergerTestLanguageFileType extends LanguageFileType {

	@NonNls 
	public static final String DEFAULT_EXTENSION = "hiddentokensmergertestlanguage";

	protected AbstractHiddenTokensMergerTestLanguageFileType(final Language language) {
		super(language);
	}
