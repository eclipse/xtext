...
@State(name = "org.eclipse.xtext.valueconverter.Bug250313Generator", storages = {
		...
		@Storage(id = "dir", file = StoragePathMacros.PROJECT_CONFIG_DIR
				+ "/Bug250313GeneratorConfig.xml", scheme = StorageScheme.DIRECTORY_BASED)})
public class Bug250313FacetConfiguration extends AbstractFacetConfiguration<GeneratorConfigurationState> {
	@Override
