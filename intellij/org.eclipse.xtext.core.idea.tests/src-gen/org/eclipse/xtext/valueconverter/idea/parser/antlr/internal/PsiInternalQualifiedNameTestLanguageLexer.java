...
public class PsiInternalQualifiedNameTestLanguageLexer extends Lexer {
    ...
    public final void mT__11() throws RecognitionException {
        try {
            ...
            // PsiInternalQualifiedNameTestLanguage.g:11:7: ( 'keyword' )
            // PsiInternalQualifiedNameTestLanguage.g:11:9: 'keyword'
            {
            match("keyword"); 
    ...
    public final void mT__12() throws RecognitionException {
        try {
            int _type = T__12;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // PsiInternalQualifiedNameTestLanguage.g:12:7: ( '.' )
            // PsiInternalQualifiedNameTestLanguage.g:12:9: '.'
            {
            match('.'); 
    ...
    public final void mT__13() throws RecognitionException {
        try {
            int _type = T__13;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // PsiInternalQualifiedNameTestLanguage.g:13:7: ( '*' )
            // PsiInternalQualifiedNameTestLanguage.g:13:9: '*'
            {
            match('*'); 
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            ...
            do {
                ...
                switch (alt2) {
            	case 1 :
            	    // PsiInternalQualifiedNameTestLanguage.g:
            	    {
    ...
    public void mTokens() throws RecognitionException {
        // PsiInternalQualifiedNameTestLanguage.g:1:8: ( T__11 | T__12 | T__13 | RULE_ID | RULE_INT | RULE_STRING | RULE_ML_COMMENT | RULE_SL_COMMENT | RULE_WS | RULE_ANY_OTHER )
        int alt12=10;
        alt12 = dfa12.predict(input);
        switch (alt12) {
            case 1 :
                // PsiInternalQualifiedNameTestLanguage.g:1:10: T__11
                {
                mT__11(); 
                ...
                break;
            case 2 :
                // PsiInternalQualifiedNameTestLanguage.g:1:16: T__12
                {
                mT__12(); 
                ...
                break;
            case 3 :
                // PsiInternalQualifiedNameTestLanguage.g:1:22: T__13
                {
                mT__13(); 
                ...
                break;
            case 4 :
                // PsiInternalQualifiedNameTestLanguage.g:1:28: RULE_ID
                {
                mRULE_ID(); 
                ...
                break;
            case 5 :
                // PsiInternalQualifiedNameTestLanguage.g:1:36: RULE_INT
                {
                mRULE_INT(); 
                ...
                break;
            case 6 :
                // PsiInternalQualifiedNameTestLanguage.g:1:45: RULE_STRING
                {
                mRULE_STRING(); 
                ...
                break;
            case 7 :
                // PsiInternalQualifiedNameTestLanguage.g:1:57: RULE_ML_COMMENT
                {
                mRULE_ML_COMMENT(); 
                ...
                break;
            case 8 :
                // PsiInternalQualifiedNameTestLanguage.g:1:73: RULE_SL_COMMENT
                {
                mRULE_SL_COMMENT(); 
                ...
                break;
            case 9 :
                // PsiInternalQualifiedNameTestLanguage.g:1:89: RULE_WS
                {
                mRULE_WS(); 
                ...
                break;
            case 10 :
                // PsiInternalQualifiedNameTestLanguage.g:1:97: RULE_ANY_OTHER
                {
                mRULE_ANY_OTHER(); 
