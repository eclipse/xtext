...
import static org.eclipse.xtext.resource.idea.parser.antlr.internal.PsiInternalBug385636Parser.*;
...
@Singleton public class Bug385636TokenTypeProvider implements TokenTypeProvider {

	private static final String[] TOKEN_NAMES = new PsiInternalBug385636Parser(null).getTokenNames();

	private static final IElementType[] tokenTypes = new IElementType[TOKEN_NAMES.length];
	
	static {
		for (int i = 0; i < TOKEN_NAMES.length; i++) {
			tokenTypes[i] = new IndexedElementType(TOKEN_NAMES[i], i, Bug385636Language.INSTANCE);
		}
	}
