...
public class AbstractLocationProviderTestLanguageFileType extends LanguageFileType {

	@NonNls 
	public static final String DEFAULT_EXTENSION = "locationprovidertestlanguage";

	protected AbstractLocationProviderTestLanguageFileType(final Language language) {
		super(language);
	}
