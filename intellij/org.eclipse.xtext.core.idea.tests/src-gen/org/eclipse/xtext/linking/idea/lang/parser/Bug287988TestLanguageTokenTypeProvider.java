...
import static org.eclipse.xtext.linking.idea.parser.antlr.internal.PsiInternalBug287988TestLanguageParser.*;
...
@Singleton public class Bug287988TestLanguageTokenTypeProvider implements TokenTypeProvider {

	private static final String[] TOKEN_NAMES = new PsiInternalBug287988TestLanguageParser(null).getTokenNames();

	private static final IElementType[] tokenTypes = new IElementType[TOKEN_NAMES.length];
	
	static {
		for (int i = 0; i < TOKEN_NAMES.length; i++) {
			tokenTypes[i] = new IndexedElementType(TOKEN_NAMES[i], i, Bug287988TestLanguageLanguage.INSTANCE);
		}
	}
