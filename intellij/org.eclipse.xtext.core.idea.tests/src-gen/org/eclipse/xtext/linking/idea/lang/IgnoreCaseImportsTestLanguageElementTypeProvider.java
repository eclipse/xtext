...
public class IgnoreCaseImportsTestLanguageElementTypeProvider implements IElementTypeProvider {

	public static final IFileElementType FILE_TYPE = new XtextFileElementType<XtextFileStub<IgnoreCaseImportsTestLanguageFileImpl>>(IgnoreCaseImportsTestLanguageLanguage.INSTANCE);
	...
	private static final IgnoreCaseImportsTestLanguageGrammarAccess GRAMMAR_ACCESS = IgnoreCaseImportsTestLanguageLanguage.INSTANCE.getInstance(IgnoreCaseImportsTestLanguageGrammarAccess.class);

	private static class ModelFactory {
		public static IGrammarAwareElementType createModelElementType() {
			return new IGrammarAwareElementType("Model_ELEMENT_TYPE", IgnoreCaseImportsTestLanguageLanguage.INSTANCE, GRAMMAR_ACCESS.getModelRule());
		}
		public static IGrammarAwareElementType createModel_GroupElementType() {
			return new IGrammarAwareElementType("Model_Group_ELEMENT_TYPE", IgnoreCaseImportsTestLanguageLanguage.INSTANCE, GRAMMAR_ACCESS.getModelAccess().getGroup());
		}
		public static IGrammarAwareElementType createModel_ImportsAssignment_0ElementType() {
			return new IGrammarAwareElementType("Model_ImportsAssignment_0_ELEMENT_TYPE", IgnoreCaseImportsTestLanguageLanguage.INSTANCE, GRAMMAR_ACCESS.getModelAccess().getImportsAssignment_0());
		}
		public static IGrammarAwareElementType createModel_ImportsImportParserRuleCall_0_0ElementType() {
			return new IGrammarAwareElementType("Model_ImportsImportParserRuleCall_0_0_ELEMENT_TYPE", IgnoreCaseImportsTestLanguageLanguage.INSTANCE, GRAMMAR_ACCESS.getModelAccess().getImportsImportParserRuleCall_0_0());
		}
		public static IGrammarAwareElementType createModel_ElementsAssignment_1ElementType() {
			return new IGrammarAwareElementType("Model_ElementsAssignment_1_ELEMENT_TYPE", IgnoreCaseImportsTestLanguageLanguage.INSTANCE, GRAMMAR_ACCESS.getModelAccess().getElementsAssignment_1());
		}
		public static IGrammarAwareElementType createModel_ElementsElementParserRuleCall_1_0ElementType() {
			return new IGrammarAwareElementType("Model_ElementsElementParserRuleCall_1_0_ELEMENT_TYPE", IgnoreCaseImportsTestLanguageLanguage.INSTANCE, GRAMMAR_ACCESS.getModelAccess().getElementsElementParserRuleCall_1_0());
		}
	}
	...
	private static class ImportFactory {
		public static IGrammarAwareElementType createImportElementType() {
			return new IGrammarAwareElementType("Import_ELEMENT_TYPE", IgnoreCaseImportsTestLanguageLanguage.INSTANCE, GRAMMAR_ACCESS.getImportRule());
		}
		public static IGrammarAwareElementType createImport_ImportURIAssignmentElementType() {
			return new IGrammarAwareElementType("Import_ImportURIAssignment_ELEMENT_TYPE", IgnoreCaseImportsTestLanguageLanguage.INSTANCE, GRAMMAR_ACCESS.getImportAccess().getImportURIAssignment());
		}
		public static IGrammarAwareElementType createImport_ImportURISTRINGTerminalRuleCall_0ElementType() {
			return new IGrammarAwareElementType("Import_ImportURISTRINGTerminalRuleCall_0_ELEMENT_TYPE", IgnoreCaseImportsTestLanguageLanguage.INSTANCE, GRAMMAR_ACCESS.getImportAccess().getImportURISTRINGTerminalRuleCall_0());
		}
	}

	public static final IGrammarAwareElementType Import_ELEMENT_TYPE = associate(ImportFactory.createImportElementType());

	public static final IGrammarAwareElementType Import_ImportURIAssignment_ELEMENT_TYPE = associate(ImportFactory.createImport_ImportURIAssignmentElementType());

	public static final IGrammarAwareElementType Import_ImportURISTRINGTerminalRuleCall_0_ELEMENT_TYPE = associate(ImportFactory.createImport_ImportURISTRINGTerminalRuleCall_0ElementType());

	private static class ElementFactory {
		public static IGrammarAwareElementType createElementElementType() {
			return new IGrammarAwareElementType("Element_ELEMENT_TYPE", IgnoreCaseImportsTestLanguageLanguage.INSTANCE, GRAMMAR_ACCESS.getElementRule());
		}
		public static IGrammarAwareElementType createElement_GroupElementType() {
			return new IGrammarAwareElementType("Element_Group_ELEMENT_TYPE", IgnoreCaseImportsTestLanguageLanguage.INSTANCE, GRAMMAR_ACCESS.getElementAccess().getGroup());
		}
		public static IGrammarAwareElementType createElement_NameAssignment_0ElementType() {
			return new IGrammarAwareElementType("Element_NameAssignment_0_ELEMENT_TYPE", IgnoreCaseImportsTestLanguageLanguage.INSTANCE, GRAMMAR_ACCESS.getElementAccess().getNameAssignment_0());
		}
		public static IGrammarAwareElementType createElement_NameIDTerminalRuleCall_0_0ElementType() {
			return new IGrammarAwareElementType("Element_NameIDTerminalRuleCall_0_0_ELEMENT_TYPE", IgnoreCaseImportsTestLanguageLanguage.INSTANCE, GRAMMAR_ACCESS.getElementAccess().getNameIDTerminalRuleCall_0_0());
		}
		public static IGrammarAwareElementType createElement_ReferenceAssignment_1ElementType() {
			return new IGrammarAwareElementType("Element_ReferenceAssignment_1_ELEMENT_TYPE", IgnoreCaseImportsTestLanguageLanguage.INSTANCE, GRAMMAR_ACCESS.getElementAccess().getReferenceAssignment_1());
		}
		public static IGrammarAwareElementType createElement_ReferenceElementCrossReference_1_0ElementType() {
			return new IGrammarAwareElementType("Element_ReferenceElementCrossReference_1_0_ELEMENT_TYPE", IgnoreCaseImportsTestLanguageLanguage.INSTANCE, GRAMMAR_ACCESS.getElementAccess().getReferenceElementCrossReference_1_0());
		}
		public static IGrammarAwareElementType createElement_ReferenceElementIDTerminalRuleCall_1_0_1ElementType() {
			return new IGrammarAwareElementType("Element_ReferenceElementIDTerminalRuleCall_1_0_1_ELEMENT_TYPE", IgnoreCaseImportsTestLanguageLanguage.INSTANCE, GRAMMAR_ACCESS.getElementAccess().getReferenceElementIDTerminalRuleCall_1_0_1());
		}
		public static IGrammarAwareElementType createElement_LeftCurlyBracketKeyword_2ElementType() {
			return new IGrammarAwareElementType("Element_LeftCurlyBracketKeyword_2_ELEMENT_TYPE", IgnoreCaseImportsTestLanguageLanguage.INSTANCE, GRAMMAR_ACCESS.getElementAccess().getLeftCurlyBracketKeyword_2());
		}
		public static IGrammarAwareElementType createElement_ElementsAssignment_3ElementType() {
			return new IGrammarAwareElementType("Element_ElementsAssignment_3_ELEMENT_TYPE", IgnoreCaseImportsTestLanguageLanguage.INSTANCE, GRAMMAR_ACCESS.getElementAccess().getElementsAssignment_3());
		}
		public static IGrammarAwareElementType createElement_ElementsElementParserRuleCall_3_0ElementType() {
			return new IGrammarAwareElementType("Element_ElementsElementParserRuleCall_3_0_ELEMENT_TYPE", IgnoreCaseImportsTestLanguageLanguage.INSTANCE, GRAMMAR_ACCESS.getElementAccess().getElementsElementParserRuleCall_3_0());
		}
		public static IGrammarAwareElementType createElement_RightCurlyBracketKeyword_4ElementType() {
			return new IGrammarAwareElementType("Element_RightCurlyBracketKeyword_4_ELEMENT_TYPE", IgnoreCaseImportsTestLanguageLanguage.INSTANCE, GRAMMAR_ACCESS.getElementAccess().getRightCurlyBracketKeyword_4());
		}
	}
	...
	public IGrammarAwareElementType getImport_ImportURIAssignmentElementType() {
		return Import_ImportURIAssignment_ELEMENT_TYPE;
	}

	public IGrammarAwareElementType getImport_ImportURISTRINGTerminalRuleCall_0ElementType() {
		return Import_ImportURISTRINGTerminalRuleCall_0_ELEMENT_TYPE;
	}
