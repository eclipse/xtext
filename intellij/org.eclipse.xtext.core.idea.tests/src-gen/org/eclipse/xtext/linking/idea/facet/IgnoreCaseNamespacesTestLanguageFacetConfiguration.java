...
@State(name = "org.eclipse.xtext.linking.IgnoreCaseNamespacesTestLanguageGenerator", storages = {
		...
		@Storage(id = "dir", file = StoragePathMacros.PROJECT_CONFIG_DIR
				+ "/IgnoreCaseNamespacesTestLanguageGeneratorConfig.xml", scheme = StorageScheme.DIRECTORY_BASED)})
public class IgnoreCaseNamespacesTestLanguageFacetConfiguration extends AbstractFacetConfiguration<GeneratorConfigurationState> {
	@Override
