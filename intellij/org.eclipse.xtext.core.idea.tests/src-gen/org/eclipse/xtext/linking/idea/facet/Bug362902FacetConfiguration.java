...
@State(name = "org.eclipse.xtext.linking.Bug362902Generator", storages = {
		...
		@Storage(id = "dir", file = StoragePathMacros.PROJECT_CONFIG_DIR
				+ "/Bug362902GeneratorConfig.xml", scheme = StorageScheme.DIRECTORY_BASED)})
public class Bug362902FacetConfiguration extends AbstractFacetConfiguration<GeneratorConfigurationState> {
	@Override
