...
import static org.eclipse.xtext.generator.ecore.idea.parser.antlr.internal.PsiInternalSuperTestLanguageParser.*;
...
@Singleton public class SuperTestLanguageTokenTypeProvider implements TokenTypeProvider {

	private static final IElementType[] tokenTypes = new IElementType[tokenNames.length];
	
	static {
		for (int i = 0; i < tokenNames.length; i++) {
			tokenTypes[i] = new IndexedElementType(tokenNames[i], i, SuperTestLanguageLanguage.INSTANCE);
		}
	}
