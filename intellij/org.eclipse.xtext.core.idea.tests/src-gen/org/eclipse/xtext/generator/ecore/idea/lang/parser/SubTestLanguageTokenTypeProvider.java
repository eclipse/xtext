...
import static org.eclipse.xtext.generator.ecore.idea.parser.antlr.internal.PsiInternalSubTestLanguageParser.*;
...
@Singleton public class SubTestLanguageTokenTypeProvider implements TokenTypeProvider {

	private static final IElementType[] tokenTypes = new IElementType[tokenNames.length];
	
	static {
		for (int i = 0; i < tokenNames.length; i++) {
			tokenTypes[i] = new IndexedElementType(tokenNames[i], i, SubTestLanguageLanguage.INSTANCE);
		}
	}
