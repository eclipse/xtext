...
public class AbstractSyntacticSequencerTestLanguageFileType extends LanguageFileType {

	@NonNls 
	public static final String DEFAULT_EXTENSION = "syntacticsequencertestlanguage";

	protected AbstractSyntacticSequencerTestLanguageFileType(final Language language) {
		super(language);
	}
