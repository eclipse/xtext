...
public class PsiInternalConcreteTestLanguageLexer extends Lexer {
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // PsiInternalConcreteTestLanguage.g:510:9: ( SUPER_ID )
            // PsiInternalConcreteTestLanguage.g:510:11: SUPER_ID
            {
            mSUPER_ID(); 
    ...
    public final void mRULE_REAL() throws RecognitionException {
        try {
            int _type = RULE_REAL;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // PsiInternalConcreteTestLanguage.g:512:11: ( RULE_INT '.' RULE_INT )
            // PsiInternalConcreteTestLanguage.g:512:13: RULE_INT '.' RULE_INT
            {
            mRULE_INT(); 
            match('.'); 
            mRULE_INT(); 
    ...
    public final void mSUPER_ID() throws RecognitionException {
        try {
            int _type = SUPER_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // PsiInternalConcreteTestLanguage.g:514:10: ( ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '\\u00F6' | '\\u00E4' | '\\u00FC' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )* )
            // PsiInternalConcreteTestLanguage.g:514:12: ( '^' )? ( 'a' .. 'z' | 'A' .. 'Z' | '\\u00F6' | '\\u00E4' | '\\u00FC' | '_' ) ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            {
            // PsiInternalConcreteTestLanguage.g:514:12: ( '^' )?
            int alt1=2;
            ...
            // PsiInternalConcreteTestLanguage.g:514:68: ( 'a' .. 'z' | 'A' .. 'Z' | '_' | '0' .. '9' )*
            loop2:
            do {
                int alt2=2;
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // PsiInternalConcreteTestLanguage.g:516:10: ( ( '0' .. '9' )+ )
            // PsiInternalConcreteTestLanguage.g:516:12: ( '0' .. '9' )+
            {
            // PsiInternalConcreteTestLanguage.g:516:12: ( '0' .. '9' )+
            int cnt3=0;
            loop3:
            do {
                ...
                switch (alt3) {
            	case 1 :
            	    // PsiInternalConcreteTestLanguage.g:516:13: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // PsiInternalConcreteTestLanguage.g:518:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // PsiInternalConcreteTestLanguage.g:518:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // PsiInternalConcreteTestLanguage.g:518:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt6=2;
            ...
            switch (alt6) {
                case 1 :
                    // PsiInternalConcreteTestLanguage.g:518:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // PsiInternalConcreteTestLanguage.g:518:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop4:
                    do {
                        int alt4=3;
                        ...
                        switch (alt4) {
                    	case 1 :
                    	    // PsiInternalConcreteTestLanguage.g:518:21: '\\\\' .
                    	    {
                    	    match('\\'); 
                    	    matchAny(); 
                    	    ...
                    	    break;
                    	case 2 :
                    	    // PsiInternalConcreteTestLanguage.g:518:28: ~ ( ( '\\\\' | '\"' ) )
                    	    {
                    ...
                    break;
                case 2 :
                    // PsiInternalConcreteTestLanguage.g:518:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // PsiInternalConcreteTestLanguage.g:518:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop5:
                    do {
                        int alt5=3;
                        ...
                        switch (alt5) {
                    	case 1 :
                    	    // PsiInternalConcreteTestLanguage.g:518:54: '\\\\' .
                    	    {
                    	    match('\\'); 
                    	    matchAny(); 
                    	    ...
                    	    break;
                    	case 2 :
                    	    // PsiInternalConcreteTestLanguage.g:518:61: ~ ( ( '\\\\' | '\\'' ) )
                    	    {
                    	    if ( (input.LA(1)>='\u0000' && input.LA(1)<='&')||(input.LA(1)>='(' && input.LA(1)<='[')||(input.LA(1)>=']' && input.LA(1)<='\uFFFF') ) {
                    	        input.consume();
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // PsiInternalConcreteTestLanguage.g:520:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // PsiInternalConcreteTestLanguage.g:520:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // PsiInternalConcreteTestLanguage.g:520:24: ( options {greedy=false; } : . )*
            loop7:
            do {
                int alt7=2;
                ...
                switch (alt7) {
            	case 1 :
            	    // PsiInternalConcreteTestLanguage.g:520:52: .
            	    {
            	    matchAny(); 
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // PsiInternalConcreteTestLanguage.g:522:17: ( '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )? )
            // PsiInternalConcreteTestLanguage.g:522:19: '//' (~ ( ( '\\n' | '\\r' ) ) )* ( ( '\\r' )? '\\n' )?
            {
            match("//"); 

            // PsiInternalConcreteTestLanguage.g:522:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop8:
            do {
                int alt8=2;
            ...
            // PsiInternalConcreteTestLanguage.g:522:40: ( ( '\\r' )? '\\n' )?
            int alt10=2;
            ...
            switch (alt10) {
                case 1 :
                    // PsiInternalConcreteTestLanguage.g:522:41: ( '\\r' )? '\\n'
                    {
                    // PsiInternalConcreteTestLanguage.g:522:41: ( '\\r' )?
                    int alt9=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // PsiInternalConcreteTestLanguage.g:524:9: ( ( ' ' | '\\t' | '\\r' | '\\n' )+ )
            // PsiInternalConcreteTestLanguage.g:524:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            {
            // PsiInternalConcreteTestLanguage.g:524:11: ( ' ' | '\\t' | '\\r' | '\\n' )+
            int cnt11=0;
            loop11:
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // PsiInternalConcreteTestLanguage.g:526:16: ( . )
            // PsiInternalConcreteTestLanguage.g:526:18: .
            {
            matchAny(); 
    ...
    public void mTokens() throws RecognitionException {
        // PsiInternalConcreteTestLanguage.g:1:8: ( T__13 | T__14 | T__15 | T__16 | T__17 | T__18 | T__19 | T__20 | T__21 | T__22 | RULE_ID | RULE_REAL | SUPER_ID | RULE_INT | RULE_STRING | RULE_ML_COMMENT | RULE_SL_COMMENT | RULE_WS | RULE_ANY_OTHER )
        int alt12=19;
        ...
        switch (alt12) {
            ...
            case 12 :
                ...
                break;
            case 13 :
                // PsiInternalConcreteTestLanguage.g:1:88: SUPER_ID
                {
                mSUPER_ID(); 
                ...
                break;
            case 14 :
                // PsiInternalConcreteTestLanguage.g:1:97: RULE_INT
                {
                mRULE_INT(); 
                ...
                break;
            case 15 :
                // PsiInternalConcreteTestLanguage.g:1:106: RULE_STRING
                {
                mRULE_STRING(); 
                ...
                break;
            case 16 :
                // PsiInternalConcreteTestLanguage.g:1:118: RULE_ML_COMMENT
                {
                mRULE_ML_COMMENT(); 
                ...
                break;
            case 17 :
                // PsiInternalConcreteTestLanguage.g:1:134: RULE_SL_COMMENT
                {
                mRULE_SL_COMMENT(); 
                ...
                break;
            case 18 :
                // PsiInternalConcreteTestLanguage.g:1:150: RULE_WS
                {
                mRULE_WS(); 
                ...
                break;
            case 19 :
                // PsiInternalConcreteTestLanguage.g:1:158: RULE_ANY_OTHER
                {
                mRULE_ANY_OTHER(); 
