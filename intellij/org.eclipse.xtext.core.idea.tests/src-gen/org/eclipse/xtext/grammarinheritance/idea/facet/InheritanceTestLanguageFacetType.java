...
public class InheritanceTestLanguageFacetType  extends AbstractFacetType<InheritanceTestLanguageFacetConfiguration> {
	...
	public static  FacetTypeId<Facet<InheritanceTestLanguageFacetConfiguration>> TYPEID = new FacetTypeId<Facet<InheritanceTestLanguageFacetConfiguration>>(TYPE_ID_STRING);
