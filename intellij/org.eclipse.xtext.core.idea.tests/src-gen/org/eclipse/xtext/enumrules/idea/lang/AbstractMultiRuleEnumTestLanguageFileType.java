...
public class AbstractMultiRuleEnumTestLanguageFileType extends LanguageFileType {

	@NonNls 
	public static final String DEFAULT_EXTENSION = "multiruleenumtestlanguage";

	protected AbstractMultiRuleEnumTestLanguageFileType(final Language language) {
		super(language);
	}
