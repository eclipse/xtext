...
@Singleton
public class BacktrackingLexerTestLanguageTokenTypeProvider implements TokenTypeProvider {
	...
	private static final TokenSet WHITESPACE_TOKENS = TokenSet.create(tokenTypes[PsiInternalBacktrackingLexerTestLanguageParser.RULE_WS]);
	private static final TokenSet COMMENT_TOKENS = TokenSet.create(tokenTypes[PsiInternalBacktrackingLexerTestLanguageParser.RULE_SL_COMMENT]);
