 ...
 * generated by Xtext
 */
package org.eclipse.xtext.idea.example.entities.ide.contentassist.antlr;
...
public class EntitiesParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.eclipse.xtext.idea.example.entities.ide.contentassist.antlr.internal.InternalEntitiesParser createParser() {
		org.eclipse.xtext.idea.example.entities.ide.contentassist.antlr.internal.InternalEntitiesParser result = new org.eclipse.xtext.idea.example.entities.ide.contentassist.antlr.internal.InternalEntitiesParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getEntitiesAccess().getImportSectionAssignment_0(), "rule__Entities__ImportSectionAssignment_0");
					put(grammarAccess.getEntitiesAccess().getElementsAssignment_1(), "rule__Entities__ElementsAssignment_1");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.eclipse.xtext.idea.example.entities.ide.contentassist.antlr.internal.InternalEntitiesParser typedParser = (org.eclipse.xtext.idea.example.entities.ide.contentassist.antlr.internal.InternalEntitiesParser) parser;
