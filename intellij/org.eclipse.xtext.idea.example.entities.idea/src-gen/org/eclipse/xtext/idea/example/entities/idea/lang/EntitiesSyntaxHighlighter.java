...
public class EntitiesSyntaxHighlighter extends SyntaxHighlighterBase {
    ...
    public TextAttributesKey[] getTokenHighlights(IElementType tokenType) {
		...
		if (tokenTypeProvider.getIElementType(InternalEntitiesLexer.RULE_SL_COMMENT) == tokenType) {
			return pack(DefaultLanguageHighlighterColors.LINE_COMMENT);
		}
		if (tokenTypeProvider.getIElementType(InternalEntitiesLexer.RULE_ML_COMMENT) == tokenType) {
