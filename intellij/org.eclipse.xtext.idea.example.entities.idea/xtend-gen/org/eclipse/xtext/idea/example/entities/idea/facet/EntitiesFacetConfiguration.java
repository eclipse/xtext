...
@State(name = "org.eclipse.xtext.idea.example.entities.EntitiesGenerator", storages = { @Storage(id = "default", file = StoragePathMacros.PROJECT_FILE), @Storage(id = "dir", file = (StoragePathMacros.PROJECT_CONFIG_DIR + "/EntitiesGeneratorConfig.xml"), scheme = StorageScheme.DIRECTORY_BASED) })
