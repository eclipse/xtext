...
public class XtendBracketMatchingTest extends LightXtendTest {
  private final static String CARET = "<caret>";
  
  public void testClassBraces() {
    StringConcatenation _builder = new StringConcatenation();
    _builder.append("class Foo {");
    _builder.append(XtendBracketMatchingTest.CARET, "");
    this.configureByText(_builder.toString());
    this.newLine();
    StringConcatenation _builder_1 = new StringConcatenation();
    _builder_1.append("class Foo {");
    _builder_1.newLine();
    _builder_1.append(XtendBracketMatchingTest.CARET, "");
  ...
  private void assertEditor(final String editorState) {
    ...
    final int caretPosition = normalized.indexOf(XtendBracketMatchingTest.CARET);
    String text = normalized;
    if ((caretPosition != (-1))) {
      String _replace = normalized.replace(XtendBracketMatchingTest.CARET, "");
      text = _replace;
