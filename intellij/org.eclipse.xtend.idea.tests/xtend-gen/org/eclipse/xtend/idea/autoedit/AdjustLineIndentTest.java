...
public class AdjustLineIndentTest extends LightToolingTest {
  public AdjustLineIndentTest() {
  ...
  public void testXEqualityExpression_01() {
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("def foo(int a, int b, int c, int d) {");
    _builder.newLine();
    _builder.append("\t\t");
    ...
    _builder_1.newLine();
    _builder_1.append("\t");
    _builder_1.append("def foo(int a, int b, int c, int d) {");
    _builder_1.newLine();
    _builder_1.append("\t\t");
  ...
  public void testXInstanceOfExpression_01() {
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("object instanceof Foo");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder_1.newLine();
    _builder_1.append("\t");
    _builder_1.append("def foo(Object object) {");
    _builder_1.newLine();
    _builder_1.append("\t\t");
    _builder_1.append("object instanceof Foo");
    _builder_1.newLine();
    _builder_1.append("\t");
    _builder_1.append("}");
    _builder_1.newLine();
  ...
  public void testXInstanceOfExpression_03() {
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("instanceof Foo");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder_1.newLine();
    _builder_1.append("\t\t\t\t");
    _builder_1.append("instanceof Foo");
    _builder_1.newLine();
    _builder_1.append("\t");
    _builder_1.append("}");
    _builder_1.newLine();
  ...
  public void testXRelationalExpression_01() {
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("def foo(int a, int b) {");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("a > b");
    _builder.newLine();
    ...
    _builder_1.newLine();
    _builder_1.append("\t");
    _builder_1.append("def foo(int a, int b) {");
    _builder_1.newLine();
    _builder_1.append("\t\t");
  ...
  public void testXAdditiveExpression_01() {
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("def foo(int a, int b, int c) {");
    _builder.newLine();
    _builder.append("\t\t");
    ...
    _builder_1.newLine();
    _builder_1.append("\t");
    _builder_1.append("def foo(int a, int b, int c) {");
    _builder_1.newLine();
    _builder_1.append("\t\t");
  ...
  public void testXUnaryOperation_01() {
    ...
    _builder_1.newLine();
    _builder_1.append("\t");
    _builder_1.append("def foo(int a) {");
    _builder_1.newLine();
    _builder_1.append("\t\t");
    _builder_1.append("-a");
    _builder_1.newLine();
  ...
  public void testXCastedExpression_01() {
    ...
    _builder_1.newLine();
    _builder_1.append("\t\t");
    _builder_1.append("object as Foo");
    _builder_1.newLine();
    _builder_1.append("\t");
    _builder_1.append("}");
    _builder_1.newLine();
  ...
  public void testXMFeatureCall_04() {
    StringConcatenation _builder = new StringConcatenation();
    _builder.append("class Foo {");
    _builder.newLine();
    _builder.append("\t");
  ...
  public void testXSynchronizedExpression_01() {
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("synchronized (this) return 1");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder_1.newLine();
    _builder_1.append("\t\t");
    _builder_1.append("synchronized (this) return 1");
    _builder_1.newLine();
    _builder_1.append("\t");
    _builder_1.append("}");
    _builder_1.newLine();
  ...
  protected Runnable adjustLineIndent(final PsiFile file) {
    final Runnable _function = new Runnable() {
      @Override
      public void run() {
        Project _project = AdjustLineIndentTest.this.getProject();
