...
public class PsiJvmModelAssociationsTests extends LightXtendTest {
  ...
  public void testAssociations() {
    ...
    Set<PsiElement> _sourceElements_1 = this._iPsiJvmModelAssociations.getSourceElements(psiField);
    PsiElement _head_1 = IterableExtensions.<PsiElement>head(_sourceElements_1);
    ...
    Set<PsiElement> _sourceElements_2 = this._iPsiJvmModelAssociations.getSourceElements(getterMethod);
    PsiElement _head_2 = IterableExtensions.<PsiElement>head(_sourceElements_2);
    ...
    Set<PsiElement> _sourceElements_3 = this._iPsiJvmModelAssociations.getSourceElements(setterMethod);
    PsiElement _head_3 = IterableExtensions.<PsiElement>head(_sourceElements_3);
    ...
    Set<PsiElement> _sourceElements_4 = this._iPsiJvmModelAssociations.getSourceElements(psiParameter);
    PsiElement _head_4 = IterableExtensions.<PsiElement>head(_sourceElements_4);
    ...
    Set<PsiElement> _sourceElements_5 = this._iPsiJvmModelAssociations.getSourceElements(innerClass);
    PsiElement _head_5 = IterableExtensions.<PsiElement>head(_sourceElements_5);
