...
public class RefactoringTestLanguageBuildProcessParametersProvider extends BuildProcessParametersProvider {
  public List<String> getClassPath() {
    ...
    {
      PluginId _id = PluginId.getId("org.eclipse.xtext.idea.common.types.RefactoringTestLanguage");
      final IdeaPluginDescriptor plugin = PluginManager.getPlugin(_id);
      File _path = plugin.getPath();
      final String path = _path.getPath();
      _xblockexpression = Collections.<String>unmodifiableList(CollectionLiterals.<String>newArrayList((path + "/bin"), (path + "/../org.eclipse.xtext.idea.common.types.RefactoringTestLanguage/bin")));
    }
