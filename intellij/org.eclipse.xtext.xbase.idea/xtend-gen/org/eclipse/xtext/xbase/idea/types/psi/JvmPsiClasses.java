...
public class JvmPsiClasses {
  ...
  public ArrayList<JvmPsiClass> getPsiClassesByName(final BaseXtextFile it, final String name) {
  ...
  public ArrayList<JvmPsiClass> getPsiClassesByQualifiedName(final BaseXtextFile it, final QualifiedName qualifiedName) {
    ArrayList<JvmPsiClass> _xblockexpression = null;
    {
      final Resource resource = it.getResource();
      final ArrayList<JvmPsiClass> result = CollectionLiterals.<JvmPsiClass>newArrayList();
