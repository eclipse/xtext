...
public class JvmPsiAnnotationMethodImpl extends PsiAnnotationMethodImpl implements PsiMirrorElement {
  public JvmPsiAnnotationMethodImpl(final ASTNode node) {
    super(node);
  }
