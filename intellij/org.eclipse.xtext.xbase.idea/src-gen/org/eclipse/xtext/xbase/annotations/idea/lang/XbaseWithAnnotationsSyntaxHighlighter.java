...
public class XbaseWithAnnotationsSyntaxHighlighter extends SyntaxHighlighterBase {
    ...
    public TextAttributesKey[] getTokenHighlights(IElementType tokenType) {
		...
		if (tokenTypeProvider.getIElementType(InternalXbaseWithAnnotationsLexer.RULE_SL_COMMENT) == tokenType) {
			return pack(DefaultLanguageHighlighterColors.LINE_COMMENT);
		}
		if (tokenTypeProvider.getIElementType(InternalXbaseWithAnnotationsLexer.RULE_ML_COMMENT) == tokenType) {
