...
@parser::members {
	...
	protected XbaseElementTypeProvider elementTypeProvider;

	public PsiInternalXbaseParser(PsiBuilder builder, TokenStream input, XbaseElementTypeProvider elementTypeProvider, XbaseGrammarAccess grammarAccess) {
		this(input);
