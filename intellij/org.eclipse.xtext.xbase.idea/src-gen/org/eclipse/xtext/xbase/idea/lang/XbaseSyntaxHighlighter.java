...
public class XbaseSyntaxHighlighter extends SyntaxHighlighterBase {
    ...
    public TextAttributesKey[] getTokenHighlights(IElementType tokenType) {
		...
		if (tokenTypeProvider.getIElementType(InternalXbaseLexer.RULE_SL_COMMENT) == tokenType) {
			return pack(DefaultLanguageHighlighterColors.LINE_COMMENT);
		}
		if (tokenTypeProvider.getIElementType(InternalXbaseLexer.RULE_ML_COMMENT) == tokenType) {
