...
abstract class AbstractCompletionContributor extends CompletionContributor {
	...
	protected def createParserBasedProposals(CompletionParameters parameters, CompletionResultSet result) {
		val contexts = newParserBasedFactory.create(parameters.text, parameters.replaceRegion, parameters.offset,parameters.resource)
	...
	protected def getReplaceRegion(CompletionParameters parameters) {
		parameters.readOnly [
