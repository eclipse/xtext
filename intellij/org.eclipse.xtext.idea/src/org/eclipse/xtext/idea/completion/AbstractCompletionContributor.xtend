...
abstract class AbstractCompletionContributor extends CompletionContributor {
	...
	protected def getSelection(CompletionParameters parameters) {
		parameters.readOnly [
			val context = parameters.position.getUserData(CompletionContext.COMPLETION_CONTEXT_KEY) as CompletionContext
			val startOffset = context.startOffset
			val endOffset = context.offsetMap.getOffset(CompletionInitializationContext.SELECTION_END_OFFSET)
