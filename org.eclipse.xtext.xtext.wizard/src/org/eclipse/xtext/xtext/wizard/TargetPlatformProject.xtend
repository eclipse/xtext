			...
			<locations>
				...
				<location includeAllPlatforms="false" includeConfigurePhase="false" includeMode="planner" includeSource="true" type="InstallableUnit">
					...
					«IF config.junitVersion == JUnitVersion.JUNIT_5»
						...
						<unit id="junit-platform-engine" version="1.9.2"/>
						<unit id="junit-platform-launcher" version="1.9.2"/>
						<unit id="junit-platform-runner" version="1.9.2"/>
						<unit id="junit-platform-suite-commons" version="1.9.2"/>
