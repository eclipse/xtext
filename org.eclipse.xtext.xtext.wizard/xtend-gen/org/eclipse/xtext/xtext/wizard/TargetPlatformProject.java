...
public class TargetPlatformProject extends ProjectDescriptor {
  ...
  public CharSequence target() {
    ...
    _builder.newLine();
    {
      ...
      if (_equals) {
        _builder.append("\t\t\t");
        _builder.append("<unit id=\"org.junit.jupiter.api\" version=\"5.5.1.v20190812-1854\"/>");
        _builder.newLine();
        _builder.append("\t\t\t");
        _builder.append("<unit id=\"org.junit.jupiter.engine\" version=\"5.5.1.v20190812-1854\"/>");
        _builder.newLine();
        _builder.append("\t\t\t");
        _builder.append("<unit id=\"org.junit.platform.commons\" version=\"1.5.1.v20190812-1854\"/>");
        _builder.newLine();
        _builder.append("\t\t\t");
        _builder.append("<unit id=\"org.junit.platform.engine\" version=\"1.5.1.v20190812-1854\"/>");
        _builder.newLine();
        _builder.append("\t\t\t");
        _builder.append("<unit id=\"org.junit.platform.launcher\" version=\"1.5.1.v20190812-1854\"/>");
        _builder.newLine();
        _builder.append("\t\t\t");
        _builder.append("<unit id=\"org.junit.platform.runner\" version=\"1.5.1.v20190812-1854\"/>");
        _builder.newLine();
        _builder.append("\t\t\t");
        _builder.append("<unit id=\"org.opentest4j\" version=\"1.2.0.v20190812-1854\"/>");
        _builder.newLine();
      }
    }
    _builder.append("\t\t\t");
