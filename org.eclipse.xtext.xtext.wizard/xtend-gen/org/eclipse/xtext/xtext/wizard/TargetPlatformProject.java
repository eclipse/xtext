...
public class TargetPlatformProject extends ProjectDescriptor {
  ...
  public CharSequence target() {
    ...
    _builder.newLine();
    {
      ...
      if (_equals) {
        _builder.append("\t\t\t");
        _builder.append("<unit id=\"org.junit.jupiter.api\" version=\"5.7.0.v20201026-1537\"/>");
        _builder.newLine();
        _builder.append("\t\t\t");
        _builder.append("<unit id=\"org.junit.jupiter.engine\" version=\"5.7.0.v20201026-1537\"/>");
        _builder.newLine();
        _builder.append("\t\t\t");
        _builder.append("<unit id=\"org.junit.platform.commons\" version=\"1.7.0.v20201026-1537\"/>");
        _builder.newLine();
        _builder.append("\t\t\t");
        _builder.append("<unit id=\"org.junit.platform.engine\" version=\"1.7.0.v20201026-1537\"/>");
        _builder.newLine();
        _builder.append("\t\t\t");
        _builder.append("<unit id=\"org.junit.platform.launcher\" version=\"1.7.0.v20201026-1537\"/>");
        _builder.newLine();
        _builder.append("\t\t\t");
        _builder.append("<unit id=\"org.junit.platform.runner\" version=\"1.7.0.v20201026-1537\"/>");
        _builder.newLine();
        _builder.append("\t\t\t");
    ...
    _builder.append("\t\t\t");
    _builder.append("<unit id=\"org.objectweb.asm\" version=\"9.0.0.v20201001-1419\"/>");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("<unit id=\"org.objectweb.asm.tree\" version=\"9.0.0.v20201001-1419\"/>");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("<unit id=\"io.github.classgraph\" version=\"4.8.35.v20190528-1517\"/>");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("<repository location=\"https://download.eclipse.org/tools/orbit/downloads/2020-12\"/>");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("</location>");
    _builder.newLine();
