...
public class TargetPlatformProject extends ProjectDescriptor {
  ...
  public CharSequence target() {
    ...
    _builder.newLine();
    {
      ...
      if (_isAtLeast) {
        _builder.append("\t\t\t");
        _builder.append("<repository location=\"https://download.eclipse.org/releases/2022-09\"/>");
        _builder.newLine();
      } else {
        _builder.append("\t\t\t");
      ...
      if (_isAtLeast_1) {
        ...
        _builder.newLine();
        {
          ...
          if (_equals) {
            ...
            _builder.append("\t\t");
            _builder.append("\t");
            _builder.append("<unit id=\"org.junit.jupiter.api\" version=\"5.8.2.v20220624-2009\"/>");
            _builder.newLine();
            _builder.append("\t\t");
            _builder.append("\t");
            _builder.append("<unit id=\"org.junit.jupiter.engine\" version=\"5.8.2.v20220624-2009\"/>");
            _builder.newLine();
            _builder.append("\t\t");
            _builder.append("\t");
            ...
            _builder.append("\t\t");
            _builder.append("\t");
            _builder.append("<unit id=\"org.junit.platform.engine\" version=\"1.8.2.v20220624-2009\"/>");
            _builder.newLine();
            _builder.append("\t\t");
            _builder.append("\t");
            _builder.append("<unit id=\"org.junit.platform.launcher\" version=\"1.8.2.v20220624-2009\"/>");
            _builder.newLine();
            _builder.append("\t\t");
            _builder.append("\t");
            _builder.append("<unit id=\"org.junit.platform.runner\" version=\"1.8.2.v20220624-2009\"/>");
            _builder.newLine();
            _builder.append("\t\t");
            _builder.append("\t");
