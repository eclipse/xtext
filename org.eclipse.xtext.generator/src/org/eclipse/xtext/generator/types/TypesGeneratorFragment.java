...
public class TypesGeneratorFragment extends DefaultGeneratorFragment implements IGeneratorFragmentExtension4 {
	...
	public String[] getRequiredBundlesRt(Grammar grammar) {
		return new String[] { "org.eclipse.xtext.common.types","org.objectweb.asm;bundle-version=\"[9.3.0,9.4.0)\";resolution:=optional" };
	}
	
	@Override
	public String[] getRequiredBundlesTests(Grammar grammar) {
		return new String[] { "org.objectweb.asm;bundle-version=\"[9.3.0,9.4.0)\";resolution:=optional" };
	}
