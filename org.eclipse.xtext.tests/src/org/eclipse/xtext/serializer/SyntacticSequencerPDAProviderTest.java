...
public class SyntacticSequencerPDAProviderTest extends AbstractXtextTests {
	...
	public void testUnassignedRuleCall2() throws Exception {
		...
		expected.append("  start 'kw1' 'kw2' val=ID\n");
		expected.append("  val=ID 'kw3' 'kw4' stop\n");
	...
	public void testReturnChoices() throws Exception {
		...
		expected.append("  start ('in1' >>Infix | 'in2' >>Infix) val=ID\n");
		expected.append("  val=ID (<<Infix 'out1' | <<Infix 'out2') stop\n");
		expected.append("Sub1 returns Infix:\n");
		expected.append("  start 'in1' val=ID\n");
		expected.append("  val=ID 'out1' stop\n");
		expected.append("Sub2 returns Infix:\n");
		expected.append("  start 'in2' val=ID\n");
		expected.append("  val=ID 'out2' stop\n");
		expected.append("Sub3 returns Infix:\n");
		expected.append("  start 'in3' val=ID\n");
		expected.append("  val=ID 'out3' stop\n");
	...
	public void testExpression1() throws Exception {
		...
		expected.append("  start ('(' >>Addition)* {Add.left=}\n");
		expected.append("  {Add.left=} '+' right=Prim\n");
		expected.append("Addition returns Val, Addition.Add_1_0 returns Val, Prim returns Val:\n");
		expected.append("  name=ID (<<Addition ')')* stop\n");
		expected.append("  start ('(' >>Addition)* {Val} name=ID\n");
	...
	public void testOptionalEnd() throws Exception {
		...
		expected.append("AbstractRule returns Rule1, Rule1 returns Rule1:\n");
		...
		expected.append("AbstractRule returns Rule2, Rule2 returns Rule2:\n");
	...
	public void testExpression5() throws Exception {
		...
		StringBuilder expected = new StringBuilder();
		expected.append("Addition returns Add, Addition.Add_1_0 returns Add:\n");
		expected.append("  right=Multiplication (<<Addition ')')* stop\n");
		expected.append("  start ('(' >>Addition)* {Add.left=}\n");
		expected.append("  {Add.left=} '+' right=Multiplication\n");
		expected.append("Addition returns Mult, Addition.Add_1_0 returns Mult, Multiplication returns Mult, Multiplication.Mult_1_0 returns Mult:\n");
		expected.append("  right=Prim (<<Addition ')')* stop\n");
		expected.append("  start ('(' >>Addition)* {Mult.left=}\n");
		expected.append("  {Mult.left=} '*' right=Prim\n");
		expected.append("Addition returns Val, Addition.Add_1_0 returns Val, Multiplication returns Val, Multiplication.Mult_1_0 returns Val, Prim returns Val:\n");
		expected.append("  name=ID (<<Addition ')')* stop\n");
		expected.append("  start ('(' >>Addition)* {Val} name=ID\n");
		expected.append("Multiplication returns Add, Multiplication.Mult_1_0 returns Add, Prim returns Add:\n");
		expected.append("  right=Multiplication (<<Addition ')')+ stop\n");
		expected.append("  start ('(' >>Addition)+ {Add.left=}\n");
		expected.append("  {Add.left=} '+' right=Multiplication\n");
	...
	public void testPotentialOOME() throws Exception {
		...
		expected.append("  start stop\n");
		expected.append("Elements returns Dummy, Dummy returns Dummy:\n");
		expected.append("  name=ID stop\n");
		expected.append("  start 'Dummy' name=ID\n");
		expected.append("Elements returns Model, Model returns Model:\n");
		...
		expected.append("  start '}'+ stop\n");
		expected.append("Elements returns null, Model returns null:\n");
		expected.append("  start '}'+ stop\n");
