...
public class TestLanguage extends XtextGeneratorLanguage {
  private AntlrOptions parserOptions = ObjectExtensions.<AntlrOptions>operator_doubleArrow(new AntlrOptions(), ((Procedure1<AntlrOptions>) (AntlrOptions it) -> {
  ...
  private SerializerFragment2 serializer = ObjectExtensions.<SerializerFragment2>operator_doubleArrow(new SerializerFragment2(), ((Procedure1<SerializerFragment2>) (SerializerFragment2 it) -> {
  ...
  private XtextAntlrGeneratorFragment2 parserGenerator = ObjectExtensions.<XtextAntlrGeneratorFragment2>operator_doubleArrow(new XtextAntlrGeneratorFragment2(), ((Procedure1<XtextAntlrGeneratorFragment2>) (XtextAntlrGeneratorFragment2 it) -> {
    it.setDebugGrammar(true);
    it.setOptions(this.parserOptions);
  }));
  
  private XtextAntlrIDEAGeneratorFragment ideaParser = ObjectExtensions.<XtextAntlrIDEAGeneratorFragment>operator_doubleArrow(new XtextAntlrIDEAGeneratorFragment(), ((Procedure1<XtextAntlrIDEAGeneratorFragment>) (XtextAntlrIDEAGeneratorFragment it) -> {
    it.setOptions(this.parserOptions);
  }));
  ...
  protected List<? extends IXtextGeneratorFragment> getImplicitFragments() {
    ...
    final Procedure1<org.eclipse.xtext.generator.parser.antlr.AntlrOptions> _function = (org.eclipse.xtext.generator.parser.antlr.AntlrOptions it) -> {
      AntlrOptions _options = this.parserGenerator.getOptions();
      boolean _isBacktrack = _options.isBacktrack();
      it.setBacktrack(_isBacktrack);
      AntlrOptions _options_1 = this.parserGenerator.getOptions();
      boolean _isBacktrackLexer = _options_1.isBacktrackLexer();
      it.setBacktrackLexer(_isBacktrackLexer);
      AntlrOptions _options_2 = this.parserGenerator.getOptions();
      boolean _isClassSplitting = _options_2.isClassSplitting();
      it.setClassSplitting(_isClassSplitting);
      AntlrOptions _options_3 = this.parserGenerator.getOptions();
      ...
      AntlrOptions _options_4 = this.parserGenerator.getOptions();
