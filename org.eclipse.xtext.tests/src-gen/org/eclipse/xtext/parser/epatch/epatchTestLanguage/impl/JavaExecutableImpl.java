 ...
 * @generated
 */
public class JavaExecutableImpl extends ExecutableImpl implements JavaExecutable
{
  /**
  ...
  {
    return EpatchTestLanguagePackage.Literals.JAVA_EXECUTABLE;
  }
  ...
  public void setMethod(String newMethod)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EpatchTestLanguagePackage.JAVA_EXECUTABLE__METHOD, oldMethod, method));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case EpatchTestLanguagePackage.JAVA_EXECUTABLE__METHOD:
        return getMethod();
    }
