...
public class InternalEcoreTerminalsTestLanguageLexer extends Lexer {
    ...
    public final void mRULE_EDOUBLE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalEcoreTerminalsTestLanguage.g:156:14: ( ( '.' ( '0' .. '9' )+ | ( '0' .. '9' )+ '.' ( '0' .. '9' )* ) ( ( 'E' | 'e' ) ( '-' | ( '+' )? ) ( '0' .. '9' )+ )? )
            // InternalEcoreTerminalsTestLanguage.g:156:16: ( '.' ( '0' .. '9' )+ | ( '0' .. '9' )+ '.' ( '0' .. '9' )* ) ( ( 'E' | 'e' ) ( '-' | ( '+' )? ) ( '0' .. '9' )+ )?
            {
            // InternalEcoreTerminalsTestLanguage.g:156:16: ( '.' ( '0' .. '9' )+ | ( '0' .. '9' )+ '.' ( '0' .. '9' )* )
            int alt4=2;
            ...
            switch (alt4) {
                case 1 :
                    // InternalEcoreTerminalsTestLanguage.g:156:17: '.' ( '0' .. '9' )+
                    {
                    match('.'); 
                    // InternalEcoreTerminalsTestLanguage.g:156:21: ( '0' .. '9' )+
                    int cnt1=0;
                    loop1:
                    do {
                        int alt1=2;
                        ...
                        switch (alt1) {
                    	case 1 :
                    	    // InternalEcoreTerminalsTestLanguage.g:156:22: '0' .. '9'
                    	    {
                    	    matchRange('0','9'); 
                    ...
                    break;
                case 2 :
                    // InternalEcoreTerminalsTestLanguage.g:156:33: ( '0' .. '9' )+ '.' ( '0' .. '9' )*
                    {
                    // InternalEcoreTerminalsTestLanguage.g:156:33: ( '0' .. '9' )+
                    int cnt2=0;
                    loop2:
                    do {
                        int alt2=2;
                        ...
                        switch (alt2) {
                    	case 1 :
                    	    // InternalEcoreTerminalsTestLanguage.g:156:34: '0' .. '9'
                    	    {
                    	    matchRange('0','9'); 
                    ...
                    match('.'); 
                    // InternalEcoreTerminalsTestLanguage.g:156:49: ( '0' .. '9' )*
                    loop3:
                    do {
                        int alt3=2;
                        ...
                        switch (alt3) {
                    	case 1 :
                    	    // InternalEcoreTerminalsTestLanguage.g:156:50: '0' .. '9'
                    	    {
                    	    matchRange('0','9'); 
            ...
            // InternalEcoreTerminalsTestLanguage.g:156:62: ( ( 'E' | 'e' ) ( '-' | ( '+' )? ) ( '0' .. '9' )+ )?
            int alt8=2;
            ...
            switch (alt8) {
                case 1 :
                    // InternalEcoreTerminalsTestLanguage.g:156:63: ( 'E' | 'e' ) ( '-' | ( '+' )? ) ( '0' .. '9' )+
                    {
                    ...
                    // InternalEcoreTerminalsTestLanguage.g:156:73: ( '-' | ( '+' )? )
                    int alt6=2;
                    ...
                    switch (alt6) {
                        case 1 :
                            // InternalEcoreTerminalsTestLanguage.g:156:74: '-'
                            {
                            match('-'); 
                            ...
                            break;
                        case 2 :
                            // InternalEcoreTerminalsTestLanguage.g:156:78: ( '+' )?
                            {
                            // InternalEcoreTerminalsTestLanguage.g:156:78: ( '+' )?
                            int alt5=2;
                    ...
                    // InternalEcoreTerminalsTestLanguage.g:156:84: ( '0' .. '9' )+
                    int cnt7=0;
                    loop7:
                    do {
                        int alt7=2;
                        ...
                        switch (alt7) {
                    	case 1 :
                    	    // InternalEcoreTerminalsTestLanguage.g:156:85: '0' .. '9'
                    	    {
                    	    matchRange('0','9'); 
    ...
    public final void mRULE_EDATE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalEcoreTerminalsTestLanguage.g:158:12: ( '0' .. '9' '0' .. '9' '0' .. '9' '0' .. '9' '-' '0' .. '9' '0' .. '9' '-' '0' .. '9' '0' .. '9' 'T' '0' .. '9' '0' .. '9' ':' '0' .. '9' '0' .. '9' ':' '0' .. '9' '0' .. '9' '.' '0' .. '9' '0' .. '9' '0' .. '9' ( '+' | '-' ) '0' .. '9' '0' .. '9' '0' .. '9' '0' .. '9' )
            // InternalEcoreTerminalsTestLanguage.g:158:14: '0' .. '9' '0' .. '9' '0' .. '9' '0' .. '9' '-' '0' .. '9' '0' .. '9' '-' '0' .. '9' '0' .. '9' 'T' '0' .. '9' '0' .. '9' ':' '0' .. '9' '0' .. '9' ':' '0' .. '9' '0' .. '9' '.' '0' .. '9' '0' .. '9' '0' .. '9' ( '+' | '-' ) '0' .. '9' '0' .. '9' '0' .. '9' '0' .. '9'
            {
            matchRange('0','9'); 
            matchRange('0','9'); 
            matchRange('0','9'); 
    ...
    public final void mRULE_EINT() throws RecognitionException {
        try {
            int _type = RULE_EINT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalEcoreTerminalsTestLanguage.g:160:11: ( ( '-' )? ( '0' .. '9' )+ )
            // InternalEcoreTerminalsTestLanguage.g:160:13: ( '-' )? ( '0' .. '9' )+
            {
            // InternalEcoreTerminalsTestLanguage.g:160:13: ( '-' )?
            int alt9=2;
            ...
            // InternalEcoreTerminalsTestLanguage.g:160:18: ( '0' .. '9' )+
            int cnt10=0;
            loop10:
            do {
                int alt10=2;
                ...
                switch (alt10) {
            	case 1 :
            	    // InternalEcoreTerminalsTestLanguage.g:160:19: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
