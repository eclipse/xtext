...
public class InternalHiddenTerminalsTestLanguageLexer extends Lexer {
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalHiddenTerminalsTestLanguage.g:684:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalHiddenTerminalsTestLanguage.g:684:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalHiddenTerminalsTestLanguage.g:684:24: ( options {greedy=false; } : . )*
            loop1:
            do {
                int alt1=2;
                ...
                switch (alt1) {
            	case 1 :
            	    // InternalHiddenTerminalsTestLanguage.g:684:52: .
            	    {
            	    matchAny(); 
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            // InternalHiddenTerminalsTestLanguage.g:686:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop2:
            do {
                int alt2=2;
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalHiddenTerminalsTestLanguage.g:690:16: ( . )
            // InternalHiddenTerminalsTestLanguage.g:690:18: .
            {
            matchAny(); 
