...
public class InternalHiddenTerminalsTestLanguageLexer extends Lexer {
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalHiddenTerminalsTestLanguage.g:679:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalHiddenTerminalsTestLanguage.g:679:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalHiddenTerminalsTestLanguage.g:679:24: ( options {greedy=false; } : . )*
            loop1:
            do {
                int alt1=2;
                ...
                switch (alt1) {
            	case 1 :
            	    // InternalHiddenTerminalsTestLanguage.g:679:52: .
            	    {
            	    matchAny(); 
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            // InternalHiddenTerminalsTestLanguage.g:681:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop2:
            do {
                int alt2=2;
            ...
            // InternalHiddenTerminalsTestLanguage.g:681:40: ( ( '\\r' )? '\\n' )?
            int alt4=2;
            ...
            switch (alt4) {
                case 1 :
                    // InternalHiddenTerminalsTestLanguage.g:681:41: ( '\\r' )? '\\n'
                    {
                    // InternalHiddenTerminalsTestLanguage.g:681:41: ( '\\r' )?
                    int alt3=2;
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalHiddenTerminalsTestLanguage.g:685:16: ( . )
            // InternalHiddenTerminalsTestLanguage.g:685:18: .
            {
            matchAny(); 
