...
public class EcoreTerminalsTestLanguageSyntacticSequencer extends AbstractSyntacticSequencer {

	protected EcoreTerminalsTestLanguageGrammarAccess grammarAccess;
	
	@Inject
	protected void init(IGrammarAccess access) {
		grammarAccess = (EcoreTerminalsTestLanguageGrammarAccess) access;
	}
