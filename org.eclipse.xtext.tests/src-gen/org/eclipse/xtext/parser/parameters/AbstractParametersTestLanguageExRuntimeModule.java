...
public abstract class AbstractParametersTestLanguageExRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "org/eclipse/xtext/parser/parameters/ParametersTestLanguageEx.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("org.eclipse.xtext.parser.parameters.ParametersTestLanguageEx");
	}
