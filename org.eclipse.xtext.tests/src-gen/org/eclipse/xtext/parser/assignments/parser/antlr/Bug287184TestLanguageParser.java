...
import org.eclipse.xtext.parser.assignments.parser.antlr.internal.InternalBug287184TestLanguageParser;
import org.eclipse.xtext.parser.assignments.services.Bug287184TestLanguageGrammarAccess;

public class Bug287184TestLanguageParser extends AbstractAntlrParser {
	...
	@Override
	protected InternalBug287184TestLanguageParser createParser(XtextTokenStream stream) {
		return new InternalBug287184TestLanguageParser(stream, getGrammarAccess());
	}
