...
import org.eclipse.xtext.parser.assignments.parser.antlr.internal.InternalBug288432TestLanguageParser;
import org.eclipse.xtext.parser.assignments.services.Bug288432TestLanguageGrammarAccess;

public class Bug288432TestLanguageParser extends AbstractAntlrParser {
	...
	@Override
	protected InternalBug288432TestLanguageParser createParser(XtextTokenStream stream) {
		return new InternalBug288432TestLanguageParser(stream, getGrammarAccess());
	}
