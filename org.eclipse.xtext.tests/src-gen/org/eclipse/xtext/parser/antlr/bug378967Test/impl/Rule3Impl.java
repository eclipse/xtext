...
public class Rule3Impl extends MinimalEObjectImpl.Container implements Rule3
{
  ...
  {
    return Bug378967TestPackage.Literals.RULE3;
  }
  ...
  public void setValue(int newValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Bug378967TestPackage.RULE3__VALUE, oldValue, value));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case Bug378967TestPackage.RULE3__VALUE:
        return getValue();
    }
