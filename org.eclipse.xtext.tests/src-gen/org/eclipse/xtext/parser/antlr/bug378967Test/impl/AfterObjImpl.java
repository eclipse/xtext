 ...
 * @generated
 */
public class AfterObjImpl extends MinimalEObjectImpl.Container implements AfterObj
{
  /**
  ...
  {
    return Bug378967TestPackage.Literals.AFTER_OBJ;
  }
  ...
  public void setValue(String newValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Bug378967TestPackage.AFTER_OBJ__VALUE, oldValue, value));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case Bug378967TestPackage.AFTER_OBJ__VALUE:
        return getValue();
    }
