 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.xtext.parser.antlr.bug378967Test.impl.Rule2Impl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class Rule2Impl extends MinimalEObjectImpl.Container implements Rule2
{
  ...
  {
    return Bug378967TestPackage.Literals.RULE2;
  }
  ...
  public void setValue(int newValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Bug378967TestPackage.RULE2__VALUE, oldValue, value));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case Bug378967TestPackage.RULE2__VALUE:
        return getValue();
    }
