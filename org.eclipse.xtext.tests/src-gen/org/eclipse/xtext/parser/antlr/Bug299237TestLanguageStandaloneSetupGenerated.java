...
public class Bug299237TestLanguageStandaloneSetupGenerated implements ISetup {
	...
	public void register(Injector injector) {
		...
		IResourceServiceProvider.Registry.INSTANCE.getExtensionToFactoryMap().put("bug299237testlanguage", serviceProvider);
		if (!EPackage.Registry.INSTANCE.containsKey("http://eclipse.org/xtext/Bug299237TestLanguage")) {
			EPackage.Registry.INSTANCE.put("http://eclipse.org/xtext/Bug299237TestLanguage", Bug299237TestPackage.eINSTANCE);
		}
	}
}
