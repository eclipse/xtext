 ...
 * @generated
 */
public class IndentationAwareTestLanguageAdapterFactory extends AdapterFactoryImpl
{
  /**
   ...
   * @generated
   */
  protected static IndentationAwareTestLanguagePackage modelPackage;
   ...
   * @generated
   */
  public IndentationAwareTestLanguageAdapterFactory()
  {
    if (modelPackage == null)
    {
      modelPackage = IndentationAwareTestLanguagePackage.eINSTANCE;
    }
  }
   ...
   * @generated
   */
  protected IndentationAwareTestLanguageSwitch<Adapter> modelSwitch =
    new IndentationAwareTestLanguageSwitch<Adapter>()
    {
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.eclipse.xtext.parser.indentation.indentationAwareTestLanguage.Tree <em>Tree</em>}'.
   * <!-- begin-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.eclipse.xtext.parser.indentation.indentationAwareTestLanguage.TreeNode <em>Tree Node</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
...
} //IndentationAwareTestLanguageAdapterFactory
