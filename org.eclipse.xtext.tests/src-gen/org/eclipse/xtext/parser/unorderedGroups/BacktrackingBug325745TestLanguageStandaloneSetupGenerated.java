...
public class BacktrackingBug325745TestLanguageStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new BacktrackingBug325745TestLanguageRuntimeModule());
	}
	...
	public void register(Injector injector) {
		...
		IResourceServiceProvider.Registry.INSTANCE.getExtensionToFactoryMap().put("backtrackingbug325745testlanguage", serviceProvider);
		if (!EPackage.Registry.INSTANCE.containsKey("http://www.eclipse.org/2010/tmf/xtext/backtrackingBug325745TestLanguage")) {
			EPackage.Registry.INSTANCE.put("http://www.eclipse.org/2010/tmf/xtext/backtrackingBug325745TestLanguage", BacktrackingBug325745TestLanguagePackage.eINSTANCE);
		}
	}
}
