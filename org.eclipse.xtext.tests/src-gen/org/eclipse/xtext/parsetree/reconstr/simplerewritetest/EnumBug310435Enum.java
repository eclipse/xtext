...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Enum Bug310435 Enum</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see org.eclipse.xtext.parsetree.reconstr.simplerewritetest.SimplerewritetestPackage#getEnumBug310435Enum()
 * @model
 * @generated
 */
public enum EnumBug310435Enum implements Enumerator
{
  /**
   ...
   * @generated
   */
  private static final EnumBug310435Enum[] VALUES_ARRAY =
    new EnumBug310435Enum[]
    {
      LIT1,
      LIT2,
    };
  ...
  /**
   * A public read-only list of all the '<em><b>Enum Bug310435 Enum</b></em>' enumerators.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  public static final List<EnumBug310435Enum> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
  ...
  public static EnumBug310435Enum get(String literal)
  {
    ...
    {
      EnumBug310435Enum result = VALUES_ARRAY[i];
   ...
   * @generated
   */
  private EnumBug310435Enum(int value, String name, String literal)
  {
    this.value = value;
    this.name = name;
