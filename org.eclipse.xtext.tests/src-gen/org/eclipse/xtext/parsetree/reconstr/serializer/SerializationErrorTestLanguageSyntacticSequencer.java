...
public class SerializationErrorTestLanguageSyntacticSequencer extends AbstractSyntacticSequencer {

	protected SerializationErrorTestLanguageGrammarAccess grammarAccess;
	
	@Inject
	protected void init(IGrammarAccess access) {
		grammarAccess = (SerializationErrorTestLanguageGrammarAccess) access;
	}
