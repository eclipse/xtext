...
public class InternalIndentationAwareTestLanguageLexer extends Lexer {
    ...
    public final void mRULE_NL() throws RecognitionException {
        try {
            ...
            do {
                ...
                switch (alt1) {
            	case 1 :
            	    // InternalIndentationAwareTestLanguage.g:
            	    {
            	    if ( input.LA(1)=='\n'||input.LA(1)=='\r' ) {
            	        input.consume();
            ...
            // InternalIndentationAwareTestLanguage.g:228:24: ( '\\t' )*
            loop2:
            do {
                int alt2=2;
    ...
    public final void mRULE_END() throws RecognitionException {
        try {
            int _type = RULE_END;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalIndentationAwareTestLanguage.g:232:10: ( '}' )
            // InternalIndentationAwareTestLanguage.g:232:12: '}'
            {
            match('}'); 
    ...
    public final void mRULE_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalIndentationAwareTestLanguage.g:234:12: ( . )
            // InternalIndentationAwareTestLanguage.g:234:14: .
            {
            matchAny(); 
    ...
    public void mTokens() throws RecognitionException {
        // InternalIndentationAwareTestLanguage.g:1:8: ( RULE_NL | RULE_BEGIN | RULE_END | RULE_OTHER )
        int alt3=4;
        ...
        switch (alt3) {
            case 1 :
                // InternalIndentationAwareTestLanguage.g:1:10: RULE_NL
                {
                mRULE_NL(); 
                ...
                break;
            case 2 :
                // InternalIndentationAwareTestLanguage.g:1:18: RULE_BEGIN
                {
                mRULE_BEGIN(); 
                ...
                break;
            case 3 :
                // InternalIndentationAwareTestLanguage.g:1:29: RULE_END
                {
                mRULE_END(); 
                ...
                break;
            case 4 :
                // InternalIndentationAwareTestLanguage.g:1:38: RULE_OTHER
                {
                mRULE_OTHER(); 
