...
public class InternalInheritanceTest2LanguageLexer extends Lexer {
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalInheritanceTest2Language.g:236:9: ( ( 'a' .. 'z' )+ )
            // InternalInheritanceTest2Language.g:236:11: ( 'a' .. 'z' )+
            {
            // InternalInheritanceTest2Language.g:236:11: ( 'a' .. 'z' )+
            int cnt1=0;
            loop1:
            do {
                ...
                switch (alt1) {
            	case 1 :
            	    // InternalInheritanceTest2Language.g:236:12: 'a' .. 'z'
            	    {
            	    matchRange('a','z'); 
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalInheritanceTest2Language.g:238:10: ( ( '0' .. '9' )+ )
            // InternalInheritanceTest2Language.g:238:12: ( '0' .. '9' )+
            {
            // InternalInheritanceTest2Language.g:238:12: ( '0' .. '9' )+
            int cnt2=0;
            loop2:
            do {
                ...
                switch (alt2) {
            	case 1 :
            	    // InternalInheritanceTest2Language.g:238:13: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public final void mRULE_STRING() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalInheritanceTest2Language.g:240:13: ( ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' ) )
            // InternalInheritanceTest2Language.g:240:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            {
            // InternalInheritanceTest2Language.g:240:15: ( '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"' | '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\'' )
            int alt5=2;
            ...
            switch (alt5) {
                case 1 :
                    // InternalInheritanceTest2Language.g:240:16: '\"' ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )* '\"'
                    {
                    match('\"'); 
                    // InternalInheritanceTest2Language.g:240:20: ( '\\\\' . | ~ ( ( '\\\\' | '\"' ) ) )*
                    loop3:
                    do {
                        int alt3=3;
                        ...
                        switch (alt3) {
                    	case 1 :
                    	    // InternalInheritanceTest2Language.g:240:21: '\\\\' .
                    	    {
                    	    match('\\'); 
                    	    matchAny(); 
                    	    ...
                    	    break;
                    	case 2 :
                    	    // InternalInheritanceTest2Language.g:240:28: ~ ( ( '\\\\' | '\"' ) )
                    	    {
                    ...
                    break;
                case 2 :
                    // InternalInheritanceTest2Language.g:240:48: '\\'' ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )* '\\''
                    {
                    match('\''); 
                    // InternalInheritanceTest2Language.g:240:53: ( '\\\\' . | ~ ( ( '\\\\' | '\\'' ) ) )*
                    loop4:
                    do {
                        int alt4=3;
                        ...
                        switch (alt4) {
                    	case 1 :
                    	    // InternalInheritanceTest2Language.g:240:54: '\\\\' .
                    	    {
                    	    match('\\'); 
                    	    matchAny(); 
                    	    ...
                    	    break;
                    	case 2 :
                    	    // InternalInheritanceTest2Language.g:240:61: ~ ( ( '\\\\' | '\\'' ) )
                    	    {
                    	    if ( (input.LA(1)>='\u0000' && input.LA(1)<='&')||(input.LA(1)>='(' && input.LA(1)<='[')||(input.LA(1)>=']' && input.LA(1)<='\uFFFF') ) {
                    	        input.consume();
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalInheritanceTest2Language.g:242:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalInheritanceTest2Language.g:242:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalInheritanceTest2Language.g:242:24: ( options {greedy=false; } : . )*
            loop6:
            do {
                int alt6=2;
                ...
                switch (alt6) {
            	case 1 :
            	    // InternalInheritanceTest2Language.g:242:52: .
            	    {
            	    matchAny(); 
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            // InternalInheritanceTest2Language.g:244:24: (~ ( ( '\\n' | '\\r' ) ) )*
            loop7:
            do {
                int alt7=2;
    ...
    public final void mRULE_ANY_OTHER() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalInheritanceTest2Language.g:248:16: ( . )
            // InternalInheritanceTest2Language.g:248:18: .
            {
            matchAny(); 
