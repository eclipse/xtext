...
public class DelegateImpl extends UnassignedImpl implements Delegate
{
  ...
  {
    return RegionaccesstestlanguagePackage.Literals.DELEGATE;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, RegionaccesstestlanguagePackage.DELEGATE__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case RegionaccesstestlanguagePackage.DELEGATE__NAME:
        return getName();
    }
