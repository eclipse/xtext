...
public class LiveContainerBuilderIntegerationTestLanguageSyntacticSequencer extends AbstractSyntacticSequencer {

	protected LiveContainerBuilderIntegerationTestLanguageGrammarAccess grammarAccess;
	
	@Inject
	protected void init(IGrammarAccess access) {
		grammarAccess = (LiveContainerBuilderIntegerationTestLanguageGrammarAccess) access;
	}
