...
public class MultiRuleEnumTestLanguageSyntacticSequencer extends AbstractSyntacticSequencer {

	protected MultiRuleEnumTestLanguageGrammarAccess grammarAccess;
	
	@Inject
	protected void init(IGrammarAccess access) {
		grammarAccess = (MultiRuleEnumTestLanguageGrammarAccess) access;
	}
