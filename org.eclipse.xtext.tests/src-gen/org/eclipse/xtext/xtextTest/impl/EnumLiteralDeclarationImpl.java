 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.xtext.xtextTest.impl.EnumLiteralDeclarationImpl#getEnumLiteral <em>Enum Literal</em>}</li>
 *   <li>{@link org.eclipse.xtext.xtextTest.impl.EnumLiteralDeclarationImpl#getLiteral <em>Literal</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EnumLiteralDeclarationImpl extends AbstractElementImpl implements EnumLiteralDeclaration
{
  ...
  {
    return XtextTestPackage.Literals.ENUM_LITERAL_DECLARATION;
  }
    ...
    if (enumLiteral != null && enumLiteral.eIsProxy())
    {
      ...
      if (enumLiteral != oldEnumLiteral)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, XtextTestPackage.ENUM_LITERAL_DECLARATION__ENUM_LITERAL, oldEnumLiteral, enumLiteral));
      }
    }
    return enumLiteral;
  }
  ...
  public void setLiteral(Keyword newLiteral)
  {
    if (newLiteral != literal)
    {
      ...
      if (literal != null)
        msgs = ((InternalEObject)literal).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XtextTestPackage.ENUM_LITERAL_DECLARATION__LITERAL, null, msgs);
      if (newLiteral != null)
        msgs = ((InternalEObject)newLiteral).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XtextTestPackage.ENUM_LITERAL_DECLARATION__LITERAL, null, msgs);
      msgs = basicSetLiteral(newLiteral, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XtextTestPackage.ENUM_LITERAL_DECLARATION__LITERAL, newLiteral, newLiteral));
  }
