 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.xtext.validation.csvalidationtest.impl.List3Impl#getVal1 <em>Val1</em>}</li>
 *   <li>{@link org.eclipse.xtext.validation.csvalidationtest.impl.List3Impl#getVal2 <em>Val2</em>}</li>
 * </ul>
 *
 * @generated
 */
public class List3Impl extends MinimalEObjectImpl.Container implements List3
{
  /**
  ...
  {
    return CsvalidationtestPackage.Literals.LIST3;
  }
  ...
  public EList<String> getVal1()
  {
    if (val1 == null)
    {
      val1 = new EDataTypeEList<String>(String.class, this, CsvalidationtestPackage.LIST3__VAL1);
    }
    return val1;
  }
  ...
  public void setVal2(String newVal2)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CsvalidationtestPackage.LIST3__VAL2, oldVal2, val2));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case CsvalidationtestPackage.LIST3__VAL1:
        return getVal1();
      case CsvalidationtestPackage.LIST3__VAL2:
        return getVal2();
    }
