 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.xtext.validation.csvalidationtest.impl.List5Impl#getVal1 <em>Val1</em>}</li>
 *   <li>{@link org.eclipse.xtext.validation.csvalidationtest.impl.List5Impl#getVal2 <em>Val2</em>}</li>
 *   <li>{@link org.eclipse.xtext.validation.csvalidationtest.impl.List5Impl#getVal3 <em>Val3</em>}</li>
 * </ul>
 *
 * @generated
 */
public class List5Impl extends MinimalEObjectImpl.Container implements List5
{
  /**
  ...
  {
    return CsvalidationtestPackage.Literals.LIST5;
  }
  ...
  public EList<String> getVal1()
  {
    if (val1 == null)
    {
      val1 = new EDataTypeEList<String>(String.class, this, CsvalidationtestPackage.LIST5__VAL1);
    }
    return val1;
  }
  ...
  public void setVal2(String newVal2)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CsvalidationtestPackage.LIST5__VAL2, oldVal2, val2));
  }
  ...
  public void setVal3(String newVal3)
  {
    ...
    val3 = newVal3;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CsvalidationtestPackage.LIST5__VAL3, oldVal3, val3));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case CsvalidationtestPackage.LIST5__VAL1:
        return getVal1();
      case CsvalidationtestPackage.LIST5__VAL2:
        return getVal2();
      case CsvalidationtestPackage.LIST5__VAL3:
        return getVal3();
    }
