...
public class ModelImpl extends org.eclipse.xtext.linking.ignoreCaseLinkingTest.impl.ModelImpl implements Model
{
  ...
  {
    return IgnoreCaseNamespacesTestPackage.Literals.MODEL;
  }
  ...
  public EList<Import> getImports()
  {
    if (imports == null)
    {
      imports = new EObjectContainmentEList<Import>(Import.class, this, IgnoreCaseNamespacesTestPackage.MODEL__IMPORTS);
    }
    return imports;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case IgnoreCaseNamespacesTestPackage.MODEL__IMPORTS:
