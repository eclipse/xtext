...
public class IgnoreCaseNamespacesTestLanguageSyntacticSequencer extends AbstractSyntacticSequencer {

	protected IgnoreCaseNamespacesTestLanguageGrammarAccess grammarAccess;
	
	@Inject
	protected void init(IGrammarAccess access) {
		grammarAccess = (IgnoreCaseNamespacesTestLanguageGrammarAccess) access;
	}
