...
public class LangATestLanguageStandaloneSetupGenerated implements ISetup {
	...
	public void register(Injector injector) {
		...
		IResourceServiceProvider.Registry.INSTANCE.getExtensionToFactoryMap().put("langatestlanguage", serviceProvider);
		if (!EPackage.Registry.INSTANCE.containsKey("http://eclipse.org/xtext/langATestLanguage")) {
			EPackage.Registry.INSTANCE.put("http://eclipse.org/xtext/langATestLanguage", LangATestLanguagePackage.eINSTANCE);
		}
	}
}
