/**
 */
package org.eclipse.xtext.linking.bug287988Test.util;
 ...
 * @generated
 */
public class Bug287988TestSwitch<T> extends Switch<T>
{
  /**
   ...
   * @generated
   */
  protected static Bug287988TestPackage modelPackage;
   ...
   * @generated
   */
  public Bug287988TestSwitch()
  {
    if (modelPackage == null)
    {
      modelPackage = Bug287988TestPackage.eINSTANCE;
    }
  }
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case Bug287988TestPackage.BASE_ATTRIBUTE:
      {
      ...
      case Bug287988TestPackage.ATTRIBUTE:
      {
        ...
        if (result == null) result = caseBaseAttribute(attribute);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case Bug287988TestPackage.MASTER:
      {
        ...
        if (result == null) result = caseBaseAttribute(master);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
