 ...
 *   <li>{@link org.eclipse.xtext.serializer.sequencertest.GroupMultiplicities#getVal3 <em>Val3</em>}</li>
 *   <li>{@link org.eclipse.xtext.serializer.sequencertest.GroupMultiplicities#getVal4 <em>Val4</em>}</li>
 *   <li>{@link org.eclipse.xtext.serializer.sequencertest.GroupMultiplicities#getVal5 <em>Val5</em>}</li>
...
public interface GroupMultiplicities extends EObject
{
   ...
   * @see #setVal1(String)
   * @see org.eclipse.xtext.serializer.sequencertest.SequencertestPackage#getGroupMultiplicities_Val1()
   * @model
   * @generated
   */
  String getVal1();
  ...
  /**
   * Sets the value of the '{@link org.eclipse.xtext.serializer.sequencertest.GroupMultiplicities#getVal1 <em>Val1</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setVal2(String)
   * @see org.eclipse.xtext.serializer.sequencertest.SequencertestPackage#getGroupMultiplicities_Val2()
   * @model
   * @generated
   */
  String getVal2();
  ...
  /**
   * Sets the value of the '{@link org.eclipse.xtext.serializer.sequencertest.GroupMultiplicities#getVal2 <em>Val2</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setVal3(String)
   * @see org.eclipse.xtext.serializer.sequencertest.SequencertestPackage#getGroupMultiplicities_Val3()
   * @model
   * @generated
   */
  String getVal3();
  ...
  /**
   * Sets the value of the '{@link org.eclipse.xtext.serializer.sequencertest.GroupMultiplicities#getVal3 <em>Val3</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.eclipse.xtext.serializer.sequencertest.SequencertestPackage#getGroupMultiplicities_Val4()
   * @model unique="false"
   * @generated
   */
   ...
   * @see org.eclipse.xtext.serializer.sequencertest.SequencertestPackage#getGroupMultiplicities_Val5()
   * @model unique="false"
   * @generated
   */
   ...
   * @see org.eclipse.xtext.serializer.sequencertest.SequencertestPackage#getGroupMultiplicities_Val6()
   * @model unique="false"
   * @generated
   */
   ...
   * @see org.eclipse.xtext.serializer.sequencertest.SequencertestPackage#getGroupMultiplicities_Val7()
   * @model unique="false"
   * @generated
   */
