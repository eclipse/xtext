 ...
 * @generated
 */
public class ContainmentRefNImpl extends MinimalEObjectImpl.Container implements ContainmentRefN
{
  /**
  ...
  {
    return AssignmentFinderTestPackage.Literals.CONTAINMENT_REF_N;
  }
  ...
  public void setVal1(String newVal1)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AssignmentFinderTestPackage.CONTAINMENT_REF_N__VAL1, oldVal1, val1));
  }
  ...
  public void setVal2(String newVal2)
  {
    ...
    val2 = newVal2;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AssignmentFinderTestPackage.CONTAINMENT_REF_N__VAL2, oldVal2, val2));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case AssignmentFinderTestPackage.CONTAINMENT_REF_N__VAL1:
        return getVal1();
      case AssignmentFinderTestPackage.CONTAINMENT_REF_N__VAL2:
        return getVal2();
    }
