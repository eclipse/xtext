 ...
 * @generated
 */
public class UnassignedDatatypeImpl extends MinimalEObjectImpl.Container implements UnassignedDatatype
{
  /**
   ...
   * @generated
   */
  protected UnassignedDatatypeImpl()
  {
    super();
  }
  ...
  {
    return SyntacticsequencertestPackage.Literals.UNASSIGNED_DATATYPE;
  }
  ...
  public void setVal(String newVal)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SyntacticsequencertestPackage.UNASSIGNED_DATATYPE__VAL, oldVal, val));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SyntacticsequencertestPackage.UNASSIGNED_DATATYPE__VAL:
        return getVal();
    }
