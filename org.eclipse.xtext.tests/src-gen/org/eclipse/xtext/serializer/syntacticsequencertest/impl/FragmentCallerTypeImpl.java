 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.xtext.serializer.syntacticsequencertest.impl.FragmentCallerTypeImpl#getVal1 <em>Val1</em>}</li>
 *   <li>{@link org.eclipse.xtext.serializer.syntacticsequencertest.impl.FragmentCallerTypeImpl#getVal <em>Val</em>}</li>
 *   <li>{@link org.eclipse.xtext.serializer.syntacticsequencertest.impl.FragmentCallerTypeImpl#getFragVal <em>Frag Val</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FragmentCallerTypeImpl extends MinimalEObjectImpl.Container implements FragmentCallerType
{
  ...
  {
    return SyntacticsequencertestPackage.Literals.FRAGMENT_CALLER_TYPE;
  }
  ...
  public void setVal1(String newVal1)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SyntacticsequencertestPackage.FRAGMENT_CALLER_TYPE__VAL1, oldVal1, val1));
  }
  ...
  public void setVal(String newVal)
  {
    ...
    val = newVal;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SyntacticsequencertestPackage.FRAGMENT_CALLER_TYPE__VAL, oldVal, val));
  }
  ...
  public void setFragVal(String newFragVal)
  {
    ...
    fragVal = newFragVal;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SyntacticsequencertestPackage.FRAGMENT_CALLER_TYPE__FRAG_VAL, oldFragVal, fragVal));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SyntacticsequencertestPackage.FRAGMENT_CALLER_TYPE__VAL1:
        return getVal1();
      case SyntacticsequencertestPackage.FRAGMENT_CALLER_TYPE__VAL:
        return getVal();
      case SyntacticsequencertestPackage.FRAGMENT_CALLER_TYPE__FRAG_VAL:
        return getFragVal();
    }
