...
public class EcoreFragmentTestLanguageSyntacticSequencer extends AbstractSyntacticSequencer {

	protected EcoreFragmentTestLanguageGrammarAccess grammarAccess;
	
	@Inject
	protected void init(IGrammarAccess access) {
		grammarAccess = (EcoreFragmentTestLanguageGrammarAccess) access;
	}
