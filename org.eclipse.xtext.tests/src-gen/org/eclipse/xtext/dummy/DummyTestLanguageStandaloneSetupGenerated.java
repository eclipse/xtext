...
public class DummyTestLanguageStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new DummyTestLanguageRuntimeModule());
	}
	...
	public void register(Injector injector) {
		...
		IResourceServiceProvider.Registry.INSTANCE.getExtensionToFactoryMap().put("dummytestlanguage", serviceProvider);
		if (!EPackage.Registry.INSTANCE.containsKey("http://www.eclipse.org/2008/xtext/DummyLang")) {
			EPackage.Registry.INSTANCE.put("http://www.eclipse.org/2008/xtext/DummyLang", DummyLangPackage.eINSTANCE);
		}
	}
}
