 ...
 * </copyright>
 *
 * $Id: SubsubpackageSwitch.java,v 1.1 2010/02/04 09:24:54 sefftinge Exp $
 */
 ...
 * @generated
 */
public class SubsubpackageSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SubsubpackagePackage.ANOTHER_TYPE: {
				AnotherType anotherType = (AnotherType)theEObject;
				T result = caseAnotherType(anotherType);
				if (result == null) result = caseAType(anotherType);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Another Type</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Another Type</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAnotherType(AnotherType object) {
		return null;
	}
