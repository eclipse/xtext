...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Extends Resource EObject</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.eclipse.xtext.metamodelreferencing.tests.ecorePerPlatformResource.impl.ExtendsResourceEObjectImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.xtext.metamodelreferencing.tests.ecorePerPlatformResource.impl.ExtendsResourceEObjectImpl#getEObjectReference1 <em>EObject Reference1</em>}</li>
 *   <li>{@link org.eclipse.xtext.metamodelreferencing.tests.ecorePerPlatformResource.impl.ExtendsResourceEObjectImpl#getEObjectReference2 <em>EObject Reference2</em>}</li>
 *   <li>{@link org.eclipse.xtext.metamodelreferencing.tests.ecorePerPlatformResource.impl.ExtendsResourceEObjectImpl#getEObjectReference3 <em>EObject Reference3</em>}</li>
 *   <li>{@link org.eclipse.xtext.metamodelreferencing.tests.ecorePerPlatformResource.impl.ExtendsResourceEObjectImpl#getEObjectReference4 <em>EObject Reference4</em>}</li>
 *   <li>{@link org.eclipse.xtext.metamodelreferencing.tests.ecorePerPlatformResource.impl.ExtendsResourceEObjectImpl#getEObjectContainment <em>EObject Containment</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class ExtendsResourceEObjectImpl extends EObjectImpl implements ExtendsResourceEObject {
	/**
	 ...
	 * @generated
	 */
	protected ExtendsResourceEObjectImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return EcorePerPlatformResourcePackage.Literals.EXTENDS_RESOURCE_EOBJECT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcorePerPlatformResourcePackage.EXTENDS_RESOURCE_EOBJECT__NAME, oldName, name));
	}
	...
	public EObject getEObjectReference1() {
		if (eObjectReference1 != null && eObjectReference1.eIsProxy()) {
			...
			if (eObjectReference1 != oldEObjectReference1) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EcorePerPlatformResourcePackage.EXTENDS_RESOURCE_EOBJECT__EOBJECT_REFERENCE1, oldEObjectReference1, eObjectReference1));
			}
		}
	...
	public void setEObjectReference1(EObject newEObjectReference1) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcorePerPlatformResourcePackage.EXTENDS_RESOURCE_EOBJECT__EOBJECT_REFERENCE1, oldEObjectReference1, eObjectReference1));
	}
	...
	public ExtendsNsURIEObject getEObjectReference2() {
		if (eObjectReference2 != null && eObjectReference2.eIsProxy()) {
			...
			if (eObjectReference2 != oldEObjectReference2) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EcorePerPlatformResourcePackage.EXTENDS_RESOURCE_EOBJECT__EOBJECT_REFERENCE2, oldEObjectReference2, eObjectReference2));
			}
		}
	...
	public void setEObjectReference2(ExtendsNsURIEObject newEObjectReference2) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcorePerPlatformResourcePackage.EXTENDS_RESOURCE_EOBJECT__EOBJECT_REFERENCE2, oldEObjectReference2, eObjectReference2));
	}
	...
	public ExtendsPluginEObject getEObjectReference3() {
		if (eObjectReference3 != null && eObjectReference3.eIsProxy()) {
			...
			if (eObjectReference3 != oldEObjectReference3) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EcorePerPlatformResourcePackage.EXTENDS_RESOURCE_EOBJECT__EOBJECT_REFERENCE3, oldEObjectReference3, eObjectReference3));
			}
		}
	...
	public void setEObjectReference3(ExtendsPluginEObject newEObjectReference3) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcorePerPlatformResourcePackage.EXTENDS_RESOURCE_EOBJECT__EOBJECT_REFERENCE3, oldEObjectReference3, eObjectReference3));
	}
	...
	public ExtendsResourceEObject getEObjectReference4() {
		if (eObjectReference4 != null && eObjectReference4.eIsProxy()) {
			...
			if (eObjectReference4 != oldEObjectReference4) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EcorePerPlatformResourcePackage.EXTENDS_RESOURCE_EOBJECT__EOBJECT_REFERENCE4, oldEObjectReference4, eObjectReference4));
			}
		}
	...
	public void setEObjectReference4(ExtendsResourceEObject newEObjectReference4) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcorePerPlatformResourcePackage.EXTENDS_RESOURCE_EOBJECT__EOBJECT_REFERENCE4, oldEObjectReference4, eObjectReference4));
	}
	...
	public EList<EObject> getEObjectContainment() {
		if (eObjectContainment == null) {
			eObjectContainment = new EObjectContainmentEList<EObject>(EObject.class, this, EcorePerPlatformResourcePackage.EXTENDS_RESOURCE_EOBJECT__EOBJECT_CONTAINMENT);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case EcorePerPlatformResourcePackage.EXTENDS_RESOURCE_EOBJECT__EOBJECT_CONTAINMENT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EcorePerPlatformResourcePackage.EXTENDS_RESOURCE_EOBJECT__NAME:
				return getName();
			case EcorePerPlatformResourcePackage.EXTENDS_RESOURCE_EOBJECT__EOBJECT_REFERENCE1:
				if (resolve) return getEObjectReference1();
				return basicGetEObjectReference1();
			case EcorePerPlatformResourcePackage.EXTENDS_RESOURCE_EOBJECT__EOBJECT_REFERENCE2:
				if (resolve) return getEObjectReference2();
				return basicGetEObjectReference2();
			case EcorePerPlatformResourcePackage.EXTENDS_RESOURCE_EOBJECT__EOBJECT_REFERENCE3:
				if (resolve) return getEObjectReference3();
				return basicGetEObjectReference3();
			case EcorePerPlatformResourcePackage.EXTENDS_RESOURCE_EOBJECT__EOBJECT_REFERENCE4:
