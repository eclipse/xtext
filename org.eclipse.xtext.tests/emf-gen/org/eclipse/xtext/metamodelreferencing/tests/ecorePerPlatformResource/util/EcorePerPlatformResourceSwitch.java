 ...
 * $Id$
 */
package org.eclipse.xtext.metamodelreferencing.tests.ecorePerPlatformResource.util;
 ...
 * @generated
 */
public class EcorePerPlatformResourceSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static EcorePerPlatformResourcePackage modelPackage;
	 ...
	 * @generated
	 */
	public EcorePerPlatformResourceSwitch() {
		if (modelPackage == null) {
			modelPackage = EcorePerPlatformResourcePackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case EcorePerPlatformResourcePackage.EXTENDS_RESOURCE_EOBJECT: {
				ExtendsResourceEObject extendsResourceEObject = (ExtendsResourceEObject)theEObject;
				T result = caseExtendsResourceEObject(extendsResourceEObject);
...
} //EcorePerPlatformResourceSwitch
