 ...
 * @generated
 */
public class EcorePerPlatformPluginAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	public EcorePerPlatformPluginAdapterFactory() {
	 ...
	 * @generated
	 */
	protected EcorePerPlatformPluginSwitch<Adapter> modelSwitch =
		new EcorePerPlatformPluginSwitch<Adapter>() {
			@Override
			public Adapter caseExtendsPluginEObject(ExtendsPluginEObject object) {
				return createExtendsPluginEObjectAdapter();
			}
			@Override
			public Adapter caseExtendsEAttribute(ExtendsEAttribute object) {
				return createExtendsEAttributeAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.xtext.metamodelreferencing.tests.ecorePerPlatformPlugin.ExtendsEAttribute <em>Extends EAttribute</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 * @return the new adapter.
	 * @see org.eclipse.xtext.metamodelreferencing.tests.ecorePerPlatformPlugin.ExtendsEAttribute
	 * @generated
	 */
	public Adapter createExtendsEAttributeAdapter() {
		return null;
	}
...
} //EcorePerPlatformPluginAdapterFactory
