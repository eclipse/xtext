...
public class RuleEngineParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, RuleEngineGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getRuleAccess().getDeviceStateAssignment_3(), "rule__Rule__DeviceStateAssignment_3");
			builder.put(grammarAccess.getRuleAccess().getThenPartAssignment_5(), "rule__Rule__ThenPartAssignment_5");
