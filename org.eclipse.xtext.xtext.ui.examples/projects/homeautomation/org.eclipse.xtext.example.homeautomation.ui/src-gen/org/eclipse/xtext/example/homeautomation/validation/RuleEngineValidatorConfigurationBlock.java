...
public class RuleEngineValidatorConfigurationBlock extends XbaseValidationConfigurationBlock {
	...
	protected IDialogSettings getDialogSettings() {
		...
		IDialogSettings section = dialogSettings.getSection("RuleEngine");
		if (section == null) {
			return dialogSettings.addNewSection("RuleEngine");
		}
		return section;
	}
}
