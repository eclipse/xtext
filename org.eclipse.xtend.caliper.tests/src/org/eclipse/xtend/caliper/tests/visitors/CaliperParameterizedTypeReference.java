...
public class CaliperParameterizedTypeReference extends CaliperTypeReference {
   ...
   * @return the kind constant '2'.
   */
  public int getKind() {
    return KIND_CALIPER_PARAMETERIZED_TYPE_REFERENCE;
  }
  
  public int acceptVisitor(final Visitor visitor, final int i, final long k) {
    return visitor.visitCaliperParameterizedTypeReference(this, i, k);
  }
}
