...
public class CompilerBug410797Test extends AbstractXtendCompilerTest {
  ...
  public void testBug_410797_01() {
    ...
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("final Function1<E, ArrayList<F>> _function = (E e) -> {");
    _builder_1.newLine();
    _builder_1.append("        ");
    ...
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("final Function1<F, D> _function_1 = (F it) -> {");
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("return this.d(it, g);");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("};");
    _builder_1.newLine();
  ...
  public void testBug_410797_03() {
    ...
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("return this.d(it, _g);");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("};");
    _builder_1.newLine();
  ...
  public void testBug_410797_04() {
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("final Function2<Integer, LeafInfo, Integer> _function = (Integer x, LeafInfo i) -> {");
    _builder_1.newLine();
    _builder_1.append("      ");
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("final Function2<Integer, CommentInfo, Integer> _function = (Integer x, CommentInfo i) -> {");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("int _newLines = i.getNewLines();");
    _builder_1.newLine();
