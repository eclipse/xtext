...
public class CompilerBug465058Test extends org.eclipse.xtend.core.tests.compiler.CompilerBug465058Test {
  @Test
  @Override
  public void test_01() {
    ...
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("return IterableExtensions.<String>head(this.list);");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("};");
    _builder_1.newLine();
  ...
  public void test_05() {
    ...
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("return this.<String>head2(this.list);");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("};");
    _builder_1.newLine();
  ...
  public void test_07() {
    ...
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("return this.<String>head2(((String[])Conversions.unwrapArray(this.list, String.class)));");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("};");
    _builder_1.newLine();
  ...
  public void test_08() {
    ...
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("return this.<String>head2(new String[] { \"one\", \"two\", \"three\" });");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("};");
    _builder_1.newLine();
  ...
  public void test_16() {
    ...
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("return this.<String>head2(Collections.<String>unmodifiableList(CollectionLiterals.<String>newArrayList(\"one\", \"two\", \"three\")));");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("};");
    _builder_1.newLine();
  ...
  public void test_19() {
    ...
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("return this.<String>head2(new Comparable[] { \"\", \"\" });");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("};");
    _builder_1.newLine();
