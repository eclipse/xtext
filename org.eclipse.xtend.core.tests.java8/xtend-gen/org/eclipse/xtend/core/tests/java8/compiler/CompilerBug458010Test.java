...
public class CompilerBug458010Test extends AbstractXtendCompilerTest {
  ...
  public void test_10_b() {
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("Collector<Demo.Person, ?, Map<Demo.Person.Sex, Double>> _groupingBy = Collectors.groupingBy(_function, ");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("Collectors.<Demo.Person>averagingInt(((ToIntFunction<Demo.Person>) (Demo.Person it) -> {");
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("return it.getAge();");
    _builder_1.newLine();
