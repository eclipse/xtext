...
import org.eclipse.xtext.testlanguages.backtracking.ui.outline.BeeLangTestLanguageOutlineTreeProvider;
import org.eclipse.xtext.testlanguages.backtracking.ui.quickfix.BeeLangTestLanguageQuickfixProvider;
...
/**
 * Manual modifications go to {@link BeeLangTestLanguageUiModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractBeeLangTestLanguageUiModule extends DefaultUiModule {

	public AbstractBeeLangTestLanguageUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public Class<? extends ILabelProvider> bindILabelProvider() {
		return BeeLangTestLanguageLabelProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.labeling.LabelProviderFragment2
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(ILabelProvider.class).annotatedWith(ResourceServiceDescriptionLabelProvider.class).to(BeeLangTestLanguageDescriptionLabelProvider.class);
	}
	...
	public Class<? extends IssueResolutionProvider> bindIssueResolutionProvider() {
		return BeeLangTestLanguageQuickfixProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.contentAssist.ContentAssistFragment2
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return BeeLangTestLanguageProposalProvider.class;
	}
