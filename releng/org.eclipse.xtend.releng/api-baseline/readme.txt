...
1. Open the api-baseline.target file {your_local_git_repo}/releng/org.eclipse.xtend.releng/api-baseline/api-baseline.target
2. Click export icon in the right-upper corner of your target definition editor
