...
<mspec:mspec xmlns:mspec="http://www.eclipse.org/buckminster/MetaData-1.0" materializer="p2" name="Xtext Latest Platform MSPEC" shortDesc="Materializes an eclipse platform based on Indigo" url="xtext-platform-Latest.cquery">
