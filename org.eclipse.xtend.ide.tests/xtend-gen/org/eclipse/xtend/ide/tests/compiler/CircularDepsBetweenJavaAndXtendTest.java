...
public class CircularDepsBetweenJavaAndXtendTest extends AbstractXtendUITestCase {
  ...
  public void testJavaSignatureDependsOnXtend() {
    try {
      ...
      _builder.append("}");
      _builder.newLine();
      final IFile file1 = this.workbenchTestHelper.createFile("test/FooProvider.java", _builder.toString());
      StringConcatenation _builder_1 = new StringConcatenation();
      ...
      _builder_1.newLine();
      _builder_1.append("\t");
      _builder_1.append("int size");
      _builder_1.newLine();
      _builder_1.append("}");
      _builder_1.newLine();
      final IFile file2 = this.workbenchTestHelper.createFile("test/Foo.xtend", _builder_1.toString());
      StringConcatenation _builder_2 = new StringConcatenation();
      ...
      _builder_2.newLine();
      _builder_2.append("\t\t");
      _builder_2.append("println(foo.size)");
      _builder_2.newLine();
      _builder_2.append("\t");
      _builder_2.append("}");
      _builder_2.newLine();
