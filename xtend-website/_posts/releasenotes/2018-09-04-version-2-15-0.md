...
## Fixed Organize Imports

In the past there were cases where oranzize import breaks code from multi catch statements or adds useless static imports whereas a static extension import was already added. Both cases are fixed now.

## Links

## Fixed Issues

As in every release we are eagerly hunting down the bugs, review and integrate lots of contributions. TODO issues, TODO Pull Requests and TODO Bugzilla tickets have made it into this release. For further details please refer to the following lists:
