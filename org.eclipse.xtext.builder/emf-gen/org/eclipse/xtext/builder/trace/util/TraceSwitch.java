...
public class TraceSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TracePackage.DEBUG_TRACE_REGION: {
				DebugTraceRegion debugTraceRegion = (DebugTraceRegion)theEObject;
				T result = caseDebugTraceRegion(debugTraceRegion);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Debug Trace Region</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Debug Trace Region</em>'.
