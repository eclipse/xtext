...
public class TraceAdapterFactory extends AdapterFactoryImpl {
	...
	protected TraceSwitch<Adapter> modelSwitch =
		new TraceSwitch<Adapter>() {
			@Override
			public Adapter caseDebugTraceRegion(DebugTraceRegion object) {
				return createDebugTraceRegionAdapter();
			}
			@Override
			public Adapter caseDebugLocationData(DebugLocationData object) {
				return createDebugLocationDataAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.xtext.builder.trace.DebugTraceRegion <em>Debug Trace Region</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createDebugTraceRegionAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.xtext.builder.trace.DebugLocationData <em>Debug Location Data</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createDebugLocationDataAdapter() {
		return null;
	}
