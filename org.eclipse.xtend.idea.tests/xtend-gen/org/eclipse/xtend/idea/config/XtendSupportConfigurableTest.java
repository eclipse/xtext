  ...
  public void testPlainJavaOutputConfiguration_02() {
    ...
    final Computable<Module> _function = () -> {
      try {
        ...
        VirtualFile _baseDir = _project_1.getBaseDir();
    ...
    final Function1<VirtualFile, Boolean> _function_1 = (VirtualFile it) -> {
      boolean _xblockexpression = false;
      {
        ...
        final String urlToCheck = _path.replace("file://", "");
        String _outputDirectory_2 = xtendConfig.getOutputDirectory();
        _xblockexpression = Objects.equal(_outputDirectory_2, urlToCheck);
      }
      return Boolean.valueOf(_xblockexpression);
    };
    ...
    final Function1<VirtualFile, Boolean> _function_2 = (VirtualFile it) -> {
      boolean _xblockexpression = false;
      {
        String _path = it.getPath();
        final String urlToCheck = _path.replace("file://", "");
        String _testOutputDirectory_2 = xtendConfig.getTestOutputDirectory();
        _xblockexpression = Objects.equal(_testOutputDirectory_2, urlToCheck);
      }
      return Boolean.valueOf(_xblockexpression);
    };
