...
public class XtendDocumentationTest extends PsiTestCase {
  ...
  protected void setUp() throws Exception {
    ...
    final Procedure1<Object> _function = (Object it) -> {
      try {
        String _testName = this.getTestName(true);
        ...
        this.src = _createDirectoryIfMissing;
        VirtualFile _createDirectoryIfMissing_1 = VfsUtil.createDirectoryIfMissing(root, "xtend-gen");
        this.xtendgen = _createDirectoryIfMissing_1;
        Module _createModule = this.createModule("myModule");
        this.myModule = _createModule;
