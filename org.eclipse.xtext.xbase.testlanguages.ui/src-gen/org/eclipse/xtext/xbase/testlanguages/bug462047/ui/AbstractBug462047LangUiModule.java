...
/**
 * Manual modifications go to {@link Bug462047LangUiModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractBug462047LangUiModule extends DefaultXbaseUiModule {
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(org.eclipse.xtext.xbase.testlanguages.bug462047.parser.antlr.internal.InternalBug462047LangLexer.class);
	}
	...
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalBug462047LangLexer.class).toProvider(LexerProvider.create(InternalBug462047LangLexer.class));
	}
	...
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return Bug462047LangProposalProvider.class;
	}
