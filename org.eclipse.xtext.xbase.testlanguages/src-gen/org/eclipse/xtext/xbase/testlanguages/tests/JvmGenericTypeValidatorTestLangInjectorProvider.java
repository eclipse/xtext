...
public class JvmGenericTypeValidatorTestLangInjectorProvider implements IInjectorProvider, IRegistryConfigurator {
	...
	protected JvmGenericTypeValidatorTestLangRuntimeModule createRuntimeModule() {
		...
		return new JvmGenericTypeValidatorTestLangRuntimeModule() {
			...
			public ClassLoader bindClassLoaderToInstance() {
				return JvmGenericTypeValidatorTestLangInjectorProvider.this.getClass()
						.getClassLoader();
			}
		};
	}
