 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.xtext.xbase.testlanguages.jvmGenericTypeValidatorTestLang.impl.MyTypeImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MyTypeImpl extends MinimalEObjectImpl.Container implements MyType
{
  ...
  {
    return JvmGenericTypeValidatorTestLangPackage.Literals.MY_TYPE;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, JvmGenericTypeValidatorTestLangPackage.MY_TYPE__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case JvmGenericTypeValidatorTestLangPackage.MY_TYPE__NAME:
        return getName();
    }
