...
entryRuleContentAssistFragmentTestLanguageRoot returns [EObject current=null]:
	...
	{ $current=$iv_ruleContentAssistFragmentTestLanguageRoot.current; }
	EOF;

// Rule ContentAssistFragmentTestLanguageRoot
ruleContentAssistFragmentTestLanguageRoot returns [EObject current=null]
@init {
	enterRule();
}
@after {
