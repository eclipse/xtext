...
public class JvmGenericTypeValidatorTestLangSemanticSequencer extends XbaseSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == JvmGenericTypeValidatorTestLangPackage.eINSTANCE)
			switch (semanticObject.eClass().getClassifierID()) {
			case JvmGenericTypeValidatorTestLangPackage.JVM_GENERIC_TYPE_VALIDATOR_TEST_LANG_MODEL:
				sequence_JvmGenericTypeValidatorTestLangModel(context, (JvmGenericTypeValidatorTestLangModel) semanticObject); 
				return; 
	 ...
	 * <pre>
	 * Contexts:
	 *     JvmGenericTypeValidatorTestLangModel returns JvmGenericTypeValidatorTestLangModel
	 *
	 * Constraint:
	 *     ((package=QualifiedName? importSection=XImportSection modelTypes+=MyType+) | (package=QualifiedName? modelTypes+=MyType+) | modelTypes+=MyType+)?
	 * </pre>
	 */
	protected void sequence_JvmGenericTypeValidatorTestLangModel(ISerializationContext context, JvmGenericTypeValidatorTestLangModel semanticObject) {
	 ...
	 * <pre>
	 * Contexts:
	 *     MyType returns MyInterface
	 *     MyInterface returns MyInterface
	 *
	 * Constraint:
	 *     (
	 *         name=ValidID 
