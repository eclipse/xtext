...
public class JvmGenericTypeValidatorTestLangSyntacticSequencer extends AbstractSyntacticSequencer {

	protected JvmGenericTypeValidatorTestLangGrammarAccess grammarAccess;
	protected AbstractElementAlias match_JvmGenericTypeValidatorTestLangModel_SemicolonKeyword_0_2_q;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (JvmGenericTypeValidatorTestLangGrammarAccess) access;
		match_JvmGenericTypeValidatorTestLangModel_SemicolonKeyword_0_2_q = new TokenAlias(false, true, grammarAccess.getJvmGenericTypeValidatorTestLangModelAccess().getSemicolonKeyword_0_2());
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			if (match_JvmGenericTypeValidatorTestLangModel_SemicolonKeyword_0_2_q.equals(syntax))
				emit_JvmGenericTypeValidatorTestLangModel_SemicolonKeyword_0_2_q(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 *     package=QualifiedName (ambiguity) modelTypes+=MyType
	 
	 * </pre>
	 */
	protected void emit_JvmGenericTypeValidatorTestLangModel_SemicolonKeyword_0_2_q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
