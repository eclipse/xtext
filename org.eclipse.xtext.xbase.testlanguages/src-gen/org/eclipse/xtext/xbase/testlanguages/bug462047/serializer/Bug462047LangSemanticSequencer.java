...
public class Bug462047LangSemanticSequencer extends XbaseSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == Bug462047Package.eINSTANCE)
			switch (semanticObject.eClass().getClassifierID()) {
			case Bug462047Package.BUG462047_ELEMENT:
				sequence_Bug462047Element(context, (Bug462047Element) semanticObject); 
				return; 
			case Bug462047Package.BUG462047_ROOT:
				sequence_Bug462047Root(context, (Bug462047Root) semanticObject); 
				return; 
			}
