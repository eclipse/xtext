...
public class PureXbaseParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, PureXbaseGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getInitialisedVariableDeclarationAccess().getAlternatives_1(), "rule__InitialisedVariableDeclaration__Alternatives_1");
			builder.put(grammarAccess.getInitialisedVariableDeclarationAccess().getAlternatives_2(), "rule__InitialisedVariableDeclaration__Alternatives_2");
			...
			builder.put(grammarAccess.getSpecialBlockExpressionAccess().getGroup_1(), "rule__SpecialBlockExpression__Group_1__0");
			...
			builder.put(grammarAccess.getInitialisedVariableDeclarationAccess().getGroup(), "rule__InitialisedVariableDeclaration__Group__0");
			builder.put(grammarAccess.getInitialisedVariableDeclarationAccess().getGroup_2_0(), "rule__InitialisedVariableDeclaration__Group_2_0__0");
			builder.put(grammarAccess.getInitialisedVariableDeclarationAccess().getGroup_2_0_0(), "rule__InitialisedVariableDeclaration__Group_2_0_0__0");
			...
			builder.put(grammarAccess.getModelAccess().getBlockAssignment_1(), "rule__Model__BlockAssignment_1");
			builder.put(grammarAccess.getSpecialBlockExpressionAccess().getExpressionsAssignment_1_0(), "rule__SpecialBlockExpression__ExpressionsAssignment_1_0");
			...
			builder.put(grammarAccess.getInitialisedVariableDeclarationAccess().getTypeAssignment_2_0_0_0(), "rule__InitialisedVariableDeclaration__TypeAssignment_2_0_0_0");
			builder.put(grammarAccess.getInitialisedVariableDeclarationAccess().getNameAssignment_2_0_0_1(), "rule__InitialisedVariableDeclaration__NameAssignment_2_0_0_1");
			builder.put(grammarAccess.getInitialisedVariableDeclarationAccess().getNameAssignment_2_1(), "rule__InitialisedVariableDeclaration__NameAssignment_2_1");
			builder.put(grammarAccess.getInitialisedVariableDeclarationAccess().getRightAssignment_4(), "rule__InitialisedVariableDeclaration__RightAssignment_4");
