...
/**
 * Manual modifications go to {@link XtendUiModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractXtendUiModule extends DefaultXbaseWithAnnotationsUiModule {

	public AbstractXtendUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureCompareViewerTitle(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(UIBindings.COMPARE_VIEWER_TITLE)).toInstance("Xtend Compare");
	}
