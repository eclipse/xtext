...
public class CompilerBug437365Test extends AbstractXtendCompilerTest {
  ...
  public void test_02() {
    ...
    _builder.newLine();
    _builder.append("        ");
    _builder.append("val arrayOfList = newArrayOfSize(4);");
    _builder.newLine();
    _builder.append("        ");
    _builder.append("arrayOfList.set(0, new java.util.LinkedList())");
    _builder.newLine();
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("final LinkedList<String>[] arrayOfList = new LinkedList[4];");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("LinkedList<String> _linkedList = new LinkedList<String>();");
    _builder_1.newLine();
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("LinkedList<String> _get = arrayOfList[0];");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("String _string = new String();");
    _builder_1.newLine();
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("LinkedList<String> _get_1 = arrayOfList[0];");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("final String a = _get_1.get(0);");
    _builder_1.newLine();
