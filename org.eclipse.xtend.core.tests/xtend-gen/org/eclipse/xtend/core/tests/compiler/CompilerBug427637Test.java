...
public class CompilerBug427637Test extends AbstractXtendCompilerTest {
  ...
  public void testBug_427637_04() {
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("this.forEach2(list.subList(1, 1), _function);");
    _builder_1.newLine();
    _builder_1.append("  ");
    _builder_1.append("}");
    _builder_1.newLine();
  ...
  public void testBug_427637_04_b() {
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("list.subList(1, 1).forEach(_function);");
    _builder_1.newLine();
    _builder_1.append("  ");
    _builder_1.append("}");
    _builder_1.newLine();
  ...
  public void testBug_427637_05() {
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("this.<V>forEach2(list.subList(1, 1), _function);");
    _builder_1.newLine();
    _builder_1.append("  ");
    _builder_1.append("}");
    _builder_1.newLine();
  ...
  public void testBug_427637_11() {
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("list.subList(0, 1).forEach(_function);");
    _builder_1.newLine();
    _builder_1.append("  ");
    _builder_1.append("}");
    _builder_1.newLine();
  ...
  public void testBug_427637_12() {
    ...
    _builder_1.newLine();
    _builder_1.append("          ");
    _builder_1.append("change.getAddedSubList().forEach(_function);");
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("}");
    _builder_1.newLine();
    ...
    _builder_1.newLine();
    _builder_1.append("          ");
    _builder_1.append("change.getRemoved().forEach(_function_1);");
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("}");
    _builder_1.newLine();
  ...
  public void testBug_427637_14() {
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("this.forEach2(change.getAddedSubList(), _function);");
    _builder_1.newLine();
    _builder_1.append("  ");
    _builder_1.append("}");
    _builder_1.newLine();
  ...
  public void testBug_427637_15() {
    ...
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("return new ToStringHelper().toString(this);");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("}");
    _builder_1.newLine();
    ...
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("return this.newNewLineData(leafs, newLines2, newLines2, it.increaseIndentationChange, it.decreaseIndentationChange, doc.isDebugConflicts());");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("}");
    _builder_1.newLine();
    ...
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("final int blankline = doc.getCfg().get(key);");
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("final int preserve = doc.getCfg().get(XbaseFormatterPreferenceKeys.preserveBlankLines);");
    _builder_1.newLine();
    _builder_1.append("        ");
    ...
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("_xblockexpression = this.newNewLineData(leafs, min, max, it.increaseIndentationChange, it.decreaseIndentationChange, doc.isDebugConflicts());");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("}");
    _builder_1.newLine();
    ...
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("final boolean newLine = doc.getCfg().get(key);");
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("final boolean preserve = doc.getCfg().get(XbaseFormatterPreferenceKeys.preserveNewLines);");
    _builder_1.newLine();
    _builder_1.append("        ");
    ...
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("_xblockexpression = this.newNewLineData(leafs, _xifexpression, _xifexpression_1, it.increaseIndentationChange, it.decreaseIndentationChange, ");
    _builder_1.newLine();
    _builder_1.append("          ");
    _builder_1.append("doc.isDebugConflicts());");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("}");
    _builder_1.newLine();
    ...
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("_xblockexpression = this.newNewLineData(leafs, minmax, minmax, it.increaseIndentationChange, it.decreaseIndentationChange, doc.isDebugConflicts());");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("}");
    _builder_1.newLine();
    ...
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("final boolean space = doc.getCfg().get(key);");
    _builder_1.newLine();
    _builder_1.append("        ");
    ...
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("_xblockexpression = this.newWhitespaceData(leafs, _xifexpression, it.increaseIndentationChange, it.decreaseIndentationChange, doc.isDebugConflicts());");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("}");
    _builder_1.newLine();
    ...
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("_xifexpression = this.newFormattingData(this._hiddenLeafAccess.getHiddenLeafsAfter(node), init);");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("}");
    _builder_1.newLine();
    ...
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("_xifexpression = this.newFormattingData(this._hiddenLeafAccess.getHiddenLeafsBefore(node), init);");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("}");
    _builder_1.newLine();
    ...
    _builder_1.newLine();
    _builder_1.append("          ");
    _builder_1.append("Function1<? super FormattableDocument, ? extends Iterable<FormattingData>> _newFormattingData = this.newFormattingData(this._hiddenLeafAccess.getHiddenLeafsBefore(node), init);");
    _builder_1.newLine();
    _builder_1.append("          ");
    ...
    _builder_1.newLine();
    _builder_1.append("          ");
    _builder_1.append("Function1<? super FormattableDocument, ? extends Iterable<FormattingData>> _newFormattingData_1 = this.newFormattingData(this._hiddenLeafAccess.getHiddenLeafsAfter(node), init);");
    _builder_1.newLine();
    _builder_1.append("          ");
    ...
    _builder_1.newLine();
    _builder_1.append("          ");
    _builder_1.append("Function1<? super FormattableDocument, ? extends Iterable<FormattingData>> _newFormattingData = this.newFormattingData(this._hiddenLeafAccess.getHiddenLeafsBefore(node), before);");
    _builder_1.newLine();
    _builder_1.append("          ");
    _builder_1.append("Iterable<FormattingData> _apply = null;");
    _builder_1.newLine();
    ...
    _builder_1.newLine();
    _builder_1.append("          ");
    _builder_1.append("Function1<? super FormattableDocument, ? extends Iterable<FormattingData>> _newFormattingData_1 = this.newFormattingData(this._hiddenLeafAccess.getHiddenLeafsAfter(node), after);");
    _builder_1.newLine();
    _builder_1.append("          ");
    _builder_1.append("Iterable<FormattingData> _apply_1 = null;");
    _builder_1.newLine();
