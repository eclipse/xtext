...
public class AnonymousClassCompilerTest extends AbstractXtendCompilerTest {
  ...
  public void testNestedLocalClass_05() {
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("return CollectionLiterals.<ArrayList<__C_1>>newArrayList(CollectionLiterals.<__C_1>newArrayList(new Function0<__C_1>() {");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("public __C_1 apply() {");
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("__C_1 ___C_1 = new __C_1() {");
    _builder_1.newLine();
    ...
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("return ___C_1;");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("}");
    _builder_1.newLine();
