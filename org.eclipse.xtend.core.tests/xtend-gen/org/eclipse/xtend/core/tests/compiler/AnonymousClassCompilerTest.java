...
public class AnonymousClassCompilerTest extends AbstractXtendCompilerTest {
  ...
  public void testField_AdditionalMember_02() {
    ...
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("final Procedure1<__C_1> _function = (__C_1 it) -> {");
    _builder_1.newLine();
    _builder_1.append("        ");
  ...
  public void testAnnotation() {
    StringConcatenation _builder = new StringConcatenation();
    _builder.append("class InstanceTest {");
    _builder.newLine();
    _builder.newLine();
    _builder.append("    ");
    ...
    _builder.append("}");
    _builder.newLine();
    _builder.append("annotation MyConfiguration {");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("String name = \'osgi\'");
    _builder.newLine();
    _builder.append("}");
    _builder.newLine();
    StringConcatenation _builder_1 = new StringConcatenation();
    ...
    _builder_1.append("@SuppressWarnings(\"all\")");
    _builder_1.newLine();
    _builder_1.append("public class InstanceTest {");
    _builder_1.newLine();
    _builder_1.append("  ");
    _builder_1.append("public void doSomething() {");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("MyConfiguration config = new MyConfiguration() {");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("@Override");
    _builder_1.newLine();
  ...
  public void testXtendIssue1301() {
    ...
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("final Procedure1<AdapterImpl> _function = (AdapterImpl it_1) -> {");
    _builder_1.newLine();
    _builder_1.append("        ");
