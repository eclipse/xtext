...
public class CompilerBugTest extends AbstractXtendCompilerTest {
  ...
  public void testBug406416_02() {
    ...
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("this.<String, Factory<String>>buildChild(f);");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("};");
    _builder_1.newLine();
  ...
  public void testBug406370() {
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("final Function1<Integer, String> _function = (Integer it) -> {");
    _builder_1.newLine();
    _builder_1.append("      ");
  ...
  public void testBug406360() {
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("final Procedure1<LoopParams> _function = (LoopParams it_1) -> {");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("};");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("final Procedure2<JvmTypeReference, ITreeAppendable> _function_1 = (JvmTypeReference it_1, ITreeAppendable app) -> {");
    _builder_1.newLine();
    _builder_1.append("      ");
  ...
  public void testBug405900_01() {
    ...
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("List<CharSequence> _children = this.getChildren();");
    _builder_1.newLine();
    _builder_1.append("        ");
  ...
  public void testBug384313() {
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("final Consumer<Map.Entry<? extends K, ? extends V>> _function = (Map.Entry<? extends K, ? extends V> it) -> {");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("this.put(it.getKey(), it.getValue());");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("};");
    _builder_1.newLine();
  ...
  public void testBug362285_01() {
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("final Function1<T, T> _function = (T x) -> {");
    _builder_1.newLine();
    _builder_1.append("      ");
  ...
  public void testBug380525_01() {
    ...
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("boolean _add = this.add(((E) it));");
    _builder_1.newLine();
    _builder_1.append("      ");
    ...
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("boolean _remove = this.remove(it);");
    _builder_1.newLine();
    _builder_1.append("        ");
  ...
  public void testBug380525_02() {
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("final Procedure1<E> _function = (E it) -> {");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("boolean _and = false;");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("boolean _add = this.add(it);");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("if (!_add) {");
    _builder_1.newLine();
  ...
  public void testBug410990() {
    ...
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("final Foo _function = (Foo foo) -> {");
    _builder_1.newLine();
    _builder_1.append("        ");
    ...
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("final Bar _function_1 = (Bar bar) -> {");
    _builder_1.newLine();
    _builder_1.append("        ");
