...
public class CompilerBugTest extends AbstractXtendCompilerTest {
  @Test
  public void testIssue461_01() {
    StringConcatenation _builder = new StringConcatenation();
    _builder.append("package com.acme;");
    _builder.newLine();
    _builder.newLine();
    _builder.append("class IdentifiedInterfaceWithAclBuilder {");
    _builder.newLine();
    _builder.newLine();
    _builder.append("\t");
    _builder.append("def void identifier(InstanceIdentifierBuilder<Object> b) {");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("b.child(Interface, null)");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("}");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("interface ChildOf<P> {}");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("interface ChoiceIn<P> {}");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("interface Identifiable<T> {}");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("interface Identifier<T extends Identifiable<?>> {}");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("interface InterfaceKey extends Identifier<Interface> {}");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("interface Interface extends ChildOf<Object>, Identifiable<InterfaceKey> {}");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("interface InstanceIdentifier<T> {}");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("interface InstanceIdentifierBuilder<T> {");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("def <C extends ChoiceIn<? super T>, N extends ChildOf<? super C>> InstanceIdentifierBuilder<N> child(");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("Class<C> caze, Class<N> container);");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("def <N extends Identifiable<K> & ChildOf<? super T>, K extends Identifier<N>> InstanceIdentifierBuilder<N> child(");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("Class<N> listItem, K listKey);");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder_1.newLine();
    _builder_1.append("public class IdentifiedInterfaceWithAclBuilder {");
    _builder_1.newLine();
    _builder_1.append("  ");
    _builder_1.append("public interface ChildOf<P extends Object> {");
    _builder_1.newLine();
    _builder_1.append("  ");
    _builder_1.append("}");
    _builder_1.newLine();
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("public abstract <C extends IdentifiedInterfaceWithAclBuilder.ChoiceIn<? super T>, N extends IdentifiedInterfaceWithAclBuilder.ChildOf<? super C>> IdentifiedInterfaceWithAclBuilder.InstanceIdentifierBuilder<N> child(final Class<C> caze, final Class<N> container);");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("public abstract <N extends IdentifiedInterfaceWithAclBuilder.Identifiable<K> & IdentifiedInterfaceWithAclBuilder.ChildOf<? super T>, K extends IdentifiedInterfaceWithAclBuilder.Identifier<N>> IdentifiedInterfaceWithAclBuilder.InstanceIdentifierBuilder<N> child(final Class<N> listItem, final K listKey);");
    _builder_1.newLine();
    _builder_1.append("  ");
    _builder_1.append("}");
    _builder_1.newLine();
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("b.<IdentifiedInterfaceWithAclBuilder.Interface, IdentifiedInterfaceWithAclBuilder.InterfaceKey>child(IdentifiedInterfaceWithAclBuilder.Interface.class, null);");
    _builder_1.newLine();
    _builder_1.append("  ");
    _builder_1.append("}");
    _builder_1.newLine();
  ...
  public void testIssue461_02() {
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("def <X> void identifier(InstanceIdentifierBuilder<X> b) {");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("b.child(Interface, null)");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("def <C extends ChoiceIn<? super T>, K extends Identifier<N>, N extends Identifiable<K> & ChildOf<? super C>> InstanceIdentifierBuilder<N> child(");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("Class<C> caze, Class<N> listItem, K listKey);");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("}");
    _builder.newLine();
  ...
  public void testIssue461_03() {
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("def <X> InstanceIdentifierBuilder<Interface> identifier(InstanceIdentifierBuilder<X> b) {");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("b.child(Interface, null)");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("interface Identifier<T extends Identifiable<N>, N extends Identifier<T, N>> {}");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("interface InterfaceKey extends Identifier<Interface, InterfaceKey> {}");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("interface Interface extends ChildOf<Object>, Identifiable<InterfaceKey> {}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("def <N extends Identifiable<K> & ChildOf<? super T>, K extends Identifier<N, K>> InstanceIdentifierBuilder<N> child(");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("Class<N> listItem, K listKey);");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("def <C extends ChoiceIn<? super T>, K extends Identifier<N, K>, N extends Identifiable<K> & ChildOf<? super C>> InstanceIdentifierBuilder<N> child(");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("Class<C> caze, Class<N> listItem, K listKey);");
    _builder.newLine();
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("public abstract <N extends IdentifiedInterfaceWithAclBuilder.Identifiable<K> & IdentifiedInterfaceWithAclBuilder.ChildOf<? super T>, K extends IdentifiedInterfaceWithAclBuilder.Identifier<N, K>> IdentifiedInterfaceWithAclBuilder.InstanceIdentifierBuilder<N> child(final Class<N> listItem, final K listKey);");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.newLine();
    _builder_1.append("    ");
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("return b.<IdentifiedInterfaceWithAclBuilder.Interface, IdentifiedInterfaceWithAclBuilder.InterfaceKey>child(IdentifiedInterfaceWithAclBuilder.Interface.class, null);");
    _builder_1.newLine();
    _builder_1.append("  ");
    _builder_1.append("}");
    _builder_1.newLine();
  ...
  public void testBug424145_01() {
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("return this.m(Collections.<String[]>unmodifiableList(CollectionLiterals.<String[]>newArrayList()))[5];");
    _builder_1.newLine();
    _builder_1.append("  ");
    _builder_1.append("}");
    _builder_1.newLine();
  ...
  public void testBug426788_01() {
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("this.m(it.iterator().next());");
    _builder_1.newLine();
    _builder_1.append("  ");
    _builder_1.append("}");
    _builder_1.newLine();
  ...
  public void testBug426788_02() {
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("this.m(IterableExtensions.<String>head(it));");
    _builder_1.newLine();
    _builder_1.append("  ");
    _builder_1.append("}");
    _builder_1.newLine();
  ...
  public void testBug406370() {
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("ListExtensions.<Integer, String>map(Collections.<Integer>unmodifiableList(CollectionLiterals.<Integer>newArrayList(Integer.valueOf(1), Integer.valueOf(2), Integer.valueOf(3))), _function).toString();");
    _builder_1.newLine();
    _builder_1.append("  ");
    _builder_1.append("}");
    _builder_1.newLine();
  ...
  public void testBug406267_01() {
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("return this.list = IterableExtensions.<String>sort(mapping.values());");
    _builder_1.newLine();
    _builder_1.append("  ");
    _builder_1.append("}");
    _builder_1.newLine();
  ...
  public void testBug404051_02() {
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("IterableExtensions.sortBy(this.<String, String>flatMap(iterable, _function), _function_1);");
    _builder_1.newLine();
    _builder_1.append("  ");
    _builder_1.append("}");
    _builder_1.newLine();
  ...
  public void testBug384313() {
    ...
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("MyMap.this.put(it.getKey(), it.getValue());");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("}");
    _builder_1.newLine();
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("t.entrySet().forEach(_function);");
    _builder_1.newLine();
    _builder_1.append("  ");
    _builder_1.append("}");
    _builder_1.newLine();
  ...
  public void testWeightComparable_01() {
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("return this.getWeight().compareTo(w.getWeight());");
    _builder_1.newLine();
    _builder_1.append("  ");
    _builder_1.append("}");
    _builder_1.newLine();
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("return 31 * 1 + ((this._weight== null) ? 0 : this._weight.hashCode());");
    _builder_1.newLine();
    _builder_1.append("  ");
    _builder_1.append("}");
    _builder_1.newLine();
  ...
  public void testBug380058_01() {
    ...
    try {
      ...
      _builder_1.newLine();
      _builder_1.append("      ");
      _builder_1.append("final Amount<Length> perim = w.plus(h).times(2);");
      _builder_1.newLine();
      _builder_1.append("      ");
  ...
  public void testBug381201_02() {
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("return 31 * 1 + ((this._nonStaticField== null) ? 0 : this._nonStaticField.hashCode());");
    _builder_1.newLine();
    _builder_1.append("  ");
    _builder_1.append("}");
    _builder_1.newLine();
  ...
  public void testBug383568() {
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("return 31 * 1 + ((this.__string== null) ? 0 : this.__string.hashCode());");
    _builder_1.newLine();
    _builder_1.append("  ");
    _builder_1.append("}");
    _builder_1.newLine();
  ...
  public void testBug399527() throws Exception {
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("final IExpectationSetters<Object> exp2 = Y.<Object>expect(this.unboundedMockHeaderAccess.getHeader());");
    _builder_1.newLine();
    _builder_1.append("  ");
    _builder_1.append("}");
    _builder_1.newLine();
