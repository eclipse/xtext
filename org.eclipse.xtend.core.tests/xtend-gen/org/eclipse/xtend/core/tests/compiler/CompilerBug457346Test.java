...
public class CompilerBug457346Test extends AbstractXtendCompilerTest {
  ...
  public void test_01() {
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("Ordering<String> _onResultOf = Ordering.<Integer>natural().<String>onResultOf(_function).<String>onResultOf(_function_1);");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("return IterableExtensions.<String>sortWith(Collections.<String>unmodifiableList(CollectionLiterals.<String>newArrayList(\"a\", \"aa\", \"aaa\")), _onResultOf);");
    _builder_1.newLine();
    _builder_1.append("  ");
    _builder_1.append("}");
    _builder_1.newLine();
  ...
  public void test_02() {
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("sortMe.sort(_onResultOf);");
    _builder_1.newLine();
    _builder_1.append("  ");
    _builder_1.append("}");
    _builder_1.newLine();
  ...
  public void test_03() {
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("C.MyComparator<String> _thenComparing2 = C.MyComparator.<String>comparingInt2(_function).<String>thenComparing2(_function_1);");
    _builder_1.newLine();
    _builder_1.append("    ");
