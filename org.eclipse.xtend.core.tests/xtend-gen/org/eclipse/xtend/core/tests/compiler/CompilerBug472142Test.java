...
public class CompilerBug472142Test extends AbstractXtendCompilerTest {
  ...
  public void test_03() {
    ...
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("this.mySeq = this.ext(((String) IterableExtensions.<CharSequence>head(new Function0<Iterable<CharSequence>>() {");
    _builder_1.newLine();
    _builder_1.append("          ");
    _builder_1.append("public Iterable<CharSequence> apply() {");
    _builder_1.newLine();
    _builder_1.append("            ");
    ...
    _builder_1.newLine();
    _builder_1.append("            ");
    _builder_1.append("List<CharSequence> _all = C.this.all(\"s\", _builder.toString());");
    _builder_1.newLine();
    _builder_1.append("            ");
    _builder_1.append("List<CharSequence> _subList = _all.subList(1, 1);");
    _builder_1.newLine();
    _builder_1.append("            ");
    _builder_1.append("return _subList;");
    _builder_1.newLine();
    _builder_1.append("          ");
    _builder_1.append("}");
    _builder_1.newLine();
  ...
  public void test_04() {
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("return this.b = this.ext((IterableExtensions.<CharSequence>head(new Function0<Iterable<CharSequence>>() {");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("public Iterable<CharSequence> apply() {");
    _builder_1.newLine();
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("}.apply()) instanceof String));");
    _builder_1.newLine();
    _builder_1.append("  ");
    _builder_1.append("}");
    _builder_1.newLine();
