...
public class CompilerBug472142Test extends AbstractXtendCompilerTest {
  ...
  public void test_03() {
    ...
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("CharSequence _head = IterableExtensions.<CharSequence>head(this.all(\"s\", _builder.toString()).subList(1, 1));");
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("this.mySeq = this.ext(((String) _head));");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("}");
    _builder_1.newLine();
  ...
  public void test_04() {
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("return this.b = this.ext((_head instanceof String));");
    _builder_1.newLine();
    _builder_1.append("  ");
    _builder_1.append("}");
    _builder_1.newLine();
