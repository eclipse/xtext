...
public class Java8OverloadCompilerTest extends AbstractXtendCompilerTest {
  ...
  public void test_15() {
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("def String m(B b) {");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("return b.m");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.append("}");
    _builder.newLine();
    _builder.append("interface IB extends IA {");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("override String m() {");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("return null");
    _builder.newLine();
    ...
    _builder.append("}");
    _builder.newLine();
    _builder.append("abstract class A implements IA {}");
    _builder.newLine();
    _builder.append("abstract class B extends A implements IB {}");
    _builder.newLine();
    StringConcatenation _builder_1 = new StringConcatenation();
    _builder_1.append("import java.util.ArrayList;");
    _builder_1.newLine();
  ...
  public void test_16() {
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("def <B extends A & IB> String m(B b) {");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("return b.m");
    _builder.newLine();
