...
public class Java8OverloadCompilerTest extends AbstractXtendCompilerTest {
  ...
  public void testBug438461_01() {
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("final Callable<Object> _function = () -> {");
    _builder_1.newLine();
    _builder_1.append("      ");
  ...
  public void testBug438461_03() {
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("final Callable<String> _function = () -> {");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("return \"\";");
    _builder_1.newLine();
  ...
  public void testBug438461_06() {
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("final Bug.I _function = (Runnable it) -> {");
    _builder_1.newLine();
    _builder_1.append("      ");
  ...
  public void testBug438461_10() {
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("final Function2<String, String, String> _function = (String $0, String $1) -> {");
    _builder_1.newLine();
    _builder_1.append("      ");
