...
public class CompilerBug458010Test extends AbstractXtendCompilerTest {
  ...
  public void test_01() {
    ...
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("return ((Objects.equals(it.gender, Demo.Person.Sex.MALE) && (it.getAge() >= 18)) && (it.getAge() <= 25));");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("};");
    _builder_1.newLine();
  ...
  public void test_03() {
    ...
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("return Boolean.valueOf(((Objects.equals(it.gender, Demo.Person.Sex.MALE) && (it.getAge() >= 18)) && (it.getAge() <= 25)));");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("};");
    _builder_1.newLine();
  ...
  public void test_04() {
    ...
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("return Objects.equals(it.gender, Demo.Person.Sex.MALE);");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("};");
    _builder_1.newLine();
  ...
  public void test_11_a() {
    ...
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("return Boolean.valueOf(Objects.equals(it.gender, Demo.Person.Sex.MALE));");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("};");
    _builder_1.newLine();
