 ...
 *******************************************************************************/
package org.eclipse.xtext.purexbase.ui.internal;
...
import org.eclipse.xtext.purexbase.ui.PureXbaseUiModule;
...
public class PurexbaseActivator extends AbstractUIPlugin {
	...
	private static PurexbaseActivator INSTANCE;
	...
	public static PurexbaseActivator getInstance() {
		return INSTANCE;
	}
	...
	protected com.google.inject.Module getRuntimeModule(String grammar) {
		if (ORG_ECLIPSE_XTEXT_PUREXBASE_PUREXBASE.equals(grammar)) {
	...
	protected com.google.inject.Module getUiModule(String grammar) {
		if (ORG_ECLIPSE_XTEXT_PUREXBASE_PUREXBASE.equals(grammar)) {
			return new PureXbaseUiModule(this);
		}
		throw new IllegalArgumentException(grammar);
	}
