...
As the last part of Xtext xbase.lib now requires Java 8 at runtime. 

## Fixed Issues

As in every release we are eagerly hunting down the bugs, review and integrate lots of contributions. XX issues, XX Pull Requests and XX Bugzilla tickets have made it into this release. For further details please refer to the following lists:
