...
Xtext makes now use of the [enhanced possibilities](https://bugs.eclipse.org/bugs/show_bug.cgi?id=579082) for requesting rebuilds in platform. Please test this in your environments and give feedback
