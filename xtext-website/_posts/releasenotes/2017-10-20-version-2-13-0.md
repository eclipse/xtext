...
One of the missing services of the Language Server Protocol was `rename`. This is now available. You can customize it by overriding `IRenameStrategy2` or hooking into the change serializer (see _EMF Model Manipulation API_ below).
