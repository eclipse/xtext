...
public class ContentAssistFragmentTestLangParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.eclipse.xtext.xbase.testlanguages.ui.contentassist.antlr.internal.InternalContentAssistFragmentTestLangParser createParser() {
		org.eclipse.xtext.xbase.testlanguages.ui.contentassist.antlr.internal.InternalContentAssistFragmentTestLangParser result = new org.eclipse.xtext.xbase.testlanguages.ui.contentassist.antlr.internal.InternalContentAssistFragmentTestLangParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getContentAssistFragmentTestLanguageRootAccess().getExpressionAssignment(), "rule__ContentAssistFragmentTestLanguageRoot__ExpressionAssignment");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.eclipse.xtext.xbase.testlanguages.ui.contentassist.antlr.internal.InternalContentAssistFragmentTestLangParser typedParser = (org.eclipse.xtext.xbase.testlanguages.ui.contentassist.antlr.internal.InternalContentAssistFragmentTestLangParser) parser;
			typedParser.entryRuleContentAssistFragmentTestLanguageRoot();
