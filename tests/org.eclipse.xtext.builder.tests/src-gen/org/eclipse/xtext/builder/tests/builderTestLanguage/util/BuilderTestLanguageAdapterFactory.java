 ...
 *
 */
package org.eclipse.xtext.builder.tests.builderTestLanguage.util;
 ...
 * @generated
 */
public class BuilderTestLanguageAdapterFactory extends AdapterFactoryImpl
{
  /**
   ...
   * @generated
   */
  protected static BuilderTestLanguagePackage modelPackage;
   ...
   * @generated
   */
  public BuilderTestLanguageAdapterFactory()
  {
    if (modelPackage == null)
    {
      modelPackage = BuilderTestLanguagePackage.eINSTANCE;
    }
  }
   ...
   * @generated
   */
  protected BuilderTestLanguageSwitch<Adapter> modelSwitch =
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.eclipse.xtext.builder.tests.builderTestLanguage.Import <em>Import</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.eclipse.xtext.builder.tests.builderTestLanguage.Element <em>Element</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
...
} //BuilderTestLanguageAdapterFactory
