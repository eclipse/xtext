...
protected class ThisRootNode extends RootToken {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			...
			case 1: return new Model_Alternatives(this, this, 1, inst);
			...
			case 40: return new FeatureCall_OperationCallParserRuleCall(this, this, 40, inst);
...
protected class DelegateModel_ModelParserRuleCall extends RuleCallToken {
	...
	public IEObjectConsumer tryConsume() {
		if(getEObject().eClass() != grammarAccess.getModelRule().getType().getClassifier())
			return null;
		if(checkForRecursion(Model_Alternatives.class, eObjectConsumer)) return null;
