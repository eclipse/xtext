...
public class CodeStyleValidationTest extends AbstractXbaseTestCase {
  ...
  public void setSeverity() {
    this.preferences.put(IssueCodes.OPERATION_WITHOUT_PARENTHESIS, "warning");
  }
  ...
  public void testMethodCallWithoutParenthesis01() {
    try {
      ...
      this.helper.assertWarning(_expression, XbasePackage.Literals.XMEMBER_FEATURE_CALL, IssueCodes.OPERATION_WITHOUT_PARENTHESIS);
    } catch (Throwable _e) {
  ...
  public void testMethodCallWithoutParenthesis02() {
    try {
      ...
      _builder.append("}");
      XExpression _expression = this.expression(_builder);
      this.helper.assertWarning(_expression, XbasePackage.Literals.XFEATURE_CALL, IssueCodes.OPERATION_WITHOUT_PARENTHESIS);
    } catch (Throwable _e) {
      throw Exceptions.sneakyThrow(_e);
    }
  }
  ...
  @Test
  public void testConstructorCallWithoutParenthesis01() {
    try {
      StringConcatenation _builder = new StringConcatenation();
      _builder.append("{");
      _builder.newLine();
      ...
      _builder.append("}");
      XExpression _expression = this.expression(_builder);
      this.helper.assertWarning(_expression, XbasePackage.Literals.XCONSTRUCTOR_CALL, IssueCodes.OPERATION_WITHOUT_PARENTHESIS);
    } catch (Throwable _e) {
      throw Exceptions.sneakyThrow(_e);
    }
  }
  ...
  @Test
  public void testConstructorCallWithParenthesis01() {
    try {
      StringConcatenation _builder = new StringConcatenation();
      _builder.append("{");
      _builder.newLine();
  ...
  @Test
  public void testConstructorCallWithBuilderSyntax01() {
    try {
      StringConcatenation _builder = new StringConcatenation();
      _builder.append("{");
      _builder.newLine();
