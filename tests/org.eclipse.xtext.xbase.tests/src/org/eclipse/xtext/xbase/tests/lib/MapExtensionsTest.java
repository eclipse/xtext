...
public class MapExtensionsTest extends Assert {
	...
	@Test
	public void operator_pluPairMap() {
		String v = UUID.randomUUID().toString();
		Map<String, String> o;
	...
	public void operator_removeMapPair_0() {
		Map<String, String> o = operator_remove(this.map, new Pair<String, String>("k0", "v0"));
		assertEquals(2, this.map.size());
		assertEquals(this.value1, this.map.get("k1"));
		assertEquals(this.value2, this.map.get("k2"));
		assertSame(this.map, o);
	...
	public void operator_removeMapPair_1() {
		Map<String, String> o = operator_remove(this.map, new Pair<String, String>("k1", "v0"));
		assertEquals(2, this.map.size());
		assertEquals(this.value1, this.map.get("k1"));
		assertEquals(this.value2, this.map.get("k2"));
		assertSame(this.map, o);
	...
	public void operator_removeMapPair_2() {
		Map<String, String> o = operator_remove(this.map, new Pair<String, String>("k1", this.value1));
		assertEquals(1, this.map.size());
		assertNull(this.map.get("k1"));
		assertEquals(this.value2, this.map.get("k2"));
		assertSame(this.map, o);
