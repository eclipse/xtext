...
import org.eclipse.xtext.junit4.smoketest.IgnoredMethods;
...
@ProcessedBy(TypeSystemSmokeTester.class)
@IgnoredMethods({
	"testNull",
	"testProxy",
	"testBlockExpression_03",
	"testFeatureCall_15_m",
	"testFeatureCall_25_b",
	"testFeatureCall_25_c",
	"testFeatureCall_25_d"
})
