...
public class ContentAssistInBlockTest extends ContentAssistTest implements IJavaProjectProvider {
	...
	public void testEmptyInput() throws Exception {
		newBuilder().assertText(expect(KEYWORDS, VARIABLE_DECL));
	}
	
	@Override
	public void testOnStringLiteral_01() throws Exception {
		newBuilder().append("''").assertText(expect(STRING_OPERATORS, CAST_INSTANCEOF, KEYWORDS, VARIABLE_DECL));
	}
	
	@Override
	public void testOnStringLiteral_03() throws Exception {
		newBuilder().append("''.").assertTextAtCursorPosition(".", expect(STRING_OPERATORS, CAST_INSTANCEOF, KEYWORDS, VARIABLE_DECL));
	}
	...
	public void testOnStringLiteral_28() throws Exception {
		newBuilder().append("''.toString.toString").assertTextAtCursorPosition(".", expect(STRING_OPERATORS, CAST_INSTANCEOF, KEYWORDS, VARIABLE_DECL));
	}
...
//	}
	...
	public void testOnStringLiteral_36() throws Exception {
		newBuilder().append("''.toString +''").assertTextAtCursorPosition("+", expect(STRING_OPERATORS, CAST_INSTANCEOF, KEYWORDS, VARIABLE_DECL));
	}
	...
	public void testAfterBinaryOperation_02() throws Exception {
		newBuilder().append("'' + ''+''").assertTextAtCursorPosition("''+", 2, expect(STRING_OPERATORS, CAST_INSTANCEOF, KEYWORDS, VARIABLE_DECL));
	}
	...
	public void testForLoop_04() throws Exception {
		super.newBuilder().append("for (String this: null) ").assertText(expect(new String[]{"this"}, STRING_FEATURES, KEYWORDS));
	}
	
	public void testForLoop_05() throws Exception {
		newBuilder().append("for (String this: null) ").assertText(expect(new String[]{"this"}, STRING_FEATURES, KEYWORDS));
	}
	
	public void testAfterVariableDeclaration_01() throws Exception {
		newBuilder().appendNl("var x = '';").assertText(expect(new String[] {"x"}, KEYWORDS, VARIABLE_DECL));
	}
	
	public void testAfterVariableDeclaration_02() throws Exception {
		newBuilder().appendNl("var x = '';").appendNl("var y = '';").assertTextAtCursorPosition("var y", expect(new String[] {"x"}, KEYWORDS, VARIABLE_DECL));
	}
	
	public void testAfterVariableDeclaration_03() throws Exception {
		newBuilder().appendNl("var x = ''").assertText(expect(new String[] {"x"}, KEYWORDS, CAST_INSTANCEOF, VARIABLE_DECL, STRING_OPERATORS));
	}
	
	public void testAfterVariableDeclaration_04() throws Exception {
		newBuilder().appendNl("var x = ''").appendNl("var y = ''").assertTextAtCursorPosition("var y", expect(new String[] {"x"}, KEYWORDS, CAST_INSTANCEOF, VARIABLE_DECL, STRING_OPERATORS));
	}
	
	public void testAfterVariableDeclaration_05() throws Exception {
		newBuilder().appendNl("var this = '';").assertText(expect(new String[] {"this"}, KEYWORDS, VARIABLE_DECL, STRING_FEATURES));
	}
	
	public void testAfterVariableDeclaration_06() throws Exception {
		newBuilder().appendNl("var this = '';").appendNl("var y = '';").assertTextAtCursorPosition("var y", expect(new String[] {"this"}, KEYWORDS, VARIABLE_DECL, STRING_FEATURES));
	}
	
	public void testAfterVariableDeclaration_07() throws Exception {
		newBuilder().appendNl("var this = ''").assertText(expect(new String[] {"this"}, KEYWORDS, CAST_INSTANCEOF, VARIABLE_DECL, STRING_OPERATORS, STRING_FEATURES));
	}
	
	public void testAfterVariableDeclaration_08() throws Exception {
		newBuilder().appendNl("var this = ''").appendNl("var y = ''").assertTextAtCursorPosition("var y", expect(new String[] {"this"}, KEYWORDS, CAST_INSTANCEOF, VARIABLE_DECL, STRING_OPERATORS, STRING_FEATURES));
	}
	
	public void testAfterVariableDeclaration_09() throws Exception {
		newBuilder().appendNl("var x = ''").appendNl("var y = ").assertText(expect(new String[] {"x"}, KEYWORDS));
	}
	
	public void testAfterVariableDeclaration_10() throws Exception {
		newBuilder().appendNl("var this = ''").appendNl("var y = ").assertText(expect(new String[] {"this"}, KEYWORDS, STRING_FEATURES));
	}
