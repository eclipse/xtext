...
public class ImportsUtilTest {
  ...
  public void testQnameSplitting() {
    ...
    Pair<String, String> _splitInTypeAndMember_2 = util.splitInTypeAndMember("java.util.Collections.sort(Object)");
    ...
    Pair<String, String> _splitInTypeAndMember_3 = util.splitInTypeAndMember("java.util.Collections.sort");
