// $ANTLR 3.0.1 ./src-gen/org/eclipse/xtext/test/parser/internal/InternalTestLanguage.g 2008-05-20 10:57:55
...
public class InternalTestLanguageParser extends Parser {
    public static final String[] tokenNames = new String[] {
        "<invalid>", "<EOR>", "<DOWN>", "<UP>", "RULE_ID", "RULE_STRING", "RULE_LEXER_BODY", "RULE_WS", "RULE_INT", "RULE_ML_COMMENT", "RULE_SL_COMMENT", "RULE_ANY_OTHER", "'choice'", "'optional'", "'reducible'"
    };
    ...
    public final EObject parse() throws RecognitionException {
        ...
        try {
            ...
            {
            currentNode = createCompositeNode(// org.eclipse.xtext.impl.ParserRuleImpl@d9a49d (name: EntryRule)
    ...
    public final EObject ruleChoiceRule() throws RecognitionException {
        ...
        try {
            ...
            match(input,12,FOLLOW_12_in_ruleChoiceRule164); 
             createLeafNode(// org.eclipse.xtext.impl.KeywordImpl@ae0d31 (cardinality: null) (value: "choice")
            ...
            match(input,RULE_ID,FOLLOW_RULE_ID_in_ruleChoiceRule198); 
             createLeafNode(// org.eclipse.xtext.impl.RuleCallImpl@a24357 (cardinality: null) (name: ID)
    ...
    public final EObject ruleReducibleRule() throws RecognitionException {
        ...
        try {
            ...
            match(input,14,FOLLOW_14_in_ruleReducibleRule238); 
             createLeafNode(// org.eclipse.xtext.impl.KeywordImpl@ef8ec6 (cardinality: null) (value: "reducible")
    ...
    public final EObject ruleTerminalRule() throws RecognitionException {
        ...
        try {
            ...
            match(input,RULE_STRING,FOLLOW_RULE_STRING_in_ruleTerminalRule312); 
             createLeafNode(// org.eclipse.xtext.impl.RuleCallImpl@75ef06 (cardinality: null) (name: STRING)
