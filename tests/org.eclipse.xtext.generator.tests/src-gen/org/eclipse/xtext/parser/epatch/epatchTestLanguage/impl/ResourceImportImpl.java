 ...
 * </copyright>
 *
 * $Id: ResourceImportImpl.java,v 1.4 2009/02/19 16:26:51 sefftinge Exp $
 */
...
public class ResourceImportImpl extends ModelImportImpl implements ResourceImport
{
  ...
  {
    return EpatchTestLanguagePackage.Literals.RESOURCE_IMPORT;
  }
  ...
  public void setUri(String newUri)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EpatchTestLanguagePackage.RESOURCE_IMPORT__URI, oldUri, uri));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case EpatchTestLanguagePackage.RESOURCE_IMPORT__URI:
        return getUri();
    }
