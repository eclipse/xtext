...
public final class EpatchTestLanguageObjectCopyConsumer extends NonTerminalConsumer {
	...
	protected int doConsumeAssignment$4(int entryPoint) throws Exception {
		final AssignmentResult result = createAssignmentResult(getRule().ele01AssignmentResource());
	...
	protected int doConsumeAssignment$7(int entryPoint) throws Exception {
		final AssignmentResult result = createAssignmentResult(getRule().ele1AssignmentFragment());
