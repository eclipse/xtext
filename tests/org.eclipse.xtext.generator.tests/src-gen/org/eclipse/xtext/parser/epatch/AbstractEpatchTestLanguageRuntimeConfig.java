 ...
 */
public abstract class AbstractEpatchTestLanguageRuntimeConfig extends AbstractServiceRegistrationFactory {
	...
	public Set<IServiceRegistration> registrations() {
		return scope(org.eclipse.xtext.parser.epatch.IEpatchTestLanguage.SCOPE)
