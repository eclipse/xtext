...
public final class EpatchTestLanguageImportConsumer extends NonTerminalConsumer {
	...
	public void setRule(ImportElements rule) {
		...
		ruleCall$3$Consumer = new RuleCall$3$Consumer(rule.ele00ParserRuleCallModelImport());
		ruleCall$4$Consumer = new RuleCall$4$Consumer(rule.ele01ParserRuleCallJavaImport());
		ruleCall$5$Consumer = new RuleCall$5$Consumer(rule.ele1ParserRuleCallExtensionImport());
	}
