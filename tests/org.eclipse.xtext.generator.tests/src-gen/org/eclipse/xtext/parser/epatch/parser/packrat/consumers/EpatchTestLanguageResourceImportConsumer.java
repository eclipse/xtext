...
public final class EpatchTestLanguageResourceImportConsumer extends NonTerminalConsumer {
	...
	public void setRule(ResourceImportElements rule) {
		...
		keyword$7$Consumer = new Keyword$7$Consumer(rule.ele01KeywordUri());
		assignment$8$Consumer = new Assignment$8$Consumer(rule.ele1AssignmentUri());
		ruleCall$9$Consumer = new RuleCall$9$Consumer(rule.ele10TerminalRuleCallSTRING());
	}
