...
public class EpatchTestLanguagePackratParser extends AbstractPackratParser {
	...
	@Override
	protected EpatchTestLanguageParserConfiguration createParserConfiguration(ICharSequenceWithOffset input,
		...
		return new EpatchTestLanguageParserConfiguration(input, markerFactory, tokenAcceptor, hiddenTokenHandler, consumerUtil);
	}
