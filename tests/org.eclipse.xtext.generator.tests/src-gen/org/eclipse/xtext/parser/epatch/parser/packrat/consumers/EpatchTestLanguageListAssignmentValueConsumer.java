...
public final class EpatchTestLanguageListAssignmentValueConsumer extends NonTerminalConsumer {
	...
	public void setRule(ListAssignmentValueElements rule) {
		...
		ruleCall$4$Consumer = new RuleCall$4$Consumer(rule.ele000LexerRuleCallINT());
		...
		ruleCall$14$Consumer = new RuleCall$14$Consumer(rule.ele10000010LexerRuleCallINT());
		...
		ruleCall$17$Consumer = new RuleCall$17$Consumer(rule.ele100010LexerRuleCallSTRING());
		...
		ruleCall$26$Consumer = new RuleCall$26$Consumer(rule.ele10011010LexerRuleCallID());
		...
		ruleCall$31$Consumer = new RuleCall$31$Consumer(rule.ele100111010LexerRuleCallINT());
