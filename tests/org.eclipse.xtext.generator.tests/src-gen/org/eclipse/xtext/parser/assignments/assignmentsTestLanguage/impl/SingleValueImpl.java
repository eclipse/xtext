 ...
 * @generated
 */
public class SingleValueImpl extends MinimalEObjectImpl.Container implements SingleValue
{
  /**
  ...
  {
    return AssignmentsTestLanguagePackage.Literals.SINGLE_VALUE;
  }
  ...
  public void setValue(String newValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AssignmentsTestLanguagePackage.SINGLE_VALUE__VALUE, oldValue, value));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case AssignmentsTestLanguagePackage.SINGLE_VALUE__VALUE:
        return getValue();
    }
