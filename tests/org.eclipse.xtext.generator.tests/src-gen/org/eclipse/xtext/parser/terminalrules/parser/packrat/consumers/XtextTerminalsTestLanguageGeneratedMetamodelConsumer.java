...
public final class XtextTerminalsTestLanguageGeneratedMetamodelConsumer extends NonTerminalConsumer {
	...
	protected int consumeRuleCall$6(int entryPoint) throws Exception {
		return consumeTerminal(idConsumer, "name", false, false, getRule().ele0010ParserRuleCallID(), getRuleCall$6$Delimiter());
	}
	...
	protected int consumeRuleCall$13(int entryPoint) throws Exception {
		return consumeTerminal(idConsumer, "alias", false, false, getRule().ele110ParserRuleCallID(), getRuleCall$13$Delimiter());
	}
