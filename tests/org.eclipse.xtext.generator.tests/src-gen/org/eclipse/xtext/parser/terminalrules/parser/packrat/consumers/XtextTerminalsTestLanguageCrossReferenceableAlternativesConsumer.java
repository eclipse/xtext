...
public final class XtextTerminalsTestLanguageCrossReferenceableAlternativesConsumer extends NonTerminalConsumer {
	...
	public void setRule(CrossReferenceableAlternativesElements rule) {
		...
		ruleCall$2$Consumer = new RuleCall$2$Consumer(rule.ele0ParserRuleCallCrossReferenceableTerminal());
		...
		ruleCall$9$Consumer = new RuleCall$9$Consumer(rule.ele1110ParserRuleCallCrossReferenceableTerminal());
	}
