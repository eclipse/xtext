...
public class XtextTerminalsTestLanguageMetamodelAccess extends BaseEPackageAccess implements IMetamodelAccess {
	...
	public static void init() {
		if (!EPackage.Registry.INSTANCE.containsKey(XTEXTTERMINALSTESTLANGUAGE_NS_URI))
			EPackage.Registry.INSTANCE.put(XTEXTTERMINALSTESTLANGUAGE_NS_URI, loadEcoreFile(XtextTerminalsTestLanguageMetamodelAccess.class.getClassLoader(), "classpath:/org/eclipse/xtext/parser/terminalrules/XtextTerminalsTestLanguage.ecore"));
	}
