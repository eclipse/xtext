...
public final class XtextTerminalsTestLanguageLexerRuleConsumer extends NonTerminalConsumer {
	...
	protected int consumeRuleCall$10(int entryPoint) throws Exception {
		return consumeTerminal(idConsumer, "name", false, false, getRule().ele000010ParserRuleCallID(), getRuleCall$10$Delimiter());
	}
	...
	protected int consumeRuleCall$17(int entryPoint) throws Exception {
		return consumeTerminal(stringConsumer, "body", false, false, getRule().ele010ParserRuleCallSTRING(), getRuleCall$17$Delimiter());
	}
	...
	// XtextTerminalsTestLanguageGrammarAccess.INSTANCE.prLexerRule()
		return rule;
	}
