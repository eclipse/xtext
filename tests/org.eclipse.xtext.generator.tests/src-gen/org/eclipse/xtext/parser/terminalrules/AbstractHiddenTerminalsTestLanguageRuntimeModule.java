...
public abstract class AbstractHiddenTerminalsTestLanguageRuntimeModule extends DefaultRuntimeModule {
	...
	public com.google.inject.Provider<org.eclipse.xtext.parser.antlr.Lexer> provideLexer() {
		return new org.eclipse.xtext.parser.antlr.LexerProvider(org.eclipse.xtext.parser.terminalrules.parser.antlr.internal.InternalHiddenTerminalsTestLanguageLexer.class);
	}
