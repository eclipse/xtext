...
public final class HiddenTerminalsTestLanguageOverridingHiddensConsumer extends NonTerminalConsumer {
	...
	protected class RuleCall$10$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume() throws Exception {
			return consumeNonTerminal(overridingHiddensCallConsumer, "called", false, false, false, getElement());
		}
	}
	...
	protected class Keyword$13$Consumer extends ElementConsumer<Keyword> {
		...
		@Override
		protected int doConsume() throws Exception {
			return consumeKeyword(getElement(), "valid", false, true, getKeyword$13$Delimiter());
		}
	}
