...
public final class XtextTerminalsTestLanguageAssignmentConsumer extends NonTerminalConsumer {
	...
	protected int doConsumeAssignment$3(int entryPoint) throws Exception {
		final AssignmentResult result = createAssignmentResult(getRule().ele00AssignmentFeature());
	...
	protected int doConsumeAssignment$5(int entryPoint) throws Exception {
		final AssignmentResult result = createAssignmentResult(getRule().ele01AssignmentOperator());
		return result.getResult(consumeAlternatives$6(entryPoint));
	}
