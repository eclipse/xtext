 ...
 * </copyright>
 *
 * $Id: ParserRuleImpl.java,v 1.4 2009/02/19 16:26:49 sefftinge Exp $
 */
 ...
 *   <li>{@link org.eclipse.xtext.parser.terminalrules.xtextTerminalsTestLanguage.impl.ParserRuleImpl#getAlternatives <em>Alternatives</em>}</li>
 *   <li>{@link org.eclipse.xtext.parser.terminalrules.xtextTerminalsTestLanguage.impl.ParserRuleImpl#isTerminal <em>Terminal</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ParserRuleImpl extends AbstractRuleImpl implements ParserRule
{
  ...
  public NotificationChain basicSetAlternatives(AbstractElement newAlternatives, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XtextTerminalsTestLanguagePackage.PARSER_RULE__ALTERNATIVES, oldAlternatives, newAlternatives);
  ...
  public void setAlternatives(AbstractElement newAlternatives)
  {
    if (newAlternatives != alternatives)
    {
      ...
      if (alternatives != null)
        msgs = ((InternalEObject)alternatives).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XtextTerminalsTestLanguagePackage.PARSER_RULE__ALTERNATIVES, null, msgs);
      if (newAlternatives != null)
        msgs = ((InternalEObject)newAlternatives).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XtextTerminalsTestLanguagePackage.PARSER_RULE__ALTERNATIVES, null, msgs);
      msgs = basicSetAlternatives(newAlternatives, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XtextTerminalsTestLanguagePackage.PARSER_RULE__ALTERNATIVES, newAlternatives, newAlternatives));
  }
  ...
  public void setTerminal(boolean newTerminal)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XtextTerminalsTestLanguagePackage.PARSER_RULE__TERMINAL, oldTerminal, terminal));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case XtextTerminalsTestLanguagePackage.PARSER_RULE__ALTERNATIVES:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case XtextTerminalsTestLanguagePackage.PARSER_RULE__TERMINAL:
