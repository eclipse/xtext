...
public class HiddenTerminalsTestLanguageParserConfiguration extends AbstractParserConfiguration {
	...
	public void configureConsumers() {
		...
		getWithoutHiddensConsumer().setKeyword$5$Delimiter(org.eclipse.xtext.parser.terminalrules.parser.packrat.HiddenTerminalsTestLanguageDelimiters.keyword$19$Delimiter);
		getWithoutHiddensConsumer().setKeyword$8$Delimiter(org.eclipse.xtext.parser.terminalrules.parser.packrat.HiddenTerminalsTestLanguageDelimiters.keyword$19$Delimiter);
		getWithoutHiddensConsumer().setKeyword$12$Delimiter(org.eclipse.xtext.parser.terminalrules.parser.packrat.HiddenTerminalsTestLanguageDelimiters.keyword$19$Delimiter);
		getWithoutHiddensConsumer().setRuleCall$7$Delimiter(org.eclipse.xtext.parser.terminalrules.parser.packrat.HiddenTerminalsTestLanguageDelimiters.ruleCall$21$Delimiter);
		getWithoutHiddensConsumer().setRuleCall$10$Delimiter(org.eclipse.xtext.parser.terminalrules.parser.packrat.HiddenTerminalsTestLanguageDelimiters.ruleCall$21$Delimiter);
		getWithHiddensConsumer().setKeyword$3$Delimiter(org.eclipse.xtext.parser.terminalrules.parser.packrat.HiddenTerminalsTestLanguageDelimiters.keyword$19$Delimiter);
		getWithHiddensConsumer().setKeyword$4$Delimiter(org.eclipse.xtext.parser.terminalrules.parser.packrat.HiddenTerminalsTestLanguageDelimiters.keyword$19$Delimiter);
		getWithHiddensConsumer().setKeyword$6$Delimiter(org.eclipse.xtext.parser.terminalrules.parser.packrat.HiddenTerminalsTestLanguageDelimiters.keyword$19$Delimiter);
		getOverridingHiddensConsumer().setKeyword$6$Delimiter(org.eclipse.xtext.parser.terminalrules.parser.packrat.HiddenTerminalsTestLanguageDelimiters.keyword$19$Delimiter);
		getOverridingHiddensConsumer().setKeyword$7$Delimiter(org.eclipse.xtext.parser.terminalrules.parser.packrat.HiddenTerminalsTestLanguageDelimiters.keyword$19$Delimiter);
		getOverridingHiddensConsumer().setKeyword$8$Delimiter(org.eclipse.xtext.parser.terminalrules.parser.packrat.HiddenTerminalsTestLanguageDelimiters.keyword$19$Delimiter);
		getOverridingHiddensConsumer().setKeyword$11$Delimiter(org.eclipse.xtext.parser.terminalrules.parser.packrat.HiddenTerminalsTestLanguageDelimiters.keyword$19$Delimiter);
		getOverridingHiddensConsumer().setKeyword$13$Delimiter(org.eclipse.xtext.parser.terminalrules.parser.packrat.HiddenTerminalsTestLanguageDelimiters.keyword$19$Delimiter);
		getOverridingHiddensCallConsumer().setKeyword$3$Delimiter(org.eclipse.xtext.parser.terminalrules.parser.packrat.HiddenTerminalsTestLanguageDelimiters.keyword$19$Delimiter);
		getOverridingHiddensCallConsumer().setKeyword$7$Delimiter(org.eclipse.xtext.parser.terminalrules.parser.packrat.HiddenTerminalsTestLanguageDelimiters.keyword$19$Delimiter);
		getOverridingHiddensCallConsumer().setRuleCall$5$Delimiter(org.eclipse.xtext.parser.terminalrules.parser.packrat.HiddenTerminalsTestLanguageDelimiters.ruleCall$21$Delimiter);
		getInheritingHiddensConsumer().setKeyword$6$Delimiter(org.eclipse.xtext.parser.terminalrules.parser.packrat.HiddenTerminalsTestLanguageDelimiters.keyword$19$Delimiter);
		getInheritingHiddensConsumer().setKeyword$7$Delimiter(org.eclipse.xtext.parser.terminalrules.parser.packrat.HiddenTerminalsTestLanguageDelimiters.keyword$19$Delimiter);
		getInheritingHiddensConsumer().setKeyword$8$Delimiter(org.eclipse.xtext.parser.terminalrules.parser.packrat.HiddenTerminalsTestLanguageDelimiters.keyword$19$Delimiter);
		getInheritingHiddensConsumer().setKeyword$14$Delimiter(org.eclipse.xtext.parser.terminalrules.parser.packrat.HiddenTerminalsTestLanguageDelimiters.keyword$19$Delimiter);
		getInheritingHiddensConsumer().setKeyword$16$Delimiter(org.eclipse.xtext.parser.terminalrules.parser.packrat.HiddenTerminalsTestLanguageDelimiters.keyword$19$Delimiter);
		getDatatypeHiddensConsumer().setKeyword$2$Delimiter(org.eclipse.xtext.parser.terminalrules.parser.packrat.HiddenTerminalsTestLanguageDelimiters.keyword$19$Delimiter);
		getDatatypeRuleConsumer().setKeyword$2$Delimiter(org.eclipse.xtext.parser.terminalrules.parser.packrat.HiddenTerminalsTestLanguageDelimiters.keyword$19$Delimiter);
		getDatatypeRuleConsumer().setKeyword$3$Delimiter(org.eclipse.xtext.parser.terminalrules.parser.packrat.HiddenTerminalsTestLanguageDelimiters.keyword$19$Delimiter);
		getHidingHiddensConsumer().setKeyword$3$Delimiter(org.eclipse.xtext.parser.terminalrules.parser.packrat.HiddenTerminalsTestLanguageDelimiters.keyword$19$Delimiter);
		getHidingHiddensConsumer().setRuleCall$5$Delimiter(org.eclipse.xtext.parser.terminalrules.parser.packrat.HiddenTerminalsTestLanguageDelimiters.ruleCall$21$Delimiter);
		getInheritingHiddensCallConsumer().setKeyword$2$Delimiter(org.eclipse.xtext.parser.terminalrules.parser.packrat.HiddenTerminalsTestLanguageDelimiters.keyword$19$Delimiter);
		getInheritingHiddensCallConsumer().setKeyword$4$Delimiter(org.eclipse.xtext.parser.terminalrules.parser.packrat.HiddenTerminalsTestLanguageDelimiters.keyword$19$Delimiter);
	}
