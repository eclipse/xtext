...
/**
 * GENERATED! Manual modification goes to XtextTerminalsTestLanguageRuntimeModule
 */
public abstract class AbstractXtextTerminalsTestLanguageRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		...
		binder.bind(IServiceScope.class).toInstance(org.eclipse.xtext.parser.terminalrules.IXtextTerminalsTestLanguage.SCOPE);
	}
