...
public final class XtextTerminalsTestLanguageGrammarIDConsumer extends NonTerminalConsumer {
		...
		switch(entryPoint) {
			...
			case 0:
				...
				if (result!=ConsumeResult.SUCCESS) {
					error("Another token expected.", getRule().ele0ParserRuleCallID());
					marker.commit();
	...
	protected int consumeRuleCall$2(int entryPoint) throws Exception {
		return consumeTerminal(idConsumer, null, false, false, getRule().ele0ParserRuleCallID(), getRuleCall$2$Delimiter());
	}
	...
	protected int doConsumeGroup$3(int entryPoint) throws Exception {
		...
		switch(entryPoint) {
			...
			case 1:
				...
				if (result!=ConsumeResult.SUCCESS) {
					error("Another token expected.", getRule().ele11ParserRuleCallID());
					marker.commit();
					announceLevelFinished();
					return result;
				}
	...
	protected int consumeRuleCall$5(int entryPoint) throws Exception {
		return consumeTerminal(idConsumer, null, false, false, getRule().ele11ParserRuleCallID(), getRuleCall$5$Delimiter());
	}
