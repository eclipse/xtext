 ...
 * </copyright>
 *
 * $Id: TypeRefImpl.java,v 1.3 2009/02/19 14:39:34 sefftinge Exp $
 */
 ...
 *   <li>{@link org.eclipse.xtext.parser.terminalrules.xtextTerminalsTestLanguage.impl.TypeRefImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TypeRefImpl extends EObjectImpl implements TypeRef
{
  ...
  public EClassifier getType()
  {
    if (type != null && type.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, XtextTerminalsTestLanguagePackage.TYPE_REF__TYPE, oldType, type));
      }
    }
    return type;
  }
  ...
  public void setType(EClassifier newType)
  {
    ...
    type = newType;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XtextTerminalsTestLanguagePackage.TYPE_REF__TYPE, oldType, type));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case XtextTerminalsTestLanguagePackage.TYPE_REF__TYPE:
