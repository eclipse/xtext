...
public final class TerminalRulesTestLanguageIDConsumer extends AbstractRuleAwareTerminalConsumer {
	...
	public TerminalRulesTestLanguageIDConsumer(ICharSequenceWithOffset input, IMarkerFactory markerFactory,
	...
	public AbstractRule doGetRule() {
		return TerminalRulesTestLanguageGrammarAccess.INSTANCE.prID().getRule();
	}
