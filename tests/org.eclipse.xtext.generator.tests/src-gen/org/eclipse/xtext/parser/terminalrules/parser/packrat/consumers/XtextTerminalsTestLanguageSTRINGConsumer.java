...
public final class XtextTerminalsTestLanguageSTRINGConsumer extends AbstractRuleAwareTerminalConsumer {


	public XtextTerminalsTestLanguageSTRINGConsumer(ICharSequenceWithOffset input, IMarkerFactory markerFactory,
	...
	public AbstractRule doGetRule() {
		return XtextTerminalsTestLanguageGrammarAccess.INSTANCE.prSTRING().getRule();
	}
