 ...
 * <ul>
 *   <li>{@link org.eclipse.xtext.parser.antlr.bug289524Test.impl.ModelElementImpl#getContainments <em>Containments</em>}</li>
 *   <li>{@link org.eclipse.xtext.parser.antlr.bug289524Test.impl.ModelElementImpl#getRefs <em>Refs</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ModelElementImpl extends MinimalEObjectImpl.Container implements ModelElement
{
  ...
  {
    return Bug289524TestPackage.Literals.MODEL_ELEMENT;
  }
  ...
  public EList<Contained> getContainments()
  {
    ...
    {
      containments = new EObjectContainmentEList<Contained>(Contained.class, this, Bug289524TestPackage.MODEL_ELEMENT__CONTAINMENTS);
    }
    return containments;
  }
  ...
  public EList<Contained> getRefs()
  {
    if (refs == null)
    {
      refs = new EObjectResolvingEList<Contained>(Contained.class, this, Bug289524TestPackage.MODEL_ELEMENT__REFS);
    }
    return refs;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case Bug289524TestPackage.MODEL_ELEMENT__CONTAINMENTS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case Bug289524TestPackage.MODEL_ELEMENT__REFS:
        return getRefs();
    }
