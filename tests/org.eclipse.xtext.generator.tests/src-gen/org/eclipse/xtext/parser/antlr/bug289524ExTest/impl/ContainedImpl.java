...
public class ContainedImpl extends MinimalEObjectImpl.Container implements Contained
{
  ...
  {
    return Bug289524ExTestPackage.Literals.CONTAINED;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Bug289524ExTestPackage.CONTAINED__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case Bug289524ExTestPackage.CONTAINED__NAME:
        return getName();
    }
