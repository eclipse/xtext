        ...
        try {
            ...
            case RULE_ID:
                ...
                if ( (LA18_1==EOF||(LA18_1>=RULE_ID && LA18_1<=RULE_STRING)||LA18_1==22||(LA18_1>=24 && LA18_1<=27)||LA18_1==31||LA18_1==34||(LA18_1>=36 && LA18_1<=37)) ) {
                    ...
                    NoViableAltException nvae =
                        new NoViableAltException("856:2: ( (this_Assignment= ruleAssignment | this_Action= ruleAction ) | this_AbstractTerminal= ruleAbstractTerminal )", 18, 1, input);
            ...
            default:
                NoViableAltException nvae =
                    new NoViableAltException("856:2: ( (this_Assignment= ruleAssignment | this_Action= ruleAction ) | this_AbstractTerminal= ruleAbstractTerminal )", 18, 0, input);
            ...
            switch (alt18) {
                case 1 :
                    ...
                    if ( (LA17_0==RULE_ID) ) {
                        ...
                        NoViableAltException nvae =
                            new NoViableAltException("856:3: (this_Assignment= ruleAssignment | this_Action= ruleAction )", 17, 0, input);
            ...
            switch (alt21) {
                case 1 :
                    ...
                    if ( ((LA20_0>=25 && LA20_0<=26)) ) {
                        ...
                        NoViableAltException nvae =
                            new NoViableAltException("887:21: ( ( '?' | '*' ) | '+' )", 20, 0, input);
                    ...
                    switch (alt20) {
                        case 1 :
                            ...
                            if ( (LA19_0==25) ) {
                                ...
                                NoViableAltException nvae =
                                    new NoViableAltException("887:22: ( '?' | '*' )", 19, 0, input);
    ...
    public final EObject ruleAssignment() throws RecognitionException {
        ...
        try {
            ...
            if ( ((LA23_0>=28 && LA23_0<=29)) ) {
                ...
                NoViableAltException nvae =
                    new NoViableAltException("955:18: ( ( '+=' | '=' ) | '?=' )", 23, 0, input);
            ...
            switch (alt23) {
                case 1 :
                    ...
                    if ( (LA22_0==28) ) {
                        ...
                        NoViableAltException nvae =
                            new NoViableAltException("955:19: ( '+=' | '=' )", 22, 0, input);
    ...
    public final EObject ruleAction() throws RecognitionException {
        ...
        try {
            ...
            if ( (LA25_0==29) ) {
                ...
                NoViableAltException nvae =
                    new NoViableAltException("1081:18: ( '=' | '+=' )", 25, 0, input);
    ...
    public final EObject ruleAbstractTerminal() throws RecognitionException {
        ...
        try {
            ...
            if ( ((LA28_0>=RULE_ID && LA28_0<=RULE_STRING)||LA28_0==36) ) {
                ...
                NoViableAltException nvae =
                    new NoViableAltException("1130:1: ( ( (this_Keyword= ruleKeyword | this_RuleCall= ruleRuleCall ) | this_ParenthesizedElement= ruleParenthesizedElement ) | this_CrossReference= ruleCrossReference )", 28, 0, input);
            ...
            switch (alt28) {
                case 1 :
                    ...
                    if ( ((LA27_0>=RULE_ID && LA27_0<=RULE_STRING)) ) {
                        ...
                        NoViableAltException nvae =
                            new NoViableAltException("1130:2: ( (this_Keyword= ruleKeyword | this_RuleCall= ruleRuleCall ) | this_ParenthesizedElement= ruleParenthesizedElement )", 27, 0, input);
                    ...
                    switch (alt27) {
                        case 1 :
                            ...
                            if ( (LA26_0==RULE_STRING) ) {
                                ...
                                NoViableAltException nvae =
                                    new NoViableAltException("1130:3: (this_Keyword= ruleKeyword | this_RuleCall= ruleRuleCall )", 26, 0, input);
