...
public final class Bug296889ExTestLanguageDataTypeVariableConsumer extends NonTerminalConsumer {
	...
	public Bug296889ExTestLanguageDataTypeVariableConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public DataTypeVariableElements getRule() {
		return rule;
	}
	
	public void setRule(DataTypeVariableElements rule) {
		this.rule = rule;
