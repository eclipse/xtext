...
parse returns [EObject current] : {currentNode = createCompositeNode(// org.eclipse.xtext.impl.ParserRuleImpl@9bb5d7 (name: Model)
...
grammar.eResource().getEObject("//@parserRules.1/@alternatives/@abstractTokens.0/@abstractTokens.0/@abstractTokens.0/@abstractTokens.0/@terminal"), currentNode,"optional");  
  associateNodeWithAstElement(currentNode, $current); }
)?'element' { createLeafNode(// org.eclipse.xtext.impl.KeywordImpl@ed0184 (cardinality: null) (value: "element")
grammar.eResource().getEObject("//@parserRules.1/@alternatives/@abstractTokens.0/@abstractTokens.0/@abstractTokens.0/@abstractTokens.1"), currentNode,null); })(
	...
	lv_name=RULE_ID{ createLeafNode(// org.eclipse.xtext.impl.RuleCallImpl@b08060 (cardinality: null) (name: ID)
...
{ if ($current==null) {
  ...
  associateNodeWithAstElement(currentNode, $current); }
	...
	lv_descriptions=RULE_STRING{ createLeafNode(// org.eclipse.xtext.impl.RuleCallImpl@50890a (cardinality: null) (name: STRING)
