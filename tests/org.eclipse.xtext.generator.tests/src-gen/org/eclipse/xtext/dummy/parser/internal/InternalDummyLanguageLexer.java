...
public class InternalDummyLanguageLexer extends Lexer {
        ...
        try {
            ...
            if ( (LA3_0=='\"') ) {
                ...
                NoViableAltException nvae =
                    new NoViableAltException("176:1: RULE_STRING : ( '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | ~ ( '\\\\' | '\"' ) )* '\"' | '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | ~ ( '\\\\' | '\\'' ) )* '\\'' );", 3, 0, input);
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            // ./src-gen/org/eclipse/xtext/dummy/parser/internal/InternalDummyLanguage.g:188:10: ( ( '0' .. '9' )+ )
            // ./src-gen/org/eclipse/xtext/dummy/parser/internal/InternalDummyLanguage.g:188:12: ( '0' .. '9' )+
            {
            // ./src-gen/org/eclipse/xtext/dummy/parser/internal/InternalDummyLanguage.g:188:12: ( '0' .. '9' )+
            int cnt11=0;
            loop11:
            do {
                ...
                switch (alt11) {
            	case 1 :
            	    // ./src-gen/org/eclipse/xtext/dummy/parser/internal/InternalDummyLanguage.g:188:13: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public void mTokens() throws RecognitionException {
        // ./src-gen/org/eclipse/xtext/dummy/parser/internal/InternalDummyLanguage.g:1:8: ( T12 | T13 | T14 | RULE_STRING | RULE_ML_COMMENT | RULE_ID | RULE_LEXER_BODY | RULE_WS | RULE_SL_COMMENT | RULE_INT | RULE_ANY_OTHER )
        int alt12=11;
        ...
        switch (alt12) {
            ...
            case 8 :
                ...
                break;
            case 9 :
                // ./src-gen/org/eclipse/xtext/dummy/parser/internal/InternalDummyLanguage.g:1:82: RULE_SL_COMMENT
                {
                mRULE_SL_COMMENT(); 
