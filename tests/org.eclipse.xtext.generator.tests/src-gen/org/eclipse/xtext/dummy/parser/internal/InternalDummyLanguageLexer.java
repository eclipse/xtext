// $ANTLR 3.0 ./src-gen/org/eclipse/xtext/dummy/parser/internal/InternalDummyLanguage.g 2008-05-22 17:07:51
...
public class InternalDummyLanguageLexer extends Lexer {
    ...
    public void mRULE_STRING() throws RecognitionException {
        try {
            ...
            // ./src-gen/org/eclipse/xtext/dummy/parser/internal/InternalDummyLanguage.g:180:15: ( '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | ~ ( '\\\\' | '\"' ) )* '\"' | '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | ~ ( '\\\\' | '\\'' ) )* '\\'' )
            int alt7=2;
            ...
            if ( (LA7_0=='\"') ) {
                ...
                NoViableAltException nvae =
                    new NoViableAltException("180:1: RULE_STRING : ( '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | ~ ( '\\\\' | '\"' ) )* '\"' | '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | ~ ( '\\\\' | '\\'' ) )* '\\'' );", 7, 0, input);
    ...
    public void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            // ./src-gen/org/eclipse/xtext/dummy/parser/internal/InternalDummyLanguage.g:186:19: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // ./src-gen/org/eclipse/xtext/dummy/parser/internal/InternalDummyLanguage.g:186:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // ./src-gen/org/eclipse/xtext/dummy/parser/internal/InternalDummyLanguage.g:186:24: ( options {greedy=false; } : . )*
            loop11:
            do {
                int alt11=2;
                ...
                switch (alt11) {
            	case 1 :
            	    // ./src-gen/org/eclipse/xtext/dummy/parser/internal/InternalDummyLanguage.g:186:52: .
            	    {
            	    matchAny(); 
    ...
    public void mTokens() throws RecognitionException {
        // ./src-gen/org/eclipse/xtext/dummy/parser/internal/InternalDummyLanguage.g:1:10: ( T12 | T13 | T14 | RULE_LEXER_BODY | RULE_WS | RULE_ID | RULE_STRING | RULE_SL_COMMENT | RULE_INT | RULE_ML_COMMENT | RULE_ANY_OTHER )
        int alt12=11;
