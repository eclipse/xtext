...
public class DummyLanguageGrammarAccess extends BaseEPackageAccess implements IGrammarAccess {
	...
	public ParserRule pr_Model() {
		return (ParserRule) getGrammar().eResource().getResourceSet().getEObject(URI.createURI("classpath:/org/eclipse/xtext/dummy/DummyLanguage.xmi#//@parserRules.0"),true); 
	}

	public ParserRule pr_Element() {
		return (ParserRule) getGrammar().eResource().getResourceSet().getEObject(URI.createURI("classpath:/org/eclipse/xtext/dummy/DummyLanguage.xmi#//@parserRules.1"),true); 
	}
