...
public final class TransientValuesTestTestOptionalConsumer extends NonTerminalConsumer {
	...
	protected class RuleCall$5$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume() throws Exception {
			return consumeTerminal(intConsumer, "opt1", false, false, getElement(), getRuleCall$5$Delimiter());
		}
	}
	...
	protected class RuleCall$9$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume() throws Exception {
			return consumeTerminal(intConsumer, "opt2", false, false, getElement(), getRuleCall$9$Delimiter());
		}
	}
