...
public final class TransientValuesTestTestOptionalConsumer extends NonTerminalConsumer {
	...
	protected int doConsumeAssignment$4(int entryPoint) throws Exception {
		final AssignmentResult result = createAssignmentResult(getRule().ele01AssignmentOpt1());
	...
	protected int doConsumeAssignment$8(int entryPoint) throws Exception {
		final AssignmentResult result = createAssignmentResult(getRule().ele11AssignmentOpt2());
