...
public final class TransientValuesTestTestRequiredConsumer extends NonTerminalConsumer {
	...
	protected int doConsumeAssignment$4(int entryPoint) throws Exception {
		final AssignmentResult result = createAssignmentResult(getRule().ele01AssignmentRequired1());
	...
	protected int doConsumeAssignment$6(int entryPoint) throws Exception {
		final AssignmentResult result = createAssignmentResult(getRule().ele1AssignmentRequired2());
