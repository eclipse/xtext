...
public final class TransientValuesTestTestRequiredConsumer extends NonTerminalConsumer {
	...
	protected class RuleCall$5$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume() throws Exception {
			return consumeTerminal(intConsumer, "required1", false, false, getElement(), getRuleCall$5$Delimiter());
		}
	}
	...
	protected class RuleCall$7$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume() throws Exception {
			return consumeTerminal(intConsumer, "required2", false, false, getElement(), getRuleCall$7$Delimiter());
		}
	}
