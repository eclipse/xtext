...
public final class SimpleReconstrTestLanguageTwoNumbersConsumer extends NonTerminalConsumer {
	...
	protected int doConsumeAssignment$3(int entryPoint) throws Exception {
		final AssignmentResult result = createAssignmentResult(getRule().ele00AssignmentNum1());
	...
	protected int doConsumeAssignment$5(int entryPoint) throws Exception {
		final AssignmentResult result = createAssignmentResult(getRule().ele01AssignmentNum2());
	...
	protected int doConsumeAssignment$9(int entryPoint) throws Exception {
		final AssignmentResult result = createAssignmentResult(getRule().ele11AssignmentNum3());
