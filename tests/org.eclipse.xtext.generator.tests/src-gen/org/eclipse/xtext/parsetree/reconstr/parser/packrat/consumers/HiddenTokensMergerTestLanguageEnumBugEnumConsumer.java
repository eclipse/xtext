...
public final class HiddenTokensMergerTestLanguageEnumBugEnumConsumer extends NonTerminalConsumer {
	...
	public HiddenTokensMergerTestLanguageEnumBugEnumConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public EnumBugEnumElements getRule() {
		return rule;
	}
	
	public void setRule(EnumBugEnumElements rule) {
		this.rule = rule;
		
		alternatives$1$Consumer = new Alternatives$1$Consumer(rule.getAlternatives());
		enumLiteralDeclaration$2$Consumer = new EnumLiteralDeclaration$2$Consumer(rule.getArrayEnumLiteralDeclaration_0());
		enumLiteralDeclaration$4$Consumer = new EnumLiteralDeclaration$4$Consumer(rule.getObjectEnumLiteralDeclaration_1());
		enumLiteralDeclaration$6$Consumer = new EnumLiteralDeclaration$6$Consumer(rule.getResultSetEnumLiteralDeclaration_2());
		enumLiteralDeclaration$8$Consumer = new EnumLiteralDeclaration$8$Consumer(rule.getIteratorEnumLiteralDeclaration_3());
	}
