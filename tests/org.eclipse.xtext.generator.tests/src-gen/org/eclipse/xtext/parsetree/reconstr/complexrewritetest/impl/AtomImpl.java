 ...
 * </copyright>
 *
 * $Id: AtomImpl.java,v 1.4 2009/02/19 16:26:51 sefftinge Exp $
 */
...
public class AtomImpl extends ExpressionImpl implements Atom
{
  ...
  {
    return ComplexrewritetestPackage.Literals.ATOM;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ComplexrewritetestPackage.ATOM__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ComplexrewritetestPackage.ATOM__NAME:
        return getName();
    }
