	...
	protected boolean doConsume() throws Exception {
		ALTERNATIVES$1SUCCESS: {
			ALTERNATIVES$1FAILURE: {
				RULECALL$2SUCCESS: {
					if (!consumeNonTerminal(trickyG1Consumer, null, false, false,  getRule().ele0ParserRuleCallTrickyG1()))
						break RULECALL$2SUCCESS;
					break ALTERNATIVES$1FAILURE;
				}
				ASSIGNMENT$3SUCCESS: {
					ASSIGNMENT$3FAILURE: {
						if (consumeTerminal(intConsumer, "val", false, false, getRule().ele10LexerRuleCallINT()))
