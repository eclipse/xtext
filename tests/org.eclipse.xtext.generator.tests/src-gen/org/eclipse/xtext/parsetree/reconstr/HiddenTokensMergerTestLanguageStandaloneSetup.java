...
public class HiddenTokensMergerTestLanguageStandaloneSetup implements ISetup {
	...
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.eclipse.org/2009/tmf/xtext/simplerewritetest")) {
		EPackage.Registry.INSTANCE.put("http://www.eclipse.org/2009/tmf/xtext/simplerewritetest", org.eclipse.xtext.parsetree.reconstr.hiddentokenmergertest.HiddentokenmergertestPackage.eINSTANCE);
	}
