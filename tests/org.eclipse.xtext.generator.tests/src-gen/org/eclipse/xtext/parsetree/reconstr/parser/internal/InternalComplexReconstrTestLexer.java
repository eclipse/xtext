...
public class InternalComplexReconstrTestLexer extends Lexer {
    ...
    public void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            // ./src-gen/org/eclipse/xtext/parsetree/reconstr/parser/internal/InternalComplexReconstrTest.g:231:19: ( '//' (~ ( '\\n' | '\\r' ) )* ( '\\r' )? '\\n' )
            // ./src-gen/org/eclipse/xtext/parsetree/reconstr/parser/internal/InternalComplexReconstrTest.g:231:19: '//' (~ ( '\\n' | '\\r' ) )* ( '\\r' )? '\\n'
            {
            match("//"); 

            // ./src-gen/org/eclipse/xtext/parsetree/reconstr/parser/internal/InternalComplexReconstrTest.g:231:24: (~ ( '\\n' | '\\r' ) )*
            loop1:
            do {
                int alt1=2;
            ...
            // ./src-gen/org/eclipse/xtext/parsetree/reconstr/parser/internal/InternalComplexReconstrTest.g:231:38: ( '\\r' )?
            int alt2=2;
        ...
        try {
            ...
            if ( (LA5_0=='\"') ) {
                ...
                NoViableAltException nvae =
                    new NoViableAltException("233:1: RULE_STRING : ( '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | ~ ( '\\\\' | '\"' ) )* '\"' | '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | ~ ( '\\\\' | '\\'' ) )* '\\'' );", 5, 0, input);
    ...
    public void mTokens() throws RecognitionException {
        // ./src-gen/org/eclipse/xtext/parsetree/reconstr/parser/internal/InternalComplexReconstrTest.g:1:10: ( T12 | T13 | T14 | T15 | T16 | RULE_SL_COMMENT | RULE_STRING | RULE_WS | RULE_ID | RULE_INT | RULE_LEXER_BODY | RULE_ML_COMMENT | RULE_ANY_OTHER )
        int alt12=13;
        ...
        if ( (LA12_0=='+') ) {
            ...
            NoViableAltException nvae =
                new NoViableAltException("1:1: Tokens : ( T12 | T13 | T14 | T15 | T16 | RULE_SL_COMMENT | RULE_STRING | RULE_WS | RULE_ID | RULE_INT | RULE_LEXER_BODY | RULE_ML_COMMENT | RULE_ANY_OTHER );", 12, 0, input);
