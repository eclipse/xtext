...
public class InternalSimpleReconstrTestParser extends Parser {
    public static final String[] tokenNames = new String[] {
        "<invalid>", "<EOR>", "<DOWN>", "<UP>", "RULE_ID", "RULE_INT", "RULE_STRING", "RULE_LEXER_BODY", "RULE_WS", "RULE_ML_COMMENT", "RULE_SL_COMMENT", "RULE_ANY_OTHER", "'('", "')'", "'!'"
    };
    ...
    public final EObject parse() throws RecognitionException {
        ...
        try {
            ...
            {
            currentNode = createCompositeNode(// org.eclipse.xtext.impl.ParserRuleImpl@3692c8 (name: Op)
    ...
    public final EObject ruleAtom() throws RecognitionException {
        ...
        try {
            ...
            match(input,RULE_ID,FOLLOW_RULE_ID_in_ruleAtom191); 
             createLeafNode(// org.eclipse.xtext.impl.RuleCallImpl@fab5ad (cardinality: null) (name: ID)
