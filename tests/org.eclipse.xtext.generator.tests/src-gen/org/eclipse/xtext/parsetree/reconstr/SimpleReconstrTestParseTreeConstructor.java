...
public class SimpleReconstrTestParseTreeConstructor extends AbstractParseTreeRewriter {
	...
	private org.eclipse.xtext.Grammar grammar = org.eclipse.xtext.parsetree.reconstr.SimpleReconstrTestConstants
			.getSimpleReconstrTestGrammar();
		...
		/* xtext::Group */
		{
			...
			while (new Predicate(obj) {
				public boolean check() {
					return obj.checkConsume("values") && obj.isOfType("Op") && obj.checkConsume("values")
							&& obj.isConsumed();
				}
			}.check()) {
				...
				/* xtext::Assignment */
				{
					...
					/* xtext::RuleCall */
					{
						...
						EObject ruleCall = grammar.eResource().getEObject(
				...
				/* xtext::Action */
				{
					...
					action(obj, newObj, (Action) grammar.eResource().getEObject(
							"//@parserRules.0/@alternatives/@abstractTokens.1/@abstractTokens.0"));
					obj = newObj;
	...
	protected void proceedAtom(InstanceDescription obj) {
		...
		/* xtext::Assignment */
		{
			...
			/* xtext::RuleCall */
			{
				...
				lexerRuleCall(value, (RuleCall) grammar.eResource().getEObject(
						"//@parserRules.2/@alternatives/@terminal"));
		...
		/* xtext::Group */
		{
			...
			if (new Predicate(obj) {
				...
				/* xtext::Keyword */
				{
					...
					keyword((Keyword) grammar.eResource().getEObject(
							"//@parserRules.3/@alternatives/@abstractTokens.1/@terminal"));
			...
			/* xtext::Group */
			{
				...
				/* xtext::Keyword */
				{
					...
					keyword((Keyword) grammar.eResource().getEObject(
							"//@parserRules.3/@alternatives/@abstractTokens.0/@abstractTokens.1"));
				...
				/* xtext::Group */
				{
					...
					/* xtext::RuleCall */
					{
						...
						InstanceDescription val = obj;
						EObject ruleCall = grammar.eResource().getEObject(
								"//@parserRules.3/@alternatives/@abstractTokens.0/@abstractTokens.0/@abstractTokens.1");
						try {
							ruleCallStart(val, false, (RuleCall) ruleCall);
							proceedOp(val);
						} finally {
