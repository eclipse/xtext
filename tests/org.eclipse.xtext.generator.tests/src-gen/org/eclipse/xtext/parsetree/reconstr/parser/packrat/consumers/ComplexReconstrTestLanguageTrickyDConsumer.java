...
public final class ComplexReconstrTestLanguageTrickyDConsumer extends NonTerminalConsumer {
	...
	public void setRule(TrickyDElements rule) {
		...
		ruleCall$15$Consumer = new RuleCall$15$Consumer(rule.ele0100LexerRuleCallINT());
		assignment$16$Consumer = new Assignment$16$Consumer(rule.ele011AssignmentType());
		ruleCall$17$Consumer = new RuleCall$17$Consumer(rule.ele0110LexerRuleCallID());
		assignment$18$Consumer = new Assignment$18$Consumer(rule.ele1AssignmentType());
		ruleCall$19$Consumer = new RuleCall$19$Consumer(rule.ele10LexerRuleCallID());
	}
