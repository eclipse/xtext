...
public abstract class AbstractSimpleReconstrTestLanguageRuntimeModule extends DefaultRuntimeModule {
	...
	public com.google.inject.Provider<org.eclipse.xtext.parser.antlr.Lexer> provideLexer() {
		return new org.eclipse.xtext.parser.antlr.LexerProvider(org.eclipse.xtext.parsetree.reconstr.parser.antlr.internal.InternalSimpleReconstrTestLanguageLexer.class);
	}
