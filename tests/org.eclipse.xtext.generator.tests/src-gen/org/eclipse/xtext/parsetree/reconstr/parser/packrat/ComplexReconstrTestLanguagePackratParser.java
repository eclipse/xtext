...
public class ComplexReconstrTestLanguagePackratParser extends AbstractPackratParser {
	...
	@Override
	protected ComplexReconstrTestLanguageParserConfiguration createParserConfiguration(ICharSequenceWithOffset input,
		...
		return new ComplexReconstrTestLanguageParserConfiguration(input, markerFactory, tokenAcceptor, hiddenTokenHandler, consumerUtil);
	}
