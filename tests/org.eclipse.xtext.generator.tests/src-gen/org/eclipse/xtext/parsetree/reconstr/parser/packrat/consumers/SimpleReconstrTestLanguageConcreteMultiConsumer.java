...
import org.eclipse.xtext.parsetree.reconstr.services.SimpleReconstrTestLanguageGrammarAccess.ConcreteMultiElements;

public final class SimpleReconstrTestLanguageConcreteMultiConsumer extends NonTerminalConsumer {

	private ConcreteMultiElements rule;	
	...
	protected class RuleCall$3$Consumer extends ElementConsumer<RuleCall> {
		...
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(idConsumer, "m1", false, false, getElement(), getRuleCall$3$Delimiter(), optional);
		}
	}
	...
	protected class RuleCall$5$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(idConsumer, "m2", false, false, getElement(), getRuleCall$5$Delimiter(), optional);
		}
	}

	public SimpleReconstrTestLanguageConcreteMultiConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public ConcreteMultiElements getRule() {
		return rule;
	}
	
	public void setRule(ConcreteMultiElements rule) {
		this.rule = rule;
		
		group$1$Consumer = new Group$1$Consumer(rule.getGroup());
		assignment$2$Consumer = new Assignment$2$Consumer(rule.getM1Assignment_0());
		ruleCall$3$Consumer = new RuleCall$3$Consumer(rule.getM1IDTerminalRuleCall_0_0());
		assignment$4$Consumer = new Assignment$4$Consumer(rule.getM2Assignment_1());
		ruleCall$5$Consumer = new RuleCall$5$Consumer(rule.getM2IDTerminalRuleCall_1_0());
	}
