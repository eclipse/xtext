...
public final class HiddenTokensMergerTestLanguageDatatypeBug286557Consumer extends NonTerminalConsumer {
	...
	public DatatypeBug286557Elements getRule() {
		return rule;
	}
	
	public void setRule(DatatypeBug286557Elements rule) {
		this.rule = rule;
		...
		keyword$6$Consumer = new Keyword$6$Consumer(rule.getRefKeyword_2_0());
		assignment$7$Consumer = new Assignment$7$Consumer(rule.getRefAssignment_2_1());
		crossReference$8$Consumer = new CrossReference$8$Consumer(rule.getRefDatatypeBug286557CrossReference_2_1_0());
