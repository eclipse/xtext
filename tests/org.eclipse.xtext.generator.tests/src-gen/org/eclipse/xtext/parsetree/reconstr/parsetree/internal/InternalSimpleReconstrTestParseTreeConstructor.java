...
public class InternalSimpleReconstrTestParseTreeConstructor extends AbstractInternalParseTreeConstructor {

	public InternalSimpleReconstrTestParseTreeConstructor(GenericEcoreElementFactory factory, Grammar grammar, IValueConverterService converterService) {
...
/* xtext::Action */ 
{
	...
	action(obj,newObj, (Action) getGrammarElement("classpath:/org/eclipse/xtext/parsetree/reconstr/SimpleReconstrTest.xmi#//@parserRules.0/@alternatives/@abstractTokens.1/@abstractTokens.0"));
	obj = newObj;
...
/* xtext::RuleCall */ 
{
		...
		lexerRuleCall(value,(RuleCall)getGrammarElement("classpath:/org/eclipse/xtext/parsetree/reconstr/SimpleReconstrTest.xmi#//@parserRules.2/@alternatives/@terminal"));
...
/* xtext::Keyword */ 
{
	...
	keyword((Keyword)getGrammarElement("classpath:/org/eclipse/xtext/parsetree/reconstr/SimpleReconstrTest.xmi#//@parserRules.3/@alternatives/@abstractTokens.1/@terminal"));
...
/* xtext::Keyword */ 
{
	...
	keyword((Keyword)getGrammarElement("classpath:/org/eclipse/xtext/parsetree/reconstr/SimpleReconstrTest.xmi#//@parserRules.3/@alternatives/@abstractTokens.0/@abstractTokens.1"));
...
/* xtext::Keyword */ 
{
	...
	keyword((Keyword)getGrammarElement("classpath:/org/eclipse/xtext/parsetree/reconstr/SimpleReconstrTest.xmi#//@parserRules.3/@alternatives/@abstractTokens.0/@abstractTokens.0/@abstractTokens.0"));
