...
public final class FormatterTestLanguageFqnRefConsumer extends NonTerminalConsumer {
	...
	protected class RuleCall$4$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeNonTerminal(fqnConsumer, "fqn", true, true, false, getElement(), optional);
		}
	}
	...
	public void setRule(FqnRefElements rule) {
		...
		assignment$3$Consumer = new Assignment$3$Consumer(rule.getFqnAssignment_1());
		ruleCall$4$Consumer = new RuleCall$4$Consumer(rule.getFqnFQNParserRuleCall_1_0());
	}
