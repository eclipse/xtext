...
public final class FormatterTestLanguageTestLinewrapConsumer extends NonTerminalConsumer {
	...
	public FormatterTestLanguageTestLinewrapConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	protected int consumeRuleCall$4(int entryPoint) throws Exception {
		return consumeNonTerminal(lineConsumer, "items", true, false, false, getRule().ele10ParserRuleCallLine());
	}
