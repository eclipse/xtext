 ...
 * </copyright>
 *
 * $Id: RootImpl.java,v 1.2 2009/02/18 21:22:30 sefftinge Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.eclipse.xtext.parsetree.formatter.formattertestlanguage.impl.RootImpl#getItems <em>Items</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class RootImpl extends EObjectImpl implements Root
{
  ...
  public EList<Line> getItems()
  {
    if (items == null)
    {
      items = new EObjectContainmentEList<Line>(Line.class, this, FormattertestlanguagePackage.ROOT__ITEMS);
    }
    return items;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case FormattertestlanguagePackage.ROOT__ITEMS:
