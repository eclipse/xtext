...
public final class FormatterTestLanguageRootConsumer extends NonTerminalConsumer {
	...
	public void setRule(RootElements rule) {
		...
		ruleCall$4$Consumer = new RuleCall$4$Consumer(rule.ele10ParserRuleCallTestLinewrap());
		ruleCall$5$Consumer = new RuleCall$5$Consumer(rule.ele11ParserRuleCallTestIndentation());
	}
