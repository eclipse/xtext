...
import org.eclipse.xtext.parsetree.unassignedtext.services.UnassignedTextTestLanguageGrammarAccess.PluralRuleElements;

public final class UnassignedTextTestLanguagePluralRuleConsumer extends NonTerminalConsumer {

	private PluralRuleElements rule;	

	private ITerminalConsumer intConsumer;

	private ITerminalConsumer pluralConsumer;
	...
	protected class RuleCall$4$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(intConsumer, "count", false, false, getElement(), getRuleCall$4$Delimiter(), optional);
		}
	}
	...
	protected class RuleCall$5$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(pluralConsumer, null, false, false, getElement(), getRuleCall$5$Delimiter(), optional);
		}
	}

	public UnassignedTextTestLanguagePluralRuleConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public PluralRuleElements getRule() {
		return rule;
	}
	
	public void setRule(PluralRuleElements rule) {
		this.rule = rule;
		
		group$1$Consumer = new Group$1$Consumer(rule.getGroup());
		keyword$2$Consumer = new Keyword$2$Consumer(rule.getContentsKeyword_0());
		assignment$3$Consumer = new Assignment$3$Consumer(rule.getCountAssignment_1());
		ruleCall$4$Consumer = new RuleCall$4$Consumer(rule.getCountINTTerminalRuleCall_1_0());
		ruleCall$5$Consumer = new RuleCall$5$Consumer(rule.getPluralTerminalRuleCall_2());
	}
	...
	public void setPluralConsumer(ITerminalConsumer pluralConsumer) {
		this.pluralConsumer = pluralConsumer;
	}
