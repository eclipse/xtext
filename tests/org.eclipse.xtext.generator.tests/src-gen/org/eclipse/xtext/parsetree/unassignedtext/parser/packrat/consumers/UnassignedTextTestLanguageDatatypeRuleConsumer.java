...
public final class UnassignedTextTestLanguageDatatypeRuleConsumer extends NonTerminalConsumer {
	...
	public UnassignedTextTestLanguageDatatypeRuleConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public void setRule(DatatypeRuleElements rule) {
		...
		ruleCall$5$Consumer = new RuleCall$5$Consumer(rule.getDatatypeParserRuleCall_2());
	}
