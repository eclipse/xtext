 ...
 * </copyright>
 *
 * $Id: ImportedURIFactoryImpl.java,v 1.4 2009/02/19 16:27:05 sefftinge Exp $
 */
...
public class ImportedURIFactoryImpl extends EFactoryImpl implements ImportedURIFactory
{
  ...
  public static ImportedURIFactory init()
  {
    try
    {
      ImportedURIFactory theImportedURIFactory = (ImportedURIFactory)EPackage.Registry.INSTANCE.getEFactory("http://eclipse.org/xtext/importUriTestLanguage"); 
