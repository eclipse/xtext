...
import org.eclipse.xtext.crossrefs.lazy.parser.packrat.consumers.LazyLinkingTestLanguageModelConsumer;
import org.eclipse.xtext.crossrefs.lazy.parser.packrat.consumers.LazyLinkingTestLanguageTypeConsumer;
import org.eclipse.xtext.crossrefs.lazy.parser.packrat.consumers.LazyLinkingTestLanguagePropertyConsumer;
...
public class LazyLinkingTestLanguageParserConfiguration extends AbstractParserConfiguration {
	...
	public void configureConsumers() {
		...
		getTypeConsumer().setKeyword$6$Delimiter(org.eclipse.xtext.crossrefs.lazy.parser.packrat.LazyLinkingTestLanguageDelimiters.keyword$8$Delimiter);
		getTypeConsumer().setKeyword$11$Delimiter(org.eclipse.xtext.crossrefs.lazy.parser.packrat.LazyLinkingTestLanguageDelimiters.keyword$17$Delimiter);
		getTypeConsumer().setKeyword$17$Delimiter(org.eclipse.xtext.crossrefs.lazy.parser.packrat.LazyLinkingTestLanguageDelimiters.keyword$8$Delimiter);
		getTypeConsumer().setKeyword$22$Delimiter(org.eclipse.xtext.crossrefs.lazy.parser.packrat.LazyLinkingTestLanguageDelimiters.keyword$8$Delimiter);
		getTypeConsumer().setKeyword$27$Delimiter(org.eclipse.xtext.crossrefs.lazy.parser.packrat.LazyLinkingTestLanguageDelimiters.keyword$17$Delimiter);
		getTypeConsumer().setKeyword$30$Delimiter(org.eclipse.xtext.crossrefs.lazy.parser.packrat.LazyLinkingTestLanguageDelimiters.keyword$17$Delimiter);
		getTypeConsumer().setKeyword$2$Delimiter(org.eclipse.xtext.crossrefs.lazy.parser.packrat.LazyLinkingTestLanguageDelimiters.keyword$8$Delimiter);
		getTypeConsumer().setRuleCall$4$Delimiter(org.eclipse.xtext.crossrefs.lazy.parser.packrat.LazyLinkingTestLanguageDelimiters.ruleCall$10$Delimiter);
		getTypeConsumer().setRuleCall$10$Delimiter(org.eclipse.xtext.crossrefs.lazy.parser.packrat.LazyLinkingTestLanguageDelimiters.ruleCall$10$Delimiter);
