...
public class LangAParseTreeConstructor extends AbstractParseTreeConstructor {
	...
	protected AbstractToken internalSerialize(EObject obj) {
		AbstractToken t = new Main_Group(null);
		t = t.createFirstSolution(getDescr(obj));
		if(t != null) return t;
		t = new Import_Group(null);
		t = t.createFirstSolution(getDescr(obj));
		if(t != null) return t;
		t = new Type_Group(null);
...
protected class Main_Group extends GroupToken {
	...
	public Main_Group(AbstractToken predecessor) {
		super(predecessor, !IS_MANY, IS_REQUIRED);
	}
	
	private Main_Group(AbstractToken predecessor, boolean many, boolean required) {
		super(predecessor, many, required);
	}
	
	protected AbstractToken newInstance(AbstractToken predecessor) {
		return new Main_Group(predecessor, true, false);
	}

		
	protected AbstractToken createOneChild(AbstractToken predecessor) {
		AbstractToken t1 = new Main_1_Assignment_types(predecessor);
		predecessor = t1.createFirstSolution(object);
		if(predecessor == null) return null;
		AbstractToken t0 = new Main_0_Assignment_imports(predecessor);
...
protected class Main_0_Assignment_imports extends AssignmentToken  {
	...
	public Main_0_Assignment_imports(AbstractToken predecessor) {
		super(predecessor, IS_MANY, !IS_REQUIRED);
	}
	
	private Main_0_Assignment_imports(AbstractToken predecessor, boolean many, boolean required) {
		super(predecessor, many, required);
	}
	
	protected AbstractToken newInstance(AbstractToken predecessor) {
		return new Main_0_Assignment_imports(predecessor, true, false);
	}
	...
	protected AbstractToken createOneChild(AbstractToken predecessor) {
		...
		AbstractToken t = new Import_Group(predecessor);
...
protected class Main_1_Assignment_types extends AssignmentToken  {
	...
	public Main_1_Assignment_types(AbstractToken predecessor) {
		super(predecessor, IS_MANY, !IS_REQUIRED);
	}
	
	private Main_1_Assignment_types(AbstractToken predecessor, boolean many, boolean required) {
		super(predecessor, many, required);
	}
	
	protected AbstractToken newInstance(AbstractToken predecessor) {
		return new Main_1_Assignment_types(predecessor, true, false);
	}
	...
	protected AbstractToken createOneChild(AbstractToken predecessor) {
		...
		AbstractToken t = new Type_Group(predecessor);
		predecessor = t.createFirstSolution(getDescr((EObject)value));
		if(predecessor == null) return null;
		object = (InstanceDescription)obj;
		return predecessor;
...
protected class Import_Group extends GroupToken {
	...
	public Import_Group(AbstractToken predecessor) {
		super(predecessor, !IS_MANY, IS_REQUIRED);
	}
	
	private Import_Group(AbstractToken predecessor, boolean many, boolean required) {
		super(predecessor, many, required);
	}
	
	protected AbstractToken newInstance(AbstractToken predecessor) {
		return new Import_Group(predecessor, true, false);
	}

		
	protected AbstractToken createOneChild(AbstractToken predecessor) {
		AbstractToken t1 = new Import_1_Assignment_uri(predecessor);
		predecessor = t1.createFirstSolution(object);
		if(predecessor == null) return null;
		AbstractToken t0 = new Import_0_Keyword_import(predecessor);
		predecessor = t0.createFirstSolution(t1.getObject());
		if(predecessor == null) return null;
		object = t0.getObject();
		return predecessor;
...
protected class Import_0_Keyword_import extends KeywordToken  {
	...
	public Import_0_Keyword_import(AbstractToken predecessor) {
		super(predecessor, !IS_MANY, IS_REQUIRED);
	}
...
protected class Import_1_Assignment_uri extends AssignmentToken  {
	...
	public Import_1_Assignment_uri(AbstractToken predecessor) {
		super(predecessor, !IS_MANY, IS_REQUIRED);
	}
	
	private Import_1_Assignment_uri(AbstractToken predecessor, boolean many, boolean required) {
		super(predecessor, many, required);
	}
	
	protected AbstractToken newInstance(AbstractToken predecessor) {
		return new Import_1_Assignment_uri(predecessor, true, false);
	}
...
protected class Type_Group extends GroupToken {
	...
	public Type_Group(AbstractToken predecessor) {
		super(predecessor, !IS_MANY, IS_REQUIRED);
	}
	
	private Type_Group(AbstractToken predecessor, boolean many, boolean required) {
		super(predecessor, many, required);
	}
	
	protected AbstractToken newInstance(AbstractToken predecessor) {
		return new Type_Group(predecessor, true, false);
	}

		
	protected AbstractToken createOneChild(AbstractToken predecessor) {
		AbstractToken t1 = new Type_1_Assignment_extends(predecessor);
		predecessor = t1.createFirstSolution(object);
		if(predecessor == null) return null;
		AbstractToken t0 = new Type_0_Group(predecessor);
		predecessor = t0.createFirstSolution(t1.getObject());
		if(predecessor == null) return null;
		object = t0.getObject();
		return predecessor;
...
protected class Type_0_Group extends GroupToken {
	...
	protected AbstractToken createOneChild(AbstractToken predecessor) {
		AbstractToken t1 = new Type_0_1_Keyword_extends(predecessor);
		predecessor = t1.createFirstSolution(object);
		if(predecessor == null) return null;
...
protected class Type_0_0_Group extends GroupToken {
	...
	protected AbstractToken createOneChild(AbstractToken predecessor) {
		AbstractToken t1 = new Type_0_0_1_Assignment_name(predecessor);
		predecessor = t1.createFirstSolution(object);
		if(predecessor == null) return null;
		AbstractToken t0 = new Type_0_0_0_Keyword_type(predecessor);
		predecessor = t0.createFirstSolution(t1.getObject());
		if(predecessor == null) return null;
		object = t0.getObject();
		return predecessor;
...
protected class Type_0_0_0_Keyword_type extends KeywordToken  {
	...
	public Type_0_0_0_Keyword_type(AbstractToken predecessor) {
		super(predecessor, !IS_MANY, IS_REQUIRED);
	}
...
protected class Type_0_0_1_Assignment_name extends AssignmentToken  {
	...
	public Type_0_0_1_Assignment_name(AbstractToken predecessor) {
		super(predecessor, !IS_MANY, IS_REQUIRED);
	}
	
	private Type_0_0_1_Assignment_name(AbstractToken predecessor, boolean many, boolean required) {
		super(predecessor, many, required);
	}
	
	protected AbstractToken newInstance(AbstractToken predecessor) {
		return new Type_0_0_1_Assignment_name(predecessor, true, false);
	}
...
protected class Type_0_1_Keyword_extends extends KeywordToken  {
	...
	public Type_0_1_Keyword_extends(AbstractToken predecessor) {
		super(predecessor, !IS_MANY, IS_REQUIRED);
	}
...
protected class Type_1_Assignment_extends extends AssignmentToken  {
	...
	public Type_1_Assignment_extends(AbstractToken predecessor) {
		super(predecessor, !IS_MANY, IS_REQUIRED);
	}
	
	private Type_1_Assignment_extends(AbstractToken predecessor, boolean many, boolean required) {
		super(predecessor, many, required);
	}
	
	protected AbstractToken newInstance(AbstractToken predecessor) {
		return new Type_1_Assignment_extends(predecessor, true, false);
	}
