...
import org.eclipse.xtext.reference.services.*;
...
public abstract class ReferenceGrammarStandaloneSetup {
	...
	public synchronized static void doSetup() {
		if(!isInitialized) {
			...
			ServiceRegistry.registerService(languageDescriptor, new org.eclipse.xtext.reference.parser.ReferenceGrammarParser(), org.eclipse.xtext.parser.IParser.class);
			...
			ServiceRegistry.registerService(languageDescriptor, new org.eclipse.xtext.reference.services.ReferenceGrammarResourceFactory(), org.eclipse.xtext.resource.IResourceFactory.class);
