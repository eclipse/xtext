...
public class MultiValueFeatureTestLanguageMetamodelAccess extends BaseEPackageAccess implements IMetamodelAccess {
	...
	public static void init() {
		if (!EPackage.Registry.INSTANCE.containsKey(MULTIVALUEFEATURETESTLANGUAGE_NS_URI))
			EPackage.Registry.INSTANCE.put(MULTIVALUEFEATURETESTLANGUAGE_NS_URI, loadEcoreFile(MultiValueFeatureTestLanguageMetamodelAccess.class.getClassLoader(), "classpath:/org/eclipse/xtext/resource/metamodel/MultiValueFeatureTestLanguage.ecore"));
	}
