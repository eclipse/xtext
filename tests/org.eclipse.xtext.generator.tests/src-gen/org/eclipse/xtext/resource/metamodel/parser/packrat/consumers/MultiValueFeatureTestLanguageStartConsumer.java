...
public final class MultiValueFeatureTestLanguageStartConsumer extends NonTerminalConsumer {
	...
	protected class RuleCall$2$Consumer extends ElementConsumer<RuleCall> {
		...
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(idConsumer, "featureA", true, false, getElement(), getRuleCall$2$Delimiter(), optional);
		}
	}
	...
	public void setRule(StartElements rule) {
		...
		assignment$1$Consumer = new Assignment$1$Consumer(rule.getFeatureAAssignment());
		ruleCall$2$Consumer = new RuleCall$2$Consumer(rule.getFeatureAIDTerminalRuleCall_0());
	}
