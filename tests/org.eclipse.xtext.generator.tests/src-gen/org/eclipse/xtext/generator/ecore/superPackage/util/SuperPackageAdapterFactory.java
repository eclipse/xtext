...
public class SuperPackageAdapterFactory extends AdapterFactoryImpl
{
   ...
   * @generated
   */
  protected SuperPackageSwitch<Adapter> modelSwitch =
    new SuperPackageSwitch<Adapter>()
    {
      @Override
      public Adapter caseSuperMain(SuperMain object)
      {
        return createSuperMainAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.eclipse.xtext.generator.ecore.superPackage.SuperMain <em>Super Main</em>}'.
   * <!-- begin-user-doc -->
