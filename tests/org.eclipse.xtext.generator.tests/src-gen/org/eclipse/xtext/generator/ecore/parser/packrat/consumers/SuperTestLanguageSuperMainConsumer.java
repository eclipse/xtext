...
import org.eclipse.xtext.generator.ecore.services.SuperTestLanguageGrammarAccess.SuperMainElements;

public final class SuperTestLanguageSuperMainConsumer extends NonTerminalConsumer {

	private SuperMainElements rule;	
	...
	public SuperTestLanguageSuperMainConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public SuperMainElements getRule() {
		return rule;
	}
	
	public void setRule(SuperMainElements rule) {
		this.rule = rule;
		
		group$1$Consumer = new Group$1$Consumer(rule.getGroup());
		keyword$2$Consumer = new Keyword$2$Consumer(rule.getSuperKeyword_0());
