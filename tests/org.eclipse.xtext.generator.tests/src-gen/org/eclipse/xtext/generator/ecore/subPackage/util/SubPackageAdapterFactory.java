...
public class SubPackageAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected SubPackageSwitch<Adapter> modelSwitch =
    ...
    {
      @Override
      public Adapter caseSubMain(SubMain object)
      {
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.eclipse.xtext.generator.ecore.subPackage.SubMain <em>Sub Main</em>}'.
   * <!-- begin-user-doc -->
