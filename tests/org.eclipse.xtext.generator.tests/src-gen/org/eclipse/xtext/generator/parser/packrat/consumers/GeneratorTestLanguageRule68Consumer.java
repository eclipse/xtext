...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule68Elements;

public final class GeneratorTestLanguageRule68Consumer extends NonTerminalConsumer {

	private Rule68Elements rule;	
	...
	public GeneratorTestLanguageRule68Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule68Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule68Elements rule) {
		this.rule = rule;
