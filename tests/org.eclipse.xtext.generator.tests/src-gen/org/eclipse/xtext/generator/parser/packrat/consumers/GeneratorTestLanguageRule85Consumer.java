...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule85Elements;

public final class GeneratorTestLanguageRule85Consumer extends NonTerminalConsumer {

	private Rule85Elements rule;	
	...
	public GeneratorTestLanguageRule85Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule85Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule85Elements rule) {
		this.rule = rule;
