...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule232Elements;

public final class GeneratorTestLanguageRule232Consumer extends NonTerminalConsumer {

	private Rule232Elements rule;	
	...
	public GeneratorTestLanguageRule232Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule232Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule232Elements rule) {
		this.rule = rule;
