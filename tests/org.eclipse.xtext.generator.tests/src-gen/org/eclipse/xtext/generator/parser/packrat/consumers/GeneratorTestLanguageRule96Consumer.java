...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule96Elements;

public final class GeneratorTestLanguageRule96Consumer extends NonTerminalConsumer {

	private Rule96Elements rule;	
	...
	public GeneratorTestLanguageRule96Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule96Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule96Elements rule) {
		this.rule = rule;
