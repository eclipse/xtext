...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule53Elements;

public final class GeneratorTestLanguageRule53Consumer extends NonTerminalConsumer {

	private Rule53Elements rule;	
	...
	public GeneratorTestLanguageRule53Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule53Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule53Elements rule) {
		this.rule = rule;
