...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule226Elements;

public final class GeneratorTestLanguageRule226Consumer extends NonTerminalConsumer {

	private Rule226Elements rule;	
	...
	public GeneratorTestLanguageRule226Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule226Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule226Elements rule) {
		this.rule = rule;
