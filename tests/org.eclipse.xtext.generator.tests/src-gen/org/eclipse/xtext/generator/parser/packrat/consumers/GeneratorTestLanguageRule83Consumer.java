...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule83Elements;

public final class GeneratorTestLanguageRule83Consumer extends NonTerminalConsumer {

	private Rule83Elements rule;	
	...
	public GeneratorTestLanguageRule83Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule83Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule83Elements rule) {
		this.rule = rule;
