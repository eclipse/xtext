...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule50Elements;

public final class GeneratorTestLanguageRule50Consumer extends NonTerminalConsumer {

	private Rule50Elements rule;	
	...
	public GeneratorTestLanguageRule50Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule50Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule50Elements rule) {
		this.rule = rule;
