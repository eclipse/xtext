...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule239Elements;

public final class GeneratorTestLanguageRule239Consumer extends NonTerminalConsumer {

	private Rule239Elements rule;	
	...
	public GeneratorTestLanguageRule239Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule239Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule239Elements rule) {
		this.rule = rule;
