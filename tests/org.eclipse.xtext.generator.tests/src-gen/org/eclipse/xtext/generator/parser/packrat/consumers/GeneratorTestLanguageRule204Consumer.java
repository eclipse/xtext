...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule204Elements;

public final class GeneratorTestLanguageRule204Consumer extends NonTerminalConsumer {

	private Rule204Elements rule;	
	...
	public GeneratorTestLanguageRule204Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule204Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule204Elements rule) {
		this.rule = rule;
