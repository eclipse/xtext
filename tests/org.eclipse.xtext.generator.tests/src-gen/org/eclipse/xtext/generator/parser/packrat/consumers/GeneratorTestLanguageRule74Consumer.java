...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule74Elements;

public final class GeneratorTestLanguageRule74Consumer extends NonTerminalConsumer {

	private Rule74Elements rule;	
	...
	public GeneratorTestLanguageRule74Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule74Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule74Elements rule) {
		this.rule = rule;
