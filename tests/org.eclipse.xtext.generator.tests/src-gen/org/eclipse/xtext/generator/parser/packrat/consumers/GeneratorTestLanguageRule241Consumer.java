...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule241Elements;

public final class GeneratorTestLanguageRule241Consumer extends NonTerminalConsumer {

	private Rule241Elements rule;	
	...
	public GeneratorTestLanguageRule241Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule241Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule241Elements rule) {
		this.rule = rule;
