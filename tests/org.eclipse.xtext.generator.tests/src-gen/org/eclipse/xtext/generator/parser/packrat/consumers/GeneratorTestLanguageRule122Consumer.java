...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule122Elements;

public final class GeneratorTestLanguageRule122Consumer extends NonTerminalConsumer {

	private Rule122Elements rule;	
	...
	public GeneratorTestLanguageRule122Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule122Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule122Elements rule) {
		this.rule = rule;
