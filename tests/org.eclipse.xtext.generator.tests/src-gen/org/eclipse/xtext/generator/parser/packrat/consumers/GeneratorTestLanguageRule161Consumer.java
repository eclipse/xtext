...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule161Elements;

public final class GeneratorTestLanguageRule161Consumer extends NonTerminalConsumer {

	private Rule161Elements rule;	
	...
	public GeneratorTestLanguageRule161Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule161Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule161Elements rule) {
		this.rule = rule;
