...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule2Elements;

public final class GeneratorTestLanguageRule2Consumer extends NonTerminalConsumer {

	private Rule2Elements rule;	
	...
	public GeneratorTestLanguageRule2Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule2Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule2Elements rule) {
		this.rule = rule;
