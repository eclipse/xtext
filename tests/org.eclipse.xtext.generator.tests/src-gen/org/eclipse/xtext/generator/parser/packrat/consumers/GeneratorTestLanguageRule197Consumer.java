...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule197Elements;

public final class GeneratorTestLanguageRule197Consumer extends NonTerminalConsumer {

	private Rule197Elements rule;	
	...
	public GeneratorTestLanguageRule197Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule197Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule197Elements rule) {
		this.rule = rule;
