...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule6Elements;

public final class GeneratorTestLanguageRule6Consumer extends NonTerminalConsumer {

	private Rule6Elements rule;	
	...
	public GeneratorTestLanguageRule6Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule6Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule6Elements rule) {
		this.rule = rule;
