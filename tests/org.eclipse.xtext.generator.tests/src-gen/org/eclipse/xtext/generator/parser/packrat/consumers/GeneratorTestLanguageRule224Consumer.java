...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule224Elements;

public final class GeneratorTestLanguageRule224Consumer extends NonTerminalConsumer {

	private Rule224Elements rule;	
	...
	public GeneratorTestLanguageRule224Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule224Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule224Elements rule) {
		this.rule = rule;
