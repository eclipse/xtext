...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule240Elements;

public final class GeneratorTestLanguageRule240Consumer extends NonTerminalConsumer {

	private Rule240Elements rule;	
	...
	public GeneratorTestLanguageRule240Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule240Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule240Elements rule) {
		this.rule = rule;
