...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule48Elements;

public final class GeneratorTestLanguageRule48Consumer extends NonTerminalConsumer {

	private Rule48Elements rule;	
	...
	public GeneratorTestLanguageRule48Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule48Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule48Elements rule) {
		this.rule = rule;
