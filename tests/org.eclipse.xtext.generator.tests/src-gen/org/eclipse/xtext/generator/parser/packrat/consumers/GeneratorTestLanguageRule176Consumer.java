...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule176Elements;

public final class GeneratorTestLanguageRule176Consumer extends NonTerminalConsumer {

	private Rule176Elements rule;	
	...
	public GeneratorTestLanguageRule176Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule176Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule176Elements rule) {
		this.rule = rule;
