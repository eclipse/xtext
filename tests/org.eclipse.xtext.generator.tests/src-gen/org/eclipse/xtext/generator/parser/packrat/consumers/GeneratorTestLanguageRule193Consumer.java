...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule193Elements;

public final class GeneratorTestLanguageRule193Consumer extends NonTerminalConsumer {

	private Rule193Elements rule;	
	...
	public GeneratorTestLanguageRule193Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule193Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule193Elements rule) {
		this.rule = rule;
