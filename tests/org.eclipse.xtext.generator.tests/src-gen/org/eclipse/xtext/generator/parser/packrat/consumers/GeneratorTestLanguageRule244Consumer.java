...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule244Elements;

public final class GeneratorTestLanguageRule244Consumer extends NonTerminalConsumer {

	private Rule244Elements rule;	
	...
	public GeneratorTestLanguageRule244Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule244Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule244Elements rule) {
		this.rule = rule;
