...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule65Elements;

public final class GeneratorTestLanguageRule65Consumer extends NonTerminalConsumer {

	private Rule65Elements rule;	
	...
	public GeneratorTestLanguageRule65Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule65Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule65Elements rule) {
		this.rule = rule;
