...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule191Elements;

public final class GeneratorTestLanguageRule191Consumer extends NonTerminalConsumer {

	private Rule191Elements rule;	
	...
	public GeneratorTestLanguageRule191Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule191Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule191Elements rule) {
		this.rule = rule;
