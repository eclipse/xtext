...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule124Elements;

public final class GeneratorTestLanguageRule124Consumer extends NonTerminalConsumer {

	private Rule124Elements rule;	
	...
	public GeneratorTestLanguageRule124Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule124Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule124Elements rule) {
		this.rule = rule;
