...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule8Elements;

public final class GeneratorTestLanguageRule8Consumer extends NonTerminalConsumer {

	private Rule8Elements rule;	
	...
	public GeneratorTestLanguageRule8Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule8Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule8Elements rule) {
		this.rule = rule;
