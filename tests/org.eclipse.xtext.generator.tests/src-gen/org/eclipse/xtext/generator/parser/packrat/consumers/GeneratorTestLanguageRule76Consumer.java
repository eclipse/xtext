...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule76Elements;

public final class GeneratorTestLanguageRule76Consumer extends NonTerminalConsumer {

	private Rule76Elements rule;	
	...
	public GeneratorTestLanguageRule76Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule76Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule76Elements rule) {
		this.rule = rule;
