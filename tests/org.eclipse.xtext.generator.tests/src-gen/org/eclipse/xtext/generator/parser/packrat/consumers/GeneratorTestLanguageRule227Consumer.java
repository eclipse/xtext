...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule227Elements;

public final class GeneratorTestLanguageRule227Consumer extends NonTerminalConsumer {

	private Rule227Elements rule;	
	...
	public GeneratorTestLanguageRule227Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule227Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule227Elements rule) {
		this.rule = rule;
