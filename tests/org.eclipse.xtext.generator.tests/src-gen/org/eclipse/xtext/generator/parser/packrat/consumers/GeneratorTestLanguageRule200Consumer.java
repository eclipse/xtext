...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule200Elements;

public final class GeneratorTestLanguageRule200Consumer extends NonTerminalConsumer {

	private Rule200Elements rule;	
	...
	public GeneratorTestLanguageRule200Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule200Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule200Elements rule) {
		this.rule = rule;
