...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule87Elements;

public final class GeneratorTestLanguageRule87Consumer extends NonTerminalConsumer {

	private Rule87Elements rule;	
	...
	public GeneratorTestLanguageRule87Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule87Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule87Elements rule) {
		this.rule = rule;
