...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule21Elements;

public final class GeneratorTestLanguageRule21Consumer extends NonTerminalConsumer {

	private Rule21Elements rule;	
	...
	public GeneratorTestLanguageRule21Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule21Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule21Elements rule) {
		this.rule = rule;
