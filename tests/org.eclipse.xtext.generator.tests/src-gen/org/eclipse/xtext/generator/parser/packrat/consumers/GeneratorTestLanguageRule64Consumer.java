...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule64Elements;

public final class GeneratorTestLanguageRule64Consumer extends NonTerminalConsumer {

	private Rule64Elements rule;	
	...
	public GeneratorTestLanguageRule64Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule64Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule64Elements rule) {
		this.rule = rule;
