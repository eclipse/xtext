...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule43Elements;

public final class GeneratorTestLanguageRule43Consumer extends NonTerminalConsumer {

	private Rule43Elements rule;	
	...
	public GeneratorTestLanguageRule43Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule43Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule43Elements rule) {
		this.rule = rule;
