...
public final class GeneratorTestLanguageRule40Consumer extends NonTerminalConsumer {

	private Rule40Elements rule;	
	...
	public GeneratorTestLanguageRule40Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule40Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule40Elements rule) {
		this.rule = rule;
