...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule127Elements;

public final class GeneratorTestLanguageRule127Consumer extends NonTerminalConsumer {

	private Rule127Elements rule;	
	...
	public GeneratorTestLanguageRule127Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule127Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule127Elements rule) {
		this.rule = rule;
