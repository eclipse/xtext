...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule212Elements;

public final class GeneratorTestLanguageRule212Consumer extends NonTerminalConsumer {

	private Rule212Elements rule;	
	...
	public GeneratorTestLanguageRule212Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule212Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule212Elements rule) {
		this.rule = rule;
