...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule104Elements;

public final class GeneratorTestLanguageRule104Consumer extends NonTerminalConsumer {

	private Rule104Elements rule;	
	...
	public GeneratorTestLanguageRule104Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule104Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule104Elements rule) {
		this.rule = rule;
