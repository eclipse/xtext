...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule118Elements;

public final class GeneratorTestLanguageRule118Consumer extends NonTerminalConsumer {

	private Rule118Elements rule;	
	...
	public GeneratorTestLanguageRule118Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule118Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule118Elements rule) {
		this.rule = rule;
