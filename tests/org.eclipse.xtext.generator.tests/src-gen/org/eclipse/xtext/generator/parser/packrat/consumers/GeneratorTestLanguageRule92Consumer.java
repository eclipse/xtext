...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule92Elements;

public final class GeneratorTestLanguageRule92Consumer extends NonTerminalConsumer {

	private Rule92Elements rule;	
	...
	public GeneratorTestLanguageRule92Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule92Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule92Elements rule) {
		this.rule = rule;
