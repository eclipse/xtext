...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule90Elements;

public final class GeneratorTestLanguageRule90Consumer extends NonTerminalConsumer {

	private Rule90Elements rule;	
	...
	public GeneratorTestLanguageRule90Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule90Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule90Elements rule) {
		this.rule = rule;
