...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule17Elements;

public final class GeneratorTestLanguageRule17Consumer extends NonTerminalConsumer {

	private Rule17Elements rule;	
	...
	public GeneratorTestLanguageRule17Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule17Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule17Elements rule) {
		this.rule = rule;
