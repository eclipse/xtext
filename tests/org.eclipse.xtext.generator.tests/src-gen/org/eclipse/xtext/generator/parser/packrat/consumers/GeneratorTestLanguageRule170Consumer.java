...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule170Elements;

public final class GeneratorTestLanguageRule170Consumer extends NonTerminalConsumer {

	private Rule170Elements rule;	
	...
	public GeneratorTestLanguageRule170Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule170Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule170Elements rule) {
		this.rule = rule;
