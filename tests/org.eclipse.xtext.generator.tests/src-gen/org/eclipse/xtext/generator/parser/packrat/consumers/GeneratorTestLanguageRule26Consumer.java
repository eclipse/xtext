...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule26Elements;

public final class GeneratorTestLanguageRule26Consumer extends NonTerminalConsumer {

	private Rule26Elements rule;	
	...
	public GeneratorTestLanguageRule26Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule26Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule26Elements rule) {
		this.rule = rule;
