...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule69Elements;

public final class GeneratorTestLanguageRule69Consumer extends NonTerminalConsumer {

	private Rule69Elements rule;	
	...
	public GeneratorTestLanguageRule69Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule69Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule69Elements rule) {
		this.rule = rule;
