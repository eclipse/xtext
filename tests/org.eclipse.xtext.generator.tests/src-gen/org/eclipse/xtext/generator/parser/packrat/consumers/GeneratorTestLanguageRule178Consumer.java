...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule178Elements;

public final class GeneratorTestLanguageRule178Consumer extends NonTerminalConsumer {

	private Rule178Elements rule;	
	...
	public GeneratorTestLanguageRule178Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule178Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule178Elements rule) {
		this.rule = rule;
