...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule120Elements;

public final class GeneratorTestLanguageRule120Consumer extends NonTerminalConsumer {

	private Rule120Elements rule;	
	...
	public GeneratorTestLanguageRule120Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule120Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule120Elements rule) {
		this.rule = rule;
