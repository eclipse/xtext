...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule52Elements;

public final class GeneratorTestLanguageRule52Consumer extends NonTerminalConsumer {

	private Rule52Elements rule;	
	...
	public GeneratorTestLanguageRule52Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule52Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule52Elements rule) {
		this.rule = rule;
