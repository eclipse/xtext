...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule220Elements;

public final class GeneratorTestLanguageRule220Consumer extends NonTerminalConsumer {

	private Rule220Elements rule;	
	...
	public GeneratorTestLanguageRule220Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule220Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule220Elements rule) {
		this.rule = rule;
