...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule58Elements;

public final class GeneratorTestLanguageRule58Consumer extends NonTerminalConsumer {

	private Rule58Elements rule;	
	...
	public GeneratorTestLanguageRule58Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule58Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule58Elements rule) {
		this.rule = rule;
