...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule203Elements;

public final class GeneratorTestLanguageRule203Consumer extends NonTerminalConsumer {

	private Rule203Elements rule;	
	...
	public GeneratorTestLanguageRule203Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule203Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule203Elements rule) {
		this.rule = rule;
