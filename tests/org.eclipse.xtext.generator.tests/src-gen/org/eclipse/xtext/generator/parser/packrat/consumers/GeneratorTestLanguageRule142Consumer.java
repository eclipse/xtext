...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule142Elements;

public final class GeneratorTestLanguageRule142Consumer extends NonTerminalConsumer {

	private Rule142Elements rule;	
	...
	public GeneratorTestLanguageRule142Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule142Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule142Elements rule) {
		this.rule = rule;
