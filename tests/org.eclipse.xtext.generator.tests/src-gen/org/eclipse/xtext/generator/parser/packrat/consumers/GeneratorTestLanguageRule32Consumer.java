...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule32Elements;

public final class GeneratorTestLanguageRule32Consumer extends NonTerminalConsumer {

	private Rule32Elements rule;	
	...
	public GeneratorTestLanguageRule32Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule32Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule32Elements rule) {
		this.rule = rule;
