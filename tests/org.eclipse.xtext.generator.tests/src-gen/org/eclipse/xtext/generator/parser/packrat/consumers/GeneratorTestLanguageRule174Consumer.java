...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule174Elements;

public final class GeneratorTestLanguageRule174Consumer extends NonTerminalConsumer {

	private Rule174Elements rule;	
	...
	public GeneratorTestLanguageRule174Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule174Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule174Elements rule) {
		this.rule = rule;
