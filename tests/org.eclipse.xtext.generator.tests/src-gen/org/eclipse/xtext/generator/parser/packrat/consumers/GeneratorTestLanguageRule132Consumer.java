...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule132Elements;

public final class GeneratorTestLanguageRule132Consumer extends NonTerminalConsumer {

	private Rule132Elements rule;	
	...
	public GeneratorTestLanguageRule132Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule132Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule132Elements rule) {
		this.rule = rule;
