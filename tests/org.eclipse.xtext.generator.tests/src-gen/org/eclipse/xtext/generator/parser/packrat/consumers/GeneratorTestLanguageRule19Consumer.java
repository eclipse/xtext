...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule19Elements;

public final class GeneratorTestLanguageRule19Consumer extends NonTerminalConsumer {

	private Rule19Elements rule;	
	...
	public GeneratorTestLanguageRule19Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule19Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule19Elements rule) {
		this.rule = rule;
