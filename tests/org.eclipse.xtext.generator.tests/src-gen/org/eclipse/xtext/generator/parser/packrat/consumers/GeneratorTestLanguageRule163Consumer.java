...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule163Elements;

public final class GeneratorTestLanguageRule163Consumer extends NonTerminalConsumer {

	private Rule163Elements rule;	
	...
	public GeneratorTestLanguageRule163Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule163Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule163Elements rule) {
		this.rule = rule;
