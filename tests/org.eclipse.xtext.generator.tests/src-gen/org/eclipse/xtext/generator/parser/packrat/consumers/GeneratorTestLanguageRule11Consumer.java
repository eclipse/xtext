...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule11Elements;

public final class GeneratorTestLanguageRule11Consumer extends NonTerminalConsumer {

	private Rule11Elements rule;	
	...
	public GeneratorTestLanguageRule11Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule11Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule11Elements rule) {
		this.rule = rule;
