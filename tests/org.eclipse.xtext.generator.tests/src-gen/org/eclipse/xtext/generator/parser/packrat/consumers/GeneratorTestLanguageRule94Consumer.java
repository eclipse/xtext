...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule94Elements;

public final class GeneratorTestLanguageRule94Consumer extends NonTerminalConsumer {

	private Rule94Elements rule;	
	...
	public GeneratorTestLanguageRule94Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule94Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule94Elements rule) {
		this.rule = rule;
