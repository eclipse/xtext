...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule55Elements;

public final class GeneratorTestLanguageRule55Consumer extends NonTerminalConsumer {

	private Rule55Elements rule;	
	...
	public GeneratorTestLanguageRule55Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule55Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule55Elements rule) {
		this.rule = rule;
