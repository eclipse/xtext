...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule46Elements;

public final class GeneratorTestLanguageRule46Consumer extends NonTerminalConsumer {

	private Rule46Elements rule;	
	...
	public GeneratorTestLanguageRule46Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule46Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule46Elements rule) {
		this.rule = rule;
