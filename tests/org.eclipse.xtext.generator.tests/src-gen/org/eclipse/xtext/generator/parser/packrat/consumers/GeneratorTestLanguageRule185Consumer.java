...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule185Elements;

public final class GeneratorTestLanguageRule185Consumer extends NonTerminalConsumer {

	private Rule185Elements rule;	
	...
	public GeneratorTestLanguageRule185Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule185Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule185Elements rule) {
		this.rule = rule;
