...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule134Elements;

public final class GeneratorTestLanguageRule134Consumer extends NonTerminalConsumer {

	private Rule134Elements rule;	
	...
	public GeneratorTestLanguageRule134Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule134Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule134Elements rule) {
		this.rule = rule;
