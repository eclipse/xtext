...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule217Elements;

public final class GeneratorTestLanguageRule217Consumer extends NonTerminalConsumer {

	private Rule217Elements rule;	
	...
	public GeneratorTestLanguageRule217Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule217Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule217Elements rule) {
		this.rule = rule;
