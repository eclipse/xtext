...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule86Elements;

public final class GeneratorTestLanguageRule86Consumer extends NonTerminalConsumer {

	private Rule86Elements rule;	
	...
	public GeneratorTestLanguageRule86Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule86Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule86Elements rule) {
		this.rule = rule;
