...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule80Elements;

public final class GeneratorTestLanguageRule80Consumer extends NonTerminalConsumer {

	private Rule80Elements rule;	
	...
	public GeneratorTestLanguageRule80Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule80Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule80Elements rule) {
		this.rule = rule;
