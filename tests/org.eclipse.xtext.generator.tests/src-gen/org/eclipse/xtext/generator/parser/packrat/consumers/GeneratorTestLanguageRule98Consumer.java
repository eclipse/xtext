...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule98Elements;

public final class GeneratorTestLanguageRule98Consumer extends NonTerminalConsumer {

	private Rule98Elements rule;	
	...
	public GeneratorTestLanguageRule98Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule98Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule98Elements rule) {
		this.rule = rule;
