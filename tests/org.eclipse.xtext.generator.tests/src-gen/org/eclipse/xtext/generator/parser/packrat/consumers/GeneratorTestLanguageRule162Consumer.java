...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule162Elements;

public final class GeneratorTestLanguageRule162Consumer extends NonTerminalConsumer {

	private Rule162Elements rule;	
	...
	public GeneratorTestLanguageRule162Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule162Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule162Elements rule) {
		this.rule = rule;
