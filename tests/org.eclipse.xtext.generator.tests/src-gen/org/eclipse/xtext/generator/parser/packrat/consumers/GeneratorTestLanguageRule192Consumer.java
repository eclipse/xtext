...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule192Elements;

public final class GeneratorTestLanguageRule192Consumer extends NonTerminalConsumer {

	private Rule192Elements rule;	
	...
	public GeneratorTestLanguageRule192Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule192Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule192Elements rule) {
		this.rule = rule;
