...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule210Elements;

public final class GeneratorTestLanguageRule210Consumer extends NonTerminalConsumer {

	private Rule210Elements rule;	
	...
	public GeneratorTestLanguageRule210Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule210Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule210Elements rule) {
		this.rule = rule;
