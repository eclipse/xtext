...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule130Elements;

public final class GeneratorTestLanguageRule130Consumer extends NonTerminalConsumer {

	private Rule130Elements rule;	
	...
	public GeneratorTestLanguageRule130Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule130Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule130Elements rule) {
		this.rule = rule;
