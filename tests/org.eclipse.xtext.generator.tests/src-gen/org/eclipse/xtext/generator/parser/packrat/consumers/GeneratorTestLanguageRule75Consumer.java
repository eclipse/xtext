...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule75Elements;

public final class GeneratorTestLanguageRule75Consumer extends NonTerminalConsumer {

	private Rule75Elements rule;	
	...
	public GeneratorTestLanguageRule75Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule75Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule75Elements rule) {
		this.rule = rule;
