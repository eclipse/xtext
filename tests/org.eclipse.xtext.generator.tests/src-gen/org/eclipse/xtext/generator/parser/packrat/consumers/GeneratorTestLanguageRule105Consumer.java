...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule105Elements;

public final class GeneratorTestLanguageRule105Consumer extends NonTerminalConsumer {

	private Rule105Elements rule;	
	...
	public GeneratorTestLanguageRule105Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule105Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule105Elements rule) {
		this.rule = rule;
