...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule3Elements;

public final class GeneratorTestLanguageRule3Consumer extends NonTerminalConsumer {

	private Rule3Elements rule;	
	...
	public GeneratorTestLanguageRule3Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule3Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule3Elements rule) {
		this.rule = rule;
