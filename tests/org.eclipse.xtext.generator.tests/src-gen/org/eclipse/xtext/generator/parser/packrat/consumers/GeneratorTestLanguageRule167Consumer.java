...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule167Elements;

public final class GeneratorTestLanguageRule167Consumer extends NonTerminalConsumer {

	private Rule167Elements rule;	
	...
	public GeneratorTestLanguageRule167Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule167Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule167Elements rule) {
		this.rule = rule;
