...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule84Elements;

public final class GeneratorTestLanguageRule84Consumer extends NonTerminalConsumer {

	private Rule84Elements rule;	
	...
	public GeneratorTestLanguageRule84Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule84Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule84Elements rule) {
		this.rule = rule;
