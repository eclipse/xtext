...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule183Elements;

public final class GeneratorTestLanguageRule183Consumer extends NonTerminalConsumer {

	private Rule183Elements rule;	
	...
	public GeneratorTestLanguageRule183Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule183Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule183Elements rule) {
		this.rule = rule;
