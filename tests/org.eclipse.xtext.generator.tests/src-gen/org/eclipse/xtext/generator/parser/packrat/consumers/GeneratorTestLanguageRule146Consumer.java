...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule146Elements;

public final class GeneratorTestLanguageRule146Consumer extends NonTerminalConsumer {

	private Rule146Elements rule;	
	...
	public GeneratorTestLanguageRule146Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule146Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule146Elements rule) {
		this.rule = rule;
