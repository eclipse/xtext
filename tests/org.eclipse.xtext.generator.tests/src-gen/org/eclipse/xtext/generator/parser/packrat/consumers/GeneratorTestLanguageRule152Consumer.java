...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule152Elements;

public final class GeneratorTestLanguageRule152Consumer extends NonTerminalConsumer {

	private Rule152Elements rule;	
	...
	public GeneratorTestLanguageRule152Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule152Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule152Elements rule) {
		this.rule = rule;
