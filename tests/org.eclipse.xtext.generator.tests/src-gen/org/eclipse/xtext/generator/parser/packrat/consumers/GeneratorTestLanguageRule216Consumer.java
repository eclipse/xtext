...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule216Elements;

public final class GeneratorTestLanguageRule216Consumer extends NonTerminalConsumer {

	private Rule216Elements rule;	
	...
	public GeneratorTestLanguageRule216Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule216Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule216Elements rule) {
		this.rule = rule;
