...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule157Elements;

public final class GeneratorTestLanguageRule157Consumer extends NonTerminalConsumer {

	private Rule157Elements rule;	
	...
	public GeneratorTestLanguageRule157Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule157Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule157Elements rule) {
		this.rule = rule;
