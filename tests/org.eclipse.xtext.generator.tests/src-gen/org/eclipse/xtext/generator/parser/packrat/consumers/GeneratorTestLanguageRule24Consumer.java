...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule24Elements;

public final class GeneratorTestLanguageRule24Consumer extends NonTerminalConsumer {

	private Rule24Elements rule;	
	...
	public GeneratorTestLanguageRule24Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule24Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule24Elements rule) {
		this.rule = rule;
