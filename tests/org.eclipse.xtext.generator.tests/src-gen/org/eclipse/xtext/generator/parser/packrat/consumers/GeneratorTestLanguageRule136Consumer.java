...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule136Elements;

public final class GeneratorTestLanguageRule136Consumer extends NonTerminalConsumer {

	private Rule136Elements rule;	
	...
	public GeneratorTestLanguageRule136Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule136Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule136Elements rule) {
		this.rule = rule;
