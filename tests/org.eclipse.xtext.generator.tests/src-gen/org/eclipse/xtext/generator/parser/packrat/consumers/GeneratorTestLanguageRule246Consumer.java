...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule246Elements;

public final class GeneratorTestLanguageRule246Consumer extends NonTerminalConsumer {

	private Rule246Elements rule;	
	...
	public GeneratorTestLanguageRule246Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule246Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule246Elements rule) {
		this.rule = rule;
