...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule15Elements;

public final class GeneratorTestLanguageRule15Consumer extends NonTerminalConsumer {

	private Rule15Elements rule;	
	...
	public GeneratorTestLanguageRule15Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule15Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule15Elements rule) {
		this.rule = rule;
