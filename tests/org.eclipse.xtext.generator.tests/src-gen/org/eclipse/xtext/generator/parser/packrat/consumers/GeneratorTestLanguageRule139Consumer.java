...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule139Elements;

public final class GeneratorTestLanguageRule139Consumer extends NonTerminalConsumer {

	private Rule139Elements rule;	
	...
	public GeneratorTestLanguageRule139Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule139Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule139Elements rule) {
		this.rule = rule;
