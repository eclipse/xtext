...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule235Elements;

public final class GeneratorTestLanguageRule235Consumer extends NonTerminalConsumer {

	private Rule235Elements rule;	
	...
	public GeneratorTestLanguageRule235Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule235Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule235Elements rule) {
		this.rule = rule;
