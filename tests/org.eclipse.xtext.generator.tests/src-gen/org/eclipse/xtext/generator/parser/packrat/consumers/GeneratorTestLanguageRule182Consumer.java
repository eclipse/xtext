...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule182Elements;

public final class GeneratorTestLanguageRule182Consumer extends NonTerminalConsumer {

	private Rule182Elements rule;	
	...
	public GeneratorTestLanguageRule182Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule182Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule182Elements rule) {
		this.rule = rule;
