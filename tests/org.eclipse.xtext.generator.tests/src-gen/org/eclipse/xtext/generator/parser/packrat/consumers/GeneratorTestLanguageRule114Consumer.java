...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule114Elements;

public final class GeneratorTestLanguageRule114Consumer extends NonTerminalConsumer {

	private Rule114Elements rule;	
	...
	public GeneratorTestLanguageRule114Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule114Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule114Elements rule) {
		this.rule = rule;
