...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule199Elements;

public final class GeneratorTestLanguageRule199Consumer extends NonTerminalConsumer {

	private Rule199Elements rule;	
	...
	public GeneratorTestLanguageRule199Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule199Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule199Elements rule) {
		this.rule = rule;
