...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule228Elements;

public final class GeneratorTestLanguageRule228Consumer extends NonTerminalConsumer {

	private Rule228Elements rule;	
	...
	public GeneratorTestLanguageRule228Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule228Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule228Elements rule) {
		this.rule = rule;
