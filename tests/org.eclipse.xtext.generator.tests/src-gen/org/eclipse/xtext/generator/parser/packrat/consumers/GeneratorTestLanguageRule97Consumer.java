...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule97Elements;

public final class GeneratorTestLanguageRule97Consumer extends NonTerminalConsumer {

	private Rule97Elements rule;	
	...
	public GeneratorTestLanguageRule97Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule97Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule97Elements rule) {
		this.rule = rule;
