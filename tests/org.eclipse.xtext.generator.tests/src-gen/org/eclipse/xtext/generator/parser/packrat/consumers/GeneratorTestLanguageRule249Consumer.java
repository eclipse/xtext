...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule249Elements;

public final class GeneratorTestLanguageRule249Consumer extends NonTerminalConsumer {

	private Rule249Elements rule;	
	...
	public GeneratorTestLanguageRule249Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule249Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule249Elements rule) {
		this.rule = rule;
