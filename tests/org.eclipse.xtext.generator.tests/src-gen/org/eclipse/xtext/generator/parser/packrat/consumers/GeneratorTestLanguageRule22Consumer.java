...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule22Elements;

public final class GeneratorTestLanguageRule22Consumer extends NonTerminalConsumer {

	private Rule22Elements rule;	
	...
	public GeneratorTestLanguageRule22Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule22Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule22Elements rule) {
		this.rule = rule;
