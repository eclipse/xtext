...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule156Elements;

public final class GeneratorTestLanguageRule156Consumer extends NonTerminalConsumer {

	private Rule156Elements rule;	
	...
	public GeneratorTestLanguageRule156Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule156Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule156Elements rule) {
		this.rule = rule;
