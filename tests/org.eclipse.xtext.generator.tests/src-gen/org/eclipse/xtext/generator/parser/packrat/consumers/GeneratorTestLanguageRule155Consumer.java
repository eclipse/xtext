...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule155Elements;

public final class GeneratorTestLanguageRule155Consumer extends NonTerminalConsumer {

	private Rule155Elements rule;	
	...
	public GeneratorTestLanguageRule155Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule155Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule155Elements rule) {
		this.rule = rule;
