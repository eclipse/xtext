...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule16Elements;

public final class GeneratorTestLanguageRule16Consumer extends NonTerminalConsumer {

	private Rule16Elements rule;	
	...
	public GeneratorTestLanguageRule16Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule16Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule16Elements rule) {
		this.rule = rule;
