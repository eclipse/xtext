...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule115Elements;

public final class GeneratorTestLanguageRule115Consumer extends NonTerminalConsumer {

	private Rule115Elements rule;	
	...
	public GeneratorTestLanguageRule115Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule115Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule115Elements rule) {
		this.rule = rule;
