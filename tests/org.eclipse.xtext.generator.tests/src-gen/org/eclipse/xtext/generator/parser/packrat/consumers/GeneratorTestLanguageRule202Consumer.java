...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule202Elements;

public final class GeneratorTestLanguageRule202Consumer extends NonTerminalConsumer {

	private Rule202Elements rule;	
	...
	public GeneratorTestLanguageRule202Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule202Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule202Elements rule) {
		this.rule = rule;
