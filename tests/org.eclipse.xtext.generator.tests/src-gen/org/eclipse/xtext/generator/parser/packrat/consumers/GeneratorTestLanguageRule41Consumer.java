...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule41Elements;

public final class GeneratorTestLanguageRule41Consumer extends NonTerminalConsumer {

	private Rule41Elements rule;	
	...
	public GeneratorTestLanguageRule41Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule41Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule41Elements rule) {
		this.rule = rule;
