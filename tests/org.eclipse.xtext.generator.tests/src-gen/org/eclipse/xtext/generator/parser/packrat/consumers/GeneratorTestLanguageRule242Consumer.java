...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule242Elements;

public final class GeneratorTestLanguageRule242Consumer extends NonTerminalConsumer {

	private Rule242Elements rule;	
	...
	public GeneratorTestLanguageRule242Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule242Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule242Elements rule) {
		this.rule = rule;
