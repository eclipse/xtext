...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule189Elements;

public final class GeneratorTestLanguageRule189Consumer extends NonTerminalConsumer {

	private Rule189Elements rule;	
	...
	public GeneratorTestLanguageRule189Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule189Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule189Elements rule) {
		this.rule = rule;
