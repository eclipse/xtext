...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule7Elements;

public final class GeneratorTestLanguageRule7Consumer extends NonTerminalConsumer {

	private Rule7Elements rule;	
	...
	public GeneratorTestLanguageRule7Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule7Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule7Elements rule) {
		this.rule = rule;
