...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule164Elements;

public final class GeneratorTestLanguageRule164Consumer extends NonTerminalConsumer {

	private Rule164Elements rule;	
	...
	public GeneratorTestLanguageRule164Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule164Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule164Elements rule) {
		this.rule = rule;
