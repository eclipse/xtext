...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule145Elements;

public final class GeneratorTestLanguageRule145Consumer extends NonTerminalConsumer {

	private Rule145Elements rule;	
	...
	public GeneratorTestLanguageRule145Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule145Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule145Elements rule) {
		this.rule = rule;
