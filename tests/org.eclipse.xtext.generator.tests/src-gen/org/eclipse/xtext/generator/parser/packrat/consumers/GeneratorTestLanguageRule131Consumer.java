...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule131Elements;

public final class GeneratorTestLanguageRule131Consumer extends NonTerminalConsumer {

	private Rule131Elements rule;	
	...
	public GeneratorTestLanguageRule131Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule131Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule131Elements rule) {
		this.rule = rule;
