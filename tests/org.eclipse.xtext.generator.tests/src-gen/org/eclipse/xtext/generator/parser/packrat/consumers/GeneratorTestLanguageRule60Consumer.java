...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule60Elements;

public final class GeneratorTestLanguageRule60Consumer extends NonTerminalConsumer {

	private Rule60Elements rule;	
	...
	public GeneratorTestLanguageRule60Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule60Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule60Elements rule) {
		this.rule = rule;
