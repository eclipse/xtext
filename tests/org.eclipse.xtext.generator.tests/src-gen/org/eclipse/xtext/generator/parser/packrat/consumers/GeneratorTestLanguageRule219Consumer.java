...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule219Elements;

public final class GeneratorTestLanguageRule219Consumer extends NonTerminalConsumer {

	private Rule219Elements rule;	
	...
	public GeneratorTestLanguageRule219Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule219Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule219Elements rule) {
		this.rule = rule;
