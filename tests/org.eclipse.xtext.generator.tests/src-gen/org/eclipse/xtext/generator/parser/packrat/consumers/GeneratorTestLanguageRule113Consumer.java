...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule113Elements;

public final class GeneratorTestLanguageRule113Consumer extends NonTerminalConsumer {

	private Rule113Elements rule;	
	...
	public GeneratorTestLanguageRule113Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule113Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule113Elements rule) {
		this.rule = rule;
