...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule129Elements;

public final class GeneratorTestLanguageRule129Consumer extends NonTerminalConsumer {

	private Rule129Elements rule;	
	...
	public GeneratorTestLanguageRule129Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule129Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule129Elements rule) {
		this.rule = rule;
