...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule151Elements;

public final class GeneratorTestLanguageRule151Consumer extends NonTerminalConsumer {

	private Rule151Elements rule;	
	...
	public GeneratorTestLanguageRule151Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule151Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule151Elements rule) {
		this.rule = rule;
