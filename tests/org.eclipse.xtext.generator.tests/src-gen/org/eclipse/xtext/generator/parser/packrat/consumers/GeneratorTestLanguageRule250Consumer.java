...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule250Elements;

public final class GeneratorTestLanguageRule250Consumer extends NonTerminalConsumer {

	private Rule250Elements rule;	
	...
	public GeneratorTestLanguageRule250Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule250Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule250Elements rule) {
		this.rule = rule;
