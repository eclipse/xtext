...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule103Elements;

public final class GeneratorTestLanguageRule103Consumer extends NonTerminalConsumer {

	private Rule103Elements rule;	
	...
	public GeneratorTestLanguageRule103Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule103Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule103Elements rule) {
		this.rule = rule;
