...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule205Elements;

public final class GeneratorTestLanguageRule205Consumer extends NonTerminalConsumer {

	private Rule205Elements rule;	
	...
	public GeneratorTestLanguageRule205Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule205Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule205Elements rule) {
		this.rule = rule;
