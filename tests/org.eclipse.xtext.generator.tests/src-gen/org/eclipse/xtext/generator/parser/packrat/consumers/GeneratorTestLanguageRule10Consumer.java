...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule10Elements;

public final class GeneratorTestLanguageRule10Consumer extends NonTerminalConsumer {

	private Rule10Elements rule;	
	...
	public GeneratorTestLanguageRule10Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule10Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule10Elements rule) {
		this.rule = rule;
