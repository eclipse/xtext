...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule108Elements;

public final class GeneratorTestLanguageRule108Consumer extends NonTerminalConsumer {

	private Rule108Elements rule;	
	...
	public GeneratorTestLanguageRule108Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule108Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule108Elements rule) {
		this.rule = rule;
