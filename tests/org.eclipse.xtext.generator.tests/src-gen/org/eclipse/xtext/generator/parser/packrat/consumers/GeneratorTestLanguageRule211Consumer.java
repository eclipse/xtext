...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule211Elements;

public final class GeneratorTestLanguageRule211Consumer extends NonTerminalConsumer {
	...
	public GeneratorTestLanguageRule211Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule211Elements getRule() {
		return rule;
	}
