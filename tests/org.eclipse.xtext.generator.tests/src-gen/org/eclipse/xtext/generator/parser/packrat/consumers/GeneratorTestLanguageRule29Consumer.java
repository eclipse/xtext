...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule29Elements;

public final class GeneratorTestLanguageRule29Consumer extends NonTerminalConsumer {

	private Rule29Elements rule;	
	...
	public GeneratorTestLanguageRule29Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule29Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule29Elements rule) {
		this.rule = rule;
