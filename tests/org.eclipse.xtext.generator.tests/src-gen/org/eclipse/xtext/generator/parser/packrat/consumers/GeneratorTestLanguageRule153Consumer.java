...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule153Elements;

public final class GeneratorTestLanguageRule153Consumer extends NonTerminalConsumer {

	private Rule153Elements rule;	
	...
	public GeneratorTestLanguageRule153Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule153Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule153Elements rule) {
		this.rule = rule;
