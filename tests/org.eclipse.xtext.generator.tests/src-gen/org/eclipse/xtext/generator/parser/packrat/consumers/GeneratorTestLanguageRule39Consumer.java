...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule39Elements;

public final class GeneratorTestLanguageRule39Consumer extends NonTerminalConsumer {

	private Rule39Elements rule;	
	...
	public GeneratorTestLanguageRule39Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule39Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule39Elements rule) {
		this.rule = rule;
