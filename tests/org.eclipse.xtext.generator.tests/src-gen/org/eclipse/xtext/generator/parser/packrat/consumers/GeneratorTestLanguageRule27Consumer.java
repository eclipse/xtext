...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule27Elements;

public final class GeneratorTestLanguageRule27Consumer extends NonTerminalConsumer {

	private Rule27Elements rule;	
	...
	public GeneratorTestLanguageRule27Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule27Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule27Elements rule) {
		this.rule = rule;
