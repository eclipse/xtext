...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule201Elements;

public final class GeneratorTestLanguageRule201Consumer extends NonTerminalConsumer {

	private Rule201Elements rule;	
	...
	public GeneratorTestLanguageRule201Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule201Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule201Elements rule) {
		this.rule = rule;
