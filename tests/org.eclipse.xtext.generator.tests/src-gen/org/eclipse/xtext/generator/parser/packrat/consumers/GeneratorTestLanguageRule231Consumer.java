...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule231Elements;

public final class GeneratorTestLanguageRule231Consumer extends NonTerminalConsumer {

	private Rule231Elements rule;	
	...
	public GeneratorTestLanguageRule231Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule231Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule231Elements rule) {
		this.rule = rule;
