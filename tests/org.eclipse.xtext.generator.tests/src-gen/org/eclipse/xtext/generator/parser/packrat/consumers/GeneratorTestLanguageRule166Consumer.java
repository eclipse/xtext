...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule166Elements;

public final class GeneratorTestLanguageRule166Consumer extends NonTerminalConsumer {

	private Rule166Elements rule;	
	...
	public GeneratorTestLanguageRule166Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule166Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule166Elements rule) {
		this.rule = rule;
