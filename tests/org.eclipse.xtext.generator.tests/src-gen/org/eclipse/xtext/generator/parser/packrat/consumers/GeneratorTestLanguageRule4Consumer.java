...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule4Elements;

public final class GeneratorTestLanguageRule4Consumer extends NonTerminalConsumer {

	private Rule4Elements rule;	
	...
	public GeneratorTestLanguageRule4Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule4Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule4Elements rule) {
		this.rule = rule;
