...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule238Elements;

public final class GeneratorTestLanguageRule238Consumer extends NonTerminalConsumer {

	private Rule238Elements rule;	
	...
	public GeneratorTestLanguageRule238Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule238Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule238Elements rule) {
		this.rule = rule;
