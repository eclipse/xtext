...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule236Elements;

public final class GeneratorTestLanguageRule236Consumer extends NonTerminalConsumer {

	private Rule236Elements rule;	
	...
	public GeneratorTestLanguageRule236Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule236Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule236Elements rule) {
		this.rule = rule;
