...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule221Elements;

public final class GeneratorTestLanguageRule221Consumer extends NonTerminalConsumer {

	private Rule221Elements rule;	
	...
	public GeneratorTestLanguageRule221Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule221Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule221Elements rule) {
		this.rule = rule;
