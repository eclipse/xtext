...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule12Elements;

public final class GeneratorTestLanguageRule12Consumer extends NonTerminalConsumer {

	private Rule12Elements rule;	
	...
	public GeneratorTestLanguageRule12Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule12Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule12Elements rule) {
		this.rule = rule;
