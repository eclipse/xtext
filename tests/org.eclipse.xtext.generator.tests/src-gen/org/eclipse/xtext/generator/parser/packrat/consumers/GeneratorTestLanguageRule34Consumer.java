...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule34Elements;

public final class GeneratorTestLanguageRule34Consumer extends NonTerminalConsumer {

	private Rule34Elements rule;	
	...
	public GeneratorTestLanguageRule34Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule34Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule34Elements rule) {
		this.rule = rule;
