...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule137Elements;

public final class GeneratorTestLanguageRule137Consumer extends NonTerminalConsumer {

	private Rule137Elements rule;	
	...
	public GeneratorTestLanguageRule137Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule137Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule137Elements rule) {
		this.rule = rule;
