...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule159Elements;

public final class GeneratorTestLanguageRule159Consumer extends NonTerminalConsumer {

	private Rule159Elements rule;	
	...
	public GeneratorTestLanguageRule159Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule159Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule159Elements rule) {
		this.rule = rule;
