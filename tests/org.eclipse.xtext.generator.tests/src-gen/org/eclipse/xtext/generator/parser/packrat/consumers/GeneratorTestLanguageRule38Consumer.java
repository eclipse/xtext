...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule38Elements;

public final class GeneratorTestLanguageRule38Consumer extends NonTerminalConsumer {

	private Rule38Elements rule;	
	...
	public GeneratorTestLanguageRule38Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule38Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule38Elements rule) {
		this.rule = rule;
