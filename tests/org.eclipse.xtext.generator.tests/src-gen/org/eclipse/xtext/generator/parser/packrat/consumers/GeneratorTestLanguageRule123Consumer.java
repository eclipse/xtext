...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule123Elements;

public final class GeneratorTestLanguageRule123Consumer extends NonTerminalConsumer {

	private Rule123Elements rule;	
	...
	public GeneratorTestLanguageRule123Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule123Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule123Elements rule) {
		this.rule = rule;
