...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule91Elements;

public final class GeneratorTestLanguageRule91Consumer extends NonTerminalConsumer {

	private Rule91Elements rule;	
	...
	public GeneratorTestLanguageRule91Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule91Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule91Elements rule) {
		this.rule = rule;
