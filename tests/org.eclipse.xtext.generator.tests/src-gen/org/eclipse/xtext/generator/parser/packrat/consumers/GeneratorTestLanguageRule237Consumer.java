...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule237Elements;

public final class GeneratorTestLanguageRule237Consumer extends NonTerminalConsumer {

	private Rule237Elements rule;	
	...
	public GeneratorTestLanguageRule237Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule237Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule237Elements rule) {
		this.rule = rule;
