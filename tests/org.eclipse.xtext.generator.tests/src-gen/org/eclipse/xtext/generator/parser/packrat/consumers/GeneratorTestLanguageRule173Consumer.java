...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule173Elements;

public final class GeneratorTestLanguageRule173Consumer extends NonTerminalConsumer {

	private Rule173Elements rule;	
	...
	public GeneratorTestLanguageRule173Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule173Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule173Elements rule) {
		this.rule = rule;
