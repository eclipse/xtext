...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule150Elements;

public final class GeneratorTestLanguageRule150Consumer extends NonTerminalConsumer {

	private Rule150Elements rule;	
	...
	public GeneratorTestLanguageRule150Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule150Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule150Elements rule) {
		this.rule = rule;
