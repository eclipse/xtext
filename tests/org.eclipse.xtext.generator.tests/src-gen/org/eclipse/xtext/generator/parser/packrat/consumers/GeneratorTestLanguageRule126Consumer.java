...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule126Elements;

public final class GeneratorTestLanguageRule126Consumer extends NonTerminalConsumer {

	private Rule126Elements rule;	
	...
	public GeneratorTestLanguageRule126Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule126Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule126Elements rule) {
		this.rule = rule;
