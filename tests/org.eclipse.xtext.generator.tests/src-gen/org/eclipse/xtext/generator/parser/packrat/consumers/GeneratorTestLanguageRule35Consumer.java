...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule35Elements;

public final class GeneratorTestLanguageRule35Consumer extends NonTerminalConsumer {

	private Rule35Elements rule;	
	...
	public GeneratorTestLanguageRule35Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule35Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule35Elements rule) {
		this.rule = rule;
