...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule172Elements;

public final class GeneratorTestLanguageRule172Consumer extends NonTerminalConsumer {

	private Rule172Elements rule;	
	...
	public GeneratorTestLanguageRule172Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule172Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule172Elements rule) {
		this.rule = rule;
