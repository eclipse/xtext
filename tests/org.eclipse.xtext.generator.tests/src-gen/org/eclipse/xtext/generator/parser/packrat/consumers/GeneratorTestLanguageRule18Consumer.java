...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule18Elements;

public final class GeneratorTestLanguageRule18Consumer extends NonTerminalConsumer {

	private Rule18Elements rule;	
	...
	public GeneratorTestLanguageRule18Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule18Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule18Elements rule) {
		this.rule = rule;
