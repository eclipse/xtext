...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule14Elements;

public final class GeneratorTestLanguageRule14Consumer extends NonTerminalConsumer {

	private Rule14Elements rule;	
	...
	public GeneratorTestLanguageRule14Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule14Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule14Elements rule) {
		this.rule = rule;
