...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule110Elements;

public final class GeneratorTestLanguageRule110Consumer extends NonTerminalConsumer {

	private Rule110Elements rule;	
	...
	public GeneratorTestLanguageRule110Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule110Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule110Elements rule) {
		this.rule = rule;
