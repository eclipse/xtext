...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule229Elements;

public final class GeneratorTestLanguageRule229Consumer extends NonTerminalConsumer {

	private Rule229Elements rule;	
	...
	public GeneratorTestLanguageRule229Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule229Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule229Elements rule) {
		this.rule = rule;
