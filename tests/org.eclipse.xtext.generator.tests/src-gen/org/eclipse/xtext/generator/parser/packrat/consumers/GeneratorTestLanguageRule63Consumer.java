...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule63Elements;

public final class GeneratorTestLanguageRule63Consumer extends NonTerminalConsumer {

	private Rule63Elements rule;	
	...
	public GeneratorTestLanguageRule63Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule63Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule63Elements rule) {
		this.rule = rule;
