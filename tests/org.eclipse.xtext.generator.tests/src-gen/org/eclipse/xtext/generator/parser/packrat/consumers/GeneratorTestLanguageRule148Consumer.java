...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule148Elements;

public final class GeneratorTestLanguageRule148Consumer extends NonTerminalConsumer {

	private Rule148Elements rule;	
	...
	public GeneratorTestLanguageRule148Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule148Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule148Elements rule) {
		this.rule = rule;
