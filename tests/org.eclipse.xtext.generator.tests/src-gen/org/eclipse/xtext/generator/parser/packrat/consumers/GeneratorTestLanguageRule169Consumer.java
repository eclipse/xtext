...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule169Elements;

public final class GeneratorTestLanguageRule169Consumer extends NonTerminalConsumer {

	private Rule169Elements rule;	
	...
	public GeneratorTestLanguageRule169Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule169Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule169Elements rule) {
		this.rule = rule;
