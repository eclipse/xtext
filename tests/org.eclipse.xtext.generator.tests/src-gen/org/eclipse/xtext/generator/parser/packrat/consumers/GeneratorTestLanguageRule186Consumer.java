...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule186Elements;

public final class GeneratorTestLanguageRule186Consumer extends NonTerminalConsumer {

	private Rule186Elements rule;	
	...
	public GeneratorTestLanguageRule186Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule186Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule186Elements rule) {
		this.rule = rule;
