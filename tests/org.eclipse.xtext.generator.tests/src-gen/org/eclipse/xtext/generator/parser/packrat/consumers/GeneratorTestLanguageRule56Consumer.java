...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule56Elements;

public final class GeneratorTestLanguageRule56Consumer extends NonTerminalConsumer {

	private Rule56Elements rule;	
	...
	public GeneratorTestLanguageRule56Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule56Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule56Elements rule) {
		this.rule = rule;
