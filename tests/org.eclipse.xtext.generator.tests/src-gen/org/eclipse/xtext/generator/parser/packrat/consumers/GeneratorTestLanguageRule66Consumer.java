...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule66Elements;

public final class GeneratorTestLanguageRule66Consumer extends NonTerminalConsumer {

	private Rule66Elements rule;	
	...
	public GeneratorTestLanguageRule66Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule66Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule66Elements rule) {
		this.rule = rule;
