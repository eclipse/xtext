...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule194Elements;

public final class GeneratorTestLanguageRule194Consumer extends NonTerminalConsumer {

	private Rule194Elements rule;	
	...
	public GeneratorTestLanguageRule194Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule194Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule194Elements rule) {
		this.rule = rule;
