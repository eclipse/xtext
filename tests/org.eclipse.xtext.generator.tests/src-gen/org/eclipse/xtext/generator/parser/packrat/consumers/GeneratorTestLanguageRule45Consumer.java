...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule45Elements;

public final class GeneratorTestLanguageRule45Consumer extends NonTerminalConsumer {

	private Rule45Elements rule;	
	...
	public GeneratorTestLanguageRule45Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule45Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule45Elements rule) {
		this.rule = rule;
