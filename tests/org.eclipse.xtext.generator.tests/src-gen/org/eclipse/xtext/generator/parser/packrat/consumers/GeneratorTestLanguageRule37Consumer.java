...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule37Elements;

public final class GeneratorTestLanguageRule37Consumer extends NonTerminalConsumer {

	private Rule37Elements rule;	
	...
	public GeneratorTestLanguageRule37Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule37Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule37Elements rule) {
		this.rule = rule;
