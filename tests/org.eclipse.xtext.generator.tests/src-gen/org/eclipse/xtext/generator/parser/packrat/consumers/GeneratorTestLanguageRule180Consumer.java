...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule180Elements;

public final class GeneratorTestLanguageRule180Consumer extends NonTerminalConsumer {

	private Rule180Elements rule;	
	...
	public GeneratorTestLanguageRule180Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule180Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule180Elements rule) {
		this.rule = rule;
