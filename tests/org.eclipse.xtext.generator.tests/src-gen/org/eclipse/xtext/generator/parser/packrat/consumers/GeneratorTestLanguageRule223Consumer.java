...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule223Elements;

public final class GeneratorTestLanguageRule223Consumer extends NonTerminalConsumer {

	private Rule223Elements rule;	
	...
	public GeneratorTestLanguageRule223Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule223Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule223Elements rule) {
		this.rule = rule;
