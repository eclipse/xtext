...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule233Elements;

public final class GeneratorTestLanguageRule233Consumer extends NonTerminalConsumer {

	private Rule233Elements rule;	
	...
	public GeneratorTestLanguageRule233Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule233Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule233Elements rule) {
		this.rule = rule;
