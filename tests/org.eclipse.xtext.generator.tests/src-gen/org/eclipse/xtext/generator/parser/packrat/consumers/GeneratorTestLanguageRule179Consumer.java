...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule179Elements;

public final class GeneratorTestLanguageRule179Consumer extends NonTerminalConsumer {

	private Rule179Elements rule;	
	...
	public GeneratorTestLanguageRule179Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule179Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule179Elements rule) {
		this.rule = rule;
