...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule61Elements;

public final class GeneratorTestLanguageRule61Consumer extends NonTerminalConsumer {

	private Rule61Elements rule;	
	...
	public GeneratorTestLanguageRule61Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule61Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule61Elements rule) {
		this.rule = rule;
