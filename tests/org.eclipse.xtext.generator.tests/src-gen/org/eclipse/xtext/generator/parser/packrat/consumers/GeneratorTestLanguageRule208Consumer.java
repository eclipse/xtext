...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule208Elements;

public final class GeneratorTestLanguageRule208Consumer extends NonTerminalConsumer {

	private Rule208Elements rule;	
	...
	public GeneratorTestLanguageRule208Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule208Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule208Elements rule) {
		this.rule = rule;
