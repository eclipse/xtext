...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule47Elements;

public final class GeneratorTestLanguageRule47Consumer extends NonTerminalConsumer {

	private Rule47Elements rule;	
	...
	public GeneratorTestLanguageRule47Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule47Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule47Elements rule) {
		this.rule = rule;
