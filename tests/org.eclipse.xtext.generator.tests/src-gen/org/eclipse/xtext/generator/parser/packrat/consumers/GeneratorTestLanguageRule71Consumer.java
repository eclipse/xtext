...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule71Elements;

public final class GeneratorTestLanguageRule71Consumer extends NonTerminalConsumer {

	private Rule71Elements rule;	
	...
	public GeneratorTestLanguageRule71Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule71Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule71Elements rule) {
		this.rule = rule;
