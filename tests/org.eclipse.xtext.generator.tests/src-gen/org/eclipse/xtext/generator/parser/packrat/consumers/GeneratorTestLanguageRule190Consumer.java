...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule190Elements;

public final class GeneratorTestLanguageRule190Consumer extends NonTerminalConsumer {

	private Rule190Elements rule;	
	...
	public GeneratorTestLanguageRule190Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule190Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule190Elements rule) {
		this.rule = rule;
