...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule23Elements;

public final class GeneratorTestLanguageRule23Consumer extends NonTerminalConsumer {

	private Rule23Elements rule;	
	...
	public GeneratorTestLanguageRule23Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule23Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule23Elements rule) {
		this.rule = rule;
