...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule198Elements;

public final class GeneratorTestLanguageRule198Consumer extends NonTerminalConsumer {

	private Rule198Elements rule;	
	...
	public GeneratorTestLanguageRule198Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule198Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule198Elements rule) {
		this.rule = rule;
