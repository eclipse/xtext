...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule177Elements;

public final class GeneratorTestLanguageRule177Consumer extends NonTerminalConsumer {

	private Rule177Elements rule;	
	...
	public GeneratorTestLanguageRule177Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule177Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule177Elements rule) {
		this.rule = rule;
