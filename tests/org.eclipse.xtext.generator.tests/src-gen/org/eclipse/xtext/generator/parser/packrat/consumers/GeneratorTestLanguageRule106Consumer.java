...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule106Elements;

public final class GeneratorTestLanguageRule106Consumer extends NonTerminalConsumer {

	private Rule106Elements rule;	
	...
	public GeneratorTestLanguageRule106Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule106Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule106Elements rule) {
		this.rule = rule;
