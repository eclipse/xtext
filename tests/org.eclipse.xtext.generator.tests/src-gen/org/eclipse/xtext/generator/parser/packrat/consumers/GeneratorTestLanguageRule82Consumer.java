...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule82Elements;

public final class GeneratorTestLanguageRule82Consumer extends NonTerminalConsumer {

	private Rule82Elements rule;	
	...
	public GeneratorTestLanguageRule82Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule82Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule82Elements rule) {
		this.rule = rule;
