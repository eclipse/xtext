...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule195Elements;

public final class GeneratorTestLanguageRule195Consumer extends NonTerminalConsumer {

	private Rule195Elements rule;	
	...
	public GeneratorTestLanguageRule195Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule195Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule195Elements rule) {
		this.rule = rule;
