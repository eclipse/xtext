...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule81Elements;

public final class GeneratorTestLanguageRule81Consumer extends NonTerminalConsumer {

	private Rule81Elements rule;	
	...
	public GeneratorTestLanguageRule81Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule81Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule81Elements rule) {
		this.rule = rule;
