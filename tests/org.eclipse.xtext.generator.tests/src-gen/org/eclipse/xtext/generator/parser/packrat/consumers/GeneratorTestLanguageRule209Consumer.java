...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule209Elements;

public final class GeneratorTestLanguageRule209Consumer extends NonTerminalConsumer {

	private Rule209Elements rule;	
	...
	public GeneratorTestLanguageRule209Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule209Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule209Elements rule) {
		this.rule = rule;
