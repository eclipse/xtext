...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule59Elements;

public final class GeneratorTestLanguageRule59Consumer extends NonTerminalConsumer {

	private Rule59Elements rule;	
	...
	public GeneratorTestLanguageRule59Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule59Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule59Elements rule) {
		this.rule = rule;
