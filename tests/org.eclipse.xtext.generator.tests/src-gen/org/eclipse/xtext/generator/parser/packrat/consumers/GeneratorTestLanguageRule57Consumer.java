...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule57Elements;

public final class GeneratorTestLanguageRule57Consumer extends NonTerminalConsumer {

	private Rule57Elements rule;	
	...
	public GeneratorTestLanguageRule57Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule57Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule57Elements rule) {
		this.rule = rule;
