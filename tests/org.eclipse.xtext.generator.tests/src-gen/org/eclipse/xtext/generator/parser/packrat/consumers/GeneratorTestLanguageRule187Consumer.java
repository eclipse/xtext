...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule187Elements;

public final class GeneratorTestLanguageRule187Consumer extends NonTerminalConsumer {

	private Rule187Elements rule;	
	...
	public GeneratorTestLanguageRule187Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule187Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule187Elements rule) {
		this.rule = rule;
