...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule243Elements;

public final class GeneratorTestLanguageRule243Consumer extends NonTerminalConsumer {

	private Rule243Elements rule;	
	...
	public GeneratorTestLanguageRule243Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule243Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule243Elements rule) {
		this.rule = rule;
