...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule141Elements;

public final class GeneratorTestLanguageRule141Consumer extends NonTerminalConsumer {

	private Rule141Elements rule;	
	...
	public GeneratorTestLanguageRule141Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule141Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule141Elements rule) {
		this.rule = rule;
