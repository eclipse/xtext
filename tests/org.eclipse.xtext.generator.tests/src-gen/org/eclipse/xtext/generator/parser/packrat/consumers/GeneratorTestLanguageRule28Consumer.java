...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule28Elements;

public final class GeneratorTestLanguageRule28Consumer extends NonTerminalConsumer {

	private Rule28Elements rule;	
	...
	public GeneratorTestLanguageRule28Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule28Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule28Elements rule) {
		this.rule = rule;
