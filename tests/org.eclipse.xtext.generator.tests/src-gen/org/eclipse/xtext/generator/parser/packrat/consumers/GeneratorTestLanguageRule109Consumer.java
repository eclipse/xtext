...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule109Elements;

public final class GeneratorTestLanguageRule109Consumer extends NonTerminalConsumer {

	private Rule109Elements rule;	
	...
	public GeneratorTestLanguageRule109Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule109Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule109Elements rule) {
		this.rule = rule;
