...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule116Elements;

public final class GeneratorTestLanguageRule116Consumer extends NonTerminalConsumer {

	private Rule116Elements rule;	
	...
	public GeneratorTestLanguageRule116Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule116Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule116Elements rule) {
		this.rule = rule;
