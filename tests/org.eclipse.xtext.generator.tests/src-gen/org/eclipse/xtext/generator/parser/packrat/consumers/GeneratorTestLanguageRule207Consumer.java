...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule207Elements;

public final class GeneratorTestLanguageRule207Consumer extends NonTerminalConsumer {

	private Rule207Elements rule;	
	...
	public GeneratorTestLanguageRule207Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule207Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule207Elements rule) {
		this.rule = rule;
