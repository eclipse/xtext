...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule99Elements;

public final class GeneratorTestLanguageRule99Consumer extends NonTerminalConsumer {

	private Rule99Elements rule;	
	...
	public GeneratorTestLanguageRule99Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule99Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule99Elements rule) {
		this.rule = rule;
