...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule77Elements;

public final class GeneratorTestLanguageRule77Consumer extends NonTerminalConsumer {

	private Rule77Elements rule;	
	...
	public GeneratorTestLanguageRule77Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule77Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule77Elements rule) {
		this.rule = rule;
