...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule67Elements;

public final class GeneratorTestLanguageRule67Consumer extends NonTerminalConsumer {

	private Rule67Elements rule;	
	...
	public GeneratorTestLanguageRule67Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule67Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule67Elements rule) {
		this.rule = rule;
