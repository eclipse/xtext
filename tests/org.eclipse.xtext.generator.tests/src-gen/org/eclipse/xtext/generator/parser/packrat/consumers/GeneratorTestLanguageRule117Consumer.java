...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule117Elements;

public final class GeneratorTestLanguageRule117Consumer extends NonTerminalConsumer {

	private Rule117Elements rule;	
	...
	public GeneratorTestLanguageRule117Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule117Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule117Elements rule) {
		this.rule = rule;
