...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule9Elements;

public final class GeneratorTestLanguageRule9Consumer extends NonTerminalConsumer {

	private Rule9Elements rule;	
	...
	public GeneratorTestLanguageRule9Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule9Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule9Elements rule) {
		this.rule = rule;
