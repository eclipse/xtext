...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule138Elements;

public final class GeneratorTestLanguageRule138Consumer extends NonTerminalConsumer {

	private Rule138Elements rule;	
	...
	public GeneratorTestLanguageRule138Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule138Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule138Elements rule) {
		this.rule = rule;
