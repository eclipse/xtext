...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule44Elements;

public final class GeneratorTestLanguageRule44Consumer extends NonTerminalConsumer {

	private Rule44Elements rule;	
	...
	public GeneratorTestLanguageRule44Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule44Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule44Elements rule) {
		this.rule = rule;
