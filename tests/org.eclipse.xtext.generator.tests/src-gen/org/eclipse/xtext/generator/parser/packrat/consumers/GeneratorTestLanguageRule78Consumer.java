...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule78Elements;

public final class GeneratorTestLanguageRule78Consumer extends NonTerminalConsumer {

	private Rule78Elements rule;	
	...
	public GeneratorTestLanguageRule78Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule78Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule78Elements rule) {
		this.rule = rule;
