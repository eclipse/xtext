...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule128Elements;

public final class GeneratorTestLanguageRule128Consumer extends NonTerminalConsumer {

	private Rule128Elements rule;	
	...
	public GeneratorTestLanguageRule128Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule128Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule128Elements rule) {
		this.rule = rule;
