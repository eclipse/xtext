...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule140Elements;

public final class GeneratorTestLanguageRule140Consumer extends NonTerminalConsumer {

	private Rule140Elements rule;	
	...
	public GeneratorTestLanguageRule140Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule140Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule140Elements rule) {
		this.rule = rule;
