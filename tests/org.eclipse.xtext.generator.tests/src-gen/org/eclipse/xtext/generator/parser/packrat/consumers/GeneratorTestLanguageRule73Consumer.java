...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule73Elements;

public final class GeneratorTestLanguageRule73Consumer extends NonTerminalConsumer {

	private Rule73Elements rule;	
	...
	public GeneratorTestLanguageRule73Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule73Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule73Elements rule) {
		this.rule = rule;
