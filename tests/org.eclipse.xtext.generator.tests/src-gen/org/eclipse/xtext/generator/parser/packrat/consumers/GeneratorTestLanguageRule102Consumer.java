...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule102Elements;

public final class GeneratorTestLanguageRule102Consumer extends NonTerminalConsumer {

	private Rule102Elements rule;	
	...
	public GeneratorTestLanguageRule102Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule102Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule102Elements rule) {
		this.rule = rule;
