...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule214Elements;

public final class GeneratorTestLanguageRule214Consumer extends NonTerminalConsumer {

	private Rule214Elements rule;	
	...
	public GeneratorTestLanguageRule214Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule214Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule214Elements rule) {
		this.rule = rule;
