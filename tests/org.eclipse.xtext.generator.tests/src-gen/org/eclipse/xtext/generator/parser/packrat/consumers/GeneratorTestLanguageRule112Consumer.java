...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule112Elements;

public final class GeneratorTestLanguageRule112Consumer extends NonTerminalConsumer {

	private Rule112Elements rule;	
	...
	public GeneratorTestLanguageRule112Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule112Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule112Elements rule) {
		this.rule = rule;
