...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule25Elements;

public final class GeneratorTestLanguageRule25Consumer extends NonTerminalConsumer {

	private Rule25Elements rule;	
	...
	public GeneratorTestLanguageRule25Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule25Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule25Elements rule) {
		this.rule = rule;
