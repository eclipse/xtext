...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule196Elements;

public final class GeneratorTestLanguageRule196Consumer extends NonTerminalConsumer {

	private Rule196Elements rule;	
	...
	public GeneratorTestLanguageRule196Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule196Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule196Elements rule) {
		this.rule = rule;
