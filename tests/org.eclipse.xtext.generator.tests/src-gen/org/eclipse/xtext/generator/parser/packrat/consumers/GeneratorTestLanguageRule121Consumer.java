...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule121Elements;

public final class GeneratorTestLanguageRule121Consumer extends NonTerminalConsumer {

	private Rule121Elements rule;	
	...
	public GeneratorTestLanguageRule121Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule121Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule121Elements rule) {
		this.rule = rule;
