...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule213Elements;

public final class GeneratorTestLanguageRule213Consumer extends NonTerminalConsumer {

	private Rule213Elements rule;	
	...
	public GeneratorTestLanguageRule213Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule213Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule213Elements rule) {
		this.rule = rule;
