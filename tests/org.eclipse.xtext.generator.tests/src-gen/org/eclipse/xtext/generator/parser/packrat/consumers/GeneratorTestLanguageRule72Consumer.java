...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule72Elements;

public final class GeneratorTestLanguageRule72Consumer extends NonTerminalConsumer {

	private Rule72Elements rule;	
	...
	public GeneratorTestLanguageRule72Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule72Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule72Elements rule) {
		this.rule = rule;
