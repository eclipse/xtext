...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule93Elements;

public final class GeneratorTestLanguageRule93Consumer extends NonTerminalConsumer {

	private Rule93Elements rule;	
	...
	public GeneratorTestLanguageRule93Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule93Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule93Elements rule) {
		this.rule = rule;
