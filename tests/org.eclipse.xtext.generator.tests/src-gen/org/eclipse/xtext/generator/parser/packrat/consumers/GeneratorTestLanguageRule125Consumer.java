...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule125Elements;

public final class GeneratorTestLanguageRule125Consumer extends NonTerminalConsumer {

	private Rule125Elements rule;	
	...
	public GeneratorTestLanguageRule125Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule125Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule125Elements rule) {
		this.rule = rule;
