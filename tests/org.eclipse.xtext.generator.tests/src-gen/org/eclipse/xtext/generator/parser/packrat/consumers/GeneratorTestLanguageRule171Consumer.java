...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule171Elements;

public final class GeneratorTestLanguageRule171Consumer extends NonTerminalConsumer {

	private Rule171Elements rule;	
	...
	public GeneratorTestLanguageRule171Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule171Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule171Elements rule) {
		this.rule = rule;
