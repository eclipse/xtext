...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule225Elements;

public final class GeneratorTestLanguageRule225Consumer extends NonTerminalConsumer {

	private Rule225Elements rule;	
	...
	public GeneratorTestLanguageRule225Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule225Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule225Elements rule) {
		this.rule = rule;
