...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule89Elements;

public final class GeneratorTestLanguageRule89Consumer extends NonTerminalConsumer {

	private Rule89Elements rule;	
	...
	public GeneratorTestLanguageRule89Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule89Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule89Elements rule) {
		this.rule = rule;
