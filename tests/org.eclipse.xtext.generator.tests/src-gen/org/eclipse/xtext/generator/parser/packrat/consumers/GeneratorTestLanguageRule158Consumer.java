...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule158Elements;

public final class GeneratorTestLanguageRule158Consumer extends NonTerminalConsumer {

	private Rule158Elements rule;	
	...
	public GeneratorTestLanguageRule158Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule158Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule158Elements rule) {
		this.rule = rule;
