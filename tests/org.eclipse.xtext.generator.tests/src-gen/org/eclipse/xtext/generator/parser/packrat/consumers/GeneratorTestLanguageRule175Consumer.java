...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule175Elements;

public final class GeneratorTestLanguageRule175Consumer extends NonTerminalConsumer {

	private Rule175Elements rule;	
	...
	public GeneratorTestLanguageRule175Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule175Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule175Elements rule) {
		this.rule = rule;
