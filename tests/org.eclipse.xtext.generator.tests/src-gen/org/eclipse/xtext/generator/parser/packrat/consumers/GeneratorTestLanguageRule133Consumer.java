...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule133Elements;

public final class GeneratorTestLanguageRule133Consumer extends NonTerminalConsumer {

	private Rule133Elements rule;	
	...
	public GeneratorTestLanguageRule133Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule133Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule133Elements rule) {
		this.rule = rule;
