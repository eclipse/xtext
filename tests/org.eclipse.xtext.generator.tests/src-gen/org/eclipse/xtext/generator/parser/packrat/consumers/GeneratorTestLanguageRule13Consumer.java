...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule13Elements;

public final class GeneratorTestLanguageRule13Consumer extends NonTerminalConsumer {

	private Rule13Elements rule;	
	...
	public GeneratorTestLanguageRule13Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule13Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule13Elements rule) {
		this.rule = rule;
