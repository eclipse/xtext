...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule245Elements;

public final class GeneratorTestLanguageRule245Consumer extends NonTerminalConsumer {

	private Rule245Elements rule;	
	...
	public GeneratorTestLanguageRule245Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule245Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule245Elements rule) {
		this.rule = rule;
