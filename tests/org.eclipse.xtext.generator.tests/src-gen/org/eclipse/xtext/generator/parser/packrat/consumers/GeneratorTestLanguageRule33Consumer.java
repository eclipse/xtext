...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule33Elements;

public final class GeneratorTestLanguageRule33Consumer extends NonTerminalConsumer {

	private Rule33Elements rule;	
	...
	public GeneratorTestLanguageRule33Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule33Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule33Elements rule) {
		this.rule = rule;
