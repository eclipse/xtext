...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule230Elements;

public final class GeneratorTestLanguageRule230Consumer extends NonTerminalConsumer {

	private Rule230Elements rule;	
	...
	public GeneratorTestLanguageRule230Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule230Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule230Elements rule) {
		this.rule = rule;
