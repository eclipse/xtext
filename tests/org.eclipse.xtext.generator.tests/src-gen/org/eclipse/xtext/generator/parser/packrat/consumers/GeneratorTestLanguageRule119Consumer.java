...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule119Elements;

public final class GeneratorTestLanguageRule119Consumer extends NonTerminalConsumer {

	private Rule119Elements rule;	
	...
	public GeneratorTestLanguageRule119Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule119Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule119Elements rule) {
		this.rule = rule;
