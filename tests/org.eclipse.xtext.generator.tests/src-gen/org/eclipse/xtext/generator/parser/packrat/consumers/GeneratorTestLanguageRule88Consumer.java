...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule88Elements;

public final class GeneratorTestLanguageRule88Consumer extends NonTerminalConsumer {

	private Rule88Elements rule;	
	...
	public GeneratorTestLanguageRule88Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule88Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule88Elements rule) {
		this.rule = rule;
