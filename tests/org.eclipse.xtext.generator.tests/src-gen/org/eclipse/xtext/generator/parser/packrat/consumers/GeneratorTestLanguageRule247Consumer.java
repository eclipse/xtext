...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule247Elements;

public final class GeneratorTestLanguageRule247Consumer extends NonTerminalConsumer {

	private Rule247Elements rule;	
	...
	public GeneratorTestLanguageRule247Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule247Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule247Elements rule) {
		this.rule = rule;
