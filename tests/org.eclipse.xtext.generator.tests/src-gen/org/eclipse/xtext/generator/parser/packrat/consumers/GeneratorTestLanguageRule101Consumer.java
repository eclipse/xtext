...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule101Elements;

public final class GeneratorTestLanguageRule101Consumer extends NonTerminalConsumer {

	private Rule101Elements rule;	
	...
	public GeneratorTestLanguageRule101Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule101Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule101Elements rule) {
		this.rule = rule;
