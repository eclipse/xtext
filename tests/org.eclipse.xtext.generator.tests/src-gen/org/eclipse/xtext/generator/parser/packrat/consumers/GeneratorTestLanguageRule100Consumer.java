...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule100Elements;

public final class GeneratorTestLanguageRule100Consumer extends NonTerminalConsumer {

	private Rule100Elements rule;	
	...
	public GeneratorTestLanguageRule100Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule100Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule100Elements rule) {
		this.rule = rule;
