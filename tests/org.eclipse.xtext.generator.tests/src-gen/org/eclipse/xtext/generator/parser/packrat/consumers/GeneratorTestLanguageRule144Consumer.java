...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule144Elements;

public final class GeneratorTestLanguageRule144Consumer extends NonTerminalConsumer {

	private Rule144Elements rule;	
	...
	public GeneratorTestLanguageRule144Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule144Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule144Elements rule) {
		this.rule = rule;
