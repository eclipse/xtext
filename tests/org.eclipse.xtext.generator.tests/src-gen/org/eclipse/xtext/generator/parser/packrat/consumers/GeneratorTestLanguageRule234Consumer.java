...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule234Elements;

public final class GeneratorTestLanguageRule234Consumer extends NonTerminalConsumer {

	private Rule234Elements rule;	
	...
	public GeneratorTestLanguageRule234Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule234Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule234Elements rule) {
		this.rule = rule;
