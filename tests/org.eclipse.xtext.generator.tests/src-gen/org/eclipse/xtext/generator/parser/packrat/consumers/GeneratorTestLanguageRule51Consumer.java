...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule51Elements;

public final class GeneratorTestLanguageRule51Consumer extends NonTerminalConsumer {

	private Rule51Elements rule;	
	...
	public GeneratorTestLanguageRule51Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule51Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule51Elements rule) {
		this.rule = rule;
