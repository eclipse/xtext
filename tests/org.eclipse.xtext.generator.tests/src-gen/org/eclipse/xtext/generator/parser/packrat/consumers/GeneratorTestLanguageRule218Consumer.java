...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule218Elements;

public final class GeneratorTestLanguageRule218Consumer extends NonTerminalConsumer {

	private Rule218Elements rule;	
	...
	public GeneratorTestLanguageRule218Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule218Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule218Elements rule) {
		this.rule = rule;
