...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule49Elements;

public final class GeneratorTestLanguageRule49Consumer extends NonTerminalConsumer {

	private Rule49Elements rule;	
	...
	public GeneratorTestLanguageRule49Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule49Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule49Elements rule) {
		this.rule = rule;
