...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule135Elements;

public final class GeneratorTestLanguageRule135Consumer extends NonTerminalConsumer {

	private Rule135Elements rule;	
	...
	public GeneratorTestLanguageRule135Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule135Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule135Elements rule) {
		this.rule = rule;
