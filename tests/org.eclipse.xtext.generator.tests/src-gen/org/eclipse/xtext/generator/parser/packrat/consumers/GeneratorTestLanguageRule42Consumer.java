...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule42Elements;

public final class GeneratorTestLanguageRule42Consumer extends NonTerminalConsumer {

	private Rule42Elements rule;	
	...
	public GeneratorTestLanguageRule42Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule42Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule42Elements rule) {
		this.rule = rule;
