...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule62Elements;

public final class GeneratorTestLanguageRule62Consumer extends NonTerminalConsumer {

	private Rule62Elements rule;	
	...
	public GeneratorTestLanguageRule62Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule62Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule62Elements rule) {
		this.rule = rule;
