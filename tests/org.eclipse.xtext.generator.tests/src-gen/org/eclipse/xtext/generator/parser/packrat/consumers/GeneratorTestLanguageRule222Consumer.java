...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule222Elements;

public final class GeneratorTestLanguageRule222Consumer extends NonTerminalConsumer {

	private Rule222Elements rule;	
	...
	public GeneratorTestLanguageRule222Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule222Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule222Elements rule) {
		this.rule = rule;
