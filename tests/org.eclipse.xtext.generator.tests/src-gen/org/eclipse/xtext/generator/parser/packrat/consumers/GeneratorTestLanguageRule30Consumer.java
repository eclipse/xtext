...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule30Elements;

public final class GeneratorTestLanguageRule30Consumer extends NonTerminalConsumer {

	private Rule30Elements rule;	
	...
	public GeneratorTestLanguageRule30Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule30Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule30Elements rule) {
		this.rule = rule;
