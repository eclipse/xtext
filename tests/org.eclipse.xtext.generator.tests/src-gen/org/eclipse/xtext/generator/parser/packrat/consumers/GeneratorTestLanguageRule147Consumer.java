...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule147Elements;

public final class GeneratorTestLanguageRule147Consumer extends NonTerminalConsumer {

	private Rule147Elements rule;	
	...
	public GeneratorTestLanguageRule147Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule147Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule147Elements rule) {
		this.rule = rule;
