...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule1Elements;

public final class GeneratorTestLanguageRule1Consumer extends NonTerminalConsumer {

	private Rule1Elements rule;	
	...
	public GeneratorTestLanguageRule1Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule1Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule1Elements rule) {
		this.rule = rule;
