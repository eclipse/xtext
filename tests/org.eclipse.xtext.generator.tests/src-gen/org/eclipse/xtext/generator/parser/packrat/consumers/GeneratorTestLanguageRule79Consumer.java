...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule79Elements;

public final class GeneratorTestLanguageRule79Consumer extends NonTerminalConsumer {

	private Rule79Elements rule;	
	...
	public GeneratorTestLanguageRule79Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule79Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule79Elements rule) {
		this.rule = rule;
