...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule20Elements;

public final class GeneratorTestLanguageRule20Consumer extends NonTerminalConsumer {

	private Rule20Elements rule;	
	...
	public GeneratorTestLanguageRule20Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule20Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule20Elements rule) {
		this.rule = rule;
