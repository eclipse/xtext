...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule54Elements;

public final class GeneratorTestLanguageRule54Consumer extends NonTerminalConsumer {

	private Rule54Elements rule;	
	...
	public GeneratorTestLanguageRule54Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule54Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule54Elements rule) {
		this.rule = rule;
