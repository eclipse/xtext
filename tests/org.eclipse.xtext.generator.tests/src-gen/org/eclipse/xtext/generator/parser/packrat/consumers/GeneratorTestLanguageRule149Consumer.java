...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule149Elements;

public final class GeneratorTestLanguageRule149Consumer extends NonTerminalConsumer {

	private Rule149Elements rule;	
	...
	public GeneratorTestLanguageRule149Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule149Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule149Elements rule) {
		this.rule = rule;
