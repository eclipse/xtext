...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule184Elements;

public final class GeneratorTestLanguageRule184Consumer extends NonTerminalConsumer {

	private Rule184Elements rule;	
	...
	public GeneratorTestLanguageRule184Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule184Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule184Elements rule) {
		this.rule = rule;
