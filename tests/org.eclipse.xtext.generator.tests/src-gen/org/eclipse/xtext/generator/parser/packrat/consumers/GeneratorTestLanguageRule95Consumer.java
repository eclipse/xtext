...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule95Elements;

public final class GeneratorTestLanguageRule95Consumer extends NonTerminalConsumer {

	private Rule95Elements rule;	
	...
	public GeneratorTestLanguageRule95Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule95Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule95Elements rule) {
		this.rule = rule;
