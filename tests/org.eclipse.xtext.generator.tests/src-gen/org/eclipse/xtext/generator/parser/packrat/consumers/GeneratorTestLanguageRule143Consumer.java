...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule143Elements;

public final class GeneratorTestLanguageRule143Consumer extends NonTerminalConsumer {

	private Rule143Elements rule;	
	...
	public GeneratorTestLanguageRule143Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule143Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule143Elements rule) {
		this.rule = rule;
