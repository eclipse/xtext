...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule181Elements;

public final class GeneratorTestLanguageRule181Consumer extends NonTerminalConsumer {

	private Rule181Elements rule;	
	...
	public GeneratorTestLanguageRule181Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule181Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule181Elements rule) {
		this.rule = rule;
