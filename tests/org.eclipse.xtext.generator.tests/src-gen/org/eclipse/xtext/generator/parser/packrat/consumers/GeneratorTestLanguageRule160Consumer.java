...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule160Elements;

public final class GeneratorTestLanguageRule160Consumer extends NonTerminalConsumer {

	private Rule160Elements rule;	
	...
	public GeneratorTestLanguageRule160Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule160Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule160Elements rule) {
		this.rule = rule;
