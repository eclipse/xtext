...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule154Elements;

public final class GeneratorTestLanguageRule154Consumer extends NonTerminalConsumer {

	private Rule154Elements rule;	
	...
	public GeneratorTestLanguageRule154Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule154Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule154Elements rule) {
		this.rule = rule;
