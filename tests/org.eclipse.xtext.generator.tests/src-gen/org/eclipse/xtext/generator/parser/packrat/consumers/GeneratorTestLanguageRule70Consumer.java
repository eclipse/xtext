...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule70Elements;

public final class GeneratorTestLanguageRule70Consumer extends NonTerminalConsumer {

	private Rule70Elements rule;	
	...
	public GeneratorTestLanguageRule70Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule70Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule70Elements rule) {
		this.rule = rule;
