...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule5Elements;

public final class GeneratorTestLanguageRule5Consumer extends NonTerminalConsumer {

	private Rule5Elements rule;	
	...
	public GeneratorTestLanguageRule5Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule5Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule5Elements rule) {
		this.rule = rule;
