...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule206Elements;

public final class GeneratorTestLanguageRule206Consumer extends NonTerminalConsumer {

	private Rule206Elements rule;	
	...
	public GeneratorTestLanguageRule206Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule206Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule206Elements rule) {
		this.rule = rule;
