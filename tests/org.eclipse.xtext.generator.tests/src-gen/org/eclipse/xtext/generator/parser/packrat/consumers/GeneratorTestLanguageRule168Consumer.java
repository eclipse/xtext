...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule168Elements;

public final class GeneratorTestLanguageRule168Consumer extends NonTerminalConsumer {

	private Rule168Elements rule;	
	...
	public GeneratorTestLanguageRule168Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule168Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule168Elements rule) {
		this.rule = rule;
