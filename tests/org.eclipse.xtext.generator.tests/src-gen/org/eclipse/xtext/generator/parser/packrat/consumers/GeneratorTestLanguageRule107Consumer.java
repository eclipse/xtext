...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule107Elements;

public final class GeneratorTestLanguageRule107Consumer extends NonTerminalConsumer {

	private Rule107Elements rule;	
	...
	public GeneratorTestLanguageRule107Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule107Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule107Elements rule) {
		this.rule = rule;
