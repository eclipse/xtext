...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule111Elements;

public final class GeneratorTestLanguageRule111Consumer extends NonTerminalConsumer {

	private Rule111Elements rule;	
	...
	public GeneratorTestLanguageRule111Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule111Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule111Elements rule) {
		this.rule = rule;
