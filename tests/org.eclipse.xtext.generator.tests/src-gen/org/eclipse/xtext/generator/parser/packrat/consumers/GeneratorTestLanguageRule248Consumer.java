...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule248Elements;

public final class GeneratorTestLanguageRule248Consumer extends NonTerminalConsumer {

	private Rule248Elements rule;	
	...
	public GeneratorTestLanguageRule248Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule248Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule248Elements rule) {
		this.rule = rule;
