...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule215Elements;

public final class GeneratorTestLanguageRule215Consumer extends NonTerminalConsumer {

	private Rule215Elements rule;	
	...
	public GeneratorTestLanguageRule215Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule215Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule215Elements rule) {
		this.rule = rule;
