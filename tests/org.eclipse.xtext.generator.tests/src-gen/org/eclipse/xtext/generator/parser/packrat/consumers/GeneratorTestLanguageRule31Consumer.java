...
import org.eclipse.xtext.generator.services.GeneratorTestLanguageGrammarAccess.Rule31Elements;

public final class GeneratorTestLanguageRule31Consumer extends NonTerminalConsumer {

	private Rule31Elements rule;	
	...
	public GeneratorTestLanguageRule31Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Rule31Elements getRule() {
		return rule;
	}
	
	public void setRule(Rule31Elements rule) {
		this.rule = rule;
