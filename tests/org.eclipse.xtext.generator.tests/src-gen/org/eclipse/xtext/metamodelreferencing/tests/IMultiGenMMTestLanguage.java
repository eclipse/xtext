...
public interface IMultiGenMMTestLanguage extends ILanguage {
	 ...
	 */
	public static final String ID = "org.eclipse.xtext.metamodelreferencing.tests.MultiGenMMTestLanguage";
	public static final String NAME = "MultiGenMMTestLanguage";
	public static final String NAMESPACE = "org.eclipse.xtext.metamodelreferencing.tests";
	public static final String[] FILE_EXTENSIONS = new String[]{"multigenmmtestlanguage"};
