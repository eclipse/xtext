 ...
 * </copyright>
 *
 * $Id: AnotherSimpleTestFactoryImpl.java,v 1.1 2009/02/18 19:45:29 sefftinge Exp $
 */
...
public class AnotherSimpleTestFactoryImpl extends EFactoryImpl implements AnotherSimpleTestFactory
{
  ...
  public static AnotherSimpleTestFactory init()
  {
    try
    {
      AnotherSimpleTestFactory theAnotherSimpleTestFactory = (AnotherSimpleTestFactory)EPackage.Registry.INSTANCE.getEFactory("http://eclipse.org/xtext/tests/AnotherSimpleTest"); 
