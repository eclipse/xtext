 ...
 * </copyright>
 *
 * $Id: FooBarImpl.java,v 1.3 2009/02/19 14:40:04 sefftinge Exp $
 */
...
public class FooBarImpl extends EObjectImpl implements FooBar
{
  ...
  {
    return OtherTestPackage.Literals.FOO_BAR;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OtherTestPackage.FOO_BAR__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case OtherTestPackage.FOO_BAR__NAME:
        return getName();
    }
