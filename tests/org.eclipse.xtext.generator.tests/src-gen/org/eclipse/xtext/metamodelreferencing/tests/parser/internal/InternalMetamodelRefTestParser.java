...
public class InternalMetamodelRefTestParser extends Parser {
    public static final String[] tokenNames = new String[] {
        "<invalid>", "<EOR>", "<DOWN>", "<UP>", "RULE_ID", "RULE_STRING", "RULE_SL_COMMENT", "RULE_WS", "RULE_LEXER_BODY", "RULE_INT", "RULE_ML_COMMENT", "RULE_ANY_OTHER"
    };
    ...
    public final EObject parse() throws RecognitionException {
        ...
        try {
            ...
            {
            currentNode = createCompositeNode(// org.eclipse.xtext.impl.ParserRuleImpl@639204 (name: Foo)
    ...
    public final EObject ruleFoo() throws RecognitionException {
        ...
        try {
            ...
            match(input,RULE_ID,FOLLOW_RULE_ID_in_ruleFoo90); 
             createLeafNode(// org.eclipse.xtext.impl.RuleCallImpl@978575 (cardinality: null) (name: ID)
    ...
    public final EObject ruleNameRef() throws RecognitionException {
        ...
        try {
            ...
            match(input,RULE_STRING,FOLLOW_RULE_STRING_in_ruleNameRef156); 
             createLeafNode(// org.eclipse.xtext.impl.RuleCallImpl@950aeb (cardinality: null) (name: STRING)
