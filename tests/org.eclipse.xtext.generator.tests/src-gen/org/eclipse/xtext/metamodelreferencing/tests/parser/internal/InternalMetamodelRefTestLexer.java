// $ANTLR 3.0.1 ./src-gen/org/eclipse/xtext/metamodelreferencing/tests/parser/internal/InternalMetamodelRefTest.g 2008-05-16 07:53:34
...
public class InternalMetamodelRefTestLexer extends Lexer {
        ...
        try {
            ...
            if ( (LA9_0=='\"') ) {
                ...
                NoViableAltException nvae =
                    new NoViableAltException("137:1: RULE_STRING : ( '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | ~ ( '\\\\' | '\"' ) )* '\"' | '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | ~ ( '\\\\' | '\\'' ) )* '\\'' );", 9, 0, input);
    ...
    public void mTokens() throws RecognitionException {
        // ./src-gen/org/eclipse/xtext/metamodelreferencing/tests/parser/internal/InternalMetamodelRefTest.g:1:8: ( RULE_ID | RULE_SL_COMMENT | RULE_INT | RULE_LEXER_BODY | RULE_STRING | RULE_ML_COMMENT | RULE_WS | RULE_ANY_OTHER )
        int alt12=8;
        ...
        if ( (LA12_0=='^') ) {
            ...
            NoViableAltException nvae =
                new NoViableAltException("1:1: Tokens : ( RULE_ID | RULE_SL_COMMENT | RULE_INT | RULE_LEXER_BODY | RULE_STRING | RULE_ML_COMMENT | RULE_WS | RULE_ANY_OTHER );", 12, 0, input);
