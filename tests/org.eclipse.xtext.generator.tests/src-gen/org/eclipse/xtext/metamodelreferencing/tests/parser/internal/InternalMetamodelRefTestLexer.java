// $ANTLR 3.0.1 ./src-gen/org/eclipse/xtext/metamodelreferencing/tests/parser/internal/InternalMetamodelRefTest.g 2008-05-21 11:52:55
...
public class InternalMetamodelRefTestLexer extends Lexer {
        ...
        try {
            ...
            if ( (LA3_0=='\"') ) {
                ...
                NoViableAltException nvae =
                    new NoViableAltException("155:1: RULE_STRING : ( '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | ~ ( '\\\\' | '\"' ) )* '\"' | '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | ~ ( '\\\\' | '\\'' ) )* '\\'' );", 3, 0, input);
    ...
    public final void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            // ./src-gen/org/eclipse/xtext/metamodelreferencing/tests/parser/internal/InternalMetamodelRefTest.g:157:10: ( ( '0' .. '9' )+ )
    ...
    public void mTokens() throws RecognitionException {
        // ./src-gen/org/eclipse/xtext/metamodelreferencing/tests/parser/internal/InternalMetamodelRefTest.g:1:8: ( RULE_STRING | RULE_INT | RULE_ML_COMMENT | RULE_LEXER_BODY | RULE_ID | RULE_WS | RULE_SL_COMMENT | RULE_ANY_OTHER )
        int alt12=8;
        ...
        if ( (LA12_0=='\"') ) {
            ...
            NoViableAltException nvae =
                new NoViableAltException("1:1: Tokens : ( RULE_STRING | RULE_INT | RULE_ML_COMMENT | RULE_LEXER_BODY | RULE_ID | RULE_WS | RULE_SL_COMMENT | RULE_ANY_OTHER );", 12, 0, input);
        ...
        switch (alt12) {
            ...
            case 2 :
                ...
                break;
            case 3 :
                // ./src-gen/org/eclipse/xtext/metamodelreferencing/tests/parser/internal/InternalMetamodelRefTest.g:1:31: RULE_ML_COMMENT
                {
                mRULE_ML_COMMENT(); 
