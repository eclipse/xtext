// $ANTLR 3.0.1 ./src-gen/org/eclipse/xtext/metamodelreferencing/tests/parser/internal/InternalMetamodelRefTest.g 2008-05-20 17:36:37
...
public class InternalMetamodelRefTestLexer extends Lexer {
        ...
        try {
            ...
            if ( (LA5_0=='\"') ) {
                ...
                NoViableAltException nvae =
                    new NoViableAltException("157:1: RULE_STRING : ( '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | ~ ( '\\\\' | '\"' ) )* '\"' | '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | ~ ( '\\\\' | '\\'' ) )* '\\'' );", 5, 0, input);
    ...
    public void mTokens() throws RecognitionException {
        // ./src-gen/org/eclipse/xtext/metamodelreferencing/tests/parser/internal/InternalMetamodelRefTest.g:1:8: ( RULE_SL_COMMENT | RULE_STRING | RULE_ML_COMMENT | RULE_LEXER_BODY | RULE_ID | RULE_INT | RULE_WS | RULE_ANY_OTHER )
        int alt12=8;
        ...
        if ( (LA12_0=='/') ) {
            ...
            NoViableAltException nvae =
                new NoViableAltException("1:1: Tokens : ( RULE_SL_COMMENT | RULE_STRING | RULE_ML_COMMENT | RULE_LEXER_BODY | RULE_ID | RULE_INT | RULE_WS | RULE_ANY_OTHER );", 12, 0, input);
        ...
        switch (alt12) {
            ...
            case 2 :
                ...
                break;
            case 3 :
                // ./src-gen/org/eclipse/xtext/metamodelreferencing/tests/parser/internal/InternalMetamodelRefTest.g:1:38: RULE_ML_COMMENT
                {
                mRULE_ML_COMMENT(); 
