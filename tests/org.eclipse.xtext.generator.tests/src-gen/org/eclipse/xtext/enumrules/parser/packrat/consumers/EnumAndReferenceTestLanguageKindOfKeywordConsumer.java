...
import org.eclipse.xtext.enumrules.services.EnumAndReferenceTestLanguageGrammarAccess.KindOfKeywordElements;

public final class EnumAndReferenceTestLanguageKindOfKeywordConsumer extends NonTerminalConsumer {

	private KindOfKeywordElements rule;	
	...
	public EnumAndReferenceTestLanguageKindOfKeywordConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public KindOfKeywordElements getRule() {
		return rule;
	}
	
	public void setRule(KindOfKeywordElements rule) {
		this.rule = rule;
		
		alternatives$1$Consumer = new Alternatives$1$Consumer(rule.getAlternatives());
		enumLiteralDeclaration$2$Consumer = new EnumLiteralDeclaration$2$Consumer(rule.getKindOfKeywordEnumLiteralDeclaration_0());
		enumLiteralDeclaration$4$Consumer = new EnumLiteralDeclaration$4$Consumer(rule.getAnotherEnumLiteralEnumLiteralDeclaration_1());
	}
