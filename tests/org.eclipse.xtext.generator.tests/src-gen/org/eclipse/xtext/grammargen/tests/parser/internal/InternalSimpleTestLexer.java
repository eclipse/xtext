// $ANTLR 3.0 ./src-gen/org/eclipse/xtext/grammargen/tests/parser/internal/InternalSimpleTest.g 2008-05-15 17:51:02
...
public class InternalSimpleTestLexer extends Lexer {
    ...
    public void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            // ./src-gen/org/eclipse/xtext/grammargen/tests/parser/internal/InternalSimpleTest.g:104:19: ( '//' (~ ( '\\n' | '\\r' ) )* ( '\\r' )? '\\n' )
            // ./src-gen/org/eclipse/xtext/grammargen/tests/parser/internal/InternalSimpleTest.g:104:19: '//' (~ ( '\\n' | '\\r' ) )* ( '\\r' )? '\\n'
            {
            match("//"); 

            // ./src-gen/org/eclipse/xtext/grammargen/tests/parser/internal/InternalSimpleTest.g:104:24: (~ ( '\\n' | '\\r' ) )*
            loop1:
            do {
                int alt1=2;
            ...
            // ./src-gen/org/eclipse/xtext/grammargen/tests/parser/internal/InternalSimpleTest.g:104:38: ( '\\r' )?
            int alt2=2;
    ...
    public void mRULE_INT() throws RecognitionException {
        try {
            int _type = RULE_INT;
            // ./src-gen/org/eclipse/xtext/grammargen/tests/parser/internal/InternalSimpleTest.g:110:12: ( ( '0' .. '9' )+ )
            // ./src-gen/org/eclipse/xtext/grammargen/tests/parser/internal/InternalSimpleTest.g:110:12: ( '0' .. '9' )+
            {
            // ./src-gen/org/eclipse/xtext/grammargen/tests/parser/internal/InternalSimpleTest.g:110:12: ( '0' .. '9' )+
            int cnt5=0;
            ...
            do {
                ...
                switch (alt5) {
            	case 1 :
            	    // ./src-gen/org/eclipse/xtext/grammargen/tests/parser/internal/InternalSimpleTest.g:110:13: '0' .. '9'
            	    {
            	    matchRange('0','9'); 
    ...
    public void mRULE_STRING() throws RecognitionException {
        try {
            ...
            // ./src-gen/org/eclipse/xtext/grammargen/tests/parser/internal/InternalSimpleTest.g:112:15: ( '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | ~ ( '\\\\' | '\"' ) )* '\"' | '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | ~ ( '\\\\' | '\\'' ) )* '\\'' )
            int alt8=2;
            ...
            if ( (LA8_0=='\"') ) {
                ...
                NoViableAltException nvae =
                    new NoViableAltException("112:1: RULE_STRING : ( '\"' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | ~ ( '\\\\' | '\"' ) )* '\"' | '\\'' ( '\\\\' ( 'b' | 't' | 'n' | 'f' | 'r' | '\\\"' | '\\'' | '\\\\' ) | ~ ( '\\\\' | '\\'' ) )* '\\'' );", 8, 0, input);
    ...
    public void mTokens() throws RecognitionException {
        // ./src-gen/org/eclipse/xtext/grammargen/tests/parser/internal/InternalSimpleTest.g:1:10: ( RULE_SL_COMMENT | RULE_ML_COMMENT | RULE_WS | RULE_INT | RULE_STRING | RULE_ID | RULE_LEXER_BODY | RULE_ANY_OTHER )
        int alt12=8;
        ...
        if ( (LA12_0=='/') ) {
            ...
            NoViableAltException nvae =
                new NoViableAltException("1:1: Tokens : ( RULE_SL_COMMENT | RULE_ML_COMMENT | RULE_WS | RULE_INT | RULE_STRING | RULE_ID | RULE_LEXER_BODY | RULE_ANY_OTHER );", 12, 0, input);
        ...
        switch (alt12) {
            case 1 :
                ...
                break;
            case 2 :
                // ./src-gen/org/eclipse/xtext/grammargen/tests/parser/internal/InternalSimpleTest.g:1:26: RULE_ML_COMMENT
                {
                mRULE_ML_COMMENT(); 
