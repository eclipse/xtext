...
parse returns [EObject current] : {currentNode = createCompositeNode(// org.eclipse.xtext.impl.ParserRuleImpl@e5f01b (name: Foo)
...
(
   ...
   lv_name=RULE_ID{ createLeafNode(// org.eclipse.xtext.impl.RuleCallImpl@7a1686 (cardinality: null) (name: ID)
