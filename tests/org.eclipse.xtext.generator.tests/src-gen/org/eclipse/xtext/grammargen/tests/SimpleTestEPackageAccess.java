...
public class SimpleTestEPackageAccess extends org.eclipse.xtext.core.parser.BaseEPackageAccess {
	...
	public static EPackage getSimpleTestEPackage() {	
		if (!EPackage.Registry.INSTANCE.containsKey(SIMPLETEST_NS_URI)) {
			EPackage p = loadEcoreFile(SimpleTestEPackageAccess.class.getClassLoader(),"org/eclipse/xtext/grammargen/tests/SimpleTest.ecore");
			if (p!=null) {
