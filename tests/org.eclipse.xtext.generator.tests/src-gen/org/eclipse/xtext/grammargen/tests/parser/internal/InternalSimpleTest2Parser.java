...
public class InternalSimpleTest2Parser extends Parser {
        ...
        try {
            ...
            switch (alt2) {
                case 1 :
                    ...
                    match(input,11,FOLLOW_11_in_ruleChild107); 
            ...
            match(input,12,FOLLOW_12_in_ruleChild114); 
            ...
            match(input,13,FOLLOW_13_in_ruleChild143); 

            }

            match(input,14,FOLLOW_14_in_ruleChild146); 
    ...
    public static final BitSet FOLLOW_ruleChild_in_ruleModel70 = new BitSet(new long[]{0x0000000000001802L});
    public static final BitSet FOLLOW_11_in_ruleChild107 = new BitSet(new long[]{0x0000000000001000L});
    public static final BitSet FOLLOW_12_in_ruleChild114 = new BitSet(new long[]{0x0000000000000010L});
    public static final BitSet FOLLOW_RULE_ID_in_ruleChild123 = new BitSet(new long[]{0x0000000000000020L});
    public static final BitSet FOLLOW_RULE_INT_in_ruleChild136 = new BitSet(new long[]{0x0000000000002000L});
    public static final BitSet FOLLOW_13_in_ruleChild143 = new BitSet(new long[]{0x0000000000004000L});
    public static final BitSet FOLLOW_14_in_ruleChild146 = new BitSet(new long[]{0x0000000000000002L});
