 ...
 * <ul>
 *   <li>{@link org.eclipse.xtext.validation.csvalidationtest.impl.SimpleMultiplicitiesImpl#getVal1 <em>Val1</em>}</li>
 *   <li>{@link org.eclipse.xtext.validation.csvalidationtest.impl.SimpleMultiplicitiesImpl#getVal2 <em>Val2</em>}</li>
 *   <li>{@link org.eclipse.xtext.validation.csvalidationtest.impl.SimpleMultiplicitiesImpl#getVal3 <em>Val3</em>}</li>
 *   <li>{@link org.eclipse.xtext.validation.csvalidationtest.impl.SimpleMultiplicitiesImpl#getVal4 <em>Val4</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SimpleMultiplicitiesImpl extends MinimalEObjectImpl.Container implements SimpleMultiplicities
{
  /**
   ...
   * @generated
   */
  protected SimpleMultiplicitiesImpl()
  {
    super();
  }
  ...
  public void setVal1(String newVal1)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CsvalidationtestPackage.SIMPLE_MULTIPLICITIES__VAL1, oldVal1, val1));
  }
  ...
  public void setVal2(String newVal2)
  {
    ...
    val2 = newVal2;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CsvalidationtestPackage.SIMPLE_MULTIPLICITIES__VAL2, oldVal2, val2));
  }
  ...
  public EList<String> getVal4()
  {
    if (val4 == null)
    {
      val4 = new EDataTypeEList<String>(String.class, this, CsvalidationtestPackage.SIMPLE_MULTIPLICITIES__VAL4);
    }
    return val4;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case CsvalidationtestPackage.SIMPLE_MULTIPLICITIES__VAL1:
        return getVal1();
      case CsvalidationtestPackage.SIMPLE_MULTIPLICITIES__VAL2:
        return getVal2();
      case CsvalidationtestPackage.SIMPLE_MULTIPLICITIES__VAL3:
        return getVal3();
      case CsvalidationtestPackage.SIMPLE_MULTIPLICITIES__VAL4:
        return getVal4();
    }
