...
public final class ConcreteSyntaxValidationTestLanguageUnassignedAction3Consumer extends NonTerminalConsumer {
	...
	protected class RuleCall$13$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(idConsumer, "val1", false, false, getElement(), getRuleCall$13$Delimiter(), optional);
		}
	}
	...
	protected class RuleCall$15$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(idConsumer, "val2", false, false, getElement(), getRuleCall$15$Delimiter(), optional);
		}
	}

	public ConcreteSyntaxValidationTestLanguageUnassignedAction3Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public UnassignedAction3Elements getRule() {
		return rule;
	}
	
	public void setRule(UnassignedAction3Elements rule) {
		this.rule = rule;
		
		group$1$Consumer = new Group$1$Consumer(rule.getGroup());
		keyword$2$Consumer = new Keyword$2$Consumer(rule.getNumberSignDigitOneDigitZeroKeyword_0());
		...
		action$6$Consumer = new Action$6$Consumer(rule.getUnassignedAction2Sub1Action_1_0_1());
		...
		action$10$Consumer = new Action$10$Consumer(rule.getUnassignedAction2Sub2Action_1_1_1());
		assignment$12$Consumer = new Assignment$12$Consumer(rule.getVal1Assignment_2());
		ruleCall$13$Consumer = new RuleCall$13$Consumer(rule.getVal1IDTerminalRuleCall_2_0());
		assignment$14$Consumer = new Assignment$14$Consumer(rule.getVal2Assignment_3());
		ruleCall$15$Consumer = new RuleCall$15$Consumer(rule.getVal2IDTerminalRuleCall_3_0());
	}
