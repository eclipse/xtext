...
public final class ConcreteSyntaxValidationTestLanguageSimpleAlternativeConsumer extends NonTerminalConsumer {
	...
	protected class RuleCall$7$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(idConsumer, "val1", false, false, getElement(), getRuleCall$7$Delimiter(), optional);
		}
	}
	...
	public ConcreteSyntaxValidationTestLanguageSimpleAlternativeConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public SimpleAlternativeElements getRule() {
		return rule;
	}
	
	public void setRule(SimpleAlternativeElements rule) {
		this.rule = rule;
		...
		assignment$6$Consumer = new Assignment$6$Consumer(rule.getVal1Assignment_1_0_1());
		ruleCall$7$Consumer = new RuleCall$7$Consumer(rule.getVal1IDTerminalRuleCall_1_0_1_0());
		...
		assignment$10$Consumer = new Assignment$10$Consumer(rule.getVal2Assignment_1_1_1());
		ruleCall$11$Consumer = new RuleCall$11$Consumer(rule.getVal2IDTerminalRuleCall_1_1_1_0());
	}
