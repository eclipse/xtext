...
public final class ConcreteTestLanguageRootRuleConsumer extends NonTerminalConsumer {
	...
	public void setRule(RootRuleElements rule) {
		...
		ruleCall$4$Consumer = new RuleCall$4$Consumer(rule.ele000ParserRuleCallConcreteParserRule());
		ruleCall$5$Consumer = new RuleCall$5$Consumer(rule.ele001ParserRuleCallCallOverridenParserRule());
		ruleCall$6$Consumer = new RuleCall$6$Consumer(rule.ele01ParserRuleCallCallExtendedParserRule());
		ruleCall$7$Consumer = new RuleCall$7$Consumer(rule.ele1ParserRuleCallOverridableParserRule2());
	}
