...
public class AbstractTestLanguagePackratParser extends AbstractPackratParser {
	...
	@Override
	protected AbstractTestLanguageParserConfiguration createParserConfiguration(ICharSequenceWithOffset input,
		...
		return new AbstractTestLanguageParserConfiguration(input, markerFactory, tokenAcceptor, hiddenTokenHandler, consumerUtil);
	}
