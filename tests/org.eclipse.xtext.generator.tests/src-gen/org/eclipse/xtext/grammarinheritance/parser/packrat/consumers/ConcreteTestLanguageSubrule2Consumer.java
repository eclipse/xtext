...
import org.eclipse.xtext.grammarinheritance.services.ConcreteTestLanguageGrammarAccess.Subrule2Elements;

import org.eclipse.xtext.grammarinheritance.parser.packrat.consumers.AbstractTestLanguageIDConsumer;
import org.eclipse.xtext.builtin.parser.packrat.consumers.XtextBuiltinSTRINGConsumer;

@SuppressWarnings("unused")
public final class ConcreteTestLanguageSubrule2Consumer extends NonTerminalConsumer {

	private Subrule2Elements rule;
	...
	public ConcreteTestLanguageSubrule2Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	protected int consumeGroup$1(int entryPoint) throws Exception {
		...
		switch(entryPoint) {
			...
			case 2:
				...
				if (result!=ConsumeResult.SUCCESS) {
					error("Another token expected.", getRule().ele1AssignmentSub2());
					marker.commit();
					announceLevelFinished();
					return result;
				}
	...
	protected int consumeRuleCall$7(int entryPoint) throws Exception {
		return consumeTerminal(stringConsumer, "sub2", false, false, getRule().ele10LexerRuleCallSTRING(), getRuleCall$7$Delimiter());
	}

	public Subrule2Elements getRule() {
	// ConcreteTestLanguageGrammarAccess.INSTANCE.prSubrule2()
		return rule;
	}
	
	public void setRule(Subrule2Elements rule) {
		this.rule = rule;
	}
