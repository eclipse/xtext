...
import org.eclipse.xtext.grammarinheritance.services.ConcreteTestLanguageGrammarAccess.Subrule1Elements;

import org.eclipse.xtext.grammarinheritance.parser.packrat.consumers.AbstractTestLanguageIDConsumer;

@SuppressWarnings("unused")
public final class ConcreteTestLanguageSubrule1Consumer extends NonTerminalConsumer {

	private Subrule1Elements rule;
	...
	public ConcreteTestLanguageSubrule1Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
		...
		switch(entryPoint) {
			...
			case 0:
				...
				if (result!=ConsumeResult.SUCCESS) {
					error("Another token expected.", getRule().ele00KeywordSubrule1());
					marker.commit();
	...
	// ConcreteTestLanguageGrammarAccess.INSTANCE.prSubrule1()
		return rule;
	}
	
	public void setRule(Subrule1Elements rule) {
		this.rule = rule;
	}
