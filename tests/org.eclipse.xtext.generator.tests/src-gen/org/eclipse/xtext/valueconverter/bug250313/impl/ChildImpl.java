 ...
 * </copyright>
 *
 * $Id: ChildImpl.java,v 1.4 2009/02/19 16:26:58 sefftinge Exp $
 */
...
public class ChildImpl extends EObjectImpl implements Child
{
  ...
  {
    return Bug250313Package.Literals.CHILD;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Bug250313Package.CHILD__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case Bug250313Package.CHILD__NAME:
        return getName();
    }
