...
public class Bug250313PackratParser extends AbstractPackratParser {
	...
	@Override
	protected Bug250313ParserConfiguration createParserConfiguration(ICharSequenceWithOffset input,
		...
		return new Bug250313ParserConfiguration(input, markerFactory, tokenAcceptor, hiddenTokenHandler, consumerUtil);
	}
