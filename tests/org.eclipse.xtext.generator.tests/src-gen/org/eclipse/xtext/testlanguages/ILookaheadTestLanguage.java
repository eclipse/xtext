...
public interface ILookaheadTestLanguage extends ILanguage {
	 ...
	 */
	public static final String ID = "org.eclipse.xtext.testlanguages.LookaheadTestLanguage";
	public static final String NAME = "LookaheadTestLanguage";
	public static final String NAMESPACE = "org.eclipse.xtext.testlanguages";
	public static final String[] FILE_EXTENSIONS = new String[]{"lookaheadtestlanguage"};
