...
/**
 * GENERATED! Manual modification goes to PartialParserTestLanguageRuntimeModule
 */
public abstract class AbstractPartialParserTestLanguageRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		...
		binder.bind(IServiceScope.class).toInstance(org.eclipse.xtext.testlanguages.IPartialParserTestLanguage.SCOPE);
	}
