...
public interface IPartialParserTestLanguage extends ILanguage {
	 ...
	 */
	public static final String ID = "org.eclipse.xtext.testlanguages.PartialParserTestLanguage";
	public static final String NAME = "PartialParserTestLanguage";
	public static final String NAMESPACE = "org.eclipse.xtext.testlanguages";
	public static final String[] FILE_EXTENSIONS = new String[]{"partialparsertestlanguage"};
