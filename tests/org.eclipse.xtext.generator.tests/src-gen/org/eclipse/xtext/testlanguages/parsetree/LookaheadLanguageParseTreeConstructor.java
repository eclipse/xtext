...
import org.eclipse.xtext.testlanguages.parsetree.internal.InternalLookaheadLanguageParseTreeConstructor;
...
public class LookaheadLanguageParseTreeConstructor extends AbstractParseTreeConstructor {
	...
	public void update(EObject object) {
		new InternalLookaheadLanguageParseTreeConstructor(getFactory(),getGrammar(),getValueConverterService()).update(object);
	}
}
