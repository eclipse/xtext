...
public class OptionalEmptyLanguageLanguageFacade extends BaseEPackageAccess implements ILanguageFacade {

	public ILanguageDescriptor getLanguageDescriptor() {
		return OptionalEmptyLanguageStandaloneSetup.getLanguageDescriptor();
	}
	
    public String getLanguageId() {
    	return OptionalEmptyLanguageStandaloneSetup.LANGUAGE_ID;
    }
