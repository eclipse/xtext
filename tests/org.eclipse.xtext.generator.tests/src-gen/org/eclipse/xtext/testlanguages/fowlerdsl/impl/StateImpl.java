 ...
 * </copyright>
 *
 * $Id: StateImpl.java,v 1.4 2009/02/19 16:26:58 sefftinge Exp $
 */
...
public class StateImpl extends EObjectImpl implements State
{
  ...
  {
    return FowlerdslPackage.Literals.STATE;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FowlerdslPackage.STATE__NAME, oldName, name));
  }
  ...
  public EList<Command> getActions()
  {
    if (actions == null)
    {
      actions = new EObjectResolvingEList<Command>(Command.class, this, FowlerdslPackage.STATE__ACTIONS);
    }
    return actions;
  }
  ...
  public EList<Transition> getTransitions()
  {
    if (transitions == null)
    {
      transitions = new EObjectContainmentEList<Transition>(Transition.class, this, FowlerdslPackage.STATE__TRANSITIONS);
    }
    return transitions;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case FowlerdslPackage.STATE__TRANSITIONS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case FowlerdslPackage.STATE__NAME:
        return getName();
      case FowlerdslPackage.STATE__ACTIONS:
        return getActions();
      case FowlerdslPackage.STATE__TRANSITIONS:
