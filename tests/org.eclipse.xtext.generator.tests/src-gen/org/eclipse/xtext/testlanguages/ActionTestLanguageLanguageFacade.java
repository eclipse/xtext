...
public class ActionTestLanguageLanguageFacade extends BaseEPackageAccess implements ILanguageFacade {

	public ILanguageDescriptor getLanguageDescriptor() {
		return ActionTestLanguageStandaloneSetup.getLanguageDescriptor();
	}
	
    public String getLanguageId() {
    	return ActionTestLanguageStandaloneSetup.LANGUAGE_ID;
    }
