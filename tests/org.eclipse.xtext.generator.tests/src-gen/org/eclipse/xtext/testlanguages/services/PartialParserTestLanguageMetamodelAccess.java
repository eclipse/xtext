...
public class PartialParserTestLanguageMetamodelAccess extends BaseEPackageAccess implements IMetamodelAccess {
	...
	public static void init() {
		if (!EPackage.Registry.INSTANCE.containsKey(PARTIALPARSERTESTLANGUAGE_NS_URI))
			EPackage.Registry.INSTANCE.put(PARTIALPARSERTESTLANGUAGE_NS_URI, loadEcoreFile(PartialParserTestLanguageMetamodelAccess.class.getClassLoader(), "classpath:/org/eclipse/xtext/testlanguages/partialParserTestLanguage.ecore"));
	}
