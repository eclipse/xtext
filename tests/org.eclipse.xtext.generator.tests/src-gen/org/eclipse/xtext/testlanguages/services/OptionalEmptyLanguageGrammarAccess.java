...
public class OptionalEmptyLanguageGrammarAccess extends BaseEPackageAccess implements IGrammarAccess {
	...
	public ParserRule pr_Model() {
		return (ParserRule) getGrammar().eResource().getResourceSet().getEObject(URI.createURI("classpath:/org/eclipse/xtext/testlanguages/OptionalEmptyLanguage.xmi#//@parserRules.0"),true); 
	}

	public ParserRule pr_Greeting() {
		return (ParserRule) getGrammar().eResource().getResourceSet().getEObject(URI.createURI("classpath:/org/eclipse/xtext/testlanguages/OptionalEmptyLanguage.xmi#//@parserRules.1"),true); 
	}
