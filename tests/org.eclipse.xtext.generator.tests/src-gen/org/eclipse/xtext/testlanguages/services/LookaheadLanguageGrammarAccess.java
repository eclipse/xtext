...
public class LookaheadLanguageGrammarAccess extends BaseEPackageAccess implements IGrammarAccess {
	...
	public ParserRule pr_Entry() {
		return (ParserRule) getGrammar().eResource().getResourceSet().getEObject(URI.createURI("classpath:/org/eclipse/xtext/testlanguages/LookaheadLanguage.xmi#//@rules.0"),true); 
	}

	public ParserRule pr_Alts() {
		return (ParserRule) getGrammar().eResource().getResourceSet().getEObject(URI.createURI("classpath:/org/eclipse/xtext/testlanguages/LookaheadLanguage.xmi#//@rules.1"),true); 
	}

	public ParserRule pr_LookAhead0() {
		return (ParserRule) getGrammar().eResource().getResourceSet().getEObject(URI.createURI("classpath:/org/eclipse/xtext/testlanguages/LookaheadLanguage.xmi#//@rules.2"),true); 
	}

	public ParserRule pr_LookAhead1() {
		return (ParserRule) getGrammar().eResource().getResourceSet().getEObject(URI.createURI("classpath:/org/eclipse/xtext/testlanguages/LookaheadLanguage.xmi#//@rules.3"),true); 
	}

	public ParserRule pr_LookAhead2() {
		return (ParserRule) getGrammar().eResource().getResourceSet().getEObject(URI.createURI("classpath:/org/eclipse/xtext/testlanguages/LookaheadLanguage.xmi#//@rules.4"),true); 
	}

	public ParserRule pr_LookAhead3() {
		return (ParserRule) getGrammar().eResource().getResourceSet().getEObject(URI.createURI("classpath:/org/eclipse/xtext/testlanguages/LookaheadLanguage.xmi#//@rules.5"),true); 
	}

	public ParserRule pr_LookAhead4() {
		return (ParserRule) getGrammar().eResource().getResourceSet().getEObject(URI.createURI("classpath:/org/eclipse/xtext/testlanguages/LookaheadLanguage.xmi#//@rules.6"),true); 
	}
