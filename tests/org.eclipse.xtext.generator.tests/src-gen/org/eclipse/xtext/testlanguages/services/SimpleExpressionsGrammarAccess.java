...
public class SimpleExpressionsGrammarAccess extends BaseEPackageAccess implements IGrammarAccess {
	...
	public ParserRule pr_Sequence() {
		return (ParserRule) getGrammar().eResource().getResourceSet().getEObject(URI.createURI("classpath:/org/eclipse/xtext/testlanguages/SimpleExpressions.xmi#//@rules.0"),true); 
	}

	public ParserRule pr_Addition() {
		return (ParserRule) getGrammar().eResource().getResourceSet().getEObject(URI.createURI("classpath:/org/eclipse/xtext/testlanguages/SimpleExpressions.xmi#//@rules.1"),true); 
	}

	public ParserRule pr_Multiplication() {
		return (ParserRule) getGrammar().eResource().getResourceSet().getEObject(URI.createURI("classpath:/org/eclipse/xtext/testlanguages/SimpleExpressions.xmi#//@rules.2"),true); 
	}

	public ParserRule pr_Term() {
		return (ParserRule) getGrammar().eResource().getResourceSet().getEObject(URI.createURI("classpath:/org/eclipse/xtext/testlanguages/SimpleExpressions.xmi#//@rules.3"),true); 
	}

	public ParserRule pr_Atom() {
		return (ParserRule) getGrammar().eResource().getResourceSet().getEObject(URI.createURI("classpath:/org/eclipse/xtext/testlanguages/SimpleExpressions.xmi#//@rules.4"),true); 
	}

	public ParserRule pr_Parens() {
		return (ParserRule) getGrammar().eResource().getResourceSet().getEObject(URI.createURI("classpath:/org/eclipse/xtext/testlanguages/SimpleExpressions.xmi#//@rules.5"),true); 
	}
