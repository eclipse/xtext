...

{
		...
		if (!EPackage.Registry.INSTANCE.containsKey(TREETESTLANGUAGE_NS_URI))
			EPackage.Registry.INSTANCE.put(TREETESTLANGUAGE_NS_URI, loadEcoreFile(getClass().getClassLoader(), "classpath:/org/eclipse/xtext/testlanguages/TreeTestLanguage.ecore"));
