...
public abstract class LexerTestLanguageStandaloneSetup {
	...
	public synchronized static void doSetup() {
		if(!isInitialized) {
		    ...
		    Injector injector = Guice.createInjector(new org.eclipse.xtext.testlanguages.LexerTestLanguageRuntimeModule());
			ServiceRegistry.registerInjector(org.eclipse.xtext.testlanguages.ILexerTestLanguage.SCOPE, injector);
