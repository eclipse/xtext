...
public interface ILookaheadLang {
	 ...
	 */
	public static final String ID = "org.eclipse.xtext.testlanguages.LookaheadLang";
	public static final String NAME = "LookaheadLang";
