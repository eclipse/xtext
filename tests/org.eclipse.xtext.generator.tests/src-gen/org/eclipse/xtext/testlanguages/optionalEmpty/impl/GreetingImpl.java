 ...
 * </copyright>
 *
 * $Id: GreetingImpl.java,v 1.4 2009/02/19 16:27:10 sefftinge Exp $
 */
 ...
 * @generated
 */
public class GreetingImpl extends EObjectImpl implements Greeting
{
  /**
  ...
  {
    return OptionalEmptyPackage.Literals.GREETING;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, OptionalEmptyPackage.GREETING__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case OptionalEmptyPackage.GREETING__NAME:
        return getName();
    }
