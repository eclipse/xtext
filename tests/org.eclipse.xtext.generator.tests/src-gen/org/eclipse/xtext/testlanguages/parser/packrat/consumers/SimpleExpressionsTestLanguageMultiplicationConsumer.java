...
public final class SimpleExpressionsTestLanguageMultiplicationConsumer extends NonTerminalConsumer {
	...
	protected int consumeKeyword$9(int entryPoint) throws Exception {
		return consumeKeyword(getRule().ele10100KeywordAsterisk(), "operator", false, false, getKeyword$9$Delimiter());
	}

	protected int consumeKeyword$10(int entryPoint) throws Exception {
		return consumeKeyword(getRule().ele10101KeywordSolidus(), "operator", false, false, getKeyword$10$Delimiter());
	}
	...
	// SimpleExpressionsTestLanguageGrammarAccess.INSTANCE.prMultiplication()
		return rule;
	}
