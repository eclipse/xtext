...
public class ContentAssistTestLanguagePackratParser extends AbstractPackratParser {
	...
	@Override
	protected ContentAssistTestLanguageParserConfiguration createParserConfiguration(ICharSequenceWithOffset input,
		...
		return new ContentAssistTestLanguageParserConfiguration(input, markerFactory, tokenAcceptor, hiddenTokenHandler, consumerUtil);
	}
