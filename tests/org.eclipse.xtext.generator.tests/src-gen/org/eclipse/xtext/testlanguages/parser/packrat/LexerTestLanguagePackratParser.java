...
public class LexerTestLanguagePackratParser extends AbstractPackratParser {
	...
	@Override
	protected LexerTestLanguageParserConfiguration createParserConfiguration(ICharSequenceWithOffset input,
		...
		return new LexerTestLanguageParserConfiguration(input, markerFactory, tokenAcceptor, hiddenTokenHandler, consumerUtil);
	}
