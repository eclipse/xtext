...
public final class PartialParserTestLanguageAbstractChildConsumer extends NonTerminalConsumer {
	...
	protected class RuleCall$2$Consumer extends ElementConsumer<RuleCall> {
		...
		protected int doConsume() throws Exception {
			return consumeNonTerminal(firstConcreteConsumer, null, false, false, false, getElement());
		}
	}
	...
	protected class RuleCall$3$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume() throws Exception {
			return consumeNonTerminal(secondConcreteConsumer, null, false, false, false, getElement());
		}
	}
	...
	public void setRule(AbstractChildElements rule) {
		...
		ruleCall$2$Consumer = new RuleCall$2$Consumer(rule.ele0ParserRuleCallFirstConcrete());
		ruleCall$3$Consumer = new RuleCall$3$Consumer(rule.ele1ParserRuleCallSecondConcrete());
	}
