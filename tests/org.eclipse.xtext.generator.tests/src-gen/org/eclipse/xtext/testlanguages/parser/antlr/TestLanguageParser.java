...
public class TestLanguageParser extends org.eclipse.xtext.parser.antlr.AbstractAntlrParser {
	...
	protected IParseResult parse(String ruleName, ANTLRInputStream in) {
		org.eclipse.xtext.testlanguages.parser.antlr.internal.InternalTestLanguageLexer lexer = new org.eclipse.xtext.testlanguages.parser.antlr.internal.InternalTestLanguageLexer(in);
		XtextTokenStream stream = new XtextTokenStream(lexer, antlrTokenDefProvider);
		stream.setInitialHiddenTokens("RULE_WS", "RULE_ML_COMMENT", "RULE_SL_COMMENT");
		org.eclipse.xtext.testlanguages.parser.antlr.internal.InternalTestLanguageParser parser = new org.eclipse.xtext.testlanguages.parser.antlr.internal.InternalTestLanguageParser(
