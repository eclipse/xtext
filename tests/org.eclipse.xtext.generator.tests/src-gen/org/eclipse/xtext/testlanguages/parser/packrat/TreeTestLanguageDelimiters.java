...
public class TreeTestLanguageDelimiters {
	...
	public static ISequenceMatcher ALL_KEYWORDS = new SetBasedKeywordMatcher(TreeTestLanguageGrammarAccess.INSTANCE.getGrammar());
