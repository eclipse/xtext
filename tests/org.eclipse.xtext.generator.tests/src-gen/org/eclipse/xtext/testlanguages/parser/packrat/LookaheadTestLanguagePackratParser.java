...
public class LookaheadTestLanguagePackratParser extends AbstractPackratParser {
	...
	@Override
	protected LookaheadTestLanguageParserConfiguration createParserConfiguration(ICharSequenceWithOffset input,
		...
		return new LookaheadTestLanguageParserConfiguration(input, markerFactory, tokenAcceptor, hiddenTokenHandler, consumerUtil);
	}
