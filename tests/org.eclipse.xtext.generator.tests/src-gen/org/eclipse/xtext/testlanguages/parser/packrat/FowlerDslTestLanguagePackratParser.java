...
public class FowlerDslTestLanguagePackratParser extends AbstractPackratParser {
	...
	@Override
	protected FowlerDslTestLanguageParserConfiguration createParserConfiguration(ICharSequenceWithOffset input,
		...
		return new FowlerDslTestLanguageParserConfiguration(input, markerFactory, tokenAcceptor, hiddenTokenHandler, consumerUtil);
	}
