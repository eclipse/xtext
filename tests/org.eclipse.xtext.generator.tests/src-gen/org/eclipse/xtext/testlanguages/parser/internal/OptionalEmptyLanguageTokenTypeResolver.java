...
import org.eclipse.xtext.testlanguages.OptionalEmptyLanguageTokenTypes;
import org.eclipse.xtext.*;
import org.eclipse.xtext.parser.ITokenTypes;
import org.eclipse.xtext.parser.ParseException;
import org.eclipse.xtext.parsetree.AbstractNode;

public class OptionalEmptyLanguageTokenTypeResolver {
	...
	private static EObject getGrammarElement(String id) {
		return LanguageFacadeFactory.getFacade("org/eclipse/xtext/testlanguages/OptionalEmptyLanguage").getGrammar().eResource().getEObject(id);
	}
