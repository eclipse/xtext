...
public class TestLanguageDelimiters {
	...
	public static ISequenceMatcher ALL_KEYWORDS = new SetBasedKeywordMatcher(TestLanguageGrammarAccess.INSTANCE.getGrammar());
