...
public class PartialParserTestLanguagePackratParser extends AbstractPackratParser {
	...
	@Override
	protected PartialParserTestLanguageParserConfiguration createParserConfiguration(ICharSequenceWithOffset input,
		...
		return new PartialParserTestLanguageParserConfiguration(input, markerFactory, tokenAcceptor, hiddenTokenHandler, consumerUtil);
	}
