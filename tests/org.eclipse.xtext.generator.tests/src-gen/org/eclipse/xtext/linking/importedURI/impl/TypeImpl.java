...
public class TypeImpl extends MinimalEObjectImpl.Container implements Type
{
  ...
  {
    return ImportedURIPackage.Literals.TYPE;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ImportedURIPackage.TYPE__NAME, oldName, name));
  }
  ...
  public Type getExtends()
  {
    if (extends_ != null && extends_.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, ImportedURIPackage.TYPE__EXTENDS, oldExtends, extends_));
      }
    }
    return extends_;
  }
  ...
  public void setExtends(Type newExtends)
  {
    ...
    extends_ = newExtends;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ImportedURIPackage.TYPE__EXTENDS, oldExtends, extends_));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ImportedURIPackage.TYPE__NAME:
        return getName();
      case ImportedURIPackage.TYPE__EXTENDS:
