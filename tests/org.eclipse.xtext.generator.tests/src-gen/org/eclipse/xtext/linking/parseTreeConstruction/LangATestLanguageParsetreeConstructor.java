...
public class LangATestLanguageParsetreeConstructor extends AbstractParseTreeConstructor2 {
...
protected class Import_UriAssignment_1 extends AssignmentToken  {
	...
	public Import_UriAssignment_1(AbstractToken2 parent, AbstractToken2 next, int no, IInstanceDescription current) {
		super(parent, next, no, current);
	}
