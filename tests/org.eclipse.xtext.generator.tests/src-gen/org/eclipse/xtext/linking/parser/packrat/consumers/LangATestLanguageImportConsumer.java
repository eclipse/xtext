...
import org.eclipse.xtext.linking.services.LangATestLanguageGrammarAccess.ImportElements;
...
public final class LangATestLanguageImportConsumer extends NonTerminalConsumer {
	...
	public void setRule(ImportElements rule) {
		...
		assignment$3$Consumer = new Assignment$3$Consumer(rule.getUriAssignment_1());
		ruleCall$4$Consumer = new RuleCall$4$Consumer(rule.getUriSTRINGTerminalRuleCall_1_0());
	}
