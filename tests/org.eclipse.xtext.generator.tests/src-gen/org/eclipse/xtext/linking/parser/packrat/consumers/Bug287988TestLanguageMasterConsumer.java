...
public final class Bug287988TestLanguageMasterConsumer extends NonTerminalConsumer {
	...
	public Bug287988TestLanguageMasterConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public MasterElements getRule() {
		return rule;
	}
	
	public void setRule(MasterElements rule) {
		this.rule = rule;
		
		group$1$Consumer = new Group$1$Consumer(rule.getGroup());
		action$2$Consumer = new Action$2$Consumer(rule.getMasterAction_0());
		keyword$4$Consumer = new Keyword$4$Consumer(rule.getMasterKeyword_1());
	}
