...
public final class Bug287988TestLanguageRuleCallAttribute3Consumer extends NonTerminalConsumer {
	...
	private INonTerminalConsumer callMe3Consumer;
	...
	protected class RuleCall$2$Consumer extends ElementConsumer<RuleCall> {
		...
		protected int doConsume(boolean optional) throws Exception {
			return consumeNonTerminal(callMe3Consumer, null, false, false, false, getElement(), optional);
		}
	}
	...
	public Bug287988TestLanguageRuleCallAttribute3Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public RuleCallAttribute3Elements getRule() {
		return rule;
	}
	
	public void setRule(RuleCallAttribute3Elements rule) {
		this.rule = rule;
		
		group$1$Consumer = new Group$1$Consumer(rule.getGroup());
		ruleCall$2$Consumer = new RuleCall$2$Consumer(rule.getCallMe3ParserRuleCall_0());
	...
	public void setCallMe3Consumer(INonTerminalConsumer callMe3Consumer) {
		this.callMe3Consumer = callMe3Consumer;
	}
