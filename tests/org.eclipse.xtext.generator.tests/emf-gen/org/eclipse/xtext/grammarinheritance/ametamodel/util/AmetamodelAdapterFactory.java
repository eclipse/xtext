 ...
 * </copyright>
 *
 * $Id: AmetamodelAdapterFactory.java,v 1.1 2009/02/18 19:43:23 sefftinge Exp $
 */
 ...
 * @generated
 */
public class AmetamodelAdapterFactory extends AdapterFactoryImpl {
	/**
	 ...
	 * @generated
	 */
	protected static AmetamodelPackage modelPackage;
	 ...
	 * @generated
	 */
	public AmetamodelAdapterFactory() {
		if (modelPackage == null) {
			modelPackage = AmetamodelPackage.eINSTANCE;
		}
	}
	 ...
	 * @generated
	 */
	protected AmetamodelSwitch<Adapter> modelSwitch =
		new AmetamodelSwitch<Adapter>() {
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.xtext.grammarinheritance.ametamodel.AModel <em>AModel</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
