 ...
 * </copyright>
 *
 * $Id: XtextTestAdapterFactory.java,v 1.5 2009/02/19 21:07:56 sefftinge Exp $
 */
...
public class XtextTestAdapterFactory extends AdapterFactoryImpl
{
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.eclipse.xtext.xtextTest.LexerRule <em>Lexer Rule</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
