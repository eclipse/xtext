...
import org.eclipse.xtext.services.XtextGrammarTestLanguageGrammarAccess.AssignableAlternativesElements;

public final class XtextGrammarTestLanguageAssignableAlternativesConsumer extends NonTerminalConsumer {
	...
	protected class RuleCall$2$Consumer extends ElementConsumer<RuleCall> {
		...
		protected int doConsume(boolean optional) throws Exception {
			return consumeNonTerminal(assignableTerminalConsumer, null, false, false, false, getElement(), optional);
		}
	}
	...
	public XtextGrammarTestLanguageAssignableAlternativesConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public AssignableAlternativesElements getRule() {
		return rule;
	}
	
	public void setRule(AssignableAlternativesElements rule) {
		this.rule = rule;
		
		group$1$Consumer = new Group$1$Consumer(rule.eleGroup());
		ruleCall$2$Consumer = new RuleCall$2$Consumer(rule.ele0ParserRuleCallAssignableTerminal());
		...
		ruleCall$9$Consumer = new RuleCall$9$Consumer(rule.ele1110ParserRuleCallAssignableTerminal());
	}
