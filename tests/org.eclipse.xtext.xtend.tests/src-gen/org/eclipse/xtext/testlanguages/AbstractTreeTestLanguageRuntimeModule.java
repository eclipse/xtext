...
/**
 * GENERATED! Manual modification goes to TreeTestLanguageRuntimeModule
 */
public abstract class AbstractTreeTestLanguageRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		...
		binder.bind(IServiceScope.class).toInstance(org.eclipse.xtext.testlanguages.ITreeTestLanguage.SCOPE);
	}
	...
	public Class<? extends org.eclipse.xtext.crossref.IScopeProvider> bindIScopeProvider() {
		return org.eclipse.xtext.testlanguages.XtendTreeTestLanguageScopeProvider.class;
	}
