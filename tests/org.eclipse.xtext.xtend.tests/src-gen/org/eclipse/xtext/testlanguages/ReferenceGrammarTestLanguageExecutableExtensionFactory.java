...
public class ReferenceGrammarTestLanguageExecutableExtensionFactory implements IExecutableExtensionFactory, IExecutableExtension {
	...
	public Object create() throws CoreException {
		...
		try {
			...
			return org.eclipse.xtext.xtend.XtendTestsActivator.getInstance().getInjector("org.eclipse.xtext.testlanguages.ReferenceGrammarTestLanguage").getInstance(class1);
		}
		catch (Exception e) {
			log.error(e);
