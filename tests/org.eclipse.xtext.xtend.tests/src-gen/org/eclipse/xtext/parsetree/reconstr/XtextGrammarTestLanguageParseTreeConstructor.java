...
protected class Grammar_0_0_0_0_0_Alternatives extends AlternativesToken {
	...
	public Alternatives getGrammarElement() {
		return XtextGrammarTestLanguageGrammarAccess.INSTANCE.prGrammar().ele00000Alternatives();
	}
...
protected class Grammar_0_0_0_0_0_0_Assignment_abstract extends AssignmentToken  {
	...
	public Assignment getGrammarElement() {
		return XtextGrammarTestLanguageGrammarAccess.INSTANCE.prGrammar().ele000000AssignmentAbstract();
	}
...
protected class Grammar_0_0_0_0_0_1_Keyword_language extends KeywordToken  {
	...
	public Keyword getGrammarElement() {
		return XtextGrammarTestLanguageGrammarAccess.INSTANCE.prGrammar().ele000001KeywordLanguage();
	}	
}
...
protected class Grammar_0_0_0_0_1_Assignment_idElements extends AssignmentToken  {
	...
	public Assignment getGrammarElement() {
		return XtextGrammarTestLanguageGrammarAccess.INSTANCE.prGrammar().ele00001AssignmentIdElements();
	}
	...
	protected Solution createSolution() {
		...
		if(Boolean.TRUE.booleanValue()) { // xtext::RuleCall FIXME: check if value is valid for lexer rule
			...
			element = XtextGrammarTestLanguageGrammarAccess.INSTANCE.prGrammar().ele000010LexerRuleCallID();
			return new Solution(obj);
		}
		return null;
	}
...
protected class Grammar_0_0_0_1_1_Assignment_idElements extends AssignmentToken  {
	...
	public Assignment getGrammarElement() {
		return XtextGrammarTestLanguageGrammarAccess.INSTANCE.prGrammar().ele00011AssignmentIdElements();
	}
	...
	protected Solution createSolution() {
		...
		if(Boolean.TRUE.booleanValue()) { // xtext::RuleCall FIXME: check if value is valid for lexer rule
			type = AssignmentType.LRC;
			element = XtextGrammarTestLanguageGrammarAccess.INSTANCE.prGrammar().ele000110LexerRuleCallID();
			return new Solution(obj);
		}
		return null;
	}
...
protected class Grammar_0_0_1_0_0_Keyword_extends extends KeywordToken  {
	...
	public Keyword getGrammarElement() {
		return XtextGrammarTestLanguageGrammarAccess.INSTANCE.prGrammar().ele00100KeywordExtends();
	}	
}
...
protected class Grammar_0_0_1_0_1_Assignment_superGrammarIdElements extends AssignmentToken  {
	...
	public Assignment getGrammarElement() {
		return XtextGrammarTestLanguageGrammarAccess.INSTANCE.prGrammar().ele00101AssignmentSuperGrammarIdElements();
	}
	...
	protected Solution createSolution() {
		...
		if(Boolean.TRUE.booleanValue()) { // xtext::RuleCall FIXME: check if value is valid for lexer rule
			type = AssignmentType.LRC;
			element = XtextGrammarTestLanguageGrammarAccess.INSTANCE.prGrammar().ele001010LexerRuleCallID();
			return new Solution(obj);
		}
		return null;
	}
...
protected class Grammar_0_0_1_1_Group extends GroupToken {
	...
	public Group getGrammarElement() {
		return XtextGrammarTestLanguageGrammarAccess.INSTANCE.prGrammar().ele0011Group();
	}
...
protected class Grammar_0_0_1_1_1_Assignment_superGrammarIdElements extends AssignmentToken  {
	...
	public Assignment getGrammarElement() {
		return XtextGrammarTestLanguageGrammarAccess.INSTANCE.prGrammar().ele00111AssignmentSuperGrammarIdElements();
	}
	...
	protected Solution createSolution() {
		...
		if(Boolean.TRUE.booleanValue()) { // xtext::RuleCall FIXME: check if value is valid for lexer rule
			type = AssignmentType.LRC;
			element = XtextGrammarTestLanguageGrammarAccess.INSTANCE.prGrammar().ele001110LexerRuleCallID();
			return new Solution(obj);
		}
		return null;
	}
