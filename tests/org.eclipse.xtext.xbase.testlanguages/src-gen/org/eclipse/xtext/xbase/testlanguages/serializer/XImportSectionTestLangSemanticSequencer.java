...
public class XImportSectionTestLangSemanticSequencer extends XbaseSemanticSequencer {
	...
	public void createSequence(EObject context, EObject semanticObject) {
		...
		else if(semanticObject.eClass().getEPackage() == XImportSectionTestLangPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			case XImportSectionTestLangPackage.IMPORT_SECTION_TEST_LANGUAGE_ROOT:
				if(context == grammarAccess.getImportSectionTestLanguageRootRule()) {
	 ...
	 */
	protected void sequence_ImportSectionTestLanguageRoot(EObject context, ImportSectionTestLanguageRoot semanticObject) {
