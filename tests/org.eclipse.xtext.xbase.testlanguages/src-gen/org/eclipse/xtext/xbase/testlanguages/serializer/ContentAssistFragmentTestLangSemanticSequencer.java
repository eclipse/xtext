...
public class ContentAssistFragmentTestLangSemanticSequencer extends XbaseSemanticSequencer {
	...
	public void createSequence(EObject context, EObject semanticObject) {
		if(semanticObject.eClass().getEPackage() == ContentAssistFragmentTestLangPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
	 ...
	 */
	protected void sequence_ContentAssistFragmentTestLanguageRoot(EObject context, ContentAssistFragmentTestLanguageRoot semanticObject) {
