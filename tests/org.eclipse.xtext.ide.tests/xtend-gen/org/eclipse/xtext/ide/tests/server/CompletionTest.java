...
public class CompletionTest extends AbstractTestLangLanguageServerTest {
  ...
  public void testCompletion_01() {
    final Procedure1<TestCompletionConfiguration> _function = new Procedure1<TestCompletionConfiguration>() {
      @Override
      public void apply(final TestCompletionConfiguration it) {
