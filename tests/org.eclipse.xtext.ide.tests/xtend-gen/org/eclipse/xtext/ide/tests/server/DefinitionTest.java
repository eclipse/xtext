...
public class DefinitionTest extends AbstractTestLangLanguageServerTest {
  ...
  public void testDefinition_01() {
    final Procedure1<DefinitionTestConfiguration> _function = new Procedure1<DefinitionTestConfiguration>() {
      @Override
      public void apply(final DefinitionTestConfiguration it) {
