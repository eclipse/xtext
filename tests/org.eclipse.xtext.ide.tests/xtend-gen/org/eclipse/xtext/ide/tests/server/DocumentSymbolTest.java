...
public class DocumentSymbolTest extends AbstractTestLangLanguageServerTest {
  ...
  public void testDocumentSymbol_01() {
    final Procedure1<DocumentSymbolConfiguraiton> _function = new Procedure1<DocumentSymbolConfiguraiton>() {
      @Override
      public void apply(final DocumentSymbolConfiguraiton it) {
