...
<code><a href="eclipse-xtext-open:java:/Objects/java.util.Collections%23java.util.Collections">java.util.Collections</a></code><dl><dt>Parameters:</dt><dd><b>a</b> </dd><dd><b>b</b> </dd></dl>'''.toString,docu)
	}
...
<code>Collections</code><dl><dt>Parameters:</dt><dd><b>a</b> </dd><dd><b>b</b> </dd></dl>'''.toString,docu)
	...
	def testJavaDocWithLinkToMethodWithoutLabel(){
		...
		val docu = documentationProvider.getDocumentation(member)
		assertEquals('''SimpleJavaDoc
<code><a href="eclipse-xtext-open:java:/Objects/java.util.Collections%23java.util.Collections.sort(java.util.List)">java.util.Collections#sort(java.util.List)</a></code><dl><dt>Parameters:</dt><dd><b>a</b> </dd><dd><b>b</b> </dd></dl>'''.toString,docu)
	}
	...
	def testJavaDocWithLinkToMethodWithLabel(){
		...
		val docu = documentationProvider.getDocumentation(member)
		assertEquals('''SimpleJavaDoc
<code><a href="eclipse-xtext-open:java:/Objects/java.util.Collections%23java.util.Collections.sort(java.util.List)"> label foo bar</a></code><dl><dt>Parameters:</dt><dd><b>a</b> </dd><dd><b>b</b> </dd></dl>'''.toString,docu)
	}
	...
	def testJavaDocWithLinkToXtendFunction(){
		...
		val docu = documentationProvider.getDocumentation(member)
		assertEquals('''SimpleJavaDoc
<code><a href="eclipse-xtext-open:__synthetic0.xtend%23/1/@members.2">testpackage.Foo#foo(java.util.List)</a></code><dl><dt>Parameters:</dt><dd><b>a</b> </dd><dd><b>b</b> </dd></dl>'''.toString, docu)
	}
