...
public class JvmOutlineTests extends AbstractOutlineTests {
	...
	public void testActiveAnnotation() throws Exception {
		...
		IProject clientProj = WorkbenchTestHelper.createPluginProject(WorkbenchTestHelper.TESTPROJECT_NAME + "-client",
				Iterables.toArray(deps, String.class));
		...
		clientAAFile.child(2, "AAOutlineTestInterface - clienttest.test").leaf(0, "myPublicMethod() : void");
		WorkbenchTestHelper.deleteProject(getWorkbenchTestHelper().getProject());
