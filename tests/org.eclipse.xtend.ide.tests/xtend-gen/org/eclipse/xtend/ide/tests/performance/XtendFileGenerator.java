...
import org.eclipse.xtend.ide.tests.performance.GeneratorConfig;
...
public class XtendFileGenerator {
  public CharSequence getContents(final GeneratorConfig conf) {
    ...
    _builder.newLine();
    _builder.append("import org.eclipse.xtext.xbase.lib.Functions");
    _builder.newLine();
  ...
  public Pair<String,CharSequence> getAmount() {
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("private BigDecimal value = null;");
    _builder.newLine();
    _builder.newLine();
    _builder.append("\t");
    _builder.append("public Amount(BigDecimal value) {");
    _builder.newLine();
    _builder.append("\t\t");
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("public Amount(String value) {");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("super();");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("public Amount operator_plus(Amount other) {");
    _builder.newLine();
    _builder.append("\t\t");
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("public Amount operator_minus(Amount other) {");
    _builder.newLine();
    _builder.append("\t\t");
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("public Amount operator_multiply(int factor) {");
    _builder.newLine();
    _builder.append("\t\t");
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("public Amount operator_divide(int divisor) {");
    _builder.newLine();
    _builder.append("\t\t");
  ...
  public Pair<String,CharSequence> getCircle() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public class Circle implements Shape {");
    _builder.newLine();
    _builder.append("\t");
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("public Circle(int diameter) {");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("super();");
    _builder.newLine();
  ...
  public Pair<String,CharSequence> getNetNode() {
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("public Iterable<NetNode> getReferences() {");
    _builder.newLine();
    _builder.append("\t\t");
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("public void setReferences(Iterable<NetNode> references) {");
    _builder.newLine();
    _builder.append("\t\t");
  ...
  public Pair<String,CharSequence> getPerson() {
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("public Person(String forename, String name) {");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("super();");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("public Set<Person> getFriends() {");
    _builder.newLine();
    _builder.append("\t\t");
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("public void setFriends(Set<Person> friends) {");
    _builder.newLine();
    _builder.append("\t\t");
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("public String getForename() {");
    _builder.newLine();
    _builder.append("\t\t");
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("public void setForename(String forename) {");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("this.forename = forename;");
    _builder.newLine();
  ...
  public Pair<String,CharSequence> getRectangle() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public class Rectangle implements Shape {");
    _builder.newLine();
    _builder.append("\t");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("public int height, width;");
    _builder.newLine();
    _builder.newLine();
    _builder.append("\t");
    _builder.append("public Rectangle(int height, int width) {");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("super();");
    _builder.newLine();
  ...
  public Pair<String,CharSequence> getShape() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("public interface Shape {");
    _builder.newLine();
    _builder.append("}");
    _builder.newLine();
