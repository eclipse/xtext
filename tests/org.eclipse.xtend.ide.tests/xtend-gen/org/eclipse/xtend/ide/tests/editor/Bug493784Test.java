...
public class Bug493784Test extends AbstractXtendUITestCase {
  ...
  private Integer getListenerCount(final XtextEditor editor) {
    ...
    final IUnitOfWork<Integer, XtextResource> _function = new IUnitOfWork<Integer, XtextResource>() {
      @Override
      public Integer exec(final XtextResource it) throws Exception {
        ...
        final Function1<Map.Entry<Notifier, List<Runnable>>, Integer> _function = new Function1<Map.Entry<Notifier, List<Runnable>>, Integer>() {
          @Override
          public Integer apply(final Map.Entry<Notifier, List<Runnable>> it) {
            List<Runnable> _value = it.getValue();
            int _size = 0;
            if (_value!=null) {
              _size=_value.size();
            }
        ...
        Iterable<Integer> _map = IterableExtensions.<Map.Entry<Notifier, List<Runnable>>, Integer>map(_entrySet, _function);
        ...
        return IterableExtensions.<Integer>reduce(_filterNull, _function_1);
      }
    };
