...
public class SeveralEditorsQueuedBuildTest extends AbstractQueuedBuildDataTest {
  ...
  public void saveSeveralEditorsOneByOne() {
    try {
      ...
      Collection<UnconfirmedStructuralChangesDelta> _unconfirmedDeltas = this.queuedBuildDataContribution.getUnconfirmedDeltas();
      ...
      Collection<UnconfirmedStructuralChangesDelta> _unconfirmedDeltas_1 = this.queuedBuildDataContribution.getUnconfirmedDeltas();
      this.assertThereAreNotDeltas(_unconfirmedDeltas_1);
      Collection<IResourceDescription.Delta> _andRemovePendingDeltas_1 = this.queuedBuildData.getAndRemovePendingDeltas();
      this.assertThereAreNotDeltas(_andRemovePendingDeltas_1);
      this._javaEditorExtension.save(barEditor);
      Collection<UnconfirmedStructuralChangesDelta> _unconfirmedDeltas_2 = this.queuedBuildDataContribution.getUnconfirmedDeltas();
      this.assertThereAreDeltas(_unconfirmedDeltas_2, "mypackage.Bar");
      Collection<IResourceDescription.Delta> _andRemovePendingDeltas_2 = this.queuedBuildData.getAndRemovePendingDeltas();
      this.assertThereAreNotDeltas(_andRemovePendingDeltas_2);
      this.confirmDeltas();
      Collection<UnconfirmedStructuralChangesDelta> _unconfirmedDeltas_3 = this.queuedBuildDataContribution.getUnconfirmedDeltas();
      this.assertThereAreNotDeltas(_unconfirmedDeltas_3);
      Collection<IResourceDescription.Delta> _andRemovePendingDeltas_3 = this.queuedBuildData.getAndRemovePendingDeltas();
      this.assertThereAreDeltas(_andRemovePendingDeltas_3, "mypackage.Bar");
      this._javaEditorExtension.save(fooEditor);
      Collection<UnconfirmedStructuralChangesDelta> _unconfirmedDeltas_4 = this.queuedBuildDataContribution.getUnconfirmedDeltas();
      this.assertThereAreDeltas(_unconfirmedDeltas_4, "mypackage.Foo");
      Collection<IResourceDescription.Delta> _andRemovePendingDeltas_4 = this.queuedBuildData.getAndRemovePendingDeltas();
      this.assertThereAreNotDeltas(_andRemovePendingDeltas_4);
      this.confirmDeltas();
      Collection<UnconfirmedStructuralChangesDelta> _unconfirmedDeltas_5 = this.queuedBuildDataContribution.getUnconfirmedDeltas();
      this.assertThereAreNotDeltas(_unconfirmedDeltas_5);
      Collection<IResourceDescription.Delta> _andRemovePendingDeltas_5 = this.queuedBuildData.getAndRemovePendingDeltas();
  ...
  public void undoEditorChangesAndSave() {
    try {
      ...
      this.confirmDeltas();
      Collection<UnconfirmedStructuralChangesDelta> _unconfirmedDeltas_6 = this.queuedBuildDataContribution.getUnconfirmedDeltas();
      this.assertThereAreNotDeltas(_unconfirmedDeltas_6);
      Collection<IResourceDescription.Delta> _andRemovePendingDeltas_6 = this.queuedBuildData.getAndRemovePendingDeltas();
