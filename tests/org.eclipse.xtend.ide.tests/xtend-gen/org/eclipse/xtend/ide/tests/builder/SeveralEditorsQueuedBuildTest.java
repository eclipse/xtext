...
public class SeveralEditorsQueuedBuildTest extends AbstractQueuedBuildDataTest {
  ...
  public void saveSeveralEditorsOneByOne() {
    try {
      ...
      Collection<Delta> _reconcileDeltas = this.javaChangeQueueFiller.getReconcileDeltas();
      this.assertThereAreDeltas(_reconcileDeltas, "mypackage.Foo");
      ...
      Collection<Delta> _reconcileDeltas_1 = this.javaChangeQueueFiller.getReconcileDeltas();
      this.assertThereAreDeltas(_reconcileDeltas_1, "mypackage.Foo", "mypackage.Bar");
      ...
      this.assertThereAreDeltas(_reconcileDeltas_2, "mypackage.Foo");
      ...
      this.assertThereAreDeltas(_reconcileDeltas_3, "mypackage.Foo");
  ...
  public void undoEditorChangesAndClose() {
    try {
      ...
      Collection<Delta> _reconcileDeltas_2 = this.javaChangeQueueFiller.getReconcileDeltas();
      this.assertThereAreDeltas(_reconcileDeltas_2, "mypackage.Foo", "mypackage.Bar");
      Collection<UnconfirmedStructuralChangesDelta> _unconfirmedDeltas_2 = this.queuedBuildData.getUnconfirmedDeltas();
      this.assertThereAreNotDeltas(_unconfirmedDeltas_2);
      Collection<Delta> _andRemovePendingDeltas_2 = this.queuedBuildData.getAndRemovePendingDeltas();
      this.assertThereAreNotDeltas(_andRemovePendingDeltas_2);
  ...
  public void undoEditorChangesAndSave() {
    try {
      ...
      this.confirmDeltas();
      Collection<Delta> _reconcileDeltas_4 = this.javaChangeQueueFiller.getReconcileDeltas();
      this.assertThereAreDeltas(_reconcileDeltas_4, "mypackage.Bar");
      Collection<UnconfirmedStructuralChangesDelta> _unconfirmedDeltas_4 = this.queuedBuildData.getUnconfirmedDeltas();
      this.assertThereAreNotDeltas(_unconfirmedDeltas_4);
      Collection<Delta> _andRemovePendingDeltas_4 = this.queuedBuildData.getAndRemovePendingDeltas();
      this.assertThereAreNotDeltas(_andRemovePendingDeltas_4);
      ...
      this.confirmDeltas();
      Collection<Delta> _reconcileDeltas_6 = this.javaChangeQueueFiller.getReconcileDeltas();
      this.assertThereAreNotDeltas(_reconcileDeltas_6);
