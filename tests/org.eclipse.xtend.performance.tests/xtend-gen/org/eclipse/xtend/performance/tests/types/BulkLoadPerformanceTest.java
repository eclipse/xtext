...
public class BulkLoadPerformanceTest extends AbstractXtendUITestCase {
  ...
  @Test
  public void testBulkLoadMoreTypesNewImpl() throws Exception {
    ResourceSetImpl _resourceSetImpl = new ResourceSetImpl();
    final ResourceSetImpl resourceSet = _resourceSetImpl;
    JdtTypeProvider _jdtTypeProvider = new JdtTypeProvider(PerformanceTestProjectSetup.testProject, resourceSet);
    final JdtTypeProvider typeProvider = _jdtTypeProvider;
    List<Class<? extends Object>> _moreTypesToLoad = this.getMoreTypesToLoad();
    final Function1<Class<? extends Object>,String> _function = new Function1<Class<? extends Object>,String>() {
        public String apply(final Class<? extends Object> it) {
          String _name = it.getName();
          return _name;
    ...
    List<String> _map = ListExtensions.<Class<? extends Object>, String>map(_moreTypesToLoad, _function);
    typeProvider.findTypesByName(_map);
  }
  
  @Test
  public void testBulkLoadMoreTypesNewImplAgain() throws Exception {
    this.testBulkLoadMoreTypesNewImpl();
  }
  
  @Test
  public void testSequentialLoadMoreTypesNewImpl() throws Exception {
    ResourceSetImpl _resourceSetImpl = new ResourceSetImpl();
    final ResourceSetImpl resourceSet = _resourceSetImpl;
    JdtTypeProvider _jdtTypeProvider = new JdtTypeProvider(PerformanceTestProjectSetup.testProject, resourceSet);
    @Extension
  ...
  @Test
  public void testBulkLoadMoreTypesNewImplAgain2() throws Exception {
    this.testBulkLoadMoreTypesNewImpl();
  }
  
  @Test
  public void testBulkLoadMoreTypesNewImplWithResolve() throws Exception {
    ResourceSetImpl _resourceSetImpl = new ResourceSetImpl();
    final ResourceSetImpl resourceSet = _resourceSetImpl;
    JdtTypeProvider _jdtTypeProvider = new JdtTypeProvider(PerformanceTestProjectSetup.testProject, resourceSet);
    final JdtTypeProvider typeProvider = _jdtTypeProvider;
  ...
  @Test
  public void testSequentialLoadMoreTypesNewImplResolve() throws Exception {
    ResourceSetImpl _resourceSetImpl = new ResourceSetImpl();
    final ResourceSetImpl resourceSet = _resourceSetImpl;
    JdtTypeProvider _jdtTypeProvider = new JdtTypeProvider(PerformanceTestProjectSetup.testProject, resourceSet);
    @Extension
  ...
  @Test
  public void testSequentialLoadMoreTypes() throws Exception {
    ResourceSetImpl _resourceSetImpl = new ResourceSetImpl();
    final ResourceSetImpl resourceSet = _resourceSetImpl;
    OldJdtTypeProvider _oldJdtTypeProvider = new OldJdtTypeProvider(PerformanceTestProjectSetup.testProject, resourceSet);
    @Extension
  ...
  @Test
  public void testBulkLoadMoreTypes() throws Exception {
    ResourceSetImpl _resourceSetImpl = new ResourceSetImpl();
    final ResourceSetImpl resourceSet = _resourceSetImpl;
    OldJdtTypeProvider _oldJdtTypeProvider = new OldJdtTypeProvider(PerformanceTestProjectSetup.testProject, resourceSet);
    final OldJdtTypeProvider typeProvider = _oldJdtTypeProvider;
  ...
  @Test
  public void testBulkLoadMoreTypesWithResolve() throws Exception {
    ResourceSetImpl _resourceSetImpl = new ResourceSetImpl();
    final ResourceSetImpl resourceSet = _resourceSetImpl;
    OldJdtTypeProvider _oldJdtTypeProvider = new OldJdtTypeProvider(PerformanceTestProjectSetup.testProject, resourceSet);
    final OldJdtTypeProvider typeProvider = _oldJdtTypeProvider;
  ...
  @Test
  public void testSequentialLoadMoreTypesResolve() throws Exception {
    ResourceSetImpl _resourceSetImpl = new ResourceSetImpl();
    final ResourceSetImpl resourceSet = _resourceSetImpl;
    OldJdtTypeProvider _oldJdtTypeProvider = new OldJdtTypeProvider(PerformanceTestProjectSetup.testProject, resourceSet);
    @Extension
