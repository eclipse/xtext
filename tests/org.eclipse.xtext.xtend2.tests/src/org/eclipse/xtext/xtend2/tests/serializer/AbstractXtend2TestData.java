...
public abstract class AbstractXtend2TestData extends AbstractXtend2TestCase {
	...
	public void testHelloWorld() throws Exception {
		...
		str.append("	\n");
		str.append("	void testHelloWorld() {\n");
		...
		str.append("	 */\n");
		str.append("	String sayHelloTo(String to) {\n");
		...
		str.append("	 * Hello World with explicit return type and explicit return expression.\n");
		str.append("	 */\n");
		str.append("	sayHelloTo2(String to) {\n");
		str.append("		'Hello '+to+'!''\n");
		str.append("	}\n");
		str.append("	\n");
		str.append("	/**\n");
		...
		str.append("	 */\n");
		str.append("	void sayHelloToSystemOut(String to) {\n");
		...
		str.append("	 */\n");
		str.append("	void sayHelloToSystemOut2(String to) {\n");
	...
	public void testSimpleExpressions() throws Exception {
		...
		str.append("	 */\n");
		str.append("	stringLiteral() {\n");
		str.append("		'Hello World'\n");
		str.append("	}\n");
		str.append("	\n");
		str.append("	booleanLiteral() {\n");
		str.append("		true || false\n");
		str.append("	}\n");
		str.append("	\n");
		str.append("	intLiteral() {\n");
		str.append("		42 + 21\n");
		str.append("	}\n");
		str.append("	\n");
		...
		str.append("	 */\n");
		str.append("	variableDeclaration() {\n");
