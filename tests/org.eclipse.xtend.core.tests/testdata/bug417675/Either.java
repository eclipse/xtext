...
public abstract class Either<L, R> implements Serializable {
  ...
  abstract class AbstractProjection<A, B> implements Projection<A, B, L, R> {
    public final Iterator<A> iterator() {
      return toOption().asSet().iterator();
    }
   ...
   */
  public final class LeftProjection extends AbstractProjection<L, R> {
   ...
   */
  public final class RightProjection extends AbstractProjection<R, L> {
