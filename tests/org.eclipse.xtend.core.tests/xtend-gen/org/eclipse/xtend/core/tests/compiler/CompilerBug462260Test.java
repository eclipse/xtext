...
public class CompilerBug462260Test extends AbstractXtendCompilerTest {
  ...
  public void test_01() {
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("def <E> Graph<E, E> graph(Set<E> vertices, Map<E, List<E>> edges)");
    _builder.newLine();
    _builder.append("\t");
    ...
    _builder.append("}");
    _builder.newLine();
    _builder.append("class Graph<K, V> {}");
    _builder.newLine();
    ...
    _builder_1.newLine();
    _builder_1.append("  ");
    _builder_1.append("public abstract <E extends Object> Graph<E, E> graph(final Set<E> vertices, final Map<E, List<E>> edges);");
    _builder_1.newLine();
    _builder_1.append("  ");
    _builder_1.newLine();
    _builder_1.append("  ");
    _builder_1.append("public Graph<String, String> test() {");
    _builder_1.newLine();
    _builder_1.append("    ");
  ...
  public void test_02() {
    ...
    _builder_1.newLine();
    _builder_1.append("  ");
    _builder_1.append("public Graph<Object, Object> test() {");
    _builder_1.newLine();
    _builder_1.append("    ");
  ...
  public void test_03() {
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("def <E, M extends Map<E, List<E>>> Graph<E, E> graph(Set<E> vertices, M edges)");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("def test() {");
    _builder.newLine();
    ...
    _builder_1.newLine();
    _builder_1.append("  ");
    _builder_1.append("public abstract <E extends Object, M extends Map<E, List<E>>> Graph<E, E> graph(final Set<E> vertices, final M edges);");
    _builder_1.newLine();
    _builder_1.append("  ");
    _builder_1.newLine();
    _builder_1.append("  ");
