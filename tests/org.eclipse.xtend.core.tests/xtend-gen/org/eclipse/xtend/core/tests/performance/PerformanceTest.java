    ...
    try {
      ...
      final Predicate<Issue> _function_1 = new Predicate<Issue>() {
        public boolean apply(final Issue it) {
          ...
          boolean _notEquals = (!Objects.equal(_code, IssueCodes.DEPRECATED_FEATURE));
          if (!_notEquals) {
            _and = false;
          } else {
            String _code_1 = it.getCode();
            boolean _notEquals_1 = (!Objects.equal(_code_1, IssueCodes.DEPRECATION_IN_DEPRECATED_CODE));
            _and = _notEquals_1;
          }
          return _and;
        }
