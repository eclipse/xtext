...
public class JavaConverterTest extends AbstractXtendTestCase {
  ...
  public void testFieldVisibility1() throws Exception {
    ...
    _builder.newLine();
    _builder.append("}");
    XtendTypeDeclaration _validTypeDeclaration = this.toValidTypeDeclaration("JavaToConvert", _builder.toString());
    final XtendInterface interfaze = ((XtendInterface) _validTypeDeclaration);
  ...
  public void testInnerIntefaceCase() throws Exception {
    ...
    XtendTypeDeclaration type = this.toValidTypeDeclaration("Clazz", _builder.toString());
  ...
  public void testEnumCase1() throws Exception {
    XtendClass enum_ = this.toValidXtendClass(
  ...
  public void testEnumNotSupportedCase() throws Exception {
    JavaConverter.ConversionResult enum_ = this.j2x.toXtend("MyEnum", 
  ...
  public void testEnumNotSupportedCase3() throws Exception {
    JavaConverter.ConversionResult enum_ = this.j2x.toXtend("MyClazz", 
  ...
  public void testSLCommentCase() throws Exception {
    ...
    InputOutput.<String>println(clazz);
    StringConcatenation _builder_1 = new StringConcatenation();
  ...
  private XtendEnum toValidXtendEnum(final String javaCode) throws Exception {
