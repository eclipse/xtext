...
public class CompilerBug404051Test extends AbstractXtendCompilerTest {
  ...
  public void test_01() {
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("List<? super Object> _sortBy = IterableExtensions.sortBy(_flatMap, _function_1);");
    _builder_1.newLine();
    _builder_1.append("    ");
  ...
  public void test_02() {
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("List<? super Number> _sortBy = IterableExtensions.sortBy(_flatMap, _function_1);");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("return _sortBy;");
    _builder_1.newLine();
  ...
  public void test_03() {
    ...
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("return Integer.valueOf(_intValue);");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("}");
    _builder_1.newLine();
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("List<? extends Number> _sortBy = IterableExtensions.sortBy(_flatMap, _function_1);");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("return _sortBy;");
    _builder_1.newLine();
  ...
  public void test_04() {
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("List<? extends Integer> _sortBy = IterableExtensions.sortBy(_flatMap, _function_1);");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("return _sortBy;");
    _builder_1.newLine();
  ...
  public void test_06() {
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("List<? extends String> _sortBy = IterableExtensions.sortBy(_flatMap, _function_1);");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("return _sortBy;");
    _builder_1.newLine();
