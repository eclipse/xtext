...
public class XtendAnnotationsFormatterTest extends AbstractXtendFormatterTest {
  ...
  public void formatClassSingleAnnotationSL() {
    final Procedure1<MapBasedPreferenceValues> _function = new Procedure1<MapBasedPreferenceValues>() {
      public void apply(final MapBasedPreferenceValues it) {
        it.put(XbaseFormatterPreferenceKeys.newLineAfterClassAnnotations, Boolean.valueOf(false));
        it.put(XbaseFormatterPreferenceKeys.preserveNewLines, Boolean.valueOf(true));
      }
    };
    StringConcatenation _builder = new StringConcatenation();
    _builder.append("package foo");
  ...
  public void formatClassSingleAnnotationML2() {
    final Procedure1<MapBasedPreferenceValues> _function = new Procedure1<MapBasedPreferenceValues>() {
      public void apply(final MapBasedPreferenceValues it) {
        it.put(XbaseFormatterPreferenceKeys.newLineAfterClassAnnotations, Boolean.valueOf(true));
        it.put(XbaseFormatterPreferenceKeys.preserveNewLines, Boolean.valueOf(true));
      }
    };
    StringConcatenation _builder = new StringConcatenation();
  ...
  public void formatConstructorTwoAnnotations1() {
    final Procedure1<MapBasedPreferenceValues> _function = new Procedure1<MapBasedPreferenceValues>() {
      public void apply(final MapBasedPreferenceValues it) {
        it.put(XbaseFormatterPreferenceKeys.newLineAfterConstructorAnnotations, Boolean.valueOf(false));
        it.put(XbaseFormatterPreferenceKeys.preserveNewLines, Boolean.valueOf(true));
      }
    };
    StringConcatenation _builder = new StringConcatenation();
  ...
  public void formatConstructorTwoAnnotations2() {
    final Procedure1<MapBasedPreferenceValues> _function = new Procedure1<MapBasedPreferenceValues>() {
      public void apply(final MapBasedPreferenceValues it) {
        it.put(XbaseFormatterPreferenceKeys.newLineAfterConstructorAnnotations, Boolean.valueOf(true));
        it.put(XbaseFormatterPreferenceKeys.preserveNewLines, Boolean.valueOf(true));
      }
    };
    StringConcatenation _builder = new StringConcatenation();
  ...
  public void formatConstructorTwoAnnotationsSL1() {
    final Procedure1<MapBasedPreferenceValues> _function = new Procedure1<MapBasedPreferenceValues>() {
      public void apply(final MapBasedPreferenceValues it) {
        it.put(XbaseFormatterPreferenceKeys.newLineAfterConstructorAnnotations, Boolean.valueOf(false));
        it.put(XbaseFormatterPreferenceKeys.preserveNewLines, Boolean.valueOf(false));
      }
    };
    StringConcatenation _builder = new StringConcatenation();
  ...
  public void formatFieldTwoAnnotations1() {
    final Procedure1<MapBasedPreferenceValues> _function = new Procedure1<MapBasedPreferenceValues>() {
      public void apply(final MapBasedPreferenceValues it) {
        it.put(XbaseFormatterPreferenceKeys.newLineAfterFieldAnnotations, Boolean.valueOf(true));
        it.put(XbaseFormatterPreferenceKeys.preserveNewLines, Boolean.valueOf(true));
      }
    };
    StringConcatenation _builder = new StringConcatenation();
  ...
  public void formatFieldTwoAnnotations2() {
    final Procedure1<MapBasedPreferenceValues> _function = new Procedure1<MapBasedPreferenceValues>() {
      public void apply(final MapBasedPreferenceValues it) {
        it.put(XbaseFormatterPreferenceKeys.newLineAfterFieldAnnotations, Boolean.valueOf(false));
        it.put(XbaseFormatterPreferenceKeys.preserveNewLines, Boolean.valueOf(false));
      }
    };
    StringConcatenation _builder = new StringConcatenation();
  ...
  public void formatMethodTwoAnnotations1() {
    final Procedure1<MapBasedPreferenceValues> _function = new Procedure1<MapBasedPreferenceValues>() {
      public void apply(final MapBasedPreferenceValues it) {
        it.put(XbaseFormatterPreferenceKeys.newLineAfterMethodAnnotations, Boolean.valueOf(true));
        it.put(XbaseFormatterPreferenceKeys.preserveNewLines, Boolean.valueOf(true));
      }
    };
    StringConcatenation _builder = new StringConcatenation();
  ...
  public void formatMethodTwoAnnotations3() {
    final Procedure1<MapBasedPreferenceValues> _function = new Procedure1<MapBasedPreferenceValues>() {
      public void apply(final MapBasedPreferenceValues it) {
        it.put(XbaseFormatterPreferenceKeys.newLineAfterMethodAnnotations, Boolean.valueOf(false));
        it.put(XbaseFormatterPreferenceKeys.preserveNewLines, Boolean.valueOf(true));
      }
    };
    StringConcatenation _builder = new StringConcatenation();
  ...
  public void formatMethodParameterTwoAnnotations1() {
    final Procedure1<MapBasedPreferenceValues> _function = new Procedure1<MapBasedPreferenceValues>() {
      public void apply(final MapBasedPreferenceValues it) {
        it.put(XbaseFormatterPreferenceKeys.newLineAfterParameterAnnotations, Boolean.valueOf(false));
        it.put(XbaseFormatterPreferenceKeys.preserveNewLines, Boolean.valueOf(true));
      }
    };
    StringConcatenation _builder = new StringConcatenation();
  ...
  public void formatMethodParameterTwoAnnotations2() {
    final Procedure1<MapBasedPreferenceValues> _function = new Procedure1<MapBasedPreferenceValues>() {
      public void apply(final MapBasedPreferenceValues it) {
        it.put(XbaseFormatterPreferenceKeys.newLineAfterParameterAnnotations, Boolean.valueOf(true));
        it.put(XbaseFormatterPreferenceKeys.preserveNewLines, Boolean.valueOf(true));
      }
    };
    StringConcatenation _builder = new StringConcatenation();
