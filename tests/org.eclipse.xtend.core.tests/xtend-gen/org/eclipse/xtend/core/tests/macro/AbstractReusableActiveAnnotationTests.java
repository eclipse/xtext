  ...
  public void testNoMutationInValidationPhase() {
    try {
      ...
      if (_t instanceof Throwable) {
        ...
        String _name = JvmClassDeclarationImpl.class.getName();
        _builder_2.append(_name, "");
        _builder_2.append(" cannot be cast to ");
        String _name_1 = MutableClassDeclaration.class.getName();
  ...
  public void testSetEmptyListAsAnnotationValue() {
    ...
    final Procedure1<CompilationUnitImpl> _function = new Procedure1<CompilationUnitImpl>() {
      public void apply(final CompilationUnitImpl it) {
        ...
        int _size = IterableExtensions.size(((Iterable<?>)Conversions.doWrapArray(_intArrayValue)));
        Assert.assertEquals(0, _size);
        long[] _longArrayValue = values.getLongArrayValue("longValue");
        int _size_1 = IterableExtensions.size(((Iterable<?>)Conversions.doWrapArray(_longArrayValue)));
        Assert.assertEquals(0, _size_1);
        short[] _shortArrayValue = values.getShortArrayValue("shortValue");
        int _size_2 = IterableExtensions.size(((Iterable<?>)Conversions.doWrapArray(_shortArrayValue)));
        Assert.assertEquals(0, _size_2);
        double[] _doubleArrayValue = values.getDoubleArrayValue("doubleValue");
        int _size_3 = IterableExtensions.size(((Iterable<?>)Conversions.doWrapArray(_doubleArrayValue)));
        Assert.assertEquals(0, _size_3);
        float[] _floatArrayValue = values.getFloatArrayValue("floatValue");
        int _size_4 = IterableExtensions.size(((Iterable<?>)Conversions.doWrapArray(_floatArrayValue)));
        Assert.assertEquals(0, _size_4);
        byte[] _byteArrayValue = values.getByteArrayValue("byteValue");
        int _size_5 = IterableExtensions.size(((Iterable<?>)Conversions.doWrapArray(_byteArrayValue)));
        Assert.assertEquals(0, _size_5);
        boolean[] _booleanArrayValue = values.getBooleanArrayValue("booleanValue");
        int _size_6 = IterableExtensions.size(((Iterable<?>)Conversions.doWrapArray(_booleanArrayValue)));
        Assert.assertEquals(0, _size_6);
        char[] _charArrayValue = values.getCharArrayValue("charValue");
        int _size_7 = IterableExtensions.size(((Iterable<?>)Conversions.doWrapArray(_charArrayValue)));
