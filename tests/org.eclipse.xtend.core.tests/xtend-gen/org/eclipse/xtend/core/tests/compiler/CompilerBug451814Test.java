...
public class CompilerBug451814Test extends AbstractXtendCompilerTest {
  ...
  public void test_01() {
    ...
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("if (!(counter == 0)) {");
    _builder_1.newLine();
    _builder_1.append("        ");
    ...
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("String _readLine = reader.readLine();");
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("boolean _tripleNotEquals = (_readLine != null);");
    _builder_1.newLine();
    _builder_1.append("        ");
  ...
  public void test_02() {
    ...
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("boolean _notEquals = (!Objects.equal(_readLine, null));");
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("_and = _notEquals;");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("}");
    _builder_1.newLine();
  ...
  public void test_03() {
    ...
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("boolean _while = _and;");
    _builder_1.newLine();
    _builder_1.append("      ");
    ...
    _builder_1.newLine();
    _builder_1.append("          ");
    _builder_1.append("String _readLine_1 = reader.readLine();");
    _builder_1.newLine();
    _builder_1.append("          ");
    _builder_1.append("boolean _notEquals_1 = (!Objects.equal(_readLine_1, null));");
    _builder_1.newLine();
    _builder_1.append("          ");
    _builder_1.append("_and_1 = _notEquals_1;");
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("}");
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("_while = _and_1;");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("}");
    _builder_1.newLine();
