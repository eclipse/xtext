...
public class XtendCompilerTest extends AbstractXtendTestCase {
  ...
  public void testDataClasses_01() {
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("String superToString = super.toString();");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("if (superToString == null) superToString = \"\";");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("int start = superToString.indexOf(\'[\');");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("int end = superToString.lastIndexOf(\']\');");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("superToString = (start == -1 || end == -1) ? \"\" : (superToString.substring(start + 1,end) + \", \");");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("return \"Foo [\" + superToString ");
    _builder_1.newLine();
    _builder_1.append("         ");
    _builder_1.append("+ \"_name = \" + _name + \", \"");
    _builder_1.newLine();
    _builder_1.append("         ");
    _builder_1.append("+ \"_myFlag = \" + _myFlag + \", \"");
    _builder_1.newLine();
    _builder_1.append("         ");
    _builder_1.append("+ \"_references = \" + _references + \"]\";");
    _builder_1.newLine();
    _builder_1.append("  ");
    _builder_1.append("}");
    _builder_1.newLine();
