...
public class XtendCompilerTest extends AbstractXtendCompilerTest {
  ...
  public void testIfWithVoid() {
    ...
    _builder.newLine();
    _builder.append("    \t");
    _builder.append("if (b) while(b) \'\'.toString");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("}");
    _builder.newLine();
  ...
  public void testIfWithVoidButNonVoidExpectation_01() {
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("val x = if (b) return \'\';");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("x");
    _builder.newLine();
  ...
  public void testIfWithVoidButNonVoidExpectation_02() {
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("def void m(boolean b) {");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("val Object x = if (b) return;");
    _builder.newLine();
    _builder.append("\t\t");
  ...
  public void testSwitchAsVoid() {
    ...
    _builder.newLine();
    _builder.append("    \t\t");
    _builder.append("case \'b\': while(b) \'\'.toString");
    _builder.newLine();
    _builder.append("    \t\t");
    _builder.append("case \'c\': if (b) return");
    _builder.newLine();
    _builder.append("    \t\t");
    ...
    _builder_1.newLine();
    _builder_1.append("  ");
    _builder_1.append("public void m(final Object a, final boolean b) {");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("boolean _matched = false;");
    _builder_1.newLine();
  ...
  public void testSwitchWithNonVoidReturn_01() {
    ...
    _builder.newLine();
    _builder.append("    \t\t");
    _builder.append("case \'c\': if (b) return \'a\'");
    _builder.newLine();
    _builder.append("    \t\t");
    _builder.append("case \'d\': for(i: 1..1) i.toString");
    _builder.newLine();
  ...
  public void testSwitchWithNonVoidReturn_02() {
    ...
    _builder.newLine();
    _builder.append("    \t\t");
    _builder.append("case \'b\': if (b) return \'a\'");
    _builder.newLine();
    _builder.append("    \t");
    _builder.append("}");
    _builder.newLine();
  ...
  public void testSwitchWithConstantExpressions_9() {
    ...
    _builder_1.newLine();
    _builder_1.append("  ");
    _builder_1.append("public boolean foo(final int y) {");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("final int x = 1;");
    _builder_1.newLine();
  ...
  public void testReturnType_02() {
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("[ if (Boolean.TRUE) it?.apply(param) ] ");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("}");
    _builder.newLine();
  ...
  public void testNullSafeFeatureCall_10() {
    ...
    _builder.newLine();
    _builder.append("    ");
    _builder.append("def getAnzuwendendeModi(String source, boolean b) {");
    _builder.newLine();
    _builder.append("\t    ");
    _builder.append("{");
    _builder.newLine();
    ...
    _builder_1.newLine();
    _builder_1.append("  ");
    _builder_1.append("public List<String> getAnzuwendendeModi(final String source, final boolean b) {");
    _builder_1.newLine();
    _builder_1.append("    ");
  ...
  public void testBug412642_01() throws Exception {
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("final Map<Object, Object> map2 = Collections.<Object, Object>unmodifiableMap(CollectionLiterals.<Object, Object>newHashMap(pair, _pair, _mappedTo, Bug412642_2.staticPair, this.pairField, _methodStaticPair, _plus));");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("Pair<String, Integer> _mappedTo_1 = Pair.<String, Integer>of(\"Banana\", Integer.valueOf(2));");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("final Set<?> map3 = Collections.<Object>unmodifiableSet(CollectionLiterals.<Object>newHashSet(Integer.valueOf((1 * 2)), _mappedTo_1));");
    _builder_1.newLine();
    _builder_1.append("  ");
    _builder_1.append("}");
    _builder_1.newLine();
  ...
  public void basicForLoopWithDuplicateSyntheticVariables() {
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("def foo(String s1, String s2) {");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("if (s1 == s2) {");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder_1.newLine();
    _builder_1.append("  ");
    _builder_1.append("public void foo(final String s1, final String s2) {");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("boolean _equals = Objects.equal(s1, s2);");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("if (_equals) {");
    _builder_1.newLine();
    ...
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("boolean _equals_1 = Objects.equal(s1, s2);");
    _builder_1.newLine();
    _builder_1.append("      ");
  ...
  public void testBug437027_2() {
    ...
    _builder_1.newLine();
    _builder_1.append("  ");
    _builder_1.append("public Object m(final boolean b) {");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("Object _xifexpression = null;");
    _builder_1.newLine();
