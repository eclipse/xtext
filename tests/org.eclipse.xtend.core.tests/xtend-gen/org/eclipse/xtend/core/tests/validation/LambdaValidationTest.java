...
public class LambdaValidationTest extends AbstractXtendTestCase {
  ...
  public void testIncompatibleReturnType_04() {
    try {
      ...
      _builder.newLine();
      XtendFile _file = this.file(_builder.toString());
      this._validationTestHelper.assertError(_file, Literals.XSTRING_LITERAL, IssueCodes.INCOMPATIBLE_TYPES, "Type mismatch: cannot convert from (int)=>String to I<Integer>");
    } catch (Throwable _e) {
      throw Exceptions.sneakyThrow(_e);
    }
  }
