...
public class ExtensionsCompilerTest extends AbstractXtendCompilerTest {
  ...
  public void testInheritedExtensionField() {
    ...
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("String _substring = this._string.substring(it);");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("_xblockexpression = (_substring);");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("}");
    _builder_1.newLine();
  ...
  public void testInheritedExtensionFieldWithAnnotation() {
    ...
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("String _substring = this.string.substring(it);");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("_xblockexpression = (_substring);");
    _builder_1.newLine();
  ...
  public void testShadowedExtensionField() {
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("String _substring = this.local.substring(it);");
    _builder_1.newLine();
    _builder_1.append("    ");
  ...
  public void testOverloadedExtensionField_01() {
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("char _charAt = this.local.charAt(it);");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("return _charAt;");
    _builder_1.newLine();
    _builder_1.append("  ");
    _builder_1.append("}");
    _builder_1.newLine();
  ...
  public void testExtensionParameterShadowsField() {
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("String _substring = s.substring(it);");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("return _substring;");
    _builder_1.newLine();
  ...
  public void testExtensionVarIsLocalInBlock() {
    ...
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("String _substring = param.substring(it);");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("_xblockexpression = (_substring);");
    _builder_1.newLine();
  ...
  public void testExtensionParamOnTryCatch() {
    ...
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("Throwable _initCause = e.initCause(it);");
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("_xtrycatchfinallyexpression = _initCause;");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("} else {");
    _builder_1.newLine();
