...
public class ParameterizedTypeCompilerTest extends AbstractXtendCompilerTest {
  ...
  public void testSimpleArgument_04() {
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("super(new Function0<U>() {");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("public U apply() {");
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("U _head = IterableExtensions.<U>head(u);");
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("return _head;");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("}");
    _builder_1.newLine();
  ...
  public void testSimpleArgument_05() {
    ...
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("U _get = list.get(0);");
    _builder_1.newLine();
    _builder_1.append("        ");
  ...
  public void testSimpleArgument_06() {
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("super(new Function0<String>() {");
    _builder_1.newLine();
    _builder_1.append("      ");
  ...
  public void testSimpleArgument_07() {
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("super(new Function0<Iterable<U>>() {");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("public Iterable<U> apply() {");
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("ArrayList<U> _newArrayList = CollectionLiterals.<U>newArrayList();");
    _builder_1.newLine();
    _builder_1.append("        ");
  ...
  public void testSimpleArgument_08() {
    ...
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("ArrayList<U> _newArrayList = CollectionLiterals.<U>newArrayList(null);");
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("return _newArrayList;");
    _builder_1.newLine();
  ...
  public void testSimpleArgument_09() {
    ...
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("ArrayList<U> _newArrayList = CollectionLiterals.<U>newArrayList(u);");
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("return _newArrayList;");
    _builder_1.newLine();
  ...
  public void testTransitiveArgument_02() {
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("super(new Function0<Iterable<AAA>>() {");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("public Iterable<AAA> apply() {");
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("ArrayList<AAA> _newArrayList = CollectionLiterals.<AAA>newArrayList(a);");
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("return _newArrayList;");
    _builder_1.newLine();
  ...
  public void testTransitiveArgument_03() {
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("this(new Function0<Iterable<AA>>() {");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("public Iterable<AA> apply() {");
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("ArrayList<AA> _newArrayList = CollectionLiterals.<AA>newArrayList(((AA) a));");
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("return _newArrayList;");
    _builder_1.newLine();
  ...
  public void testTransitiveArgument_05() {
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("super(new Function0<Collection<? extends T>>() {");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("public Collection<? extends T> apply() {");
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("ArrayList<U> _newArrayList = CollectionLiterals.<U>newArrayList(u);");
    _builder_1.newLine();
