...
public class ResourceStorageTest extends AbstractXtendTestCase {
  ...
  public void testParsing() {
    try {
      ...
      ResourceStorageOutputStream _createResourceStorageOutputStream = this.resourceStorageFacade.createResourceStorageOutputStream(bout);
      Resource _eResource = file.eResource();
      _createResourceStorageOutputStream.writeResource(((StorageAwareResource) _eResource));
      byte[] _byteArray = bout.toByteArray();
      ByteArrayInputStream _byteArrayInputStream = new ByteArrayInputStream(_byteArray);
      final ResourceStorageInputStream in = this.resourceStorageFacade.createResourceStorageInputStream(_byteArrayInputStream);
