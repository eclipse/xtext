...
public class CompilerBugTest extends AbstractXtendCompilerTest {
  ...
  public void testBug406370() {
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("List<Integer> _xlistliteral = null;");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("Builder<Integer> _builder = ImmutableList.builder();");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("_builder.add(1);");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("_builder.add(2);");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("_builder.add(3);");
    _builder_1.newLine();
    _builder_1.append("    ");
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("List<String> _map = ListExtensions.<Integer, String>map(_xlistliteral, _function);");
    _builder_1.newLine();
    _builder_1.append("    ");
