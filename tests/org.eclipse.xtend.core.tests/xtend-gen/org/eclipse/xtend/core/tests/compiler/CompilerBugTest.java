...
public class CompilerBugTest extends AbstractXtendCompilerTest {
  ...
  public void testReturnExpressionConverted_01() {
    ...
    _builder_1.newLine();
    _builder_1.append("  ");
    _builder_1.append("public Iterable<? extends Object> m() {");
    _builder_1.newLine();
    _builder_1.append("    ");
    ...
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("return ((Iterable<? extends Object>)Conversions.doWrapArray(b));");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("}");
    _builder_1.newLine();
  ...
  public void testAutocast_02() {
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("boolean _while = (a instanceof B);");
    _builder_1.newLine();
    _builder_1.append("    ");
    ...
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("_while = (a instanceof B);");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("}");
    _builder_1.newLine();
  ...
  public void test410794() {
    ...
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("Number _n = this.n = _double;");
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("_switchResult = _n;");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("}");
    _builder_1.newLine();
  ...
  public void test416617() {
    ...
    _builder_1.newLine();
    _builder_1.append("          ");
    _builder_1.append("A _tmp = tmp = _elvis;");
    _builder_1.newLine();
    _builder_1.append("          ");
    _builder_1.append("_switchResult = _tmp;");
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("}");
    _builder_1.newLine();
  ...
  public void test412083() {
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("Object _foo = foo.foo(this, 1);");
    _builder_1.newLine();
    _builder_1.append("    ");
  ...
  public void test412083_01() {
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("Object _foo = this.foo.foo(this, 1);");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("return _foo;");
    _builder_1.newLine();
  ...
  public void test412083_02() {
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("Object _foo = this.foo(this, 1);");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("return _foo;");
    _builder_1.newLine();
  ...
  public void testBug406416_01() {
    ...
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("String _buildChild = this.<String, Factory<String>>buildChild(f);");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("return _buildChild;");
    _builder_1.newLine();
    _builder_1.append("  ");
    _builder_1.append("}");
    _builder_1.newLine();
  ...
  public void testNestedListLiteral() {
    ...
    _builder_1.newLine();
    _builder_1.append("  ");
    _builder_1.append("private final List<? extends Collection<String>> f = Collections.<Collection<String>>unmodifiableList(Lists.<Collection<String>>newArrayList(Collections.<String>unmodifiableList(Lists.<String>newArrayList(\"a\")), Collections.<String>unmodifiableSet(Sets.<String>newHashSet())));");
    _builder_1.newLine();
    _builder_1.append("}");
    _builder_1.newLine();
    this.assertCompilesTo(_builder, _builder_1);
  ...
  public void testBug383551_01() {
    ...
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("Some<X> _some = new Some<X>();");
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("_switchResult = _some;");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("}");
    _builder_1.newLine();
    ...
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("None<X> _none = new None<X>();");
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("_switchResult = _none;");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("}");
    _builder_1.newLine();
  ...
  public void testBug383551_02() {
    ...
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("E<X> _e = new E<X>();");
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("_switchResult = _e;");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("}");
    _builder_1.newLine();
  ...
  public void testBug410990() {
    ...
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("Object _bug = this.bug(_function_1);");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("_xblockexpression = (_bug);");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("}");
    _builder_1.newLine();
