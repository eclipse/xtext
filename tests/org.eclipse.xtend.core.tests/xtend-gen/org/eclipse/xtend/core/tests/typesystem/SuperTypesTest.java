...
public class SuperTypesTest extends AbstractSuperTypesTest {
  ...
  public void testParameterizedInnerTypes_01() {
    this.assertSuperTypes("test.InnerClasses.SubString<Number>.SubInner<CharSequence>", "InnerClasses$Super<String>$Inner<CharSequence>");
  }
  
  @Test
  public void testParameterizedInnerTypes_02() {
    this.assertSuperTypes("test.InnerClasses.Sub<Number>.SubInner2<CharSequence>", "InnerClasses$Super<Number>$Inner<Number>");
  }
  ...
  public void testParameterizedInnerTypes_04() {
    this.assertSuperTypes("test.InnerClasses.Sub4<Number>.Inner3<CharSequence>", "InnerClasses$Super3<String>$Inner2<Number>");
  }
}
