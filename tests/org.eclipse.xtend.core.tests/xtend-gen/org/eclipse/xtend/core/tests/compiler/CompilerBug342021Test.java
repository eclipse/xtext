...
public class CompilerBug342021Test extends AbstractXtendCompilerTest {
  ...
  public void testIfExpression_01() {
    ...
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("final Iterable<Object> _function = new Iterable<Object>() {");
    _builder_1.newLine();
    _builder_1.append("          ");
    _builder_1.append("public Iterator<Object> iterator() {");
    _builder_1.newLine();
    _builder_1.append("            ");
    _builder_1.append("ArrayList<Object> _newArrayList = CollectionLiterals.<Object>newArrayList();");
    _builder_1.newLine();
    _builder_1.append("            ");
    _builder_1.append("Iterator<Object> _iterator = _newArrayList.iterator();");
    _builder_1.newLine();
    _builder_1.append("            ");
    _builder_1.append("return _iterator;");
    _builder_1.newLine();
    _builder_1.append("          ");
    _builder_1.append("}");
    _builder_1.newLine();
    ...
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("_xifexpression = ((Iterable<Object>)Conversions.doWrapArray(_array));");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("}");
    _builder_1.newLine();
  ...
  public void testIfExpression_04() {
    ...
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("_xifexpression = _array;");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("}");
    _builder_1.newLine();
  ...
  public void testIfExpression_08() {
    ...
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("return ((Iterable<Object>)Conversions.doWrapArray(_array));");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("}");
    _builder_1.newLine();
  ...
  public void testIfExpression_11() {
    ...
    _builder_1.newLine();
    _builder_1.append("          ");
    _builder_1.append("_xblockexpression_2 = (_array);");
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("}");
    _builder_1.newLine();
  ...
  public void testIfExpression_14() {
    ...
    _builder_1.newLine();
    _builder_1.append("          ");
    _builder_1.append("_xblockexpression_1 = (_array);");
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("}");
    _builder_1.newLine();
  ...
  public void testSwitchExpression_04() {
    ...
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("List<Object> _emptyList = CollectionLiterals.<Object>emptyList();");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("_switchResult = _emptyList;");
    _builder_1.newLine();
    _builder_1.append("    ");
    _builder_1.append("}");
    _builder_1.newLine();
  ...
  public void testTryCatchExpression_01() {
    ...
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("_xtrycatchfinallyexpression = ((Iterable<Object>)Conversions.doWrapArray(_array));");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("} else {");
    _builder_1.newLine();
  ...
  public void testNestedIfInSwitchExpression_01() {
    ...
    _builder_1.newLine();
    _builder_1.append("import com.google.common.collect.ImmutableSet.Builder;");
    _builder_1.newLine();
    _builder_1.append("import java.util.ArrayList;");
    _builder_1.newLine();
    _builder_1.append("import java.util.Iterator;");
    ...
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("Set<Object> _xsetliteral = null;");
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("Builder<Object> _builder = ImmutableSet.builder();");
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("_xsetliteral = _builder.build();");
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("return _xsetliteral;");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("}");
    _builder_1.newLine();
