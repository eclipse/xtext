...
public class DeclarationsTest extends AbstractXtendTestCase {
  ...
  public void testAnnotation3() {
    ...
    final Procedure1<CompilationUnitImpl> _function = (CompilationUnitImpl it) -> {
      ...
      AnnotationReference _newAnnotationReference = _annotationReferenceProvider.newAnnotationReference(anno, _function_1);
  ...
  public void testRemove() {
    ...
    final Procedure1<CompilationUnitImpl> _function = (CompilationUnitImpl it) -> {
      ...
      _declaredMembers.forEach(_function_1);
  ...
  public void testTypeReferences() {
    ...
    final Procedure1<CompilationUnitImpl> _function = (CompilationUnitImpl it) -> {
      ...
      this.checkPrimitive(_primitiveBoolean, "java.lang.Boolean");
      ...
      this.checkPrimitive(_primitiveInt, "java.lang.Integer");
      ...
      this.checkPrimitive(_primitiveLong, "java.lang.Long");
      ...
      this.checkPrimitive(_primitiveShort, "java.lang.Short");
      ...
      this.checkPrimitive(_primitiveChar, "java.lang.Character");
      ...
      this.checkPrimitive(_primitiveByte, "java.lang.Byte");
      ...
      this.checkPrimitive(_primitiveFloat, "java.lang.Float");
      ...
      this.checkPrimitive(_primitiveDouble, "java.lang.Double");
