  ...
  public void testSimpleClassWithField() {
    ...
    final Procedure1<CompilationUnit> _function = new Procedure1<CompilationUnit>() {
        public void apply(final CompilationUnit it) {
          ...
          List<GeneratedTypeDeclaration> _generatedTypeDeclarations = it.getGeneratedTypeDeclarations();
          GeneratedTypeDeclaration _head_3 = IterableExtensions.<GeneratedTypeDeclaration>head(_generatedTypeDeclarations);
  ...
  public void testXtendClassWithMethodFieldAndConstructor() {
    ...
    final Procedure1<CompilationUnit> _function = new Procedure1<CompilationUnit>() {
        public void apply(final CompilationUnit it) {
          ...
          final SourceClassDeclaration clazz = ((SourceClassDeclaration) _head);
          List<GeneratedTypeDeclaration> _generatedTypeDeclarations = it.getGeneratedTypeDeclarations();
          GeneratedTypeDeclaration _head_1 = IterableExtensions.<GeneratedTypeDeclaration>head(_generatedTypeDeclarations);
          final GeneratedClassDeclaration genClazz = ((GeneratedClassDeclaration) _head_1);
          String _name = clazz.getName();
          Assert.assertEquals("foo.MyClass", _name);
          TypeReference _superclass = clazz.getSuperclass();
          ...
          List<SourceTypeParameterDeclaration> _typeParameters = clazz.getTypeParameters();
          SourceTypeParameterDeclaration _head_2 = IterableExtensions.<SourceTypeParameterDeclaration>head(_typeParameters);
          String _name_1 = _head_2.getName();
          Assert.assertEquals("T", _name_1);
          List<SourceTypeParameterDeclaration> _typeParameters_1 = clazz.getTypeParameters();
          SourceTypeParameterDeclaration _head_3 = IterableExtensions.<SourceTypeParameterDeclaration>head(_typeParameters_1);
          ...
          List<SourceTypeParameterDeclaration> _typeParameters_2 = clazz.getTypeParameters();
          SourceTypeParameterDeclaration _head_5 = IterableExtensions.<SourceTypeParameterDeclaration>head(_typeParameters_2);
          SourceTypeParameterDeclarator _typeParameterDeclarator = _head_5.getTypeParameterDeclarator();
          ...
          final SourceMethodDeclaration method = ((SourceMethodDeclaration) _get_1);
          List<GeneratedMemberDeclaration> _members_4 = genClazz.getMembers();
          GeneratedMemberDeclaration _get_2 = _members_4.get(2);
          final GeneratedMethodDeclaration genMethod = ((GeneratedMethodDeclaration) _get_2);
          TypeDeclaration _declaringType_2 = method.getDeclaringType();
          Assert.assertSame(clazz, _declaringType_2);
          List<SourceParameterDeclaration> _parameters_2 = method.getParameters();
          SourceParameterDeclaration _head_9 = IterableExtensions.<SourceParameterDeclaration>head(_parameters_2);
          String _name_5 = _head_9.getName();
          Assert.assertEquals("a", _name_5);
          List<SourceParameterDeclaration> _parameters_3 = method.getParameters();
          SourceParameterDeclaration _head_10 = IterableExtensions.<SourceParameterDeclaration>head(_parameters_3);
          TypeReference _type_2 = _head_10.getType();
          String _string_3 = _type_2.toString();
          Assert.assertEquals("T2", _string_3);
          List<GeneratedTypeParameterDeclaration> _typeParameters_3 = genMethod.getTypeParameters();
          GeneratedTypeParameterDeclaration _head_11 = IterableExtensions.<GeneratedTypeParameterDeclaration>head(_typeParameters_3);
          List<SourceParameterDeclaration> _parameters_4 = method.getParameters();
          SourceParameterDeclaration _head_12 = IterableExtensions.<SourceParameterDeclaration>head(_parameters_4);
          TypeReference _type_3 = _head_12.getType();
          Type _type_4 = _type_3.getType();
          Assert.assertSame(_head_11, _type_4);
          List<SourceParameterDeclaration> _parameters_5 = method.getParameters();
          SourceParameterDeclaration _get_3 = _parameters_5.get(1);
          ...
          List<SourceParameterDeclaration> _parameters_6 = method.getParameters();
          SourceParameterDeclaration _get_4 = _parameters_6.get(1);
          ...
          List<SourceTypeParameterDeclaration> _typeParameters_5 = method.getTypeParameters();
          SourceTypeParameterDeclaration _head_14 = IterableExtensions.<SourceTypeParameterDeclaration>head(_typeParameters_5);
          String _name_6 = _head_14.getName();
          Assert.assertEquals("T2", _name_6);
          List<SourceTypeParameterDeclaration> _typeParameters_6 = method.getTypeParameters();
          SourceTypeParameterDeclaration _head_15 = IterableExtensions.<SourceTypeParameterDeclaration>head(_typeParameters_6);
          ...
          List<SourceTypeParameterDeclaration> _typeParameters_7 = method.getTypeParameters();
          SourceTypeParameterDeclaration _head_17 = IterableExtensions.<SourceTypeParameterDeclaration>head(_typeParameters_7);
          List<SourceTypeParameterDeclaration> _typeParameters_8 = method.getTypeParameters();
          SourceTypeParameterDeclaration _head_18 = IterableExtensions.<SourceTypeParameterDeclaration>head(_typeParameters_8);
          Assert.assertSame(_head_17, _head_18);
          List<SourceTypeParameterDeclaration> _typeParameters_9 = method.getTypeParameters();
          SourceTypeParameterDeclaration _head_19 = IterableExtensions.<SourceTypeParameterDeclaration>head(_typeParameters_9);
          SourceTypeParameterDeclarator _typeParameterDeclarator_1 = _head_19.getTypeParameterDeclarator();
