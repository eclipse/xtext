  ...
  public void testXtendClassWithMethodFieldAndConstructor() {
    ...
    final Procedure1<CompilationUnit> _function = new Procedure1<CompilationUnit>() {
        public void apply(final CompilationUnit it) {
          ...
          List<ParameterDeclaration> _parameters = constructor.getParameters();
          ParameterDeclaration _head_2 = IterableExtensions.<ParameterDeclaration>head(_parameters);
          String _name_3 = _head_2.getName();
          Assert.assertEquals("initial", _name_3);
          List<ParameterDeclaration> _parameters_1 = constructor.getParameters();
          ParameterDeclaration _head_3 = IterableExtensions.<ParameterDeclaration>head(_parameters_1);
          ...
          List<ParameterDeclaration> _parameters_2 = method.getParameters();
          ParameterDeclaration _head_4 = IterableExtensions.<ParameterDeclaration>head(_parameters_2);
          String _name_4 = _head_4.getName();
          Assert.assertEquals("a", _name_4);
          List<ParameterDeclaration> _parameters_3 = method.getParameters();
          ParameterDeclaration _head_5 = IterableExtensions.<ParameterDeclaration>head(_parameters_3);
