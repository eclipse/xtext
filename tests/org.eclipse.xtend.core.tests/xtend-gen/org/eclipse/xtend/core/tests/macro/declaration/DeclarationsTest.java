  ...
  public void testTypeReferences() {
    ...
    final Procedure1<CompilationUnit> _function = new Procedure1<CompilationUnit>() {
        public void apply(final CompilationUnit it) {
          ...
          final TypeReference anyType = typeReferenceProvider.getAnyType();
          boolean _isAnyType = anyType.isAnyType();
          Assert.assertTrue(_isAnyType);
          final TypeReference stringType = typeReferenceProvider.getString();
          String _name = CharSequence.class.getName();
          final TypeReference charsequenceType = typeReferenceProvider.newTypeReference(_name);
          ...
          TypeReference _primitiveBoolean = typeReferenceProvider.getPrimitiveBoolean();
          DeclarationsTest.this.checkPrimitive(_primitiveBoolean, "java.lang.Boolean");
          TypeReference _primitiveInt = typeReferenceProvider.getPrimitiveInt();
          DeclarationsTest.this.checkPrimitive(_primitiveInt, "java.lang.Integer");
          TypeReference _primitiveLong = typeReferenceProvider.getPrimitiveLong();
          DeclarationsTest.this.checkPrimitive(_primitiveLong, "java.lang.Long");
          TypeReference _primitiveShort = typeReferenceProvider.getPrimitiveShort();
          DeclarationsTest.this.checkPrimitive(_primitiveShort, "java.lang.Short");
          TypeReference _primitiveChar = typeReferenceProvider.getPrimitiveChar();
          DeclarationsTest.this.checkPrimitive(_primitiveChar, "java.lang.Character");
          TypeReference _primitiveByte = typeReferenceProvider.getPrimitiveByte();
          DeclarationsTest.this.checkPrimitive(_primitiveByte, "java.lang.Byte");
          TypeReference _primitiveFloat = typeReferenceProvider.getPrimitiveFloat();
          DeclarationsTest.this.checkPrimitive(_primitiveFloat, "java.lang.Float");
          TypeReference _primitiveDouble = typeReferenceProvider.getPrimitiveDouble();
          DeclarationsTest.this.checkPrimitive(_primitiveDouble, "java.lang.Double");
          final TypeReference primitiveVoid = typeReferenceProvider.getPrimitiveVoid();
          boolean _isVoid = primitiveVoid.isVoid();
          Assert.assertTrue(_isVoid);
          TypeReference _string = typeReferenceProvider.getString();
          final TypeReference listOfStringType = typeReferenceProvider.getList(_string);
          ...
          final TypeReference setOfString = typeReferenceProvider.getSet(_head);
          ...
          TypeReference _newWildcardTypeReference = typeReferenceProvider.newWildcardTypeReference();
          TypeReference _set = typeReferenceProvider.getSet(_newWildcardTypeReference);
          String _string_5 = _set.toString();
          Assert.assertEquals("Set<?>", _string_5);
          TypeReference _newWildcardTypeReference_1 = typeReferenceProvider.newWildcardTypeReference(listOfStringType);
          TypeReference _set_1 = typeReferenceProvider.getSet(_newWildcardTypeReference_1);
