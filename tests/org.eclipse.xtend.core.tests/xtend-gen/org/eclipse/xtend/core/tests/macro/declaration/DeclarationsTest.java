  ...
  public void testXtendClassWithMethodFieldAndConstructor() {
    ...
    final Procedure1<CompilationUnitImpl> _function = new Procedure1<CompilationUnitImpl>() {
        public void apply(final CompilationUnitImpl it) {
          ...
          List<TypeReference> _upperBounds = _head_2.getUpperBounds();
          TypeReference _head_3 = IterableExtensions.<TypeReference>head(_upperBounds);
          ...
          List<? extends MemberDeclaration> _members_1 = clazz.getMembers();
          MemberDeclaration _head_5 = IterableExtensions.head(_members_1);
          final FieldDeclaration field = ((FieldDeclaration) _head_5);
          ...
          ParameterDeclaration _head_6 = IterableExtensions.head(_parameters);
          String _name_4 = _head_6.getName();
          Assert.assertEquals("initial", _name_4);
          List<? extends ParameterDeclaration> _parameters_1 = constructor.getParameters();
          ParameterDeclaration _head_7 = IterableExtensions.head(_parameters_1);
          TypeReference _type_1 = _head_7.getType();
          ...
          ParameterDeclaration _head_8 = IterableExtensions.head(_parameters_2);
          String _name_5 = _head_8.getName();
          Assert.assertEquals("a", _name_5);
          List<? extends ParameterDeclaration> _parameters_3 = method.getParameters();
          ParameterDeclaration _head_9 = IterableExtensions.head(_parameters_3);
          TypeReference _type_2 = _head_9.getType();
          ...
          MutableTypeParameterDeclaration _head_10 = IterableExtensions.<MutableTypeParameterDeclaration>head(_typeParameters_3);
          List<? extends ParameterDeclaration> _parameters_4 = method.getParameters();
          ParameterDeclaration _head_11 = IterableExtensions.head(_parameters_4);
          TypeReference _type_3 = _head_11.getType();
          Type _type_4 = _type_3.getType();
          Assert.assertSame(_head_10, _type_4);
          ...
          TypeParameterDeclaration _head_12 = IterableExtensions.head(_typeParameters_4);
          ...
          Assert.assertSame(_head_12, _type_7);
          ...
          TypeParameterDeclaration _head_13 = IterableExtensions.head(_typeParameters_5);
          String _name_6 = _head_13.getName();
          Assert.assertEquals("T2", _name_6);
          List<? extends TypeParameterDeclaration> _typeParameters_6 = method.getTypeParameters();
          TypeParameterDeclaration _head_14 = IterableExtensions.head(_typeParameters_6);
          List<TypeReference> _upperBounds_1 = _head_14.getUpperBounds();
          TypeReference _head_15 = IterableExtensions.<TypeReference>head(_upperBounds_1);
          String _string_5 = _head_15.toString();
          ...
          TypeParameterDeclaration _head_16 = IterableExtensions.head(_typeParameters_7);
          List<? extends TypeParameterDeclaration> _typeParameters_8 = method.getTypeParameters();
          TypeParameterDeclaration _head_17 = IterableExtensions.head(_typeParameters_8);
          Assert.assertSame(_head_16, _head_17);
          List<? extends TypeParameterDeclaration> _typeParameters_9 = method.getTypeParameters();
          TypeParameterDeclaration _head_18 = IterableExtensions.head(_typeParameters_9);
          TypeParameterDeclarator _typeParameterDeclarator_1 = _head_18.getTypeParameterDeclarator();
