  ...
  public void testSetImplementedInterfaces() {
    ...
    final Procedure1<CompilationUnitImpl> _function = new Procedure1<CompilationUnitImpl>() {
      public void apply(final CompilationUnitImpl it) {
        ...
        Iterable<TypeReference> _implementedInterfaces = baseClass.getImplementedInterfaces();
        boolean _isEmpty = IterableExtensions.isEmpty(_implementedInterfaces);
        Assert.assertTrue(_isEmpty);
        TypeReferenceProvider _typeReferenceProvider = it.getTypeReferenceProvider();
        ...
        Iterable<TypeReference> _implementedInterfaces_1 = baseClass.getImplementedInterfaces();
        ...
        Iterable<TypeReference> _implementedInterfaces_2 = baseClass.getImplementedInterfaces();
        ...
        Iterable<TypeReference> _implementedInterfaces_3 = baseClass.getImplementedInterfaces();
        ...
        Iterable<TypeReference> _implementedInterfaces_4 = baseClass.getImplementedInterfaces();
  ...
  public void testAnnotationReferenceValues() {
    ...
    final Procedure1<CompilationUnitImpl> _function = new Procedure1<CompilationUnitImpl>() {
      public void apply(final CompilationUnitImpl it) {
        ...
        final Object[] bools = ((Object[]) _value_3);
        Object _get = bools[0];
        Assert.assertTrue((((Boolean) _get)).booleanValue());
        Object _get_1 = bools[1];
        Assert.assertFalse((((Boolean) _get_1)).booleanValue());
        int _minus_2 = (-1);
        int _plus_3 = (34 + 45);
        int _minus_3 = (2 - 6);
        Object _value_4 = annoRef.getValue("intArrayValue");
        Assert.assertArrayEquals(new Object[] { Integer.valueOf(_minus_2), Integer.valueOf(_plus_3), Integer.valueOf(_minus_3) }, ((Object[]) _value_4));
        Object _value_5 = annoRef.getValue("typeArrayValue");
        final Object[] type = ((Object[]) _value_5);
        TypeReferenceProvider _typeReferenceProvider = it.getTypeReferenceProvider();
