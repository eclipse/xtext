...
public class LineNumberMappingTests extends AbstractXtendTestCase {
  ...
  public void testLineMapping_05() {
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("switch x : \"Hello\" as Object { \t\t// 7..11");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("String case x.length > 4 : { \t// 12..13");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("println(\t\t\t\t\t// 19");
    _builder.newLine();
    _builder.append("\t\t\t\t\t");
    _builder.append("\"It\'s a long one \" \t\t// 17..18");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t");
    _builder.append("+ x.length)\t\t\t// 16");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("}");
    _builder.newLine();
