 ...
 */
abstract class AbstractAnnotationCompilerSmokeTest extends AnnotationCompilerTest {
 ...
 * @author Sebastian Zarnekow - Initial contribution and API
 */
class SkipLastCharactersAnnotationCompilerSmokeTest extends AbstractAnnotationCompilerSmokeTest {
 ...
 * @author Sebastian Zarnekow - Initial contribution and API
 */
class SkipFirstCharactersAnnotationCompilerSmokeTest extends AbstractAnnotationCompilerSmokeTest {
 ...
 * @author Sebastian Zarnekow - Initial contribution and API
 */
class SkipCharacterInBetweenAnnotationCompilerSmokeTest extends AbstractAnnotationCompilerSmokeTest {
 ...
 * @author Sebastian Zarnekow - Initial contribution and API
 */
class SkipThreeCharactersInBetweenAnnotationCompilerSmokeTest extends AbstractAnnotationCompilerSmokeTest {
 ...
 * @author Sebastian Zarnekow - Initial contribution and API
 */
class SkipTokensInBetweenAnnotationCompilerSmokeTest extends AbstractAnnotationCompilerSmokeTest {
 ...
 * @author Sebastian Zarnekow - Initial contribution and API
 */
class SkipNodesInBetweenAnnotationCompilerSmokeTest extends AbstractAnnotationCompilerSmokeTest {
