...
import org.eclipse.xtend.core.tests.compiler.ExtensionsCompilerTest
 ...
 */
abstract class AbstractExtensionsCompilerSmokeTest extends ExtensionsCompilerTest {
 ...
 * @author Sebastian Zarnekow - Initial contribution and API
 */
class SkipLastCharactersExtensionsCompilerSmokeTest extends AbstractExtensionsCompilerSmokeTest {
 ...
 * @author Sebastian Zarnekow - Initial contribution and API
 */
class SkipFirstCharactersExtensionsCompilerSmokeTest extends AbstractExtensionsCompilerSmokeTest {
 ...
 * @author Sebastian Zarnekow - Initial contribution and API
 */
class SkipCharacterInBetweenExtensionsCompilerSmokeTest extends AbstractExtensionsCompilerSmokeTest {
 ...
 * @author Sebastian Zarnekow - Initial contribution and API
 */
class SkipThreeCharactersInBetweenExtensionsCompilerSmokeTest extends AbstractExtensionsCompilerSmokeTest {
 ...
 * @author Sebastian Zarnekow - Initial contribution and API
 */
class SkipTokensInBetweenExtensionsCompilerSmokeTest extends AbstractExtensionsCompilerSmokeTest {
 ...
 * @author Sebastian Zarnekow - Initial contribution and API
 */
class SkipNodesInBetweenExtensionsCompilerSmokeTest extends AbstractExtensionsCompilerSmokeTest {
