 ...
 */
abstract class AbstractCompilerBugSmokeTest extends CompilerBugTest {
 ...
 * @author Sebastian Zarnekow - Initial contribution and API
 */
class SkipLastCharactersCompilerBugSmokeTest extends AbstractCompilerBugSmokeTest {
 ...
 * @author Sebastian Zarnekow - Initial contribution and API
 */
class SkipFirstCharactersCompilerBugSmokeTest extends AbstractCompilerBugSmokeTest {
 ...
 * @author Sebastian Zarnekow - Initial contribution and API
 */
class SkipCharacterInBetweenCompilerBugSmokeTest extends AbstractCompilerBugSmokeTest {
 ...
 * @author Sebastian Zarnekow - Initial contribution and API
 */
class SkipThreeCharactersInBetweenCompilerBugSmokeTest extends AbstractCompilerBugSmokeTest {
 ...
 * @author Sebastian Zarnekow - Initial contribution and API
 */
class SkipNodesInBetweenCompilerBugSmokeTest extends AbstractCompilerBugSmokeTest {
