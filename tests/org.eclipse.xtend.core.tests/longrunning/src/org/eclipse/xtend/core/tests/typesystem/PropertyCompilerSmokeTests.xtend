...
import org.eclipse.xtend.core.tests.compiler.PropertyCompilerTest
 ...
 */
abstract class AbstractPropertyCompilerSmokeTest extends PropertyCompilerTest {
 ...
 * @author Sebastian Zarnekow - Initial contribution and API
 */
class SkipLastCharactersPropertyCompilerSmokeTest extends AbstractPropertyCompilerSmokeTest {
 ...
 * @author Sebastian Zarnekow - Initial contribution and API
 */
class SkipFirstCharactersPropertyCompilerSmokeTest extends AbstractPropertyCompilerSmokeTest {
 ...
 * @author Sebastian Zarnekow - Initial contribution and API
 */
class SkipCharacterInBetweenPropertyCompilerSmokeTest extends AbstractPropertyCompilerSmokeTest {
 ...
 * @author Sebastian Zarnekow - Initial contribution and API
 */
class SkipThreeCharactersInBetweenPropertyCompilerSmokeTest extends AbstractPropertyCompilerSmokeTest {
 ...
 * @author Sebastian Zarnekow - Initial contribution and API
 */
class SkipTokensInBetweenPropertyCompilerSmokeTest extends AbstractPropertyCompilerSmokeTest {
 ...
 * @author Sebastian Zarnekow - Initial contribution and API
 */
class SkipNodesInBetweenPropertyCompilerSmokeTest extends AbstractPropertyCompilerSmokeTest {
