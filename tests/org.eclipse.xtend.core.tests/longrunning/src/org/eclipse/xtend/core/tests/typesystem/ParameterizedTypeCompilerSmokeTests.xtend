 ...
 */
abstract class AbstractParameterizedTypeCompilerSmokeTest extends ParameterizedTypeCompilerTest {
 ...
 * @author Sebastian Zarnekow - Initial contribution and API
 */
class SkipLastCharactersParameterizedTypeCompilerSmokeTest extends AbstractParameterizedTypeCompilerSmokeTest {
 ...
 * @author Sebastian Zarnekow - Initial contribution and API
 */
class SkipFirstCharactersParameterizedTypeCompilerSmokeTest extends AbstractParameterizedTypeCompilerSmokeTest {
 ...
 * @author Sebastian Zarnekow - Initial contribution and API
 */
class SkipCharacterInBetweenParameterizedTypeCompilerSmokeTest extends AbstractParameterizedTypeCompilerSmokeTest {
 ...
 * @author Sebastian Zarnekow - Initial contribution and API
 */
class SkipThreeCharactersInBetweenParameterizedTypeCompilerSmokeTest extends AbstractParameterizedTypeCompilerSmokeTest {
 ...
 * @author Sebastian Zarnekow - Initial contribution and API
 */
class SkipTokensInBetweenParameterizedTypeCompilerSmokeTest extends AbstractParameterizedTypeCompilerSmokeTest {
 ...
 * @author Sebastian Zarnekow - Initial contribution and API
 */
class SkipNodesInBetweenParameterizedTypeCompilerSmokeTest extends AbstractParameterizedTypeCompilerSmokeTest {
