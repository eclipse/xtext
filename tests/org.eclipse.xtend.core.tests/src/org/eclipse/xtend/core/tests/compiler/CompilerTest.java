...
public class CompilerTest extends AbstractXtendTestCase {
	...
	@Test
	public void testGenericVoidFunction() throws Exception {
		String code = " def String getString(String myString) {\n"
	...
	public void testRecursiveTypeParameter_01() throws Exception {
		String code = " def String produceString(String s) {\n"
	...
	@Test
	public void testRecursiveTypeParameter_05() throws Exception {
		String code = " def String produceString(String s) {\n"
				+ "   selftypes.ConcreteBuilder::create.append(s).append(s).build\n" + " }";
		invokeAndExpect2("zonkzonk", code, "produceString", "zonk");
	}
	...
	@Test
	public void testRecursiveTypeParameter_06() throws Exception {
		String code = " def String produceString(String s) {\n"
				+ "   selftypes.ConcreteSubBuilder::create.append(s).appendTwice(s).build\n" + " }";
		invokeAndExpect2("zonkzonkzonk", code, "produceString", "zonk");
	}
	...
	@Test
	public void testRecursiveTypeParameter_07() throws Exception {
		String code = " def String produceString(String s) {\n" + "   s.inferReturnType.build\n" + " }\n"
				+ " def inferReturnType(String s) {\n" + "   selftypes.ConcreteBuilder::create.append(s).append(s)"
				+ " }";
		invokeAndExpect2("zonkzonk", code, "produceString", "zonk");
	...
	@Test
	public void testRecursiveTypeParameter_08() throws Exception {
		String code = " def String produceString(String s) {\n" + "   s.inferReturnType.appendTwice(s).build\n"
				+ " }\n" + " def inferReturnType(String s) {\n" + "   selftypes.ConcreteSubBuilder::create.append(s)"
				+ " }";
		invokeAndExpect2("zonkzonkzonk", code, "produceString", "zonk");
	...
	@Test
	public void testRecursiveTypeParameter_09() throws Exception {
		String code = " def String produceString(String s) {\n"
				+ "   selftypes.ConcreteBuilder.create.append(s).append(s).build\n" + " }";
		invokeAndExpect2("zonkzonk", code, "produceString", "zonk");
	}
	...
	@Test
	public void testRecursiveTypeParameter_10() throws Exception {
		String code = " def String produceString(String s) {\n"
				+ "   selftypes.ConcreteSubBuilder.create.append(s).appendTwice(s).build\n" + " }";
		invokeAndExpect2("zonkzonkzonk", code, "produceString", "zonk");
	}
	...
	@Test
	public void testRecursiveTypeParameter_11() throws Exception {
		String code = " def String produceString(String s) {\n" + "   s.inferReturnType.build\n" + " }\n"
				+ " def inferReturnType(String s) {\n" + "   selftypes.ConcreteBuilder.create.append(s).append(s)"
				+ " }";
		invokeAndExpect2("zonkzonk", code, "produceString", "zonk");
	...
	@Test
	public void testRecursiveTypeParameter_12() throws Exception {
		String code = " def String produceString(String s) {\n" + "   s.inferReturnType.appendTwice(s).build\n"
				+ " }\n" + " def inferReturnType(String s) {\n" + "   selftypes.ConcreteSubBuilder.create.append(s)"
				+ " }";
		invokeAndExpect2("zonkzonkzonk", code, "produceString", "zonk");
	...
	@Test
	public void testBug372864() throws Exception {
		String code = " def String testSwitch(Object e) {\n" + "        switch e {\n"
				+ "           Object : return 'foo'\n" + "           default: null\n" + "        }\n" + "    }";
		invokeAndExpect2("foo", code, "testSwitch", new Object());
	}

	@Test
	public void testBug372864_1() throws Exception {
		String code = " def String testSwitch(Object e) {\n" + "        switch e {\n" + "           Object : null\n"
				+ "        }\n" + "    }";
	...
	@Test
	public void testBug372864_2() throws Exception {
		String code = " def String testSwitch(Object e) {\n" + "        switch e {\n"
				+ "           Object : return null\n" + "        }\n" + "    }";
		invokeAndExpect2(null, code, "testSwitch", new Object());
	}
	...
	public void testBug367763() throws Exception {
		String code = "  def String foo(Number x) { throw new IllegalArgumentException() }\n" + "\n"
	...
	public void testFieldInitialization_01() throws Exception {
		String code = "String field = if (true) newArrayList('a', 'b').join(',') else ''\n" + "def getField() {\n"
				+ "  field" + "}";
	...
	public void testFieldInitialization_02() throws Exception {
		String code = "String field = return 123.toString\n" + "def getField() {\n" + "  field" + "}";
		invokeAndExpect2("123", code, "getField");
	}

	@Test
	public void testFieldInitialization_03() throws Exception {
		String code = "int other = 12\n" + "int field = other + 1\n" + "def getField() {\n" + "  field" + "}";
		invokeAndExpect2(Integer.valueOf(13), code, "getField");
	}

	@Test
	public void testFieldInitialization_04() throws Exception {
		String code = "val other = 12\n" + "val field = other + 1\n" + "def getField() {\n" + "  field" + "}";
		invokeAndExpect2(Integer.valueOf(13), code, "getField");
	}

	@Test
	public void testFieldInitialization_05() throws Exception {
		String code = "val String other\n" + "new() { other = 'foo' } \n" + "def getField() {\n" + "  other" + "}";
		invokeAndExpect2("foo", code, "getField");
	}

	@Test
	public void testFieldInitialization_06() throws Exception {
		String code = "extension val String\n" + "new() { _string = 'foo' } \n" + "def getField() {\n" + "  _string"
				+ "}";
		invokeAndExpect2("foo", code, "getField");
	}

	@Test
	public void testFieldInitialization_07() throws Exception {
		String code = "String field = 123.toString\n" + "def getField() {\n" + "  field" + "}";
		invokeAndExpect2("123", code, "getField");
	}
	...
	public void testDeclaredConstructor_04() throws Exception {
		String code = "  static int j " + "  int i " + "  new() { this(j) } " + "  new(int i) { this.i = i } "
	...
	public void testDeclaredConstructor_07() throws Exception {
		String code = "  static int j " + "  int i " + "  new() { this(1 + j * 2 - 1) } "
				+ "  new(int i) { this.i = i } " + "  def static invokeMe() { j = 47 new Y().i }";
		invokeAndExpectStatic(Integer.valueOf(94), code, "invokeMe");
	}

	@Test
	public void testDeclaredConstructorWithVarArgs() throws Exception {
		String code = "int a " + "int b " + "new() { this(1,2) } " + "new(int... i) { " + "  this.a = i.get(0) "
				+ "  this.b = i.get(1) " + "}" + "def static invokeMe() { " + "  val x = new Y() "
				+ "  return x.a -> x.b" + "}";
	...
	public void testBug362236_04() throws Exception {
		String code = "import java.util.List\n" + "class Z {\n" + "    def returnListOfClosures() {  \n"
				+ "      val list = <(String)=>int>newArrayList()" + "      list.add [ length ]" + "      list\n"
				+ "    }\n" + "}";
		String javaCode = compileToJavaCode(code);
		Class<?> class1 = javaCompiler.compileToClass("Z", javaCode);
		Object object = class1.newInstance();
	...
	public void testReferenceStaticallyImportedFields() throws Exception {
		String code = "import java.lang.annotation.RetentionPolicy\n"
	...
	public void testReferenceStaticallyImportedFields_1() throws Exception {
		String code = "import static java.util.Collections.*\n" + "class Z {\n" + "	def Object test() {\n"
				+ "       EMPTY_SET\n" + "	}\n" + "}\n";
		String javaCode = compileToJavaCode(code);
		Class<?> class1 = javaCompiler.compileToClass("Z", javaCode);
		Object object = class1.newInstance();
	...
	public void testSimpleExtensionMethodCall() throws Exception {
		String code = "package x class Z {" + "  def create result : <String>newArrayList() copyNet(String append) {\n"
	...
	public void testExtendsJavaLangObject() throws Exception {
		String code = "package x class Z {" + "  def test() {\n" + "    this.equals(this.toString())\n" + "  }\n"
				+ "}\n";
		String javaCode = compileToJavaCode(code);
		Class<?> class1 = javaCompiler.compileToClass("x.Z", javaCode);
		Object object = class1.newInstance();
	...
	public void testFunctionNameStartingWithUnderscore() throws Exception {
		String code = "package x class Z {" + "  def _foo(Object x, boolean b) {}\n"
	...
	public void testDispatchSignatureWithPrimitives() throws Exception {
		String code = "package x class Z {" + "  def dispatch foo(Object x, boolean b) {}\n"
	 ...
	 */
	@Test
	public void testDispatchedCreateMethods_02() throws Exception {
		String code = "package x class Z {\n"
	...
	public void testBug_345458() throws Exception {
		String code = "package x class Z {" + "  def create(Object x) { \n" + "    if(true) {\n" + "      if(true)\n"
	...
	public void testBug_345828_01() throws Exception {
		String code = "package x\n" + "class Z {" + "  def <T extends =>Integer> baz(T t) {\n"
				+ "    val int i = t.apply\n" + "    if (i == 0)\n" + "      t.apply\n" + "    t.apply\n" + "  }\n"
				+ "}\n";
		String javaCode = compileToJavaCode(code);
		javaCompiler.compileToClass("x.Z", javaCode);
	...
	public void testBug_351330_02() throws Exception {
		String code = "package x class Z <T> {"
	...
	public void testBug_350932_01() throws Exception {
		String code = "package x class Z {" + "  def bug(){\n" + "    if (true) return false\n" + "  }\n"
				+ "  def invoke() {\n" + "    val boolean b = bug\n" + "  }\n" + "}\n";
		String javaCode = compileToJavaCode(code);
		javaCompiler.compileToClass("x.Z", javaCode);
	}
	 ...
	 */
	@Test
	public void testBug_350932_12() throws Exception {
	...
	public void testBug_351582_01() throws Exception {
		String code = "package x class Z {" + "  String s" + "  def sorted(Iterable<Z> it){\n"
				+ "    it.sortBy(z|z.s)\n" + "  }\n" + "}\n";
		String javaCode = compileToJavaCode(code);
		javaCompiler.compileToClass("x.Z", javaCode);
	}
	...
	public void testBug_352705_01() throws Exception {
		String code = "package x class Z {" + "  def void forEachError(testdata.PropertiesHolder h) {\n" + "    {\n"
	...
	public void testBug_352844_01() throws Exception {
		String code = "package x class Z {" + "  	def generate(java.util.List<String> d, String fsa) {\n"
	...
	//	}
	@Test
	public void testBug_352849_01_b() throws Exception {
		String code = "package x\n" + "import java.util.Collection\n" + "import java.util.List\n" + "class Z {"
				+ "  	def generate() {\n" + "		val List<CharSequence> seq = null\n"
	...
	@Test
	public void testBug_352849_02_b() throws Exception {
		String code = "package x\n" + "import java.util.Collection\n" + "import java.util.List\n" + "class Z {"
				+ "  	def generate() {\n" + "		val List<CharSequence> seq = null\n"
				+ "		val List<String> strings = null\n" + "		val Collection<String> result1 = seq.addAll2(strings)\n"
				+ "		val Collection<String> result2 = strings.addAll3(seq)\n" + "	}\n"
	...
	@Test
	public void testBug_396879_01() throws Exception {
	...
	@Test
	public void testBug_396879_02() throws Exception {
		String code = "package x\n" + "import bug396879.*\n" + "class Z {\n"
	...
	@Test
	public void testBug_396879_03() throws Exception {
		String code = "package x\n" + "import bug396879.*\n" + "class Z {\n"
	...
	public void testSuperCall() throws Exception {
		Class<?> clazz = compileJavaCode("x.Y", "package x class Y extends Object {"
				+ "  override boolean equals(Object p){\n" + "    if ('foo' == p) " + "       return true"
				+ "    else " + "       super.equals(p)" + "  }\n" + "}");
	...
	public void testSuperCall_00() throws Exception {
		String code = "package x class Z {" + "  override boolean equals(Object p){\n" + "    if ('foo' == p) "
				+ "       return true" + "    else " + "       return super.equals(p)" + "  }\n" + "}";
		String javaCode = compileToJavaCode(code);
	...
	public void testCreateExtension_00() throws Exception {
		Class<?> clazz = compileJavaCode("x.Y", "package x " + "class Y {"
				+ "  def create result: new StringBuilder() aBuilder(String x) {" + "   result.append(x)" + "  }" + "}");
		Object instance = clazz.newInstance();
	...
	public void testCreateExtension_01() throws Exception {
		Class<?> clazz = compileJavaCode("x.Y", "package x " + "import java.util.List " + "class Y {"
				+ "  def Iterable<String> create result: newArrayList listWith(String s) {" + "   result.add(s)"
				+ "  }" + "}");
		Object instance = clazz.newInstance();
	...
	public void testCreateExtension_02() throws Exception {
		Class<?> clazz = compileJavaCode("foo.Bar", "package foo " + "class Bar { "
	...
	public void testCreateExtension_03() throws Exception {
		Class<?> clazz = compileJavaCode("x.Y", "package x " + "import java.util.List " + "class Y {"
				+ "  def Iterable<String> create newArrayList listWith(String s) {" + "   it.add(s)\n" + "   add(s)\n"
				+ "  }" + "}");
		Object instance = clazz.newInstance();
		Method method = clazz.getDeclaredMethod("listWith", String.class);
		@SuppressWarnings("unchecked")
	...
	public void testCreateExtension_Bug362868() throws Exception {
		Class<?> clazz = compileJavaCode("x.Y", "package x " + "import java.util.List " + "import java.util.ArrayList "
				+ "class Y {" + "  def List<String> newArrayList() {\n" + "    return new ArrayList<String>()\n"
				+ "  }\n" + "  def Iterable<String> create this.newArrayList listWith(String s) {" + "   it.add(s)\n"
				+ "   add(s)\n" + "  }" + "}");
		Object instance = clazz.newInstance();
		Method method = clazz.getDeclaredMethod("listWith", String.class);
		@SuppressWarnings("unchecked")
	...
	public void testInferredReturnType() throws Exception {
		Class<?> clazz = compileJavaCode("x.Y", "package x " + "class Y {" + "  def int a() {" + "   b()" + "  }"
				+ "  " + "  def b() {" + "    c()" + "  }" + "  " + "  def c() {" + "    2" + "  }" + "}");
	...
	public void testSugarForLocalExtensions_01() throws Exception {
		Class<?> class1 = compileJavaCode("x.Y", "package x " + "class Y { " + " def operator_plus(int x, String s) {"
				+ "   x.toString + s" + " }" + "" + " def test() {" + "    return 42 + 'foo'" + " }" + "}");
		assertEquals("42foo", apply(class1, "test"));
	}

	@Test
	public void testSugarForLocalExtensions_02() throws Exception {
		Class<?> class1 = compileJavaCode("x.Y", "package x " + "class Y { " + " def getSize(String s) {"
				+ "   s.length" + " }" + "" + " def test() {" + "    return 'foo'.size" + " }" + "}");
	...
	public void testStaticExtensionMethod_01() throws Exception {
		Class<?> class1 = compileJavaCode("x.Y",
				"package x import static extension java.util.Collections.* class Y { def foo() {'foo'.singleton()}}");
		assertEquals(singleton("foo"), apply(class1, "foo"));
	}

	@Test
	public void testStaticExtensionMethod_02() throws Exception {
		Class<?> class1 = compileJavaCode("x.Y", "package x " + "import static extension java.util.Collections.* "
				+ "class Y { " + " def foo() {" + "   'foo'.singleton" + " }" + "}");
		assertEquals(singleton("foo"), apply(class1, "foo"));
	}

	@Test
	public void testImportNestedTypes_01() throws Exception {
		String code = "package x " + "import java.util.Map$Entry " + "import java.util.Map " + "class Z { "
	...
	@Test
	public void testImportNestedTypes_02() throws Exception {
		String code = "package x " + "import java.util.Map.Entry " + "import java.util.Map " + "class Z { "
				+ " def foo(Map$Entry e1, Entry e2, Map m) {" + " }" + "}";
		String javaCode = compileToJavaCode(code);
		javaCompiler.compileToClass("x.Z", javaCode);
	...
	@Test
	public void testImportNestedTypes_03() throws Exception {
		String code = "package x " + "import java.util.Map.Entry " + "import java.util.Map " + "class Z { "
				+ " def foo(Map.Entry e1, Entry e2, Map m) {" + " }" + "}";
		String javaCode = compileToJavaCode(code);
		javaCompiler.compileToClass("x.Z", javaCode);
	...
	@Test
	public void testImportNestedTypes_04() throws Exception {
		String code = "package x " + "import java.util.Map$Entry " + "import java.util.Map " + "class Z { "
				+ " def foo(Map.Entry e1, Entry e2, Map m) {" + " }" + "}";
		String javaCode = compileToJavaCode(code);
		javaCompiler.compileToClass("x.Z", javaCode);
	...
	public void testInjectedExtensionMethod_01() throws Exception {
		Class<?> class1 = compileJavaCode("x.Y", "package x " + "class Y { "
				+ "  @com.google.inject.Inject extension test.GenericExtensionMethods<String,Integer> x" + "  "
				+ "  def foo(String arg) { " + "    arg.method " + "    42.method" + "    return x.result" + "  }"
				+ "}");
	...
	public void testInjectedExtensionMethod_02() throws Exception {
		Class<?> class1 = compileJavaCode("x.Y", "package x " + "class Y { "
				+ "  @com.google.inject.Inject extension test.ExtensionMethods e" + "  " + "  def foo(String arg) { "
	...
	public void testInjectedExtensionMethod_05() throws Exception {
		Class<?> class1 = compileJavaCode(
				"x.Y",
				"package x class Y { @com.google.inject.Inject extension test.ExtensionMethods e def foo(String arg) { return arg.operator_minus('bar') } }");
	...
	public void testInjectedExtensionMethod_06() throws Exception {
		Class<?> class1 = compileJavaCode("x.Y", "package x " + "class Y { "
				+ "  @com.google.inject.Inject extension test.ExtensionMethods e" + "  def a(String arg) { "
				+ "    return arg.operator_minus('bar') " + "  } " + "  def b(String arg) { "
				+ "    return (arg as Object).operator_minus('bar') " + "  } " + "  def c(String arg) { "
				+ "    return arg.operator_minus('bar' as Object) " + "  } " + "  def d(String arg) { "
	...
	public void testInjectedExtensionMethod_07() throws Exception {
		Class<?> class1 = compileJavaCode("x.Y", "package x " + "class Y { "
				+ "  @com.google.inject.Inject extension test.ExtensionMethods" + "  " + "  def foo(String arg) { "
				+ "    (arg as CharSequence).generic()" + "  }" + "}");
		assertEquals(ExtensionMethods.GENERIC_T, apply(class1, "foo", "x"));
	}
	...
	public void testInjectedExtensionMethod_10() throws Exception {
		Class<?> class1 = compileJavaCode(
				"x.Y",
				"package x class Y { @com.google.inject.Inject extension test.ExtensionMethods def foo(String arg) { return arg.operator_minus('bar') } }");
		assertEquals(ExtensionMethods.OPERATOR_MINUS_STRING_STRING, apply(class1, "foo", "foobar"));
	}
	...
	public void testInjectedExtensionMethod_11() throws Exception {
		Class<?> class1 = compileJavaCode("x.Y", "package x " + "class Y { "
				+ "  @com.google.inject.Inject extension test.ExtensionMethods" + "  def a(String arg) { "
				+ "    return arg.operator_minus('bar') " + "  } " + "  def b(String arg) { "
				+ "    return (arg as Object).operator_minus('bar') " + "  } " + "  def c(String arg) { "
				+ "    return arg.operator_minus('bar' as Object) " + "  } " + "  def d(String arg) { "
				+ "    return arg.operator_minus('bar' as CharSequence) " + "  } " + "}");
	...
	public void testExtensionMethodForLocalFunctions_00() throws Exception {
		invokeAndExpect2("foobar", "def with(String x, String y) { x+y} def main(String x) { x.with('bar')}", "main",
				"foo");
	}

	@Test
	public void testClosureReturnsVoid() throws Exception {
		invokeAndExpect2(null, "def foo() { " + "  [|{}].apply" + "}", "foo");
	}

	@Test
	public void testDependencyDeclaration() throws Exception {
		invokeAndExpect2(Boolean.TRUE, "def check() {obj!=null} @com.google.inject.Inject test.ExtensionMethods obj",
				"check");
	}

	@Test
	public void testReturnTypeAndReturnExpression_00() throws Exception {
		String decl = "def String test() {" + "  return 'foo'" + "}";
		invokeAndExpect2("foo", decl, "test");
	}

	@Test
	public void testReturnTypeAndReturnExpression_01() throws Exception {
		String decl = "def CharSequence test() {" + "  if ('foo' == 'foo') {" + "    return 'foo'" + "  }" + "}";
		invokeAndExpect2("foo", decl, "test");
	}
	...
	public void testDispatchFunction_01() throws Exception {
		final String definition = "x(p1)} " + "def  dispatch x(Comparable<Boolean> s) {'comparable'}"
				+ "def  dispatch x(String s) {'string'}" + "def  dispatch x(CharSequence o) {'charSeq'}"
	...
	public void testDispatchFunction_02() throws Exception {
		final String definition = "x(p1 as String)}" + "def  dispatch x(Void s) {'null'}"
	...
	public void testDispatchFunction_04() throws Exception {
		final String definition = "x(p1)}" + " def dispatch x(int s) {'int'}"
				+ " def dispatch x(boolean s) {'boolean'}" + " def dispatch x(double s) {'double'";
	...
	public void testDispatchFunction_06() throws Exception {
		final String definition = "foo(p1)} " + "def dispatch foo (String string) {\n" + "    string + string\n"
	...
	public void testDispatchFunction_07() throws Exception {
		final String definition = "def invokeMe(String p1) { foo(p1) }\n" + "def dispatch foo (String string) {\n"
	...
	public void testDispatchFunction_08() throws Exception {
		final String definition = "foo(p1)} " + "def dispatch String foo(String string) {\n" + "    string + string\n"
	...
	public void testGenericFunction_01() throws Exception {
		final String definition = "def test(String arg) {\n" + "  arg.doApply(e|e+arg);\n" + "}\n" + "\n"
	...
	public void testGenericFunction_02() throws Exception {
		String def = "def test(String x) {" + "  x.init(e|{})" + "}" + "def <T> T init(T obj, (T)=>Void function) {\n"
				+ "  function.apply(obj)\n" + "  return obj\n" + "}";
	...
	public void testBug342134() throws Exception {
		...
		invokeAndExpect2(list, "def bug342134(java.util.ArrayList<String> strings) {\n"
				+ "    strings.map(e| newArrayList(e)).flatten.toList\n" + "}", "bug342134", list);
	}

	@Test
	public void testTypeInferrence_00() throws Exception {
		compileJavaCode("Foo", "import org.eclipse.emf.ecore.EObject " + "class Foo { "
				+ "	def Iterable<? extends EObject> test(EObject e) {" + "		e.eContents().map(o|test(o)).flatten()"
				+ "	}" + "}");
	}

	@Test
	public void testDispatchTypes() throws Exception {
		compileJavaCode("Dispatch", "class Dispatch { " + "  def dispatch doSomething(int i) { i.toString() } "
				+ "  def dispatch doSomething(Object o) { null } " + "}");
	}

	@Test
	public void testBug343090_1() throws Exception {
		invokeAndExpect2(23, "def bug343090(Integer a, Integer b) {\n" + "    addFunction.apply(a, b)\n" + "}\n"
	...
	public void testBug343090_3() throws Exception {
		invokeAndExpect2(23, "def bug343090(Integer a, Integer b) {\n" + "    addFunction.apply(a, b)\n" + "}\n"
				+ "def <T extends Integer> addFunction() {\n" + "    [T a,T b|a+b] as (T,T)=>T\n" + "}", "bug343090",
				Integer.valueOf(18), Integer.valueOf(5));
	}
	...
	public void testBug343088_1() throws Exception {
		invokeAndExpect2(23, "def bug343088(Integer a, Integer b) {\n" + "    addFunction.apply(a, b)\n" + "}\n"
	...
	public void testBug358418_01() throws Exception {
		invokeAndExpect3(Lists.<Object> newArrayList(), "def <T> Iterable<T> nullSafe(Iterable<T> elements) {\n"
				+ "  if (elements == null)\n" + "    newArrayList\n" + "  else\n" + "    elements\n" + "}", "nullSafe",
				new Class[] { Iterable.class }, new Object[] { null });
	}

	@Test
	public void testBug358418_02() throws Exception {
		invokeAndExpect3(Lists.newArrayList("a", "b"), "def <T> Iterable<T> nullSafe(Iterable<T> elements) {\n"
				+ "  if (elements == null)\n" + "    newArrayList\n" + "  else\n" + "    elements\n" + "}", "nullSafe",
				new Class[] { Iterable.class }, Lists.newArrayList("a", "b"));
	}

	@Test
	public void testBug342274() throws Exception {
		invokeAndExpect2(null, "def void castNull() {\n" + "  var raw = null as Iterable\n"
	...
	public void testBug343096_01() throws Exception {
		compileJavaCode("x.Y", "package x class Y {" + "def <T> bug343096() {\n" + "  [T t|switch t {\n"
				+ "    case t : bug343096\n" + "  }]" + "}}");
	}

	@Test
	public void testBug343096_02() throws Exception {
		invokeAndExpect2(Functions.Function1.class.getCanonicalName(), "def <T> bug343096() {\n"
	...
	public void testBug343096_03() throws Exception {
		invokeAndExpect2(Object.class.getCanonicalName(), "def <T> bug343096() {\n" + "  [T t|switch t {\n"
				+ "    case t : bug343096\n" + "  }].getClass.superclass.canonicalName" + "}", "bug343096");
	}

	@Test
	public void testBug345373_01() throws Exception {
		invokeAndExpect3("string", "def String rawListGet(java.util.List elements) {\n"
	...
	public void testBug345373_02() throws Exception {
		invokeAndExpect3("no string", "def String rawListGet(java.util.List elements) {\n"
				+ "  if (elements.get(0) instanceof String) {\n" + "    'string'\n" + "  } else {" + "    'no string'"
	...
	public void testBug346763_03() throws Exception {
		...
		//			}
		//		}
		invokeAndExpect2(Collections.singletonList("A"), "def java.util.List<String> wildcardExtends() {\n"
	...
	public void testBug346763_05() throws Exception {
		//		List<? extends String> strings = null;
		//		IterableExtensions.forEach(strings, (Functions.Function1<CharSequence, Void>) null);
		invokeAndExpect2(null, "def void forEachString() {\n" + "  var java.util.List<String> v = null\n"
				+ "  if (v != null) v.forEach(CharSequence e|e.length)\n" + "}", "forEachString");
	}
	...
	public void testBug346763_07() throws Exception {
		...
		//			}
		//		}
		invokeAndExpect2(Collections.singletonList("A"), "def java.util.List<String> wildcardSuper() {\n"
	...
	public void testBug358118_NoNPE() throws Exception {
		invokeAndExpect2(null, "def dispatch void recursiveMethod(CharSequence r, java.util.Set<Object> shapes) {}\n"
	...
	public void testBug355848() throws Exception {
		invokeAndExpect2(Integer.valueOf(1), "def closureWithPrimitives() {\n" + "    val (int)=>int sum = [a|a]\n"
				+ "    sum.apply(1)" + "}", "closureWithPrimitives");
	}

	@Test
	public void testBug356742_01() throws Exception {
		invokeAndExpect2("logInfo(a)",
				"@com.google.inject.Inject extension testdata.ClassWithVarArgs classWithVarArgs\n" + "\n"
						+ "def doLog() {" + "    classWithVarArgs.logInfo('a')\n" + "}", "doLog");
	}

	@Test
	public void testBug356742_02() throws Exception {
		invokeAndExpect2("logInfo(a, args...)",
				"@com.google.inject.Inject extension testdata.ClassWithVarArgs classWithVarArgs\n" + "\n"
						+ "def doLog() {" + "    classWithVarArgs.logInfo('a', 'b')\n" + "}", "doLog");
	}

	@Test
	public void testBug356742_03() throws Exception {
		invokeAndExpect2("logInfo(a, args...)", "@com.google.inject.Inject extension testdata.ClassWithVarArgs\n"
				+ "\n" + "def doLog() {" + "    'a'.logInfo('b')\n" + "}", "doLog");
	}

	@Test
	public void testBug356742_04() throws Exception {
		invokeAndExpect2("logInfo(a)", "@com.google.inject.Inject extension testdata.ClassWithVarArgs\n" + "\n"
				+ "def doLog() {" + "    'a'.logInfo()\n" + "}", "doLog");
	}

	@Test
	public void testOperationParameterOnScope() throws Exception {
		String code = "package foo " + "class Bar {" + "  def foo(int bar) {" + "    switch(bar) {"
				+ "      case 1: 'bar'" + "    }" + "  }" + "}";
		String javaCode = compileToJavaCode(code);
	...
	public void testArrayConversion_01() throws Exception {
		...
		invokeAndExpect3(expected, "def int[] unpackArray(Iterable<Integer> iterable) {" + "    return iterable\n"
	...
	public void testArrayConversion_02() throws Exception {
		int[] expected = new int[] { 1, 2, 3 };
		String classBody = "def int[] unpackArray(Iterable<Integer> iterable) {" + "    return iterable\n" + "}";
		...
		assertTrue(Arrays.toString((int[]) result) + "!=" + Arrays.toString(expected),
				Arrays.equals(expected, (int[]) result));
	}

	@Test
	public void testArrayConversion_03() throws Exception {
		String code = "package foo " + "class Bar extends testdata.ArrayClient {"
				+ "  override toStringArray(String s1, String s2) {" + "    newArrayList(s1, s2)" + "  }" + "}";
	...
	public void testImplictFirstArgument_01() throws Exception {
		invokeAndExpect2("Hello World", "def prependHello(String myString) {\n" + "  'Hello '+myString\n" + "}\n"
				+ "def testExtensionMethods(String it) {\n" + "  prependHello\n" + "}", "testExtensionMethods", "World");
	}

	@Test
	public void testImplictFirstArgument_02() throws Exception {
		String code = "package foo " + "class Bar {\n" + "  @com.google.inject.Inject\n"
				+ "  extension test.SampleBuilder" + "  def createRoot(String first, String second, String third) {"
				+ "    root [" + "      name = first" + "      parent [" + "        name = second" + "        child ["
				+ "          name = third" + "        ]" + "      ]\n" + "    ]" + "  }" + "}";
		Class<?> class1 = compileJavaCode("foo.Bar", code);
		Object result = applyImpl(class1, "createRoot", new Class[] { String.class, String.class, String.class }, "a",
				"b", "c");
	...
	public void testImplictFirstArgument_03() throws Exception {
		String code = "package foo " + "import static extension test.SampleBuilder.*" + "class Bar {\n"
				+ "  def createRoot(String first, String second, String third) {" + "    staticRoot ["
				+ "      name = first" + "      staticParent [" + "        name = second" + "        staticChild ["
				+ "          name = third" + "        ]" + "      ]\n" + "    ]" + "  }" + "}";
		Class<?> class1 = compileJavaCode("foo.Bar", code);
		Object result = applyImpl(class1, "createRoot", new Class[] { String.class, String.class, String.class }, "a",
				"b", "c");
	...
	public void testBug361539_01() throws Exception {
		invokeAndExpect2(Boolean.TRUE, "def addHelloWorld(String myString) {\n" + "  myString.foos += 'Hello World'\n"
	...
	public void testBug361539_02() throws Exception {
		invokeAndExpect2(Boolean.TRUE, "def addHelloWorld(String it) {\n" + "  foos += 'Hello World'\n" + "}\n"
				+ "def getFoos(String key) {\n" + "  if (key == 'zonk') newArrayList(key) \n" + "}", "addHelloWorld",
				"zonk");
	}
	...
	public void testAssignmentWithExtension_01() throws Exception {
		invokeAndExpect2("Hello World", "def doStuff(String it, String addMe) {\n" + "  things=addMe\n" + "}\n"
	...
	public void testThrowsDeclaration() throws Exception {
		try {
			invokeAndExpect2(null, "def foo() throws NoSuchFieldException { throw new NoSuchFieldException(\"foo\") }",
					"foo");
		} catch (InvocationTargetException e) {
	...
	public void testRichStringAndSwitch() throws Exception {
		invokeAndExpect2("foo", "def x() { " + "	runTest().toString() " + "} "
				+ "def runTest() '''«switch x : '''test''' { CharSequence : '''foo''' }»'''", "x");
	}

	@Test
	public void testBug366293() throws Exception {
		invokeAndExpect2("success", "def String whileLoopTest () {\n" + "        while (true)\n"
				+ "            try {\n" + "                return 'success'\n" + "            }\n"
				+ "            catch (Exception ex)\n" + "            {\n" + "                throw ex\n"
				+ "            }    \n" + "		 return 'failure'" + "    }", "whileLoopTest");
	}
	...
	public void testBug366293_related() throws Exception {
		invokeAndExpect2("success", "def String whileLoopTest () {\n" + "  do {\n" + "    try {\n"
				+ "      toString()\n" + "      return 'success'\n" + "    }\n" + "    catch (Exception ex)\n"
				+ "    {\n" + "      throw ex\n" + "    }\n" + "  } while (true)" + "}", "whileLoopTest");
	}

	@Test
	public void testBug366525_0() throws Exception {
		try {
			invokeAndExpect2(null, "  def foo() {\n"
	...
	protected void invokeAndExpectStatic(Object expectation, String xtendclassBody, String methodToInvoke,
	...
	protected Object applyImpl(Class<?> type, String methodName, Class<?>[] parameterTypes, Object... args)
			throws Exception {
	...
	protected Object applyStatic(Class<?> type, String methodName, Class<?>[] parameterTypes, Object... args)
			throws Exception {
		if (args == null) {
	...
	public void testVarArgs() throws Exception {
		invokeAndExpect2("[FOO, BAR, BAZ]", "def String foo() {" + "  foo('foo','bar','baz')" + "}"
				+ "def String foo(String ... s) { " + "  s.map[toUpperCase].toString" + "}", "foo");
	}

	@Test
	public void testSpaceShipOperator() throws Exception {
		invokeAndExpect2("FOOBARBAZ", "def String foo() {" + "  'foo' <=> 'bar' <=> 'baz'" + "}"
				+ "def String operator_spaceship(String a, String b) { " + "  a.toUpperCase + b.toUpperCase" + "}",
				"foo");
	}
	...
	public void testDiamondOperator() throws Exception {
		invokeAndExpect2("FOOBARBAZ", "def String foo() {" + "  'foo' <> 'bar' <> 'baz'" + "}"
				+ "def String operator_diamond(String a, String b) { " + "  a.toUpperCase + b.toUpperCase" + "}", "foo");
	}

	@Test
	public void testTripleLessThanOperator() throws Exception {
		invokeAndExpect2("FOOBARBAZ",
				"def String foo() {" + "  'foo' <<< 'bar' <<< 'baz'" + "}"
						+ "def String operator_tripleLessThan(String a, String b) { "
						+ "  a.toUpperCase + b.toUpperCase" + "}", "foo");
	}

	@Test
	public void testAbstractClasses_01() throws Exception {
		Class<?> code = compileJavaCode("foo.Bar", "package foo abstract class Bar {}");
		assertTrue(Modifier.isAbstract(code.getModifiers()));
	}

	@Test
	public void testAbstractClasses_02() throws Exception {
	...
	@Test
	public void testProperty_01() throws Exception {
		Class<?> code = compileJavaCode("foo.Bar",
				"package foo class Bar { @Property var String myField = 'hello' def String getMyField() { _myField.toUpperCase } }");
	...
	public void testData_01() throws Exception {
		Class<?> code = compileJavaCode("foo.Bar",
				"package foo @Data class Bar { val myField = 'hello' boolean myFlag }");
		Method getter = code.getDeclaredMethod("getMyField");
	...
	public void testData_02() throws Exception {
		Class<?> code = compileJavaCode("foo.Bar",
				"package foo @Data class Bar extends test.BasicDataClass { val myField = 'hello' boolean myFlag }");
		Method getter = code.getDeclaredMethod("getMyField");
		Method isMyFlag = code.getDeclaredMethod("isMyFlag");
