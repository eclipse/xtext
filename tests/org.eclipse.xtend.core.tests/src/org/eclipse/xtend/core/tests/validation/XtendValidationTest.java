...
public class XtendValidationTest extends AbstractXtendTestCase {
	...
	@Test public void testMultipleAnnotations_00() throws Exception {
		XtendClass clazz = clazz("@testdata.Annotation2('foo') @testdata.Annotation2('bar')  class X { }");
		helper.assertError(clazz, XAnnotationsPackage.Literals.XANNOTATION, ANNOTATION_MULTIPLE, "@Annotation2");
	}
