...
class CompilerBug435473Test extends AbstractXtendCompilerTest {
	...
	def test_01() {
		...
		''', '''
			...
			public class Outer {
			  private final List<Function0<?>> x = Collections.<Function0<?>>unmodifiableList(CollectionLiterals.<Function0<?>>newArrayList(new Function0<Integer>() {
	...
	def test_02() {
		...
		''', '''
			...
			@SuppressWarnings("all")
			public class Outer {
			  private final List<Function0<? extends Number>> x = Collections.<Function0<? extends Number>>unmodifiableList(CollectionLiterals.<Function0<? extends Number>>newArrayList(new Function0<Integer>() {
			    public Integer apply() {
			      return Integer.valueOf(1);
			    }
			  }, new Function0<Double>() {
	...
	def test_05() {
		...
		''', '''
			...
			@SuppressWarnings("all")
			public class Outer {
			  private final Set<Function0<? extends Number>> x = Collections.<Function0<? extends Number>>unmodifiableSet(CollectionLiterals.<Function0<? extends Number>>newHashSet(new Function0<Integer>() {
			    public Integer apply() {
			      return Integer.valueOf(1);
			    }
			  }, new Function0<Double>() {
	...
	def test_07() {
		...
		''', '''
			...
			@SuppressWarnings("all")
			public class Outer {
			  private final Set<? extends Function0<? extends Number>> x = Collections.<Function0<? extends Number>>unmodifiableSet(CollectionLiterals.<Function0<? extends Number>>newHashSet(new Function0<Integer>() {
			    public Integer apply() {
			      return Integer.valueOf(1);
			    }
			  }, new Function0<Double>() {
