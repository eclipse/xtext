	...
	def test_01() {
		...
		''', '''
			...
			public class Outer {
			  ...
			  private final Set<Class<? extends Outer.C>> x = Collections.<Class<? extends Outer.C>>unmodifiableSet(CollectionLiterals.<Class<? extends Outer.C>>newHashSet(Outer.C0.class, Outer.C1.class));
			}
		''')
	}
	...
	def test_02() {
		...
		''', '''
			...
			public class Outer {
			  ...
			  private final List<Class<? extends Outer.C>> x = Collections.<Class<? extends Outer.C>>unmodifiableList(CollectionLiterals.<Class<? extends Outer.C>>newArrayList(Outer.C0.class, Outer.C1.class));
			}
		''')
	}
