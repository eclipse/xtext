 ...
 */
abstract class AbstractTypeArgumentCollectorTest extends AbstractXtendTestCase {

	@Inject
	extension IXtendJvmAssociations
	
	def Multimap<JvmTypeParameter, ? extends Object> mappedBy(String typeParameters, String... alternatingTypeReferences)
	...
	def Multimap<JvmTypeParameter, ? extends Object> assertMapping(Multimap<JvmTypeParameter, ? extends Object> mapping, String typeParamName, Triple<String,VarianceInfo,VarianceInfo>... mappedTypes)
	
	def Multimap<JvmTypeParameter, ? extends Object> assertOrigins(Multimap<JvmTypeParameter, ? extends Object> mapping, String typeParamName, int count)
