 ...
 * </copyright>
 *
 * $Id: EnumsFactoryImpl.java,v 1.1 2010/02/03 18:24:43 sefftinge Exp $
 */
...
public class EnumsFactoryImpl extends EFactoryImpl implements EnumsFactory {
	...
	public static EnumsFactory init() {
		try {
			EnumsFactory theEnumsFactory = (EnumsFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.eclipse.org/2009/tmf/xtext/ui/EnumRulesTestLanguage/imported"); 
