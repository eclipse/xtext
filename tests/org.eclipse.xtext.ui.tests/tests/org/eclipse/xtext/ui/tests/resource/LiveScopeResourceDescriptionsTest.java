...
import org.eclipse.xtext.ui.resource.XtextLiveModelScopeResourceSetProvider;
...
public class LiveScopeResourceDescriptionsTest extends AbstractScopeResourceDescriptionsTest {
	...
	@Inject
	private XtextLiveModelScopeResourceSetProvider liveModelScopeResourceSetProvider;
	...
	protected ResourceSet createResourceSet(IProject project) {
		return liveModelScopeResourceSetProvider.get(project);
	}
}
