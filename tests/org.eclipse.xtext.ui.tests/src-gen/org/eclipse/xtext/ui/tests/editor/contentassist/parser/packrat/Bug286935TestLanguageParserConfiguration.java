...
import org.eclipse.xtext.ui.tests.editor.contentassist.parser.packrat.consumers.Bug286935TestLanguageStateConsumer;
import org.eclipse.xtext.ui.tests.editor.contentassist.parser.packrat.consumers.Bug286935TestLanguageStateTypeConsumer;
...
public class Bug286935TestLanguageParserConfiguration extends AbstractParserConfiguration {
	...
	public void configureConsumers() {
		...
		getStateConsumer().setKeyword$11$Delimiter(org.eclipse.xtext.ui.tests.editor.contentassist.parser.packrat.Bug286935TestLanguageDelimiters.keyword$6$Delimiter);
		getStateConsumer().setKeyword$16$Delimiter(org.eclipse.xtext.ui.tests.editor.contentassist.parser.packrat.Bug286935TestLanguageDelimiters.keyword$6$Delimiter);
		getStateConsumer().setKeyword$20$Delimiter(org.eclipse.xtext.ui.tests.editor.contentassist.parser.packrat.Bug286935TestLanguageDelimiters.keyword$6$Delimiter);
		getStateConsumer().setKeyword$21$Delimiter(org.eclipse.xtext.ui.tests.editor.contentassist.parser.packrat.Bug286935TestLanguageDelimiters.keyword$6$Delimiter);
		getStateConsumer().setKeyword$4$Delimiter(org.eclipse.xtext.ui.tests.editor.contentassist.parser.packrat.Bug286935TestLanguageDelimiters.keyword$6$Delimiter);
		getStateConsumer().setKeyword$6$Delimiter(org.eclipse.xtext.ui.tests.editor.contentassist.parser.packrat.Bug286935TestLanguageDelimiters.keyword$6$Delimiter);
		getStateConsumer().setRuleCall$23$Delimiter(org.eclipse.xtext.ui.tests.editor.contentassist.parser.packrat.Bug286935TestLanguageDelimiters.ruleCall$25$Delimiter);
		getStateConsumer().setRuleCall$25$Delimiter(org.eclipse.xtext.ui.tests.editor.contentassist.parser.packrat.Bug286935TestLanguageDelimiters.ruleCall$27$Delimiter);
	}
