...
public class TwoParametersTestLanguageGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class ParserRuleParametersElements extends AbstractParserRuleElementFinder {
		...
		//	'#9' (scenario=Scenario8<true,true> | scenario=Scenario6<true,true> 'trailing'?) | '#10'
		//	(scenario=Scenario8<true,true> | scenario=Scenario6<false,false> 'trailing'?) | '#11' (scenario=Scenario8<false,false>
		//	| scenario=Scenario6<true,true> 'trailing'?) | '#12' (scenario=Scenario8<false,false> |
		//	scenario=Scenario6<false,false> 'trailing'?));
		@Override public ParserRule getRule() { return rule; }

		//{ParserRuleParameters} ('#1' scenario=Scenario5<true,true> | '#2' scenario=Scenario5<false,false> | '#3'
		//scenario=Scenario6<true,true> | '#4' scenario=Scenario6<false,true> | => ('#5' scenario=Scenario6<true,true>) | =>
		//('#6' scenario=Scenario6<false,false>) | '#7' scenario=Scenario7<true,true> | '#8' scenario=Scenario7<false,true> |
		//'#9' (scenario=Scenario8<true,true> | scenario=Scenario6<true,true> 'trailing'?) | '#10' (scenario=Scenario8<true,true>
		//| scenario=Scenario6<false,false> 'trailing'?) | '#11' (scenario=Scenario8<false,false> | scenario=Scenario6<true,true>
		//'trailing'?) | '#12' (scenario=Scenario8<false,false> | scenario=Scenario6<false,false> 'trailing'?))
		...
		//scenario=Scenario6<true,true> 'trailing'?) | '#10' (scenario=Scenario8<true,true> | scenario=Scenario6<false,false>
		//'trailing'?) | '#11' (scenario=Scenario8<false,false> | scenario=Scenario6<true,true> 'trailing'?) | '#12'
		//(scenario=Scenario8<false,false> | scenario=Scenario6<false,false> 'trailing'?))
		...
		//(scenario=Scenario8<true,true> | scenario=Scenario6<true,true> 'trailing'?)
		...
		//scenario=Scenario6<true,true> 'trailing'?
		...
		//(scenario=Scenario8<true,true> | scenario=Scenario6<false,false> 'trailing'?)
		...
		//(scenario=Scenario8<false,false> | scenario=Scenario6<true,true> 'trailing'?)
	...
	public class Scenario5Elements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "org.eclipse.xtext.ui.tests.editor.contentassist.TwoParametersTestLanguage.Scenario5");
