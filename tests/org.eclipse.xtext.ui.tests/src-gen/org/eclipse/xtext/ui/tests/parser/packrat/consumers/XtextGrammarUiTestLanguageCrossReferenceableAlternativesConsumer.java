...
import org.eclipse.xtext.ui.tests.services.XtextGrammarUiTestLanguageGrammarAccess.CrossReferenceableAlternativesElements;

public final class XtextGrammarUiTestLanguageCrossReferenceableAlternativesConsumer extends NonTerminalConsumer {

	private CrossReferenceableAlternativesElements rule;	

	private INonTerminalConsumer crossReferenceableTerminalConsumer;
	...
	protected class RuleCall$2$Consumer extends ElementConsumer<RuleCall> {
		...
		protected int doConsume(boolean optional) throws Exception {
			return consumeNonTerminal(crossReferenceableTerminalConsumer, null, false, false, false, getElement(), optional);
		}
	}
	...
	protected class RuleCall$9$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeNonTerminal(crossReferenceableTerminalConsumer, "groups", true, false, false, getElement(), optional);
		}
	}

	public XtextGrammarUiTestLanguageCrossReferenceableAlternativesConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public CrossReferenceableAlternativesElements getRule() {
		return rule;
	}
	
	public void setRule(CrossReferenceableAlternativesElements rule) {
		this.rule = rule;
		
		group$1$Consumer = new Group$1$Consumer(rule.getGroup());
		ruleCall$2$Consumer = new RuleCall$2$Consumer(rule.getCrossReferenceableTerminalParserRuleCall_0());
		...
		ruleCall$9$Consumer = new RuleCall$9$Consumer(rule.getGroupsCrossReferenceableTerminalParserRuleCall_1_1_1_0());
	}
	...
	public void setCrossReferenceableTerminalConsumer(INonTerminalConsumer crossReferenceableTerminalConsumer) {
		this.crossReferenceableTerminalConsumer = crossReferenceableTerminalConsumer;
	}
