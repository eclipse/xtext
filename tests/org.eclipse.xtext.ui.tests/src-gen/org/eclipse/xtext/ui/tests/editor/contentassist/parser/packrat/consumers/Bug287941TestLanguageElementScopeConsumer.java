...
import org.eclipse.xtext.ui.tests.editor.contentassist.services.Bug287941TestLanguageGrammarAccess.ElementScopeElements;

public final class Bug287941TestLanguageElementScopeConsumer extends NonTerminalConsumer {

	private ElementScopeElements rule;	
	...
	protected class RuleCall$5$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(stringConsumer, "uris", true, false, getElement(), getRuleCall$5$Delimiter(), optional);
		}
	}
	...
	protected class RuleCall$9$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(stringConsumer, "uris", true, false, getElement(), getRuleCall$9$Delimiter(), optional);
		}
	}
	...
	public Bug287941TestLanguageElementScopeConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public ElementScopeElements getRule() {
		return rule;
	}
	
	public void setRule(ElementScopeElements rule) {
		this.rule = rule;
		
		group$1$Consumer = new Group$1$Consumer(rule.getGroup());
		keyword$2$Consumer = new Keyword$2$Consumer(rule.getElementsKeyword_0());
		keyword$3$Consumer = new Keyword$3$Consumer(rule.getLeftCurlyBracketKeyword_1());
		assignment$4$Consumer = new Assignment$4$Consumer(rule.getUrisAssignment_2());
		ruleCall$5$Consumer = new RuleCall$5$Consumer(rule.getUrisSTRINGTerminalRuleCall_2_0());
		group$6$Consumer = new Group$6$Consumer(rule.getGroup_3());
		keyword$7$Consumer = new Keyword$7$Consumer(rule.getCommaKeyword_3_0());
		assignment$8$Consumer = new Assignment$8$Consumer(rule.getUrisAssignment_3_1());
		ruleCall$9$Consumer = new RuleCall$9$Consumer(rule.getUrisSTRINGTerminalRuleCall_3_1_0());
