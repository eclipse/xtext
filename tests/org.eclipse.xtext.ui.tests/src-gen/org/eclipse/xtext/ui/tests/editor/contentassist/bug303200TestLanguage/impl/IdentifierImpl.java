 ...
 * @generated
 */
public class IdentifierImpl extends PrimaryExpressionImpl implements Identifier
{
  /**
  ...
  {
    return Bug303200TestLanguagePackage.Literals.IDENTIFIER;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Bug303200TestLanguagePackage.IDENTIFIER__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case Bug303200TestLanguagePackage.IDENTIFIER__NAME:
        return getName();
    }
