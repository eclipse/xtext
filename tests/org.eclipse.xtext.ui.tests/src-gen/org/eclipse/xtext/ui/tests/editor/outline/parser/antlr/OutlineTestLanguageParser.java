...
public class OutlineTestLanguageParser extends org.eclipse.xtext.parser.antlr.AbstractAntlrParser {
	...
	protected IParseResult parse(String ruleName, CharStream in) {
		...
		org.eclipse.xtext.ui.tests.editor.outline.parser.antlr.internal.InternalOutlineTestLanguageParser parser = createParser(tokenStream);
	...
	protected org.eclipse.xtext.ui.tests.editor.outline.parser.antlr.internal.InternalOutlineTestLanguageParser createParser(XtextTokenStream stream) {
		return new org.eclipse.xtext.ui.tests.editor.outline.parser.antlr.internal.InternalOutlineTestLanguageParser(stream, getElementFactory(), getGrammarAccess());
	}
