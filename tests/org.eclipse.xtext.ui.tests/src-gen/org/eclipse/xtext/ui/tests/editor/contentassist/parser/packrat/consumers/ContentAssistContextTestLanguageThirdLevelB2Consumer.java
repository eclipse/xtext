...
import org.eclipse.xtext.ui.tests.editor.contentassist.services.ContentAssistContextTestLanguageGrammarAccess.ThirdLevelB2Elements;

public final class ContentAssistContextTestLanguageThirdLevelB2Consumer extends NonTerminalConsumer {

	private ThirdLevelB2Elements rule;	
	...
	public ContentAssistContextTestLanguageThirdLevelB2Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public ThirdLevelB2Elements getRule() {
		return rule;
	}
	
	public void setRule(ThirdLevelB2Elements rule) {
		this.rule = rule;
		
		group$1$Consumer = new Group$1$Consumer(rule.getGroup());
		keyword$2$Consumer = new Keyword$2$Consumer(rule.getB2Keyword_0());
		action$3$Consumer = new Action$3$Consumer(rule.getThirdLevelB2Action_1());
