...
import org.eclipse.xtext.ui.tests.editor.contentassist.services.Bug287941TestLanguageGrammarAccess.AndWhereEntryElements;

public final class Bug287941TestLanguageAndWhereEntryConsumer extends NonTerminalConsumer {

	private AndWhereEntryElements rule;	

	private INonTerminalConsumer concreteWhereEntryConsumer;
	...
	protected class RuleCall$2$Consumer extends ElementConsumer<RuleCall> {
		...
		protected int doConsume(boolean optional) throws Exception {
			return consumeNonTerminal(concreteWhereEntryConsumer, null, false, false, false, getElement(), optional);
		}
	}
	...
	protected class RuleCall$9$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeNonTerminal(concreteWhereEntryConsumer, "entries", true, false, false, getElement(), optional);
		}
	}

	public Bug287941TestLanguageAndWhereEntryConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public AndWhereEntryElements getRule() {
		return rule;
	}
	
	public void setRule(AndWhereEntryElements rule) {
		this.rule = rule;
		
		group$1$Consumer = new Group$1$Consumer(rule.getGroup());
		ruleCall$2$Consumer = new RuleCall$2$Consumer(rule.getConcreteWhereEntryParserRuleCall_0());
		group$3$Consumer = new Group$3$Consumer(rule.getGroup_1());
		action$4$Consumer = new Action$4$Consumer(rule.getAndWhereEntryEntriesAction_1_0());
		group$6$Consumer = new Group$6$Consumer(rule.getGroup_1_1());
		keyword$7$Consumer = new Keyword$7$Consumer(rule.getAndKeyword_1_1_0());
		assignment$8$Consumer = new Assignment$8$Consumer(rule.getEntriesAssignment_1_1_1());
		ruleCall$9$Consumer = new RuleCall$9$Consumer(rule.getEntriesConcreteWhereEntryParserRuleCall_1_1_1_0());
	}
	...
	public void setConcreteWhereEntryConsumer(INonTerminalConsumer concreteWhereEntryConsumer) {
		this.concreteWhereEntryConsumer = concreteWhereEntryConsumer;
	}
