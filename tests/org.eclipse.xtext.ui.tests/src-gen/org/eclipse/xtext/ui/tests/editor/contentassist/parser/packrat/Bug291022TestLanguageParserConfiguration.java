...
import org.eclipse.xtext.ui.tests.editor.contentassist.parser.packrat.consumers.Bug291022TestLanguageRootModelConsumer;
import org.eclipse.xtext.ui.tests.editor.contentassist.parser.packrat.consumers.Bug291022TestLanguageModelElementConsumer;
import org.eclipse.xtext.ui.tests.editor.contentassist.parser.packrat.consumers.Bug291022TestLanguageModelAttributeConsumer;
import org.eclipse.xtext.ui.tests.editor.contentassist.parser.packrat.consumers.Bug291022TestLanguageAttributeConsumer;
...
public class Bug291022TestLanguageParserConfiguration extends AbstractParserConfiguration {
	...
	public void configureConsumers() {
		...
		getRootModelConsumer().setKeyword$11$Delimiter(org.eclipse.xtext.ui.tests.editor.contentassist.parser.packrat.Bug291022TestLanguageDelimiters.keyword$13$Delimiter);
		getRootModelConsumer().setKeyword$14$Delimiter(org.eclipse.xtext.ui.tests.editor.contentassist.parser.packrat.Bug291022TestLanguageDelimiters.keyword$13$Delimiter);
		getRootModelConsumer().setRuleCall$9$Delimiter(org.eclipse.xtext.ui.tests.editor.contentassist.parser.packrat.Bug291022TestLanguageDelimiters.ruleCall$7$Delimiter);
		getRootModelConsumer().setRuleCall$5$Delimiter(org.eclipse.xtext.ui.tests.editor.contentassist.parser.packrat.Bug291022TestLanguageDelimiters.ruleCall$7$Delimiter);
		getModelElementConsumer().setKeyword$7$Delimiter(org.eclipse.xtext.ui.tests.editor.contentassist.parser.packrat.Bug291022TestLanguageDelimiters.keyword$13$Delimiter);
		getModelElementConsumer().setKeyword$15$Delimiter(org.eclipse.xtext.ui.tests.editor.contentassist.parser.packrat.Bug291022TestLanguageDelimiters.keyword$13$Delimiter);
		getModelElementConsumer().setKeyword$17$Delimiter(org.eclipse.xtext.ui.tests.editor.contentassist.parser.packrat.Bug291022TestLanguageDelimiters.keyword$13$Delimiter);
		getModelElementConsumer().setKeyword$20$Delimiter(org.eclipse.xtext.ui.tests.editor.contentassist.parser.packrat.Bug291022TestLanguageDelimiters.keyword$13$Delimiter);
		getModelElementConsumer().setRuleCall$5$Delimiter(org.eclipse.xtext.ui.tests.editor.contentassist.parser.packrat.Bug291022TestLanguageDelimiters.ruleCall$7$Delimiter);
		getModelElementConsumer().setRuleCall$9$Delimiter(org.eclipse.xtext.ui.tests.editor.contentassist.parser.packrat.Bug291022TestLanguageDelimiters.ruleCall$7$Delimiter);
		getModelElementConsumer().setRuleCall$13$Delimiter(org.eclipse.xtext.ui.tests.editor.contentassist.parser.packrat.Bug291022TestLanguageDelimiters.ruleCall$7$Delimiter);
		getAttributeConsumer().setKeyword$6$Delimiter(org.eclipse.xtext.ui.tests.editor.contentassist.parser.packrat.Bug291022TestLanguageDelimiters.keyword$13$Delimiter);
		getAttributeConsumer().setRuleCall$5$Delimiter(org.eclipse.xtext.ui.tests.editor.contentassist.parser.packrat.Bug291022TestLanguageDelimiters.ruleCall$7$Delimiter);
		getAttributeConsumer().setRuleCall$8$Delimiter(org.eclipse.xtext.ui.tests.editor.contentassist.parser.packrat.Bug291022TestLanguageDelimiters.ruleCall$7$Delimiter);
	}
