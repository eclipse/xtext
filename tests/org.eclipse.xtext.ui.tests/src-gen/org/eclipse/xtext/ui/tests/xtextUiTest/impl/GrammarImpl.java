 ...
 *   <li>{@link org.eclipse.xtext.ui.tests.xtextUiTest.impl.GrammarImpl#isDefinesHiddenTokens <em>Defines Hidden Tokens</em>}</li>
 *   <li>{@link org.eclipse.xtext.ui.tests.xtextUiTest.impl.GrammarImpl#getHiddenTokens <em>Hidden Tokens</em>}</li>
...
public class GrammarImpl extends MinimalEObjectImpl.Container implements Grammar
{
  ...
  {
    return XtextUiTestPackage.Literals.GRAMMAR;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XtextUiTestPackage.GRAMMAR__NAME, oldName, name));
  }
  ...
  public EList<Grammar> getUsedGrammars()
  {
    ...
    {
      usedGrammars = new EObjectResolvingEList<Grammar>(Grammar.class, this, XtextUiTestPackage.GRAMMAR__USED_GRAMMARS);
    }
    return usedGrammars;
  }
  ...
  public void setDefinesHiddenTokens(boolean newDefinesHiddenTokens)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XtextUiTestPackage.GRAMMAR__DEFINES_HIDDEN_TOKENS, oldDefinesHiddenTokens, definesHiddenTokens));
  }
  ...
  public EList<AbstractRule> getHiddenTokens()
  {
    ...
    {
      hiddenTokens = new EObjectResolvingEList<AbstractRule>(AbstractRule.class, this, XtextUiTestPackage.GRAMMAR__HIDDEN_TOKENS);
    }
    return hiddenTokens;
  }
  ...
  public EList<AbstractMetamodelDeclaration> getMetamodelDeclarations()
  {
    ...
    {
      metamodelDeclarations = new EObjectContainmentEList<AbstractMetamodelDeclaration>(AbstractMetamodelDeclaration.class, this, XtextUiTestPackage.GRAMMAR__METAMODEL_DECLARATIONS);
    }
  ...
  public EList<AbstractRule> getRules()
  {
    if (rules == null)
    {
      rules = new EObjectContainmentEList<AbstractRule>(AbstractRule.class, this, XtextUiTestPackage.GRAMMAR__RULES);
    }
    return rules;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case XtextUiTestPackage.GRAMMAR__METAMODEL_DECLARATIONS:
        return ((InternalEList<?>)getMetamodelDeclarations()).basicRemove(otherEnd, msgs);
      case XtextUiTestPackage.GRAMMAR__RULES:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case XtextUiTestPackage.GRAMMAR__NAME:
        return getName();
      case XtextUiTestPackage.GRAMMAR__USED_GRAMMARS:
        return getUsedGrammars();
      case XtextUiTestPackage.GRAMMAR__DEFINES_HIDDEN_TOKENS:
        return isDefinesHiddenTokens();
      case XtextUiTestPackage.GRAMMAR__HIDDEN_TOKENS:
