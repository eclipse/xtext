...
import org.eclipse.xtext.ui.tests.editor.contentassist.services.UnorderedGroupsTestLanguageGrammarAccess.GroupLoopedModelElements;

public final class UnorderedGroupsTestLanguageGroupLoopedModelConsumer extends NonTerminalConsumer {

	private GroupLoopedModelElements rule;	
	...
	protected class UnorderedGroup$2$Consumer extends LoopUnorderedGroupConsumer {
	...
	public GroupLoopedModelElements getRule() {
		return rule;
	}
	
	public void setRule(GroupLoopedModelElements rule) {
		this.rule = rule;
