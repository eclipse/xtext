...
import org.eclipse.xtext.ui.tests.editor.contentassist.services.DatatypeRuleTestLanguageGrammarAccess.CompositeTypeElements;

public final class DatatypeRuleTestLanguageCompositeTypeConsumer extends NonTerminalConsumer {

	private CompositeTypeElements rule;	

	private INonTerminalConsumer compositeTypeEntryConsumer;
	...
	protected class RuleCall$7$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeNonTerminal(compositeTypeEntryConsumer, "baseType", false, false, false, getElement(), optional);
		}
	}
	...
	public DatatypeRuleTestLanguageCompositeTypeConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public CompositeTypeElements getRule() {
		return rule;
	}
	
	public void setRule(CompositeTypeElements rule) {
		this.rule = rule;
		
		group$1$Consumer = new Group$1$Consumer(rule.getGroup());
		keyword$2$Consumer = new Keyword$2$Consumer(rule.getCompositeKeyword_0());
		...
		keyword$5$Consumer = new Keyword$5$Consumer(rule.getBaseKeyword_2());
		assignment$6$Consumer = new Assignment$6$Consumer(rule.getBaseTypeAssignment_3());
		ruleCall$7$Consumer = new RuleCall$7$Consumer(rule.getBaseTypeCompositeTypeEntryParserRuleCall_3_0());
	...
	public void setCompositeTypeEntryConsumer(INonTerminalConsumer compositeTypeEntryConsumer) {
		this.compositeTypeEntryConsumer = compositeTypeEntryConsumer;
	}
