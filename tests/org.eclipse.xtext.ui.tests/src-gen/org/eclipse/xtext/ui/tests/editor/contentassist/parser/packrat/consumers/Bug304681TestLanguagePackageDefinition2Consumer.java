...
import org.eclipse.xtext.ui.tests.editor.contentassist.services.Bug304681TestLanguageGrammarAccess.PackageDefinition2Elements;

public final class Bug304681TestLanguagePackageDefinition2Consumer extends NonTerminalConsumer {

	private PackageDefinition2Elements rule;	

	private ITerminalConsumer idConsumer;

	private INonTerminalConsumer object2Consumer;
	...
	protected class RuleCall$9$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeNonTerminal(object2Consumer, "contents", true, false, false, getElement(), optional);
		}
	}

	public Bug304681TestLanguagePackageDefinition2Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public PackageDefinition2Elements getRule() {
		return rule;
	}
	
	public void setRule(PackageDefinition2Elements rule) {
		this.rule = rule;
		...
		ruleCall$9$Consumer = new RuleCall$9$Consumer(rule.getContentsObject2ParserRuleCall_4_0());
	}
	...
	public void setObject2Consumer(INonTerminalConsumer object2Consumer) {
		this.object2Consumer = object2Consumer;
	}
