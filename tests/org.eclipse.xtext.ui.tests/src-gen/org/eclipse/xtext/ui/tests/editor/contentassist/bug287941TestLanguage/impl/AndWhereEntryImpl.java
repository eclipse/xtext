 ...
 * <ul>
 *   <li>{@link org.eclipse.xtext.ui.tests.editor.contentassist.bug287941TestLanguage.impl.AndWhereEntryImpl#getEntries <em>Entries</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AndWhereEntryImpl extends WhereEntryImpl implements AndWhereEntry
{
  ...
  {
    return Bug287941TestLanguagePackage.Literals.AND_WHERE_ENTRY;
  }
  ...
  public EList<WhereEntry> getEntries()
  {
    if (entries == null)
    {
      entries = new EObjectContainmentEList<WhereEntry>(WhereEntry.class, this, Bug287941TestLanguagePackage.AND_WHERE_ENTRY__ENTRIES);
    }
    return entries;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case Bug287941TestLanguagePackage.AND_WHERE_ENTRY__ENTRIES:
