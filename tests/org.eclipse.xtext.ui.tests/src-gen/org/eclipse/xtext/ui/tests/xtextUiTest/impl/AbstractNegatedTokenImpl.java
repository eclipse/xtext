 ...
 * <ul>
 *   <li>{@link org.eclipse.xtext.ui.tests.xtextUiTest.impl.AbstractNegatedTokenImpl#getTerminal <em>Terminal</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AbstractNegatedTokenImpl extends AbstractElementImpl implements AbstractNegatedToken
{
  ...
  {
    return XtextUiTestPackage.Literals.ABSTRACT_NEGATED_TOKEN;
  }
  ...
  public NotificationChain basicSetTerminal(AbstractElement newTerminal, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XtextUiTestPackage.ABSTRACT_NEGATED_TOKEN__TERMINAL, oldTerminal, newTerminal);
  ...
  public void setTerminal(AbstractElement newTerminal)
  {
    if (newTerminal != terminal)
    {
      ...
      if (terminal != null)
        msgs = ((InternalEObject)terminal).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XtextUiTestPackage.ABSTRACT_NEGATED_TOKEN__TERMINAL, null, msgs);
      if (newTerminal != null)
        msgs = ((InternalEObject)newTerminal).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XtextUiTestPackage.ABSTRACT_NEGATED_TOKEN__TERMINAL, null, msgs);
      msgs = basicSetTerminal(newTerminal, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XtextUiTestPackage.ABSTRACT_NEGATED_TOKEN__TERMINAL, newTerminal, newTerminal));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case XtextUiTestPackage.ABSTRACT_NEGATED_TOKEN__TERMINAL:
