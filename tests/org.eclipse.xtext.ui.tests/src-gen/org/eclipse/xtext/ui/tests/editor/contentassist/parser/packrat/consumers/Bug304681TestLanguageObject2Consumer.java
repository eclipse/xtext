...
import org.eclipse.xtext.ui.tests.editor.contentassist.services.Bug304681TestLanguageGrammarAccess.Object2Elements;

public final class Bug304681TestLanguageObject2Consumer extends NonTerminalConsumer {

	private Object2Elements rule;	

	private INonTerminalConsumer feature2Consumer;
	...
	protected class RuleCall$38$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeNonTerminal(feature2Consumer, "features", true, false, false, getElement(), optional);
		}
	}
	...
	public Bug304681TestLanguageObject2Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Object2Elements getRule() {
		return rule;
	}
	
	public void setRule(Object2Elements rule) {
		this.rule = rule;
		...
		ruleCall$38$Consumer = new RuleCall$38$Consumer(rule.getFeaturesFeature2ParserRuleCall_5_4_0());
		keyword$39$Consumer = new Keyword$39$Consumer(rule.getRightCurlyBracketKeyword_6());
	}
	...
	public void setFeature2Consumer(INonTerminalConsumer feature2Consumer) {
		this.feature2Consumer = feature2Consumer;
	}
