...
import org.eclipse.xtext.ui.tests.editor.contentassist.services.Bug287941TestLanguageGrammarAccess.BooleanOperatorElements;

public final class Bug287941TestLanguageBooleanOperatorConsumer extends NonTerminalConsumer {

	private BooleanOperatorElements rule;	
	...
	public Bug287941TestLanguageBooleanOperatorConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public BooleanOperatorElements getRule() {
		return rule;
	}
	
	public void setRule(BooleanOperatorElements rule) {
		this.rule = rule;
