...
import org.eclipse.xtext.ui.tests.editor.contentassist.services.Bug304681TestLanguageGrammarAccess.ModelElements;

public final class Bug304681TestLanguageModelConsumer extends NonTerminalConsumer {

	private ModelElements rule;	

	private INonTerminalConsumer packageDefinition2Consumer;

	private INonTerminalConsumer packageDefinitionConsumer;
	...
	protected class RuleCall$5$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeNonTerminal(packageDefinitionConsumer, "definition", false, false, false, getElement(), optional);
		}
	}
	...
	protected class RuleCall$9$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeNonTerminal(packageDefinition2Consumer, "definition", false, false, false, getElement(), optional);
		}
	}

	public Bug304681TestLanguageModelConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public void setRule(ModelElements rule) {
		...
		assignment$4$Consumer = new Assignment$4$Consumer(rule.getDefinitionAssignment_0_1());
		ruleCall$5$Consumer = new RuleCall$5$Consumer(rule.getDefinitionPackageDefinitionParserRuleCall_0_1_0());
		...
		assignment$8$Consumer = new Assignment$8$Consumer(rule.getDefinitionAssignment_1_1());
		ruleCall$9$Consumer = new RuleCall$9$Consumer(rule.getDefinitionPackageDefinition2ParserRuleCall_1_1_0());
	}
	...
	public void setPackageDefinition2Consumer(INonTerminalConsumer packageDefinition2Consumer) {
		this.packageDefinition2Consumer = packageDefinition2Consumer;
	}
	
	public void setPackageDefinitionConsumer(INonTerminalConsumer packageDefinitionConsumer) {
		this.packageDefinitionConsumer = packageDefinitionConsumer;
	}
