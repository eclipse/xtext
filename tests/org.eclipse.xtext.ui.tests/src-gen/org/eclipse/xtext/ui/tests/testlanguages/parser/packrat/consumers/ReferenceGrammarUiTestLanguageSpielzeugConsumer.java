...
import org.eclipse.xtext.ui.tests.testlanguages.services.ReferenceGrammarUiTestLanguageGrammarAccess.SpielzeugElements;

public final class ReferenceGrammarUiTestLanguageSpielzeugConsumer extends NonTerminalConsumer {
	...
	public ReferenceGrammarUiTestLanguageSpielzeugConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public void setRule(SpielzeugElements rule) {
		...
		keyword$2$Consumer = new Keyword$2$Consumer(rule.getSpielzeugKeyword_0());
		...
		assignment$6$Consumer = new Assignment$6$Consumer(rule.getFarbeAssignment_3());
		ruleCall$7$Consumer = new RuleCall$7$Consumer(rule.getFarbeFarbeParserRuleCall_3_0());
