...
import org.eclipse.xtext.ui.tests.editor.contentassist.services.ContentAssistCustomizingTestLanguageGrammarAccess.ModelElements;

public final class ContentAssistCustomizingTestLanguageModelConsumer extends NonTerminalConsumer {
	...
	public ContentAssistCustomizingTestLanguageModelConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public void setRule(ModelElements rule) {
		...
		assignment$1$Consumer = new Assignment$1$Consumer(rule.getTypesAssignment());
		ruleCall$2$Consumer = new RuleCall$2$Consumer(rule.getTypesTypeParserRuleCall_0());
	}
