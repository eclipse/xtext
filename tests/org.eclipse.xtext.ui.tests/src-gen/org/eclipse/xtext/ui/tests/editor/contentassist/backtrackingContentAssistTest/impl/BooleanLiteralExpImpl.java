...
public class BooleanLiteralExpImpl extends PrimitiveLiteralExpImpl implements BooleanLiteralExp
{
  ...
  {
    return BacktrackingContentAssistTestPackage.Literals.BOOLEAN_LITERAL_EXP;
  }
  ...
  public void setIsTrue(boolean newIsTrue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BacktrackingContentAssistTestPackage.BOOLEAN_LITERAL_EXP__IS_TRUE, oldIsTrue, isTrue));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case BacktrackingContentAssistTestPackage.BOOLEAN_LITERAL_EXP__IS_TRUE:
        return isIsTrue();
    }
