...
public final class Bug303200TestLanguageWSConsumer extends AbstractRuleAwareTerminalConsumer {

	public Bug303200TestLanguageWSConsumer(ITerminalConsumerConfiguration configuration) {
		super(configuration);
	}
