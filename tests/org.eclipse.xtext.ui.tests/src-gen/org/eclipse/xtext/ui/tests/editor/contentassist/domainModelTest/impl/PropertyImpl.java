...
public class PropertyImpl extends MinimalEObjectImpl.Container implements Property
{
  ...
  {
    return DomainModelTestPackage.Literals.PROPERTY;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DomainModelTestPackage.PROPERTY__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DomainModelTestPackage.PROPERTY__NAME:
        return getName();
    }
