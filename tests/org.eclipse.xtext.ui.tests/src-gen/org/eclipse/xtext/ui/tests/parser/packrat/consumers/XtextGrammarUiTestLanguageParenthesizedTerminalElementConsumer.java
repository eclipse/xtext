...
import org.eclipse.xtext.ui.tests.services.XtextGrammarUiTestLanguageGrammarAccess.ParenthesizedTerminalElementElements;

public final class XtextGrammarUiTestLanguageParenthesizedTerminalElementConsumer extends NonTerminalConsumer {
	...
	public XtextGrammarUiTestLanguageParenthesizedTerminalElementConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public void setRule(ParenthesizedTerminalElementElements rule) {
		...
		ruleCall$3$Consumer = new RuleCall$3$Consumer(rule.getTerminalAlternativesParserRuleCall_1());
