...
import org.eclipse.xtext.ui.tests.editor.contentassist.services.Bug287941TestLanguageGrammarAccess.StringOperatorElements;

public final class Bug287941TestLanguageStringOperatorConsumer extends NonTerminalConsumer {

	private StringOperatorElements rule;	
	...
	public Bug287941TestLanguageStringOperatorConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public StringOperatorElements getRule() {
		return rule;
	}
	
	public void setRule(StringOperatorElements rule) {
		this.rule = rule;
		
		alternatives$1$Consumer = new Alternatives$1$Consumer(rule.getAlternatives());
		enumLiteralDeclaration$2$Consumer = new EnumLiteralDeclaration$2$Consumer(rule.getEqualEnumLiteralDeclaration_0());
		enumLiteralDeclaration$4$Consumer = new EnumLiteralDeclaration$4$Consumer(rule.getNotEqualEnumLiteralDeclaration_1());
		enumLiteralDeclaration$6$Consumer = new EnumLiteralDeclaration$6$Consumer(rule.getLikeEnumLiteralDeclaration_2());
		enumLiteralDeclaration$8$Consumer = new EnumLiteralDeclaration$8$Consumer(rule.getNotLikeEnumLiteralDeclaration_3());
	}
