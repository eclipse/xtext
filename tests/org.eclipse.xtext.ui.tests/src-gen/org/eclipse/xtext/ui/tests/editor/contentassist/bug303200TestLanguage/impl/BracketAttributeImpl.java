 ...
 * @generated
 */
public class BracketAttributeImpl extends AttributeImpl implements BracketAttribute
{
  /**
   ...
   * @generated
   */
  protected BracketAttributeImpl()
  {
    super();
  }
  ...
  {
    return Bug303200TestLanguagePackage.Literals.BRACKET_ATTRIBUTE;
  }
  ...
  public NotificationChain basicSetExpression(PostfixExpression newExpression, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Bug303200TestLanguagePackage.BRACKET_ATTRIBUTE__EXPRESSION, oldExpression, newExpression);
  ...
  public void setExpression(PostfixExpression newExpression)
  {
    if (newExpression != expression)
    {
      ...
      if (expression != null)
        msgs = ((InternalEObject)expression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Bug303200TestLanguagePackage.BRACKET_ATTRIBUTE__EXPRESSION, null, msgs);
      if (newExpression != null)
        msgs = ((InternalEObject)newExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Bug303200TestLanguagePackage.BRACKET_ATTRIBUTE__EXPRESSION, null, msgs);
      msgs = basicSetExpression(newExpression, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Bug303200TestLanguagePackage.BRACKET_ATTRIBUTE__EXPRESSION, newExpression, newExpression));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case Bug303200TestLanguagePackage.BRACKET_ATTRIBUTE__EXPRESSION:
