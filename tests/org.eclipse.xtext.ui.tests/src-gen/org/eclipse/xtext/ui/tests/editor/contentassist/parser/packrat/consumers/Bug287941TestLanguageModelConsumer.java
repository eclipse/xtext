...
import org.eclipse.xtext.ui.tests.editor.contentassist.services.Bug287941TestLanguageGrammarAccess.ModelElements;

public final class Bug287941TestLanguageModelConsumer extends NonTerminalConsumer {
	...
	protected class RuleCall$5$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeNonTerminal(mqLqueryConsumer, "query", false, false, false, getElement(), optional);
		}
	}

	public Bug287941TestLanguageModelConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public void setRule(ModelElements rule) {
		...
		assignment$4$Consumer = new Assignment$4$Consumer(rule.getQueryAssignment_1());
		ruleCall$5$Consumer = new RuleCall$5$Consumer(rule.getQueryMQLqueryParserRuleCall_1_0());
	}
