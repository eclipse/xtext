...
public class LocationProviderTestLanguageParser extends org.eclipse.xtext.parser.antlr.AbstractAntlrParser {
	...
	protected IParseResult parse(String ruleName, ANTLRInputStream in) {
		...
		org.eclipse.xtext.ui.tests.parser.antlr.internal.InternalLocationProviderTestLanguageParser parser = createParser(tokenStream);
	...
	protected org.eclipse.xtext.ui.tests.parser.antlr.internal.InternalLocationProviderTestLanguageParser createParser(XtextTokenStream stream) {
		return new org.eclipse.xtext.ui.tests.parser.antlr.internal.InternalLocationProviderTestLanguageParser(stream, getElementFactory(), getGrammarAccess());
	}
