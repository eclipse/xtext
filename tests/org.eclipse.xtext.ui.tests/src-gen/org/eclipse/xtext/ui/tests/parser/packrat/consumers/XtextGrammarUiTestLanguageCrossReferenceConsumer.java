...
import org.eclipse.xtext.ui.tests.services.XtextGrammarUiTestLanguageGrammarAccess.CrossReferenceElements;

public final class XtextGrammarUiTestLanguageCrossReferenceConsumer extends NonTerminalConsumer {
	...
	protected class RuleCall$8$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeNonTerminal(crossReferenceableTerminalConsumer, "terminal", false, false, false, getElement(), optional);
		}
	}
	...
	public XtextGrammarUiTestLanguageCrossReferenceConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
