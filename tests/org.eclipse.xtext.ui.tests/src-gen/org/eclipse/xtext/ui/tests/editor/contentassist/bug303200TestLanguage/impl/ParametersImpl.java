 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.xtext.ui.tests.editor.contentassist.bug303200TestLanguage.impl.ParametersImpl#getParams <em>Params</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParametersImpl extends MinimalEObjectImpl.Container implements Parameters
{
  ...
  {
    return Bug303200TestLanguagePackage.Literals.PARAMETERS;
  }
  ...
  public EList<String> getParams()
  {
    if (params == null)
    {
      params = new EDataTypeEList<String>(String.class, this, Bug303200TestLanguagePackage.PARAMETERS__PARAMS);
    }
    return params;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case Bug303200TestLanguagePackage.PARAMETERS__PARAMS:
        return getParams();
    }
