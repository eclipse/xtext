...
public class AbstractRuleImpl extends MinimalEObjectImpl.Container implements AbstractRule
{
  ...
  {
    return XtextUiTestPackage.Literals.ABSTRACT_RULE;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XtextUiTestPackage.ABSTRACT_RULE__NAME, oldName, name));
  }
  ...
  public NotificationChain basicSetType(TypeRef newType, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XtextUiTestPackage.ABSTRACT_RULE__TYPE, oldType, newType);
  ...
  public void setType(TypeRef newType)
  {
    if (newType != type)
    {
      ...
      if (type != null)
        msgs = ((InternalEObject)type).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XtextUiTestPackage.ABSTRACT_RULE__TYPE, null, msgs);
      if (newType != null)
        msgs = ((InternalEObject)newType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XtextUiTestPackage.ABSTRACT_RULE__TYPE, null, msgs);
      msgs = basicSetType(newType, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XtextUiTestPackage.ABSTRACT_RULE__TYPE, newType, newType));
  }
  ...
  public NotificationChain basicSetAlternatives(AbstractElement newAlternatives, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XtextUiTestPackage.ABSTRACT_RULE__ALTERNATIVES, oldAlternatives, newAlternatives);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setAlternatives(AbstractElement newAlternatives)
  {
    if (newAlternatives != alternatives)
    {
      ...
      if (alternatives != null)
        msgs = ((InternalEObject)alternatives).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XtextUiTestPackage.ABSTRACT_RULE__ALTERNATIVES, null, msgs);
      if (newAlternatives != null)
        msgs = ((InternalEObject)newAlternatives).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XtextUiTestPackage.ABSTRACT_RULE__ALTERNATIVES, null, msgs);
      msgs = basicSetAlternatives(newAlternatives, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XtextUiTestPackage.ABSTRACT_RULE__ALTERNATIVES, newAlternatives, newAlternatives));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case XtextUiTestPackage.ABSTRACT_RULE__TYPE:
        return basicSetType(null, msgs);
      case XtextUiTestPackage.ABSTRACT_RULE__ALTERNATIVES:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case XtextUiTestPackage.ABSTRACT_RULE__NAME:
        return getName();
      case XtextUiTestPackage.ABSTRACT_RULE__TYPE:
        return getType();
      case XtextUiTestPackage.ABSTRACT_RULE__ALTERNATIVES:
