...
public class UnorderedGroupsTestLanguageStandaloneSetup implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new org.eclipse.xtext.ui.tests.editor.contentassist.UnorderedGroupsTestLanguageRuntimeModule());
	}
	
	public void register(Injector injector) {
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.eclipse.org/xtext/ui/tests/2010/UnorderedGroupsTest")) {
		EPackage.Registry.INSTANCE.put("http://www.eclipse.org/xtext/ui/tests/2010/UnorderedGroupsTest", org.eclipse.xtext.ui.tests.editor.contentassist.unorderedGroupsTest.UnorderedGroupsTestPackage.eINSTANCE);
	}
