...
import org.eclipse.xtext.ui.tests.editor.contentassist.services.DatatypeRuleTestLanguageGrammarAccess.SimpleTypeElements;

public final class DatatypeRuleTestLanguageSimpleTypeConsumer extends NonTerminalConsumer {

	private SimpleTypeElements rule;	
	...
	public DatatypeRuleTestLanguageSimpleTypeConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public SimpleTypeElements getRule() {
		return rule;
	}
	
	public void setRule(SimpleTypeElements rule) {
		this.rule = rule;
