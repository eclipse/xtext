...
public final class Bug288760TestLanguageINTConsumer extends AbstractRuleAwareTerminalConsumer {

	public Bug288760TestLanguageINTConsumer(ITerminalConsumerConfiguration configuration) {
		super(configuration);
	}
