...
public class AlternativeImpl extends MinimalEObjectImpl.Container implements Alternative
{
   ...
   * @ordered
   */
  protected RecursiveClassDeclaration rootDeclaration;
  ...
  {
    return Bug360834TestLanguagePackage.Literals.ALTERNATIVE;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Bug360834TestLanguagePackage.ALTERNATIVE__NAME, oldName, name));
  }
   ...
   * @generated
   */
  public NotificationChain basicSetRootDeclaration(RecursiveClassDeclaration newRootDeclaration, NotificationChain msgs)
  {
    RecursiveClassDeclaration oldRootDeclaration = rootDeclaration;
    rootDeclaration = newRootDeclaration;
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Bug360834TestLanguagePackage.ALTERNATIVE__ROOT_DECLARATION, oldRootDeclaration, newRootDeclaration);
  ...
  public void setRootDeclaration(RecursiveClassDeclaration newRootDeclaration)
  {
    if (newRootDeclaration != rootDeclaration)
    {
      ...
      if (rootDeclaration != null)
        msgs = ((InternalEObject)rootDeclaration).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Bug360834TestLanguagePackage.ALTERNATIVE__ROOT_DECLARATION, null, msgs);
      if (newRootDeclaration != null)
        msgs = ((InternalEObject)newRootDeclaration).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Bug360834TestLanguagePackage.ALTERNATIVE__ROOT_DECLARATION, null, msgs);
      msgs = basicSetRootDeclaration(newRootDeclaration, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Bug360834TestLanguagePackage.ALTERNATIVE__ROOT_DECLARATION, newRootDeclaration, newRootDeclaration));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case Bug360834TestLanguagePackage.ALTERNATIVE__ROOT_DECLARATION:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case Bug360834TestLanguagePackage.ALTERNATIVE__NAME:
        return getName();
      case Bug360834TestLanguagePackage.ALTERNATIVE__ROOT_DECLARATION:
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      case Bug360834TestLanguagePackage.ALTERNATIVE__NAME:
        ...
        return;
      case Bug360834TestLanguagePackage.ALTERNATIVE__ROOT_DECLARATION:
        setRootDeclaration((RecursiveClassDeclaration)newValue);
        return;
    }
  ...
  public void eUnset(int featureID)
  {
    switch (featureID)
    {
      case Bug360834TestLanguagePackage.ALTERNATIVE__NAME:
        ...
        return;
      case Bug360834TestLanguagePackage.ALTERNATIVE__ROOT_DECLARATION:
        setRootDeclaration((RecursiveClassDeclaration)null);
        return;
    }
