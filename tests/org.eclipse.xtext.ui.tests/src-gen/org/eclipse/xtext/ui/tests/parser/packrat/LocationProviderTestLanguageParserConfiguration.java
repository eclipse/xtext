...
import org.eclipse.xtext.ui.tests.parser.packrat.consumers.LocationProviderTestLanguageModelConsumer;
import org.eclipse.xtext.ui.tests.parser.packrat.consumers.LocationProviderTestLanguageElementConsumer;
...
public class LocationProviderTestLanguageParserConfiguration extends AbstractParserConfiguration {
	...
	public void configureConsumers() {
		...
		getElementConsumer().setKeyword$6$Delimiter(org.eclipse.xtext.ui.tests.parser.packrat.LocationProviderTestLanguageDelimiters.keyword$8$Delimiter);
		getElementConsumer().setKeyword$12$Delimiter(org.eclipse.xtext.ui.tests.parser.packrat.LocationProviderTestLanguageDelimiters.keyword$8$Delimiter);
		getElementConsumer().setKeyword$2$Delimiter(org.eclipse.xtext.ui.tests.parser.packrat.LocationProviderTestLanguageDelimiters.keyword$8$Delimiter);
		getElementConsumer().setRuleCall$4$Delimiter(org.eclipse.xtext.ui.tests.parser.packrat.LocationProviderTestLanguageDelimiters.ruleCall$10$Delimiter);
		getElementConsumer().setRuleCall$10$Delimiter(org.eclipse.xtext.ui.tests.parser.packrat.LocationProviderTestLanguageDelimiters.ruleCall$10$Delimiter);
		getElementConsumer().setRuleCall$16$Delimiter(org.eclipse.xtext.ui.tests.parser.packrat.LocationProviderTestLanguageDelimiters.ruleCall$10$Delimiter);
	}
