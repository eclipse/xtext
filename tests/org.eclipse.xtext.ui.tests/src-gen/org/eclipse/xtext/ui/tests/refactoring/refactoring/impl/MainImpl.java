...
public class MainImpl extends MinimalEObjectImpl.Container implements Main
{
  ...
  {
    return RefactoringPackage.Literals.MAIN;
  }
  ...
  public EList<AbstractElement> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<AbstractElement>(AbstractElement.class, this, RefactoringPackage.MAIN__ELEMENTS);
    }
    return elements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case RefactoringPackage.MAIN__ELEMENTS:
