...
import org.eclipse.xtext.ui.tests.editor.contentassist.services.UnorderedGroupsTestLanguageGrammarAccess.SimpleModelElements;

public final class UnorderedGroupsTestLanguageSimpleModelConsumer extends NonTerminalConsumer {

	private SimpleModelElements rule;	
	...
	public UnorderedGroupsTestLanguageSimpleModelConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public SimpleModelElements getRule() {
		return rule;
	}
	
	public void setRule(SimpleModelElements rule) {
		this.rule = rule;
