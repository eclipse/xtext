...
public class ChildImpl extends MinimalEObjectImpl.Container implements Child
{
  ...
  {
    return Bug377311Package.Literals.CHILD;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Bug377311Package.CHILD__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case Bug377311Package.CHILD__NAME:
        return getName();
    }
