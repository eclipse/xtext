 ...
 * @generated
 */
public class XtextUiTestSwitch<T> extends Switch<T>
{
  /**
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case XtextUiTestPackage.ABSTRACT_RULE:
      {
      ...
      case XtextUiTestPackage.ABSTRACT_METAMODEL_DECLARATION:
      {
      ...
      case XtextUiTestPackage.ABSTRACT_ELEMENT:
      {
      ...
      case XtextUiTestPackage.ABSTRACT_NEGATED_TOKEN:
      {
