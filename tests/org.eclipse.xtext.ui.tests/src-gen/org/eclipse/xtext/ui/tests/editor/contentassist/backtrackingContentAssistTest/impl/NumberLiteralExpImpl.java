 ...
 * <ul>
 *   <li>{@link org.eclipse.xtext.ui.tests.editor.contentassist.backtrackingContentAssistTest.impl.NumberLiteralExpImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class NumberLiteralExpImpl extends PrimitiveLiteralExpImpl implements NumberLiteralExp
{
  ...
  {
    return BacktrackingContentAssistTestPackage.Literals.NUMBER_LITERAL_EXP;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BacktrackingContentAssistTestPackage.NUMBER_LITERAL_EXP__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case BacktrackingContentAssistTestPackage.NUMBER_LITERAL_EXP__NAME:
        return getName();
    }
