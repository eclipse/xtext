...
public class LookAheadContentAssistTestLanguageStandaloneSetupGenerated implements ISetup, ISetupExtension {

	@Override
	public List<String> getFileExtensions() {
		return Arrays.asList("lookaheadcontentassisttestlanguage");
	}
