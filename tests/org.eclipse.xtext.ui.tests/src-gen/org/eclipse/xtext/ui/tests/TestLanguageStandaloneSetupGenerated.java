...
public class TestLanguageStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new org.eclipse.xtext.ui.tests.TestLanguageRuntimeModule());
	}
	
	public void register(Injector injector) {
	if (!EPackage.Registry.INSTANCE.containsKey("http://foo")) {
		EPackage.Registry.INSTANCE.put("http://foo", org.eclipse.xtext.ui.tests.foo.FooPackage.eINSTANCE);
	}
