...
public abstract class AbstractBug291022TestLanguageRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		...
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance(
			"org.eclipse.xtext.ui.tests.editor.contentassist.Bug291022TestLanguage");
	...
	public Class<? extends org.eclipse.xtext.parser.packrat.IPackratParser> bindIPackratParser() {
		return org.eclipse.xtext.ui.tests.editor.contentassist.parser.packrat.Bug291022TestLanguagePackratParser.class;
	}
