...
import org.eclipse.xtext.ui.tests.editor.contentassist.services.UnorderedGroupsTestLanguageGrammarAccess.Bug304681ReferenceElements;

public final class UnorderedGroupsTestLanguageBug304681ReferenceConsumer extends NonTerminalConsumer {

	private Bug304681ReferenceElements rule;	
	...
	public UnorderedGroupsTestLanguageBug304681ReferenceConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Bug304681ReferenceElements getRule() {
		return rule;
	}
	
	public void setRule(Bug304681ReferenceElements rule) {
		this.rule = rule;
