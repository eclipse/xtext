...
import org.eclipse.xtext.ui.tests.editor.contentassist.services.DatatypeRuleTestLanguageGrammarAccess.TypesElements;

public final class DatatypeRuleTestLanguageTypesConsumer extends NonTerminalConsumer {

	private TypesElements rule;	
	...
	public DatatypeRuleTestLanguageTypesConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public TypesElements getRule() {
		return rule;
	}
	
	public void setRule(TypesElements rule) {
		this.rule = rule;
		
		group$1$Consumer = new Group$1$Consumer(rule.getGroup());
		keyword$2$Consumer = new Keyword$2$Consumer(rule.getTypesKeyword_0());
		assignment$3$Consumer = new Assignment$3$Consumer(rule.getTypesAssignment_1());
		ruleCall$4$Consumer = new RuleCall$4$Consumer(rule.getTypesTypeParserRuleCall_1_0());
	}
