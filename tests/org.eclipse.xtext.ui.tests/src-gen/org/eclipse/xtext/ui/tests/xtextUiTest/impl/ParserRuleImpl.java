 ...
 * <ul>
 *   <li>{@link org.eclipse.xtext.ui.tests.xtextUiTest.impl.ParserRuleImpl#isDefinesHiddenTokens <em>Defines Hidden Tokens</em>}</li>
 *   <li>{@link org.eclipse.xtext.ui.tests.xtextUiTest.impl.ParserRuleImpl#getHiddenTokens <em>Hidden Tokens</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ParserRuleImpl extends AbstractRuleImpl implements ParserRule
{
  ...
  {
    return XtextUiTestPackage.Literals.PARSER_RULE;
  }
  ...
  public void setDefinesHiddenTokens(boolean newDefinesHiddenTokens)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XtextUiTestPackage.PARSER_RULE__DEFINES_HIDDEN_TOKENS, oldDefinesHiddenTokens, definesHiddenTokens));
  }
  ...
  public EList<AbstractRule> getHiddenTokens()
  {
    ...
    {
      hiddenTokens = new EObjectResolvingEList<AbstractRule>(AbstractRule.class, this, XtextUiTestPackage.PARSER_RULE__HIDDEN_TOKENS);
    }
    return hiddenTokens;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case XtextUiTestPackage.PARSER_RULE__DEFINES_HIDDEN_TOKENS:
        return isDefinesHiddenTokens();
      case XtextUiTestPackage.PARSER_RULE__HIDDEN_TOKENS:
