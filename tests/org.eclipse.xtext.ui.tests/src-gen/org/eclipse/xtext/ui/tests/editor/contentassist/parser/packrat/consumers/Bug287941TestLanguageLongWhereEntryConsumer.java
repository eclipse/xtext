...
import org.eclipse.xtext.ui.tests.editor.contentassist.services.Bug287941TestLanguageGrammarAccess.LongWhereEntryElements;

public final class Bug287941TestLanguageLongWhereEntryConsumer extends NonTerminalConsumer {

	private LongWhereEntryElements rule;	

	private ITerminalConsumer idConsumer;

	private INonTerminalConsumer numericOperatorConsumer;

	private ITerminalConsumer singedLongConsumer;
	...
	protected class RuleCall$14$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(singedLongConsumer, "value", false, false, getElement(), getRuleCall$14$Delimiter(), optional);
		}
	}

	public Bug287941TestLanguageLongWhereEntryConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public LongWhereEntryElements getRule() {
		return rule;
	}
	
	public void setRule(LongWhereEntryElements rule) {
		this.rule = rule;
		...
		ruleCall$14$Consumer = new RuleCall$14$Consumer(rule.getValueSINGED_LONGTerminalRuleCall_4_0());
	}
	...
	public void setSingedLongConsumer(ITerminalConsumer singedLongConsumer) {
		this.singedLongConsumer = singedLongConsumer;
	}
