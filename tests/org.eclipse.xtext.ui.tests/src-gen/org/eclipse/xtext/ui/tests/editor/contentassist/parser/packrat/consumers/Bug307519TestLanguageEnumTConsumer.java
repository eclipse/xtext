...
import org.eclipse.xtext.ui.tests.editor.contentassist.services.Bug307519TestLanguageGrammarAccess.EnumTElements;

public final class Bug307519TestLanguageEnumTConsumer extends NonTerminalConsumer {

	private EnumTElements rule;	
	...
	public Bug307519TestLanguageEnumTConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public EnumTElements getRule() {
		return rule;
	}
	
	public void setRule(EnumTElements rule) {
		this.rule = rule;
		
		alternatives$1$Consumer = new Alternatives$1$Consumer(rule.getAlternatives());
		enumLiteralDeclaration$2$Consumer = new EnumLiteralDeclaration$2$Consumer(rule.getT1EnumLiteralDeclaration_0());
		enumLiteralDeclaration$4$Consumer = new EnumLiteralDeclaration$4$Consumer(rule.getT2EnumLiteralDeclaration_1());
	}
