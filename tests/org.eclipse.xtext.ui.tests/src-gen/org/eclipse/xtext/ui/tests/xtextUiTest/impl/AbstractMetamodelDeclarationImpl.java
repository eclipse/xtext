...
public class AbstractMetamodelDeclarationImpl extends MinimalEObjectImpl.Container implements AbstractMetamodelDeclaration
{
  ...
  {
    return XtextUiTestPackage.Literals.ABSTRACT_METAMODEL_DECLARATION;
  }
    ...
    if (ePackage != null && ePackage.eIsProxy())
    {
      ...
      if (ePackage != oldEPackage)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, XtextUiTestPackage.ABSTRACT_METAMODEL_DECLARATION__EPACKAGE, oldEPackage, ePackage));
      }
    }
    return ePackage;
  }
  ...
  public void setEPackage(EPackage newEPackage)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XtextUiTestPackage.ABSTRACT_METAMODEL_DECLARATION__EPACKAGE, oldEPackage, ePackage));
  }
  ...
  public void setAlias(String newAlias)
  {
    ...
    alias = newAlias;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XtextUiTestPackage.ABSTRACT_METAMODEL_DECLARATION__ALIAS, oldAlias, alias));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case XtextUiTestPackage.ABSTRACT_METAMODEL_DECLARATION__EPACKAGE:
        if (resolve) return getEPackage();
        return basicGetEPackage();
      case XtextUiTestPackage.ABSTRACT_METAMODEL_DECLARATION__ALIAS:
        return getAlias();
    }
