 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.xtext.ui.tests.editor.contentassist.backtrackingContentAssistTest.impl.StringLiteralExpImpl#getValues <em>Values</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StringLiteralExpImpl extends PrimitiveLiteralExpImpl implements StringLiteralExp
{
  ...
  {
    return BacktrackingContentAssistTestPackage.Literals.STRING_LITERAL_EXP;
  }
  ...
  public EList<String> getValues()
  {
    if (values == null)
    {
      values = new EDataTypeEList<String>(String.class, this, BacktrackingContentAssistTestPackage.STRING_LITERAL_EXP__VALUES);
    }
    return values;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case BacktrackingContentAssistTestPackage.STRING_LITERAL_EXP__VALUES:
        return getValues();
    }
