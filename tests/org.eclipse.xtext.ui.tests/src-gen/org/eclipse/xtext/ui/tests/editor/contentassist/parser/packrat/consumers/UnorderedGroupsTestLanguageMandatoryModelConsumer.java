...
import org.eclipse.xtext.ui.tests.editor.contentassist.services.UnorderedGroupsTestLanguageGrammarAccess.MandatoryModelElements;

public final class UnorderedGroupsTestLanguageMandatoryModelConsumer extends NonTerminalConsumer {

	private MandatoryModelElements rule;	
	...
	public UnorderedGroupsTestLanguageMandatoryModelConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public MandatoryModelElements getRule() {
		return rule;
	}
	
	public void setRule(MandatoryModelElements rule) {
		this.rule = rule;
