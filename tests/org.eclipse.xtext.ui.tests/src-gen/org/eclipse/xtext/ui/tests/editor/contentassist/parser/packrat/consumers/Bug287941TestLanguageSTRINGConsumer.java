...
public final class Bug287941TestLanguageSTRINGConsumer extends AbstractRuleAwareTerminalConsumer {

	public Bug287941TestLanguageSTRINGConsumer(ITerminalConsumerConfiguration configuration) {
		super(configuration);
	}
