...
import org.eclipse.xtext.ui.tests.editor.contentassist.services.Bug304681TestLanguageGrammarAccess.Reference2Elements;

public final class Bug304681TestLanguageReference2Consumer extends NonTerminalConsumer {

	private Reference2Elements rule;	
	...
	public Bug304681TestLanguageReference2Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Reference2Elements getRule() {
		return rule;
	}
	
	public void setRule(Reference2Elements rule) {
		this.rule = rule;
