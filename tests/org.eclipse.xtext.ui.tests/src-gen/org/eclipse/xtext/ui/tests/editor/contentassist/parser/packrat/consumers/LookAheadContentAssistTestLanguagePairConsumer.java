...
import org.eclipse.xtext.ui.tests.editor.contentassist.services.LookAheadContentAssistTestLanguageGrammarAccess.PairElements;

public final class LookAheadContentAssistTestLanguagePairConsumer extends NonTerminalConsumer {

	private PairElements rule;	
	...
	public LookAheadContentAssistTestLanguagePairConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public PairElements getRule() {
		return rule;
	}
	
	public void setRule(PairElements rule) {
		this.rule = rule;
