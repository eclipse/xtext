...
import org.eclipse.xtext.ui.tests.editor.contentassist.services.ContentAssistCustomizingTestLanguageGrammarAccess.FQNElements;

public final class ContentAssistCustomizingTestLanguageFQNConsumer extends NonTerminalConsumer {
	...
	public ContentAssistCustomizingTestLanguageFQNConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public FQNElements getRule() {
		return rule;
	}
	
	public void setRule(FQNElements rule) {
		this.rule = rule;
