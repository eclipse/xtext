...
public class TaskMarkerContributorTest extends AbstractXtextTests {
  ...
  public void testMarkerCreation() {
    try {
      ...
      _builder.append("*/");
      _builder.newLine();
      final IFile file = IResourcesSetupUtil.createFile("foo/foo.domainModelTest", _builder.toString());
      ...
      Assert.assertEquals(Integer.valueOf(7), _attribute_2);
      ...
      Assert.assertEquals(Integer.valueOf(15), _attribute_3);
      ...
      Assert.assertEquals(Integer.valueOf(20), _attribute_8);
      IMarker _get_3 = markers[1];
      Object _attribute_9 = _get_3.getAttribute(IMarker.CHAR_END);
      Assert.assertEquals(Integer.valueOf(29), _attribute_9);
