...
public class BmTestLanguageStandaloneSetup implements ISetup {
	...
	if (!EPackage.Registry.INSTANCE.containsKey("http://xtext.org/ui/integartion/tests/bracketmatching")) {
		EPackage.Registry.INSTANCE.put("http://xtext.org/ui/integartion/tests/bracketmatching", org.eclipse.xtext.ui.integration.tests.editor.bracketmatching.bracketmatching.BracketmatchingPackage.eINSTANCE);
	}
