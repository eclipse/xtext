...
public class CaliperCompoundTypeReference extends CaliperTypeReference {
   ...
   * @return the kind constant '6'.
   */
  public int getKind() {
    return KIND_CALIPER_COMPOUND_TYPE_REFERENCE;
  }
  
  public int acceptVisitor(final Visitor visitor, final int i, final long k) {
    return visitor.visitCaliperCompoundTypeReference(this, i, k);
  }
}
