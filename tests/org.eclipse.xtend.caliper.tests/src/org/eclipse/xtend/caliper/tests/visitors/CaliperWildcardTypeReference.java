...
public class CaliperWildcardTypeReference extends CaliperTypeReference {
   ...
   * @return the kind constant '8'.
   */
  public int getKind() {
    return KIND_CALIPER_WILDCARD_TYPE_REFERENCE;
  }
  
  public int acceptVisitor(final Visitor visitor, final int i, final long k) {
    return visitor.visitCaliperWildcardTypeReference(this, i, k);
  }
}
