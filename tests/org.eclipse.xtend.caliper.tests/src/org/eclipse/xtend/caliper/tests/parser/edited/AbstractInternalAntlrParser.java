...
public abstract class AbstractInternalAntlrParser extends Parser {
	...
	protected static class NoViableAltException extends org.antlr.runtime.NoViableAltException {
		...
		public NoViableAltException(String grammarDecisionDescription, int decisionNumber, int stateNumber,
				IntStream input) {
	...
	protected static class EarlyExitException extends org.antlr.runtime.EarlyExitException {
	...
	protected static class UnwantedTokenException extends org.antlr.runtime.UnwantedTokenException {
	...
	protected static class MismatchedTokenException extends org.antlr.runtime.MismatchedTokenException {
	...
	protected static class FailedPredicateException extends org.antlr.runtime.FailedPredicateException {
		...
		public FailedPredicateException(IntStream input, String ruleName, String predicateText) {
			super(input, ruleName, predicateText);
		}
	...
	protected static class MissingTokenException extends org.antlr.runtime.MissingTokenException {
		...
		public MissingTokenException(int expecting, IntStream input, Object inserted) {
			super(expecting, input, inserted);
		}
	...
	private DefaultEcoreElementFactory semanticModelBuilder;
	...
	protected void set(EObject _this, int feature, Object value, String lexerRule, INode node) {
		try {
	...
	protected void set(EObject _this, int feature, Object value, String lexerRule) {
		set(_this, feature, value, lexerRule, currentNode);
	}
	
	protected void setWithLastConsumed(EObject _this, int feature, Object value, String lexerRule) {
		set(_this, feature, value, lexerRule, lastConsumedNode);
	}

	protected void add(EObject _this, int feature, Object value, String lexerRule, INode node) {
		try {
	...
	protected void add(EObject _this, int feature, Object value, String lexerRule) {
		add(_this, feature, value, lexerRule, currentNode);
	}
	
	protected void addWithLastConsumed(EObject _this, int feature, Object value, String lexerRule) {
    ...
    protected EObject forceCreateModelElementAndSet(Action action, int feature, EObject value) {
    	EObject result = semanticModelBuilder.create(action.getType().getClassifier());
    	semanticModelBuilder.set(result, feature, value, null /* ParserRule */, currentNode);
    	insertCompositeNode(action);
    	associateNodeWithAstElement(currentNode, result);
    	return result;
    }
    
    protected EObject forceCreateModelElementAndAdd(Action action, int feature, EObject value) {
    	EObject result = semanticModelBuilder.create(action.getType().getClassifier());
    	semanticModelBuilder.add(result, feature, value, null /* ParserRule */, currentNode);
    	insertCompositeNode(action);
    	associateNodeWithAstElement(currentNode, result);
    	return result;
    }
	...
	public void setSemanticModelBuilder(DefaultEcoreElementFactory semanticModelBuilder) {
		this.semanticModelBuilder = semanticModelBuilder;
	}
	
	public DefaultEcoreElementFactory getSemanticModelBuilder() {
