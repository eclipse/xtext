		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getConcrete1Access().getAlternatives(), "rule__Concrete1__Alternatives");
					...
					put(grammarAccess.getConcrete0Access().getGroup_1(), "rule__Concrete0__Group_1__0");
					put(grammarAccess.getConcrete1Access().getGroup_1(), "rule__Concrete1__Group_1__0");
					...
					put(grammarAccess.getConcrete0Access().getNameAssignment_1_2(), "rule__Concrete0__NameAssignment_1_2");
					put(grammarAccess.getConcrete1Access().getNameAssignment_1_2(), "rule__Concrete1__NameAssignment_1_2");
