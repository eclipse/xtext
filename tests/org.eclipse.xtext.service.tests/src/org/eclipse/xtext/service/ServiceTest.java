...
public class ServiceTest extends TestCase {
	...
	public void testServiceRegistry() throws Exception {
		...
		InjectedLanguageService service = ServiceRegistry.getService(myLanguageDescriptor,
				InjectedLanguageService.class);
	...
	public void testPriority() throws Exception {
		...
		GenericSingletonLanguageServiceFactory factory0 = new GenericSingletonLanguageServiceFactory(
				injectedLanguageService0, InjectedLanguageService.class);
		...
		GenericSingletonLanguageServiceFactory factory1 = new GenericSingletonLanguageServiceFactory(
				injectedLanguageService1, InjectedLanguageService.class);
