...
public class AbstractActivator extends AbstractUIPlugin {
	...
	public void start(BundleContext context) throws Exception {
		...
		try {
			...
			injectors.put("org.eclipse.xtext.common.types.xtext.ui.ContentAssistTestLanguage", Guice.createInjector(
				Modules.override(Modules.override(getRuntimeModule("org.eclipse.xtext.common.types.xtext.ui.ContentAssistTestLanguage")).with(getUiModule("org.eclipse.xtext.common.types.xtext.ui.ContentAssistTestLanguage"))).with(getSharedStateModule())
			));
