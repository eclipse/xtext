...
public class ContentAssistTestLanguageGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class GenerateDirectiveElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "GenerateDirective");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	private GenerateDirectiveElements pGenerateDirective;
	private ImportElements pImport;
	private ImportedFQNElements pImportedFQN;
	private FQNElements pFQN;
	private QNElements pQN;
	...
	public GenerateDirectiveElements getGenerateDirectiveAccess() {
		return (pGenerateDirective != null) ? pGenerateDirective : (pGenerateDirective = new GenerateDirectiveElements());
	}
	...
	public QNElements getQNAccess() {
		return (pQN != null) ? pQN : (pQN = new QNElements());
	}
