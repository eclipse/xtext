...
public class ClassReaderTypeProviderPerformanceTest extends AbstractTypeProviderPerformanceTest {
	...
	public void setUp() throws Exception {
		typeProvider = new ClassReaderTypeProvider(getClass().getClassLoader(), resourceSet, indexedJvmTypeAccess);
	}
