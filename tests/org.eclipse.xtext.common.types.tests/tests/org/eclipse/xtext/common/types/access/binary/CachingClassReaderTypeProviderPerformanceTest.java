...
public class CachingClassReaderTypeProviderPerformanceTest extends AbstractTypeProviderPerformanceTest {

	@Inject
	private ResourceSet resourceSet;

	private ClassReaderTypeProvider typeProvider;
	
	private CachingClassReaderTypeProviderFactory typeProviderFactory;

	@Before
	public void setUp() throws Exception {
		typeProviderFactory = new CachingClassReaderTypeProviderFactory(getClass().getClassLoader()); 
	...
	@Override
	public ClassReaderTypeProvider getTypeProvider() {
		return typeProvider;
	}
