...
public class ClassReaderTypeProviderTest extends AbstractTypeProviderTest {
	...
	protected ClassReaderTypeProvider createTypeProvider() {
		return new ClassReaderTypeProvider(getClass().getClassLoader(), resourceSet, indexedJvmTypeAccess);
	}
