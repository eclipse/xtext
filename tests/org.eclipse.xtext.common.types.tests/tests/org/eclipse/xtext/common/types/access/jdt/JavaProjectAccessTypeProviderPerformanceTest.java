 ...
 */
public class JavaProjectAccessTypeProviderPerformanceTest extends AbstractTypeProviderPerformanceTest {

	private ResourceSet resourceSet;
	private JavaProjectAccessTypeProvider typeProvider;
	...
	public void setUp() throws Exception {
		...
		typeProvider = new JavaProjectAccessTypeProvider((JavaProject) projectProvider.getJavaProject(resourceSet), resourceSet);
