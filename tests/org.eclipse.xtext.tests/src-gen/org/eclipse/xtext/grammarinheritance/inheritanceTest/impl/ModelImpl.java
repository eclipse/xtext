 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.xtext.grammarinheritance.inheritanceTest.impl.ModelImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ModelImpl extends org.eclipse.xtext.grammarinheritance.baseInheritanceTest.impl.ModelImpl implements Model
{
  ...
  {
    return InheritanceTestPackage.Literals.MODEL;
  }
  ...
  public EList<Element> getElements()
  {
    if (elements == null)
    {
      elements = new EObjectContainmentEList<Element>(Element.class, this, InheritanceTestPackage.MODEL__ELEMENTS);
    }
    return elements;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case InheritanceTestPackage.MODEL__ELEMENTS:
