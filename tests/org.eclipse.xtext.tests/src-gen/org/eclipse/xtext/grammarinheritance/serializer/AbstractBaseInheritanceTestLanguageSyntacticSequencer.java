...
public class AbstractBaseInheritanceTestLanguageSyntacticSequencer extends AbstractSyntacticSequencer {

	protected BaseInheritanceTestLanguageGrammarAccess grammarAccess;
	
	@Inject
	protected void init(IGrammarAccess access) {
		grammarAccess = (BaseInheritanceTestLanguageGrammarAccess) access;
	}
