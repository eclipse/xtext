...
public final class ConcreteTestLanguageSubrule2Consumer extends NonTerminalConsumer {
	...
	protected class RuleCall$6$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(stringConsumer, "sub2", false, false, getElement(), getRuleCall$6$Delimiter(), optional);
		}
	}
	...
	public void setRule(Subrule2Elements rule) {
		...
		assignment$5$Consumer = new Assignment$5$Consumer(rule.getSub2Assignment_2());
		ruleCall$6$Consumer = new RuleCall$6$Consumer(rule.getSub2STRINGTerminalRuleCall_2_0());
	}
