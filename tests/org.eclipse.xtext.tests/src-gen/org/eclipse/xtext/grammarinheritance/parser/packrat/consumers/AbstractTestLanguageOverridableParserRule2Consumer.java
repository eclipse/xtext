...
public final class AbstractTestLanguageOverridableParserRule2Consumer extends NonTerminalConsumer {
	...
	public void setRule(OverridableParserRule2Elements rule) {
		...
		keyword$2$Consumer = new Keyword$2$Consumer(rule.getOtherElementKeyword_0());
		assignment$3$Consumer = new Assignment$3$Consumer(rule.getNameAssignment_1());
		ruleCall$4$Consumer = new RuleCall$4$Consumer(rule.getNameSTRINGTerminalRuleCall_1_0());
	}
