...
public final class AbstractTestLanguageAbstractCallOverridenParserRuleConsumer extends NonTerminalConsumer {
	...
	public void setRule(AbstractCallOverridenParserRuleElements rule) {
		...
		keyword$2$Consumer = new Keyword$2$Consumer(rule.getOverridemodelKeyword_0());
		assignment$3$Consumer = new Assignment$3$Consumer(rule.getElementsAssignment_1());
		ruleCall$4$Consumer = new RuleCall$4$Consumer(rule.getElementsOverridableParserRuleParserRuleCall_1_0());
	}
