...
public class SyntacticSequencerTestLanguageStandaloneSetupGenerated implements ISetup, ISetupExtension {

	@Override
	public List<String> getFileExtensions() {
		return Arrays.asList("syntacticsequencertestlanguage");
	}
