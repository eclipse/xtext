...
public abstract class AbstractHiddenTokenSequencerTestLanguageSyntacticSequencer extends AbstractSyntacticSequencer {

	protected HiddenTokenSequencerTestLanguageGrammarAccess grammarAccess;
	
	@Inject
	protected void init(IGrammarAccess access) {
		grammarAccess = (HiddenTokenSequencerTestLanguageGrammarAccess) access;
	}
