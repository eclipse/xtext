...
public class DomainModelImpl extends MinimalEObjectImpl.Container implements DomainModel
{
  ...
  {
    return HiddentokensequencertestPackage.Literals.DOMAIN_MODEL;
  }
  ...
  public EList<Entity> getEntities()
  {
    if (entities == null)
    {
      entities = new EObjectContainmentEList<Entity>(Entity.class, this, HiddentokensequencertestPackage.DOMAIN_MODEL__ENTITIES);
    }
    return entities;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case HiddentokensequencertestPackage.DOMAIN_MODEL__ENTITIES:
