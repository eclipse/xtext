...
public class SimpleMultiplicitiesImpl extends MinimalEObjectImpl.Container implements SimpleMultiplicities
{
  ...
  {
    return SequencertestPackage.Literals.SIMPLE_MULTIPLICITIES;
  }
  ...
  public void setVal1(String newVal1)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SequencertestPackage.SIMPLE_MULTIPLICITIES__VAL1, oldVal1, val1));
  }
  ...
  public void setVal2(String newVal2)
  {
    ...
    val2 = newVal2;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SequencertestPackage.SIMPLE_MULTIPLICITIES__VAL2, oldVal2, val2));
  }
  ...
  public EList<String> getVal3()
  {
    if (val3 == null)
    {
      val3 = new EDataTypeEList<String>(String.class, this, SequencertestPackage.SIMPLE_MULTIPLICITIES__VAL3);
    }
    return val3;
  }
  ...
  public EList<String> getVal4()
  {
    if (val4 == null)
    {
      val4 = new EDataTypeEList<String>(String.class, this, SequencertestPackage.SIMPLE_MULTIPLICITIES__VAL4);
    }
    return val4;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SequencertestPackage.SIMPLE_MULTIPLICITIES__VAL1:
        return getVal1();
      case SequencertestPackage.SIMPLE_MULTIPLICITIES__VAL2:
        return getVal2();
      case SequencertestPackage.SIMPLE_MULTIPLICITIES__VAL3:
        return getVal3();
      case SequencertestPackage.SIMPLE_MULTIPLICITIES__VAL4:
        return getVal4();
    }
