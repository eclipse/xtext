 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.xtext.serializer.sequencertest.impl.List1Impl#getVal1 <em>Val1</em>}</li>
 * </ul>
 *
 * @generated
 */
public class List1Impl extends MinimalEObjectImpl.Container implements List1
{
  ...
  {
    return SequencertestPackage.Literals.LIST1;
  }
  ...
  public EList<String> getVal1()
  {
    if (val1 == null)
    {
      val1 = new EDataTypeEList<String>(String.class, this, SequencertestPackage.LIST1__VAL1);
    }
    return val1;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SequencertestPackage.LIST1__VAL1:
        return getVal1();
    }
