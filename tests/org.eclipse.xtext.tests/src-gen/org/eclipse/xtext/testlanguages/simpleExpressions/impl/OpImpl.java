...
public class OpImpl extends ExpressionImpl implements Op
{
  ...
  {
    return SimpleExpressionsPackage.Literals.OP;
  }
  ...
  public EList<Expression> getValues()
  {
    if (values == null)
    {
      values = new EObjectContainmentEList<Expression>(Expression.class, this, SimpleExpressionsPackage.OP__VALUES);
    }
    return values;
  }
  ...
  public void setOperator(String newOperator)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SimpleExpressionsPackage.OP__OPERATOR, oldOperator, operator));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SimpleExpressionsPackage.OP__VALUES:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SimpleExpressionsPackage.OP__VALUES:
        return getValues();
      case SimpleExpressionsPackage.OP__OPERATOR:
        return getOperator();
    }
