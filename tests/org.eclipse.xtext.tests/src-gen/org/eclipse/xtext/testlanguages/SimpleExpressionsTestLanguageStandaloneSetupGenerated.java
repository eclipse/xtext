...
public class SimpleExpressionsTestLanguageStandaloneSetupGenerated implements ISetup, ISetupExtension {

	@Override
	public List<String> getFileExtensions() {
		return Arrays.asList("simpleexpressionstestlanguage");
	}
