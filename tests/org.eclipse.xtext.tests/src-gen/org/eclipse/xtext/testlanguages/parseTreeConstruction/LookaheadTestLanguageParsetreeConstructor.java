...
public class LookaheadTestLanguageParsetreeConstructor extends org.eclipse.xtext.parsetree.reconstr.impl.AbstractParseTreeConstructor {
...
protected class LookAhead1_Group extends GroupToken {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new LookAhead1_ZAssignment_3(lastRuleCallOrigin, this, 0, inst);
			default: return null;
		}	
	}
...
protected class LookAhead1_ZAssignment_3 extends AssignmentToken  {
	...
	@Override
	public Assignment getGrammarElement() {
		return grammarAccess.getLookAhead1Access().getZAssignment_3();
	}
	...
	public IEObjectConsumer tryConsume() {
		...
		if(keywordSerializer.isValid(obj.getEObject(), grammarAccess.getLookAhead1Access().getZDKeyword_3_0(), value, null)) {
			type = AssignmentType.KEYWORD;
			element = grammarAccess.getLookAhead1Access().getZDKeyword_3_0();
			return obj;
		}
		return null;
	}
