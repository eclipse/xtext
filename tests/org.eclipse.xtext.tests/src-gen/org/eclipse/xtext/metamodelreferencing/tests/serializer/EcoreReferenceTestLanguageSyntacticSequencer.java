...
public class EcoreReferenceTestLanguageSyntacticSequencer extends AbstractSyntacticSequencer {

	protected EcoreReferenceTestLanguageGrammarAccess grammarAccess;
	
	@Inject
	protected void init(IGrammarAccess access) {
		grammarAccess = (EcoreReferenceTestLanguageGrammarAccess) access;
	}
