...
public class AbstractMetamodelRefTestLanguageSyntacticSequencer extends AbstractSyntacticSequencer {

	protected MetamodelRefTestLanguageGrammarAccess grammarAccess;
	
	@Inject
	protected void init(IGrammarAccess access) {
		grammarAccess = (MetamodelRefTestLanguageGrammarAccess) access;
	}
