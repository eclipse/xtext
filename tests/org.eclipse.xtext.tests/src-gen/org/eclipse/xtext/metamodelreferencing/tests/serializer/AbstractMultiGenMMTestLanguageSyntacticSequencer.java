...
public class AbstractMultiGenMMTestLanguageSyntacticSequencer extends AbstractSyntacticSequencer {

	protected MultiGenMMTestLanguageGrammarAccess grammarAccess;
	
	@Inject
	protected void init(IGrammarAccess access) {
		grammarAccess = (MultiGenMMTestLanguageGrammarAccess) access;
	}
