...
public class GrammarAccessTestLanguageSyntacticSequencer extends AbstractSyntacticSequencer {

	protected GrammarAccessTestLanguageGrammarAccess grammarAccess;
	
	@Inject
	protected void init(IGrammarAccess access) {
		grammarAccess = (GrammarAccessTestLanguageGrammarAccess) access;
	}
