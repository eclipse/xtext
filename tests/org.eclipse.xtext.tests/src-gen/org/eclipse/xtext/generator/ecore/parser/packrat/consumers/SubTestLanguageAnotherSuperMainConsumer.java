...
import org.eclipse.xtext.generator.ecore.services.SubTestLanguageGrammarAccess.AnotherSuperMainElements;

public final class SubTestLanguageAnotherSuperMainConsumer extends NonTerminalConsumer {
	...
	public SubTestLanguageAnotherSuperMainConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public void setRule(AnotherSuperMainElements rule) {
		...
		keyword$2$Consumer = new Keyword$2$Consumer(rule.getUpsKeyword_0());
