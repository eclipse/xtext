...
public final class SuperTestLanguageAnotherSuperMainConsumer extends NonTerminalConsumer {
	...
	public SuperTestLanguageAnotherSuperMainConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public AnotherSuperMainElements getRule() {
		return rule;
	}
	
	public void setRule(AnotherSuperMainElements rule) {
		this.rule = rule;
		
		group$1$Consumer = new Group$1$Consumer(rule.getGroup());
		keyword$2$Consumer = new Keyword$2$Consumer(rule.getAnotherKeyword_0());
