 ...
 * <!-- end-user-doc -->
 * @see org.eclipse.xtext.generator.ecore.genmodelaccess.root.RootPackage#getRootEnum()
 * @model
 * @generated
 */
public enum RootEnum implements Enumerator
{
	/**
	 ...
	 * @generated
	 */
	public static final List<RootEnum> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));
	 ...
	 * @generated
	 */
	private RootEnum(int value, String name, String literal)
	{
		this.value = value;
		this.name = name;
