...
import org.eclipse.xtext.lexer.services.BacktrackingLexerTestLanguageGrammarAccess.XbElements;

public final class BacktrackingLexerTestLanguageXbConsumer extends NonTerminalConsumer {

	private XbElements rule;	

	private ITerminalConsumer charXConsumer;
	...
	protected class RuleCall$3$Consumer extends ElementConsumer<RuleCall> {
		...
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(charXConsumer, "x", false, false, getElement(), getRuleCall$3$Delimiter(), optional);
		}
	}
	...
	public BacktrackingLexerTestLanguageXbConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public XbElements getRule() {
		return rule;
	}
	
	public void setRule(XbElements rule) {
		this.rule = rule;
		
		group$1$Consumer = new Group$1$Consumer(rule.getGroup());
		assignment$2$Consumer = new Assignment$2$Consumer(rule.getXAssignment_0());
		ruleCall$3$Consumer = new RuleCall$3$Consumer(rule.getXCharXTerminalRuleCall_0_0());
	...
	public void setCharXConsumer(ITerminalConsumer charXConsumer) {
		this.charXConsumer = charXConsumer;
	}
