...
public final class IgnoreCaseLexerTestLanguageWSConsumer extends AbstractRuleAwareTerminalConsumer {

	public IgnoreCaseLexerTestLanguageWSConsumer(ITerminalConsumerConfiguration configuration) {
		super(configuration);
	}
