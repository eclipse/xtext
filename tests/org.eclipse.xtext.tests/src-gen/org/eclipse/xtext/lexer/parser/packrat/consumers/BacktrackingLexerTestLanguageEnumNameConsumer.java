...
public final class BacktrackingLexerTestLanguageEnumNameConsumer extends NonTerminalConsumer {
	...
	public BacktrackingLexerTestLanguageEnumNameConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public EnumNameElements getRule() {
		return rule;
	}
	
	public void setRule(EnumNameElements rule) {
		this.rule = rule;
		
		alternatives$1$Consumer = new Alternatives$1$Consumer(rule.getAlternatives());
		enumLiteralDeclaration$2$Consumer = new EnumLiteralDeclaration$2$Consumer(rule.getAbcEnumLiteralDeclaration_0());
		enumLiteralDeclaration$4$Consumer = new EnumLiteralDeclaration$4$Consumer(rule.getEfgEnumLiteralDeclaration_1());
	}
