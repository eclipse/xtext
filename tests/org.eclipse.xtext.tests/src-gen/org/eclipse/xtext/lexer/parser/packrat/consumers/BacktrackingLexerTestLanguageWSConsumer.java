...
public final class BacktrackingLexerTestLanguageWSConsumer extends AbstractRuleAwareTerminalConsumer {

	public BacktrackingLexerTestLanguageWSConsumer(ITerminalConsumerConfiguration configuration) {
		super(configuration);
	}
