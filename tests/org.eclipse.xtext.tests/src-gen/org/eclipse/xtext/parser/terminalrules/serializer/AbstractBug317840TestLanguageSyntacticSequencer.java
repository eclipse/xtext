...
public class AbstractBug317840TestLanguageSyntacticSequencer extends AbstractSyntacticSequencer {

	protected Bug317840TestLanguageGrammarAccess grammarAccess;
	
	@Inject
	protected void init(IGrammarAccess access) {
		grammarAccess = (Bug317840TestLanguageGrammarAccess) access;
	}
