...
public class TypeRefImpl extends MinimalEObjectImpl.Container implements TypeRef
{
  ...
  {
    return XtextTerminalsTestLanguagePackage.Literals.TYPE_REF;
  }
    ...
    if (metamodel != null && metamodel.eIsProxy())
    {
      ...
      if (metamodel != oldMetamodel)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, XtextTerminalsTestLanguagePackage.TYPE_REF__METAMODEL, oldMetamodel, metamodel));
      }
    }
    return metamodel;
  }
  ...
  public void setMetamodel(AbstractMetamodelDeclaration newMetamodel)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XtextTerminalsTestLanguagePackage.TYPE_REF__METAMODEL, oldMetamodel, metamodel));
  }
  ...
  public EClassifier getClassifier()
  {
    if (classifier != null && classifier.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, XtextTerminalsTestLanguagePackage.TYPE_REF__CLASSIFIER, oldClassifier, classifier));
      }
    }
    return classifier;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case XtextTerminalsTestLanguagePackage.TYPE_REF__METAMODEL:
        if (resolve) return getMetamodel();
        return basicGetMetamodel();
      case XtextTerminalsTestLanguagePackage.TYPE_REF__CLASSIFIER:
