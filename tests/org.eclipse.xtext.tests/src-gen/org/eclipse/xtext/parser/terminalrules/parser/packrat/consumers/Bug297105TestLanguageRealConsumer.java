...
public final class Bug297105TestLanguageRealConsumer extends NonTerminalConsumer {
	...
	private ITerminalConsumer extIntConsumer;
	...
	protected class RuleCall$2$Consumer extends OptionalElementConsumer<RuleCall> {
	...
	protected class RuleCall$5$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(extIntConsumer, null, false, false, getElement(), getRuleCall$5$Delimiter(), optional);
		}
	}
	...
	public Bug297105TestLanguageRealConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public RealElements getRule() {
		return rule;
	}
	
	public void setRule(RealElements rule) {
		this.rule = rule;
		...
		ruleCall$5$Consumer = new RuleCall$5$Consumer(rule.getEXT_INTTerminalRuleCall_2_0());
		ruleCall$6$Consumer = new RuleCall$6$Consumer(rule.getINTTerminalRuleCall_2_1());
	}
	...
	public void setExtIntConsumer(ITerminalConsumer extIntConsumer) {
		this.extIntConsumer = extIntConsumer;
	}
