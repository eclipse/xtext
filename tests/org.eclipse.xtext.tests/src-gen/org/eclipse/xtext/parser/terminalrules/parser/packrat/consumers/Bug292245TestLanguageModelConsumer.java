...
import org.eclipse.xtext.parser.terminalrules.services.Bug292245TestLanguageGrammarAccess.ModelElements;

@SuppressWarnings("all")
public final class Bug292245TestLanguageModelConsumer extends NonTerminalConsumer {

	private ModelElements rule;	

	private INonTerminalConsumer apostropheConsumer;

	private INonTerminalConsumer errorConsumer;

	private INonTerminalConsumer fixConsumer;
	...
	protected class RuleCall$5$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeNonTerminal(fixConsumer, "fix", true, true, false, getElement(), optional);
		}
	}
	...
	protected class RuleCall$9$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeNonTerminal(errorConsumer, "error", true, true, false, getElement(), optional);
		}
	}
	...
	protected class RuleCall$13$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeNonTerminal(apostropheConsumer, "tick", true, true, false, getElement(), optional);
		}
	}

	public Bug292245TestLanguageModelConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public void setRule(ModelElements rule) {
		...
		keyword$3$Consumer = new Keyword$3$Consumer(rule.getFIXKeyword_0_0());
		assignment$4$Consumer = new Assignment$4$Consumer(rule.getFixAssignment_0_1());
		ruleCall$5$Consumer = new RuleCall$5$Consumer(rule.getFixFixParserRuleCall_0_1_0());
		group$6$Consumer = new Group$6$Consumer(rule.getGroup_1());
		keyword$7$Consumer = new Keyword$7$Consumer(rule.getERRORKeyword_1_0());
		assignment$8$Consumer = new Assignment$8$Consumer(rule.getErrorAssignment_1_1());
		ruleCall$9$Consumer = new RuleCall$9$Consumer(rule.getErrorErrorParserRuleCall_1_1_0());
		group$10$Consumer = new Group$10$Consumer(rule.getGroup_2());
		keyword$11$Consumer = new Keyword$11$Consumer(rule.getTICKKeyword_2_0());
		assignment$12$Consumer = new Assignment$12$Consumer(rule.getTickAssignment_2_1());
		ruleCall$13$Consumer = new RuleCall$13$Consumer(rule.getTickApostropheParserRuleCall_2_1_0());
	}
	...
	public void setApostropheConsumer(INonTerminalConsumer apostropheConsumer) {
		this.apostropheConsumer = apostropheConsumer;
	}
	
	public void setErrorConsumer(INonTerminalConsumer errorConsumer) {
		this.errorConsumer = errorConsumer;
	}
	
	public void setFixConsumer(INonTerminalConsumer fixConsumer) {
		this.fixConsumer = fixConsumer;
	}
