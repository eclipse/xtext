...
public final class Bug292245TestLanguageGraphicalConsumer extends NonTerminalConsumer {
	...
	private ITerminalConsumer charConsumer;
	...
	protected class RuleCall$2$Consumer extends ElementConsumer<RuleCall> {
		...
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(charConsumer, null, false, false, getElement(), getRuleCall$2$Delimiter(), optional);
		}
	}
	...
	protected class RuleCall$3$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(wsConsumer, null, false, false, getElement(), getRuleCall$3$Delimiter(), optional);
		}
	}

	public Bug292245TestLanguageGraphicalConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public GraphicalElements getRule() {
		return rule;
	}
	
	public void setRule(GraphicalElements rule) {
		this.rule = rule;
		
		alternatives$1$Consumer = new Alternatives$1$Consumer(rule.getAlternatives());
		ruleCall$2$Consumer = new RuleCall$2$Consumer(rule.getCHARTerminalRuleCall_0());
		ruleCall$3$Consumer = new RuleCall$3$Consumer(rule.getWSTerminalRuleCall_1());
	}
	...
	public void setCharConsumer(ITerminalConsumer charConsumer) {
