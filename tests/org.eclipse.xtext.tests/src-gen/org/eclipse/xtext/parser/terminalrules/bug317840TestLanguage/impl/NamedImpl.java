...
public class NamedImpl extends MinimalEObjectImpl.Container implements Named
{
  ...
  {
    return Bug317840TestLanguagePackage.Literals.NAMED;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Bug317840TestLanguagePackage.NAMED__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case Bug317840TestLanguagePackage.NAMED__NAME:
        return getName();
    }
