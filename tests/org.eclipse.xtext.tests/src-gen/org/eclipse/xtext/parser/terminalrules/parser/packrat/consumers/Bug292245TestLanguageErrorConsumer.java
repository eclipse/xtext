...
public final class Bug292245TestLanguageErrorConsumer extends NonTerminalConsumer {
	...
	public Bug292245TestLanguageErrorConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public ErrorElements getRule() {
		return rule;
	}
	
	public void setRule(ErrorElements rule) {
		this.rule = rule;
