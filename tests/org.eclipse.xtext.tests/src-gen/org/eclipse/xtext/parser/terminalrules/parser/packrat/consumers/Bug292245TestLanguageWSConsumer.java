...
public final class Bug292245TestLanguageWSConsumer extends AbstractRuleAwareTerminalConsumer {

	public Bug292245TestLanguageWSConsumer(ITerminalConsumerConfiguration configuration) {
		super(configuration);
	}
