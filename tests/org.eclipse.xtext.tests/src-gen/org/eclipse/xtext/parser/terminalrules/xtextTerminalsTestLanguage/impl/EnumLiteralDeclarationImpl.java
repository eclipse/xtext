 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.xtext.parser.terminalrules.xtextTerminalsTestLanguage.impl.EnumLiteralDeclarationImpl#getEnumLiteral <em>Enum Literal</em>}</li>
 *   <li>{@link org.eclipse.xtext.parser.terminalrules.xtextTerminalsTestLanguage.impl.EnumLiteralDeclarationImpl#getLiteral <em>Literal</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EnumLiteralDeclarationImpl extends AbstractElementImpl implements EnumLiteralDeclaration
{
  ...
  {
    return XtextTerminalsTestLanguagePackage.Literals.ENUM_LITERAL_DECLARATION;
  }
    ...
    if (enumLiteral != null && enumLiteral.eIsProxy())
    {
      ...
      if (enumLiteral != oldEnumLiteral)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, XtextTerminalsTestLanguagePackage.ENUM_LITERAL_DECLARATION__ENUM_LITERAL, oldEnumLiteral, enumLiteral));
      }
    }
    return enumLiteral;
  }
  ...
  public NotificationChain basicSetLiteral(Keyword newLiteral, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XtextTerminalsTestLanguagePackage.ENUM_LITERAL_DECLARATION__LITERAL, oldLiteral, newLiteral);
  ...
  public void setLiteral(Keyword newLiteral)
  {
    if (newLiteral != literal)
    {
      ...
      if (literal != null)
        msgs = ((InternalEObject)literal).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XtextTerminalsTestLanguagePackage.ENUM_LITERAL_DECLARATION__LITERAL, null, msgs);
      if (newLiteral != null)
        msgs = ((InternalEObject)newLiteral).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XtextTerminalsTestLanguagePackage.ENUM_LITERAL_DECLARATION__LITERAL, null, msgs);
      msgs = basicSetLiteral(newLiteral, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XtextTerminalsTestLanguagePackage.ENUM_LITERAL_DECLARATION__LITERAL, newLiteral, newLiteral));
  }
