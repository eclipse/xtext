...
public class LiteralImpl extends MinimalEObjectImpl.Container implements Literal
{
  ...
  {
    return Bug297105TestLanguagePackage.Literals.LITERAL;
  }
  ...
  public void setValue(String newValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Bug297105TestLanguagePackage.LITERAL__VALUE, oldValue, value));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case Bug297105TestLanguagePackage.LITERAL__VALUE:
        return getValue();
    }
