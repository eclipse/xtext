...
public class AbstractBug299237TestLanguageSyntacticSequencer extends AbstractSyntacticSequencer {

	protected Bug299237TestLanguageGrammarAccess grammarAccess;
	
	@Inject
	protected void init(IGrammarAccess access) {
		grammarAccess = (Bug299237TestLanguageGrammarAccess) access;
	}
