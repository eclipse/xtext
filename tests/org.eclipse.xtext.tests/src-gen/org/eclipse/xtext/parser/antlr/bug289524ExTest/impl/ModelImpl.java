...
public class ModelImpl extends MinimalEObjectImpl.Container implements Model
{
   ...
   * @ordered
   */
  protected EList<ModelElement> refs;
  ...
  {
    return Bug289524ExTestPackage.Literals.MODEL;
  }
  ...
  public EList<ModelElement> getRefs()
  {
    if (refs == null)
    {
      refs = new EObjectContainmentEList<ModelElement>(ModelElement.class, this, Bug289524ExTestPackage.MODEL__REFS);
    }
    return refs;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case Bug289524ExTestPackage.MODEL__REFS:
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      case Bug289524ExTestPackage.MODEL__REFS:
        getRefs().clear();
        getRefs().addAll((Collection<? extends ModelElement>)newValue);
        return;
    }
