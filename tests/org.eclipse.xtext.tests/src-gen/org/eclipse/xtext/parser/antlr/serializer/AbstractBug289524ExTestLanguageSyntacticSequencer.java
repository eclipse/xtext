...
public class AbstractBug289524ExTestLanguageSyntacticSequencer extends AbstractSyntacticSequencer {

	protected Bug289524ExTestLanguageGrammarAccess grammarAccess;
	
	@Inject
	protected void init(IGrammarAccess access) {
		grammarAccess = (Bug289524ExTestLanguageGrammarAccess) access;
	}
