...
import org.eclipse.xtext.parser.antlr.services.Bug289524TestLanguageGrammarAccess.ContainedElements;

@SuppressWarnings("all")
public final class Bug289524TestLanguageContainedConsumer extends NonTerminalConsumer {
	...
	public Bug289524TestLanguageContainedConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public ContainedElements getRule() {
		return rule;
	}
	
	public void setRule(ContainedElements rule) {
		this.rule = rule;
		
		group$1$Consumer = new Group$1$Consumer(rule.getGroup());
		keyword$2$Consumer = new Keyword$2$Consumer(rule.getContainmentKeyword_0());
