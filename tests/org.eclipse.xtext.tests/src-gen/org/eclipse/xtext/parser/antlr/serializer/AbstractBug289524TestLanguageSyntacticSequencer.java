...
public class AbstractBug289524TestLanguageSyntacticSequencer extends AbstractSyntacticSequencer {

	protected Bug289524TestLanguageGrammarAccess grammarAccess;
	
	@Inject
	protected void init(IGrammarAccess access) {
		grammarAccess = (Bug289524TestLanguageGrammarAccess) access;
	}
