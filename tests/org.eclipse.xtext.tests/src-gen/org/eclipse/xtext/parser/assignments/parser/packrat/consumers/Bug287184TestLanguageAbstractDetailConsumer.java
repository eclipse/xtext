...
public final class Bug287184TestLanguageAbstractDetailConsumer extends NonTerminalConsumer {
	...
	protected class RuleCall$2$Consumer extends ElementConsumer<RuleCall> {
		...
		protected int doConsume(boolean optional) throws Exception {
			return consumeNonTerminal(detailConsumer, null, false, false, false, getElement(), optional);
		}
	}
	...
	protected class RuleCall$3$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeNonTerminal(associatedDetailConsumer, null, false, false, false, getElement(), optional);
		}
	}

	public Bug287184TestLanguageAbstractDetailConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public AbstractDetailElements getRule() {
		return rule;
	}
	
	public void setRule(AbstractDetailElements rule) {
		this.rule = rule;
		
		alternatives$1$Consumer = new Alternatives$1$Consumer(rule.getAlternatives());
		ruleCall$2$Consumer = new RuleCall$2$Consumer(rule.getDetailParserRuleCall_0());
		ruleCall$3$Consumer = new RuleCall$3$Consumer(rule.getAssociatedDetailParserRuleCall_1());
	}
