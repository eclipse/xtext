...
public final class Bug288432TestLanguageParameterConsumer extends NonTerminalConsumer {
	...
	public Bug288432TestLanguageParameterConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public void setRule(ParameterElements rule) {
		...
		crossReference$5$Consumer = new CrossReference$5$Consumer(rule.getValueParameterObjectCrossReference_1_0());
	}
