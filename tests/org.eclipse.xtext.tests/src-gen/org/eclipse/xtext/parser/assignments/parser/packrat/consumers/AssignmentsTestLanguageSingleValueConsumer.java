...
public final class AssignmentsTestLanguageSingleValueConsumer extends NonTerminalConsumer {
	...
	protected class RuleCall$5$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(idConsumer, "value", false, false, getElement(), getRuleCall$5$Delimiter(), optional);
		}
	}
	...
	protected class RuleCall$11$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(stringConsumer, "value", false, false, getElement(), getRuleCall$11$Delimiter(), optional);
		}
	}
	...
	protected class RuleCall$15$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(stringConsumer, "value", false, false, getElement(), getRuleCall$15$Delimiter(), optional);
		}
	}

	public AssignmentsTestLanguageSingleValueConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public SingleValueElements getRule() {
		return rule;
	}
	
	public void setRule(SingleValueElements rule) {
		this.rule = rule;
		...
		keyword$3$Consumer = new Keyword$3$Consumer(rule.getIdKeyword_0_0());
		...
		keyword$7$Consumer = new Keyword$7$Consumer(rule.getAlternativeKeyword_1_0());
		...
		keyword$13$Consumer = new Keyword$13$Consumer(rule.getStringKeyword_2_0());
