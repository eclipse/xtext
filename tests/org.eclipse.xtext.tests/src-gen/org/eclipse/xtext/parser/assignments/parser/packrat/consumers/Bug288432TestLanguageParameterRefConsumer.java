...
import org.eclipse.xtext.parser.assignments.services.Bug288432TestLanguageGrammarAccess.ParameterRefElements;

@SuppressWarnings("all")
public final class Bug288432TestLanguageParameterRefConsumer extends NonTerminalConsumer {

	private ParameterRefElements rule;	
	...
	protected class CrossReference$2$Consumer extends ElementConsumer<CrossReference> {
		...
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(idConsumer, "parameter", false, false, getElement(), getRuleCall$4$Delimiter(), optional);
		}
	}
	...
	public Bug288432TestLanguageParameterRefConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public ParameterRefElements getRule() {
		return rule;
	}
	
	public void setRule(ParameterRefElements rule) {
		this.rule = rule;
		
		assignment$1$Consumer = new Assignment$1$Consumer(rule.getParameterAssignment());
		crossReference$2$Consumer = new CrossReference$2$Consumer(rule.getParameterParameterCrossReference_0());
	}
