...
public final class AssignmentsTestLanguageSingleDatatypeConsumer extends NonTerminalConsumer {
	...
	protected class RuleCall$5$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeNonTerminal(idDatatypeConsumer, "value", false, true, false, getElement(), optional);
		}
	}
	...
	protected class RuleCall$11$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeNonTerminal(stringDatatypeConsumer, "value", false, true, false, getElement(), optional);
		}
	}
	...
	public AssignmentsTestLanguageSingleDatatypeConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public SingleDatatypeElements getRule() {
		return rule;
	}
	
	public void setRule(SingleDatatypeElements rule) {
		this.rule = rule;
		...
		keyword$3$Consumer = new Keyword$3$Consumer(rule.getDatatypeidKeyword_0_0());
		...
		keyword$7$Consumer = new Keyword$7$Consumer(rule.getDatatypealternativeKeyword_1_0());
		...
		keyword$13$Consumer = new Keyword$13$Consumer(rule.getDatatypestringKeyword_2_0());
