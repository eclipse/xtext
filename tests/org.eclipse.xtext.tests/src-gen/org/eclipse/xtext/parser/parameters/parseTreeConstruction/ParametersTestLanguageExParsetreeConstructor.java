...
public class ParametersTestLanguageExParsetreeConstructor extends org.eclipse.xtext.parsetree.reconstr.impl.AbstractParseTreeConstructor {
...
protected class ThisRootNode extends RootToken {
	...
	public AbstractToken createFollower(int index, IEObjectConsumer inst) {
		switch(index) {
			case 0: return new ParserRuleFragmentsEx_ParserRuleParametersParserRuleCall(this, this, 0, inst);
			case 1: return new ParserRuleParameters_Group(this, this, 1, inst);
			case 2: return new Scenario1_Alternatives(this, this, 2, inst);
			case 3: return new Scenario2_FirstAssignment(this, this, 3, inst);
			case 4: return new Scenario3_Alternatives(this, this, 4, inst);
			case 5: return new Scenario4_Group(this, this, 5, inst);
			default: return null;
		}	
	}	
}
...
// ParserRuleParameters
protected class ParserRuleFragmentsEx_ParserRuleParametersParserRuleCall extends RuleCallToken {
	
	public ParserRuleFragmentsEx_ParserRuleParametersParserRuleCall(AbstractToken lastRuleCallOrigin, AbstractToken next, int transitionIndex, IEObjectConsumer eObjectConsumer) {
		super(lastRuleCallOrigin, next, transitionIndex, eObjectConsumer);
	}
	
	@Override
	public RuleCall getGrammarElement() {
		return grammarAccess.getParserRuleFragmentsExAccess().getParserRuleParametersParserRuleCall();
	}
	...
	public IEObjectConsumer tryConsume() {
		if(getEObject().eClass() != grammarAccess.getParserRuleParametersAccess().getParserRuleParametersAction_0().getType().getClassifier())
			return null;
		if(checkForRecursion(ParserRuleParameters_Group.class, eObjectConsumer)) return null;
