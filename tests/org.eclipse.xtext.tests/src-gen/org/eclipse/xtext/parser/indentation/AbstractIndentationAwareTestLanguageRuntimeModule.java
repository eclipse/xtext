...
public abstract class AbstractIndentationAwareTestLanguageRuntimeModule extends org.eclipse.xtext.service.DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "org/eclipse/xtext/parser/indentation/IndentationAwareTestLanguage.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("org.eclipse.xtext.parser.indentation.IndentationAwareTestLanguage");
	}
	...
	public Class<? extends org.eclipse.xtext.parsetree.reconstr.IParseTreeConstructor> bindIParseTreeConstructor() {
		return org.eclipse.xtext.parser.indentation.parseTreeConstruction.IndentationAwareTestLanguageParsetreeConstructor.class;
	}
