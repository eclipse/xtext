...
public class InternalIndentationAwareTestLanguageParser extends AbstractInternalAntlrParser {
    public static final String[] tokenNames = new String[] {
        "<invalid>", "<EOR>", "<DOWN>", "<UP>", "RULE_INDENT", "RULE_DEDENT", "RULE_ID", "RULE_INT", "RULE_STRING", "RULE_ML_COMMENT", "RULE_SL_COMMENT", "RULE_WS", "RULE_ANY_OTHER"
    };
    ...
    public final EObject entryRuleTree() throws RecognitionException {
        ...
        try {
            ...
            pushFollow(FOLLOW_ruleTree_in_entryRuleTree67);
            iv_ruleTree=ruleTree();

            state._fsp--;

             current =iv_ruleTree; 
            match(input,EOF,FOLLOW_EOF_in_entryRuleTree77); 
        ...
        try {
            ...
            do {
            	...
            	case 1 :
            	    ...
            	    pushFollow(FOLLOW_ruleTreeNode_in_ruleTree132);
    ...
    public final EObject entryRuleTreeNode() throws RecognitionException {
        ...
        try {
            ...
            pushFollow(FOLLOW_ruleTreeNode_in_entryRuleTreeNode168);
            iv_ruleTreeNode=ruleTreeNode();

            state._fsp--;

             current =iv_ruleTreeNode; 
            match(input,EOF,FOLLOW_EOF_in_entryRuleTreeNode178); 
    ...
    public final EObject ruleTreeNode() throws RecognitionException {
        ...
        try {
            ...
            {
            lv_name_0_0=(Token)match(input,RULE_ID,FOLLOW_RULE_ID_in_ruleTreeNode220); 
            ...
            switch (alt3) {
                case 1 :
                    ...
                    {
                    this_INDENT_1=(Token)match(input,RULE_INDENT,FOLLOW_RULE_INDENT_in_ruleTreeNode237); 
                    ...
                    do {
                    	...
                    	case 1 :
                    	    ...
                    	    pushFollow(FOLLOW_ruleTreeNode_in_ruleTreeNode257);
                    ...
                    this_DEDENT_3=(Token)match(input,RULE_DEDENT,FOLLOW_RULE_DEDENT_in_ruleTreeNode269); 
    ...
    public static final BitSet FOLLOW_ruleTreeNode_in_ruleTree132 = new BitSet(new long[]{0x0000000000000042L});
    ...
    public static final BitSet FOLLOW_RULE_ID_in_ruleTreeNode220 = new BitSet(new long[]{0x0000000000000012L});
    public static final BitSet FOLLOW_RULE_INDENT_in_ruleTreeNode237 = new BitSet(new long[]{0x0000000000000060L});
    public static final BitSet FOLLOW_ruleTreeNode_in_ruleTreeNode257 = new BitSet(new long[]{0x0000000000000060L});
