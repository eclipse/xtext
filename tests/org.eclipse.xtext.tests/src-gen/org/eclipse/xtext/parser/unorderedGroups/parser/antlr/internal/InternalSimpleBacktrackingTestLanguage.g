...
* generated by Xtext
*/
grammar InternalSimpleBacktrackingTestLanguage;
...
*/
    ...
    public InternalSimpleBacktrackingTestLanguageParser(TokenStream input, IAstFactory factory, SimpleBacktrackingTestLanguageGrammarAccess grammarAccess) {
        this(input);
    ...
    protected InputStream getTokenFile() {
    	...
    	return classLoader.getResourceAsStream("org/eclipse/xtext/parser/unorderedGroups/parser/antlr/internal/InternalSimpleBacktrackingTestLanguage.tokens");
    }
    ...
    protected String getFirstRuleName() {
   	...
   	@Override
   	protected SimpleBacktrackingTestLanguageGrammarAccess getGrammarAccess() {
