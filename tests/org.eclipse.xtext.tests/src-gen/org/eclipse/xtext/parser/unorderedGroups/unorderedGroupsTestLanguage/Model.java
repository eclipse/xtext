 ...
 * <ul>
 *   <li>{@link org.eclipse.xtext.parser.unorderedGroups.unorderedGroupsTestLanguage.Model#isFirst <em>First</em>}</li>
 *   <li>{@link org.eclipse.xtext.parser.unorderedGroups.unorderedGroupsTestLanguage.Model#isSecond <em>Second</em>}</li>
 *   <li>{@link org.eclipse.xtext.parser.unorderedGroups.unorderedGroupsTestLanguage.Model#isThird <em>Third</em>}</li>
 *   <li>{@link org.eclipse.xtext.parser.unorderedGroups.unorderedGroupsTestLanguage.Model#isForth <em>Forth</em>}</li>
 *   <li>{@link org.eclipse.xtext.parser.unorderedGroups.unorderedGroupsTestLanguage.Model#getFirstAsList <em>First As List</em>}</li>
 *   <li>{@link org.eclipse.xtext.parser.unorderedGroups.unorderedGroupsTestLanguage.Model#getSecondAsList <em>Second As List</em>}</li>
 *   <li>{@link org.eclipse.xtext.parser.unorderedGroups.unorderedGroupsTestLanguage.Model#getThirdAsList <em>Third As List</em>}</li>
 ...
 * </p>
 *
 * @see org.eclipse.xtext.parser.unorderedGroups.unorderedGroupsTestLanguage.UnorderedGroupsTestLanguagePackage#getModel()
 * @model
 * @generated
 */
public interface Model extends EObject
{
   ...
   * @see org.eclipse.xtext.parser.unorderedGroups.unorderedGroupsTestLanguage.UnorderedGroupsTestLanguagePackage#getModel_First()
   * @model
   * @generated
   */
  boolean isFirst();
  ...
  /**
   * Sets the value of the '{@link org.eclipse.xtext.parser.unorderedGroups.unorderedGroupsTestLanguage.Model#isFirst <em>First</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.eclipse.xtext.parser.unorderedGroups.unorderedGroupsTestLanguage.UnorderedGroupsTestLanguagePackage#getModel_Second()
   * @model
   * @generated
   */
  boolean isSecond();
  ...
  /**
   * Sets the value of the '{@link org.eclipse.xtext.parser.unorderedGroups.unorderedGroupsTestLanguage.Model#isSecond <em>Second</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.eclipse.xtext.parser.unorderedGroups.unorderedGroupsTestLanguage.UnorderedGroupsTestLanguagePackage#getModel_Third()
   * @model
   * @generated
   */
  boolean isThird();
  ...
  /**
   * Sets the value of the '{@link org.eclipse.xtext.parser.unorderedGroups.unorderedGroupsTestLanguage.Model#isThird <em>Third</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.eclipse.xtext.parser.unorderedGroups.unorderedGroupsTestLanguage.UnorderedGroupsTestLanguagePackage#getModel_Forth()
   * @model
   * @generated
   */
  boolean isForth();
  ...
  /**
   * Sets the value of the '{@link org.eclipse.xtext.parser.unorderedGroups.unorderedGroupsTestLanguage.Model#isForth <em>Forth</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setValue(String)
   * @see org.eclipse.xtext.parser.unorderedGroups.unorderedGroupsTestLanguage.UnorderedGroupsTestLanguagePackage#getModel_Value()
   * @model
   * @generated
   */
  String getValue();
  ...
  /**
   * Sets the value of the '{@link org.eclipse.xtext.parser.unorderedGroups.unorderedGroupsTestLanguage.Model#getValue <em>Value</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.eclipse.xtext.parser.unorderedGroups.unorderedGroupsTestLanguage.UnorderedGroupsTestLanguagePackage#getModel_Serialized()
   * @model containment="true"
   * @generated
   */
  UnorderedSerialization getSerialized();

  /**
   * Sets the value of the '{@link org.eclipse.xtext.parser.unorderedGroups.unorderedGroupsTestLanguage.Model#getSerialized <em>Serialized</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @param value the new value of the '<em>Serialized</em>' containment reference.
   * @see #getSerialized()
   * @generated
   */
