...
public class ExUnorderedGroupsTestLanguageParser extends org.eclipse.xtext.parser.antlr.AbstractAntlrParser {
	...
	protected IParseResult parse(String ruleName, ANTLRInputStream in) {
		...
		org.eclipse.xtext.parser.unorderedGroups.parser.antlr.internal.InternalExUnorderedGroupsTestLanguageParser parser = createParser(tokenStream);
	...
	protected org.eclipse.xtext.parser.unorderedGroups.parser.antlr.internal.InternalExUnorderedGroupsTestLanguageParser createParser(XtextTokenStream stream) {
		return new org.eclipse.xtext.parser.unorderedGroups.parser.antlr.internal.InternalExUnorderedGroupsTestLanguageParser(stream, getElementFactory(), getGrammarAccess());
	}
