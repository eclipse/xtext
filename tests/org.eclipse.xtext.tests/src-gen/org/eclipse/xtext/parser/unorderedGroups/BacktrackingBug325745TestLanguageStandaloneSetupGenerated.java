...
public class BacktrackingBug325745TestLanguageStandaloneSetupGenerated implements ISetup, ISetupExtension {

	@Override
	public List<String> getFileExtensions() {
		return Arrays.asList("backtrackingbug325745testlanguage");
	}
