 ...
 * <ul>
 *   <li>{@link org.eclipse.xtext.parser.unorderedGroups.backtrackingTestLanguage.impl.SimpleTypeRefImpl#getRawType <em>Raw Type</em>}</li>
 *   <li>{@link org.eclipse.xtext.parser.unorderedGroups.backtrackingTestLanguage.impl.SimpleTypeRefImpl#getActualArgumentsList <em>Actual Arguments List</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SimpleTypeRefImpl extends TypeRefImpl implements SimpleTypeRef
{
  ...
  {
    return BacktrackingTestLanguagePackage.Literals.SIMPLE_TYPE_REF;
  }
  ...
  public void setRawType(String newRawType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BacktrackingTestLanguagePackage.SIMPLE_TYPE_REF__RAW_TYPE, oldRawType, rawType));
  }
  ...
  public EList<String> getActualArgumentsList()
  {
    ...
    {
      actualArgumentsList = new EDataTypeEList<String>(String.class, this, BacktrackingTestLanguagePackage.SIMPLE_TYPE_REF__ACTUAL_ARGUMENTS_LIST);
    }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case BacktrackingTestLanguagePackage.SIMPLE_TYPE_REF__RAW_TYPE:
        return getRawType();
      case BacktrackingTestLanguagePackage.SIMPLE_TYPE_REF__ACTUAL_ARGUMENTS_LIST:
