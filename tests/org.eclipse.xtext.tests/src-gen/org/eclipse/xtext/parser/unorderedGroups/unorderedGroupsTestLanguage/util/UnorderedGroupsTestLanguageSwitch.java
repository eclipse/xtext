 ...
 * @generated
 */
public class UnorderedGroupsTestLanguageSwitch<T> extends Switch<T>
{
  /**
   ...
   * @generated
   */
  public UnorderedGroupsTestLanguageSwitch()
  {
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case UnorderedGroupsTestLanguagePackage.UNORDERED_SERIALIZATION:
      {
        ...
        T result = caseUnorderedSerialization(unorderedSerialization);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Unordered Serialization</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Unordered Serialization</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseUnorderedSerialization(UnorderedSerialization object)
  {
    return null;
  }
...
} //UnorderedGroupsTestLanguageSwitch
