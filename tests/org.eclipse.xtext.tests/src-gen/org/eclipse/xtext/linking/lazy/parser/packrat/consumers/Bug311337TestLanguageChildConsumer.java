...
public final class Bug311337TestLanguageChildConsumer extends NonTerminalConsumer {
	...
	protected class CrossReference$7$Consumer extends ElementConsumer<CrossReference> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(idConsumer, "link", false, false, getElement(), getRuleCall$9$Delimiter(), optional);
		}
	}
	...
	public Bug311337TestLanguageChildConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public void setRule(ChildElements rule) {
		...
		keyword$2$Consumer = new Keyword$2$Consumer(rule.getChildKeyword_0());
		...
		assignment$6$Consumer = new Assignment$6$Consumer(rule.getLinkAssignment_3());
		crossReference$7$Consumer = new CrossReference$7$Consumer(rule.getLinkDefinitionCrossReference_3_0());
	}
