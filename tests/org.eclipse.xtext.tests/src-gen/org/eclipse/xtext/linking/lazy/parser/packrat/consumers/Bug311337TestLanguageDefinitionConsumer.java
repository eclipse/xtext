...
import org.eclipse.xtext.linking.lazy.services.Bug311337TestLanguageGrammarAccess.DefinitionElements;

@SuppressWarnings("all")
public final class Bug311337TestLanguageDefinitionConsumer extends NonTerminalConsumer {

	private DefinitionElements rule;	
	...
	protected class RuleCall$7$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeNonTerminal(childConsumer, "child", true, false, false, getElement(), optional);
		}
	}
	...
	protected class RuleCall$9$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeNonTerminal(referenceConsumer, "ref", true, false, false, getElement(), optional);
		}
	}

	public Bug311337TestLanguageDefinitionConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public DefinitionElements getRule() {
		return rule;
	}
	
	public void setRule(DefinitionElements rule) {
		this.rule = rule;
		
		group$1$Consumer = new Group$1$Consumer(rule.getGroup());
		keyword$2$Consumer = new Keyword$2$Consumer(rule.getDefKeyword_0());
		...
		assignment$6$Consumer = new Assignment$6$Consumer(rule.getChildAssignment_3());
		ruleCall$7$Consumer = new RuleCall$7$Consumer(rule.getChildChildParserRuleCall_3_0());
		assignment$8$Consumer = new Assignment$8$Consumer(rule.getRefAssignment_4());
		ruleCall$9$Consumer = new RuleCall$9$Consumer(rule.getRefReferenceParserRuleCall_4_0());
	}
