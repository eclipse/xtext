...
public class AbstractBug313089TestLanguageSyntacticSequencer extends AbstractSyntacticSequencer {

	protected Bug313089TestLanguageGrammarAccess grammarAccess;
	
	@Inject
	protected void init(IGrammarAccess access) {
		grammarAccess = (Bug313089TestLanguageGrammarAccess) access;
	}
