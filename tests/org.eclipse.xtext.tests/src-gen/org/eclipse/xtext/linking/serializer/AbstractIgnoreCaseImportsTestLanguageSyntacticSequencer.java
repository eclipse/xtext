...
public class AbstractIgnoreCaseImportsTestLanguageSyntacticSequencer extends AbstractSyntacticSequencer {

	protected IgnoreCaseImportsTestLanguageGrammarAccess grammarAccess;
	
	@Inject
	protected void init(IGrammarAccess access) {
		grammarAccess = (IgnoreCaseImportsTestLanguageGrammarAccess) access;
	}
