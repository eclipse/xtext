...
public final class Bug287988TestLanguageCallMe2Consumer extends NonTerminalConsumer {
	...
	public Bug287988TestLanguageCallMe2Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public CallMe2Elements getRule() {
		return rule;
	}
	
	public void setRule(CallMe2Elements rule) {
		this.rule = rule;
