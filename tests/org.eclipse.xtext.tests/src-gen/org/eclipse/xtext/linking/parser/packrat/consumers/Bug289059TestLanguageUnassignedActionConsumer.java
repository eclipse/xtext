...
public final class Bug289059TestLanguageUnassignedActionConsumer extends NonTerminalConsumer {
	...
	public Bug289059TestLanguageUnassignedActionConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public UnassignedActionElements getRule() {
		return rule;
	}
	
	public void setRule(UnassignedActionElements rule) {
		this.rule = rule;
		
		group$1$Consumer = new Group$1$Consumer(rule.getGroup());
		action$2$Consumer = new Action$2$Consumer(rule.getUnassignedActionAction_0());
		keyword$4$Consumer = new Keyword$4$Consumer(rule.getEnabledKeyword_1());
	}
