...
public class IgnoreCaseNamespacesTestLanguageParser extends org.eclipse.xtext.parser.antlr.AbstractAntlrParser {
	...
	protected IParseResult parse(String ruleName, CharStream in) {
		...
		org.eclipse.xtext.linking.parser.antlr.internal.InternalIgnoreCaseNamespacesTestLanguageParser parser = createParser(tokenStream);
	...
	protected org.eclipse.xtext.linking.parser.antlr.internal.InternalIgnoreCaseNamespacesTestLanguageParser createParser(XtextTokenStream stream) {
		return new org.eclipse.xtext.linking.parser.antlr.internal.InternalIgnoreCaseNamespacesTestLanguageParser(stream, getElementFactory(), getGrammarAccess());
	}
