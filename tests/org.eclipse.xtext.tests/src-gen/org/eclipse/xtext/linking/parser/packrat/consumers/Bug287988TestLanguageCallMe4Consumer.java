...
import org.eclipse.xtext.linking.services.Bug287988TestLanguageGrammarAccess.CallMe4Elements;

@SuppressWarnings("all")
public final class Bug287988TestLanguageCallMe4Consumer extends NonTerminalConsumer {

	private CallMe4Elements rule;	
	...
	public Bug287988TestLanguageCallMe4Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public CallMe4Elements getRule() {
		return rule;
	}
	
	public void setRule(CallMe4Elements rule) {
		this.rule = rule;
