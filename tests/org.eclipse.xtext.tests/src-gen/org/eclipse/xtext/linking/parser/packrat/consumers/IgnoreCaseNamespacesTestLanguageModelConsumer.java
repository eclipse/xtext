...
import org.eclipse.xtext.linking.services.IgnoreCaseNamespacesTestLanguageGrammarAccess.ModelElements;

@SuppressWarnings("all")
public final class IgnoreCaseNamespacesTestLanguageModelConsumer extends NonTerminalConsumer {
	...
	public IgnoreCaseNamespacesTestLanguageModelConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public void setRule(ModelElements rule) {
		...
		ruleCall$5$Consumer = new RuleCall$5$Consumer(rule.getElementsElementParserRuleCall_1_0());
	}
