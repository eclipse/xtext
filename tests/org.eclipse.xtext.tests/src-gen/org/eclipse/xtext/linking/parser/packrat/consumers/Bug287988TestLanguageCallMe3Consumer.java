...
public final class Bug287988TestLanguageCallMe3Consumer extends NonTerminalConsumer {
	...
	private INonTerminalConsumer callMe4Consumer;
	...
	protected class RuleCall$4$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeNonTerminal(callMe4Consumer, null, false, false, false, getElement(), optional);
		}
	}

	public Bug287988TestLanguageCallMe3Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public CallMe3Elements getRule() {
		return rule;
	}
	
	public void setRule(CallMe3Elements rule) {
		this.rule = rule;
		
		group$1$Consumer = new Group$1$Consumer(rule.getGroup());
		keyword$2$Consumer = new Keyword$2$Consumer(rule.getCallKeyword_0());
		keyword$3$Consumer = new Keyword$3$Consumer(rule.getMeKeyword_1());
		ruleCall$4$Consumer = new RuleCall$4$Consumer(rule.getCallMe4ParserRuleCall_2());
	}
	...
	public void setCallMe4Consumer(INonTerminalConsumer callMe4Consumer) {
		this.callMe4Consumer = callMe4Consumer;
	}
