...
public final class IgnoreCaseNamespacesTestLanguageImportConsumer extends NonTerminalConsumer {
	...
	protected class RuleCall$2$Consumer extends ElementConsumer<RuleCall> {
		...
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(stringConsumer, "importedNamespace", false, false, getElement(), getRuleCall$2$Delimiter(), optional);
		}
	}

	public IgnoreCaseNamespacesTestLanguageImportConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public void setRule(ImportElements rule) {
		...
		assignment$1$Consumer = new Assignment$1$Consumer(rule.getImportedNamespaceAssignment());
		ruleCall$2$Consumer = new RuleCall$2$Consumer(rule.getImportedNamespaceSTRINGTerminalRuleCall_0());
	}
