...
public class IgnoreCaseImportsTestLanguageParser extends org.eclipse.xtext.parser.antlr.AbstractAntlrParser {
	...
	protected IParseResult parse(String ruleName, ANTLRInputStream in) {
		...
		org.eclipse.xtext.linking.parser.antlr.internal.InternalIgnoreCaseImportsTestLanguageParser parser = createParser(tokenStream);
	...
	protected org.eclipse.xtext.linking.parser.antlr.internal.InternalIgnoreCaseImportsTestLanguageParser createParser(XtextTokenStream stream) {
		return new org.eclipse.xtext.linking.parser.antlr.internal.InternalIgnoreCaseImportsTestLanguageParser(stream, getElementFactory(), getGrammarAccess());
	}
