...
protected class Import_ImportedNamespaceAssignment extends AssignmentToken  {
	...
	public Import_ImportedNamespaceAssignment(AbstractToken parent, AbstractToken next, int no, IInstanceDescription current) {
		super(parent, next, no, current);
	}
	...
	protected IInstanceDescription tryConsumeVal() {
		...
		if(valueSerializer.isValid(obj.getDelegate(), grammarAccess.getImportAccess().getImportedNamespaceSTRINGTerminalRuleCall_0(), value, null)) {
