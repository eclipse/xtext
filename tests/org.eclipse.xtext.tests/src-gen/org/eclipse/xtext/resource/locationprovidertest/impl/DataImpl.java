...
public class DataImpl extends MinimalEObjectImpl.Container implements Data
{
  ...
  {
    return LocationprovidertestPackage.Literals.DATA;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LocationprovidertestPackage.DATA__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case LocationprovidertestPackage.DATA__NAME:
        return getName();
    }
