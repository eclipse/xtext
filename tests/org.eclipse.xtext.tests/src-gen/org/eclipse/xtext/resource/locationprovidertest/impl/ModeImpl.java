...
public class ModeImpl extends MinimalEObjectImpl.Container implements Mode
{
  ...
  {
    return LocationprovidertestPackage.Literals.MODE;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, LocationprovidertestPackage.MODE__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case LocationprovidertestPackage.MODE__NAME:
        return getName();
    }
