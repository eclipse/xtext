...
public class AbstractFlatResourceSetBasedAllContainersStateTestLanguageSyntacticSequencer extends AbstractSyntacticSequencer {

	protected FlatResourceSetBasedAllContainersStateTestLanguageGrammarAccess grammarAccess;
	
	@Inject
	protected void init(IGrammarAccess access) {
		grammarAccess = (FlatResourceSetBasedAllContainersStateTestLanguageGrammarAccess) access;
	}
