...
public class AbstractLocationProviderTestLanguageSyntacticSequencer extends AbstractSyntacticSequencer {

	protected LocationProviderTestLanguageGrammarAccess grammarAccess;
	
	@Inject
	protected void init(IGrammarAccess access) {
		grammarAccess = (LocationProviderTestLanguageGrammarAccess) access;
	}
