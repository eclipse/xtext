...
public class AbstractLiveContainerTestLanguageSyntacticSequencer extends AbstractSyntacticSequencer {

	protected LiveContainerTestLanguageGrammarAccess grammarAccess;
	
	@Inject
	protected void init(IGrammarAccess access) {
		grammarAccess = (LiveContainerTestLanguageGrammarAccess) access;
	}
