...
public class MultiValueFeatureTestLanguageStandaloneSetupGenerated implements ISetup, ISetupExtension {
	...
	public List<String> getFileExtensions() {
		return Arrays.asList("multivaluefeaturetestlanguage");
	}
