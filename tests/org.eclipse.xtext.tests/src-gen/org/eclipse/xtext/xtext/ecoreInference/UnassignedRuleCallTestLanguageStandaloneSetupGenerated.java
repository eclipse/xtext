...
public class UnassignedRuleCallTestLanguageStandaloneSetupGenerated implements ISetup, ISetupExtension {
	...
	public List<String> getFileExtensions() {
		return Arrays.asList("unassignedrulecalltestlanguage");
	}
