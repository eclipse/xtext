...
public final class UnassignedTextTestLanguageCommonTerminalsRuleConsumer extends NonTerminalConsumer {
	...
	protected class RuleCall$7$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(idConsumer, "val", false, false, getElement(), getRuleCall$7$Delimiter(), optional);
		}
	}

	public UnassignedTextTestLanguageCommonTerminalsRuleConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public CommonTerminalsRuleElements getRule() {
		return rule;
	}
	
	public void setRule(CommonTerminalsRuleElements rule) {
		this.rule = rule;
		
		group$1$Consumer = new Group$1$Consumer(rule.getGroup());
		keyword$2$Consumer = new Keyword$2$Consumer(rule.getTerminalsKeyword_0());
		ruleCall$3$Consumer = new RuleCall$3$Consumer(rule.getIDTerminalRuleCall_1());
		...
		assignment$6$Consumer = new Assignment$6$Consumer(rule.getValAssignment_4());
		ruleCall$7$Consumer = new RuleCall$7$Consumer(rule.getValIDTerminalRuleCall_4_0());
	}
