...
protected class Element_Group extends GroupToken {
	...
	public IInstanceDescription tryConsume() {
		if(current.getDelegate().eClass() == grammarAccess.getElementAccess().getElementAction_0().getType().getClassifier())
...
protected class Element_NameAssignment_3 extends AssignmentToken  {
	...
	protected IInstanceDescription tryConsumeVal() {
		...
		if(valueSerializer.isValid(obj.getDelegate(), grammarAccess.getElementAccess().getNameIDTerminalRuleCall_3_0(), value, null)) {
