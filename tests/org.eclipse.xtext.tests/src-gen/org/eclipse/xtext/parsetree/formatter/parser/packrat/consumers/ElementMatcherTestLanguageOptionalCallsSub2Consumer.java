...
import org.eclipse.xtext.parsetree.formatter.services.ElementMatcherTestLanguageGrammarAccess.OptionalCallsSub2Elements;

@SuppressWarnings("all")
public final class ElementMatcherTestLanguageOptionalCallsSub2Consumer extends NonTerminalConsumer {

	private OptionalCallsSub2Elements rule;	
	...
	public ElementMatcherTestLanguageOptionalCallsSub2Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public OptionalCallsSub2Elements getRule() {
		return rule;
	}
	
	public void setRule(OptionalCallsSub2Elements rule) {
		this.rule = rule;
		
		group$1$Consumer = new Group$1$Consumer(rule.getGroup());
		keyword$2$Consumer = new Keyword$2$Consumer(rule.getSub2Keyword_0());
