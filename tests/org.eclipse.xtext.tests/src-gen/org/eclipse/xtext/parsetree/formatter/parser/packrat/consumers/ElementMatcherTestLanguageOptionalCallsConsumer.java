...
public final class ElementMatcherTestLanguageOptionalCallsConsumer extends NonTerminalConsumer {

	private OptionalCallsElements rule;	

	private ITerminalConsumer idConsumer;

	private INonTerminalConsumer optionalCallsSub1Consumer;
	...
	protected class RuleCall$6$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeNonTerminal(optionalCallsSub1Consumer, "opt1", false, false, false, getElement(), optional);
		}
	}
	...
	public ElementMatcherTestLanguageOptionalCallsConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public OptionalCallsElements getRule() {
		return rule;
	}
	
	public void setRule(OptionalCallsElements rule) {
		this.rule = rule;
		
		group$1$Consumer = new Group$1$Consumer(rule.getGroup());
		keyword$2$Consumer = new Keyword$2$Consumer(rule.getNumberSignDigitThreeKeyword_0());
		action$3$Consumer = new Action$3$Consumer(rule.getOptionalCallsAction_1());
		assignment$5$Consumer = new Assignment$5$Consumer(rule.getOpt1Assignment_2());
		ruleCall$6$Consumer = new RuleCall$6$Consumer(rule.getOpt1OptionalCallsSub1ParserRuleCall_2_0());
	...
	public void setOptionalCallsSub1Consumer(INonTerminalConsumer optionalCallsSub1Consumer) {
		this.optionalCallsSub1Consumer = optionalCallsSub1Consumer;
	}
