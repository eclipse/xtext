...
import org.eclipse.xtext.parsetree.formatter.services.FormatterTestLanguageGrammarAccess.Enum1Elements;

@SuppressWarnings("all")
public final class FormatterTestLanguageEnum1Consumer extends NonTerminalConsumer {

	private Enum1Elements rule;	
	...
	public FormatterTestLanguageEnum1Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Enum1Elements getRule() {
		return rule;
	}
	
	public void setRule(Enum1Elements rule) {
		this.rule = rule;
		
		alternatives$1$Consumer = new Alternatives$1$Consumer(rule.getAlternatives());
		enumLiteralDeclaration$2$Consumer = new EnumLiteralDeclaration$2$Consumer(rule.getLit1EnumLiteralDeclaration_0());
		enumLiteralDeclaration$4$Consumer = new EnumLiteralDeclaration$4$Consumer(rule.getLit2EnumLiteralDeclaration_1());
		enumLiteralDeclaration$6$Consumer = new EnumLiteralDeclaration$6$Consumer(rule.getLit3EnumLiteralDeclaration_2());
	}
