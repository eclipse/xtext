...
import org.eclipse.xtext.parsetree.formatter.services.ElementMatcherTestLanguageGrammarAccess.OptionalCallsSub3Elements;

@SuppressWarnings("all")
public final class ElementMatcherTestLanguageOptionalCallsSub3Consumer extends NonTerminalConsumer {

	private OptionalCallsSub3Elements rule;	
	...
	public ElementMatcherTestLanguageOptionalCallsSub3Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public OptionalCallsSub3Elements getRule() {
		return rule;
	}
	
	public void setRule(OptionalCallsSub3Elements rule) {
		this.rule = rule;
		
		group$1$Consumer = new Group$1$Consumer(rule.getGroup());
		keyword$2$Consumer = new Keyword$2$Consumer(rule.getSub3Keyword_0());
