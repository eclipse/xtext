...
import org.eclipse.xtext.parsetree.formatter.services.ElementMatcherTestLanguageGrammarAccess.RuleCallsAss1Elements;

@SuppressWarnings("all")
public final class ElementMatcherTestLanguageRuleCallsAss1Consumer extends NonTerminalConsumer {

	private RuleCallsAss1Elements rule;	
	...
	public ElementMatcherTestLanguageRuleCallsAss1Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public RuleCallsAss1Elements getRule() {
		return rule;
	}
	
	public void setRule(RuleCallsAss1Elements rule) {
		this.rule = rule;
		
		group$1$Consumer = new Group$1$Consumer(rule.getGroup());
		keyword$2$Consumer = new Keyword$2$Consumer(rule.getAss1Keyword_0());
