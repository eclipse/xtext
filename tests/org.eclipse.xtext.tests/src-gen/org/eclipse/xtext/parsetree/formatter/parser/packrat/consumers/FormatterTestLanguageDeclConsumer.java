...
import org.eclipse.xtext.parsetree.formatter.services.FormatterTestLanguageGrammarAccess.DeclElements;

@SuppressWarnings("all")
public final class FormatterTestLanguageDeclConsumer extends NonTerminalConsumer {

	private DeclElements rule;	
	...
	public FormatterTestLanguageDeclConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public DeclElements getRule() {
		return rule;
	}
	
	public void setRule(DeclElements rule) {
		this.rule = rule;
