...
public final class FormatterTestLanguageTestIndentationConsumer extends NonTerminalConsumer {
	...
	protected class Keyword$11$Consumer extends ElementConsumer<Keyword> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeKeyword(getElement(), "semi", false, true, getKeyword$11$Delimiter(), optional);
		}
	}
	...
	public void setRule(TestIndentationElements rule) {
		...
		assignment$10$Consumer = new Assignment$10$Consumer(rule.getSemiAssignment_4());
		keyword$11$Consumer = new Keyword$11$Consumer(rule.getSemiSemicolonKeyword_4_0());
	}
