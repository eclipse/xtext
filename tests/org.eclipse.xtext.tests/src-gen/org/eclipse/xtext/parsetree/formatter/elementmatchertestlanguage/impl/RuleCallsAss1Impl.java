 ...
 * @generated
 */
public class RuleCallsAss1Impl extends MinimalEObjectImpl.Container implements RuleCallsAss1
{
  /**
  ...
  {
    return ElementmatchertestlanguagePackage.Literals.RULE_CALLS_ASS1;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ElementmatchertestlanguagePackage.RULE_CALLS_ASS1__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ElementmatchertestlanguagePackage.RULE_CALLS_ASS1__NAME:
        return getName();
    }
