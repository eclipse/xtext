...
public final class ElementMatcherTestLanguageSimpleConsumer extends NonTerminalConsumer {

	private SimpleElements rule;	
	...
	protected class RuleCall$8$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(idConsumer, "optional", false, false, getElement(), getRuleCall$8$Delimiter(), optional);
		}
	}
	...
	protected class RuleCall$10$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeNonTerminal(fqnConsumer, "datatype", false, true, false, getElement(), optional);
		}
	}

	public ElementMatcherTestLanguageSimpleConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public SimpleElements getRule() {
		return rule;
	}
	
	public void setRule(SimpleElements rule) {
		this.rule = rule;
		...
		assignment$7$Consumer = new Assignment$7$Consumer(rule.getOptionalAssignment_2_1());
		ruleCall$8$Consumer = new RuleCall$8$Consumer(rule.getOptionalIDTerminalRuleCall_2_1_0());
		assignment$9$Consumer = new Assignment$9$Consumer(rule.getDatatypeAssignment_3());
		ruleCall$10$Consumer = new RuleCall$10$Consumer(rule.getDatatypeFQNParserRuleCall_3_0());
	}
