...
public final class ElementMatcherTestLanguageLoopConsumer extends NonTerminalConsumer {

	private LoopElements rule;	
	...
	protected class RuleCall$4$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(idConsumer, "names", true, false, getElement(), getRuleCall$4$Delimiter(), optional);
		}
	}
	...
	protected class RuleCall$8$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(idConsumer, "gr", true, false, getElement(), getRuleCall$8$Delimiter(), optional);
		}
	}
	...
	protected class RuleCall$11$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(intConsumer, "ints", true, false, getElement(), getRuleCall$11$Delimiter(), optional);
		}
	}
	...
	protected class RuleCall$13$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(stringConsumer, "strings", true, false, getElement(), getRuleCall$13$Delimiter(), optional);
		}
	}

	public ElementMatcherTestLanguageLoopConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public LoopElements getRule() {
		return rule;
	}
	
	public void setRule(LoopElements rule) {
		this.rule = rule;
		
		group$1$Consumer = new Group$1$Consumer(rule.getGroup());
		keyword$2$Consumer = new Keyword$2$Consumer(rule.getNumberSignDigitFiveKeyword_0());
		assignment$3$Consumer = new Assignment$3$Consumer(rule.getNamesAssignment_1());
		ruleCall$4$Consumer = new RuleCall$4$Consumer(rule.getNamesIDTerminalRuleCall_1_0());
		group$5$Consumer = new Group$5$Consumer(rule.getGroup_2());
		keyword$6$Consumer = new Keyword$6$Consumer(rule.getGrKeyword_2_0());
		assignment$7$Consumer = new Assignment$7$Consumer(rule.getGrAssignment_2_1());
		ruleCall$8$Consumer = new RuleCall$8$Consumer(rule.getGrIDTerminalRuleCall_2_1_0());
		alternatives$9$Consumer = new Alternatives$9$Consumer(rule.getAlternatives_3());
		assignment$10$Consumer = new Assignment$10$Consumer(rule.getIntsAssignment_3_0());
		ruleCall$11$Consumer = new RuleCall$11$Consumer(rule.getIntsINTTerminalRuleCall_3_0_0());
		assignment$12$Consumer = new Assignment$12$Consumer(rule.getStringsAssignment_3_1());
		ruleCall$13$Consumer = new RuleCall$13$Consumer(rule.getStringsSTRINGTerminalRuleCall_3_1_0());
	}
