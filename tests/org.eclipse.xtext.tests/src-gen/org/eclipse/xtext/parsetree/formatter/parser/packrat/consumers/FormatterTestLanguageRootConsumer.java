...
public final class FormatterTestLanguageRootConsumer extends NonTerminalConsumer {
	...
	public void setRule(RootElements rule) {
		...
		ruleCall$4$Consumer = new RuleCall$4$Consumer(rule.getTestLinewrapParserRuleCall_1_0());
		ruleCall$5$Consumer = new RuleCall$5$Consumer(rule.getTestIndentationParserRuleCall_1_1());
	}
