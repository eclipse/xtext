...
import org.eclipse.xtext.parsetree.formatter.services.ElementMatcherTestLanguageGrammarAccess.RuleCallsAss2Elements;

@SuppressWarnings("all")
public final class ElementMatcherTestLanguageRuleCallsAss2Consumer extends NonTerminalConsumer {

	private RuleCallsAss2Elements rule;	
	...
	public ElementMatcherTestLanguageRuleCallsAss2Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public RuleCallsAss2Elements getRule() {
		return rule;
	}
	
	public void setRule(RuleCallsAss2Elements rule) {
		this.rule = rule;
		
		group$1$Consumer = new Group$1$Consumer(rule.getGroup());
		keyword$2$Consumer = new Keyword$2$Consumer(rule.getAss2Keyword_0());
