 ...
 * <ul>
 *   <li>{@link org.eclipse.xtext.parsetree.formatter.elementmatchertestlanguage.impl.ValueImpl#getVal <em>Val</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ValueImpl extends ExpressionImpl implements Value
{
  ...
  {
    return ElementmatchertestlanguagePackage.Literals.VALUE;
  }
  ...
  public void setVal(int newVal)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ElementmatchertestlanguagePackage.VALUE__VAL, oldVal, val));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ElementmatchertestlanguagePackage.VALUE__VAL:
        return getVal();
    }
