...
import org.eclipse.xtext.parsetree.reconstr.services.HiddenTokensMergerTestLanguageGrammarAccess.AppendToFileEndItemElements;

@SuppressWarnings("all")
public final class HiddenTokensMergerTestLanguageAppendToFileEndItemConsumer extends NonTerminalConsumer {

	private AppendToFileEndItemElements rule;	
	...
	public HiddenTokensMergerTestLanguageAppendToFileEndItemConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public AppendToFileEndItemElements getRule() {
		return rule;
	}
	
	public void setRule(AppendToFileEndItemElements rule) {
		this.rule = rule;
		...
		keyword$5$Consumer = new Keyword$5$Consumer(rule.getEndclassKeyword_2());
	}
