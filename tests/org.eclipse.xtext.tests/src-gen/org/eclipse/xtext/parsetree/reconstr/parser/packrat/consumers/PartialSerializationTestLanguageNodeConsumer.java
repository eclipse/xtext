...
public final class PartialSerializationTestLanguageNodeConsumer extends NonTerminalConsumer {
	...
	public PartialSerializationTestLanguageNodeConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public void setRule(NodeElements rule) {
		...
		keyword$2$Consumer = new Keyword$2$Consumer(rule.getNodeKeyword_0());
		...
		assignment$7$Consumer = new Assignment$7$Consumer(rule.getChildrenAssignment_2_1());
		ruleCall$8$Consumer = new RuleCall$8$Consumer(rule.getChildrenNodeParserRuleCall_2_1_0());
		keyword$9$Consumer = new Keyword$9$Consumer(rule.getRightParenthesisKeyword_2_2());
	}
