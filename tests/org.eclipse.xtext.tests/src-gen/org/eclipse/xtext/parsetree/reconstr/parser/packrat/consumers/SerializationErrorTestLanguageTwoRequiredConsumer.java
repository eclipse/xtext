...
public final class SerializationErrorTestLanguageTwoRequiredConsumer extends NonTerminalConsumer {
	...
	protected class RuleCall$4$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(idConsumer, "one", false, false, getElement(), getRuleCall$4$Delimiter(), optional);
		}
	}
	...
	protected class RuleCall$6$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(idConsumer, "two", false, false, getElement(), getRuleCall$6$Delimiter(), optional);
		}
	}

	public SerializationErrorTestLanguageTwoRequiredConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public TwoRequiredElements getRule() {
		return rule;
	}
	
	public void setRule(TwoRequiredElements rule) {
		this.rule = rule;
		
		group$1$Consumer = new Group$1$Consumer(rule.getGroup());
		keyword$2$Consumer = new Keyword$2$Consumer(rule.getTworequiredKeyword_0());
		assignment$3$Consumer = new Assignment$3$Consumer(rule.getOneAssignment_1());
		ruleCall$4$Consumer = new RuleCall$4$Consumer(rule.getOneIDTerminalRuleCall_1_0());
		assignment$5$Consumer = new Assignment$5$Consumer(rule.getTwoAssignment_2());
		ruleCall$6$Consumer = new RuleCall$6$Consumer(rule.getTwoIDTerminalRuleCall_2_0());
	}
