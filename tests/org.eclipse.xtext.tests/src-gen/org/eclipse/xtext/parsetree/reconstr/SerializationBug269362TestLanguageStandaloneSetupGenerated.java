...
public class SerializationBug269362TestLanguageStandaloneSetupGenerated implements ISetup, ISetupExtension {
	...
	public List<String> getFileExtensions() {
		return Arrays.asList("serializationbug269362testlanguage");
	}
