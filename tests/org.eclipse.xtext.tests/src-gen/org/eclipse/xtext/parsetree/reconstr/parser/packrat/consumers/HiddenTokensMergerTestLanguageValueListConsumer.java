...
import org.eclipse.xtext.parsetree.reconstr.services.HiddenTokensMergerTestLanguageGrammarAccess.ValueListElements;

@SuppressWarnings("all")
public final class HiddenTokensMergerTestLanguageValueListConsumer extends NonTerminalConsumer {

	private ValueListElements rule;	
	...
	public HiddenTokensMergerTestLanguageValueListConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public ValueListElements getRule() {
		return rule;
	}
	
	public void setRule(ValueListElements rule) {
		this.rule = rule;
		
		group$1$Consumer = new Group$1$Consumer(rule.getGroup());
		keyword$2$Consumer = new Keyword$2$Consumer(rule.getNumberSignDigitFourKeyword_0());
		assignment$3$Consumer = new Assignment$3$Consumer(rule.getIdsAssignment_1());
		ruleCall$4$Consumer = new RuleCall$4$Consumer(rule.getIdsFQNParserRuleCall_1_0());
	}
