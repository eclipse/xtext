 ...
 * @generated
 */
public class TrickyCImpl extends MinimalEObjectImpl.Container implements TrickyC
{
  /**
  ...
  {
    return ComplexrewritetestPackage.Literals.TRICKY_C;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, ComplexrewritetestPackage.TRICKY_C__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case ComplexrewritetestPackage.TRICKY_C__NAME:
        return getName();
    }
