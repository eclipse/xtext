...
public class HiddenTokensMergerTestLanguageStandaloneSetupGenerated implements ISetup, ISetupExtension {
	...
	public List<String> getFileExtensions() {
		return Arrays.asList("hiddentokensmergertestlanguage");
	}
