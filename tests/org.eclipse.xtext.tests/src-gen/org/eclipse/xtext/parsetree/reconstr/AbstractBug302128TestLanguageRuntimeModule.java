...
public abstract class AbstractBug302128TestLanguageRuntimeModule extends org.eclipse.xtext.service.DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		properties = tryBindProperties(binder, "org/eclipse/xtext/parsetree/reconstr/Bug302128TestLanguage.properties");
		super.configure(binder);
	}
	
	public void configureLanguageName(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance("org.eclipse.xtext.parsetree.reconstr.Bug302128TestLanguage");
	}
	...
	public org.eclipse.xtext.parsetree.reconstr.bug302128.Bug302128Package bindBug302128PackageToInstance() {
		return org.eclipse.xtext.parsetree.reconstr.bug302128.Bug302128Package.eINSTANCE;
	}

	// contributed by org.eclipse.xtext.generator.ecore.EMFGeneratorFragment
	public org.eclipse.xtext.parsetree.reconstr.bug302128.Bug302128Factory bindBug302128FactoryToInstance() {
		return org.eclipse.xtext.parsetree.reconstr.bug302128.Bug302128Factory.eINSTANCE;
	}
