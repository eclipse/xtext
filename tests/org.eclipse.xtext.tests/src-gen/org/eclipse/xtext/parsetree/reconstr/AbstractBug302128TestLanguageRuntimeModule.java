...
public abstract class AbstractBug302128TestLanguageRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		...
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance(
			"org.eclipse.xtext.parsetree.reconstr.Bug302128TestLanguage");
	...
	public Class<? extends org.eclipse.xtext.parser.packrat.IPackratParser> bindIPackratParser() {
		return org.eclipse.xtext.parsetree.reconstr.parser.packrat.Bug302128TestLanguagePackratParser.class;
	}
