...
import org.eclipse.xtext.parsetree.reconstr.services.HiddenTokensMergerTestLanguageGrammarAccess.CommentableItemElements;

public final class HiddenTokensMergerTestLanguageCommentableItemConsumer extends NonTerminalConsumer {

	private CommentableItemElements rule;	
	...
	protected class RuleCall$4$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(idConsumer, "id", false, false, getElement(), getRuleCall$4$Delimiter(), optional);
		}
	}

	public HiddenTokensMergerTestLanguageCommentableItemConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public CommentableItemElements getRule() {
		return rule;
	}
	
	public void setRule(CommentableItemElements rule) {
		this.rule = rule;
		
		group$1$Consumer = new Group$1$Consumer(rule.getGroup());
		keyword$2$Consumer = new Keyword$2$Consumer(rule.getItemKeyword_0());
