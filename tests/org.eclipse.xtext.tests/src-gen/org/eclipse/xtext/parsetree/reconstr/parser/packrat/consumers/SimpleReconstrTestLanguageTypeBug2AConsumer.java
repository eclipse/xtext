...
import org.eclipse.xtext.parsetree.reconstr.services.SimpleReconstrTestLanguageGrammarAccess.TypeBug2AElements;

@SuppressWarnings("all")
public final class SimpleReconstrTestLanguageTypeBug2AConsumer extends NonTerminalConsumer {

	private TypeBug2AElements rule;	
	...
	public SimpleReconstrTestLanguageTypeBug2AConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public TypeBug2AElements getRule() {
		return rule;
	}
	
	public void setRule(TypeBug2AElements rule) {
		this.rule = rule;
		
		group$1$Consumer = new Group$1$Consumer(rule.getGroup());
		action$2$Consumer = new Action$2$Consumer(rule.getTypeBug2AAction_0());
