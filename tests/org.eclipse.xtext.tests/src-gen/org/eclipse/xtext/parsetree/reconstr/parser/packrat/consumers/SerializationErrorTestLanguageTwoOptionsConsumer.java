...
import org.eclipse.xtext.parsetree.reconstr.services.SerializationErrorTestLanguageGrammarAccess.TwoOptionsElements;

@SuppressWarnings("all")
public final class SerializationErrorTestLanguageTwoOptionsConsumer extends NonTerminalConsumer {

	private TwoOptionsElements rule;	
	...
	protected class RuleCall$7$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(idConsumer, "one", false, false, getElement(), getRuleCall$7$Delimiter(), optional);
		}
	}
	...
	protected class RuleCall$11$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(idConsumer, "two", false, false, getElement(), getRuleCall$11$Delimiter(), optional);
		}
	}

	public SerializationErrorTestLanguageTwoOptionsConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public TwoOptionsElements getRule() {
		return rule;
	}
	
	public void setRule(TwoOptionsElements rule) {
		this.rule = rule;
		
		group$1$Consumer = new Group$1$Consumer(rule.getGroup());
		keyword$2$Consumer = new Keyword$2$Consumer(rule.getTwooptionsKeyword_0());
		...
		keyword$5$Consumer = new Keyword$5$Consumer(rule.getOneKeyword_1_0_0());
		assignment$6$Consumer = new Assignment$6$Consumer(rule.getOneAssignment_1_0_1());
		ruleCall$7$Consumer = new RuleCall$7$Consumer(rule.getOneIDTerminalRuleCall_1_0_1_0());
		group$8$Consumer = new Group$8$Consumer(rule.getGroup_1_1());
		keyword$9$Consumer = new Keyword$9$Consumer(rule.getTwoKeyword_1_1_0());
		assignment$10$Consumer = new Assignment$10$Consumer(rule.getTwoAssignment_1_1_1());
		ruleCall$11$Consumer = new RuleCall$11$Consumer(rule.getTwoIDTerminalRuleCall_1_1_1_0());
	}
