...
import org.eclipse.xtext.parsetree.reconstr.services.SimpleReconstrTestLanguageGrammarAccess.TypeBug1AElements;

@SuppressWarnings("all")
public final class SimpleReconstrTestLanguageTypeBug1AConsumer extends NonTerminalConsumer {

	private TypeBug1AElements rule;	
	...
	public SimpleReconstrTestLanguageTypeBug1AConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public TypeBug1AElements getRule() {
		return rule;
	}
	
	public void setRule(TypeBug1AElements rule) {
		this.rule = rule;
		
		group$1$Consumer = new Group$1$Consumer(rule.getGroup());
		action$2$Consumer = new Action$2$Consumer(rule.getTypeBug1AAction_0());
		keyword$4$Consumer = new Keyword$4$Consumer(rule.getKaKeyword_1());
