 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.xtext.parsetree.reconstr.simplerewritetest.impl.SpareImpl#getId <em>Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SpareImpl extends ExpressionImpl implements Spare
{
  /**
  ...
  {
    return SimplerewritetestPackage.Literals.SPARE;
  }
  ...
  public EList<String> getId()
  {
    if (id == null)
    {
      id = new EDataTypeEList<String>(String.class, this, SimplerewritetestPackage.SPARE__ID);
    }
    return id;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SimplerewritetestPackage.SPARE__ID:
        return getId();
    }
