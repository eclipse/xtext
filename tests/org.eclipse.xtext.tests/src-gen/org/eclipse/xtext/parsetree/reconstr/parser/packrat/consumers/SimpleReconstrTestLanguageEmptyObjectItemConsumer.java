...
public final class SimpleReconstrTestLanguageEmptyObjectItemConsumer extends NonTerminalConsumer {
	...
	public SimpleReconstrTestLanguageEmptyObjectItemConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public EmptyObjectItemElements getRule() {
		return rule;
	}
	
	public void setRule(EmptyObjectItemElements rule) {
		this.rule = rule;
