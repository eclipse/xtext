...
public abstract class AbstractBug299395TestLanguageRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		...
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance(
			"org.eclipse.xtext.parsetree.reconstr.Bug299395TestLanguage");
		bindProperties(binder);
	}
	
	protected void bindProperties(Binder binder) {
		bindProperties(binder, "org/eclipse/xtext/parsetree/reconstr/Bug299395TestLanguage.properties");
	}
	...
	public Class<? extends org.eclipse.xtext.parser.packrat.IPackratParser> bindIPackratParser() {
		return org.eclipse.xtext.parsetree.reconstr.parser.packrat.Bug299395TestLanguagePackratParser.class;
	}
