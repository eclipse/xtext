...
public final class HiddenTokensMergerTestLanguageRefListConsumer extends NonTerminalConsumer {
	...
	protected class RuleCall$4$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeNonTerminal(refObjConsumer, "objs", true, false, false, getElement(), optional);
		}
	}
	...
	protected class CrossReference$7$Consumer extends ElementConsumer<CrossReference> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeNonTerminal(fqnConsumer, "refs", true, true, false, getElement(), optional);
		}
	}
	...
	public HiddenTokensMergerTestLanguageRefListConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public RefListElements getRule() {
		return rule;
	}
	
	public void setRule(RefListElements rule) {
		this.rule = rule;
		
		group$1$Consumer = new Group$1$Consumer(rule.getGroup());
		keyword$2$Consumer = new Keyword$2$Consumer(rule.getNumberSignDigitFiveKeyword_0());
		assignment$3$Consumer = new Assignment$3$Consumer(rule.getObjsAssignment_1());
		ruleCall$4$Consumer = new RuleCall$4$Consumer(rule.getObjsRefObjParserRuleCall_1_0());
		keyword$5$Consumer = new Keyword$5$Consumer(rule.getRefsKeyword_2());
		assignment$6$Consumer = new Assignment$6$Consumer(rule.getRefsAssignment_3());
		crossReference$7$Consumer = new CrossReference$7$Consumer(rule.getRefsRefObjCrossReference_3_0());
	}
