...
public class PartialSerializationTestLanguageParser extends org.eclipse.xtext.parser.antlr.AbstractAntlrParser {
	...
	protected IParseResult parse(String ruleName, CharStream in) {
		...
		org.eclipse.xtext.parsetree.reconstr.parser.antlr.internal.InternalPartialSerializationTestLanguageParser parser = createParser(tokenStream);
	...
	protected org.eclipse.xtext.parsetree.reconstr.parser.antlr.internal.InternalPartialSerializationTestLanguageParser createParser(XtextTokenStream stream) {
		return new org.eclipse.xtext.parsetree.reconstr.parser.antlr.internal.InternalPartialSerializationTestLanguageParser(stream, getElementFactory(), getGrammarAccess());
	}
