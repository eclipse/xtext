...
public class AtomImpl extends ExpressionImpl implements Atom
{
  ...
  {
    return SimplerewritetestPackage.Literals.ATOM;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SimplerewritetestPackage.ATOM__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SimplerewritetestPackage.ATOM__NAME:
        return getName();
    }
