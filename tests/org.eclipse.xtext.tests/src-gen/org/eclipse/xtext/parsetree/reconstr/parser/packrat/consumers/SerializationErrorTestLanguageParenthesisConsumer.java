...
import org.eclipse.xtext.parsetree.reconstr.services.SerializationErrorTestLanguageGrammarAccess.ParenthesisElements;

@SuppressWarnings("all")
public final class SerializationErrorTestLanguageParenthesisConsumer extends NonTerminalConsumer {

	private ParenthesisElements rule;	
	...
	protected class RuleCall$3$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeNonTerminal(testConsumer, null, false, false, false, getElement(), optional);
		}
	}
	...
	public SerializationErrorTestLanguageParenthesisConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public ParenthesisElements getRule() {
		return rule;
	}
	
	public void setRule(ParenthesisElements rule) {
		this.rule = rule;
		
		group$1$Consumer = new Group$1$Consumer(rule.getGroup());
		keyword$2$Consumer = new Keyword$2$Consumer(rule.getLeftParenthesisKeyword_0());
		ruleCall$3$Consumer = new RuleCall$3$Consumer(rule.getTestParserRuleCall_1());
