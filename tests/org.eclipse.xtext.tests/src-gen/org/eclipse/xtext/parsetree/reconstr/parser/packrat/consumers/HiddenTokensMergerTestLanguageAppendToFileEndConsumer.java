...
public final class HiddenTokensMergerTestLanguageAppendToFileEndConsumer extends NonTerminalConsumer {
	...
	private INonTerminalConsumer appendToFileEndItemConsumer;
	...
	protected class RuleCall$4$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeNonTerminal(appendToFileEndItemConsumer, "items", true, false, false, getElement(), optional);
		}
	}

	public HiddenTokensMergerTestLanguageAppendToFileEndConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public AppendToFileEndElements getRule() {
		return rule;
	}
	
	public void setRule(AppendToFileEndElements rule) {
		this.rule = rule;
		...
		ruleCall$4$Consumer = new RuleCall$4$Consumer(rule.getItemsAppendToFileEndItemParserRuleCall_1_0());
	}
	...
	public void setAppendToFileEndItemConsumer(INonTerminalConsumer appendToFileEndItemConsumer) {
		this.appendToFileEndItemConsumer = appendToFileEndItemConsumer;
	}
