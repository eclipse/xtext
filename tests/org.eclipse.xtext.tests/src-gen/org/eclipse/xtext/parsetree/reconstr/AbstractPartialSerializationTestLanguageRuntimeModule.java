...
public abstract class AbstractPartialSerializationTestLanguageRuntimeModule extends DefaultRuntimeModule {
	...
	public void configure(Binder binder) {
		...
		binder.bind(String.class).annotatedWith(Names.named(Constants.LANGUAGE_NAME)).toInstance(
			"org.eclipse.xtext.parsetree.reconstr.PartialSerializationTestLanguage");
		bindProperties(binder);
	}
	
	protected void bindProperties(Binder binder) {
		bindProperties(binder, "org/eclipse/xtext/parsetree/reconstr/PartialSerializationTestLanguage.properties");
	}
	...
	public Class<? extends org.eclipse.xtext.parser.packrat.IPackratParser> bindIPackratParser() {
		return org.eclipse.xtext.parsetree.reconstr.parser.packrat.PartialSerializationTestLanguagePackratParser.class;
	}
