...
public final class HiddenTokensMergerTestLanguageAction1Sub1Consumer extends NonTerminalConsumer {
	...
	public HiddenTokensMergerTestLanguageAction1Sub1Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public Action1Sub1Elements getRule() {
		return rule;
	}
	
	public void setRule(Action1Sub1Elements rule) {
		this.rule = rule;
		
		group$1$Consumer = new Group$1$Consumer(rule.getGroup());
		action$2$Consumer = new Action$2$Consumer(rule.getAction1SubAction_0());
		keyword$4$Consumer = new Keyword$4$Consumer(rule.getSub1Keyword_1());
	}
