...
public final class SimpleReconstrTestLanguageTypeBug1BConsumer extends NonTerminalConsumer {
	...
	public SimpleReconstrTestLanguageTypeBug1BConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public TypeBug1BElements getRule() {
		return rule;
	}
	
	public void setRule(TypeBug1BElements rule) {
		this.rule = rule;
		
		group$1$Consumer = new Group$1$Consumer(rule.getGroup());
		action$2$Consumer = new Action$2$Consumer(rule.getTypeBug1BAction_0());
