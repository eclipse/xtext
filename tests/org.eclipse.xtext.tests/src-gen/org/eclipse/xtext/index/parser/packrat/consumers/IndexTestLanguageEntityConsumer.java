...
public final class IndexTestLanguageEntityConsumer extends NonTerminalConsumer {
	...
	public IndexTestLanguageEntityConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public void setRule(EntityElements rule) {
		...
		assignment$6$Consumer = new Assignment$6$Consumer(rule.getPropertiesAssignment_3());
		ruleCall$7$Consumer = new RuleCall$7$Consumer(rule.getPropertiesPropertyParserRuleCall_3_0());
