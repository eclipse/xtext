...
public class QualifiedNameTestLanguageSyntacticSequencer extends AbstractSyntacticSequencer {

	protected QualifiedNameTestLanguageGrammarAccess grammarAccess;
	
	@Inject
	protected void init(IGrammarAccess access) {
		grammarAccess = (QualifiedNameTestLanguageGrammarAccess) access;
	}
