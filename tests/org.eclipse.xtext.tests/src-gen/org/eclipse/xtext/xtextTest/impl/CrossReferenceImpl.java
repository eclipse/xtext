 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.xtext.xtextTest.impl.CrossReferenceImpl#getType <em>Type</em>}</li>
 *   <li>{@link org.eclipse.xtext.xtextTest.impl.CrossReferenceImpl#getTerminal <em>Terminal</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CrossReferenceImpl extends AbstractElementImpl implements CrossReference
{
  ...
  public NotificationChain basicSetTerminal(AbstractElement newTerminal, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, XtextTestPackage.CROSS_REFERENCE__TERMINAL, oldTerminal, newTerminal);
      if (msgs == null) msgs = notification; else msgs.add(notification);
    }
    return msgs;
  }
  ...
  public void setTerminal(AbstractElement newTerminal)
  {
    if (newTerminal != terminal)
    {
      NotificationChain msgs = null;
      if (terminal != null)
        msgs = ((InternalEObject)terminal).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - XtextTestPackage.CROSS_REFERENCE__TERMINAL, null, msgs);
      if (newTerminal != null)
        msgs = ((InternalEObject)newTerminal).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - XtextTestPackage.CROSS_REFERENCE__TERMINAL, null, msgs);
      msgs = basicSetTerminal(newTerminal, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XtextTestPackage.CROSS_REFERENCE__TERMINAL, newTerminal, newTerminal));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      ...
      case XtextTestPackage.CROSS_REFERENCE__TERMINAL:
