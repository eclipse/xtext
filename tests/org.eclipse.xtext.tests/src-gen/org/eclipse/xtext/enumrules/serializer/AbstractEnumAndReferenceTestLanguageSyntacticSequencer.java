...
public class AbstractEnumAndReferenceTestLanguageSyntacticSequencer extends AbstractSyntacticSequencer {

	protected EnumAndReferenceTestLanguageGrammarAccess grammarAccess;
	
	@Inject
	protected void init(IGrammarAccess access) {
		grammarAccess = (EnumAndReferenceTestLanguageGrammarAccess) access;
	}
