...
public class AbstractEnumRulesTestLanguageSyntacticSequencer extends AbstractSyntacticSequencer {

	protected EnumRulesTestLanguageGrammarAccess grammarAccess;
	
	@Inject
	protected void init(IGrammarAccess access) {
		grammarAccess = (EnumRulesTestLanguageGrammarAccess) access;
	}
