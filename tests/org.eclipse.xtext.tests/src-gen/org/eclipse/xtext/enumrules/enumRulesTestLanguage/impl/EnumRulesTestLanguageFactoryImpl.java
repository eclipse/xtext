...
public class EnumRulesTestLanguageFactoryImpl extends EFactoryImpl implements EnumRulesTestLanguageFactory
{
  ...
  public static EnumRulesTestLanguageFactory init()
  {
    try
    {
      EnumRulesTestLanguageFactory theEnumRulesTestLanguageFactory = (EnumRulesTestLanguageFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.eclipse.org/2009/tmf/xtext/AbstractEnumRulesTest"); 
