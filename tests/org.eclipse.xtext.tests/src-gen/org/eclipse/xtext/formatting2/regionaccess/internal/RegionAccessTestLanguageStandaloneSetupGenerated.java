...
public class RegionAccessTestLanguageStandaloneSetupGenerated implements ISetup {
	...
	if (!EPackage.Registry.INSTANCE.containsKey("http://simple/formattertestlanguage")) {
		EPackage.Registry.INSTANCE.put("http://simple/formattertestlanguage", org.eclipse.xtext.formatting2.regionaccess.internal.formattertestlanguage.FormattertestlanguagePackage.eINSTANCE);
	}
