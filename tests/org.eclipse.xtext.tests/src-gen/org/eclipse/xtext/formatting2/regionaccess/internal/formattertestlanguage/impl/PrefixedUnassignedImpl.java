...
import org.eclipse.xtext.formatting2.regionaccess.internal.formattertestlanguage.PrefixedDelegate;
 ...
 * <ul>
 *   <li>{@link org.eclipse.xtext.formatting2.regionaccess.internal.formattertestlanguage.impl.PrefixedUnassignedImpl#getDelegate <em>Delegate</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PrefixedUnassignedImpl extends RootImpl implements PrefixedUnassigned
{
  ...
  {
    return FormattertestlanguagePackage.Literals.PREFIXED_UNASSIGNED;
  }
  ...
  public NotificationChain basicSetDelegate(PrefixedDelegate newDelegate, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FormattertestlanguagePackage.PREFIXED_UNASSIGNED__DELEGATE, oldDelegate, newDelegate);
  ...
  public void setDelegate(PrefixedDelegate newDelegate)
  {
    if (newDelegate != delegate)
    {
      ...
      if (delegate != null)
        msgs = ((InternalEObject)delegate).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FormattertestlanguagePackage.PREFIXED_UNASSIGNED__DELEGATE, null, msgs);
      if (newDelegate != null)
        msgs = ((InternalEObject)newDelegate).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FormattertestlanguagePackage.PREFIXED_UNASSIGNED__DELEGATE, null, msgs);
      msgs = basicSetDelegate(newDelegate, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FormattertestlanguagePackage.PREFIXED_UNASSIGNED__DELEGATE, newDelegate, newDelegate));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case FormattertestlanguagePackage.PREFIXED_UNASSIGNED__DELEGATE:
