 ...
 * @generated
 */
public interface RegionaccesstestlanguageFactory extends EFactory
{
  /**
   ...
   * @generated
   */
  RegionaccesstestlanguageFactory eINSTANCE = org.eclipse.xtext.formatting2.regionaccess.internal.regionaccesstestlanguage.impl.RegionaccesstestlanguageFactoryImpl.init();
  ...
  /**
   * Returns a new object of class '<em>Prefixed Unassigned</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Prefixed Unassigned</em>'.
   * @generated
   */
  PrefixedUnassigned createPrefixedUnassigned();

  /**
   * Returns a new object of class '<em>Prefixed Delegate</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Prefixed Delegate</em>'.
   * @generated
   */
  PrefixedDelegate createPrefixedDelegate();
  ...
  /**
   * Returns a new object of class '<em>Assigned Action</em>'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return a new object of class '<em>Assigned Action</em>'.
   * @generated
   */
  AssignedAction createAssignedAction();
   ...
   * @generated
   */
  RegionaccesstestlanguagePackage getRegionaccesstestlanguagePackage();

} //RegionaccesstestlanguageFactory
