/**
 */
package org.eclipse.xtext.formatting2.internal.formattertestlanguage.util;
...
public class FormattertestlanguageAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected FormattertestlanguageSwitch<Adapter> modelSwitch =
    new FormattertestlanguageSwitch<Adapter>()
    {
      ...
      @Override
      public Adapter caseKWList(KWList object)
      {
        return createKWListAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.eclipse.xtext.formatting2.internal.formattertestlanguage.Root <em>Root</em>}'.
   * <!-- begin-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.eclipse.xtext.formatting2.internal.formattertestlanguage.IDList <em>ID List</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.eclipse.xtext.formatting2.internal.formattertestlanguage.KWList <em>KW List</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
   ...
   * @generated
   */
  public Adapter createKWListAdapter()
  {
    return null;
  }
