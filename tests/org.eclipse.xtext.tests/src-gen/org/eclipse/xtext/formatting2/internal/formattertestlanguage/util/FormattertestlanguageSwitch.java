...
public class FormattertestlanguageSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case FormattertestlanguagePackage.ID_LIST:
      {
        ...
        if (result == null) result = caseRoot(idList);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case FormattertestlanguagePackage.KW_LIST:
      {
        KWList kwList = (KWList)theEObject;
        T result = caseKWList(kwList);
        if (result == null) result = caseRoot(kwList);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>KW List</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>KW List</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseKWList(KWList object)
  {
    return null;
  }
