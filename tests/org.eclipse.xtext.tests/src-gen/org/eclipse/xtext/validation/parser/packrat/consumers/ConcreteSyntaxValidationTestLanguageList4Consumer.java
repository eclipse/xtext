...
public final class ConcreteSyntaxValidationTestLanguageList4Consumer extends NonTerminalConsumer {
	...
	protected class RuleCall$11$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(idConsumer, "val2", false, false, getElement(), getRuleCall$11$Delimiter(), optional);
		}
	}

	public ConcreteSyntaxValidationTestLanguageList4Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public List4Elements getRule() {
		return rule;
	}
	
	public void setRule(List4Elements rule) {
		this.rule = rule;
		...
		keyword$9$Consumer = new Keyword$9$Consumer(rule.getKw3Keyword_3());
		assignment$10$Consumer = new Assignment$10$Consumer(rule.getVal2Assignment_4());
		ruleCall$11$Consumer = new RuleCall$11$Consumer(rule.getVal2IDTerminalRuleCall_4_0());
	}
