...
import org.eclipse.xtext.validation.services.ConcreteSyntaxValidationTestLanguageGrammarAccess.UnassignedAction1Elements;

@SuppressWarnings("all")
public final class ConcreteSyntaxValidationTestLanguageUnassignedAction1Consumer extends NonTerminalConsumer {

	private UnassignedAction1Elements rule;	
	...
	public ConcreteSyntaxValidationTestLanguageUnassignedAction1Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public UnassignedAction1Elements getRule() {
		return rule;
	}
	
	public void setRule(UnassignedAction1Elements rule) {
		this.rule = rule;
		
		group$1$Consumer = new Group$1$Consumer(rule.getGroup());
		action$2$Consumer = new Action$2$Consumer(rule.getUnassignedAction1Action_0());
		keyword$4$Consumer = new Keyword$4$Consumer(rule.getNumberSignDigitEightKeyword_1());
