...
import org.eclipse.xtext.validation.services.ConcreteSyntaxValidationTestLanguageGrammarAccess.SimpleGroupElements;

@SuppressWarnings("all")
public final class ConcreteSyntaxValidationTestLanguageSimpleGroupConsumer extends NonTerminalConsumer {

	private SimpleGroupElements rule;	
	...
	protected class RuleCall$6$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(idConsumer, "val2", false, false, getElement(), getRuleCall$6$Delimiter(), optional);
		}
	}

	public ConcreteSyntaxValidationTestLanguageSimpleGroupConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public SimpleGroupElements getRule() {
		return rule;
	}
	
	public void setRule(SimpleGroupElements rule) {
		this.rule = rule;
		
		group$1$Consumer = new Group$1$Consumer(rule.getGroup());
		keyword$2$Consumer = new Keyword$2$Consumer(rule.getNumberSignDigitOneKeyword_0());
		...
		assignment$5$Consumer = new Assignment$5$Consumer(rule.getVal2Assignment_2());
		ruleCall$6$Consumer = new RuleCall$6$Consumer(rule.getVal2IDTerminalRuleCall_2_0());
	}
