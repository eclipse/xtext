...
public final class ConcreteSyntaxValidationTestLanguageTransientSerializeables1EnumConsumer extends NonTerminalConsumer {
	...
	public ConcreteSyntaxValidationTestLanguageTransientSerializeables1EnumConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public TransientSerializeables1EnumElements getRule() {
		return rule;
	}
	
	public void setRule(TransientSerializeables1EnumElements rule) {
		this.rule = rule;
