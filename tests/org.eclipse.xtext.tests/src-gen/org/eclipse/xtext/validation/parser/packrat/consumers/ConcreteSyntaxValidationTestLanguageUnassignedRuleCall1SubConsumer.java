...
public final class ConcreteSyntaxValidationTestLanguageUnassignedRuleCall1SubConsumer extends NonTerminalConsumer {
	...
	protected class RuleCall$2$Consumer extends ElementConsumer<RuleCall> {
		...
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(idConsumer, "val1", false, false, getElement(), getRuleCall$2$Delimiter(), optional);
		}
	}

	public ConcreteSyntaxValidationTestLanguageUnassignedRuleCall1SubConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public UnassignedRuleCall1SubElements getRule() {
		return rule;
	}
	
	public void setRule(UnassignedRuleCall1SubElements rule) {
		this.rule = rule;
		
		assignment$1$Consumer = new Assignment$1$Consumer(rule.getVal1Assignment());
		ruleCall$2$Consumer = new RuleCall$2$Consumer(rule.getVal1IDTerminalRuleCall_0());
	}
