...
import org.eclipse.xtext.validation.services.ConcreteSyntaxValidationTestLanguageGrammarAccess.List1Elements;

@SuppressWarnings("all")
public final class ConcreteSyntaxValidationTestLanguageList1Consumer extends NonTerminalConsumer {

	private List1Elements rule;	
	...
	protected class RuleCall$4$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(idConsumer, "val1", true, false, getElement(), getRuleCall$4$Delimiter(), optional);
		}
	}
	...
	protected class RuleCall$8$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(idConsumer, "val1", true, false, getElement(), getRuleCall$8$Delimiter(), optional);
		}
	}

	public ConcreteSyntaxValidationTestLanguageList1Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public List1Elements getRule() {
		return rule;
	}
	
	public void setRule(List1Elements rule) {
		this.rule = rule;
		...
		assignment$7$Consumer = new Assignment$7$Consumer(rule.getVal1Assignment_2_1());
		ruleCall$8$Consumer = new RuleCall$8$Consumer(rule.getVal1IDTerminalRuleCall_2_1_0());
	}
