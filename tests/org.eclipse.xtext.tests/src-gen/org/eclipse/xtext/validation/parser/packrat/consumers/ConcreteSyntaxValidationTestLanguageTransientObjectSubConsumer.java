...
import org.eclipse.xtext.validation.services.ConcreteSyntaxValidationTestLanguageGrammarAccess.TransientObjectSubElements;

@SuppressWarnings("all")
public final class ConcreteSyntaxValidationTestLanguageTransientObjectSubConsumer extends NonTerminalConsumer {

	private TransientObjectSubElements rule;	
	...
	protected class RuleCall$3$Consumer extends ElementConsumer<RuleCall> {
		...
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(idConsumer, "val2", false, false, getElement(), getRuleCall$3$Delimiter(), optional);
		}
	}
	...
	protected class RuleCall$5$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(idConsumer, "val3", false, false, getElement(), getRuleCall$5$Delimiter(), optional);
		}
	}

	public ConcreteSyntaxValidationTestLanguageTransientObjectSubConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public TransientObjectSubElements getRule() {
		return rule;
	}
	
	public void setRule(TransientObjectSubElements rule) {
		this.rule = rule;
		
		group$1$Consumer = new Group$1$Consumer(rule.getGroup());
		assignment$2$Consumer = new Assignment$2$Consumer(rule.getVal2Assignment_0());
		ruleCall$3$Consumer = new RuleCall$3$Consumer(rule.getVal2IDTerminalRuleCall_0_0());
		assignment$4$Consumer = new Assignment$4$Consumer(rule.getVal3Assignment_1());
		ruleCall$5$Consumer = new RuleCall$5$Consumer(rule.getVal3IDTerminalRuleCall_1_0());
	}
