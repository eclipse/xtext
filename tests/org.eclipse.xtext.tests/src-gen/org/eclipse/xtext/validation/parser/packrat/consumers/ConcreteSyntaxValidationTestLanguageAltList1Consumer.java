...
import org.eclipse.xtext.validation.services.ConcreteSyntaxValidationTestLanguageGrammarAccess.AltList1Elements;

@SuppressWarnings("all")
public final class ConcreteSyntaxValidationTestLanguageAltList1Consumer extends NonTerminalConsumer {

	private AltList1Elements rule;	
	...
	protected class RuleCall$12$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(idConsumer, "val1", false, false, getElement(), getRuleCall$12$Delimiter(), optional);
		}
	}
	...
	protected class RuleCall$14$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(idConsumer, "val3", false, false, getElement(), getRuleCall$14$Delimiter(), optional);
		}
	}
	...
	protected class RuleCall$18$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(idConsumer, "val1", false, false, getElement(), getRuleCall$18$Delimiter(), optional);
		}
	}

	protected class Assignment$19$Consumer extends OptionalAssignmentConsumer {
	...
	protected class RuleCall$20$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(idConsumer, "val4", false, false, getElement(), getRuleCall$20$Delimiter(), optional);
		}
	}

	public ConcreteSyntaxValidationTestLanguageAltList1Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public AltList1Elements getRule() {
		return rule;
	}
	
	public void setRule(AltList1Elements rule) {
		this.rule = rule;
		
		group$1$Consumer = new Group$1$Consumer(rule.getGroup());
		keyword$2$Consumer = new Keyword$2$Consumer(rule.getNumberSignDigitTwoDigitTwoKeyword_0());
		...
		keyword$10$Consumer = new Keyword$10$Consumer(rule.getKw1Keyword_1_1_0());
		...
		assignment$13$Consumer = new Assignment$13$Consumer(rule.getVal3Assignment_1_1_2());
		ruleCall$14$Consumer = new RuleCall$14$Consumer(rule.getVal3IDTerminalRuleCall_1_1_2_0());
		group$15$Consumer = new Group$15$Consumer(rule.getGroup_1_2());
		keyword$16$Consumer = new Keyword$16$Consumer(rule.getKw2Keyword_1_2_0());
		assignment$17$Consumer = new Assignment$17$Consumer(rule.getVal1Assignment_1_2_1());
		ruleCall$18$Consumer = new RuleCall$18$Consumer(rule.getVal1IDTerminalRuleCall_1_2_1_0());
		assignment$19$Consumer = new Assignment$19$Consumer(rule.getVal4Assignment_1_2_2());
		ruleCall$20$Consumer = new RuleCall$20$Consumer(rule.getVal4IDTerminalRuleCall_1_2_2_0());
	}
