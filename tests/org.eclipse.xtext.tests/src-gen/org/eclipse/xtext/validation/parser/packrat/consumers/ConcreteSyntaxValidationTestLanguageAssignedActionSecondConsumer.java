...
import org.eclipse.xtext.validation.services.ConcreteSyntaxValidationTestLanguageGrammarAccess.AssignedActionSecondElements;

@SuppressWarnings("all")
public final class ConcreteSyntaxValidationTestLanguageAssignedActionSecondConsumer extends NonTerminalConsumer {

	private AssignedActionSecondElements rule;	
	...
	public ConcreteSyntaxValidationTestLanguageAssignedActionSecondConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public AssignedActionSecondElements getRule() {
		return rule;
	}
	
	public void setRule(AssignedActionSecondElements rule) {
		this.rule = rule;
