...
public final class ConcreteSyntaxValidationTestLanguageList2Consumer extends NonTerminalConsumer {
	...
	protected class RuleCall$5$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(idConsumer, "val1", true, false, getElement(), getRuleCall$5$Delimiter(), optional);
		}
	}
	...
	protected class RuleCall$9$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(idConsumer, "val1", true, false, getElement(), getRuleCall$9$Delimiter(), optional);
		}
	}

	public ConcreteSyntaxValidationTestLanguageList2Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public List2Elements getRule() {
		return rule;
	}
	
	public void setRule(List2Elements rule) {
		this.rule = rule;
		...
		assignment$8$Consumer = new Assignment$8$Consumer(rule.getVal1Assignment_1_1_1());
		ruleCall$9$Consumer = new RuleCall$9$Consumer(rule.getVal1IDTerminalRuleCall_1_1_1_0());
	}
