 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.xtext.validation.csvalidationtest.impl.AltList1Impl#getVal1 <em>Val1</em>}</li>
 *   <li>{@link org.eclipse.xtext.validation.csvalidationtest.impl.AltList1Impl#getVal2 <em>Val2</em>}</li>
 *   <li>{@link org.eclipse.xtext.validation.csvalidationtest.impl.AltList1Impl#getVal3 <em>Val3</em>}</li>
 *   <li>{@link org.eclipse.xtext.validation.csvalidationtest.impl.AltList1Impl#getVal4 <em>Val4</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AltList1Impl extends MinimalEObjectImpl.Container implements AltList1
{
  /**
  ...
  {
    return CsvalidationtestPackage.Literals.ALT_LIST1;
  }
  ...
  public void setVal1(String newVal1)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CsvalidationtestPackage.ALT_LIST1__VAL1, oldVal1, val1));
  }
  ...
  public void setVal2(String newVal2)
  {
    ...
    val2 = newVal2;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CsvalidationtestPackage.ALT_LIST1__VAL2, oldVal2, val2));
  }
  ...
  public void setVal3(String newVal3)
  {
    ...
    val3 = newVal3;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CsvalidationtestPackage.ALT_LIST1__VAL3, oldVal3, val3));
  }
  ...
  public void setVal4(String newVal4)
  {
    ...
    val4 = newVal4;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CsvalidationtestPackage.ALT_LIST1__VAL4, oldVal4, val4));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case CsvalidationtestPackage.ALT_LIST1__VAL1:
        return getVal1();
      case CsvalidationtestPackage.ALT_LIST1__VAL2:
        return getVal2();
      case CsvalidationtestPackage.ALT_LIST1__VAL3:
        return getVal3();
      case CsvalidationtestPackage.ALT_LIST1__VAL4:
        return getVal4();
    }
