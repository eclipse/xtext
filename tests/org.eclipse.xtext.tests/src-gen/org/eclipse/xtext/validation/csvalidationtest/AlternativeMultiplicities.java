 ...
 *   <li>{@link org.eclipse.xtext.validation.csvalidationtest.AlternativeMultiplicities#getVal4 <em>Val4</em>}</li>
 *   <li>{@link org.eclipse.xtext.validation.csvalidationtest.AlternativeMultiplicities#getVal5 <em>Val5</em>}</li>
...
public interface AlternativeMultiplicities extends EObject
{
   ...
   * @see #setVal2(String)
   * @see org.eclipse.xtext.validation.csvalidationtest.CsvalidationtestPackage#getAlternativeMultiplicities_Val2()
   * @model
   * @generated
   */
  String getVal2();
  ...
  /**
   * Sets the value of the '{@link org.eclipse.xtext.validation.csvalidationtest.AlternativeMultiplicities#getVal2 <em>Val2</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setVal3(String)
   * @see org.eclipse.xtext.validation.csvalidationtest.CsvalidationtestPackage#getAlternativeMultiplicities_Val3()
   * @model
   * @generated
   */
  String getVal3();
  ...
  /**
   * Sets the value of the '{@link org.eclipse.xtext.validation.csvalidationtest.AlternativeMultiplicities#getVal3 <em>Val3</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.eclipse.xtext.validation.csvalidationtest.CsvalidationtestPackage#getAlternativeMultiplicities_Val4()
   * @model unique="false"
   * @generated
   */
   ...
   * @see org.eclipse.xtext.validation.csvalidationtest.CsvalidationtestPackage#getAlternativeMultiplicities_Val5()
   * @model unique="false"
   * @generated
   */
   ...
   * @see org.eclipse.xtext.validation.csvalidationtest.CsvalidationtestPackage#getAlternativeMultiplicities_Val6()
   * @model unique="false"
   * @generated
   */
   ...
   * @see org.eclipse.xtext.validation.csvalidationtest.CsvalidationtestPackage#getAlternativeMultiplicities_Val7()
   * @model unique="false"
   * @generated
   */
