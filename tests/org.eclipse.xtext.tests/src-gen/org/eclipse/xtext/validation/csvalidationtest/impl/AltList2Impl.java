...
public class AltList2Impl extends MinimalEObjectImpl.Container implements AltList2
{
  ...
  {
    return CsvalidationtestPackage.Literals.ALT_LIST2;
  }
  ...
  public EList<String> getVal1()
  {
    if (val1 == null)
    {
      val1 = new EDataTypeEList<String>(String.class, this, CsvalidationtestPackage.ALT_LIST2__VAL1);
    }
    return val1;
  }
  ...
  public void setVal2(String newVal2)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CsvalidationtestPackage.ALT_LIST2__VAL2, oldVal2, val2));
  }
  ...
  public void setVal3(String newVal3)
  {
    ...
    val3 = newVal3;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, CsvalidationtestPackage.ALT_LIST2__VAL3, oldVal3, val3));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case CsvalidationtestPackage.ALT_LIST2__VAL1:
        return getVal1();
      case CsvalidationtestPackage.ALT_LIST2__VAL2:
        return getVal2();
      case CsvalidationtestPackage.ALT_LIST2__VAL3:
        return getVal3();
    }
