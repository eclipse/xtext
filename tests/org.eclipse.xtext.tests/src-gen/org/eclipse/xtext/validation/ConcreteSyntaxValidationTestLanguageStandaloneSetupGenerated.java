...
public class ConcreteSyntaxValidationTestLanguageStandaloneSetupGenerated implements ISetup, ISetupExtension {
	...
	public List<String> getFileExtensions() {
		return Arrays.asList("concretesyntaxvalidationtestlanguage");
	}
