...
public class ImportScopeTest extends TestCase {
	...
	public void testImports_01() throws Exception {
		...
		SimpleScope outer = new SimpleScope(newArrayList(desc1,desc2));
		...
		ImportScope scope = new ImportScope(newArrayList(n1,n2), outer, false);
	...
	public void testRelativeImports_01() throws Exception {
		final IEObjectDescription desc1 = EObjectDescription.create(QualifiedName.create("com","foo","bar"), EcorePackage.Literals.EANNOTATION);
		final IEObjectDescription desc2 = EObjectDescription.create(QualifiedName.create("de","foo"), EcorePackage.Literals.EATTRIBUTE);
		IScope outer = new SimpleScope(newArrayList(desc1,desc2));
		ImportNormalizer n1 = new ImportNormalizer(QualifiedName.create("com"), true);
		ImportNormalizer n2 = new ImportNormalizer(QualifiedName.create("de"), true);
		outer = new ImportScope(newArrayList(n1,n2), outer, false);
	...
	public void testDuplicatesNotVisible_01_IgnoreCase() throws Exception {
		final IEObjectDescription desc1 = new EObjectDescription(QualifiedName.create("com","foo"), EcorePackage.Literals.EANNOTATION, null, true);
		final IEObjectDescription desc2 = new EObjectDescription(QualifiedName.create("de","Foo"), EcorePackage.Literals.EATTRIBUTE, null, true);
		SimpleScope outer = new SimpleScope(newArrayList(desc1,desc2));
		ImportNormalizer n1 = new ImportNormalizer(QualifiedName.create("com"), true);
		ImportNormalizer n2 = new ImportNormalizer(QualifiedName.create("de"), true);
		ImportScope scope = new ImportScope(newArrayList(n1,n2), outer, true);
	...
	public void testDuplicatesNotVisible_02_IgnoreCase() throws Exception {
		...
		assertNull(scope.getSingleElement(selectByNameIgnoreCase(QualifiedName.create("Foo"))));
		assertNotNull(scope.getSingleElement(selectByNameIgnoreCase(QualifiedName.create("com","Foo"))));
		assertNotNull(scope.getSingleElement(selectByNameIgnoreCase(QualifiedName.create("de","Foo"))));
	}
}
