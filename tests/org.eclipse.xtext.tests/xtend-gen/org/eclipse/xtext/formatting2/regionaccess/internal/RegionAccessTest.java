...
import org.eclipse.xtext.formatting2.regionaccess.internal.formattertestlanguage.Root;
...
public class RegionAccessTest {
  ...
  public void testSimple() {
    ...
    _builder_1.append("00 0 Hidden");
    _builder_1.newLine();
    _builder_1.append("     ");
    _builder_1.append("Start    Simple\'foo\'");
    _builder_1.newLine();
    _builder_1.append("00 4 Semantic \"test\" Root:\'test\'");
    _builder_1.newLine();
    _builder_1.append("04 1 Hidden   \" \" Whitespace:TerminalRule\'WS\'");
    _builder_1.newLine();
    _builder_1.append("05 1 Semantic \"1\" Simple:\'1\'");
    _builder_1.newLine();
    _builder_1.append("06 1 Hidden   \" \" Whitespace:TerminalRule\'WS\'");
    _builder_1.newLine();
    _builder_1.append("07 3 Semantic \"foo\" Simple:name=ID");
    _builder_1.newLine();
    _builder_1.append("     ");
  ...
  public void testAssignedDelegate() {
    ...
    _builder_1.append("04 1 Hidden   \" \" Whitespace:TerminalRule\'WS\'");
    _builder_1.newLine();
    _builder_1.append("05 1 Semantic \"2\" Delegation:\'2\'");
    _builder_1.newLine();
    _builder_1.append("06 1 Hidden   \" \" Whitespace:TerminalRule\'WS\'");
    _builder_1.newLine();
    _builder_1.append("     ");
    ...
    _builder_1.newLine();
    _builder_1.append("07 3 Semantic \"foo\" Delegate:name=ID");
    _builder_1.newLine();
    _builder_1.append("     ");
  ...
  public void testUnassignedDelegate() {
    ...
    _builder_1.append("04 1 Hidden   \" \" Whitespace:TerminalRule\'WS\'");
    _builder_1.newLine();
    _builder_1.append("05 1 Semantic \"3\" Unassigned:\'3\'");
    _builder_1.newLine();
    _builder_1.append("06 1 Hidden   \" \" Whitespace:TerminalRule\'WS\'");
    _builder_1.newLine();
    _builder_1.append("07 3 Semantic \"foo\" Delegate:name=ID");
  ...
  public void testUnassignedPrefixedDelegate() {
    ...
    _builder_1.append("04 1 Hidden   \" \" Whitespace:TerminalRule\'WS\'");
    _builder_1.newLine();
    _builder_1.append("05 1 Semantic \"4\" PrefixedUnassigned:\'4\'");
    _builder_1.newLine();
    _builder_1.append("06 1 Hidden   \" \" Whitespace:TerminalRule\'WS\'");
    _builder_1.newLine();
    _builder_1.append("     ");
    _builder_1.append("Start    delegate=Delegate\'foo\'");
    _builder_1.newLine();
    _builder_1.append("07 6 Semantic \"prefix\" PrefixedDelegate:\'prefix\'");
    _builder_1.newLine();
