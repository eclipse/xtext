...
public class RegionAccessBuilderTest {
  ...
  public void testUnassignedPrefixedDelegate() {
    ...
    _builder_1.newLine();
    _builder_1.append("     ");
    _builder_1.append("B PrefixedUnassignedRoot");
    _builder_1.newLine();
    _builder_1.append(" ");
    ...
    _builder_1.newLine();
    _builder_1.append("     ");
    _builder_1.append("E PrefixedUnassignedRoot");
    _builder_1.newLine();
  ...
  public void testRef() {
    ...
    _builder_1.newLine();
    _builder_1.append("     ");
    _builder_1.append("B AssignedActionRoot");
    _builder_1.newLine();
    _builder_1.append(" ");
    _builder_1.append("0 1 S \"6\"        Root:\'6\'");
    _builder_1.newLine();
    ...
    _builder_1.newLine();
    _builder_1.append("     ");
    _builder_1.append("E AssignedActionRoot");
    _builder_1.newLine();
  ...
  public void testAssignmentActionAction() {
    ...
    _builder_1.newLine();
    _builder_1.append("     ");
    _builder_1.append("B AssignedActionMixed:{AssignedAction.child=} path:AssignedAction/child");
    _builder_1.newLine();
    _builder_1.append("     ");
    ...
    _builder_1.newLine();
    _builder_1.append("     ");
    _builder_1.append("E AssignedActionMixed:{AssignedAction.child=} path:AssignedAction/child");
    _builder_1.newLine();
    _builder_1.append("14 1 H \" \"        Whitespace:TerminalRule\'WS\'");
    _builder_1.newLine();
