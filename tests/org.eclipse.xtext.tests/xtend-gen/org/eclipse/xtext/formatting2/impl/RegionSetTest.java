...
import org.eclipse.xtext.formatting2.impl.TestableTextSegmentSet;
...
public class RegionSetTest {
  private void test(final CharSequence expectation, final Procedure1<? super TestableTextSegmentSet> test) {
    ArrayListTextSegmentSet<ITextSegment> _arrayListTextSegmentSet = new ArrayListTextSegmentSet<ITextSegment>();
