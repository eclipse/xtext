...
import org.eclipse.emf.index.dao.AbstractECrossReferenceDAOTest;
import org.eclipse.emf.index.impl.memory.EClassDAOImpl;
import org.eclipse.emf.index.impl.memory.ECrossReferenceDAOImpl;
...
public class ECrossReferenceDAOTest extends AbstractECrossReferenceDAOTest {
	...
	protected ECrossReferenceDescriptor.DAO createECrossReferenceDAO() {
		return new ECrossReferenceDAOImpl(indexStore);
	}
