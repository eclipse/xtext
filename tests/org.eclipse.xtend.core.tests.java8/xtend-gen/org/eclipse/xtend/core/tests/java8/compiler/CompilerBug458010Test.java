...
public class CompilerBug458010Test extends AbstractXtendCompilerTest {
  ...
  public void test_01() {
    ...
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("boolean _equals = Objects.equal(it.gender, Demo.Person.Sex.MALE);");
    _builder_1.newLine();
    _builder_1.append("      ");
    ...
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("int _age = it.getAge();");
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("boolean _greaterEqualsThan = (_age >= 18);");
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("_and_1 = _greaterEqualsThan;");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("}");
    _builder_1.newLine();
    ...
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("int _age_1 = it.getAge();");
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("boolean _lessEqualsThan = (_age_1 <= 25);");
    _builder_1.newLine();
    _builder_1.append("        ");
    _builder_1.append("_and = _lessEqualsThan;");
    _builder_1.newLine();
    _builder_1.append("      ");
    _builder_1.append("}");
    _builder_1.newLine();
