...
public class ContentAssistTestLanguagePackratParser extends AbstractPackratParser {
	...
	@Override
	protected org.eclipse.xtext.testlanguages.parser.packrat.ContentAssistTestLanguageParserConfiguration createParserConfiguration(IInternalParserConfiguration configuration) {
		return new org.eclipse.xtext.testlanguages.parser.packrat.ContentAssistTestLanguageParserConfiguration(configuration, getGrammarAccess());
	}
