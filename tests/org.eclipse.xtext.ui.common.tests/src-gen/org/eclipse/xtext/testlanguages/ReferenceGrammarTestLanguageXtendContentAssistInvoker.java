 ...
 */
public class ReferenceGrammarTestLanguageXtendContentAssistInvoker extends AbstractXtendService implements IContentAssistInvocationHandler {

	private static final Logger log = Logger.getLogger(ReferenceGrammarTestLanguageXtendContentAssistInvoker.class);
	...
	protected String getMasterXtendFileName() {
		...
		return "org::eclipse::xtext::testlanguages::ReferenceGrammarTestLanguageProposalProvider";
	}
