...
import org.eclipse.xtext.testlanguages.TreeTestLanguageRuntimeModule;

/**
 * Manual modifications go to {org.eclipse.xtext.testlanguages.TreeTestLanguageUiModule}
 */
public abstract class AbstractTreeTestLanguageUiModule extends TreeTestLanguageRuntimeModule {
	...
	public Class<? extends org.eclipse.xtext.ui.common.editor.contentassist.antlr.IContentAssistParser> bindIContentAssistParser() {
		return org.eclipse.xtext.testlanguages.contentassist.antlr.TreeTestLanguageParser.class;
	}
