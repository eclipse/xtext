...
import org.eclipse.xtext.ui.common.editor.contentassist.parser.packrat.consumers.Bug288734TestLanguageModelConsumer;
import org.eclipse.xtext.ui.common.editor.contentassist.parser.packrat.consumers.Bug288734TestLanguageTConstantConsumer;
import org.eclipse.xtext.ui.common.editor.contentassist.parser.packrat.consumers.Bug288734TestLanguageTStringConstantConsumer;
import org.eclipse.xtext.ui.common.editor.contentassist.parser.packrat.consumers.Bug288734TestLanguageTIntegerConstantConsumer;
import org.eclipse.xtext.ui.common.editor.contentassist.parser.packrat.consumers.Bug288734TestLanguageTBooleanConstantConsumer;
import org.eclipse.xtext.ui.common.editor.contentassist.parser.packrat.consumers.Bug288734TestLanguageTAnnotationConsumer;
...
public class Bug288734TestLanguageParserConfiguration extends AbstractParserConfiguration {
	...
	public void configureConsumers() {
		...
		getTStringConstantConsumer().setKeyword$4$Delimiter(org.eclipse.xtext.ui.common.editor.contentassist.parser.packrat.Bug288734TestLanguageDelimiters.keyword$16$Delimiter);
		getTStringConstantConsumer().setKeyword$5$Delimiter(org.eclipse.xtext.ui.common.editor.contentassist.parser.packrat.Bug288734TestLanguageDelimiters.keyword$16$Delimiter);
		getTStringConstantConsumer().setRuleCall$7$Delimiter(org.eclipse.xtext.ui.common.editor.contentassist.parser.packrat.Bug288734TestLanguageDelimiters.ruleCall$19$Delimiter);
		getTIntegerConstantConsumer().setKeyword$4$Delimiter(org.eclipse.xtext.ui.common.editor.contentassist.parser.packrat.Bug288734TestLanguageDelimiters.keyword$16$Delimiter);
		getTIntegerConstantConsumer().setKeyword$5$Delimiter(org.eclipse.xtext.ui.common.editor.contentassist.parser.packrat.Bug288734TestLanguageDelimiters.keyword$16$Delimiter);
		getTIntegerConstantConsumer().setRuleCall$7$Delimiter(org.eclipse.xtext.ui.common.editor.contentassist.parser.packrat.Bug288734TestLanguageDelimiters.ruleCall$19$Delimiter);
		getTBooleanConstantConsumer().setKeyword$4$Delimiter(org.eclipse.xtext.ui.common.editor.contentassist.parser.packrat.Bug288734TestLanguageDelimiters.keyword$16$Delimiter);
		getTBooleanConstantConsumer().setKeyword$5$Delimiter(org.eclipse.xtext.ui.common.editor.contentassist.parser.packrat.Bug288734TestLanguageDelimiters.keyword$16$Delimiter);
		getTBooleanConstantConsumer().setRuleCall$7$Delimiter(org.eclipse.xtext.ui.common.editor.contentassist.parser.packrat.Bug288734TestLanguageDelimiters.ruleCall$19$Delimiter);
		getTAnnotationConsumer().setKeyword$2$Delimiter(org.eclipse.xtext.ui.common.editor.contentassist.parser.packrat.Bug288734TestLanguageDelimiters.keyword$41$Delimiter);
		getTAnnotationConsumer().setRuleCall$4$Delimiter(org.eclipse.xtext.ui.common.editor.contentassist.parser.packrat.Bug288734TestLanguageDelimiters.ruleCall$43$Delimiter);
	}
