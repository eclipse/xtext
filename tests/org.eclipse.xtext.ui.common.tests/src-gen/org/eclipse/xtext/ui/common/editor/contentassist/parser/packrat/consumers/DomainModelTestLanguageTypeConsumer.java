...
import org.eclipse.xtext.ui.common.editor.contentassist.services.DomainModelTestLanguageGrammarAccess.TypeElements;

public final class DomainModelTestLanguageTypeConsumer extends NonTerminalConsumer {
	...
	protected class RuleCall$3$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeNonTerminal(classConsumer, null, false, false, false, getElement(), optional);
		}
	}

	public DomainModelTestLanguageTypeConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public void setRule(TypeElements rule) {
		...
		ruleCall$2$Consumer = new RuleCall$2$Consumer(rule.getDataTypeParserRuleCall_0());
		ruleCall$3$Consumer = new RuleCall$3$Consumer(rule.getClassParserRuleCall_1());
	}
