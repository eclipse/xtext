...
public final class Bug288760TestLanguageWSConsumer extends AbstractRuleAwareTerminalConsumer {

	public Bug288760TestLanguageWSConsumer(ITerminalConsumerConfiguration configuration) {
		super(configuration);
	}
