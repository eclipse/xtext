...
import org.eclipse.xtext.ui.common.editor.contentassist.services.ContentAssistContextTestLanguageGrammarAccess.ThirdLevelB1Elements;

public final class ContentAssistContextTestLanguageThirdLevelB1Consumer extends NonTerminalConsumer {

	private ThirdLevelB1Elements rule;	
	...
	public ContentAssistContextTestLanguageThirdLevelB1Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public ThirdLevelB1Elements getRule() {
		return rule;
	}
	
	public void setRule(ThirdLevelB1Elements rule) {
		this.rule = rule;
		
		group$1$Consumer = new Group$1$Consumer(rule.getGroup());
		keyword$2$Consumer = new Keyword$2$Consumer(rule.getB1Keyword_0());
		action$3$Consumer = new Action$3$Consumer(rule.getThirdLevelB1Action_1());
