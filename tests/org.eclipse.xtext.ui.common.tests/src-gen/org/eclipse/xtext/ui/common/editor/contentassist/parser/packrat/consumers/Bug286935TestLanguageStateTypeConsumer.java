...
import org.eclipse.xtext.ui.common.editor.contentassist.services.Bug286935TestLanguageGrammarAccess.StateTypeElements;

public final class Bug286935TestLanguageStateTypeConsumer extends NonTerminalConsumer {

	private StateTypeElements rule;	
	...
	public Bug286935TestLanguageStateTypeConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public StateTypeElements getRule() {
		return rule;
	}
	
	public void setRule(StateTypeElements rule) {
		this.rule = rule;
		
		alternatives$1$Consumer = new Alternatives$1$Consumer(rule.getAlternatives());
		enumLiteralDeclaration$2$Consumer = new EnumLiteralDeclaration$2$Consumer(rule.getNORMALEnumLiteralDeclaration_0());
		enumLiteralDeclaration$4$Consumer = new EnumLiteralDeclaration$4$Consumer(rule.getPSEUDOEnumLiteralDeclaration_1());
		enumLiteralDeclaration$6$Consumer = new EnumLiteralDeclaration$6$Consumer(rule.getREFERENCEEnumLiteralDeclaration_2());
		enumLiteralDeclaration$8$Consumer = new EnumLiteralDeclaration$8$Consumer(rule.getTEXTUALEnumLiteralDeclaration_3());
	}
