...
import org.eclipse.xtext.ui.common.editor.contentassist.services.DomainModelTestLanguageGrammarAccess.AttributeElements;

public final class DomainModelTestLanguageAttributeConsumer extends NonTerminalConsumer {
	...
	public DomainModelTestLanguageAttributeConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public void setRule(AttributeElements rule) {
		...
		crossReference$7$Consumer = new CrossReference$7$Consumer(rule.getTypeDataTypeCrossReference_3_0());
		keyword$10$Consumer = new Keyword$10$Consumer(rule.getSemicolonKeyword_4());
	}
