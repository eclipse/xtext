...
public class Bug289187TestLanguagePackageImpl extends EPackageImpl implements Bug289187TestLanguagePackage
{
   ...
   * @see org.eclipse.xtext.ui.common.editor.contentassist.bug289187TestLanguage.Bug289187TestLanguagePackage#eNS_URI
   * @see #init()
   * @generated
   */
  ...
  public void initializePackageContents()
  {
    ...
    initEClass(classEClass, org.eclipse.xtext.ui.common.editor.contentassist.bug289187TestLanguage.Class.class, "Class", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEAttribute(getClass_Abstract(), ecorePackage.getEBoolean(), "abstract", null, 0, 1, org.eclipse.xtext.ui.common.editor.contentassist.bug289187TestLanguage.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getClass_Transient(), ecorePackage.getEBoolean(), "transient", null, 0, 1, org.eclipse.xtext.ui.common.editor.contentassist.bug289187TestLanguage.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getClass_Name(), ecorePackage.getEString(), "name", null, 0, 1, org.eclipse.xtext.ui.common.editor.contentassist.bug289187TestLanguage.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getClass_SuperClass(), this.getClass_(), null, "superClass", null, 0, 1, org.eclipse.xtext.ui.common.editor.contentassist.bug289187TestLanguage.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getClass_ImplementedInterfaces(), this.getClass_(), null, "implementedInterfaces", null, 0, -1, org.eclipse.xtext.ui.common.editor.contentassist.bug289187TestLanguage.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getClass_ClassNumber(), ecorePackage.getEInt(), "classNumber", null, 0, 1, org.eclipse.xtext.ui.common.editor.contentassist.bug289187TestLanguage.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getClass_Quid(), ecorePackage.getEInt(), "quid", null, 0, 1, org.eclipse.xtext.ui.common.editor.contentassist.bug289187TestLanguage.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getClass_Documentation(), ecorePackage.getEString(), "documentation", null, 0, 1, org.eclipse.xtext.ui.common.editor.contentassist.bug289187TestLanguage.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getClass_Attributes(), this.getAttribute(), null, "attributes", null, 0, -1, org.eclipse.xtext.ui.common.editor.contentassist.bug289187TestLanguage.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getClass_Operations(), this.getOperation(), null, "operations", null, 0, -1, org.eclipse.xtext.ui.common.editor.contentassist.bug289187TestLanguage.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
