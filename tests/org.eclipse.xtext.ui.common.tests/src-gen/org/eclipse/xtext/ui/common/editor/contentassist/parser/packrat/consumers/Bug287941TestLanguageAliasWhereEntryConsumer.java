...
import org.eclipse.xtext.ui.common.editor.contentassist.services.Bug287941TestLanguageGrammarAccess.AliasWhereEntryElements;

public final class Bug287941TestLanguageAliasWhereEntryConsumer extends NonTerminalConsumer {

	private AliasWhereEntryElements rule;	
	...
	protected class CrossReference$8$Consumer extends ElementConsumer<CrossReference> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(idConsumer, "rightAlias", false, false, getElement(), getRuleCall$10$Delimiter(), optional);
		}
	}
	...
	public Bug287941TestLanguageAliasWhereEntryConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public AliasWhereEntryElements getRule() {
		return rule;
	}
	
	public void setRule(AliasWhereEntryElements rule) {
		this.rule = rule;
		...
		assignment$7$Consumer = new Assignment$7$Consumer(rule.getRightAliasAssignment_2());
		crossReference$8$Consumer = new CrossReference$8$Consumer(rule.getRightAliasFromEntryCrossReference_2_0());
	}
