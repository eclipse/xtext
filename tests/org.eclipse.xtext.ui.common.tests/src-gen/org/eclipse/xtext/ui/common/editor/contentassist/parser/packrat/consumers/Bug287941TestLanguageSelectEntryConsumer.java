...
import org.eclipse.xtext.ui.common.editor.contentassist.services.Bug287941TestLanguageGrammarAccess.SelectEntryElements;

public final class Bug287941TestLanguageSelectEntryConsumer extends NonTerminalConsumer {

	private SelectEntryElements rule;	
	...
	protected class CrossReference$3$Consumer extends ElementConsumer<CrossReference> {
		...
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(idConsumer, "select", false, false, getElement(), getRuleCall$5$Delimiter(), optional);
		}
	}
	...
	protected class CrossReference$9$Consumer extends ElementConsumer<CrossReference> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(idConsumer, "attribute", false, false, getElement(), getRuleCall$11$Delimiter(), optional);
		}
	}
	...
	public Bug287941TestLanguageSelectEntryConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public SelectEntryElements getRule() {
		return rule;
	}
	
	public void setRule(SelectEntryElements rule) {
		this.rule = rule;
		
		group$1$Consumer = new Group$1$Consumer(rule.getGroup());
		assignment$2$Consumer = new Assignment$2$Consumer(rule.getSelectAssignment_0());
		crossReference$3$Consumer = new CrossReference$3$Consumer(rule.getSelectFromEntryCrossReference_0_0());
		group$6$Consumer = new Group$6$Consumer(rule.getGroup_1());
		keyword$7$Consumer = new Keyword$7$Consumer(rule.getFullStopKeyword_1_0());
		assignment$8$Consumer = new Assignment$8$Consumer(rule.getAttributeAssignment_1_1());
		crossReference$9$Consumer = new CrossReference$9$Consumer(rule.getAttributeEAttributeCrossReference_1_1_0());
	}
