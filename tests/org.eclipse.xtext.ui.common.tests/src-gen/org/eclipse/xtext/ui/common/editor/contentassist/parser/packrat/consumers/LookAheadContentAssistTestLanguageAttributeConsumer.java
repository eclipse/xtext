...
import org.eclipse.xtext.ui.common.editor.contentassist.services.LookAheadContentAssistTestLanguageGrammarAccess.AttributeElements;

public final class LookAheadContentAssistTestLanguageAttributeConsumer extends NonTerminalConsumer {
	...
	protected class RuleCall$2$Consumer extends ElementConsumer<RuleCall> {
		...
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(idConsumer, "value", false, false, getElement(), getRuleCall$2$Delimiter(), optional);
		}
	}

	public LookAheadContentAssistTestLanguageAttributeConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public void setRule(AttributeElements rule) {
		...
		ruleCall$2$Consumer = new RuleCall$2$Consumer(rule.getValueIDTerminalRuleCall_0());
	}
