...
public class DomainModelTestPackageImpl extends EPackageImpl implements DomainModelTestPackage
{
   ...
   * @see org.eclipse.xtext.ui.common.editor.contentassist.domainModelTest.DomainModelTestPackage#eNS_URI
   * @see #init()
   * @generated
   */
  ...
  public void initializePackageContents()
  {
    ...
    initEClass(classEClass, org.eclipse.xtext.ui.common.editor.contentassist.domainModelTest.Class.class, "Class", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getClass_SuperClass(), this.getClass_(), null, "superClass", null, 0, 1, org.eclipse.xtext.ui.common.editor.contentassist.domainModelTest.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getClass_Properties(), this.getProperty(), null, "properties", null, 0, -1, org.eclipse.xtext.ui.common.editor.contentassist.domainModelTest.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getClass_SubClasses(), this.getClass_(), null, "subClasses", null, 0, -1, org.eclipse.xtext.ui.common.editor.contentassist.domainModelTest.Class.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
