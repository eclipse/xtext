...
import org.eclipse.xtext.ui.common.editor.contentassist.services.Bug287941TestLanguageGrammarAccess.WhereEntryElements;

public final class Bug287941TestLanguageWhereEntryConsumer extends NonTerminalConsumer {

	private WhereEntryElements rule;	

	private INonTerminalConsumer andWhereEntryConsumer;
	...
	protected class RuleCall$2$Consumer extends ElementConsumer<RuleCall> {
		...
		protected int doConsume(boolean optional) throws Exception {
			return consumeNonTerminal(andWhereEntryConsumer, null, false, false, false, getElement(), optional);
		}
	}
	...
	protected class RuleCall$9$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeNonTerminal(andWhereEntryConsumer, "entries", true, false, false, getElement(), optional);
		}
	}

	public Bug287941TestLanguageWhereEntryConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public WhereEntryElements getRule() {
		return rule;
	}
	
	public void setRule(WhereEntryElements rule) {
		this.rule = rule;
		
		group$1$Consumer = new Group$1$Consumer(rule.getGroup());
		ruleCall$2$Consumer = new RuleCall$2$Consumer(rule.getAndWhereEntryParserRuleCall_0());
		group$3$Consumer = new Group$3$Consumer(rule.getGroup_1());
		action$4$Consumer = new Action$4$Consumer(rule.getOrWhereEntryEntriesAction_1_0());
		group$6$Consumer = new Group$6$Consumer(rule.getGroup_1_1());
		keyword$7$Consumer = new Keyword$7$Consumer(rule.getOrKeyword_1_1_0());
		assignment$8$Consumer = new Assignment$8$Consumer(rule.getEntriesAssignment_1_1_1());
		ruleCall$9$Consumer = new RuleCall$9$Consumer(rule.getEntriesAndWhereEntryParserRuleCall_1_1_1_0());
	}
	...
	public void setAndWhereEntryConsumer(INonTerminalConsumer andWhereEntryConsumer) {
		this.andWhereEntryConsumer = andWhereEntryConsumer;
	}
