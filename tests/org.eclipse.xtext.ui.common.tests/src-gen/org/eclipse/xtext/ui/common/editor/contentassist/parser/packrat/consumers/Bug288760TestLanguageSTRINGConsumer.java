...
public final class Bug288760TestLanguageSTRINGConsumer extends AbstractRuleAwareTerminalConsumer {

	public Bug288760TestLanguageSTRINGConsumer(ITerminalConsumerConfiguration configuration) {
		super(configuration);
	}
