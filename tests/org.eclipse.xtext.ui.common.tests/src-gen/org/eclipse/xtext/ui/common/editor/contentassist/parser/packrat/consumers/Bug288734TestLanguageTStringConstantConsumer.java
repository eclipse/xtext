...
import org.eclipse.xtext.ui.common.editor.contentassist.services.Bug288734TestLanguageGrammarAccess.TStringConstantElements;

public final class Bug288734TestLanguageTStringConstantConsumer extends NonTerminalConsumer {

	private TStringConstantElements rule;	
	...
	public Bug288734TestLanguageTStringConstantConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public TStringConstantElements getRule() {
		return rule;
	}
	
	public void setRule(TStringConstantElements rule) {
		this.rule = rule;
		...
		keyword$5$Consumer = new Keyword$5$Consumer(rule.getStringKeyword_2());
