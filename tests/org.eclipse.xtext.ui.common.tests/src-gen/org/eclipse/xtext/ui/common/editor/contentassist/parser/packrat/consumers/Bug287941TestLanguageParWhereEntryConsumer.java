...
import org.eclipse.xtext.ui.common.editor.contentassist.services.Bug287941TestLanguageGrammarAccess.ParWhereEntryElements;

public final class Bug287941TestLanguageParWhereEntryConsumer extends NonTerminalConsumer {

	private ParWhereEntryElements rule;	
	...
	protected class RuleCall$3$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeNonTerminal(whereEntryConsumer, null, false, false, false, getElement(), optional);
		}
	}
	...
	public Bug287941TestLanguageParWhereEntryConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public ParWhereEntryElements getRule() {
		return rule;
	}
	
	public void setRule(ParWhereEntryElements rule) {
		this.rule = rule;
		
		group$1$Consumer = new Group$1$Consumer(rule.getGroup());
		keyword$2$Consumer = new Keyword$2$Consumer(rule.getLeftParenthesisKeyword_0());
		ruleCall$3$Consumer = new RuleCall$3$Consumer(rule.getWhereEntryParserRuleCall_1());
