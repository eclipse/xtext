...
import org.eclipse.xtext.ui.common.editor.contentassist.services.Bug287941TestLanguageGrammarAccess.StringAttributeWhereEntryElements;

public final class Bug287941TestLanguageStringAttributeWhereEntryConsumer extends NonTerminalConsumer {

	private StringAttributeWhereEntryElements rule;	

	private ITerminalConsumer idConsumer;

	private ITerminalConsumer stringConsumer;

	private INonTerminalConsumer stringOperatorConsumer;
	...
	protected class RuleCall$12$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeNonTerminal(stringOperatorConsumer, "operator", false, false, false, getElement(), optional);
		}
	}
	...
	protected class RuleCall$14$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(stringConsumer, "pattern", false, false, getElement(), getRuleCall$14$Delimiter(), optional);
		}
	}

	public Bug287941TestLanguageStringAttributeWhereEntryConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public StringAttributeWhereEntryElements getRule() {
		return rule;
	}
	
	public void setRule(StringAttributeWhereEntryElements rule) {
		this.rule = rule;
		...
		ruleCall$12$Consumer = new RuleCall$12$Consumer(rule.getOperatorStringOperatorEnumRuleCall_3_0());
		assignment$13$Consumer = new Assignment$13$Consumer(rule.getPatternAssignment_4());
		ruleCall$14$Consumer = new RuleCall$14$Consumer(rule.getPatternSTRINGTerminalRuleCall_4_0());
	}
	...
	public void setStringOperatorConsumer(INonTerminalConsumer stringOperatorConsumer) {
		this.stringOperatorConsumer = stringOperatorConsumer;
	}
