...
import org.eclipse.xtext.ui.common.editor.contentassist.services.Bug289187TestLanguageGrammarAccess.VisibilityElements;

public final class Bug289187TestLanguageVisibilityConsumer extends NonTerminalConsumer {

	private VisibilityElements rule;	
	...
	public Bug289187TestLanguageVisibilityConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public VisibilityElements getRule() {
		return rule;
	}
	
	public void setRule(VisibilityElements rule) {
		this.rule = rule;
		
		alternatives$1$Consumer = new Alternatives$1$Consumer(rule.getAlternatives());
		enumLiteralDeclaration$2$Consumer = new EnumLiteralDeclaration$2$Consumer(rule.getPRIVATEEnumLiteralDeclaration_0());
		enumLiteralDeclaration$4$Consumer = new EnumLiteralDeclaration$4$Consumer(rule.getPROTECTEDEnumLiteralDeclaration_1());
		enumLiteralDeclaration$6$Consumer = new EnumLiteralDeclaration$6$Consumer(rule.getPACKAGE_PRIVATEEnumLiteralDeclaration_2());
		enumLiteralDeclaration$8$Consumer = new EnumLiteralDeclaration$8$Consumer(rule.getPUBLICEnumLiteralDeclaration_3());
	}
