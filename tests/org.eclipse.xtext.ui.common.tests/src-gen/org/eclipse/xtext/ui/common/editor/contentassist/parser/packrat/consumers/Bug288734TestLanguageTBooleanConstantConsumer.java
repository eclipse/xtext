...
import org.eclipse.xtext.ui.common.editor.contentassist.services.Bug288734TestLanguageGrammarAccess.TBooleanConstantElements;

public final class Bug288734TestLanguageTBooleanConstantConsumer extends NonTerminalConsumer {

	private TBooleanConstantElements rule;	
	...
	public Bug288734TestLanguageTBooleanConstantConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public TBooleanConstantElements getRule() {
		return rule;
	}
	
	public void setRule(TBooleanConstantElements rule) {
		this.rule = rule;
		...
		keyword$5$Consumer = new Keyword$5$Consumer(rule.getBooleanKeyword_2());
