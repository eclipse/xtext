...
public final class Bug287941TestLanguageIDConsumer extends AbstractRuleAwareTerminalConsumer {

	public Bug287941TestLanguageIDConsumer(ITerminalConsumerConfiguration configuration) {
		super(configuration);
	}
