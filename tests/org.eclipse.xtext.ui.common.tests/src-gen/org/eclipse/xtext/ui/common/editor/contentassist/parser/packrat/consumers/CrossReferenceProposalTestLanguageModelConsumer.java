...
import org.eclipse.xtext.ui.common.editor.contentassist.services.CrossReferenceProposalTestLanguageGrammarAccess.ModelElements;

public final class CrossReferenceProposalTestLanguageModelConsumer extends NonTerminalConsumer {
	...
	protected class RuleCall$2$Consumer extends ElementConsumer<RuleCall> {
		...
		protected int doConsume(boolean optional) throws Exception {
			return consumeNonTerminal(classConsumer, "elements", true, false, false, getElement(), optional);
		}
	}

	public CrossReferenceProposalTestLanguageModelConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public void setRule(ModelElements rule) {
		...
		ruleCall$2$Consumer = new RuleCall$2$Consumer(rule.getElementsClassParserRuleCall_0());
	}
