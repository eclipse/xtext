...
import org.eclipse.xtext.ui.common.editor.contentassist.services.Bug288734TestLanguageGrammarAccess.TAnnotationElements;

public final class Bug288734TestLanguageTAnnotationConsumer extends NonTerminalConsumer {

	private TAnnotationElements rule;	
	...
	protected class RuleCall$4$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeTerminal(stringConsumer, "description", false, false, getElement(), getRuleCall$4$Delimiter(), optional);
		}
	}

	public Bug288734TestLanguageTAnnotationConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public TAnnotationElements getRule() {
		return rule;
	}
	
	public void setRule(TAnnotationElements rule) {
		this.rule = rule;
		
		group$1$Consumer = new Group$1$Consumer(rule.getGroup());
		keyword$2$Consumer = new Keyword$2$Consumer(rule.getDescKeyword_0());
		assignment$3$Consumer = new Assignment$3$Consumer(rule.getDescriptionAssignment_1());
		ruleCall$4$Consumer = new RuleCall$4$Consumer(rule.getDescriptionSTRINGTerminalRuleCall_1_0());
	}
