...
import org.eclipse.xtext.ui.common.editor.contentassist.services.ContentAssistContextTestLanguageGrammarAccess.ThirdLevelA2Elements;

public final class ContentAssistContextTestLanguageThirdLevelA2Consumer extends NonTerminalConsumer {

	private ThirdLevelA2Elements rule;	
	...
	public ContentAssistContextTestLanguageThirdLevelA2Consumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public ThirdLevelA2Elements getRule() {
		return rule;
	}
	
	public void setRule(ThirdLevelA2Elements rule) {
		this.rule = rule;
		
		group$1$Consumer = new Group$1$Consumer(rule.getGroup());
		keyword$2$Consumer = new Keyword$2$Consumer(rule.getA2Keyword_0());
		action$3$Consumer = new Action$3$Consumer(rule.getThirdLevelA2Action_1());
