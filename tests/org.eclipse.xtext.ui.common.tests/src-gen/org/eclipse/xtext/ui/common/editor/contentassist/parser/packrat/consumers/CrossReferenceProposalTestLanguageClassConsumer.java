...
import org.eclipse.xtext.ui.common.editor.contentassist.services.CrossReferenceProposalTestLanguageGrammarAccess.ClassElements;

public final class CrossReferenceProposalTestLanguageClassConsumer extends NonTerminalConsumer {
	...
	public CrossReferenceProposalTestLanguageClassConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public void setRule(ClassElements rule) {
		...
		assignment$3$Consumer = new Assignment$3$Consumer(rule.getSuperClassAssignment_0_0());
		crossReference$4$Consumer = new CrossReference$4$Consumer(rule.getSuperClassClassCrossReference_0_0_0());
		keyword$7$Consumer = new Keyword$7$Consumer(rule.getLessThanSignHyphenMinusKeyword_0_1());
		assignment$8$Consumer = new Assignment$8$Consumer(rule.getNameAssignment_1());
		ruleCall$9$Consumer = new RuleCall$9$Consumer(rule.getNameIDTerminalRuleCall_1_0());
		keyword$10$Consumer = new Keyword$10$Consumer(rule.getLeftCurlyBracketKeyword_2());
		keyword$11$Consumer = new Keyword$11$Consumer(rule.getRightCurlyBracketKeyword_3());
	}
