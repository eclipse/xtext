...
public final class Bug288760TestLanguageIDConsumer extends AbstractRuleAwareTerminalConsumer {

	public Bug288760TestLanguageIDConsumer(ITerminalConsumerConfiguration configuration) {
		super(configuration);
	}
