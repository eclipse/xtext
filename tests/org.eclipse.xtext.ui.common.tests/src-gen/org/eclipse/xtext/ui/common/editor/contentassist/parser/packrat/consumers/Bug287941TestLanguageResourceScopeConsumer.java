...
import org.eclipse.xtext.ui.common.editor.contentassist.services.Bug287941TestLanguageGrammarAccess.ResourceScopeElements;

public final class Bug287941TestLanguageResourceScopeConsumer extends NonTerminalConsumer {

	private ResourceScopeElements rule;	
	...
	public Bug287941TestLanguageResourceScopeConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public ResourceScopeElements getRule() {
		return rule;
	}
	
	public void setRule(ResourceScopeElements rule) {
		this.rule = rule;
		
		group$1$Consumer = new Group$1$Consumer(rule.getGroup());
		keyword$2$Consumer = new Keyword$2$Consumer(rule.getResourcesKeyword_0());
