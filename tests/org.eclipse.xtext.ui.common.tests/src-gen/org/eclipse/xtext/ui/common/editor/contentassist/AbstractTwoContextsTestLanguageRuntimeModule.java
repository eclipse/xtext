...
public abstract class AbstractTwoContextsTestLanguageRuntimeModule extends DefaultRuntimeModule {
	...
	public com.google.inject.Provider<org.eclipse.xtext.parser.antlr.Lexer> provideLexer() {
		return new org.eclipse.xtext.parser.antlr.LexerProvider(org.eclipse.xtext.ui.common.editor.contentassist.parser.antlr.internal.InternalTwoContextsTestLanguageLexer.class);
	}
