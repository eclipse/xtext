...
import org.eclipse.xtext.ui.common.editor.contentassist.parser.packrat.consumers.DatatypeRuleTestLanguageModelConsumer;
import org.eclipse.xtext.ui.common.editor.contentassist.parser.packrat.consumers.DatatypeRuleTestLanguageTypesConsumer;
import org.eclipse.xtext.ui.common.editor.contentassist.parser.packrat.consumers.DatatypeRuleTestLanguageTypeConsumer;
import org.eclipse.xtext.ui.common.editor.contentassist.parser.packrat.consumers.DatatypeRuleTestLanguageSimpleTypeConsumer;
import org.eclipse.xtext.ui.common.editor.contentassist.parser.packrat.consumers.DatatypeRuleTestLanguageCompositeTypeConsumer;
import org.eclipse.xtext.ui.common.editor.contentassist.parser.packrat.consumers.DatatypeRuleTestLanguageCompositeTypeEntryConsumer;
import org.eclipse.xtext.ui.common.editor.contentassist.parser.packrat.consumers.DatatypeRuleTestLanguageTypeIdConsumer;
...
public class DatatypeRuleTestLanguageParserConfiguration extends AbstractParserConfiguration {
	...
	public void configureConsumers() {
		...
		getTypesConsumer().setKeyword$2$Delimiter(org.eclipse.xtext.ui.common.editor.contentassist.parser.packrat.DatatypeRuleTestLanguageDelimiters.keyword$7$Delimiter);
		getSimpleTypeConsumer().setKeyword$2$Delimiter(org.eclipse.xtext.ui.common.editor.contentassist.parser.packrat.DatatypeRuleTestLanguageDelimiters.keyword$7$Delimiter);
		getSimpleTypeConsumer().setKeyword$5$Delimiter(org.eclipse.xtext.ui.common.editor.contentassist.parser.packrat.DatatypeRuleTestLanguageDelimiters.keyword$21$Delimiter);
		getSimpleTypeConsumer().setRuleCall$4$Delimiter(org.eclipse.xtext.ui.common.editor.contentassist.parser.packrat.DatatypeRuleTestLanguageDelimiters.ruleCall$20$Delimiter);
		getCompositeTypeConsumer().setKeyword$2$Delimiter(org.eclipse.xtext.ui.common.editor.contentassist.parser.packrat.DatatypeRuleTestLanguageDelimiters.keyword$7$Delimiter);
		getCompositeTypeConsumer().setKeyword$5$Delimiter(org.eclipse.xtext.ui.common.editor.contentassist.parser.packrat.DatatypeRuleTestLanguageDelimiters.keyword$7$Delimiter);
		getCompositeTypeConsumer().setKeyword$8$Delimiter(org.eclipse.xtext.ui.common.editor.contentassist.parser.packrat.DatatypeRuleTestLanguageDelimiters.keyword$21$Delimiter);
		getCompositeTypeConsumer().setRuleCall$4$Delimiter(org.eclipse.xtext.ui.common.editor.contentassist.parser.packrat.DatatypeRuleTestLanguageDelimiters.ruleCall$20$Delimiter);
		getTypeIdConsumer().setKeyword$4$Delimiter(org.eclipse.xtext.ui.common.editor.contentassist.parser.packrat.DatatypeRuleTestLanguageDelimiters.keyword$21$Delimiter);
		getTypeIdConsumer().setKeyword$7$Delimiter(org.eclipse.xtext.ui.common.editor.contentassist.parser.packrat.DatatypeRuleTestLanguageDelimiters.keyword$21$Delimiter);
		getTypeIdConsumer().setKeyword$9$Delimiter(org.eclipse.xtext.ui.common.editor.contentassist.parser.packrat.DatatypeRuleTestLanguageDelimiters.keyword$21$Delimiter);
		getTypeIdConsumer().setRuleCall$2$Delimiter(org.eclipse.xtext.ui.common.editor.contentassist.parser.packrat.DatatypeRuleTestLanguageDelimiters.ruleCall$20$Delimiter);
	}
