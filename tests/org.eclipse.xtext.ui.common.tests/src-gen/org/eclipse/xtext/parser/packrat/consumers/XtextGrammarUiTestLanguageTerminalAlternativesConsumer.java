...
import org.eclipse.xtext.services.XtextGrammarUiTestLanguageGrammarAccess.TerminalAlternativesElements;

public final class XtextGrammarUiTestLanguageTerminalAlternativesConsumer extends NonTerminalConsumer {
	...
	protected class RuleCall$2$Consumer extends ElementConsumer<RuleCall> {
		...
		protected int doConsume(boolean optional) throws Exception {
			return consumeNonTerminal(terminalGroupConsumer, null, false, false, false, getElement(), optional);
		}
	}
	...
	protected class RuleCall$9$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeNonTerminal(terminalGroupConsumer, "groups", true, false, false, getElement(), optional);
		}
	}

	public XtextGrammarUiTestLanguageTerminalAlternativesConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
