...
import org.eclipse.xtext.services.XtextGrammarUiTestLanguageGrammarAccess.ParenthesizedElementElements;

public final class XtextGrammarUiTestLanguageParenthesizedElementConsumer extends NonTerminalConsumer {
	...
	protected class RuleCall$3$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeNonTerminal(alternativesConsumer, null, false, false, false, getElement(), optional);
		}
	}
	...
	public XtextGrammarUiTestLanguageParenthesizedElementConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
