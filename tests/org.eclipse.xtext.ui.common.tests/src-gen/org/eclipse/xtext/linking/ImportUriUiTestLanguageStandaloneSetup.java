...
public class ImportUriUiTestLanguageStandaloneSetup implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new org.eclipse.xtext.linking.ImportUriUiTestLanguageRuntimeModule());
	}
	
	public void register(Injector injector) {
	if (!EPackage.Registry.INSTANCE.containsKey("http://eclipse.org/xtext/importUriUiTestLanguage")) {
		EPackage.Registry.INSTANCE.put("http://eclipse.org/xtext/importUriUiTestLanguage", org.eclipse.xtext.linking.importUriUi.ImportUriUiPackage.eINSTANCE);
	}
