...
import org.eclipse.xtext.enumrules.enumRulesUiTestLanguage.EnumRulesUiTestLanguagePackage;
 ...
 * <ul>
 *   <li>{@link org.eclipse.xtext.enumrules.enumRulesUiTestLanguage.impl.ModelImpl#getExisting <em>Existing</em>}</li>
 *   <li>{@link org.eclipse.xtext.enumrules.enumRulesUiTestLanguage.impl.ModelImpl#getGenerated <em>Generated</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ModelImpl extends MinimalEObjectImpl.Container implements Model
{
  ...
  {
    return EnumRulesUiTestLanguagePackage.Literals.MODEL;
  }
  ...
  public void setExisting(ExistingEnum newExisting)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EnumRulesUiTestLanguagePackage.MODEL__EXISTING, oldExisting, existing));
  }
  ...
  public void setGenerated(GeneratedEnum newGenerated)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EnumRulesUiTestLanguagePackage.MODEL__GENERATED, oldGenerated, generated));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case EnumRulesUiTestLanguagePackage.MODEL__EXISTING:
        return getExisting();
      case EnumRulesUiTestLanguagePackage.MODEL__GENERATED:
        return getGenerated();
    }
