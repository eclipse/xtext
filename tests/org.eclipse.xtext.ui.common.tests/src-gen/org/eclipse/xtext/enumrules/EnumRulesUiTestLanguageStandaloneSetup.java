 ...
 */
public class EnumRulesUiTestLanguageStandaloneSetup implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new org.eclipse.xtext.enumrules.EnumRulesUiTestLanguageRuntimeModule());
	}
	
	public void register(Injector injector) {
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.eclipse.org/2009/xtext/ui/common/tests/EnumRulesTest")) {
		EPackage.Registry.INSTANCE.put("http://www.eclipse.org/2009/xtext/ui/common/tests/EnumRulesTest", org.eclipse.xtext.enumrules.enumRulesUiTestLanguage.EnumRulesUiTestLanguagePackage.eINSTANCE);
	}
