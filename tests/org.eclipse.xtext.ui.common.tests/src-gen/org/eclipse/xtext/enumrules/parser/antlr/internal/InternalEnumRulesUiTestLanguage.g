...
@parser::members {
    ...
    public InternalEnumRulesUiTestLanguageParser(TokenStream input, IAstFactory factory, EnumRulesUiTestLanguageGrammarAccess grammarAccess) {
        this(input);
    ...
    protected InputStream getTokenFile() {
    	...
    	return classLoader.getResourceAsStream("org/eclipse/xtext/enumrules/parser/antlr/internal/InternalEnumRulesUiTestLanguage.tokens");
    }
