...
import org.eclipse.xtext.xtextUiTest.AbstractMetamodelDeclaration;
import org.eclipse.xtext.xtextUiTest.TypeRef;
 ...
 * <ul>
 *   <li>{@link org.eclipse.xtext.xtextUiTest.impl.TypeRefImpl#getMetamodel <em>Metamodel</em>}</li>
 *   <li>{@link org.eclipse.xtext.xtextUiTest.impl.TypeRefImpl#getClassifier <em>Classifier</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TypeRefImpl extends MinimalEObjectImpl.Container implements TypeRef
{
  ...
  {
    return XtextUiTestPackage.Literals.TYPE_REF;
  }
    ...
    if (metamodel != null && metamodel.eIsProxy())
    {
      ...
      if (metamodel != oldMetamodel)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, XtextUiTestPackage.TYPE_REF__METAMODEL, oldMetamodel, metamodel));
      }
    }
    return metamodel;
  }
  ...
  public void setMetamodel(AbstractMetamodelDeclaration newMetamodel)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XtextUiTestPackage.TYPE_REF__METAMODEL, oldMetamodel, metamodel));
  }
  ...
  public EClassifier getClassifier()
  {
    if (classifier != null && classifier.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, XtextUiTestPackage.TYPE_REF__CLASSIFIER, oldClassifier, classifier));
      }
    }
    return classifier;
  }
  ...
  public void setClassifier(EClassifier newClassifier)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XtextUiTestPackage.TYPE_REF__CLASSIFIER, oldClassifier, classifier));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case XtextUiTestPackage.TYPE_REF__METAMODEL:
        if (resolve) return getMetamodel();
        return basicGetMetamodel();
      case XtextUiTestPackage.TYPE_REF__CLASSIFIER:
