 ...
 * <ul>
 *   <li>{@link org.eclipse.xtext.xtextUiTest.impl.AbstractElementImpl#getCardinality <em>Cardinality</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class AbstractElementImpl extends MinimalEObjectImpl.Container implements AbstractElement
{
  ...
  {
    return XtextUiTestPackage.Literals.ABSTRACT_ELEMENT;
  }
  ...
  public void setCardinality(String newCardinality)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XtextUiTestPackage.ABSTRACT_ELEMENT__CARDINALITY, oldCardinality, cardinality));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case XtextUiTestPackage.ABSTRACT_ELEMENT__CARDINALITY:
