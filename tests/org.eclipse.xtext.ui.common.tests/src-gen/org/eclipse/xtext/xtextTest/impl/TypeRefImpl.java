...
public class TypeRefImpl extends MinimalEObjectImpl.Container implements TypeRef
{
  ...
  public EClassifier getClassifier()
  {
    if (classifier != null && classifier.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, XtextTestPackage.TYPE_REF__CLASSIFIER, oldClassifier, classifier));
      }
    }
    return classifier;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      ...
      case XtextTestPackage.TYPE_REF__CLASSIFIER:
