    ...
    if (_isGenerateXtendStubs) {
      ...
      StringConcatenationClient _client_1 = new StringConcatenationClient() {
        ...
        protected void appendTo(StringConcatenationClient.TargetStringConcatenation _builder) {
          ...
          _builder.append("\t");
          _builder.append("public ");
          TypeReference _ideModule_1 = XtextGeneratorTemplates.this.naming.getIdeModule(it);
          String _simpleName_1 = _ideModule_1.getSimpleName();
          _builder.append(_simpleName_1, "\t");
          _builder.append("() {");
          _builder.newLineIfNotEmpty();
          _builder.append("\t\t");
          ...
          _builder.append("\t");
          _builder.append("public ");
          TypeReference _ideModule_2 = XtextGeneratorTemplates.this.naming.getIdeModule(it);
          String _simpleName_2 = _ideModule_2.getSimpleName();
  ...
  public JavaFileAccess createIdeGenModule(final IXtextGeneratorLanguage langConfig) {
    ...
    StringConcatenationClient _client_1 = new StringConcatenationClient() {
      ...
      protected void appendTo(StringConcatenationClient.TargetStringConcatenation _builder) {
        ...
        _builder.append("\t");
        _builder.append("public ");
        TypeReference _ideGenModule_1 = XtextGeneratorTemplates.this.naming.getIdeGenModule(it);
        String _simpleName_1 = _ideGenModule_1.getSimpleName();
        _builder.append(_simpleName_1, "\t");
        _builder.append("() {");
        _builder.newLineIfNotEmpty();
        _builder.append("\t\t");
        ...
        _builder.append("\t");
        _builder.append("public ");
        TypeReference _ideGenModule_2 = XtextGeneratorTemplates.this.naming.getIdeGenModule(it);
        String _simpleName_2 = _ideGenModule_2.getSimpleName();
        _builder.append(_simpleName_2, "\t");
        _builder.append("(");
        _builder.append(Provider.class, "\t");
        _builder.append("<");
        ...
        _builder.newLine();
        {
          GuiceModuleAccess _ideGenModule_3 = langConfig.getIdeGenModule();
          Set<GuiceModuleAccess.Binding> _bindings = _ideGenModule_3.getBindings();
          for(final GuiceModuleAccess.Binding binding : _bindings) {
            _builder.append("\t");
            StringConcatenationClient _createBindingMethod = XtextGeneratorTemplates.this.createBindingMethod(binding);
            _builder.append(_createBindingMethod, "\t");
    ...
    if (_isGenerateXtendStubs) {
      ...
      StringConcatenationClient _client_1 = new StringConcatenationClient() {
        ...
        protected void appendTo(StringConcatenationClient.TargetStringConcatenation _builder) {
          ...
          _builder.append("\t");
          _builder.append("public ");
          TypeReference _webModule_1 = XtextGeneratorTemplates.this.naming.getWebModule(it);
          ...
          _builder.append("\t");
          _builder.append("public ");
          TypeReference _webModule_2 = XtextGeneratorTemplates.this.naming.getWebModule(it);
          String _simpleName_2 = _webModule_2.getSimpleName();
          _builder.append(_simpleName_2, "\t");
          _builder.append("(");
          _builder.append(Provider.class, "\t");
          _builder.append("<");
  ...
  public JavaFileAccess createWebGenModule(final IXtextGeneratorLanguage langConfig) {
    ...
    StringConcatenationClient _client_1 = new StringConcatenationClient() {
      ...
      protected void appendTo(StringConcatenationClient.TargetStringConcatenation _builder) {
        ...
        _builder.append("\t");
        _builder.append("public ");
        TypeReference _webGenModule_2 = XtextGeneratorTemplates.this.naming.getWebGenModule(it);
        String _simpleName_2 = _webGenModule_2.getSimpleName();
        _builder.append(_simpleName_2, "\t");
        _builder.append("(");
        _builder.append(Provider.class, "\t");
        _builder.append("<");
        ...
        _builder.newLine();
        {
          GuiceModuleAccess _webGenModule_3 = langConfig.getWebGenModule();
          Set<GuiceModuleAccess.Binding> _bindings = _webGenModule_3.getBindings();
          for(final GuiceModuleAccess.Binding binding : _bindings) {
            _builder.append("\t");
            StringConcatenationClient _createBindingMethod = XtextGeneratorTemplates.this.createBindingMethod(binding);
            _builder.append(_createBindingMethod, "\t");
    ...
    if (_isGenerateXtendStubs) {
      ...
      StringConcatenationClient _client = new StringConcatenationClient() {
        ...
        protected void appendTo(StringConcatenationClient.TargetStringConcatenation _builder) {
          ...
          _builder.newLineIfNotEmpty();
          _builder.append("\t\t");
          _builder.append("val ideModule = new ");
          TypeReference _ideModule = XtextGeneratorTemplates.this.naming.getIdeModule(it);
          _builder.append(_ideModule, "\t\t");
          _builder.append("(executorServiceProvider)");
          _builder.newLineIfNotEmpty();
          ...
          _builder.append(".createInjector(");
          _builder.append(Modules2.class, "\t\t");
          _builder.append(".mixin(runtimeModule, ideModule, webModule))");
          _builder.newLineIfNotEmpty();
          _builder.append("\t");
          _builder.append("}");
          _builder.newLine();
      ...
      StringConcatenationClient _client_1 = new StringConcatenationClient() {
        ...
        protected void appendTo(StringConcatenationClient.TargetStringConcatenation _builder) {
          ...
          _builder.newLine();
          _builder.append("\t");
          TypeReference _webSetup_1 = XtextGeneratorTemplates.this.naming.getWebSetup(it);
          ...
          TypeReference _runtimeModule_1 = XtextGeneratorTemplates.this.naming.getRuntimeModule(it);
          ...
          TypeReference _ideModule = XtextGeneratorTemplates.this.naming.getIdeModule(it);
          _builder.append(_ideModule, "\t\t");
          _builder.append(" ideModule = new ");
          TypeReference _ideModule_1 = XtextGeneratorTemplates.this.naming.getIdeModule(it);
          _builder.append(_ideModule_1, "\t\t");
          _builder.append("(executorServiceProvider);");
          _builder.newLineIfNotEmpty();
          _builder.append("\t\t");
          TypeReference _webModule = XtextGeneratorTemplates.this.naming.getWebModule(it);
