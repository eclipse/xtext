    ...
    JavaFileAccess _xblockexpression = null;
    {
      ...
      StringConcatenationClient _client = new StringConcatenationClient() {
        ...
        protected void appendTo(StringConcatenationClient.TargetStringConcatenation _builder) {
          ...
          String _simpleName = Junit4Fragment2.this.injectorProvider().getSimpleName();
          ...
          TypeReference _runtimeSetup = Junit4Fragment2.this._xtextGeneratorNaming.getRuntimeSetup(Junit4Fragment2.this.getGrammar());
          ...
          _builder.append("\t");
          _builder.append("protected ");
          TypeReference _runtimeModule = Junit4Fragment2.this._xtextGeneratorNaming.getRuntimeModule(Junit4Fragment2.this.getGrammar());
          ...
          _builder.append("\t\t");
          _builder.append("return new ");
          TypeReference _runtimeModule_1 = Junit4Fragment2.this._xtextGeneratorNaming.getRuntimeModule(Junit4Fragment2.this.getGrammar());
          ...
          _builder.append("\t\t\t\t");
          _builder.append("return ");
          String _simpleName_1 = Junit4Fragment2.this.injectorProvider().getSimpleName();
