...
public class BinaryOpExpressionImpl extends ExpressionImpl implements BinaryOpExpression
{
  ...
  {
    return BeeLangTestLanguagePackage.Literals.BINARY_OP_EXPRESSION;
  }
  ...
  public void setLeftExpr(Expression newLeftExpr)
  {
    if (newLeftExpr != leftExpr)
    {
      ...
      if (leftExpr != null)
        msgs = ((InternalEObject)leftExpr).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BeeLangTestLanguagePackage.BINARY_OP_EXPRESSION__LEFT_EXPR, null, msgs);
      if (newLeftExpr != null)
        msgs = ((InternalEObject)newLeftExpr).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BeeLangTestLanguagePackage.BINARY_OP_EXPRESSION__LEFT_EXPR, null, msgs);
      msgs = basicSetLeftExpr(newLeftExpr, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BeeLangTestLanguagePackage.BINARY_OP_EXPRESSION__LEFT_EXPR, newLeftExpr, newLeftExpr));
  }
  ...
  public void setFunctionName(String newFunctionName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BeeLangTestLanguagePackage.BINARY_OP_EXPRESSION__FUNCTION_NAME, oldFunctionName, functionName));
  }
  ...
  public void setRightExpr(Expression newRightExpr)
  {
    if (newRightExpr != rightExpr)
    {
      NotificationChain msgs = null;
      if (rightExpr != null)
        msgs = ((InternalEObject)rightExpr).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BeeLangTestLanguagePackage.BINARY_OP_EXPRESSION__RIGHT_EXPR, null, msgs);
      if (newRightExpr != null)
        msgs = ((InternalEObject)newRightExpr).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BeeLangTestLanguagePackage.BINARY_OP_EXPRESSION__RIGHT_EXPR, null, msgs);
      msgs = basicSetRightExpr(newRightExpr, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, BeeLangTestLanguagePackage.BINARY_OP_EXPRESSION__RIGHT_EXPR, newRightExpr, newRightExpr));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case BeeLangTestLanguagePackage.BINARY_OP_EXPRESSION__LEFT_EXPR:
        return basicSetLeftExpr(null, msgs);
      case BeeLangTestLanguagePackage.BINARY_OP_EXPRESSION__RIGHT_EXPR:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case BeeLangTestLanguagePackage.BINARY_OP_EXPRESSION__LEFT_EXPR:
        return getLeftExpr();
      case BeeLangTestLanguagePackage.BINARY_OP_EXPRESSION__FUNCTION_NAME:
