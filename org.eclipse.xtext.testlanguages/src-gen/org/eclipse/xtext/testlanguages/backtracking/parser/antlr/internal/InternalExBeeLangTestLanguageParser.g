...
options {
	tokenVocab=InternalExBeeLangTestLanguageLexer;
			...
			(
				(
					...
					(
						...
						(
							(
								lv_varArgs_11_0=FullStopFullStopFullStop
								{
				...
				(
					(
						(
							lv_varArgs_13_0=FullStopFullStopFullStop
							{
...
@after {
	...
	(
		...
		(
			(
				...
				(
					...
					(
						(
							lv_varArgs_5_0=FullStopFullStopFullStop
							{
			...
			(
				(
					(
						lv_varArgs_7_0=FullStopFullStopFullStop
						{
		...
		otherlv_10=EqualsSignGreaterThanSign
		{
				...
				(
					(
						...
						}
						{
						    ...
						    |
						lv_functionName_2_2=HyphenMinus
						{
				...
				(
					(
						...
						}
						{
						    ...
						    |
						lv_functionName_2_3=PercentSign
						{
...
@after {
	...
	(
		...
		(
			...
			(
				(
					lv_functionName_2_0=FullStopFullStop
					{
...
@after {
	...
	(
		...
		(
			(
				(
					lv_functionName_1_1=ExclamationMark
					{
					...
					}
					{
					    ...
					    |
					lv_functionName_1_2=HyphenMinus
					{
...
@after {
	...
	(
		...
		(
			(
				(
					lv_functionName_1_1=PlusSignPlusSign
					{
					...
					}
					{
					    ...
					    |
					lv_functionName_1_2=HyphenMinusHyphenMinus
					{
	...
	(
		...
		(
			...
			(
				(
					(
						lv_functionName_2_1=HyphenMinusHyphenMinus
						{
						...
						}
						{
						    ...
						    |
						lv_functionName_2_2=PlusSignPlusSign
						{
			...
			(
				...
				(
					...
					(
						...
						(
							(
								lv_varArgs_9_0=FullStopFullStopFullStop
								{
