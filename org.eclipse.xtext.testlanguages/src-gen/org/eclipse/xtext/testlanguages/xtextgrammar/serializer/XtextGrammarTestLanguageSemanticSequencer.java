...
import org.eclipse.xtext.testlanguages.xtextgrammar.xtextGrammarTest.Alternatives;
...
import org.eclipse.xtext.testlanguages.xtextgrammar.xtextGrammarTest.GeneratedMetamodel;
...
public class XtextGrammarTestLanguageSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	protected void sequence_CharacterRange(ISerializationContext context, CharacterRange semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, XtextGrammarTestPackage.Literals.CHARACTER_RANGE__LEFT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, XtextGrammarTestPackage.Literals.CHARACTER_RANGE__LEFT));
			if (transientValues.isValueTransient(semanticObject, XtextGrammarTestPackage.Literals.CHARACTER_RANGE__RIGHT) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, XtextGrammarTestPackage.Literals.CHARACTER_RANGE__RIGHT));
		}
	...
	protected void sequence_Keyword(ISerializationContext context, Keyword semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, XtextGrammarTestPackage.Literals.KEYWORD__VALUE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, XtextGrammarTestPackage.Literals.KEYWORD__VALUE));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
