...
import org.eclipse.xtext.testlanguages.xtextgrammar.xtextGrammarTest.AbstractMetamodelDeclaration;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.xtext.testlanguages.xtextgrammar.xtextGrammarTest.impl.TypeRefImpl#getMetamodel <em>Metamodel</em>}</li>
 *   <li>{@link org.eclipse.xtext.testlanguages.xtextgrammar.xtextGrammarTest.impl.TypeRefImpl#getClassifier <em>Classifier</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TypeRefImpl extends MinimalEObjectImpl.Container implements TypeRef
{
  ...
  {
    return XtextGrammarTestPackage.Literals.TYPE_REF;
  }
    ...
    if (metamodel != null && metamodel.eIsProxy())
    {
      ...
      if (metamodel != oldMetamodel)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, XtextGrammarTestPackage.TYPE_REF__METAMODEL, oldMetamodel, metamodel));
      }
    }
    return metamodel;
  }
  ...
  public void setMetamodel(AbstractMetamodelDeclaration newMetamodel)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XtextGrammarTestPackage.TYPE_REF__METAMODEL, oldMetamodel, metamodel));
  }
  ...
  public EClassifier getClassifier()
  {
    if (classifier != null && classifier.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, XtextGrammarTestPackage.TYPE_REF__CLASSIFIER, oldClassifier, classifier));
      }
    }
    return classifier;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case XtextGrammarTestPackage.TYPE_REF__METAMODEL:
        if (resolve) return getMetamodel();
        return basicGetMetamodel();
      case XtextGrammarTestPackage.TYPE_REF__CLASSIFIER:
