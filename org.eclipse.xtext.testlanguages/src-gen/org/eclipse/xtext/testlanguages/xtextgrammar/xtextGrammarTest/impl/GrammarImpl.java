...
import org.eclipse.xtext.testlanguages.xtextgrammar.xtextGrammarTest.Grammar;
 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.xtext.testlanguages.xtextgrammar.xtextGrammarTest.impl.GrammarImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.xtext.testlanguages.xtextgrammar.xtextGrammarTest.impl.GrammarImpl#getUsedGrammars <em>Used Grammars</em>}</li>
 *   <li>{@link org.eclipse.xtext.testlanguages.xtextgrammar.xtextGrammarTest.impl.GrammarImpl#isDefinesHiddenTokens <em>Defines Hidden Tokens</em>}</li>
 *   <li>{@link org.eclipse.xtext.testlanguages.xtextgrammar.xtextGrammarTest.impl.GrammarImpl#getHiddenTokens <em>Hidden Tokens</em>}</li>
 *   <li>{@link org.eclipse.xtext.testlanguages.xtextgrammar.xtextGrammarTest.impl.GrammarImpl#getMetamodelDeclarations <em>Metamodel Declarations</em>}</li>
 *   <li>{@link org.eclipse.xtext.testlanguages.xtextgrammar.xtextGrammarTest.impl.GrammarImpl#getRules <em>Rules</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GrammarImpl extends MinimalEObjectImpl.Container implements Grammar
{
  ...
  {
    return XtextGrammarTestPackage.Literals.GRAMMAR;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XtextGrammarTestPackage.GRAMMAR__NAME, oldName, name));
  }
  ...
  public EList<Grammar> getUsedGrammars()
  {
    ...
    {
      usedGrammars = new EObjectResolvingEList<Grammar>(Grammar.class, this, XtextGrammarTestPackage.GRAMMAR__USED_GRAMMARS);
    }
    return usedGrammars;
  }
  ...
  public void setDefinesHiddenTokens(boolean newDefinesHiddenTokens)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, XtextGrammarTestPackage.GRAMMAR__DEFINES_HIDDEN_TOKENS, oldDefinesHiddenTokens, definesHiddenTokens));
  }
  ...
  public EList<AbstractRule> getHiddenTokens()
  {
    ...
    {
      hiddenTokens = new EObjectResolvingEList<AbstractRule>(AbstractRule.class, this, XtextGrammarTestPackage.GRAMMAR__HIDDEN_TOKENS);
    }
    return hiddenTokens;
  }
  ...
  public EList<AbstractMetamodelDeclaration> getMetamodelDeclarations()
  {
    ...
    {
      metamodelDeclarations = new EObjectContainmentEList<AbstractMetamodelDeclaration>(AbstractMetamodelDeclaration.class, this, XtextGrammarTestPackage.GRAMMAR__METAMODEL_DECLARATIONS);
    }
  ...
  public EList<AbstractRule> getRules()
  {
    if (rules == null)
    {
      rules = new EObjectContainmentEList<AbstractRule>(AbstractRule.class, this, XtextGrammarTestPackage.GRAMMAR__RULES);
    }
    return rules;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case XtextGrammarTestPackage.GRAMMAR__METAMODEL_DECLARATIONS:
        return ((InternalEList<?>)getMetamodelDeclarations()).basicRemove(otherEnd, msgs);
      case XtextGrammarTestPackage.GRAMMAR__RULES:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case XtextGrammarTestPackage.GRAMMAR__NAME:
        return getName();
      case XtextGrammarTestPackage.GRAMMAR__USED_GRAMMARS:
        return getUsedGrammars();
      case XtextGrammarTestPackage.GRAMMAR__DEFINES_HIDDEN_TOKENS:
        return isDefinesHiddenTokens();
      case XtextGrammarTestPackage.GRAMMAR__HIDDEN_TOKENS:
