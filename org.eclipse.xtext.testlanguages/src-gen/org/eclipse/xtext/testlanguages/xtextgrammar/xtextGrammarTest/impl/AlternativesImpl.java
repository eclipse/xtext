 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.xtext.testlanguages.xtextgrammar.xtextGrammarTest.impl.AlternativesImpl#getGroups <em>Groups</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AlternativesImpl extends AbstractElementImpl implements Alternatives
{
  ...
  {
    return XtextGrammarTestPackage.Literals.ALTERNATIVES;
  }
  ...
  public EList<AbstractElement> getGroups()
  {
    if (groups == null)
    {
      groups = new EObjectContainmentEList<AbstractElement>(AbstractElement.class, this, XtextGrammarTestPackage.ALTERNATIVES__GROUPS);
    }
    return groups;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case XtextGrammarTestPackage.ALTERNATIVES__GROUPS:
