 ...
 * @generated
 */
public class XtextGrammarTestSwitch<T> extends Switch<T>
{
  /**
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case XtextGrammarTestPackage.ABSTRACT_RULE:
      {
      ...
      case XtextGrammarTestPackage.ABSTRACT_METAMODEL_DECLARATION:
      {
      ...
      case XtextGrammarTestPackage.ABSTRACT_ELEMENT:
      {
      ...
      case XtextGrammarTestPackage.ABSTRACT_NEGATED_TOKEN:
      {
