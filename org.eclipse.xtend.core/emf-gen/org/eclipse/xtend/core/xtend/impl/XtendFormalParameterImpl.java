...
public class XtendFormalParameterImpl extends JvmFormalParameterImplCustom implements XtendFormalParameter
{
	 ...
	 * @generated
	 */
	protected XtendFormalParameterImpl()
	{
		super();
	}
	...
	public void setExtension(boolean newExtension)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XtendPackage.XTEND_FORMAL_PARAMETER__EXTENSION, oldExtension, extension));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType)
	{
		switch (featureID)
		{
			case XtendPackage.XTEND_FORMAL_PARAMETER__EXTENSION:
				return isExtension();
		}
