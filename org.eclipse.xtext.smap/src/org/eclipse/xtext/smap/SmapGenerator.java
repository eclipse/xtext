...
public class SmapGenerator {
	 ...
	 *            if <tt>true</tt>, this SmapStratum is considered to represent the default SMAP stratum unless
	 *            overwritten
	 */
	 ...
	 *            the SMAP to embed
	 * @param stratumName
	 *            the name of the stratum output by the compilation that produced the <tt>smap</tt> to be embedded
	 */
	...
	/**
	 * Instructs the SmapGenerator whether to actually print any embedded SMAPs or not. Intended for situations without
	 * an SMAP resolver.
	 * 
	 * @param status
