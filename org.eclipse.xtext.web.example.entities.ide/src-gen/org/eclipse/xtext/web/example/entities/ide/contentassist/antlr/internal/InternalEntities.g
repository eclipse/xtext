...
:
(
	{ before(grammarAccess.getEntitiesAccess().getImportSectionAssignment_0()); }
...
:
	(
		{ before(grammarAccess.getEntitiesAccess().getImportSectionXImportSectionParserRuleCall_0_0()); }
		ruleXImportSection
		{ after(grammarAccess.getEntitiesAccess().getImportSectionXImportSectionParserRuleCall_0_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
...
:
	(
		{ before(grammarAccess.getEntitiesAccess().getElementsAbstractElementParserRuleCall_1_0()); }
		ruleAbstractElement
		{ after(grammarAccess.getEntitiesAccess().getElementsAbstractElementParserRuleCall_1_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
...
:
	(
		...
		ruleJvmParameterizedTypeReference
		{ after(grammarAccess.getEntityAccess().getSuperTypeJvmParameterizedTypeReferenceParserRuleCall_2_1_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
