...
/**
 * This is the item provider adapter for a {@link org.eclipse.xtext.common.types.FormalParameter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FormalParameterItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FormalParameter_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FormalParameter_name_feature", "_UI_FormalParameter_type"),
				 TypesPackage.Literals.FORMAL_PARAMETER__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TypesPackage.Literals.FORMAL_PARAMETER__PARAMETER_TYPE);
		}
