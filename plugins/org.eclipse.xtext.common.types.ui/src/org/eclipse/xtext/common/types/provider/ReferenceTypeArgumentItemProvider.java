		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ReferenceTypeArgument_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ReferenceTypeArgument_type_feature", "_UI_ReferenceTypeArgument_type"),
				 TypesPackage.Literals.REFERENCE_TYPE_ARGUMENT__TYPE,
				 true,
				 false,
				 true,
				 null,
