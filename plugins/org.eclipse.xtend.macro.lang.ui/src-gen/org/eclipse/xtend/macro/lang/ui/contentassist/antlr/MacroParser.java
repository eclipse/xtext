...
* generated by Xtext
*/
package org.eclipse.xtend.macro.lang.ui.contentassist.antlr;
...
public class MacroParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.eclipse.xtend.macro.lang.ui.contentassist.antlr.internal.InternalMacroParser createParser() {
		org.eclipse.xtend.macro.lang.ui.contentassist.antlr.internal.InternalMacroParser result = new org.eclipse.xtend.macro.lang.ui.contentassist.antlr.internal.InternalMacroParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getMacroFileAccess().getGroup_0(), "rule__MacroFile__Group_0__0");
					put(grammarAccess.getClassDeclarationAccess().getGroup(), "rule__ClassDeclaration__Group__0");
					put(grammarAccess.getMacroAnnotationAccess().getGroup(), "rule__MacroAnnotation__Group__0");
					put(grammarAccess.getMacroAnnotationAccess().getGroup_2(), "rule__MacroAnnotation__Group_2__0");
					put(grammarAccess.getMacroAnnotationAccess().getGroup_2_2(), "rule__MacroAnnotation__Group_2_2__0");
					put(grammarAccess.getFieldAccess().getGroup(), "rule__Field__Group__0");
					put(grammarAccess.getFieldAccess().getGroup_3(), "rule__Field__Group_3__0");
					put(grammarAccess.getRegistratorAccess().getGroup(), "rule__Registrator__Group__0");
					...
					put(grammarAccess.getMacroFileAccess().getImportsAssignment_1(), "rule__MacroFile__ImportsAssignment_1");
					...
					put(grammarAccess.getClassDeclarationAccess().getMembersAssignment_3(), "rule__ClassDeclaration__MembersAssignment_3");
					put(grammarAccess.getMacroAnnotationAccess().getNameAssignment_1(), "rule__MacroAnnotation__NameAssignment_1");
					put(grammarAccess.getMacroAnnotationAccess().getTargetTypeAssignment_2_1(), "rule__MacroAnnotation__TargetTypeAssignment_2_1");
					put(grammarAccess.getMacroAnnotationAccess().getTargetTypeAssignment_2_2_1(), "rule__MacroAnnotation__TargetTypeAssignment_2_2_1");
					put(grammarAccess.getMacroAnnotationAccess().getMembersAssignment_4(), "rule__MacroAnnotation__MembersAssignment_4");
					put(grammarAccess.getFieldAccess().getStaticAssignment_0(), "rule__Field__StaticAssignment_0");
					...
					put(grammarAccess.getProcessorAccess().getExpressionAssignment_1(), "rule__Processor__ExpressionAssignment_1");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.eclipse.xtend.macro.lang.ui.contentassist.antlr.internal.InternalMacroParser typedParser = (org.eclipse.xtend.macro.lang.ui.contentassist.antlr.internal.InternalMacroParser) parser;
			typedParser.entryRuleMacroFile();
