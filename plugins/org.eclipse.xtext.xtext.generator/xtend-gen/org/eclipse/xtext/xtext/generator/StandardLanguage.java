...
public class StandardLanguage extends LanguageConfig2 {
  ...
  public void initialize(final Injector injector) {
    ...
    final ArrayList<IGeneratorFragment2> configuredFragments = new ArrayList<IGeneratorFragment2>(_fragments);
    List<IGeneratorFragment2> _fragments_1 = this.getFragments();
    _fragments_1.clear();
    this.addFragment(this.grammarAccess);
    this.addFragment(this.emfGenerator);
    this.addFragment(this.resourceFactoryFragment);
    this.addFragment(this.serializer);
    this.addFragment(this.parserGenerator);
    this.addFragment(this.validator);
    this.addFragment(this.formatter);
    this.addFragment(this.generator);
    this.addFragment(this.builder);
    this.addFragment(this.scopeProvider);
    this.addFragment(this.qualifiedNamesProvider);
    this.addFragment(this.commonTypesSupport);
    this.addFragment(this.xtypeSupport);
    this.addFragment(this.xbaseSupport);
    this.addFragment(this.junitSupport);
    this.addFragment(this.quickFixProvider);
    this.addFragment(this.labelProvider);
    this.addFragment(this.outline);
    this.addFragment(this.quickOutline);
    this.addFragment(this.compareEditor);
    this.addFragment(this.contentAssist);
    this.addFragment(this.renameRefactoring);
    this.addFragment(this.codeTemplates);
    this.addFragment(this.ideaParser);
    this.addFragment(this.ideaPlugin);
    this.addFragment(this.webSupport);
    List<IGeneratorFragment2> _fragments_2 = this.getFragments();
    _fragments_2.addAll(configuredFragments);
