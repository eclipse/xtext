...
public class ProjectConfigGenerator {
  ...
  public CharSequence generateImpl() {
    ...
    _builder.append("\t");
    _builder.append("private String orionJsGenPath;");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("private String aceJsGenPath;");
    _builder.newLine();
    _builder.append("\t");
    _builder.newLine();
    _builder.append("\t");
    ...
    _builder.newLine();
    {
      for(final String p_1 : ProjectConfigGenerator.PROJECTS) {
        ...
        _builder.append("if (");
        _builder.append(p_1, "\t\t");
        _builder.append("SrcPath != null)");
        _builder.newLineIfNotEmpty();
        _builder.append("\t");
        _builder.append("\t\t");
        _builder.append("return new FileSystemAccess(");
        _builder.append(p_1, "\t\t\t");
        _builder.append("SrcPath, encodingProvider);");
        _builder.newLineIfNotEmpty();
        _builder.append("\t");
        _builder.append("\t");
        ...
        _builder.append("if (");
        _builder.append(p_1, "\t\t");
        _builder.append("SrcGenPath != null)");
        _builder.newLineIfNotEmpty();
        _builder.append("\t");
        _builder.append("\t\t");
        _builder.append("return new FileSystemAccess(");
        _builder.append(p_1, "\t\t\t");
        _builder.append("SrcGenPath, encodingProvider);");
        _builder.newLineIfNotEmpty();
        _builder.append("\t");
        _builder.append("\t");
        _builder.append("else");
        ...
        _builder.append("this.");
        _builder.append(p_1, "\t\t");
        _builder.append("SrcGenPath = path;");
        _builder.newLineIfNotEmpty();
        _builder.append("\t");
        _builder.append("}");
        _builder.newLine();
        ...
        _builder.append("this.");
        _builder.append(p_1, "\t\t");
        _builder.append("ManifestAccess = manifest;");
        _builder.newLineIfNotEmpty();
        _builder.append("\t");
        _builder.append("}");
        _builder.newLine();
        ...
        _builder.append("if (");
        _builder.append(p_1, "\t\t");
        _builder.append("ModuleAccess == null) {");
        _builder.newLineIfNotEmpty();
        _builder.append("\t");
        _builder.append("\t\t");
        _builder.append(p_1, "\t\t\t");
        _builder.append("ModuleAccess = new ModuleAccess(get");
        ...
        _builder.append("this.");
        _builder.append(p_1, "\t\t\t");
        _builder.append("PluginXmlAccess = new TextFileAccess();");
        _builder.newLineIfNotEmpty();
        _builder.append("\t");
        _builder.append("\t\t");
        _builder.append("this.");
        _builder.append(p_1, "\t\t\t");
        _builder.append("PluginXmlAccess.setPath(path);");
        _builder.newLineIfNotEmpty();
        _builder.append("\t");
        _builder.append("\t");
        _builder.append("} else {");
        ...
        _builder.append("this.");
        _builder.append(p_1, "\t\t\t");
        _builder.append("PluginXmlAccess = null;");
        _builder.newLineIfNotEmpty();
        _builder.append("\t");
        _builder.append("\t");
        _builder.append("}");
        ...
        String _firstUpper_9 = StringExtensions.toFirstUpper(p_1);
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("if (orionJsGenPath != null)");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("return new FileSystemAccess(orionJsGenPath, encodingProvider);");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("else");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("this.orionJsGenPath = path;");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("if (aceJsGenPath != null)");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("return new FileSystemAccess(aceJsGenPath, encodingProvider);");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("else");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("this.aceJsGenPath = path;");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("}");
    _builder.newLine();
