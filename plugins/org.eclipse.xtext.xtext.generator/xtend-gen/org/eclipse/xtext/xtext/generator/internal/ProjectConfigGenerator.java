  ...
  public CharSequence generateInterface() {
    ...
    _builder.newLine();
    {
      for(final String p : ProjectConfigGenerator.PROJECTS) {
        ...
        _builder.newLineIfNotEmpty();
        _builder.append("\t");
        _builder.append("TextFileAccess get");
  ...
  public CharSequence generateImpl() {
    ...
    _builder.newLine();
    {
      for(final String p : ProjectConfigGenerator.PROJECTS) {
        ...
        _builder.newLineIfNotEmpty();
        _builder.append("\t");
        _builder.append("private TextFileAccess ");
        _builder.append(p, "\t");
        _builder.append("PluginXml;");
        _builder.newLineIfNotEmpty();
      }
    ...
    _builder.newLine();
    {
      for(final String p_2 : ProjectConfigGenerator.PROJECTS) {
        ...
        _builder.append("\t");
        _builder.append("public IFileSystemAccess2 get");
        String _firstUpper_2 = StringExtensions.toFirstUpper(p_2);
        _builder.append(_firstUpper_2, "\t");
        _builder.append("SrcGen() {");
        _builder.newLineIfNotEmpty();
        _builder.append("\t");
        ...
        _builder.append("\t");
        _builder.append("public void set");
        String _firstUpper_3 = StringExtensions.toFirstUpper(p_2);
        _builder.append(_firstUpper_3, "\t");
        ...
        String _firstUpper_4 = StringExtensions.toFirstUpper(p_2);
        ...
        _builder.append("\t");
        _builder.append("public void set");
        String _firstUpper_5 = StringExtensions.toFirstUpper(p_2);
        ...
        _builder.append("\t");
        _builder.append("public void set");
        String _firstUpper_6 = StringExtensions.toFirstUpper(p_2);
        ...
        _builder.append("this.");
        _builder.append(p_2, "\t\t\t");
        _builder.append("PluginXml = new TextFileAccess();");
        _builder.newLineIfNotEmpty();
        _builder.append("\t");
        _builder.append("\t\t");
        _builder.append("this.");
        _builder.append(p_2, "\t\t\t");
        _builder.append("PluginXml.setPath(path);");
        _builder.newLineIfNotEmpty();
        _builder.append("\t");
        _builder.append("\t");
        ...
        _builder.newLine();
        _builder.append("\t");
        _builder.append("public TextFileAccess get");
        String _firstUpper_7 = StringExtensions.toFirstUpper(p_2);
