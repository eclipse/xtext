...
public class XbaseEditor extends XtextEditor {
	...
	private IClipboardActionFactory clipboardActionsFactory;
	...
	/* 
	 * replace cut/copy/paste actions with a version that provided by the factory if any injected
	 */
	protected void createClipboardActions() {
		if (clipboardActionsFactory != null) {
			ResourceBundle bundle = XbaseEditorMessages.getBundleForConstructedKeys();
			TextEditorAction action = clipboardActionsFactory.create(bundle,
