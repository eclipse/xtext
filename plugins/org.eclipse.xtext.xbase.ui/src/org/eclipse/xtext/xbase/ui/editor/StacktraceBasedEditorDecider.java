...
public class StacktraceBasedEditorDecider {
	...
	private boolean isOpenGeneratedCode(StackTraceElement element) {
		return ("org.eclipse.xtext.ui.generator.trace.AbstractOpenOppositeFileHandler".equals(element.getClassName()) || "org.eclipse.xtext.xbase.ui.generator.trace.XbaseOpenGeneratedFileHandler"
				.equals(element.getClassName())) && "execute".equals(element.getMethodName());
	}
