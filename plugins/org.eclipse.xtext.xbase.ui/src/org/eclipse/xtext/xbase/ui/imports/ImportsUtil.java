...
public class ImportsUtil {
	...
	public Triple<Set<String>, Set<String>, Set<String>> collectImports(XtextResource state, final int offset,
			final int endOffset) {
		DefaultImportsAcceptor acceptor = new DefaultImportsAcceptor();
		importsCollector.collectImports(state, offset, endOffset, acceptor);
