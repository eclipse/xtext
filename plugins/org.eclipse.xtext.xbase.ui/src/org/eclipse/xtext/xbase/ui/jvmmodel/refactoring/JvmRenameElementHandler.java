	...
	protected IRenameElementContext createRenameElementContext(EObject targetElement, XtextEditor editor,
		...
		if (!jvmElements.isEmpty()) {
			...
			if (!javaElements.isEmpty()) {
				return new RenameJavaElementContext(EcoreUtil2.getNormalizedURI(targetElement), targetElement.eClass(),
						javaElements, editor, selection, EcoreUtil2.getNormalizedResourceURI(targetElement));
			}
		}
