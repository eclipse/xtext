 ...
 */
public class OpenImplementationHandler extends AbstractModelElementHandler {
	...
	protected void openPresentation(XtextEditor editor, IJavaElement javaElement, EObject selectedElement) {
		if (editor != null) {
			...
			XbaseImplementatorsHyperlink.openImplementations(javaElement, editor.getInternalSourceViewer(), region);
		}
	}
}
