...
public class CodetemplatesGrammarAccess extends AbstractGrammarElementFinder {
	...
	public CodetemplatesElements getCodetemplatesAccess() {
		return (pCodetemplates != null) ? pCodetemplates : (pCodetemplates = new CodetemplatesElements());
	}
	...
	public CodetemplateElements getCodetemplateAccess() {
		return (pCodetemplate != null) ? pCodetemplate : (pCodetemplate = new CodetemplateElements());
	}
	...
	public TemplateBodyWithQuotesElements getTemplateBodyWithQuotesAccess() {
		return (pTemplateBodyWithQuotes != null) ? pTemplateBodyWithQuotes : (pTemplateBodyWithQuotes = new TemplateBodyWithQuotesElements());
	}
	...
	public TemplateBodyElements getTemplateBodyAccess() {
		return (pTemplateBody != null) ? pTemplateBody : (pTemplateBody = new TemplateBodyElements());
	}
	...
	public TemplatePartElements getTemplatePartAccess() {
		return (pTemplatePart != null) ? pTemplatePart : (pTemplatePart = new TemplatePartElements());
	}
	...
	public VariableOrDollarElements getVariableOrDollarAccess() {
		return (pVariableOrDollar != null) ? pVariableOrDollar : (pVariableOrDollar = new VariableOrDollarElements());
	}
