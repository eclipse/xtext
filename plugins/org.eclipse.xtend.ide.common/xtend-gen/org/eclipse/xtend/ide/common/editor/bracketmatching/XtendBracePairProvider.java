...
public class XtendBracePairProvider extends DefaultBracePairProvider {
  public XtendBracePairProvider() {
    super(
      Collections.<BracePair>unmodifiableList(CollectionLiterals.<BracePair>newArrayList(new BracePair("(", ")", false), new BracePair("{", "}", true), new BracePair("[", "]", false), new BracePair("«", "»", false))));
  }
}
