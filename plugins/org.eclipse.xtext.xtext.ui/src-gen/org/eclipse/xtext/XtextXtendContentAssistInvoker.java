 ...
 */
public class XtextXtendContentAssistInvoker extends AbstractXtendService implements IContentAssistInvocationHandler {

	private static final Logger log = Logger.getLogger(XtextXtendContentAssistInvoker.class);
	...
	protected String getMasterXtendFileName() {
		...
		return "org::eclipse::xtext::XtextProposalProvider";
	}
