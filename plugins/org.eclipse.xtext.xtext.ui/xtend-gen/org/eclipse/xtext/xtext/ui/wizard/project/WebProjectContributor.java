...
public class WebProjectContributor extends DefaultProjectFactoryContributor {
  ...
  public void contributeFiles(final IProject project, final IProjectFactoryContributor.IFileCreator fc) {
    ...
    _builder.newLine();
    _builder.append("to test the editor for your language.");
    _builder.newLine();
  ...
  public IFile contributeWebFiles(final IProjectFactoryContributor.IFileCreator fc) {
    IFile _xblockexpression = null;
    {
      ...
      _builder.newLine();
      _builder.append("\t\t\t   \t");
      _builder.append("\"orion-edit\": \"http://orionhub.org/edit/edit\"");
      _builder.newLine();
      _builder.append("\t\t\t");
      _builder.append("}");
      _builder.newLine();
      ...
      _builder.newLine();
      _builder.append("\t\t\t");
      _builder.append("xtext.createEditor({theme: \"https://orionhub.org/edit/edit.css\"});");
      _builder.newLine();
      _builder.append("\t\t");
      _builder.append("});");
      _builder.newLine();
  ...
  public IFile contributeGradleFiles(final IProjectFactoryContributor.IFileCreator fc) {
    IFile _xblockexpression = null;
    {
      ...
      _builder.newLine();
      _builder.append("\t");
      _builder.append("main.java.srcDir \'src/main/xtend-gen\'");
      _builder.newLine();
      _builder.append("}");
      _builder.newLine();
      _builder.newLine();
  ...
  public IFile contributeXtendCode(final IProjectFactoryContributor.IFileCreator fc) {
    IFile _xblockexpression = null;
    {
      ...
      _builder_3.newLineIfNotEmpty();
      _builder_3.append("import org.eclipse.xtext.web.server.persistence.IResourceBaseProvider");
      _builder_3.newLine();
      _builder_3.newLine();
      ...
      _builder_3.newLine();
      _builder_3.newLine();
      _builder_3.append("//\tdef Class<? extends IServerResourceHandler> bindIServerResourceHandler() {");
      _builder_3.newLine();
      _builder_3.append("//\t\tFileResourceHandler");
      _builder_3.newLine();
      _builder_3.append("//\t}");
      _builder_3.newLine();
      _builder_3.newLine();
      ...
      _builder_3.newLine();
      _builder_3.append("\t\t");
      _builder_3.append("if (resourceBaseProvider !== null)");
      _builder_3.newLine();
      _builder_3.append("\t\t\t");
      _builder_3.append("binder.bind(IResourceBaseProvider).toInstance(resourceBaseProvider)");
      _builder_3.newLine();
      _builder_3.append("\t");
      _builder_3.append("}");
      _builder_3.newLine();
