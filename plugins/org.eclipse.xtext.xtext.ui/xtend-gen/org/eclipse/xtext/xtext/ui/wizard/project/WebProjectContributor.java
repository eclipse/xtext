...
public class WebProjectContributor extends DefaultProjectFactoryContributor {
  ...
  public IFile contributeWebFiles(final IProjectFactoryContributor.IFileCreator fc) {
    IFile _xblockexpression = null;
    {
      ...
      _builder.newLine();
      _builder.append("\t");
      _builder.append("<meta http-equiv=\"Cache-Control\" content=\"no-store\" />");
      _builder.newLine();
      _builder.append("\t");
      ...
      _builder.newLine();
      _builder.append("\t\t\t\t");
      _builder.append("\"orion-edit\": [\"orion/Deferred\", \"orion/keyBinding\", \"orion/editor/editorFeatures\",");
      _builder.newLine();
      _builder.append("\t\t\t\t\t");
      _builder.append("\"orion/editor/textStyler\", \"orion/editor/textModel\", \"orion/editor/textTheme\",");
      _builder.newLine();
      _builder.append("\t\t\t\t\t");
      _builder.append("\"orion/editor/textView\", \"orion/editor/contentAssist\", \"orion/editor/editor\",");
      _builder.newLine();
      _builder.append("\t\t\t\t\t");
      _builder.append("\"orion/editor/projectionTextModel\"]");
      _builder.newLine();
      _builder.append("\t\t\t");
      _builder.append("},");
      _builder.newLine();
      ...
      _builder.newLine();
      _builder.append("\t\t\t   \t");
      _builder.append("\"jquery\": \"http://code.jquery.com/jquery-2.1.3.min\",");
      _builder.newLine();
      _builder.append("\t\t\t   \t");
      _builder.append("\"orion-edit\": \"orion/built-editor-amd.min\"");
      _builder.newLine();
      _builder.append("\t\t\t");
      _builder.append("}");
      _builder.newLine();
      ...
      _builder.newLine();
      _builder.append("\t\t\t");
      _builder.append("xtext.createEditor({theme: \"orion/themes/default.css\"});");
      _builder.newLine();
      _builder.append("\t\t");
      _builder.append("});");
      _builder.newLine();
  ...
  public IFile contributeGradleFiles(final IProjectFactoryContributor.IFileCreator fc) {
    IFile _xblockexpression = null;
    {
      ...
      _builder.newLine();
      _builder.append(" ");
      _builder.append("* The following download/unpack tasks are currently necessary ");
      _builder.newLine();
      _builder.append(" ");
      _builder.append("* because Eclipse Orion does not provide easily consumable artifacts");
      _builder.newLine();
      _builder.append(" ");
      _builder.append("*/");
      _builder.newLine();
      ...
      _builder.newLine();
      _builder.append("def orionZip = file(\"$buildDir/orionTmp/built-editor.zip\")");
      _builder.newLine();
      _builder.newLine();
      ...
      _builder.newLine();
      _builder.append("\t\t");
      _builder.append("ant.get(src: \'http://download.eclipse.org/orion/drops/R-8.0-201502161823/built-editor.zip\', dest: orionZip)");
      _builder.newLine();
      _builder.append("\t");
      _builder.append("}");
      _builder.newLine();
