...
public class BuildScriptCreator {
  ...
  public CharSequence createScript(final RelengProjectInfo projectInfo) {
    ...
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("<arg value=\"-Dbuckminster.output.root=${build.root}/buckminster.output\" />");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("<arg value=\"-Dbuckminster.temp.root=${build.root}/buckminster.temp\" />");
    _builder.newLine();
    _builder.append("\t\t\t");
