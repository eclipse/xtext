 ...
 * @generated
 */
public class JvmDoubleAnnotationValueItemProvider extends JvmAnnotationValueItemProvider
{
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_JvmDoubleAnnotationValue_values_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_JvmDoubleAnnotationValue_values_feature", "_UI_JvmDoubleAnnotationValue_type"),
