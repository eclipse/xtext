...
public abstract class AbstractXtendSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_File_SemicolonKeyword_1_2_q;
	...
	protected void init(IGrammarAccess access) {
		...
		match_File_SemicolonKeyword_1_2_q = new TokenAlias(false, true, grammarAccess.getFileAccess().getSemicolonKeyword_1_2());
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			else if(match_File_SemicolonKeyword_1_2_q.equals(syntax))
				emit_File_SemicolonKeyword_1_2_q(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 *     ';'?
	 */
	protected void emit_File_SemicolonKeyword_1_2_q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
