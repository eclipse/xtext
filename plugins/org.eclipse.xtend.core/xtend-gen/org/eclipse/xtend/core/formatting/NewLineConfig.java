...
import org.eclipse.xtend.core.formatting.AbstractConfigurationKey;
...
public class NewLineConfig extends AbstractConfigurationKey<NewLineConfigValue> implements IConfigurationKeyWithStorage<NewLineConfigValue> {
  private final static Logger log = new Function0<Logger>() {
    public Logger apply() {
      Logger _logger = Logger.getLogger(NewLineConfig.class);
      return _logger;
    }
  }.apply();
    ...
    Integer _xblockexpression = null;
    {
      try {
        ...
        if (_t instanceof NumberFormatException) {
          ...
          StringConcatenation _builder = new StringConcatenation();
          _builder.append("Error parsing Integer: ");
          _builder.append(value, "");
          NewLineConfig.log.error(_builder, e);
        } else {
