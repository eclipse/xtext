  ...
  public void runActiveAnnotationValidation(final Resource resource, final CancelIndicator indicator) {
    ...
    try {
      ...
      if (_t instanceof Throwable) {
        ...
        EList<Resource.Diagnostic> _errors = resource.getErrors();
        EObjectDiagnosticImpl _eObjectDiagnosticImpl = new EObjectDiagnosticImpl(Severity.ERROR, IssueCodes.PROCESSING_ERROR, "Could not create active annotation contexts", file, null, (-1), null);
