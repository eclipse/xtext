  ...
  private Object toArrayOfType(final Iterable<? extends Object> iterable, final Class<? extends Object> componentType) {
    ...
    if (!_matched) {
      if (Objects.equal(componentType,int.class)) {
        _matched=true;
        int[] _array = Ints.toArray(((List<? extends Number>) collection));
    ...
    if (!_matched) {
      if (Objects.equal(componentType,long.class)) {
        _matched=true;
        long[] _array_1 = Longs.toArray(((List<? extends Number>) collection));
    ...
    if (!_matched) {
      if (Objects.equal(componentType,byte.class)) {
        _matched=true;
        byte[] _array_4 = Bytes.toArray(((List<? extends Number>) collection));
    ...
    if (!_matched) {
      if (Objects.equal(componentType,short.class)) {
        _matched=true;
        short[] _array_5 = Shorts.toArray(((List<? extends Number>) collection));
    ...
    if (!_matched) {
      if (Objects.equal(componentType,float.class)) {
        _matched=true;
        float[] _array_6 = Floats.toArray(((List<? extends Number>) collection));
    ...
    if (!_matched) {
      if (Objects.equal(componentType,double.class)) {
        _matched=true;
        double[] _array_7 = Doubles.toArray(((List<? extends Number>) collection));
