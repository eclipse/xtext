...
public class SourceTypeParameterDeclarationImpl extends AbstractDeclarationImpl<JvmTypeParameter> implements SourceTypeParameterDeclaration {
  public List<TypeReference> getUpperBounds() {
    ...
    final Function1<JvmUpperBound,TypeReference> _function = new Function1<JvmUpperBound,TypeReference>() {
        public TypeReference apply(final JvmUpperBound it) {
          CompilationUnitImpl _compilationUnit = SourceTypeParameterDeclarationImpl.this.getCompilationUnit();
