...
import org.eclipse.xtend.core.macro.declaration.GeneratedTypeDeclarationImpl;
...
public class GeneratedClassDeclarationImpl extends GeneratedTypeDeclarationImpl<JvmGenericType> implements GeneratedClassDeclaration {
    ...
    List<TypeReference> _xblockexpression = null;
    {
      ...
      final Function1<JvmTypeReference,TypeReference> _function_1 = new Function1<JvmTypeReference,TypeReference>() {
          public TypeReference apply(final JvmTypeReference it) {
            CompilationUnitImpl _compilationUnit = GeneratedClassDeclarationImpl.this.getCompilationUnit();
