 ...
 * @generated
 */
public class XtendTypeDeclarationImpl extends XtendMemberImplCustom implements XtendTypeDeclaration
{
	/**
	 ...
	 * @generated
	 */
	protected XtendTypeDeclarationImpl()
	{
		super();
	}
	...
	{
		return XtendPackage.Literals.XTEND_TYPE_DECLARATION;
	}
	...
	public void setName(String newName)
	{
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XtendPackage.XTEND_TYPE_DECLARATION__NAME, oldName, name));
	}
	...
	public EList<XtendMember> getMembers()
	{
		if (members == null)
		{
			members = new EObjectContainmentWithInverseEList<XtendMember>(XtendMember.class, this, XtendPackage.XTEND_TYPE_DECLARATION__MEMBERS, XtendPackage.XTEND_MEMBER__DECLARING_TYPE);
		}
		return members;
	}
