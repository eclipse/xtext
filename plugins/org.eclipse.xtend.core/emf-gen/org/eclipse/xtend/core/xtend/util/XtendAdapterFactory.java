...
public class XtendAdapterFactory extends AdapterFactoryImpl
{
	...
	protected XtendSwitch<Adapter> modelSwitch =
		new XtendSwitch<Adapter>()
		{
			...
			@Override
			public Adapter caseXtendConstructorCall(XtendConstructorCall object)
			{
				return createXtendConstructorCallAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.xtend.core.xtend.XtendConstructorCall <em>Constructor Call</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createXtendConstructorCallAdapter()
	{
		return null;
	}
