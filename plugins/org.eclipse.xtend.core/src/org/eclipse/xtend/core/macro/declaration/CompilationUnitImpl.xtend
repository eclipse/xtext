...
class CompilationUnitImpl implements CompilationUnit {
	...
	private def Object toArrayOfType(Iterable<?> iterable, Class<?> componentType) {
		...
		return switch componentType {
			case int : Ints.toArray(collection as List<? extends Number>)
			case long : Longs.toArray(collection as List<? extends Number>)
			case char : Chars.toArray(collection as List<Character>)
			case boolean : Booleans.toArray(collection as List<Boolean>)
			case byte : Bytes.toArray(collection as List<? extends Number>)
			case short : Shorts.toArray(collection as List<? extends Number>)
			case float : Floats.toArray(collection as List<? extends Number>)
			case double : Doubles.toArray(collection as List<? extends Number>)
