...
class CompilationContextImpl implements CompilationContext {
	...
	TypeReferenceSerializer2 typeRefSerializer

	new(ITreeAppendable appendable, CompilationUnitImpl compilationUnit, TypeReferenceSerializer2 typeRefSerializer) {
