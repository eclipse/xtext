...
public interface IXtextBuiltIn_Temp {
	 ...
	 */
	public static final String ID = "org.eclipse.xtext.builtin.XtextBuiltIn_Temp";
	public static final String NAME = "XtextBuiltIn_Temp";
