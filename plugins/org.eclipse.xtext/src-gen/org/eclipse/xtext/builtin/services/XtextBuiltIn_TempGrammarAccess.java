...
public class XtextBuiltIn_TempGrammarAccess extends BaseEPackageAccess implements IGrammarAccess {

	private static final String XTEXTBUILTIN_TEMP_GRAMMAR_CP_URI = "classpath:/org/eclipse/xtext/builtin/XtextBuiltIn_Temp.xmi";
	...
	public Grammar getGrammar() {	
		if (GRAMMAR==null) {
			...
			GRAMMAR = (Grammar) loadGrammarFile(XtextBuiltIn_TempGrammarAccess.class.getClassLoader(),XTEXTBUILTIN_TEMP_GRAMMAR_CP_URI);
		}
		return GRAMMAR;
	}
	
	public String getGrammarClasspathURI() {
		return XTEXTBUILTIN_TEMP_GRAMMAR_CP_URI;
	}
