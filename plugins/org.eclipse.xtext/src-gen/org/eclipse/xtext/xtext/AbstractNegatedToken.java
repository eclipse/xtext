 ...
 * </copyright>
 *
 * $Id: AbstractNegatedToken.java,v 1.2 2009/02/18 21:19:46 sefftinge Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.eclipse.xtext.xtext.AbstractNegatedToken#getTerminal <em>Terminal</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.eclipse.xtext.xtext.XtextPackage#getAbstractNegatedToken()
 * @model
 * @generated
 */
public interface AbstractNegatedToken extends AbstractElement
{
   ...
   * @see org.eclipse.xtext.xtext.XtextPackage#getAbstractNegatedToken_Terminal()
  ...
  /**
   * Sets the value of the '{@link org.eclipse.xtext.xtext.AbstractNegatedToken#getTerminal <em>Terminal</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
