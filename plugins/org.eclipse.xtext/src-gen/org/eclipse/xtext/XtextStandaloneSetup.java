...
public abstract class XtextStandaloneSetup {
	...
	public synchronized static void doSetup() {
		if (!isInitialized) {
			...
			ServiceRegistry.registerService(languageDescriptor, IParseTreeConstructor.class,
					XtextParseTreeConstructor.class);
			...
			// register EPackages to EMF
			if (!EPackage.Registry.INSTANCE.containsKey("http://www.eclipse.org/2008/Xtext"))
				EPackage.Registry.INSTANCE.put("http://www.eclipse.org/2008/Xtext", EcoreUtil2.loadEPackage(
						"classpath:/org/eclipse/xtext/xtext.ecore", XtextStandaloneSetup.class.getClassLoader()));
			isInitialized = true;
		}
	}
