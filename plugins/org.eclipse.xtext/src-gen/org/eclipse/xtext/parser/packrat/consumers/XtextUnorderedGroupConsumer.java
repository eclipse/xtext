...
public final class XtextUnorderedGroupConsumer extends NonTerminalConsumer {

	private UnorderedGroupElements rule;	
	...
	protected class RuleCall$9$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeNonTerminal(groupConsumer, "elements", true, false, false, getElement(), optional);
		}
	}

	public XtextUnorderedGroupConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public UnorderedGroupElements getRule() {
		return rule;
	}
	
	public void setRule(UnorderedGroupElements rule) {
		this.rule = rule;
		...
		action$4$Consumer = new Action$4$Consumer(rule.getUnorderedGroupElementsAction_1_0());
		group$6$Consumer = new Group$6$Consumer(rule.getGroup_1_1());
		keyword$7$Consumer = new Keyword$7$Consumer(rule.getAmpersandKeyword_1_1_0());
		assignment$8$Consumer = new Assignment$8$Consumer(rule.getElementsAssignment_1_1_1());
		ruleCall$9$Consumer = new RuleCall$9$Consumer(rule.getElementsGroupParserRuleCall_1_1_1_0());
	}
