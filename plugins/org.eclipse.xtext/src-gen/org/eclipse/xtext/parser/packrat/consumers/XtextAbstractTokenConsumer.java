...
public final class XtextAbstractTokenConsumer extends NonTerminalConsumer {
	...
	public XtextAbstractTokenConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	// XtextGrammarAccess.INSTANCE.prAbstractToken()
		return rule;
	}
