...
public final class XtextActionConsumer extends NonTerminalConsumer {
	...
	protected boolean consumeKeyword$8() throws Exception {
		return consumeKeyword(getRule().ele0000000KeywordLeftCurlyBracket(), null, false, false, XtextDelimiters.ANY_OTHER_DELIMITER);
	}
	...
	protected boolean consumeKeyword$10() throws Exception {
		return consumeKeyword(getRule().ele00000010KeywordCurrent(), null, false, false, XtextDelimiters.ID_DELIMITER);
	}

	protected boolean consumeKeyword$11() throws Exception {
		return consumeKeyword(getRule().ele00000011KeywordEqualsSign(), null, false, false, XtextDelimiters.ANY_OTHER_DELIMITER);
	}
	...
	protected boolean consumeKeyword$14() throws Exception {
		return consumeKeyword(getRule().ele00001KeywordFullStop(), null, false, false, XtextDelimiters.ANY_OTHER_DELIMITER);
	}

	protected boolean consumeAssignment$15() throws Exception {
		if (consumeTerminal(idConsumer, "feature", false, false, getRule().ele00010LexerRuleCallID(), XtextDelimiters.ALL_KEYWORDS))
			return true;
		return false;
	}

	protected boolean consumeAssignment$17() throws Exception {
		if (consumeKeyword(getRule().ele00100KeywordEqualsSign(), "operator", false, false, XtextDelimiters.ANY_OTHER_DELIMITER))
			return true;
		if (consumeKeyword(getRule().ele00101KeywordPlusSignEqualsSign(), "operator", false, false, XtextDelimiters.ANY_OTHER_DELIMITER))
			return true;
		return false;
	}

	protected boolean consumeKeyword$21() throws Exception {
		return consumeKeyword(getRule().ele01KeywordCurrent(), null, false, false, XtextDelimiters.ID_DELIMITER);
	}

	protected boolean consumeKeyword$22() throws Exception {
		return consumeKeyword(getRule().ele1KeywordRightCurlyBracket(), null, false, false, XtextDelimiters.ANY_OTHER_DELIMITER);
	}
