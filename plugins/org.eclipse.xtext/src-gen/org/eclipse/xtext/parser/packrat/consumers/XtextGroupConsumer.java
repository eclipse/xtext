...
public final class XtextGroupConsumer extends NonTerminalConsumer {
	...
	protected class RuleCall$7$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeNonTerminal(abstractTokenConsumer, "elements", true, false, false, getElement(), optional);
		}
	}
	...
	public void setRule(GroupElements rule) {
		...
		ruleCall$7$Consumer = new RuleCall$7$Consumer(rule.getElementsAbstractTokenParserRuleCall_1_1_0());
	}
