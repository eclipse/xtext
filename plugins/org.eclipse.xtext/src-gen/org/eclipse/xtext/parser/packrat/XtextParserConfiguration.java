...
public class XtextParserConfiguration extends AbstractParserConfiguration {
	...
	public void configureConsumers() {
		...
		getGrammarConsumer().setCrossReference$22$Delimiter(org.eclipse.xtext.parser.packrat.XtextDelimiters.crossReference$25$Delimiter);
		getGrammarConsumer().setCrossReference$27$Delimiter(org.eclipse.xtext.parser.packrat.XtextDelimiters.crossReference$25$Delimiter);
		getGrammarConsumer().setKeyword$10$Delimiter(org.eclipse.xtext.parser.packrat.XtextDelimiters.keyword$9$Delimiter);
		getGrammarConsumer().setKeyword$18$Delimiter(org.eclipse.xtext.parser.packrat.XtextDelimiters.keyword$9$Delimiter);
		getGrammarConsumer().setKeyword$19$Delimiter(org.eclipse.xtext.parser.packrat.XtextDelimiters.keyword$22$Delimiter);
		getGrammarConsumer().setKeyword$25$Delimiter(org.eclipse.xtext.parser.packrat.XtextDelimiters.keyword$22$Delimiter);
		getGrammarConsumer().setKeyword$29$Delimiter(org.eclipse.xtext.parser.packrat.XtextDelimiters.keyword$22$Delimiter);
		...
		getAlternativesConsumer().setKeyword$7$Delimiter(org.eclipse.xtext.parser.packrat.XtextDelimiters.keyword$22$Delimiter);
		getTerminalAlternativesConsumer().setKeyword$7$Delimiter(org.eclipse.xtext.parser.packrat.XtextDelimiters.keyword$22$Delimiter);
		getAbstractTokenConsumer().setKeyword$10$Delimiter(org.eclipse.xtext.parser.packrat.XtextDelimiters.keyword$22$Delimiter);
		getAbstractTokenConsumer().setKeyword$11$Delimiter(org.eclipse.xtext.parser.packrat.XtextDelimiters.keyword$22$Delimiter);
		getAbstractTokenConsumer().setKeyword$12$Delimiter(org.eclipse.xtext.parser.packrat.XtextDelimiters.keyword$22$Delimiter);
		getTerminalTokenConsumer().setKeyword$6$Delimiter(org.eclipse.xtext.parser.packrat.XtextDelimiters.keyword$22$Delimiter);
		getTerminalTokenConsumer().setKeyword$7$Delimiter(org.eclipse.xtext.parser.packrat.XtextDelimiters.keyword$22$Delimiter);
		getTerminalTokenConsumer().setKeyword$8$Delimiter(org.eclipse.xtext.parser.packrat.XtextDelimiters.keyword$22$Delimiter);
		getAssignmentConsumer().setKeyword$8$Delimiter(org.eclipse.xtext.parser.packrat.XtextDelimiters.keyword$22$Delimiter);
		getAssignmentConsumer().setKeyword$9$Delimiter(org.eclipse.xtext.parser.packrat.XtextDelimiters.keyword$22$Delimiter);
		getAssignmentConsumer().setKeyword$10$Delimiter(org.eclipse.xtext.parser.packrat.XtextDelimiters.keyword$22$Delimiter);
		getAssignmentConsumer().setRuleCall$4$Delimiter(org.eclipse.xtext.parser.packrat.XtextDelimiters.crossReference$25$Delimiter);
		getActionConsumer().setKeyword$8$Delimiter(org.eclipse.xtext.parser.packrat.XtextDelimiters.keyword$22$Delimiter);
		getActionConsumer().setKeyword$10$Delimiter(org.eclipse.xtext.parser.packrat.XtextDelimiters.keyword$9$Delimiter);
		getActionConsumer().setKeyword$11$Delimiter(org.eclipse.xtext.parser.packrat.XtextDelimiters.keyword$22$Delimiter);
		getActionConsumer().setKeyword$14$Delimiter(org.eclipse.xtext.parser.packrat.XtextDelimiters.keyword$22$Delimiter);
		getActionConsumer().setKeyword$19$Delimiter(org.eclipse.xtext.parser.packrat.XtextDelimiters.keyword$22$Delimiter);
		getActionConsumer().setKeyword$20$Delimiter(org.eclipse.xtext.parser.packrat.XtextDelimiters.keyword$22$Delimiter);
		getActionConsumer().setKeyword$21$Delimiter(org.eclipse.xtext.parser.packrat.XtextDelimiters.keyword$9$Delimiter);
		getActionConsumer().setKeyword$22$Delimiter(org.eclipse.xtext.parser.packrat.XtextDelimiters.keyword$22$Delimiter);
		getActionConsumer().setRuleCall$16$Delimiter(org.eclipse.xtext.parser.packrat.XtextDelimiters.crossReference$25$Delimiter);
		getNegatedTokenConsumer().setKeyword$2$Delimiter(org.eclipse.xtext.parser.packrat.XtextDelimiters.keyword$22$Delimiter);
		getUpToTokenConsumer().setKeyword$2$Delimiter(org.eclipse.xtext.parser.packrat.XtextDelimiters.keyword$22$Delimiter);
		getWildcardConsumer().setKeyword$2$Delimiter(org.eclipse.xtext.parser.packrat.XtextDelimiters.keyword$22$Delimiter);
		getCharacterRangeConsumer().setKeyword$7$Delimiter(org.eclipse.xtext.parser.packrat.XtextDelimiters.keyword$22$Delimiter);
		getCrossReferenceConsumer().setCrossReference$10$Delimiter(org.eclipse.xtext.parser.packrat.XtextDelimiters.crossReference$25$Delimiter);
		getCrossReferenceConsumer().setKeyword$4$Delimiter(org.eclipse.xtext.parser.packrat.XtextDelimiters.keyword$22$Delimiter);
		getCrossReferenceConsumer().setKeyword$8$Delimiter(org.eclipse.xtext.parser.packrat.XtextDelimiters.keyword$22$Delimiter);
		getCrossReferenceConsumer().setKeyword$12$Delimiter(org.eclipse.xtext.parser.packrat.XtextDelimiters.keyword$22$Delimiter);
		getParenthesizedElementConsumer().setKeyword$3$Delimiter(org.eclipse.xtext.parser.packrat.XtextDelimiters.keyword$22$Delimiter);
