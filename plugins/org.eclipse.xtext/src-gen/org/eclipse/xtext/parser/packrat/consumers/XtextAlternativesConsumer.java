...
public final class XtextAlternativesConsumer extends NonTerminalConsumer {
	...
	protected class RuleCall$9$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeNonTerminal(unorderedGroupConsumer, "elements", true, false, false, getElement(), optional);
		}
	}
	...
	public void setRule(AlternativesElements rule) {
		...
		ruleCall$9$Consumer = new RuleCall$9$Consumer(rule.getElementsUnorderedGroupParserRuleCall_1_1_1_0());
	}
