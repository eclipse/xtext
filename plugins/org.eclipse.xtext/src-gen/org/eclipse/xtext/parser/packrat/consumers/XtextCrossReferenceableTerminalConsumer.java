...
import org.eclipse.xtext.services.XtextGrammarAccess.CrossReferenceableTerminalElements;

public final class XtextCrossReferenceableTerminalConsumer extends NonTerminalConsumer {
	...
	public XtextCrossReferenceableTerminalConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	public void setRule(CrossReferenceableTerminalElements rule) {
		...
		ruleCall$4$Consumer = new RuleCall$4$Consumer(rule.ele2ParserRuleCallParenthesizedCrossReferenceableElement());
	}
