...
public class XtextPackratParser extends AbstractPackratParser {
	...
	@Override
	protected XtextParserConfiguration createParserConfiguration(ICharSequenceWithOffset input,
		...
		return new XtextParserConfiguration(input, markerFactory, tokenAcceptor, hiddenTokenHandler, consumerUtil);
	}
