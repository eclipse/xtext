...
public final class XtextTerminalAlternativesConsumer extends NonTerminalConsumer {
	...
	public XtextTerminalAlternativesConsumer(INonTerminalConsumerConfiguration configuration, ITerminalConsumer[] hiddenTokens) {
	...
	// XtextGrammarAccess.INSTANCE.prTerminalAlternatives()
		return rule;
	}
