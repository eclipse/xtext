...
public final class XtextTerminalAlternativesConsumer extends NonTerminalConsumer {
	...
	protected class RuleCall$9$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume(boolean optional) throws Exception {
			return consumeNonTerminal(terminalGroupConsumer, "elements", true, false, false, getElement(), optional);
		}
	}
	...
	public void setRule(TerminalAlternativesElements rule) {
		...
		ruleCall$9$Consumer = new RuleCall$9$Consumer(rule.getElementsTerminalGroupParserRuleCall_1_1_1_0());
	}
