...
public final class XtextTerminalAlternativesConsumer extends NonTerminalConsumer {
	...
	protected class RuleCall$2$Consumer extends ElementConsumer<RuleCall> {
		...
		protected int doConsume() throws Exception {
			return consumeNonTerminal(terminalGroupConsumer, null, false, false, false, getElement());
		}
	}
	...
	protected class RuleCall$9$Consumer extends ElementConsumer<RuleCall> {
		...
		@Override
		protected int doConsume() throws Exception {
			return consumeNonTerminal(terminalGroupConsumer, "groups", true, false, false, getElement());
		}
	}
