 ...
 */
public abstract class AbstractXtextRuntimeConfig extends AbstractServiceRegistrationFactory {
	...
	protected Class<? extends org.eclipse.xtext.parser.IParser> getIParser() {
		return org.eclipse.xtext.parser.XtextParser.class;
	}
		
	protected Class<? extends org.eclipse.xtext.parser.antlr.IAntlrTokenFileProvider> getIAntlrTokenFileProvider() {
		return org.eclipse.xtext.parser.XtextAntlrTokenFileProvider.class;
	}
	...
	protected Class<? extends org.eclipse.xtext.parser.antlr.Lexer> getLexer() {
		return org.eclipse.xtext.parser.internal.InternalXtextLexer.class;
	}
