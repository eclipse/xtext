 ...
 * 
 * It's used as a protocol to tell whether a SerializableResource
...
public class SourceLevelURIsAdapter extends AdapterImpl {
  ...
  public static void setSourceLevelUris(final ResourceSet resourceSet, final Collection<URI> uris) {
    ...
    if (_findInstalledAdapter != null) {
      ...
      _elvis = _sourceLevelURIsAdapter;
    }
    ...
    final SourceLevelURIsAdapter adapter = ObjectExtensions.<SourceLevelURIsAdapter>operator_doubleArrow(_elvis, _function);
