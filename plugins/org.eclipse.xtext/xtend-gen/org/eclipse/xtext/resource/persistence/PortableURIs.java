...
public class PortableURIs {
  ...
  public URI toPortableURI(final StorageAwareResource res, final URI uri, final String fragment) {
    ...
    if (_notEquals) {
      ...
      final String portableFragment = this.getPortableURIFragment(obj);
      boolean _notEquals_1 = (!Objects.equal(portableFragment, null));
      if (_notEquals_1) {
        URI _uRI = res.getURI();
        return _uRI.appendFragment(portableFragment);
      }
    }
