  ...
  public IResourceDescription getResourceDescription(final Resource resource) {
    ...
    if (!_matched) {
      if (resource instanceof StorageAwareResource) {
        boolean _notEquals = (!Objects.equal(((StorageAwareResource)resource).resourceDescription, null));
        if (_notEquals) {
          _matched=true;
          _switchResult = ((StorageAwareResource)resource).resourceDescription;
        }
      }
    }
    if (!_matched) {
