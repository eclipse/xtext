...
public class ResourceStorageWriteable {
  private final static Logger LOG = Logger.getLogger(ResourceStorageWriteable.class);
    ...
    try {
      ...
      try {
        ...
        if (_t instanceof IOException) {
          ...
          ResourceStorageWriteable.LOG.error(_message, e);
        } else {
  ...
  public ResourceStorageWriteable(final OutputStream out) {
    super();
    this.out = out;
  }
  ...
  public boolean equals(final Object obj) {
    ...
    if (getClass() != obj.getClass())
      return false;
    ResourceStorageWriteable other = (ResourceStorageWriteable) obj;
    if (this.out == null) {
      if (other.out != null)
        return false;
