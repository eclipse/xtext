 ...
 * </copyright>
 *
 * $Id: XtextutilSwitch.java,v 1.12 2008/06/05 08:58:46 sefftinge Exp $
 */
...
public class XtextutilSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case XtextutilPackage.COMPLEX_TYPE: {
			...
			case XtextutilPackage.DATA_TYPE: {
