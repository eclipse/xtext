 ...
 */
public class GapFormattingToString implements Function<IGapFormatting, String> {
	public String apply(IGapFormatting gapFormatting) {
		String space = gapFormatting.getSpace();
		Integer nlMin = gapFormatting.getNewLineMinValue();
		Integer nlDefault = gapFormatting.getNewLineDefaultValue();
		Integer nlMax = gapFormatting.getNewLineMaxValue();
		Boolean autowrap = gapFormatting.getAutowrapValue();
		Integer indentationIncrease = gapFormatting.getIndentationIncreaseValue();
		Integer indentationDecrease = gapFormatting.getIndentationDecreaseValue();
