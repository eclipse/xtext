...
public class GapFormatting implements IGapFormatting, Mergeable<IGapFormatting> {
	private Boolean autowrap = null;
	private final IFormattableDocument document;
	private final IGap gap;
	...
	private int priority = IGapFormatting.NORMAL_PRIORITY;
	private String space = null;

	public GapFormatting(IFormattableDocument document, IGap gap) {
		super();
		this.gap = gap;
	...
	public void highPriority() {
		setPriority(IGapFormatting.HIGH_PRIORITY);
	}
	...
	public void lowPriority() {
		setPriority(IGapFormatting.LOW_PRIORITY);
	}
	...
	public IGapFormatting mergeWith(IGapFormatting o) {
		if (gap != o.getGapValue())
			return null;
		int strategy = o.getPriority() - getPriority();
		GapFormatting m = new GapFormatting(document, gap);
	...
	public String toString() {
		return new GapFormattingToString().apply(this);
	}
}