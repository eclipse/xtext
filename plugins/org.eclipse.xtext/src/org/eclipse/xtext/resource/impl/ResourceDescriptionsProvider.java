...
public class ResourceDescriptionsProvider {
	 ...
	 * <li>{@link #LIVE_SCOPE} if the resource set contains resources that are going to be modified locally and should
	 * definitely shadow the context of the persisted resource descriptions.</li>
	...
	public IResourceDescriptions getResourceDescriptions(@NonNull ResourceSet resourceSet) {
		...
		String[] mutualExclusiveFlags = new String[] { NAMED_BUILDER_SCOPE, LIVE_MODEL_SCOPE, LIVE_SCOPE,
	...
	/**
	 * The returned IResourceDescriptions represent the Xtext Index' state shadowed by the current ResourceSets
	 * contents.
	 * 
	 * @since 2.6
	 */
