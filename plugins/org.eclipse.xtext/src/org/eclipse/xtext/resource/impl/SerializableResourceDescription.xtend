...
import static extension org.eclipse.xtext.resource.impl.SerializationExtensions.*
...
@Accessors class SerializableResourceDescription extends AbstractResourceDescription implements Externalizable {
	...
	List<SerializableEObjectDescription> descriptions
	List<SerializableReferenceDescription> references
