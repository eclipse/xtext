...
import org.eclipse.xtext.resource.impl.DefaultResourceServiceProviderRegistry;
...
public interface IResourceServiceProvider {
	...
	@ImplementedBy(DefaultResourceServiceProviderRegistry.class)
	interface Registry {
		/**
		 * Returns the {@link IResourceServiceProvider} appropriate for the given URI. <b>Content types are not
		 * yet supported.</b>
		 * 
		 * @param uri
		 *            the URI.
		 ...
		 *            lookup.
		 * @return the {@link IResourceServiceProvider} appropriate for the given URI, or <code>null</code> if
		 *         there isn't one.
		 */
