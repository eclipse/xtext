...
interface IResourceStorageFacade {
	 ...
	 */
	def ResourceStorageInputStream getOrCreateResourceStorageInputStream(StorageAwareResource resource)
	 ...
	 */
	def ResourceStorageOutputStream createResourceStorageOutputStream(OutputStream outputStream)
	
	/**
	 * Creates a fresh ResourceStorageInputStream wrapping the given InputStream 
	 */
	def ResourceStorageInputStream createResourceStorageInputStream(InputStream inputStream)
