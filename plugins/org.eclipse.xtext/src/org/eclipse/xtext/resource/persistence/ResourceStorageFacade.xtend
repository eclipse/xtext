...
class ResourceStorageFacade implements IResourceStorageFacade {
	 ...
	 */
	override ResourceStorageInputStream getOrCreateResourceStorageInputStream(StorageAwareResource resource) {
	...
	override def ResourceStorageInputStream createResourceStorageInputStream(InputStream in) {
		return new ResourceStorageInputStream(in)
	}
	
	override def ResourceStorageOutputStream createResourceStorageOutputStream(OutputStream out) {
