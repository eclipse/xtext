...
public class CurrentTypeFinder {
	...
	public EClassifier findCurrentTypeAfter(AbstractElement element) {
		...
		AfterImplementation implementation = new AfterImplementation();
		implementation.computeResult(rule, element);
		return implementation.getResult();
	}
	
	public static class BeforeImplementation extends XtextSwitch<Boolean> {
	...
	public static class AfterImplementation extends XtextSwitch<Boolean> {
