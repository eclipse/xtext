...
public interface ITextRegionAccess { // ITextRegionAccess
	...
	ISemanticRegion immediatelyFollowingKeyword(ISemanticRegion region, String keyword);

	ISemanticRegion immediatelyPrecedingKeyword(EObject owner, String keyword);

	ISemanticRegion immediatelyPrecedingKeyword(ISemanticRegion region, String keyword);

	ISemanticRegion immediatelyPrecedingKeyword(EObject owner);

	ISemanticRegion immediatelyPrecedingKeyword(ISemanticRegion region);
