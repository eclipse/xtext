...
/**
 * A FormattableDocument is a stateful object that maps {@link ITextSegment}s to {@link ITextReplacer}s. The document can
...
public interface IFormattableDocument {
	...
	ITextSegment setReplacer(ITextSegment region, ITextReplacer replacer);
