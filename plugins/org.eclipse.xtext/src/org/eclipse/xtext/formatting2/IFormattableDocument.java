...
/**
 * A FormattableDocument is a stateful object that maps {@link ITextRegion2}s to {@link ITextReplacer}s. The document can
...
public interface IFormattableDocument {
	...
	ITextRegion2 setReplacer(ITextRegion2 region, ITextReplacer replacer);
