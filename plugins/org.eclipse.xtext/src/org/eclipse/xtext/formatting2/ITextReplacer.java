...
public interface ITextReplacer {
	 ...
	 */
	public interface Flow { // TODO: merge with TextReplacerContext
		int getIndentation();

		Flow withIndentation(int indentation);
	}

	public interface Mergeable<T> { // TODO: use symmetric implementation
		T mergeWith(T other);
	}

	Flow createReplacements(ITextReplacerContext context);
}
