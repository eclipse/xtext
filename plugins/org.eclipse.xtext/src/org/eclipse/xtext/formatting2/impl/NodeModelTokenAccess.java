...
public class NodeModelTokenAccess extends AbstractTokenAccess {
	...
	public static class Builder extends AbstractTokenAccess.Builder {
		...
		private ITextRegion2 lastTokenOrGap;
		...
		protected void setTrailingGaps() {
			...
			if (lastTokenOrGap instanceof IHiddenRegion)
				token = ((IHiddenRegion) lastTokenOrGap).getPreviousToken();
			else
	...
	public static class Gap extends AbstractTextRegion2 implements IHiddenRegion {
		...
		public ISemanticRegion getNextToken() {
			return next;
		}
		...
		public ISemanticRegion getPreviousToken() {
			return previous;
		}
		...
		public List<IHiddenRegionPart> getWhitespaceAndComments() {
	...
	public static class NodeRegion extends AbstractTextRegion2 {
		private final INode node;
		private final ITextRegionAccess tokenAccess;
