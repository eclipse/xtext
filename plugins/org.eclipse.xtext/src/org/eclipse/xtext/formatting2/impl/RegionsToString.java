 ...
 */
public class RegionsToString<T extends ITextRegion2> implements Function<Iterable<? extends T>, String> {

	private Function<? super T, String> regionToString = Functions.toStringFunction();
	private ITextRegion2 root = null;
	...
	public String applyAsReplacements(Iterable<? extends T> input) {
		...
		if (root == null)
			root = (ITextRegion2) list.get(0).getTextRegionAccess();
	...
	public RegionsToString<T> withRoot(ITextRegion2 root) {
		this.root = root;
		return this;
	}
