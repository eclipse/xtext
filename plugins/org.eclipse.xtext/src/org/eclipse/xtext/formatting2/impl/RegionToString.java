...
import org.eclipse.xtext.formatting2.ITextRegion;
...
public class RegionToString {
	...
	protected String toString(ITextRegion region) {
		String result;
	...
	protected List<ITextRegion> toTokenAndGapList() {
		final int range = this.hightlightOrigin ? 4 : (Integer.MAX_VALUE / 2);
		ITextRegion first = null;
		{
			ITextRegion current = origin;
	...
	public RegionToString withOrigin(ITextRegion origin) {
		this.origin = origin;
		return this;
	}
