 ...
 */
public abstract class FormattableDocument extends AbstractTextRegion2 implements IFormattableDocument {

	protected static class ConditionalReplacer extends AbstractTextRegion2 implements ITextReplacer {
	...
	protected static class ReplacerContext extends AbstractTextRegion2 implements ITextReplacerContext,
		...
		public void replaceText(ITextRegion2 region, CharSequence text) {
	...
	public static class RootDocument extends FormattableDocument {
		...
		public int getLength() {
			ITextRegion2 tokens = (ITextRegion2) request.getTokens();
	...
	protected static class TextReplacement extends AbstractTextRegion2 implements ITextReplacement {
		private final int length;
		private final int offset;
	...
	protected <T extends ITextRegion2> RegionSet<T> createRegionSet(ITextRegion2 root, FormatterProblemReporter handler) {
		return new RegionSet<T>(root, null, handler);
	}
	...
	public ITextRegion2 setReplacer(ITextRegion2 region, ITextReplacer replacer) {
		if (region != null) {
