 ...
 */
public class ReplacementsToString<T> implements Function<Iterable<? extends T>, String> {
	...
	public ReplacementsToString<T> withRegionGetter(Function<? super T, ? extends ITextRegion> regionAccess) {
		this.regionAccess = regionAccess;
		return this;
	}

	public ReplacementsToString<T> withRegionToString(Function<? super T, String> regionToString) {
		this.regionToString = regionToString;
		return this;
	}

	public ReplacementsToString<T> withRoot(ITextSegment root) {
		this.root = root;
		return this;
	}
