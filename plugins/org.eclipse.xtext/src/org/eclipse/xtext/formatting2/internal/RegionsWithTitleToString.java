 ...
 */
public class RegionsWithTitleToString {
	...
	public RegionsWithTitleToString add(String title, ITextSegment region) {
	...
	public RegionsWithTitleToString setFrame(ITextSegment frame) {
		this.frame = frame;
		return this;
	}

	public RegionsWithTitleToString setLeadingLines(int leadingLines) {
		this.leadingLines = leadingLines;
		return this;
	}

	public RegionsWithTitleToString setTextRegionAccess(ITextRegionAccess textRegionAccess) {
		this.textRegionAccess = textRegionAccess;
		return this;
	}

	public RegionsWithTitleToString setTrailingLines(int trailingLines) {
	...
	public String toString() {
		...
		for (int i = 0; i < this.items.size(); i++) {
			...
			replacements.add(new TextReplacement(access, region.getOffset() - offset, 0, open));
			replacements.add(new TextReplacement(access, region.getEndOffset() - offset, 0, close));
		}
		String vizualized = TextReplacements.apply(frame.getText(), replacements);
