...
public class SingleHoverShowingHyperlinkPresenter extends MultipleHyperlinkPresenter {
  ...
  public void showHyperlinks(final IHyperlink[] activeHyperlinks, final boolean takesFocusWhenVisible) {
    try {
      super.showHyperlinks(activeHyperlinks, takesFocusWhenVisible);
      boolean _and = false;
