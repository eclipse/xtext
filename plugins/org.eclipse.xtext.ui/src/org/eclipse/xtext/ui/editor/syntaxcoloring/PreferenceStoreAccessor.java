...
public class PreferenceStoreAccessor {
	...
	private ChainedPreferenceStore getPluginCssPreferenceStore() {
		return new ChainedPreferenceStore(new IPreferenceStore[] {
				new ScopedPreferenceStore(new InstanceScope(), plugin.getBundle().getSymbolicName()),
				new ScopedPreferenceStore(new InstanceScope(), Activator.getDefault().getBundle().getSymbolicName())
		});
	}
