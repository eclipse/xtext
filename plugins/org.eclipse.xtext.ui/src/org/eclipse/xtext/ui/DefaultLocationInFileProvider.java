...
public class DefaultLocationInFileProvider implements ILocationInFileProvider {
	...
	public Region getLocation(EObject referenceOwner, EStructuralFeature feature, int indexInList) {
			...
			if (parserNode != null) {
				...
				for (TreeIterator<EObject> childrenIterator = parserNode.eAllContents(); childrenIterator.hasNext();) {
					...
					if (grammarElement instanceof CrossReference) {
						...
						if (feature == crossReference2) {
							if (currentIndex == indexInList || !feature.isMany()) {
