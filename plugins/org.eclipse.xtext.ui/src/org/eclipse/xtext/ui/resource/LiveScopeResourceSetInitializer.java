 ...
 * text editors, shadowed by the contents of the current ResourceSet. If you don't want to include the dirty state, use
 * {@link LiveModelScopeResourceSetInitializer}.
 * 
