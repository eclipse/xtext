package org.eclipse.xtend.macro.lang.serializer;
...
public class MacroSemanticSequencer extends XtendSemanticSequencer {
	...
	public void createSequence(EObject context, EObject semanticObject) {
		if(semanticObject.eClass().getEPackage() == MacroPackage.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			case MacroPackage.MACRO_ANNOTATION:
				if(context == grammarAccess.getMacroAnnotationRule() ||
				   context == grammarAccess.getTypeRule()) {
					sequence_MacroAnnotation(context, (MacroAnnotation) semanticObject); 
					return; 
				}
				else break;
			case MacroPackage.PROCESSOR:
				if(context == grammarAccess.getMacroAnnotationMemberRule() ||
				   context == grammarAccess.getProcessorRule()) {
					sequence_Processor(context, (Processor) semanticObject); 
					return; 
				}
				else break;
			case MacroPackage.REGISTRATOR:
				if(context == grammarAccess.getMacroAnnotationMemberRule() ||
				   context == grammarAccess.getRegistratorRule()) {
					sequence_Registrator(context, (Registrator) semanticObject); 
					return; 
				}
				else break;
			}
			...
			case XtendPackage.XTEND_CLASS:
				if(context == grammarAccess.getClassDeclarationRule() ||
				   context == grammarAccess.getTypeRule()) {
					sequence_ClassDeclaration(context, (XtendClass) semanticObject); 
					return; 
				}
				else break;
			...
			case XtendPackage.XTEND_FIELD:
				...
				else if(context == grammarAccess.getFieldRule() ||
				   context == grammarAccess.getMacroAnnotationMemberRule()) {
			...
			case XtendPackage.XTEND_FILE:
				...
				else if(context == grammarAccess.getMacroFileRule()) {
					sequence_MacroFile(context, (XtendFile) semanticObject); 
					return; 
				}
				else break;
	...
	/**
	 * Constraint:
	 *     (name=ValidID members+=Member*)
	 */
	protected void sequence_ClassDeclaration(EObject context, XtendClass semanticObject) {
	...
	/**
	 * Constraint:
	 *     (name=ValidID (targetType+=TargetType targetType+=TargetType*)? members+=MacroAnnotationMember*)
	 */
	protected void sequence_MacroAnnotation(EObject context, MacroAnnotation semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 *     expression=XBlockExpression
	 */
	protected void sequence_Registrator(EObject context, Registrator semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
}
