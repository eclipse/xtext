...
entryRuleMacroFile returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getMacroFileRule()); }
	 iv_ruleMacroFile=ruleMacroFile 
	 { $current=$iv_ruleMacroFile.current; } 
	 EOF 
;

// Rule MacroFile
ruleMacroFile returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((	otherlv_0='package' 
    {
    	newLeafNode(otherlv_0, grammarAccess.getMacroFileAccess().getPackageKeyword_0_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getMacroFileAccess().getPackageQualifiedNameParserRuleCall_0_1_0()); 
	    }
		lv_package_1_0=ruleQualifiedName		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getMacroFileRule());
	        }
       		set(
       			$current, 
       			"package",
    ...
    {
    	newLeafNode(otherlv_2, grammarAccess.getMacroFileAccess().getSemicolonKeyword_0_2());
    }
)?)?(
(
		{ 
	        newCompositeNode(grammarAccess.getMacroFileAccess().getImportSectionXImportSectionParserRuleCall_1_0()); 
	    }
...
(
    { 
        newCompositeNode(grammarAccess.getTypeAccess().getClassDeclarationParserRuleCall_0()); 
    }
    ...
    |
    { 
        newCompositeNode(grammarAccess.getTypeAccess().getMacroAnnotationParserRuleCall_1()); 
    }
    this_MacroAnnotation_1=ruleMacroAnnotation
    { 
        $current = $this_MacroAnnotation_1.current; 
        afterParserOrEnumRuleCall();
    }
)
;
...
(
		{ 
	        newCompositeNode(grammarAccess.getClassDeclarationAccess().getNameValidIDParserRuleCall_1_0()); 
	    }
    ...
    {
    	newLeafNode(otherlv_2, grammarAccess.getClassDeclarationAccess().getLeftCurlyBracketKeyword_2());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getClassDeclarationAccess().getMembersMemberParserRuleCall_3_0()); 
	    }
...
entryRuleMacroAnnotation returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getMacroAnnotationRule()); }
	 iv_ruleMacroAnnotation=ruleMacroAnnotation 
	 { $current=$iv_ruleMacroAnnotation.current; } 
	 EOF 
;

// Rule MacroAnnotation
ruleMacroAnnotation returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='@' 
    {
    	newLeafNode(otherlv_0, grammarAccess.getMacroAnnotationAccess().getCommercialAtKeyword_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getMacroAnnotationAccess().getNameValidIDParserRuleCall_1_0()); 
	    }
		lv_name_1_0=ruleValidID		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getMacroAnnotationRule());
	        }
       		set(
       			$current, 
       			"name",
    ...
    {
    	newLeafNode(otherlv_2, grammarAccess.getMacroAnnotationAccess().getForKeyword_2_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getMacroAnnotationAccess().getTargetTypeTargetTypeEnumRuleCall_2_1_0()); 
	    }
    ...
    {
    	newLeafNode(otherlv_4, grammarAccess.getMacroAnnotationAccess().getCommaKeyword_2_2_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getMacroAnnotationAccess().getTargetTypeTargetTypeEnumRuleCall_2_2_1_0()); 
	    }
		lv_targetType_5_0=ruleTargetType		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getMacroAnnotationRule());
	        }
       		add(
    ...
    {
    	newLeafNode(otherlv_6, grammarAccess.getMacroAnnotationAccess().getLeftCurlyBracketKeyword_3());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getMacroAnnotationAccess().getMembersMacroAnnotationMemberParserRuleCall_4_0()); 
	    }
		lv_members_7_0=ruleMacroAnnotationMember		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getMacroAnnotationRule());
	        }
       		add(
    ...
    {
    	newLeafNode(otherlv_8, grammarAccess.getMacroAnnotationAccess().getRightCurlyBracketKeyword_5());
    }
)
;
...
(    this_ID_0=RULE_ID    {
    ...
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getValidIDAccess().getFieldKeyword_3()); 
    }
    ...
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getValidIDAccess().getMethodKeyword_4()); 
    }
    ...
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getValidIDAccess().getParameterKeyword_5()); 
    }
    ...
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getValidIDAccess().getConstructorKeyword_6()); 
    }
    ...
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getValidIDAccess().getMacroKeyword_7()); 
    }
)
    ;
...
entryRuleMacroAnnotationMember returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getMacroAnnotationMemberRule()); }
	 iv_ruleMacroAnnotationMember=ruleMacroAnnotationMember 
	 { $current=$iv_ruleMacroAnnotationMember.current; } 
	 EOF 
;

// Rule MacroAnnotationMember
ruleMacroAnnotationMember returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(
    { 
        newCompositeNode(grammarAccess.getMacroAnnotationMemberAccess().getProcessorParserRuleCall_0()); 
    }
    this_Processor_0=ruleProcessor
    { 
        $current = $this_Processor_0.current; 
        afterParserOrEnumRuleCall();
    }

    |
    { 
        newCompositeNode(grammarAccess.getMacroAnnotationMemberAccess().getFieldParserRuleCall_1()); 
    }
    ...
    |
    { 
        newCompositeNode(grammarAccess.getMacroAnnotationMemberAccess().getRegistratorParserRuleCall_2()); 
    }
    this_Registrator_2=ruleRegistrator
    { 
        $current = $this_Registrator_2.current; 
        afterParserOrEnumRuleCall();
    }
)
;
...
(
    ...
    {
        newLeafNode(lv_static_0_0, grammarAccess.getFieldAccess().getStaticStaticKeyword_0_0());
    }
...
(
		{ 
	        newCompositeNode(grammarAccess.getFieldAccess().getInitialValueXExpressionParserRuleCall_3_1_0()); 
	    }
		lv_initialValue_4_0=ruleXExpression		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getFieldRule());
	        }
       		set(
...
entryRuleRegistrator returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getRegistratorRule()); }
	 iv_ruleRegistrator=ruleRegistrator 
	 { $current=$iv_ruleRegistrator.current; } 
	 EOF 
;

// Rule Registrator
ruleRegistrator returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='register' 
    {
    	newLeafNode(otherlv_0, grammarAccess.getRegistratorAccess().getRegisterKeyword_0());
    }
(
(
		lv_each_1_0=	'each' 
...
(	otherlv_0='process' 
    {
    	newLeafNode(otherlv_0, grammarAccess.getProcessorAccess().getProcessKeyword_0());
    }
(
(
		lv_each_1_0=	'each' 
...
((	enumLiteral_0='class' 
	{
        $current = grammarAccess.getTargetTypeAccess().getClassEnumLiteralDeclaration_0().getEnumLiteral().getInstance();
        newLeafNode(enumLiteral_0, grammarAccess.getTargetTypeAccess().getClassEnumLiteralDeclaration_0()); 
    }
)
    |(	enumLiteral_1='field' 
	{
        $current = grammarAccess.getTargetTypeAccess().getFieldEnumLiteralDeclaration_1().getEnumLiteral().getInstance();
        newLeafNode(enumLiteral_1, grammarAccess.getTargetTypeAccess().getFieldEnumLiteralDeclaration_1()); 
    }
)
    |(	enumLiteral_2='method' 
	{
        $current = grammarAccess.getTargetTypeAccess().getMethodEnumLiteralDeclaration_2().getEnumLiteral().getInstance();
        newLeafNode(enumLiteral_2, grammarAccess.getTargetTypeAccess().getMethodEnumLiteralDeclaration_2()); 
    }
)
    |(	enumLiteral_3='parameter' 
	{
        $current = grammarAccess.getTargetTypeAccess().getParameterEnumLiteralDeclaration_3().getEnumLiteral().getInstance();
        newLeafNode(enumLiteral_3, grammarAccess.getTargetTypeAccess().getParameterEnumLiteralDeclaration_3()); 
    }
)
    |(	enumLiteral_4='constructor' 
	{
        $current = grammarAccess.getTargetTypeAccess().getConstructorEnumLiteralDeclaration_4().getEnumLiteral().getInstance();
        newLeafNode(enumLiteral_4, grammarAccess.getTargetTypeAccess().getConstructorEnumLiteralDeclaration_4()); 
    }
));
