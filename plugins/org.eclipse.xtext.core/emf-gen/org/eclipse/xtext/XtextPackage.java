 ...
 * </copyright>
 *
 * $Id: XtextPackage.java,v 1.5 2008/05/19 12:11:16 jkohnlein Exp $
 */
...
public interface XtextPackage extends EPackage
{
   ...
   * @ordered
   */
  int PARSER_RULE__TYPE = ABSTRACT_RULE_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int LEXER_RULE__TOKEN_TYPE = ABSTRACT_RULE_FEATURE_COUNT + 0;
   ...
   * @ordered
   */
  int LEXER_RULE__BODY = ABSTRACT_RULE_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int GRAMMAR__METAMODEL_DECLARATIONS = 2;
   ...
   * @ordered
   */
  int ACTION__TYPE_NAME = ABSTRACT_ELEMENT_FEATURE_COUNT + 1;
   ...
   * @ordered
   */
  int ACTION__FEATURE = ABSTRACT_ELEMENT_FEATURE_COUNT + 2;
