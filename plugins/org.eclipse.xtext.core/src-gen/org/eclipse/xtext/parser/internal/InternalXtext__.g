...
// $ANTLR src "../org.eclipse.xtext.core/src-gen/org/eclipse/xtext/parser/internal/InternalXtext.g" 595
RULE_WS : (' '|'\t'|'\r'|'\n')+ {$channel=HIDDEN;};

// $ANTLR src "../org.eclipse.xtext.core/src-gen/org/eclipse/xtext/parser/internal/InternalXtext.g" 597
RULE_ID : ('^')?('a'..'z'|'A'..'Z'|'_') ('a'..'z'|'A'..'Z'|'_'|'0'..'9')*;

// $ANTLR src "../org.eclipse.xtext.core/src-gen/org/eclipse/xtext/parser/internal/InternalXtext.g" 599
RULE_LEXER_BODY : '<#' ( options {greedy=false;} : . )* '#>';

// $ANTLR src "../org.eclipse.xtext.core/src-gen/org/eclipse/xtext/parser/internal/InternalXtext.g" 601
