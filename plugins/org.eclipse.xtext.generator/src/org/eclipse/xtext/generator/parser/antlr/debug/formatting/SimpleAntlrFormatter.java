...
public class SimpleAntlrFormatter extends AbstractDeclarativeFormatter {
	...
	protected void configureFormatting(FormattingConfig c) {
		...
		c.setIndentation(getGrammarAccess().getRuleAccess().getColonKeyword_1(), getGrammarAccess().getRuleAccess().getSemicolonKeyword_3());
		...
		c.setLinewrap().after(getGrammarAccess().getRuleAccess().getColonKeyword_1());
		c.setLinewrap().before(getGrammarAccess().getRuleAccess().getSemicolonKeyword_3());
		c.setLinewrap(2).after(getGrammarAccess().getRuleAccess().getSemicolonKeyword_3());
	}
