 ...
 * </copyright>
 *
 * $Id: TestAdapterFactory.java,v 1.1 2008/10/30 08:34:08 sefftinge Exp $
 */
package org.eclipse..test.util;
...
public class TestAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected TestSwitch modelSwitch =
    new TestSwitch()
    {
      public Object caseFoo(Foo object)
      {
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.eclipse..test.Foo <em>Foo</em>}'.
   * <!-- begin-user-doc -->
