 ...
 * @generated
 */
public class AlternativesImpl extends RuleElementImpl implements Alternatives
{
  /**
   ...
   * @ordered
   */
  protected EList<RuleElement> groups;
  ...
  {
    return SimpleAntlrPackage.Literals.ALTERNATIVES;
  }
  ...
  public EList<RuleElement> getGroups()
  {
    if (groups == null)
    {
      groups = new EObjectContainmentEList<RuleElement>(RuleElement.class, this, SimpleAntlrPackage.ALTERNATIVES__GROUPS);
    }
    return groups;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SimpleAntlrPackage.ALTERNATIVES__GROUPS:
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      case SimpleAntlrPackage.ALTERNATIVES__GROUPS:
        getGroups().clear();
        getGroups().addAll((Collection<? extends RuleElement>)newValue);
        return;
    }
