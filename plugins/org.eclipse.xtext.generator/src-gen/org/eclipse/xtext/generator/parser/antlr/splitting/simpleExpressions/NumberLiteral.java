...
public interface NumberLiteral extends Expression
{
   ...
   * @see #setValue(int)
   * @see org.eclipse.xtext.generator.parser.antlr.splitting.simpleExpressions.SimpleExpressionsPackage#getNumberLiteral_Value()
   * @model
   * @generated
   */
  int getValue();
  ...
  /**
   * Sets the value of the '{@link org.eclipse.xtext.generator.parser.antlr.splitting.simpleExpressions.NumberLiteral#getValue <em>Value</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
