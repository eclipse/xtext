...
public class GenServiceImpl extends EObjectImpl implements GenService {
	...
	/**
	 * The cached value of the '{@link #getGenParameters() <em>Gen Parameters</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Map<String, String> getGenParameters() {
	 ...
	 * @generated
	 */
	public void setGenParameters(Map<String, String> newGenParameters) {
		Map<String, String> oldGenParameters = genParameters;
		genParameters = newGenParameters;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XtextgenPackage.GEN_SERVICE__GEN_PARAMETERS, oldGenParameters, genParameters));
	}
