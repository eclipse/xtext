...
public class DataProcessor extends AbstractClassProcessor {
  ...
  public void doTransform(final MutableClassDeclaration it, @Extension final TransformationContext context) {
    ...
    if (_not) {
      ...
      ehUtil.addHashCode(it, _dataFields_1, _hasSuperEquals);
    }
    ...
    if (_not_1) {
      ...
      boolean _hasSuperEquals_1 = ehUtil.hasSuperEquals(it);
      ehUtil.addEquals(it, _dataFields_2, _hasSuperEquals_1);
    }
