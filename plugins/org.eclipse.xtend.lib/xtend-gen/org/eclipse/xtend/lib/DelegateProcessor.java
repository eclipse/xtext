...
public class DelegateProcessor implements TransformationParticipant<MutableMemberDeclaration> {
  ...
  public static class Util {
    ...
    public Set<? extends TypeReference> getImplementedInterfaces(final TypeReference it) {
      Iterable<? extends TypeReference> _superTypes = it.getSuperTypes();
      ...
      Iterable<Set<? extends TypeReference>> _map = IterableExtensions.map(_superTypes, _function);
      ...
      MutableMethodDeclaration _xblockexpression = null;
      {
        ...
        final Procedure1<MutableMethodDeclaration> _function = new Procedure1<MutableMethodDeclaration>() {
          public void apply(final MutableMethodDeclaration impl) {
            Iterable<? extends TypeParameterDeclaration> _resolvedTypeParameters = resolvedMethod.getResolvedTypeParameters();
            final Procedure1<TypeParameterDeclaration> _function = new Procedure1<TypeParameterDeclaration>() {
              public void apply(final TypeParameterDeclaration it) {
                ...
                impl.addTypeParameter(_simpleName, ((TypeReference[])Conversions.unwrapArray(_upperBounds, TypeReference.class)));
              }
            };
            IterableExtensions.forEach(_resolvedTypeParameters, _function);
            Iterable<? extends TypeReference> _resolvedExceptions = resolvedMethod.getResolvedExceptions();
            impl.setExceptions(((TypeReference[])Conversions.unwrapArray(_resolvedExceptions, TypeReference.class)));
            ...
            impl.setReturnType(_resolvedReturnType);
            Iterable<? extends ResolvedParameter> _resolvedParameters = resolvedMethod.getResolvedParameters();
            final Procedure1<ResolvedParameter> _function_1 = new Procedure1<ResolvedParameter>() {
              public void apply(final ResolvedParameter p) {
                ...
                impl.addParameter(_simpleName, _resolvedType);
              }
            };
            IterableExtensions.forEach(_resolvedParameters, _function_1);
