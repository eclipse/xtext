...
public class AccessorsProcessor implements TransformationParticipant<MutableMemberDeclaration> {
  ...
  public static class Util {
    ...
    public void validateGetter(final MutableFieldDeclaration field) {
      ...
      if (_isInferred) {
        StringConcatenation _builder = new StringConcatenation();
        _builder.append("Support for inferred types on getters may be removed in the future.");
        _builder.newLine();
        _builder.append("Important validations cannot be done. Also, for boolean types the");
        _builder.newLine();
        _builder.append("getter may incorrectly be prefixed with \"get\" instead of \"is\".");
        _builder.newLine();
        this.context.addWarning(field, _builder.toString());
        return;
      }
      ...
      if (_tripleNotEquals) {
        ...
        if (_isFinal) {
          ...
          _builder_1.append("Cannot override the final method ");
          String _simpleSignature = overriddenGetter.getSimpleSignature();
          _builder_1.append(_simpleSignature, "");
        ...
        if (_not) {
          ...
          _builder_2.append("Cannot override the method ");
          String _simpleSignature_1 = overriddenGetter.getSimpleSignature();
          _builder_2.append(_simpleSignature_1, "");
          ...
          _builder_2.append("because its return type is incompatible with ");
          TypeReference _type_2 = field.getType();
          String _simpleName_2 = _type_2.getSimpleName();
          _builder_2.append(_simpleName_2, "");
          _builder_2.newLineIfNotEmpty();
          this.context.addError(field, _builder_2.toString());
        }
      }
    }
