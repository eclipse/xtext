...
public interface TypeLookup {
	...
	/**
	 * @param qualifiedName - the qualified name of the type to look up
	...
	/**
	 * @param qualifiedName - the qualified name of the type to look up
	 * @return the <code>MutableEnumerationTypeDeclaration</code> with given qualified
	 *         name, or <code>null</code> if no such class declaration is
	 *         contained in the currently processed <code>CompilationUnit</code>
	 */
	...
	/**
	 * @param qualifiedName - the qualified name of the type to look up
	 * @return the <code>MutableAnnotationTypeDeclaration</code> with given qualified
	 *         name, or <code>null</code> if no such class declaration is
	 *         contained in the currently processed <code>CompilationUnit</code>
	 */
