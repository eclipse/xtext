	...
	static class Util {
		...
		def StringConcatenationClient contributeToEquals(FieldDeclaration it) {
			switch (type.orObject.wrapperIfPrimitive) {
				...
				case Character.newTypeReference,
				case Byte.newTypeReference,
				case Short.newTypeReference,
