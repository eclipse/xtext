...
public class AbstractXtend2SemanticSequencer extends AbstractSemanticSequencer {
		...
		if(semanticObject.eClass().getEPackage() == Xtend2Package.eINSTANCE) switch(semanticObject.eClass().getClassifierID()) {
			...
			case Xtend2Package.XTEND_FIELD:
				if(context == grammarAccess.getMemberRule()) {
					sequence_Member_XtendField(context, (XtendField) semanticObject); 
					return; 
				}
				else break;
			case Xtend2Package.XTEND_MEMBER:
				if(context == grammarAccess.getMemberAccess().getXtendFieldAnnotationInfoAction_2_0_0() ||
				   context == grammarAccess.getMemberAccess().getXtendFunctionAnnotationInfoAction_2_1_0()) {
					sequence_Member_XtendField_2_0_0_XtendFunction_2_1_0_XtendMember(context, (XtendMember) semanticObject); 
					return; 
				}
				else break;
			case Xtend2Package.XTEND_FUNCTION:
				if(context == grammarAccess.getMemberRule()) {
					sequence_Member_XtendFunction(context, (XtendFunction) semanticObject); 
					return; 
				}
				else break;
			case Xtend2Package.XTEND_PARAMETER:
				if(context == grammarAccess.getParameterRule()) {
					sequence_Parameter_XtendParameter(context, (XtendParameter) semanticObject); 
					return; 
				}
				else break;
	...
	protected void sequence_CreateExtensionInfo_CreateExtensionInfo(EObject context, CreateExtensionInfo semanticObject) {
		...
		acceptor.accept(grammarAccess.getCreateExtensionInfoAccess().getNameIDTerminalRuleCall_1_0(), semanticObject.getName());
		acceptor.accept(grammarAccess.getCreateExtensionInfoAccess().getCreateExpressionXExpressionParserRuleCall_3_0(), semanticObject.getCreateExpression());
		acceptor.finish();
	}
	...
	protected void sequence_InternalRichStringLiteral_RichStringLiteral(EObject context, RichStringLiteral semanticObject) {
		...
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceAcceptor acceptor = createSequencerAcceptor(semanticObject, nodes);
		acceptor.accept(grammarAccess.getInternalRichStringLiteralAccess().getValueRICH_TEXT_INBETWEENTerminalRuleCall_1_0(), semanticObject.getValue());
		acceptor.finish();
	}
	 ...
	 *         EXCLUDE_IF_SET type
	 */
	protected void sequence_Member_XtendField(EObject context, XtendField semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	/**
	 * Constraint:
	 *     (TYPEMATCH annotations+=XAnnotation*)
	 *
	 * Features:
	 *    annotations[0, *]
	 */
	protected void sequence_Member_XtendField_2_0_0_XtendFunction_2_1_0_XtendMember(EObject context, XtendMember semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	 ...
	 */
	protected void sequence_Member_XtendFunction(EObject context, XtendFunction semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	/**
	 * Constraint:
	 *     (annotations+=XAnnotation* parameterType=JvmTypeReference name=ID)
	 *
	 * Features:
	 *    annotations[0, *]
	 *    name[1, 1]
	 *    parameterType[1, 1]
	 */
	protected void sequence_Parameter_XtendParameter(EObject context, XtendParameter semanticObject) {
		genericSequencer.createSequence(context, semanticObject);
	}
	...
	protected void sequence_RichStringElseIf_RichStringElseIf(EObject context, RichStringElseIf semanticObject) {
		...
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceAcceptor acceptor = createSequencerAcceptor(semanticObject, nodes);
		acceptor.accept(grammarAccess.getRichStringElseIfAccess().getIfXExpressionParserRuleCall_1_0(), semanticObject.getIf());
		acceptor.accept(grammarAccess.getRichStringElseIfAccess().getThenInternalRichStringParserRuleCall_2_0(), semanticObject.getThen());
		acceptor.finish();
	}
	...
	protected void sequence_RichStringLiteralEnd_RichStringLiteral(EObject context, RichStringLiteral semanticObject) {
		...
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceAcceptor acceptor = createSequencerAcceptor(semanticObject, nodes);
		acceptor.accept(grammarAccess.getRichStringLiteralEndAccess().getValueRICH_TEXT_ENDTerminalRuleCall_1_0(), semanticObject.getValue());
		acceptor.finish();
	}
	...
	protected void sequence_RichStringLiteralInbetween_RichStringLiteral(EObject context, RichStringLiteral semanticObject) {
		...
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceAcceptor acceptor = createSequencerAcceptor(semanticObject, nodes);
		acceptor.accept(grammarAccess.getRichStringLiteralInbetweenAccess().getValueRICH_TEXT_INBETWEENTerminalRuleCall_1_0(), semanticObject.getValue());
		acceptor.finish();
	}
	...
	protected void sequence_RichStringLiteralStart_RichStringLiteral(EObject context, RichStringLiteral semanticObject) {
		...
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceAcceptor acceptor = createSequencerAcceptor(semanticObject, nodes);
		acceptor.accept(grammarAccess.getRichStringLiteralStartAccess().getValueRICH_TEXT_STARTTerminalRuleCall_1_0(), semanticObject.getValue());
		acceptor.finish();
	}
	...
	protected void sequence_RichStringLiteral_RichStringLiteral(EObject context, RichStringLiteral semanticObject) {
		...
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceAcceptor acceptor = createSequencerAcceptor(semanticObject, nodes);
		acceptor.accept(grammarAccess.getRichStringLiteralAccess().getValueRICH_TEXTTerminalRuleCall_1_0(), semanticObject.getValue());
		acceptor.finish();
	}
	...
	/**
	 * Constraint:
	 *     (element=[JvmOperation|ID] value=XAnnotationElementValue)
	 *
	 * Features:
	 *    value[1, 1]
	 *    element[1, 1]
	...
	protected void sequence_XStringLiteral_XStringLiteral(EObject context, XStringLiteral semanticObject) {
		...
		INodesForEObjectProvider nodes = createNodeProvider(semanticObject);
		SequenceAcceptor acceptor = createSequencerAcceptor(semanticObject, nodes);
		acceptor.accept(grammarAccess.getXStringLiteralAccess().getValueSTRINGTerminalRuleCall_0_1_0(), semanticObject.getValue());
		acceptor.finish();
	}
