 ...
 * </copyright>
 *
 * $Id: XTypeLiteralImpl.java,v 1.1 2010/01/16 08:50:52 sefftinge Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.eclipse.xtext.xpression.impl.XTypeLiteralImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class XTypeLiteralImpl extends XExpressionImpl implements XTypeLiteral {
	...
	protected EClass eStaticClass() {
		return XpressionPackage.Literals.XTYPE_LITERAL;
	}
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, XpressionPackage.XTYPE_LITERAL__TYPE, oldType, type));
			}
		}
		return type;
	}
