 ...
 * </copyright>
 *
 * $Id: BooleanLiteralImpl.java,v 1.1 2010/01/14 14:40:17 sefftinge Exp $
 */
 ...
 * <ul>
 *   <li>{@link org.eclipse.xtext.xpression.impl.BooleanLiteralImpl#isIsTrue <em>Is True</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BooleanLiteralImpl extends ExpressionImpl implements BooleanLiteral {
	...
	protected EClass eStaticClass() {
		return XpressionPackage.Literals.BOOLEAN_LITERAL;
	}
	...
	public void setIsTrue(boolean newIsTrue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, XpressionPackage.BOOLEAN_LITERAL__IS_TRUE, oldIsTrue, isTrue));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case XpressionPackage.BOOLEAN_LITERAL__IS_TRUE:
				return isIsTrue();
		}
