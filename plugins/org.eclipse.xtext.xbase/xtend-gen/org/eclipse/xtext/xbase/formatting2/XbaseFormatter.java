...
public class XbaseFormatter extends AbstractFormatter {
  ...
  protected void format(final IFormattableDocument document) {
    ...
    XtextResource _resource = _textRegionAccess.getResource();
    ...
    if (_isEmpty) {
      ...
      if (_isMultiline) {
        ...
        final ISubFormatter _function_1 = new ISubFormatter() {
          public void format(@Extension final IFormattableSubDocument sub) throws FormattingNotApplicableException {
            final EObject head = IterableExtensions.head(elements);
            IHiddenRegion _leadingHiddenRegion = XbaseFormatter.this.regionAccess.leadingHiddenRegion(head);
            final int offset = _leadingHiddenRegion.getOffset();
            IHiddenRegion _trailingHiddenRegion = XbaseFormatter.this.regionAccess.trailingHiddenRegion(head);
            ...
            final ISubFormatter _function_1 = new ISubFormatter() {
              public void format(@Extension final IFormattableSubDocument doc) throws FormattingNotApplicableException {
                ...
                if (_prependNewLineIfMultiline) {
                  ...
                  doc.<EObject>prepend(head, _function);
                } else {
                  final Procedure1<IHiddenRegionFormatter> _function_1 = new Procedure1<IHiddenRegionFormatter>() {
                    public void apply(final IHiddenRegionFormatter it) {
                      it.noSpace();
                  ...
                  doc.<EObject>prepend(head, _function_1);
                }
                XbaseFormatter.this.format(head, doc);
              }
            };
            sub.formatConditionally(offset, lenght, _function, _function_1);
            ...
            for (final EObject arg : _tail) {
              {
                ...
                final int argoffset = _previousHiddenRegion.getOffset();
                IHiddenRegion _trailingHiddenRegion_1 = XbaseFormatter.this.regionAccess.trailingHiddenRegion(arg);
                int _offset_1 = _trailingHiddenRegion_1.getOffset();
                ...
                final ISubFormatter _function_3 = new ISubFormatter() {
                  public void format(@Extension final IFormattableSubDocument doc) throws FormattingNotApplicableException {
                    ...
                    final ISemanticRegion comma = doc.prepend(_immediatelyPrecedingKeyword, _function);
                    ...
                    if (_prependNewLineIfMultiline) {
                      ...
                      doc.append(comma, _function_2);
                    }
                    XbaseFormatter.this.format(arg, doc);
                  }
                };
                sub.formatConditionally(argoffset, arglenght, _function_2, _function_3);
              }
            }
            EObject _last = IterableExtensions.last(elements);
            final Procedure1<IHiddenRegionFormatter> _function_2 = new Procedure1<IHiddenRegionFormatter>() {
            ...
            sub.<EObject>append(_last, _function_2);
          }
        };
        final ISubFormatter fmt = _function_1;
        EObject _head = IterableExtensions.head(elements);
        IHiddenRegion _leadingHiddenRegion = this.regionAccess.leadingHiddenRegion(_head);
        final int offset = _leadingHiddenRegion.getOffset();
        EObject _last = IterableExtensions.last(elements);
        IHiddenRegion _trailingHiddenRegion = this.regionAccess.trailingHiddenRegion(_last);
        int _endOffset = _trailingHiddenRegion.getEndOffset();
        final int lenght = (_endOffset - offset);
        final ISubFormatter _function_2 = new ISubFormatter() {
          public void format(final IFormattableSubDocument doc) throws FormattingNotApplicableException {
            IFormattableSubDocument _requireFitsInLine = doc.requireFitsInLine();
            fmt.format(_requireFitsInLine);
          }
        };
        final ISubFormatter _function_3 = new ISubFormatter() {
          public void format(@Extension final IFormattableSubDocument doc) throws FormattingNotApplicableException {
            ...
            doc.<EObject>prepend(_head, _function);
            fmt.format(doc);
            EObject _last = IterableExtensions.last(elements);
            final Procedure1<IHiddenRegionFormatter> _function_1 = new Procedure1<IHiddenRegionFormatter>() {
              public void apply(final IHiddenRegionFormatter it) {
            ...
            doc.<EObject>append(_last, _function_1);
          }
        };
        format.formatConditionally(offset, lenght, _function_2, _function_3);
      }
  ...
  protected void _format(final JvmGenericArrayTypeReference array, @Extension final IFormattableDocument document) {
    ...
    ArrayBracketsFormattingReplacer _arrayBracketsFormattingReplacer = new ArrayBracketsFormattingReplacer(document, _regionForRuleCallTo);
  ...
  protected void _format(final XMemberFeatureCall expr, @Extension final IFormattableDocument format) {
    ...
    for (final XMemberFeatureCall call : calls) {
      {
        ...
        ISemanticRegion _regionForKeyword = this.regionAccess.regionForKeyword(call, op);
        final Procedure1<IHiddenRegionFormatter> _function = new Procedure1<IHiddenRegionFormatter>() {
          public void apply(final IHiddenRegionFormatter it) {
            it.noSpace();
          }
        };
        ISemanticRegion _prepend = format.prepend(_regionForKeyword, _function);
        final Procedure1<IHiddenRegionFormatter> _function_1 = new Procedure1<IHiddenRegionFormatter>() {
          public void apply(final IHiddenRegionFormatter it) {
            it.noSpace();
        ...
        if (_isExplicitOperationCall) {
          ISemanticRegion _regionForKeyword_1 = this.regionAccess.regionForKeyword(call, "(");
          final Procedure1<IHiddenRegionFormatter> _function_2 = new Procedure1<IHiddenRegionFormatter>() {
            public void apply(final IHiddenRegionFormatter it) {
              it.noSpace();
            }
          };
          final ISemanticRegion open = format.prepend(_regionForKeyword_1, _function_2);
  ...
  protected void _format(final XBinaryOperation expr, @Extension final IFormattableDocument format) {
    ...
    final ArrayList<XBinaryOperation> calls = CollectionLiterals.<XBinaryOperation>newArrayList();
    EObject top = expr;
    ...
    Collections.reverse(calls);
    final ISubFormatter _function = new ISubFormatter() {
      public void format(@Extension final IFormattableSubDocument x) throws FormattingNotApplicableException {
        for (final XBinaryOperation call : calls) {
          {
            final ISemanticRegion op = XbaseFormatter.this.regionAccess.regionForFeature(call, XbasePackage.Literals.XABSTRACT_FEATURE_CALL__FEATURE);
            IHiddenRegion _previousHiddenRegion = op.getPreviousHiddenRegion();
            final int offset = _previousHiddenRegion.getOffset();
            XExpression _rightOperand = call.getRightOperand();
            IHiddenRegion _trailingHiddenRegion = XbaseFormatter.this.regionAccess.trailingHiddenRegion(_rightOperand);
            int _offset = _trailingHiddenRegion.getOffset();
            final int length = (_offset - offset);
            final ISubFormatter _function = new ISubFormatter() {
              public void format(final IFormattableSubDocument doc) throws FormattingNotApplicableException {
            ...
            x.formatConditionally(offset, length, _function, _function_1);
          }
        }
      }
    };
    final ISubFormatter formatCalls = _function;
    XBinaryOperation _head = IterableExtensions.<XBinaryOperation>head(calls);
    ISemanticRegion _regionForFeature = this.regionAccess.regionForFeature(_head, XbasePackage.Literals.XABSTRACT_FEATURE_CALL__FEATURE);
    IHiddenRegion _previousHiddenRegion = _regionForFeature.getPreviousHiddenRegion();
    final int offset = _previousHiddenRegion.getOffset();
    XBinaryOperation _last = IterableExtensions.<XBinaryOperation>last(calls);
    XExpression _rightOperand = _last.getRightOperand();
    IHiddenRegion _trailingHiddenRegion = this.regionAccess.trailingHiddenRegion(_rightOperand);
    int _offset = _trailingHiddenRegion.getOffset();
    final int length = (_offset - offset);
    final ISubFormatter _function_1 = new ISubFormatter() {
      public void format(final IFormattableSubDocument doc) throws FormattingNotApplicableException {
        IFormattableSubDocument _requireFitsInLine = doc.requireFitsInLine();
        formatCalls.format(_requireFitsInLine);
      }
    };
    final ISubFormatter _function_2 = new ISubFormatter() {
      public void format(@Extension final IFormattableSubDocument it) throws FormattingNotApplicableException {
        XBinaryOperation _head = IterableExtensions.<XBinaryOperation>head(calls);
        ISemanticRegion _regionForFeature = XbaseFormatter.this.regionAccess.regionForFeature(_head, XbasePackage.Literals.XABSTRACT_FEATURE_CALL__FEATURE);
        final Procedure1<IHiddenRegionFormatter> _function = new Procedure1<IHiddenRegionFormatter>() {
          public void apply(final IHiddenRegionFormatter it) {
            it.increaseIndentation();
          }
        };
        it.prepend(_regionForFeature, _function);
        formatCalls.format(it);
        XBinaryOperation _last = IterableExtensions.<XBinaryOperation>last(calls);
        ISemanticRegion _regionForFeature_1 = XbaseFormatter.this.regionAccess.regionForFeature(_last, XbasePackage.Literals.XABSTRACT_FEATURE_CALL__FEATURE);
        final Procedure1<IHiddenRegionFormatter> _function_1 = new Procedure1<IHiddenRegionFormatter>() {
          public void apply(final IHiddenRegionFormatter it) {
            it.decreaseIndentation();
          }
        };
        it.append(_regionForFeature_1, _function_1);
      }
    };
    format.formatConditionally(offset, length, _function_1, _function_2);
  }
    ...
    for (final ISemanticRegion region : _regionsForRuleCallsTo) {
      {
        ...
        ArrayBracketsFormattingReplacer _arrayBracketsFormattingReplacer = new ArrayBracketsFormattingReplacer(format, region);
    ...
    if (switchSL) {
      ...
      if (caseSL) {
        ...
        if (_notEquals_8) {
          ...
          format.append(_regionForKeyword_3, _function_23);
  ...
  protected void _format(final XClosure expr, @Extension final IFormattableDocument format) {
    ...
    if (_isEmpty) {
      ...
      if (_isMultiline) {
        ...
        IHiddenRegion _nextHiddenRegion_1 = close.getNextHiddenRegion();
        int _offset = _nextHiddenRegion_1.getOffset();
        final int length = (_offset - offset);
        final ISubFormatter _function_3 = new ISubFormatter() {
          public void format(final IFormattableSubDocument doc) throws FormattingNotApplicableException {
            @Extension
