...
public class XbaseFormatter extends AbstractFormatter2 {
  ...
  protected void _format(final XMemberFeatureCall expr, @Extension final IFormattableDocument format) {
    EObject top = expr;
    ITextSegment _region = this.regionAccess.region(expr);
    SeparatorRegions<XMemberFeatureCall, ISemanticRegion> calls = new SeparatorRegions<XMemberFeatureCall, ISemanticRegion>(_region);
    ...
    for (final ObjectEntry<XMemberFeatureCall, ISemanticRegion> entry : calls) {
      {
        ...
        ITextSegment _region_1 = entry.getRegion();
        int _length = _region_1.getLength();
