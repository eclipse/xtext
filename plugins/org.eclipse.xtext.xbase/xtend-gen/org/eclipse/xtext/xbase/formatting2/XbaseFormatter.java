...
public class XbaseFormatter extends AbstractFormatter {
  @Inject
  ...
  protected void format(final IFormattableDocument document) {
    IFormatterRequest _request = document.getRequest();
    ITextRegionAccess _tokens = _request.getTokens();
    XtextResource _resource = _tokens.getResource();
    EList<EObject> _contents = _resource.getContents();
    EObject _head = IterableExtensions.<EObject>head(_contents);
    this.format(_head, document);
  }
  
  protected void _format(final Void expr, @Extension final IFormattableDocument format) {
  }
  
  protected void _format(final EObject expr, @Extension final IFormattableDocument format) {
  }
  
  protected void _format(final XCollectionLiteral literal, @Extension final IFormattableDocument document) {
    ISemanticRegion _kenForKeyword = this.regionAccess.tokenForKeyword(literal, "#");
    ...
    document.append(_kenForKeyword, _function);
    ISemanticRegion _elvis = null;
    ISemanticRegion _kenForKeyword_1 = this.regionAccess.tokenForKeyword(literal, "[");
    if (_kenForKeyword_1 != null) {
      _elvis = _kenForKeyword_1;
    } else {
      ISemanticRegion _kenForKeyword_2 = this.regionAccess.tokenForKeyword(literal, "{");
      _elvis = _kenForKeyword_2;
    }
    final ISemanticRegion open = _elvis;
    ISemanticRegion _elvis_1 = null;
    ISemanticRegion _kenForKeyword_3 = this.regionAccess.tokenForKeyword(literal, "]");
    if (_kenForKeyword_3 != null) {
      _elvis_1 = _kenForKeyword_3;
    } else {
      ISemanticRegion _kenForKeyword_4 = this.regionAccess.tokenForKeyword(literal, "}");
      _elvis_1 = _kenForKeyword_4;
    }
  ...
  protected Object formatCommaSeparatedList(final Collection<? extends EObject> elements, final ISemanticRegion open, final ISemanticRegion close, @Extension final IFormattableDocument format) {
    ...
    if (_isEmpty) {
      ...
      IHiddenRegion _leadingGap = close.getLeadingGap();
      boolean _isMultiline = _leadingGap.isMultiline();
      if (_isMultiline) {
          ...
          for (final EObject elem : elements) {
            {
              ...
              final Procedure1<IHiddenRegionFormatting> _function_2 = new Procedure1<IHiddenRegionFormatting>() {
                public void apply(final IHiddenRegionFormatting it) {
                  it.noSpace();
                }
              };
              ISemanticRegion _prepend = format.prepend(_immediatelyFollowingKeyword, _function_2);
              final Procedure1<IHiddenRegionFormatting> _function_3 = new Procedure1<IHiddenRegionFormatting>() {
                public void apply(final IHiddenRegionFormatting it) {
                  it.newLine();
                }
              };
        ...
        {
          final EObject head = IterableExtensions.head(elements);
          IHiddenRegion _leadingGap_1 = this.regionAccess.leadingGap(head);
          final int offset = _leadingGap_1.getOffset();
          IHiddenRegion _trailingGap = this.regionAccess.trailingGap(head);
          int _offset = _trailingGap.getOffset();
          final int lenght = (_offset - offset);
          final ISubFormatter _function_1 = new ISubFormatter() {
            public void format(final IFormattableSubDocument doc) throws FormattingNotApplicableException {
              ...
              EObject _prepend = it.<EObject>prepend(head, _function);
              XbaseFormatter.this.format(_prepend, it);
            }
          };
          final ISubFormatter _function_2 = new ISubFormatter() {
            public void format(@Extension final IFormattableSubDocument it) throws FormattingNotApplicableException {
              boolean _prependNewLineIfMultiline = XbaseFormatter.this.prependNewLineIfMultiline(head);
              if (_prependNewLineIfMultiline) {
                ...
                it.<EObject>prepend(head, _function);
              } else {
                final Procedure1<IHiddenRegionFormatting> _function_1 = new Procedure1<IHiddenRegionFormatting>() {
                  public void apply(final IHiddenRegionFormatting it) {
                    it.noSpace();
                ...
                it.<EObject>prepend(head, _function_1);
              }
              XbaseFormatter.this.format(head, it);
            }
          };
          format.formatConditionally(offset, lenght, _function_1, _function_2);
          Iterable<? extends EObject> _tail = IterableExtensions.tail(elements);
          for (final EObject arg : _tail) {
            {
              ISemanticRegion _immediatelyPrecedingKeyword = this.regionAccess.immediatelyPrecedingKeyword(arg, ",");
              IHiddenRegion _leadingGap_2 = _immediatelyPrecedingKeyword.getLeadingGap();
              final int argoffset = _leadingGap_2.getOffset();
              IHiddenRegion _trailingGap_1 = this.regionAccess.trailingGap(arg);
              int _offset_1 = _trailingGap_1.getOffset();
              final int arglenght = (_offset_1 - argoffset);
              final ISubFormatter _function_3 = new ISubFormatter() {
                public void format(final IFormattableSubDocument doc) throws FormattingNotApplicableException {
                  @Extension
                  final IFormattableSubDocument it = doc.requireFitsInLine();
                  ISemanticRegion _immediatelyPrecedingKeyword = XbaseFormatter.this.regionAccess.immediatelyPrecedingKeyword(arg, ",");
                  final Procedure1<IHiddenRegionFormatting> _function = new Procedure1<IHiddenRegionFormatting>() {
                    public void apply(final IHiddenRegionFormatting it) {
                      it.noSpace();
                    }
                  };
                  ISemanticRegion _prepend = it.prepend(_immediatelyPrecedingKeyword, _function);
                  final Procedure1<IHiddenRegionFormatting> _function_1 = new Procedure1<IHiddenRegionFormatting>() {
                    public void apply(final IHiddenRegionFormatting it) {
                      it.oneSpace();
                      it.autowrap();
                  ...
                  it.append(_prepend, _function_1);
                  XbaseFormatter.this.format(arg, it);
                }
              };
              final ISubFormatter _function_4 = new ISubFormatter() {
                public void format(@Extension final IFormattableSubDocument it) throws FormattingNotApplicableException {
                  ...
                  final ISemanticRegion comma = it.prepend(_immediatelyPrecedingKeyword, _function);
                  boolean _prependNewLineIfMultiline = XbaseFormatter.this.prependNewLineIfMultiline(arg);
                  if (_prependNewLineIfMultiline) {
                    final Procedure1<IHiddenRegionFormatting> _function_1 = new Procedure1<IHiddenRegionFormatting>() {
                      public void apply(final IHiddenRegionFormatting it) {
                        it.newLine();
                    ...
                    it.append(comma, _function_2);
                  }
                  XbaseFormatter.this.format(arg, it);
                }
              };
              format.formatConditionally(argoffset, arglenght, _function_3, _function_4);
            }
          }
          EObject _last = IterableExtensions.last(elements);
          final Procedure1<IHiddenRegionFormatting> _function_3 = new Procedure1<IHiddenRegionFormatting>() {
          ...
          _xblockexpression_1 = format.<EObject>append(_last, _function_3);
        }
  ...
  protected void _format(final XAnnotation ann, @Extension final IFormattableDocument document) {
    ISemanticRegion _kenForKeyword = this.regionAccess.tokenForKeyword(ann, "@");
    final Procedure1<IHiddenRegionFormatting> _function = new Procedure1<IHiddenRegionFormatting>() {
      public void apply(final IHiddenRegionFormatting it) {
        it.noSpace();
      }
    ...
    document.append(_kenForKeyword, _function);
    ISemanticRegion _kenForKeyword_1 = this.regionAccess.tokenForKeyword(ann, "(");
    final Procedure1<IHiddenRegionFormatting> _function_1 = new Procedure1<IHiddenRegionFormatting>() {
      public void apply(final IHiddenRegionFormatting it) {
        it.noSpace();
      }
    };
    document.surround(_kenForKeyword_1, _function_1);
    XExpression _value = ann.getValue();
    boolean _notEquals = (!Objects.equal(_value, null));
    if (_notEquals) {
      XExpression _value_1 = ann.getValue();
      this.format(_value_1, document);
      ISemanticRegion _kenForKeyword_2 = this.regionAccess.tokenForKeyword(ann, ")");
      final Procedure1<IHiddenRegionFormatting> _function_2 = new Procedure1<IHiddenRegionFormatting>() {
        public void apply(final IHiddenRegionFormatting it) {
          it.noSpace();
        }
      };
      document.prepend(_kenForKeyword_2, _function_2);
    } else {
      ...
      if (_not) {
        ...
        for (final XAnnotationElementValuePair pair : _elementValuePairs_1) {
          {
            ISemanticRegion _kenForKeyword_3 = this.regionAccess.tokenForKeyword(pair, "=");
            final Procedure1<IHiddenRegionFormatting> _function_3 = new Procedure1<IHiddenRegionFormatting>() {
              public void apply(final IHiddenRegionFormatting it) {
                it.noSpace();
              }
            };
            document.surround(_kenForKeyword_3, _function_3);
            ...
            final Procedure1<IHiddenRegionFormatting> _function_4 = new Procedure1<IHiddenRegionFormatting>() {
              public void apply(final IHiddenRegionFormatting it) {
                it.noSpace();
              }
            };
            ISemanticRegion _prepend = document.prepend(_immediatelyFollowingKeyword, _function_4);
            final Procedure1<IHiddenRegionFormatting> _function_5 = new Procedure1<IHiddenRegionFormatting>() {
              public void apply(final IHiddenRegionFormatting it) {
                it.oneSpace();
              }
            };
        ...
        ISemanticRegion _kenForKeyword_3 = this.regionAccess.tokenForKeyword(ann, ")");
        final Procedure1<IHiddenRegionFormatting> _function_3 = new Procedure1<IHiddenRegionFormatting>() {
          public void apply(final IHiddenRegionFormatting it) {
            it.noSpace();
          }
        };
        document.prepend(_kenForKeyword_3, _function_3);
      }
    }
  }
  
  protected ITextReplacer formatArrayBrackets() {
    final ITextReplacer _function = new ITextReplacer() {
      public ITextReplacer.Flow createReplacements(final ITextReplacerContext it) {
        final String t = it.getText();
  ...
  protected void _format(final JvmGenericArrayTypeReference array, @Extension final IFormattableDocument document) {
    final ITextReplacer a = this.formatArrayBrackets();
    ParserRule _arrayBracketsRule = this.grammar.getArrayBracketsRule();
    ISemanticRegion _kenForRuleCallTo = this.regionAccess.tokenForRuleCallTo(array, _arrayBracketsRule);
    document.setReplacer(_kenForRuleCallTo, a);
  ...
  protected void _format(final XFunctionTypeRef func, @Extension final IFormattableDocument document) {
    ISemanticRegion _kenForKeyword = this.regionAccess.tokenForKeyword(func, "(");
    final Procedure1<IHiddenRegionFormatting> _function = new Procedure1<IHiddenRegionFormatting>() {
      public void apply(final IHiddenRegionFormatting it) {
        it.noSpace();
      }
    ...
    ISemanticRegion _kenForKeyword_1 = this.regionAccess.tokenForKeyword(func, ")");
    final Procedure1<IHiddenRegionFormatting> _function_1 = new Procedure1<IHiddenRegionFormatting>() {
      public void apply(final IHiddenRegionFormatting it) {
        EList<JvmTypeReference> _paramTypes = func.getParamTypes();
    ...
    ISemanticRegion _prepend = document.prepend(_kenForKeyword_1, _function_1);
    final Procedure1<IHiddenRegionFormatting> _function_2 = new Procedure1<IHiddenRegionFormatting>() {
      public void apply(final IHiddenRegionFormatting it) {
        it.noSpace();
      }
    ...
    document.append(_prepend, _function_2);
    ISemanticRegion _kenForKeyword_2 = this.regionAccess.tokenForKeyword(func, "=>");
    final Procedure1<IHiddenRegionFormatting> _function_3 = new Procedure1<IHiddenRegionFormatting>() {
      public void apply(final IHiddenRegionFormatting it) {
        it.noSpace();
      }
    };
    document.append(_kenForKeyword_2, _function_3);
  ...
  protected void _format(final JvmParameterizedTypeReference ref, @Extension final IFormattableDocument document) {
    ISemanticRegion _kenForKeyword = this.regionAccess.tokenForKeyword(ref, "<");
    final Procedure1<IHiddenRegionFormatting> _function = new Procedure1<IHiddenRegionFormatting>() {
      public void apply(final IHiddenRegionFormatting it) {
        it.noSpace();
      }
    };
    document.surround(_kenForKeyword, _function);
    ...
    boolean _not = (!_isEmpty);
    if (_not) {
      ISemanticRegion _kenForKeyword_1 = this.regionAccess.tokenForKeyword(ref, ">");
      final Procedure1<IHiddenRegionFormatting> _function_1 = new Procedure1<IHiddenRegionFormatting>() {
        public void apply(final IHiddenRegionFormatting it) {
          it.noSpace();
        }
      };
      document.prepend(_kenForKeyword_1, _function_1);
    }
  }
  ...
  protected void _format(final XVariableDeclaration expr, @Extension final IFormattableDocument format) {
    ISemanticRegion _kenForKeyword = this.regionAccess.tokenForKeyword(expr, "val");
    final Procedure1<IHiddenRegionFormatting> _function = new Procedure1<IHiddenRegionFormatting>() {
      public void apply(final IHiddenRegionFormatting it) {
        it.oneSpace();
      }
    };
    format.append(_kenForKeyword, _function);
    ISemanticRegion _kenForKeyword_1 = this.regionAccess.tokenForKeyword(expr, "var");
    final Procedure1<IHiddenRegionFormatting> _function_1 = new Procedure1<IHiddenRegionFormatting>() {
      public void apply(final IHiddenRegionFormatting it) {
        it.oneSpace();
      }
    };
    format.append(_kenForKeyword_1, _function_1);
    ...
    ISemanticRegion _kenForKeyword_2 = this.regionAccess.tokenForKeyword(expr, "=");
    final Procedure1<IHiddenRegionFormatting> _function_3 = new Procedure1<IHiddenRegionFormatting>() {
      public void apply(final IHiddenRegionFormatting it) {
        it.oneSpace();
      }
    };
    format.surround(_kenForKeyword_2, _function_3);
  ...
  protected void _format(final XAssignment expr, @Extension final IFormattableDocument format) {
    ...
    ISemanticRegion _kenForRuleCallTo = this.regionAccess.tokenForRuleCallTo(expr, _opSingleAssignRule);
    final Procedure1<IHiddenRegionFormatting> _function = new Procedure1<IHiddenRegionFormatting>() {
      public void apply(final IHiddenRegionFormatting it) {
        it.oneSpace();
      }
    };
    format.surround(_kenForRuleCallTo, _function);
    ...
    ISemanticRegion _kenForKeyword = this.regionAccess.tokenForKeyword(expr, _xifexpression);
    final Procedure1<IHiddenRegionFormatting> _function_1 = new Procedure1<IHiddenRegionFormatting>() {
      public void apply(final IHiddenRegionFormatting it) {
        it.noSpace();
      }
    };
    format.surround(_kenForKeyword, _function_1);
  ...
  protected void formatBuilderWithLeadingGap(final XClosure closure, @Extension final IFormattableDocument format) {
    ...
    if (_notEquals) {
      IHiddenRegion _leadingGap = this.regionAccess.leadingGap(closure);
      final int offset = _leadingGap.getOffset();
      IHiddenRegion _trailingGap = this.regionAccess.trailingGap(closure);
      int _offset = _trailingGap.getOffset();
  ...
  protected void _format(final XConstructorCall expr, @Extension final IFormattableDocument format) {
    ISemanticRegion _kenForFeature = this.regionAccess.tokenForFeature(expr, XbasePackage.Literals.XCONSTRUCTOR_CALL__CONSTRUCTOR);
    final Procedure1<IHiddenRegionFormatting> _function = new Procedure1<IHiddenRegionFormatting>() {
      public void apply(final IHiddenRegionFormatting it) {
        it.oneSpace();
      }
    };
    format.prepend(_kenForFeature, _function);
    EList<JvmTypeReference> _typeArguments = expr.getTypeArguments();
    boolean _isEmpty = _typeArguments.isEmpty();
    boolean _not = (!_isEmpty);
    if (_not) {
      ISemanticRegion _kenForKeyword = this.regionAccess.tokenForKeyword(expr, "<");
      final Procedure1<IHiddenRegionFormatting> _function_1 = new Procedure1<IHiddenRegionFormatting>() {
        public void apply(final IHiddenRegionFormatting it) {
          it.noSpace();
        }
      ...
      ISemanticRegion _kenForKeyword_1 = this.regionAccess.tokenForKeyword(expr, ">");
      final Procedure1<IHiddenRegionFormatting> _function_2 = new Procedure1<IHiddenRegionFormatting>() {
        public void apply(final IHiddenRegionFormatting it) {
          it.noSpace();
        }
      };
      format.prepend(_kenForKeyword_1, _function_2);
    }
    final ISemanticRegion open = this.regionAccess.tokenForKeyword(expr, "(");
    final ISemanticRegion close = this.regionAccess.tokenForKeyword(expr, ")");
    final Procedure1<IHiddenRegionFormatting> _function_3 = new Procedure1<IHiddenRegionFormatting>() {
      public void apply(final IHiddenRegionFormatting it) {
        it.noSpace();
      }
  ...
  protected void formatFeatureCallTypeParameters(final XAbstractFeatureCall expr, @Extension final IFormattableDocument format) {
    ...
    if (_not) {
      ...
      format.surround(_kenForKeyword_1, _function_1);
    }
  }
  ...
  protected void _format(final XFeatureCall expr, @Extension final IFormattableDocument format) {
    ...
    if (_isExplicitOperationCall) {
      ...
      final ISemanticRegion open = format.prepend(_kenForKeyword, _function);
      final ISemanticRegion close = this.regionAccess.tokenForKeyword(expr, ")");
    ...
    for (final XMemberFeatureCall call : _reverse) {
      {
        ...
        ISemanticRegion _kenForKeyword = this.regionAccess.tokenForKeyword(call, op);
        final Procedure1<IHiddenRegionFormatting> _function = new Procedure1<IHiddenRegionFormatting>() {
          public void apply(final IHiddenRegionFormatting it) {
            it.noSpace();
          }
        };
        ISemanticRegion _prepend = format.prepend(_kenForKeyword, _function);
        final Procedure1<IHiddenRegionFormatting> _function_1 = new Procedure1<IHiddenRegionFormatting>() {
          public void apply(final IHiddenRegionFormatting it) {
            it.noSpace();
            it.autowrap();
        ...
        if (_isExplicitOperationCall) {
          ISemanticRegion _kenForKeyword_1 = this.regionAccess.tokenForKeyword(call, "(");
          final Procedure1<IHiddenRegionFormatting> _function_2 = new Procedure1<IHiddenRegionFormatting>() {
            public void apply(final IHiddenRegionFormatting it) {
              it.noSpace();
            }
          };
          final ISemanticRegion open = format.prepend(_kenForKeyword_1, _function_2);
          final ISemanticRegion close = this.regionAccess.tokenForKeyword(call, ")");
  ...
  protected AbstractRule binaryOperationPrecedence(final EObject op) {
    final ISemanticRegion node = this.regionAccess.tokenForFeature(op, XbasePackage.Literals.XABSTRACT_FEATURE_CALL__FEATURE);
    boolean _and = false;
  ...
  protected void _format(final XBinaryOperation expr, @Extension final IFormattableDocument format) {
    ...
    for (final XBinaryOperation call : _reverse) {
      {
        final ISemanticRegion op = this.regionAccess.tokenForFeature(call, XbasePackage.Literals.XABSTRACT_FEATURE_CALL__FEATURE);
        IHiddenRegion _leadingGap = op.getLeadingGap();
        final int offset = _leadingGap.getOffset();
        XExpression _rightOperand = call.getRightOperand();
        IHiddenRegion _trailingGap = this.regionAccess.trailingGap(_rightOperand);
        int _offset = _trailingGap.getOffset();
        final int length = (_offset - offset);
        final ISubFormatter _function = new ISubFormatter() {
          public void format(final IFormattableSubDocument doc) throws FormattingNotApplicableException {
            ...
            ISemanticRegion _prepend = it.prepend(op, _function);
            final Procedure1<IHiddenRegionFormatting> _function_1 = new Procedure1<IHiddenRegionFormatting>() {
              public void apply(final IHiddenRegionFormatting it) {
                it.oneSpace();
                it.autowrap();
            ...
            it.append(_prepend, _function_1);
            XExpression _rightOperand = call.getRightOperand();
            XbaseFormatter.this.format(_rightOperand, it);
          }
        };
        final ISubFormatter _function_1 = new ISubFormatter() {
          public void format(@Extension final IFormattableSubDocument it) throws FormattingNotApplicableException {
            ...
            it.prepend(op, _function);
            XExpression _rightOperand = call.getRightOperand();
            boolean _prependNewLineIfMultiline = XbaseFormatter.this.prependNewLineIfMultiline(_rightOperand);
            if (_prependNewLineIfMultiline) {
              final Procedure1<IHiddenRegionFormatting> _function_1 = new Procedure1<IHiddenRegionFormatting>() {
                public void apply(final IHiddenRegionFormatting it) {
                  it.newLine();
              ...
              it.append(op, _function_2);
            }
            XExpression _rightOperand_1 = call.getRightOperand();
            XbaseFormatter.this.format(_rightOperand_1, it);
          }
        };
        format.formatConditionally(offset, length, _function, _function_1);
      }
  ...
  protected void _format(final XSynchronizedExpression expr, @Extension final IFormattableDocument format) {
    ...
    if ((_eContainer instanceof XVariableDeclaration)) {
      ISemanticRegion _kenForKeyword = this.regionAccess.tokenForKeyword(expr, "synchronized");
      final Procedure1<IHiddenRegionFormatting> _function = new Procedure1<IHiddenRegionFormatting>() {
        public void apply(final IHiddenRegionFormatting it) {
          it.increaseIndentation();
        }
    ...
    if (_isMultiline) {
      ...
      IHiddenRegion _leadingGap = this.regionAccess.leadingGap(_expression_1);
      boolean _isMultiline_1 = _leadingGap.isMultiline();
      _or = _isMultiline_1;
    }
    ...
    if (_or_1) {
      ISemanticRegion _kenForKeyword_1 = this.regionAccess.tokenForKeyword(expr, "synchronized");
      format.append(_kenForKeyword_1, XbaseFormatterPreferenceKeys.whitespaceBetweenKeywordAndParenthesisML);
    } else {
      ISemanticRegion _kenForKeyword_2 = this.regionAccess.tokenForKeyword(expr, "synchronized");
      format.append(_kenForKeyword_2, XbaseFormatterPreferenceKeys.whitespaceBetweenKeywordAndParenthesisSL);
    }
  ...
  protected void _format(final XIfExpression expr, @Extension final IFormattableDocument format) {
    EObject _eContainer = expr.eContainer();
    if ((_eContainer instanceof XVariableDeclaration)) {
      ISemanticRegion _kenForKeyword = this.regionAccess.tokenForKeyword(expr, "if");
      final Procedure1<IHiddenRegionFormatting> _function = new Procedure1<IHiddenRegionFormatting>() {
        public void apply(final IHiddenRegionFormatting it) {
          it.increaseIndentation();
        }
    ...
    if (_or_1) {
      ISemanticRegion _kenForKeyword_1 = this.regionAccess.tokenForKeyword(expr, "if");
      format.append(_kenForKeyword_1, XbaseFormatterPreferenceKeys.whitespaceBetweenKeywordAndParenthesisML);
    } else {
      ISemanticRegion _kenForKeyword_2 = this.regionAccess.tokenForKeyword(expr, "if");
      format.append(_kenForKeyword_2, XbaseFormatterPreferenceKeys.whitespaceBetweenKeywordAndParenthesisSL);
    }
    ...
    if ((_then_2 instanceof XBlockExpression)) {
      ...
      if ((!multiline)) {
        ...
        if (_notEquals_2) {
          ...
          final Procedure1<IHiddenRegionFormatting> _function_6 = new Procedure1<IHiddenRegionFormatting>() {
            public void apply(final IHiddenRegionFormatting it) {
              it.newLine();
              it.decreaseIndentation();
            }
          ...
          final Procedure1<IHiddenRegionFormatting> _function_7 = new Procedure1<IHiddenRegionFormatting>() {
            public void apply(final IHiddenRegionFormatting it) {
              it.decreaseIndentation();
            }
          };
    ...
    if ((_else_4 instanceof XBlockExpression)) {
      ...
      if (_or_2) {
        ...
        final Procedure1<IHiddenRegionFormatting> _function_8 = new Procedure1<IHiddenRegionFormatting>() {
          public void apply(final IHiddenRegionFormatting it) {
            it.oneSpace();
          }
        };
        ...
        final Procedure1<IHiddenRegionFormatting> _function_9 = new Procedure1<IHiddenRegionFormatting>() {
          public void apply(final IHiddenRegionFormatting it) {
            it.newLine();
            it.increaseIndentation();
          }
        ...
        final Procedure1<IHiddenRegionFormatting> _function_10 = new Procedure1<IHiddenRegionFormatting>() {
          public void apply(final IHiddenRegionFormatting it) {
            it.decreaseIndentation();
          }
        };
  ...
  protected void _format(final XForLoopExpression expr, @Extension final IFormattableDocument format) {
    ISemanticRegion _kenForKeyword = this.regionAccess.tokenForKeyword(expr, "for");
    final Procedure1<IHiddenRegionFormatting> _function = new Procedure1<IHiddenRegionFormatting>() {
      public void apply(final IHiddenRegionFormatting it) {
        it.oneSpace();
      }
  ...
  protected void _format(final XBasicForLoopExpression expr, @Extension final IFormattableDocument format) {
    ...
    format.append(_kenForKeyword_1, _function_1);
    List<ISemanticRegion> _kensForKeywords = this.regionAccess.tokensForKeywords(expr, ";");
    ...
    IterableExtensions.<ISemanticRegion>forEach(_kensForKeywords, _function_2);
    List<ISemanticRegion> _kensForKeywords_1 = this.regionAccess.tokensForKeywords(expr, ",");
    ...
    IterableExtensions.<ISemanticRegion>forEach(_kensForKeywords_1, _function_3);
    ISemanticRegion _kenForKeyword_2 = this.regionAccess.tokenForKeyword(expr, ")");
    final Procedure1<IHiddenRegionFormatting> _function_4 = new Procedure1<IHiddenRegionFormatting>() {
      public void apply(final IHiddenRegionFormatting it) {
        it.noSpace();
    ...
    format.prepend(_kenForKeyword_2, _function_4);
  ...
  protected void _format(final XWhileExpression expr, @Extension final IFormattableDocument format) {
    ISemanticRegion _kenForKeyword = this.regionAccess.tokenForKeyword(expr, "while");
    format.append(_kenForKeyword, XbaseFormatterPreferenceKeys.whitespaceBetweenKeywordAndParenthesisML);
  ...
  protected void _format(final XTypeLiteral expr, @Extension final IFormattableDocument format) {
    ISemanticRegion _kenForKeyword = this.regionAccess.tokenForKeyword(expr, "typeof");
    final Procedure1<IHiddenRegionFormatting> _function = new Procedure1<IHiddenRegionFormatting>() {
      public void apply(final IHiddenRegionFormatting it) {
        it.noSpace();
      }
    ...
    format.append(_kenForKeyword, _function);
    ISemanticRegion _kenForFeature = this.regionAccess.tokenForFeature(expr, XbasePackage.Literals.XTYPE_LITERAL__TYPE);
    final Procedure1<IHiddenRegionFormatting> _function_1 = new Procedure1<IHiddenRegionFormatting>() {
      public void apply(final IHiddenRegionFormatting it) {
        it.noSpace();
      }
    };
    ISemanticRegion _prepend = format.prepend(_kenForFeature, _function_1);
    final Procedure1<IHiddenRegionFormatting> _function_2 = new Procedure1<IHiddenRegionFormatting>() {
      public void apply(final IHiddenRegionFormatting it) {
        it.noSpace();
      }
    ...
    final ITextReplacer a = this.formatArrayBrackets();
    ParserRule _arrayBracketsRule = this.grammar.getArrayBracketsRule();
    List<ISemanticRegion> _kensForRuleCallsTo = this.regionAccess.tokensForRuleCallsTo(expr, _arrayBracketsRule);
    final Procedure1<ISemanticRegion> _function_3 = new Procedure1<ISemanticRegion>() {
      public void apply(final ISemanticRegion it) {
        final Procedure1<IHiddenRegionFormatting> _function = new Procedure1<IHiddenRegionFormatting>() {
          public void apply(final IHiddenRegionFormatting it) {
        ...
        ISemanticRegion _append = format.append(it, _function);
        format.setReplacer(_append, a);
      }
    };
    IterableExtensions.<ISemanticRegion>forEach(_kensForRuleCallsTo, _function_3);
  }
  ...
  protected void _format(final XCatchClause expr, @Extension final IFormattableDocument format) {
    ISemanticRegion _kenForKeyword = this.regionAccess.tokenForKeyword(expr, "catch");
    format.append(_kenForKeyword, XbaseFormatterPreferenceKeys.whitespaceBetweenKeywordAndParenthesisML);
    JvmFormalParameter _declaredParam = expr.getDeclaredParam();
    final Procedure1<IHiddenRegionFormatting> _function = new Procedure1<IHiddenRegionFormatting>() {
      public void apply(final IHiddenRegionFormatting it) {
  ...
  protected void _format(final XSwitchExpression expr, @Extension final IFormattableDocument format) {
    ...
    final ISemanticRegion open = this.regionAccess.tokenForKeyword(expr, "{");
    final ISemanticRegion close = this.regionAccess.tokenForKeyword(expr, "}");
    ISemanticRegion _kenForKeyword = this.regionAccess.tokenForKeyword(expr, "switch");
    final Procedure1<IHiddenRegionFormatting> _function_2 = new Procedure1<IHiddenRegionFormatting>() {
      public void apply(final IHiddenRegionFormatting it) {
        it.oneSpace();
      }
    };
    format.append(_kenForKeyword, _function_2);
    if (switchSL) {
      final Procedure1<IHiddenRegionFormatting> _function_3 = new Procedure1<IHiddenRegionFormatting>() {
        public void apply(final IHiddenRegionFormatting it) {
          it.oneSpace();
      ...
      if (_notEquals_1) {
        ISemanticRegion _kenForKeyword_1 = this.regionAccess.tokenForKeyword(expr, "default");
        final Procedure1<IHiddenRegionFormatting> _function_8 = new Procedure1<IHiddenRegionFormatting>() {
          public void apply(final IHiddenRegionFormatting it) {
            it.noSpace();
          }
        };
        format.append(_kenForKeyword_1, _function_8);
      ...
      if (caseSL) {
        ...
        final Procedure1<IHiddenRegionFormatting> _function_11 = new Procedure1<IHiddenRegionFormatting>() {
          public void apply(final IHiddenRegionFormatting it) {
            it.increaseIndentation();
          }
        };
        ...
        for (final XCasePart c_1 : _cases_5) {
          {
            ...
            final Procedure1<IHiddenRegionFormatting> _function_12 = new Procedure1<IHiddenRegionFormatting>() {
              public void apply(final IHiddenRegionFormatting it) {
                it.oneSpace();
              }
            };
            ...
            if (_notEquals_2) {
              final Procedure1<IHiddenRegionFormatting> _function_13 = new Procedure1<IHiddenRegionFormatting>() {
                public void apply(final IHiddenRegionFormatting it) {
                  it.newLine();
                }
              };
        ...
        if (_notEquals_2) {
          ISemanticRegion _kenForKeyword_2 = this.regionAccess.tokenForKeyword(expr, "default");
          final Procedure1<IHiddenRegionFormatting> _function_12 = new Procedure1<IHiddenRegionFormatting>() {
            public void apply(final IHiddenRegionFormatting it) {
              it.newLine();
            }
          };
          ISemanticRegion _prepend_1 = format.prepend(_kenForKeyword_2, _function_12);
          final Procedure1<IHiddenRegionFormatting> _function_13 = new Procedure1<IHiddenRegionFormatting>() {
            public void apply(final IHiddenRegionFormatting it) {
              it.noSpace();
            }
          ...
          final Procedure1<IHiddenRegionFormatting> _function_14 = new Procedure1<IHiddenRegionFormatting>() {
            public void apply(final IHiddenRegionFormatting it) {
              it.oneSpace();
            }
          };
        ...
        final Procedure1<IHiddenRegionFormatting> _function_15 = new Procedure1<IHiddenRegionFormatting>() {
          public void apply(final IHiddenRegionFormatting it) {
            it.newLine();
            it.decreaseIndentation();
          }
        ...
        format.prepend(open, XbaseFormatterPreferenceKeys.bracesInNewLine);
        final Procedure1<IHiddenRegionFormatting> _function_16 = new Procedure1<IHiddenRegionFormatting>() {
          public void apply(final IHiddenRegionFormatting it) {
            it.newLine();
          }
        };
        ...
        if (_or_1) {
          final Procedure1<IHiddenRegionFormatting> _function_17 = new Procedure1<IHiddenRegionFormatting>() {
            public void apply(final IHiddenRegionFormatting it) {
              it.increaseIndentation();
            }
          };
        ...
        for (final XCasePart c_2 : _cases_7) {
          ...
          if ((_then_2 instanceof XBlockExpression)) {
            ...
            if (_or_2) {
              ...
              final Procedure1<IHiddenRegionFormatting> _function_18 = new Procedure1<IHiddenRegionFormatting>() {
                public void apply(final IHiddenRegionFormatting it) {
                  it.newLine();
                }
              };
              ...
              final Procedure1<IHiddenRegionFormatting> _function_19 = new Procedure1<IHiddenRegionFormatting>() {
                public void apply(final IHiddenRegionFormatting it) {
                  it.newLine();
                  it.decreaseIndentation();
                }
            ...
            final Procedure1<IHiddenRegionFormatting> _function_20 = new Procedure1<IHiddenRegionFormatting>() {
              public void apply(final IHiddenRegionFormatting it) {
                it.newLine();
                it.increaseIndentation();
              }
            };
            format.<XExpression>prepend(_then_6, _function_20);
            boolean _or_3 = false;
            ...
            if (_or_3) {
              ...
              final Procedure1<IHiddenRegionFormatting> _function_21 = new Procedure1<IHiddenRegionFormatting>() {
                public void apply(final IHiddenRegionFormatting it) {
                  it.newLine();
                  it.decreaseIndentation();
                }
              };
              format.<XExpression>append(_then_7, _function_21);
            } else {
              XExpression _then_8 = c_2.getThen();
              final Procedure1<IHiddenRegionFormatting> _function_22 = new Procedure1<IHiddenRegionFormatting>() {
                public void apply(final IHiddenRegionFormatting it) {
                  it.newLine();
                  it.setDecreaseIndentation(2);
                }
              };
              format.<XExpression>append(_then_8, _function_22);
            }
          }
        }
        ...
        if (_notEquals_8) {
          ISemanticRegion _kenForKeyword_3 = this.regionAccess.tokenForKeyword(expr, "default");
          final Procedure1<IHiddenRegionFormatting> _function_23 = new Procedure1<IHiddenRegionFormatting>() {
            public void apply(final IHiddenRegionFormatting it) {
              it.noSpace();
            }
          };
          format.append(_kenForKeyword_3, _function_23);
          XExpression _default_10 = expr.getDefault();
          if ((_default_10 instanceof XBlockExpression)) {
            XExpression _default_11 = expr.getDefault();
            XExpression _prepend_2 = format.<XExpression>prepend(_default_11, XbaseFormatterPreferenceKeys.bracesInNewLine);
            final Procedure1<IHiddenRegionFormatting> _function_24 = new Procedure1<IHiddenRegionFormatting>() {
              public void apply(final IHiddenRegionFormatting it) {
                it.newLine();
                it.decreaseIndentation();
              }
            };
            format.<XExpression>append(_prepend_2, _function_24);
          } else {
            XExpression _default_12 = expr.getDefault();
            final Procedure1<IHiddenRegionFormatting> _function_25 = new Procedure1<IHiddenRegionFormatting>() {
              public void apply(final IHiddenRegionFormatting it) {
                it.newLine();
                it.increaseIndentation();
              }
            };
            XExpression _prepend_3 = format.<XExpression>prepend(_default_12, _function_25);
            final Procedure1<IHiddenRegionFormatting> _function_26 = new Procedure1<IHiddenRegionFormatting>() {
              public void apply(final IHiddenRegionFormatting it) {
                it.newLine();
                it.setDecreaseIndentation(2);
              }
    ...
    for (final XCasePart c_3 : _cases_10) {
      {
        ...
        if (_and_4) {
          final ISemanticRegion typenode = this.regionAccess.tokenForFeature(c_3, XbasePackage.Literals.XCASE_PART__TYPE_GUARD);
          final ISemanticRegion casenode = this.regionAccess.tokenForFeature(c_3, XbasePackage.Literals.XCASE_PART__CASE);
          final Procedure1<IHiddenRegionFormatting> _function_27 = new Procedure1<IHiddenRegionFormatting>() {
            public void apply(final IHiddenRegionFormatting it) {
              it.oneSpace();
            }
          };
          format.append(typenode, _function_27);
          final Procedure1<IHiddenRegionFormatting> _function_28 = new Procedure1<IHiddenRegionFormatting>() {
            public void apply(final IHiddenRegionFormatting it) {
              it.oneSpace();
            }
          };
          format.prepend(casenode, _function_28);
          final Procedure1<IHiddenRegionFormatting> _function_29 = new Procedure1<IHiddenRegionFormatting>() {
            public void apply(final IHiddenRegionFormatting it) {
              it.noSpace();
            }
          };
          format.append(casenode, _function_29);
        } else {
          JvmTypeReference _typeGuard_1 = c_3.getTypeGuard();
          boolean _notEquals_11 = (!Objects.equal(_typeGuard_1, null));
          if (_notEquals_11) {
            final ISemanticRegion typenode_1 = this.regionAccess.tokenForFeature(c_3, XbasePackage.Literals.XCASE_PART__TYPE_GUARD);
            final Procedure1<IHiddenRegionFormatting> _function_30 = new Procedure1<IHiddenRegionFormatting>() {
              public void apply(final IHiddenRegionFormatting it) {
                it.noSpace();
              }
            };
            format.append(typenode_1, _function_30);
          } else {
            XExpression _case_1 = c_3.getCase();
            boolean _notEquals_12 = (!Objects.equal(_case_1, null));
            if (_notEquals_12) {
              XExpression _case_2 = c_3.getCase();
              final Procedure1<IHiddenRegionFormatting> _function_31 = new Procedure1<IHiddenRegionFormatting>() {
                public void apply(final IHiddenRegionFormatting it) {
                  it.oneSpace();
                }
              };
              XExpression _prepend_4 = format.<XExpression>prepend(_case_2, _function_31);
              final Procedure1<IHiddenRegionFormatting> _function_32 = new Procedure1<IHiddenRegionFormatting>() {
                public void apply(final IHiddenRegionFormatting it) {
                  it.noSpace();
                }
              };
              format.<XExpression>append(_prepend_4, _function_32);
            }
          }
        }
  ...
  protected ISemanticRegion formatClosureParams(final XClosure expr, final ISemanticRegion open, @Extension final IFormattableDocument format, final Procedure1<? super IHiddenRegionFormatting> init) {
    ...
    if (_isExplicitSyntax) {
      ...
      for (final JvmFormalParameter param : _declaredFormalParameters) {
        {
          ...
          ISemanticRegion _prepend = format.prepend(_immediatelyFollowingKeyword, _function);
          final Procedure1<IHiddenRegionFormatting> _function_1 = new Procedure1<IHiddenRegionFormatting>() {
            public void apply(final IHiddenRegionFormatting it) {
              it.oneSpace();
            }
      ...
      format.append(open, ((Procedure1<IHiddenRegionFormatting>)init));
      final ISemanticRegion last = this.regionAccess.tokenForFeature(expr, XbasePackage.Literals.XCLOSURE__EXPLICIT_SYNTAX);
      EList<JvmFormalParameter> _declaredFormalParameters_1 = expr.getDeclaredFormalParameters();
      boolean _isEmpty = _declaredFormalParameters_1.isEmpty();
      boolean _not = (!_isEmpty);
      if (_not) {
        format.prepend(last, ((Procedure1<IHiddenRegionFormatting>)init));
      }
      return last;
    }
    return open;
  ...
  protected void _format(final XClosure expr, @Extension final IFormattableDocument format) {
    ISemanticRegion _elvis = null;
    ISemanticRegion _kenForKeyword = this.regionAccess.tokenForKeyword(expr, "[");
    if (_kenForKeyword != null) {
      _elvis = _kenForKeyword;
    } else {
    ...
    if (_isEmpty) {
      IHiddenRegion _trailingGap = open.getTrailingGap();
      boolean _containsComment = _trailingGap.containsComment();
      if (_containsComment) {
        final Procedure1<IHiddenRegionFormatting> _function = new Procedure1<IHiddenRegionFormatting>() {
          public void apply(final IHiddenRegionFormatting it) {
            it.newLine();
      ...
      if (_isMultiline) {
        ...
        IHiddenRegion _leadingGap_1 = open.getLeadingGap();
        ISemanticRegion _nextToken = _leadingGap_1.getNextToken();
        final int offset = _nextToken.getEndOffset();
        IHiddenRegion _trailingGap_1 = close.getTrailingGap();
        int _offset = _trailingGap_1.getOffset();
        final int length = (_offset - offset);
        final ISubFormatter _function_3 = new ISubFormatter() {
          public void format(final IFormattableSubDocument doc) throws FormattingNotApplicableException {
            @Extension
  ...
  protected boolean isMultilineOrInNewLine(final EObject obj) {
    ...
    if (!_notEquals) {
      ...
      if (_isMultiline) {
        ...
        IHiddenRegion _leadingGap = this.regionAccess.leadingGap(obj);
        boolean _isMultiline_1 = _leadingGap.isMultiline();
        _or = _isMultiline_1;
      }
      _and = _or;
  ...
  protected void format(final EObject ref, final IFormattableDocument document) {
