...
public class ImportsCollector {
  ...
  protected void _visit(final JvmGenericType jvmType, final Iterable<INode> node, final ImportsAcceptor acceptor) {
    ...
    if (_isAnonymous) {
      ...
      this._visit(((JvmDeclaredType) jvmType), node, acceptor);
    }
  }
  ...
  public void visit(final EObject jvmType, final Iterable<INode> node, final ImportsAcceptor acceptor) {
    if (jvmType instanceof JvmGenericType) {
      _visit((JvmGenericType)jvmType, node, acceptor);
      return;
