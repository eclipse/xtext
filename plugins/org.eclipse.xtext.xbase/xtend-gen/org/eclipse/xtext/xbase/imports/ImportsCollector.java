...
public class ImportsCollector {
    ...
    while (contents.hasNext()) {
      {
        ...
        this.visitIfInRange(next, offset, endOffset, acceptor);
      }
    }
  }
  ...
  public void visitIfInRange(final EObject object, final int offset, final int endOffset, final ImportsAcceptor acceptor) {
    ...
    if (_and) {
      ...
      List<INode> _list = IterableExtensions.<INode>toList(_children);
      this.visit(object, _list, acceptor);
    }
  }
  
  protected void _visit(final JvmTypeReference semanticElement, final List<INode> node, final ImportsAcceptor acceptor) {
    JvmType _type = semanticElement.getType();
    this.visit(_type, node, acceptor);
  }
  
  protected void _visit(final Void nullCase, final List<INode> node, final ImportsAcceptor acceptor) {
  }
  
  protected void _visit(final XAbstractFeatureCall semanticObj, final List<INode> node, final ImportsAcceptor acceptor) {
    this.collectStaticImportsFrom(semanticObj, acceptor);
  }
  
  protected void _visit(final XMemberFeatureCall semanticObj, final List<INode> node, final ImportsAcceptor acceptor) {
    boolean _and = false;
  ...
  protected void _visit(final XFeatureCall semanticObj, final List<INode> node, final ImportsAcceptor acceptor) {
    boolean _and = false;
    JvmIdentifiableElement _feature = semanticObj.getFeature();
    if (!(_feature instanceof JvmType)) {
      _and = false;
  ...
  protected void _visit(final JvmDeclaredType jvmType, final List<INode> node, final ImportsAcceptor acceptor) {
    boolean _or = false;
  ...
  protected void _visit(final XConstructorCall semanticElement, final List<INode> node, final ImportsAcceptor acceptor) {
  ...
  protected void _visit(final XAnnotation semanticElement, final List<INode> node, final ImportsAcceptor acceptor) {
    JvmType _annotationType = semanticElement.getAnnotationType();
    this.visit(_annotationType, node, acceptor);
  }
  
  protected void _visit(final XTypeLiteral semanticElement, final List<INode> node, final ImportsAcceptor acceptor) {
  ...
  protected void _visit(final EObject semanticObj, final List<INode> node, final ImportsAcceptor acceptor) {
  ...
  protected JvmIdentifiableElement getReferencedElement(final EObject owner, final EReference reference) {
    Object _eGet = owner.eGet(reference);
    JvmIdentifiableElement referencedThing = ((JvmIdentifiableElement) _eGet);
  ...
  public void visit(final EObject jvmType, final List<INode> node, final ImportsAcceptor acceptor) {
