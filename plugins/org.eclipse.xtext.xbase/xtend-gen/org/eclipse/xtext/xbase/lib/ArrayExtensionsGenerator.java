...
public class ArrayExtensionsGenerator {
  ...
  public CharSequence generateEquals(final String string) {
    ...
    _builder.newLine();
    _builder.append(" ");
    _builder.append("* Returns whether the array and the given other object are equal.");
    _builder.newLine();
    _builder.append(" ");
    _builder.append("* ");
    _builder.newLine();
    _builder.append(" ");
    _builder.append("* Delegates to {@link Arrays#equals(");
    _builder.append(string, " ");
    _builder.append("[], ");
    _builder.append(string, " ");
    _builder.append("[])}");
    ...
    _builder.newLineIfNotEmpty();
    _builder.append("\t\t");
    _builder.append("return Arrays.equals(array, (");
    _builder.append(string, "\t\t");
