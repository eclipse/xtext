...
public class XbaseFormatter3 implements Formatter.Impl {
  public static class Service extends Formatter {
    @Accessors(AccessorType.PUBLIC_GETTER)
    @Inject
    private XbaseGrammarAccess grammar;
    
    protected Formatter.Impl createFormatterImpl(final IFormatter.Request request) {
      return new XbaseFormatter3(this, request);
    }
  ...
  @Extension
  protected final XbaseGrammarAccess _xbaseGrammarAccess;
  
  @Extension
  protected final ITokenAccess _iTokenAccess;
  
  public void format(final IFormattableDocument document) {
    IFormatter.Request _request = document.getRequest();
    ITokenAccess _tokens = _request.getTokens();
  ...
  public XbaseFormatter3(final XbaseFormatter3.Service service, final IFormatter.Request request) {
    this._xbaseGrammarAccess = service.grammar;
    ITokenAccess _tokens = request.getTokens();
    this._iTokenAccess = _tokens;
  }
  
  protected void _format(final XCollectionLiteral literal, @Extension final IFormattableDocument document) {
    ITokenAccess.IToken _kenForKeyword = this._iTokenAccess.tokenForKeyword(literal, "#");
    final Procedure1<IGapFormatting> _function = new Procedure1<IGapFormatting>() {
      public void apply(final IGapFormatting it) {
        it.noSpace();
      }
    };
    document.append(_kenForKeyword, _function);
    ITokenAccess.IToken _elvis = null;
    ITokenAccess.IToken _kenForKeyword_1 = this._iTokenAccess.tokenForKeyword(literal, "[");
    if (_kenForKeyword_1 != null) {
      _elvis = _kenForKeyword_1;
    } else {
      ITokenAccess.IToken _kenForKeyword_2 = this._iTokenAccess.tokenForKeyword(literal, "{");
      _elvis = _kenForKeyword_2;
    }
    final ITokenAccess.IToken open = _elvis;
    ITokenAccess.IToken _elvis_1 = null;
    ITokenAccess.IToken _kenForKeyword_3 = this._iTokenAccess.tokenForKeyword(literal, "]");
    if (_kenForKeyword_3 != null) {
      _elvis_1 = _kenForKeyword_3;
    } else {
      ITokenAccess.IToken _kenForKeyword_4 = this._iTokenAccess.tokenForKeyword(literal, "}");
      _elvis_1 = _kenForKeyword_4;
    }
    final ITokenAccess.IToken close = _elvis_1;
    EList<XExpression> _elements = literal.getElements();
    this.formatCommaSeparatedList(_elements, open, close, document);
  }
  
  protected Object formatCommaSeparatedList(final Collection<? extends EObject> elements, final ITokenAccess.IToken open, final ITokenAccess.IToken close, @Extension final IFormattableDocument format) {
    ...
    if (_isEmpty) {
      ...
      ITokenAccess.IGap _leadingGap = close.getLeadingGap();
      boolean _isMultiline = _leadingGap.isMultiline();
      if (_isMultiline) {
        EObject _xblockexpression = null;
        {
          final Procedure1<IGapFormatting> _function_1 = new Procedure1<IGapFormatting>() {
            public void apply(final IGapFormatting it) {
              it.newLine();
          ...
          for (final EObject elem : elements) {
            {
              ...
              ITokenAccess.IToken _immediatelyFollowingKeyword = this._iTokenAccess.immediatelyFollowingKeyword(elem, ",");
              final Procedure1<IGapFormatting> _function_2 = new Procedure1<IGapFormatting>() {
                public void apply(final IGapFormatting it) {
                  it.noSpace();
                }
              };
              ITokenAccess.IToken _prepend = format.prepend(_immediatelyFollowingKeyword, _function_2);
              final Procedure1<IGapFormatting> _function_3 = new Procedure1<IGapFormatting>() {
                public void apply(final IGapFormatting it) {
                  it.newLine();
                }
              };
        ...
        EObject _xblockexpression_1 = null;
        {
          ...
          ITokenAccess.IGap _leadingGap_1 = this._iTokenAccess.leadingGap(head);
          final int offset = _leadingGap_1.getOffset();
          ITokenAccess.IGap _trailingGap = this._iTokenAccess.trailingGap(head);
          int _offset = _trailingGap.getOffset();
          final int lenght = (_offset - offset);
          final IFormattableDocument.ISubFormatter _function_1 = new IFormattableDocument.ISubFormatter() {
            public void format(final IFormattableDocument.IFormattableSubDocument doc) throws IFormattableDocument.FormattingNotApplicableException {
              @Extension
              final IFormattableDocument.IFormattableSubDocument it = doc.requireFitsInLine();
              final Procedure1<IGapFormatting> _function = new Procedure1<IGapFormatting>() {
                public void apply(final IGapFormatting it) {
                  it.noSpace();
                  it.autowrap();
              ...
              XbaseFormatter3.this.format(_prepend, it);
            }
          };
          final IFormattableDocument.ISubFormatter _function_2 = new IFormattableDocument.ISubFormatter() {
            public void format(@Extension final IFormattableDocument.IFormattableSubDocument it) throws IFormattableDocument.FormattingNotApplicableException {
              boolean _prependNewLineIfMultiline = XbaseFormatter3.this.prependNewLineIfMultiline(head);
              ...
              XbaseFormatter3.this.format(head, it);
            }
          };
          ...
          for (final EObject arg : _tail) {
            {
              ITokenAccess.IToken _immediatelyPrecedingKeyword = this._iTokenAccess.immediatelyPrecedingKeyword(arg, ",");
              ITokenAccess.IGap _leadingGap_2 = _immediatelyPrecedingKeyword.getLeadingGap();
              final int argoffset = _leadingGap_2.getOffset();
              ITokenAccess.IGap _trailingGap_1 = this._iTokenAccess.trailingGap(arg);
              int _offset_1 = _trailingGap_1.getOffset();
              final int arglenght = (_offset_1 - argoffset);
              final IFormattableDocument.ISubFormatter _function_3 = new IFormattableDocument.ISubFormatter() {
                public void format(final IFormattableDocument.IFormattableSubDocument doc) throws IFormattableDocument.FormattingNotApplicableException {
                  @Extension
                  final IFormattableDocument.IFormattableSubDocument it = doc.requireFitsInLine();
                  ITokenAccess.IToken _immediatelyPrecedingKeyword = XbaseFormatter3.this._iTokenAccess.immediatelyPrecedingKeyword(arg, ",");
                  final Procedure1<IGapFormatting> _function = new Procedure1<IGapFormatting>() {
                    public void apply(final IGapFormatting it) {
                      it.noSpace();
                    }
                  };
                  ITokenAccess.IToken _prepend = it.prepend(_immediatelyPrecedingKeyword, _function);
                  final Procedure1<IGapFormatting> _function_1 = new Procedure1<IGapFormatting>() {
                    public void apply(final IGapFormatting it) {
                      it.oneSpace();
                      it.autowrap();
                  ...
                  XbaseFormatter3.this.format(arg, it);
                }
              };
              final IFormattableDocument.ISubFormatter _function_4 = new IFormattableDocument.ISubFormatter() {
                public void format(@Extension final IFormattableDocument.IFormattableSubDocument it) throws IFormattableDocument.FormattingNotApplicableException {
                  ITokenAccess.IToken _immediatelyPrecedingKeyword = XbaseFormatter3.this._iTokenAccess.immediatelyPrecedingKeyword(arg, ",");
                  final Procedure1<IGapFormatting> _function = new Procedure1<IGapFormatting>() {
                    public void apply(final IGapFormatting it) {
                  ...
                  final ITokenAccess.IToken comma = it.prepend(_immediatelyPrecedingKeyword, _function);
                  boolean _prependNewLineIfMultiline = XbaseFormatter3.this.prependNewLineIfMultiline(arg);
                  if (_prependNewLineIfMultiline) {
                    final Procedure1<IGapFormatting> _function_1 = new Procedure1<IGapFormatting>() {
                      public void apply(final IGapFormatting it) {
                        it.newLine();
  ...
  protected void _format(final XAnnotation ann, @Extension final IFormattableDocument document) {
    ITokenAccess.IToken _kenForKeyword = this._iTokenAccess.tokenForKeyword(ann, "@");
    final Procedure1<IGapFormatting> _function = new Procedure1<IGapFormatting>() {
      public void apply(final IGapFormatting it) {
        it.noSpace();
      }
    ...
    document.append(_kenForKeyword, _function);
    ITokenAccess.IToken _kenForKeyword_1 = this._iTokenAccess.tokenForKeyword(ann, "(");
    final Procedure1<IGapFormatting> _function_1 = new Procedure1<IGapFormatting>() {
      public void apply(final IGapFormatting it) {
        it.noSpace();
      }
    ...
    if (_notEquals) {
      ...
      ITokenAccess.IToken _kenForKeyword_2 = this._iTokenAccess.tokenForKeyword(ann, ")");
      final Procedure1<IGapFormatting> _function_2 = new Procedure1<IGapFormatting>() {
        public void apply(final IGapFormatting it) {
          it.noSpace();
        }
      ...
      if (_not) {
        ...
        for (final XAnnotationElementValuePair pair : _elementValuePairs_1) {
          {
            ITokenAccess.IToken _kenForKeyword_3 = this._iTokenAccess.tokenForKeyword(pair, "=");
            final Procedure1<IGapFormatting> _function_3 = new Procedure1<IGapFormatting>() {
              public void apply(final IGapFormatting it) {
                it.noSpace();
              }
            ...
            ITokenAccess.IToken _immediatelyFollowingKeyword = this._iTokenAccess.immediatelyFollowingKeyword(pair, ",");
            final Procedure1<IGapFormatting> _function_4 = new Procedure1<IGapFormatting>() {
              public void apply(final IGapFormatting it) {
                it.noSpace();
              }
            };
            ITokenAccess.IToken _prepend = document.prepend(_immediatelyFollowingKeyword, _function_4);
            final Procedure1<IGapFormatting> _function_5 = new Procedure1<IGapFormatting>() {
              public void apply(final IGapFormatting it) {
                it.oneSpace();
              }
            };
        ...
        ITokenAccess.IToken _kenForKeyword_3 = this._iTokenAccess.tokenForKeyword(ann, ")");
        final Procedure1<IGapFormatting> _function_3 = new Procedure1<IGapFormatting>() {
          public void apply(final IGapFormatting it) {
            it.noSpace();
          }
  ...
  protected Function1<ITextReplacer.Context, ITextReplacer.Flow> formatArrayBrackets() {
    final Function1<ITextReplacer.Context, ITextReplacer.Flow> _function = new Function1<ITextReplacer.Context, ITextReplacer.Flow>() {
      public ITextReplacer.Flow apply(final ITextReplacer.Context it) {
  ...
  protected void _format(final JvmGenericArrayTypeReference array, @Extension final IFormattableDocument document) {
    final Function1<ITextReplacer.Context, ITextReplacer.Flow> a = this.formatArrayBrackets();
    ParserRule _arrayBracketsRule = this._xbaseGrammarAccess.getArrayBracketsRule();
    ITokenAccess.IToken _kenForRuleCallTo = this._iTokenAccess.tokenForRuleCallTo(array, _arrayBracketsRule);
    document.setReplacer(_kenForRuleCallTo, new ITextReplacer() {
        public ITextReplacer.Flow createReplacements(ITextReplacer.Context context) {
  ...
  protected void _format(final XFunctionTypeRef func, @Extension final IFormattableDocument document) {
    ITokenAccess.IToken _kenForKeyword = this._iTokenAccess.tokenForKeyword(func, "(");
    final Procedure1<IGapFormatting> _function = new Procedure1<IGapFormatting>() {
      public void apply(final IGapFormatting it) {
        it.noSpace();
      }
    ...
    for (final JvmTypeReference param : _paramTypes) {
      {
        ...
        ITokenAccess.IToken _immediatelyFollowingKeyword = this._iTokenAccess.immediatelyFollowingKeyword(param, ",");
        final Procedure1<IGapFormatting> _function_1 = new Procedure1<IGapFormatting>() {
          public void apply(final IGapFormatting it) {
            it.noSpace();
          }
        };
        ITokenAccess.IToken _prepend = document.prepend(_immediatelyFollowingKeyword, _function_1);
        final Procedure1<IGapFormatting> _function_2 = new Procedure1<IGapFormatting>() {
          public void apply(final IGapFormatting it) {
            it.oneSpace();
          }
    ...
    ITokenAccess.IToken _kenForKeyword_1 = this._iTokenAccess.tokenForKeyword(func, ")");
    final Procedure1<IGapFormatting> _function_1 = new Procedure1<IGapFormatting>() {
      public void apply(final IGapFormatting it) {
        EList<JvmTypeReference> _paramTypes = func.getParamTypes();
    ...
    ITokenAccess.IToken _prepend = document.prepend(_kenForKeyword_1, _function_1);
    final Procedure1<IGapFormatting> _function_2 = new Procedure1<IGapFormatting>() {
      public void apply(final IGapFormatting it) {
        it.noSpace();
      }
    ...
    document.append(_prepend, _function_2);
    ITokenAccess.IToken _kenForKeyword_2 = this._iTokenAccess.tokenForKeyword(func, "=>");
    final Procedure1<IGapFormatting> _function_3 = new Procedure1<IGapFormatting>() {
      public void apply(final IGapFormatting it) {
        it.noSpace();
      }
  ...
  protected void _format(final JvmParameterizedTypeReference ref, @Extension final IFormattableDocument document) {
    ITokenAccess.IToken _kenForKeyword = this._iTokenAccess.tokenForKeyword(ref, "<");
    final Procedure1<IGapFormatting> _function = new Procedure1<IGapFormatting>() {
      public void apply(final IGapFormatting it) {
        it.noSpace();
      }
    ...
    for (final JvmTypeReference arg : _arguments) {
      {
        ...
        ITokenAccess.IToken _immediatelyFollowingKeyword = this._iTokenAccess.immediatelyFollowingKeyword(arg, ",");
        final Procedure1<IGapFormatting> _function_1 = new Procedure1<IGapFormatting>() {
          public void apply(final IGapFormatting it) {
            it.noSpace();
          }
    ...
    boolean _not = (!_isEmpty);
    if (_not) {
      ITokenAccess.IToken _kenForKeyword_1 = this._iTokenAccess.tokenForKeyword(ref, ">");
      final Procedure1<IGapFormatting> _function_1 = new Procedure1<IGapFormatting>() {
        public void apply(final IGapFormatting it) {
          it.noSpace();
        }
  ...
  protected void _format(final XVariableDeclaration expr, @Extension final IFormattableDocument format) {
    ITokenAccess.IToken _kenForKeyword = this._iTokenAccess.tokenForKeyword(expr, "val");
    final Procedure1<IGapFormatting> _function = new Procedure1<IGapFormatting>() {
      public void apply(final IGapFormatting it) {
        it.oneSpace();
      }
    ...
    ITokenAccess.IToken _kenForKeyword_1 = this._iTokenAccess.tokenForKeyword(expr, "var");
    final Procedure1<IGapFormatting> _function_1 = new Procedure1<IGapFormatting>() {
      public void apply(final IGapFormatting it) {
        it.oneSpace();
      }
    ...
    ITokenAccess.IToken _kenForKeyword_2 = this._iTokenAccess.tokenForKeyword(expr, "=");
    final Procedure1<IGapFormatting> _function_3 = new Procedure1<IGapFormatting>() {
      public void apply(final IGapFormatting it) {
        it.oneSpace();
      }
  ...
  protected void _format(final XAssignment expr, @Extension final IFormattableDocument format) {
    ParserRule _opSingleAssignRule = this._xbaseGrammarAccess.getOpSingleAssignRule();
    ITokenAccess.IToken _kenForRuleCallTo = this._iTokenAccess.tokenForRuleCallTo(expr, _opSingleAssignRule);
    final Procedure1<IGapFormatting> _function = new Procedure1<IGapFormatting>() {
      public void apply(final IGapFormatting it) {
        it.oneSpace();
      }
    ...
    ITokenAccess.IToken _kenForKeyword = this._iTokenAccess.tokenForKeyword(expr, _xifexpression);
    final Procedure1<IGapFormatting> _function_1 = new Procedure1<IGapFormatting>() {
      public void apply(final IGapFormatting it) {
        it.noSpace();
      }
  ...
  protected void formatFeatureCallParams(final List<XExpression> params, final ITokenAccess.IToken open, final ITokenAccess.IToken close, @Extension final IFormattableDocument format) {
  ...
  protected void formatBuilderWithLeadingGap(final XClosure closure, @Extension final IFormattableDocument format) {
    ...
    if (_notEquals) {
      ITokenAccess.IGap _leadingGap = this._iTokenAccess.leadingGap(closure);
      final int offset = _leadingGap.getOffset();
      ITokenAccess.IGap _trailingGap = this._iTokenAccess.trailingGap(closure);
      int _offset = _trailingGap.getOffset();
      final int length = (_offset - offset);
      final IFormattableDocument.ISubFormatter _function = new IFormattableDocument.ISubFormatter() {
        public void format(final IFormattableDocument.IFormattableSubDocument doc) throws IFormattableDocument.FormattingNotApplicableException {
          @Extension
          final IFormattableDocument.IFormattableSubDocument it = doc.requireFitsInLine();
          final Procedure1<IGapFormatting> _function = new Procedure1<IGapFormatting>() {
          ...
          XbaseFormatter3.this.format(closure, it);
        }
      };
      final IFormattableDocument.ISubFormatter _function_1 = new IFormattableDocument.ISubFormatter() {
        public void format(@Extension final IFormattableDocument.IFormattableSubDocument it) throws IFormattableDocument.FormattingNotApplicableException {
  ...
  protected XClosure builder(final List<XExpression> params) {
    ...
    if (_notEquals) {
      XClosure _xblockexpression = null;
      {
        ...
        final AbstractElement grammarElement = this._iTokenAccess.getInvokingGrammarElement(_last_1);
  ...
  protected void _format(final XConstructorCall expr, @Extension final IFormattableDocument format) {
    ITokenAccess.IToken _kenForFeature = this._iTokenAccess.tokenForFeature(expr, XbasePackage.Literals.XCONSTRUCTOR_CALL__CONSTRUCTOR);
    final Procedure1<IGapFormatting> _function = new Procedure1<IGapFormatting>() {
      public void apply(final IGapFormatting it) {
        it.oneSpace();
      }
    ...
    boolean _not = (!_isEmpty);
    if (_not) {
      ITokenAccess.IToken _kenForKeyword = this._iTokenAccess.tokenForKeyword(expr, "<");
      final Procedure1<IGapFormatting> _function_1 = new Procedure1<IGapFormatting>() {
        public void apply(final IGapFormatting it) {
          it.noSpace();
        }
      ...
      ITokenAccess.IToken _kenForKeyword_1 = this._iTokenAccess.tokenForKeyword(expr, ">");
      final Procedure1<IGapFormatting> _function_2 = new Procedure1<IGapFormatting>() {
        public void apply(final IGapFormatting it) {
          it.noSpace();
        }
    ...
    final ITokenAccess.IToken open = this._iTokenAccess.tokenForKeyword(expr, "(");
    final ITokenAccess.IToken close = this._iTokenAccess.tokenForKeyword(expr, ")");
    final Procedure1<IGapFormatting> _function_3 = new Procedure1<IGapFormatting>() {
      public void apply(final IGapFormatting it) {
        it.noSpace();
      }
      ...
      for (final JvmTypeReference arg : _typeArguments_1) {
        {
          ...
          ITokenAccess.IToken _prepend = format.prepend(_immediatelyFollowingKeyword, _function_1);
          final Procedure1<IGapFormatting> _function_2 = new Procedure1<IGapFormatting>() {
            public void apply(final IGapFormatting it) {
              it.oneSpace();
            }
  ...
  protected void _format(final XFeatureCall expr, @Extension final IFormattableDocument format) {
    ...
    if (_isExplicitOperationCall) {
      ...
      final ITokenAccess.IToken open = format.prepend(_kenForKeyword, _function);
      final ITokenAccess.IToken close = this._iTokenAccess.tokenForKeyword(expr, ")");
    ...
    for (final XMemberFeatureCall call : _reverse) {
      {
        ...
        ITokenAccess.IToken _kenForKeyword = this._iTokenAccess.tokenForKeyword(call, op);
        final Procedure1<IGapFormatting> _function = new Procedure1<IGapFormatting>() {
          public void apply(final IGapFormatting it) {
            it.noSpace();
          }
        };
        ITokenAccess.IToken _prepend = format.prepend(_kenForKeyword, _function);
        final Procedure1<IGapFormatting> _function_1 = new Procedure1<IGapFormatting>() {
          public void apply(final IGapFormatting it) {
            it.noSpace();
            it.autowrap();
        ...
        if (_isExplicitOperationCall) {
          ITokenAccess.IToken _kenForKeyword_1 = this._iTokenAccess.tokenForKeyword(call, "(");
          final Procedure1<IGapFormatting> _function_2 = new Procedure1<IGapFormatting>() {
            public void apply(final IGapFormatting it) {
              it.noSpace();
            }
          };
          final ITokenAccess.IToken open = format.prepend(_kenForKeyword_1, _function_2);
          final ITokenAccess.IToken close = this._iTokenAccess.tokenForKeyword(call, ")");
  ...
  protected AbstractRule binaryOperationPrecedence(final EObject op) {
    final ITokenAccess.IToken node = this._iTokenAccess.tokenForFeature(op, XbasePackage.Literals.XABSTRACT_FEATURE_CALL__FEATURE);
    boolean _and = false;
  ...
  protected void _format(final XBinaryOperation expr, @Extension final IFormattableDocument format) {
    ...
    for (final XBinaryOperation call : _reverse) {
      {
        final ITokenAccess.IToken op = this._iTokenAccess.tokenForFeature(call, XbasePackage.Literals.XABSTRACT_FEATURE_CALL__FEATURE);
        ITokenAccess.IGap _leadingGap = op.getLeadingGap();
        final int offset = _leadingGap.getOffset();
        XExpression _rightOperand = call.getRightOperand();
        ITokenAccess.IGap _trailingGap = this._iTokenAccess.trailingGap(_rightOperand);
        int _offset = _trailingGap.getOffset();
        final int length = (_offset - offset);
        final IFormattableDocument.ISubFormatter _function = new IFormattableDocument.ISubFormatter() {
          public void format(final IFormattableDocument.IFormattableSubDocument doc) throws IFormattableDocument.FormattingNotApplicableException {
            ...
            ITokenAccess.IToken _prepend = it.prepend(op, _function);
            final Procedure1<IGapFormatting> _function_1 = new Procedure1<IGapFormatting>() {
              public void apply(final IGapFormatting it) {
                it.oneSpace();
                it.autowrap();
            ...
            it.append(_prepend, _function_1);
            XExpression _rightOperand = call.getRightOperand();
            XbaseFormatter3.this.format(_rightOperand, it);
          }
        };
        final IFormattableDocument.ISubFormatter _function_1 = new IFormattableDocument.ISubFormatter() {
          public void format(@Extension final IFormattableDocument.IFormattableSubDocument it) throws IFormattableDocument.FormattingNotApplicableException {
            ...
            XExpression _rightOperand = call.getRightOperand();
            boolean _prependNewLineIfMultiline = XbaseFormatter3.this.prependNewLineIfMultiline(_rightOperand);
            if (_prependNewLineIfMultiline) {
              final Procedure1<IGapFormatting> _function_1 = new Procedure1<IGapFormatting>() {
                public void apply(final IGapFormatting it) {
                  it.newLine();
            ...
            XbaseFormatter3.this.format(_rightOperand_1, it);
          }
        };
        format.formatConditionally(offset, length, _function, _function_1);
      }
  ...
  protected void _format(final XSynchronizedExpression expr, @Extension final IFormattableDocument format) {
    ...
    if ((_eContainer instanceof XVariableDeclaration)) {
      ITokenAccess.IToken _kenForKeyword = this._iTokenAccess.tokenForKeyword(expr, "synchronized");
      final Procedure1<IGapFormatting> _function = new Procedure1<IGapFormatting>() {
        public void apply(final IGapFormatting it) {
          it.increaseIndentation();
        }
    ...
    boolean _isMultiline = this._iTokenAccess.isMultiline(_expression);
    if (_isMultiline) {
      _or = true;
    } else {
      XExpression _expression_1 = expr.getExpression();
      ITokenAccess.IGap _leadingGap = this._iTokenAccess.leadingGap(_expression_1);
    ...
    if (_or_1) {
      ITokenAccess.IToken _kenForKeyword_1 = this._iTokenAccess.tokenForKeyword(expr, "synchronized");
      format.append(_kenForKeyword_1, XbaseFormatterPreferenceKeys.whitespaceBetweenKeywordAndParenthesisML);
    } else {
      ITokenAccess.IToken _kenForKeyword_2 = this._iTokenAccess.tokenForKeyword(expr, "synchronized");
  ...
  protected void _format(final XIfExpression expr, @Extension final IFormattableDocument format) {
    EObject _eContainer = expr.eContainer();
    if ((_eContainer instanceof XVariableDeclaration)) {
      ITokenAccess.IToken _kenForKeyword = this._iTokenAccess.tokenForKeyword(expr, "if");
      final Procedure1<IGapFormatting> _function = new Procedure1<IGapFormatting>() {
        public void apply(final IGapFormatting it) {
          it.increaseIndentation();
        }
    ...
    if (_or_1) {
      ITokenAccess.IToken _kenForKeyword_1 = this._iTokenAccess.tokenForKeyword(expr, "if");
      format.append(_kenForKeyword_1, XbaseFormatterPreferenceKeys.whitespaceBetweenKeywordAndParenthesisML);
    } else {
      ITokenAccess.IToken _kenForKeyword_2 = this._iTokenAccess.tokenForKeyword(expr, "if");
      format.append(_kenForKeyword_2, XbaseFormatterPreferenceKeys.whitespaceBetweenKeywordAndParenthesisSL);
    }
    ...
    if ((_then_2 instanceof XBlockExpression)) {
      ...
      if ((!multiline)) {
        ...
        if (_notEquals_2) {
          ...
          final Procedure1<IGapFormatting> _function_6 = new Procedure1<IGapFormatting>() {
            public void apply(final IGapFormatting it) {
              it.newLine();
              it.decreaseIndentation();
            }
          ...
          final Procedure1<IGapFormatting> _function_7 = new Procedure1<IGapFormatting>() {
            public void apply(final IGapFormatting it) {
              it.decreaseIndentation();
            }
          };
    ...
    if ((_else_4 instanceof XBlockExpression)) {
      ...
      if (_or_2) {
        ...
        final Procedure1<IGapFormatting> _function_8 = new Procedure1<IGapFormatting>() {
          public void apply(final IGapFormatting it) {
            it.oneSpace();
          }
        };
        ...
        final Procedure1<IGapFormatting> _function_9 = new Procedure1<IGapFormatting>() {
          public void apply(final IGapFormatting it) {
            it.newLine();
            it.increaseIndentation();
          }
        ...
        final Procedure1<IGapFormatting> _function_10 = new Procedure1<IGapFormatting>() {
          public void apply(final IGapFormatting it) {
            it.decreaseIndentation();
          }
        };
  ...
  protected void _format(final XForLoopExpression expr, @Extension final IFormattableDocument format) {
    ITokenAccess.IToken _kenForKeyword = this._iTokenAccess.tokenForKeyword(expr, "for");
    final Procedure1<IGapFormatting> _function = new Procedure1<IGapFormatting>() {
      public void apply(final IGapFormatting it) {
        it.oneSpace();
      }
  ...
  protected void _format(final XBasicForLoopExpression expr, @Extension final IFormattableDocument format) {
    ...
    format.append(_kenForKeyword_1, _function_1);
    List<ITokenAccess.IToken> _kensForKeywords = this._iTokenAccess.tokensForKeywords(expr, ";");
    final Procedure1<ITokenAccess.IToken> _function_2 = new Procedure1<ITokenAccess.IToken>() {
      public void apply(final ITokenAccess.IToken it) {
        final Procedure1<IGapFormatting> _function = new Procedure1<IGapFormatting>() {
          public void apply(final IGapFormatting it) {
            it.noSpace();
          }
        };
        ITokenAccess.IToken _prepend = format.prepend(it, _function);
        final Procedure1<IGapFormatting> _function_1 = new Procedure1<IGapFormatting>() {
          public void apply(final IGapFormatting it) {
            it.noSpace();
            it.lowPriority();
    ...
    IterableExtensions.<ITokenAccess.IToken>forEach(_kensForKeywords, _function_2);
    List<ITokenAccess.IToken> _kensForKeywords_1 = this._iTokenAccess.tokensForKeywords(expr, ",");
    final Procedure1<ITokenAccess.IToken> _function_3 = new Procedure1<ITokenAccess.IToken>() {
      public void apply(final ITokenAccess.IToken it) {
        final Procedure1<IGapFormatting> _function = new Procedure1<IGapFormatting>() {
          public void apply(final IGapFormatting it) {
            it.noSpace();
    ...
    IterableExtensions.<ITokenAccess.IToken>forEach(_kensForKeywords_1, _function_3);
    ITokenAccess.IToken _kenForKeyword_2 = this._iTokenAccess.tokenForKeyword(expr, ")");
    final Procedure1<IGapFormatting> _function_4 = new Procedure1<IGapFormatting>() {
      public void apply(final IGapFormatting it) {
        it.noSpace();
    ...
    final Procedure1<XExpression> _function_5 = new Procedure1<XExpression>() {
      public void apply(final XExpression it) {
        XbaseFormatter3.this.format(it, format);
      }
    };
  ...
  protected void _format(final XWhileExpression expr, @Extension final IFormattableDocument format) {
    ITokenAccess.IToken _kenForKeyword = this._iTokenAccess.tokenForKeyword(expr, "while");
  ...
  protected void _format(final XTypeLiteral expr, @Extension final IFormattableDocument format) {
    ITokenAccess.IToken _kenForKeyword = this._iTokenAccess.tokenForKeyword(expr, "typeof");
    final Procedure1<IGapFormatting> _function = new Procedure1<IGapFormatting>() {
      public void apply(final IGapFormatting it) {
        it.noSpace();
      }
    ...
    format.append(_kenForKeyword, _function);
    ITokenAccess.IToken _kenForFeature = this._iTokenAccess.tokenForFeature(expr, XbasePackage.Literals.XTYPE_LITERAL__TYPE);
    final Procedure1<IGapFormatting> _function_1 = new Procedure1<IGapFormatting>() {
      public void apply(final IGapFormatting it) {
        it.noSpace();
      }
    };
    ITokenAccess.IToken _prepend = format.prepend(_kenForFeature, _function_1);
    final Procedure1<IGapFormatting> _function_2 = new Procedure1<IGapFormatting>() {
      public void apply(final IGapFormatting it) {
        it.noSpace();
      }
    ...
    final Function1<ITextReplacer.Context, ITextReplacer.Flow> a = this.formatArrayBrackets();
    ParserRule _arrayBracketsRule = this._xbaseGrammarAccess.getArrayBracketsRule();
    List<ITokenAccess.IToken> _kensForRuleCallsTo = this._iTokenAccess.tokensForRuleCallsTo(expr, _arrayBracketsRule);
    final Procedure1<ITokenAccess.IToken> _function_3 = new Procedure1<ITokenAccess.IToken>() {
      public void apply(final ITokenAccess.IToken it) {
        final Procedure1<IGapFormatting> _function = new Procedure1<IGapFormatting>() {
          public void apply(final IGapFormatting it) {
        ...
        ITokenAccess.IToken _append = format.append(it, _function);
        format.setReplacer(_append, new ITextReplacer() {
            public ITextReplacer.Flow createReplacements(ITextReplacer.Context context) {
              return a.apply(context);
            }
        });
    ...
    IterableExtensions.<ITokenAccess.IToken>forEach(_kensForRuleCallsTo, _function_3);
  }
  ...
  protected void _format(final XCatchClause expr, @Extension final IFormattableDocument format) {
    ITokenAccess.IToken _kenForKeyword = this._iTokenAccess.tokenForKeyword(expr, "catch");
    format.append(_kenForKeyword, XbaseFormatterPreferenceKeys.whitespaceBetweenKeywordAndParenthesisML);
    JvmFormalParameter _declaredParam = expr.getDeclaredParam();
    final Procedure1<IGapFormatting> _function = new Procedure1<IGapFormatting>() {
      public void apply(final IGapFormatting it) {
  ...
  protected void _format(final XSwitchExpression expr, @Extension final IFormattableDocument format) {
    ...
    if (!(!containsBlockExpr)) {
      ...
      boolean _isMultiline = this._iTokenAccess.isMultiline(expr);
    ...
    if (!_and_3) {
      ...
      final Function1<XCasePart, Boolean> _function_1 = new Function1<XCasePart, Boolean>() {
        public Boolean apply(final XCasePart it) {
          return Boolean.valueOf(XbaseFormatter3.this._iTokenAccess.isMultiline(it));
        }
      };
    ...
    final ITokenAccess.IToken open = this._iTokenAccess.tokenForKeyword(expr, "{");
    final ITokenAccess.IToken close = this._iTokenAccess.tokenForKeyword(expr, "}");
    ITokenAccess.IToken _kenForKeyword = this._iTokenAccess.tokenForKeyword(expr, "switch");
    final Procedure1<IGapFormatting> _function_2 = new Procedure1<IGapFormatting>() {
      public void apply(final IGapFormatting it) {
        it.oneSpace();
      }
    ...
    if (switchSL) {
      ...
      if (_notEquals_1) {
        ITokenAccess.IToken _kenForKeyword_1 = this._iTokenAccess.tokenForKeyword(expr, "default");
        final Procedure1<IGapFormatting> _function_8 = new Procedure1<IGapFormatting>() {
          public void apply(final IGapFormatting it) {
            it.noSpace();
          }
      ...
      if (caseSL) {
        ...
        final Procedure1<IGapFormatting> _function_11 = new Procedure1<IGapFormatting>() {
          public void apply(final IGapFormatting it) {
            it.increaseIndentation();
          }
        };
        ...
        for (final XCasePart c_1 : _cases_5) {
          {
            ...
            final Procedure1<IGapFormatting> _function_12 = new Procedure1<IGapFormatting>() {
              public void apply(final IGapFormatting it) {
                it.oneSpace();
              }
            };
            ...
            if (_notEquals_2) {
              final Procedure1<IGapFormatting> _function_13 = new Procedure1<IGapFormatting>() {
                public void apply(final IGapFormatting it) {
                  it.newLine();
                }
              };
        ...
        if (_notEquals_2) {
          ITokenAccess.IToken _kenForKeyword_2 = this._iTokenAccess.tokenForKeyword(expr, "default");
          final Procedure1<IGapFormatting> _function_12 = new Procedure1<IGapFormatting>() {
            public void apply(final IGapFormatting it) {
              it.newLine();
            }
          };
          ITokenAccess.IToken _prepend_1 = format.prepend(_kenForKeyword_2, _function_12);
          final Procedure1<IGapFormatting> _function_13 = new Procedure1<IGapFormatting>() {
            public void apply(final IGapFormatting it) {
              it.noSpace();
            }
          ...
          final Procedure1<IGapFormatting> _function_14 = new Procedure1<IGapFormatting>() {
            public void apply(final IGapFormatting it) {
              it.oneSpace();
            }
          };
        ...
        final Procedure1<IGapFormatting> _function_15 = new Procedure1<IGapFormatting>() {
          public void apply(final IGapFormatting it) {
            it.newLine();
            it.decreaseIndentation();
          }
        ...
        format.prepend(open, XbaseFormatterPreferenceKeys.bracesInNewLine);
        final Procedure1<IGapFormatting> _function_16 = new Procedure1<IGapFormatting>() {
          public void apply(final IGapFormatting it) {
            it.newLine();
          }
        };
        ...
        if (_or_1) {
          final Procedure1<IGapFormatting> _function_17 = new Procedure1<IGapFormatting>() {
            public void apply(final IGapFormatting it) {
              it.increaseIndentation();
            }
          };
        ...
        for (final XCasePart c_2 : _cases_7) {
          ...
          if ((_then_2 instanceof XBlockExpression)) {
            ...
            if (_or_2) {
              ...
              final Procedure1<IGapFormatting> _function_18 = new Procedure1<IGapFormatting>() {
                public void apply(final IGapFormatting it) {
                  it.newLine();
                }
              };
              ...
              final Procedure1<IGapFormatting> _function_19 = new Procedure1<IGapFormatting>() {
                public void apply(final IGapFormatting it) {
                  it.newLine();
                  it.decreaseIndentation();
                }
            ...
            final Procedure1<IGapFormatting> _function_20 = new Procedure1<IGapFormatting>() {
              public void apply(final IGapFormatting it) {
                it.newLine();
                it.increaseIndentation();
              }
            ...
            if (_or_3) {
              ...
              final Procedure1<IGapFormatting> _function_21 = new Procedure1<IGapFormatting>() {
                public void apply(final IGapFormatting it) {
                  it.newLine();
                  it.decreaseIndentation();
                }
              ...
              final Procedure1<IGapFormatting> _function_22 = new Procedure1<IGapFormatting>() {
                public void apply(final IGapFormatting it) {
                  it.newLine();
        ...
        if (_notEquals_8) {
          ITokenAccess.IToken _kenForKeyword_3 = this._iTokenAccess.tokenForKeyword(expr, "default");
          final Procedure1<IGapFormatting> _function_23 = new Procedure1<IGapFormatting>() {
            public void apply(final IGapFormatting it) {
              it.noSpace();
            }
          };
          ...
          if ((_default_10 instanceof XBlockExpression)) {
            ...
            final Procedure1<IGapFormatting> _function_24 = new Procedure1<IGapFormatting>() {
              public void apply(final IGapFormatting it) {
                it.newLine();
                it.decreaseIndentation();
              }
            ...
            final Procedure1<IGapFormatting> _function_25 = new Procedure1<IGapFormatting>() {
              public void apply(final IGapFormatting it) {
                it.newLine();
                it.increaseIndentation();
              }
            ...
            final Procedure1<IGapFormatting> _function_26 = new Procedure1<IGapFormatting>() {
              public void apply(final IGapFormatting it) {
                it.newLine();
                it.setDecreaseIndentation(2);
              }
    ...
    for (final XCasePart c_3 : _cases_10) {
      {
        ...
        if (_and_4) {
          final ITokenAccess.IToken typenode = this._iTokenAccess.tokenForFeature(c_3, XbasePackage.Literals.XCASE_PART__TYPE_GUARD);
          final ITokenAccess.IToken casenode = this._iTokenAccess.tokenForFeature(c_3, XbasePackage.Literals.XCASE_PART__CASE);
          final Procedure1<IGapFormatting> _function_27 = new Procedure1<IGapFormatting>() {
            public void apply(final IGapFormatting it) {
              it.oneSpace();
            }
          };
          format.append(typenode, _function_27);
          final Procedure1<IGapFormatting> _function_28 = new Procedure1<IGapFormatting>() {
            public void apply(final IGapFormatting it) {
              it.oneSpace();
            }
          };
          format.prepend(casenode, _function_28);
          final Procedure1<IGapFormatting> _function_29 = new Procedure1<IGapFormatting>() {
            public void apply(final IGapFormatting it) {
              it.noSpace();
            }
          };
          ...
          if (_notEquals_11) {
            final ITokenAccess.IToken typenode_1 = this._iTokenAccess.tokenForFeature(c_3, XbasePackage.Literals.XCASE_PART__TYPE_GUARD);
            final Procedure1<IGapFormatting> _function_30 = new Procedure1<IGapFormatting>() {
              public void apply(final IGapFormatting it) {
                it.noSpace();
              }
            };
            ...
            if (_notEquals_12) {
              ...
              final Procedure1<IGapFormatting> _function_31 = new Procedure1<IGapFormatting>() {
                public void apply(final IGapFormatting it) {
                  it.oneSpace();
                }
              };
              XExpression _prepend_4 = format.<XExpression>prepend(_case_2, _function_31);
              final Procedure1<IGapFormatting> _function_32 = new Procedure1<IGapFormatting>() {
                public void apply(final IGapFormatting it) {
                  it.noSpace();
                }
              };
  ...
  protected ITokenAccess.IToken formatClosureParams(final XClosure expr, final ITokenAccess.IToken open, @Extension final IFormattableDocument format, final Procedure1<? super IGapFormatting> init) {
    ...
    if (_isExplicitSyntax) {
      ...
      for (final JvmFormalParameter param : _declaredFormalParameters) {
        {
          ...
          ITokenAccess.IToken _prepend = format.prepend(_immediatelyFollowingKeyword, _function);
          final Procedure1<IGapFormatting> _function_1 = new Procedure1<IGapFormatting>() {
            public void apply(final IGapFormatting it) {
              it.oneSpace();
            }
      ...
      format.append(open, ((Procedure1<IGapFormatting>)init));
      final ITokenAccess.IToken last = this._iTokenAccess.tokenForFeature(expr, XbasePackage.Literals.XCLOSURE__EXPLICIT_SYNTAX);
      ...
      boolean _not = (!_isEmpty);
      if (_not) {
        format.prepend(last, ((Procedure1<IGapFormatting>)init));
      }
      return last;
    }
    return open;
  ...
  protected void _format(final XClosure expr, @Extension final IFormattableDocument format) {
    ...
    if (_kenForKeyword != null) {
      ...
      ITokenAccess.IToken _immediatelyPrecedingKeyword = this._iTokenAccess.immediatelyPrecedingKeyword(expr, "(");
    ...
    if (_kenForKeyword_1 != null) {
      ...
      ITokenAccess.IToken _immediatelyFollowingKeyword = this._iTokenAccess.immediatelyFollowingKeyword(expr, ")");
    ...
    if (_isEmpty) {
      ITokenAccess.IGap _trailingGap = open.getTrailingGap();
      ...
      if (_isMultiline) {
        ...
        final ITokenAccess.IToken last = this.formatClosureParams(expr, open, format, _function_2);
        this.formatExpressionsMultiline(children, last, close, format);
      } else {
        ITokenAccess.IGap _leadingGap_1 = open.getLeadingGap();
        ITokenAccess.IToken _nextToken = _leadingGap_1.getNextToken();
        final int offset = _nextToken.getEndOffset();
        ITokenAccess.IGap _trailingGap_1 = close.getTrailingGap();
        ...
        final IFormattableDocument.ISubFormatter _function_3 = new IFormattableDocument.ISubFormatter() {
          public void format(final IFormattableDocument.IFormattableSubDocument doc) throws IFormattableDocument.FormattingNotApplicableException {
            ...
            final ITokenAccess.IToken last = XbaseFormatter3.this.formatClosureParams(expr, open, it, _function);
            final Procedure1<IGapFormatting> _function_1 = new Procedure1<IGapFormatting>() {
              public void apply(final IGapFormatting it) {
                it.noSpace();
              }
            ...
            for (final XExpression c : children) {
              {
                XbaseFormatter3.this.format(c, it);
                final ITokenAccess.IToken semicolon = XbaseFormatter3.this._iTokenAccess.immediatelyFollowingKeyword(c, ";");
                ...
                if (_notEquals) {
                  ...
                  ITokenAccess.IToken _prepend = it.prepend(semicolon, _function_2);
                  final Procedure1<IGapFormatting> _function_3 = new Procedure1<IGapFormatting>() {
                    public void apply(final IGapFormatting it) {
        ...
        final IFormattableDocument.ISubFormatter _function_4 = new IFormattableDocument.ISubFormatter() {
          public void format(final IFormattableDocument.IFormattableSubDocument doc) throws IFormattableDocument.FormattingNotApplicableException {
            ...
            final ITokenAccess.IToken last = XbaseFormatter3.this.formatClosureParams(expr, open, format, _function);
            XbaseFormatter3.this.formatExpressionsMultiline(children, last, close, doc);
          }
        };
  ...
  protected void formatExpressionsMultiline(final Collection<? extends XExpression> expressions, final ITokenAccess.IToken open, final ITokenAccess.IToken close, @Extension final IFormattableDocument format) {
    ...
    if (_isEmpty) {
      ...
      ITokenAccess.IToken _append = format.append(open, XbaseFormatterPreferenceKeys.blankLinesAroundExpression);
      final Procedure1<IGapFormatting> _function_2 = new Procedure1<IGapFormatting>() {
        public void apply(final IGapFormatting it) {
          it.increaseIndentation();
        }
      ...
      for (final XExpression child : expressions) {
        {
          ...
          final ITokenAccess.IToken sem = this._iTokenAccess.immediatelyFollowingKeyword(child, ";");
          ...
          if (_notEquals) {
            ...
            ITokenAccess.IToken _prepend = format.prepend(sem, _function_3);
  ...
  protected boolean isMultilineOrInNewLine(final EObject obj) {
    ...
    if (!_notEquals) {
      ...
      boolean _or = false;
      boolean _isMultiline = this._iTokenAccess.isMultiline(obj);
      if (_isMultiline) {
        _or = true;
      } else {
        ITokenAccess.IGap _leadingGap = this._iTokenAccess.leadingGap(obj);
        boolean _isMultiline_1 = _leadingGap.isMultiline();
        _or = _isMultiline_1;
      }
      _and = _or;
