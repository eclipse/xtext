...
public class AbstractXbaseSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		if (!transition.isSyntacticallyAmbiguous())
			return;
		if(match_XBlockExpression_XParenthesizedExpression_LeftParenthesisKeyword_0_a_LeftCurlyBracketKeyword_1_RightCurlyBracketKeyword_3_RightParenthesisKeyword_2_a.equals(transition.getAmbiguousSyntax()))
