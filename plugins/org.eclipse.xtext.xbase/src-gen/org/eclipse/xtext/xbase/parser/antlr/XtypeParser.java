...
public class XtypeParser extends org.eclipse.xtext.parser.antlr.AbstractAntlrParser {
	...
	protected IParseResult parse(String ruleName, CharStream in) {
		...
		org.eclipse.xtext.xbase.parser.antlr.internal.InternalXtypeParser parser = createParser(tokenStream);
	...
	protected org.eclipse.xtext.xbase.parser.antlr.internal.InternalXtypeParser createParser(XtextTokenStream stream) {
		return new org.eclipse.xtext.xbase.parser.antlr.internal.InternalXtypeParser(stream, getElementFactory(), getGrammarAccess());
	}
