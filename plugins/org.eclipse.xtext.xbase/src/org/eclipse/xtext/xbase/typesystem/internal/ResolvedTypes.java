...
//		AbstractTypeComputationState state = expectation.getState();
	...
	protected final void addExpressionScope(EObject context, IFeatureScopeSession session) {
		for(IExpressionScope.Anchor anchor: IExpressionScope.Anchor.values()) {
			addExpressionScope(context, session, anchor);
		}
	}
	...
	protected abstract void replacePreviousExpressionScope(XExpression context, IFeatureScopeSession session, IExpressionScope.Anchor anchor);
