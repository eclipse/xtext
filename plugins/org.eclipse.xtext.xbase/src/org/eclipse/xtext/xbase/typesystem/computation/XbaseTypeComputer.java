...
public class XbaseTypeComputer implements ITypeComputer {
	...
	protected void _computeTypes(final XBasicForLoopExpression object, final ITypeComputationState state) {
		...
		for (XExpression updateExpression : object.getUpdateExpressions()) {
			ITypeComputationState updateExpressionState = reassignCheckedType(expression, updateExpression, stateWithoutExpectation);
			updateExpressionState.computeTypes(updateExpression);
		}
