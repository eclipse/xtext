...
public class ConstructorScopes extends DelegatingScopes {
	 ...
	 */
	protected IScope createAnonymousClassConstructorScope(final JvmGenericType instantiatedType, EObject context, final IFeatureScopeSession session) {
		...
		return new ConstructorTypeScopeWrapper(context, protectedIsVisible, IScope.NULLSCOPE) {
			...
			public Iterable<IEObjectDescription> getElements(QualifiedName name) {
				IEObjectDescription typeDescription = EObjectDescription.create(name, instantiatedType);
