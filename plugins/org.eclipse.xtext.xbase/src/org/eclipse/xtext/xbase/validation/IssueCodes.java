...
public class IssueCodes {
	...
	/** A deprecated feature is used inside a deprecated feature.
	 */
	public static final String DEPRECATION_IN_DEPRECATED_CODE = ISSUE_CODE_PREFIX + "deprecation_in_deprecated_code";
