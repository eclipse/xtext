...
public class XbaseConfigurableIssueCodes extends ConfigurableIssueCodesProvider {
	...
	public static final String COMPILER_PB_DEPRECATION_IN_DEPRECATED_CODE = JDT_CORE_PLUGIN_ID + ".compiler.problem.deprecationInDeprecatedCode"; //$NON-NLS-1$
	...
	protected void initialize(IAcceptor<PreferenceKey> iAcceptor) {
		...
		iAcceptor.accept(createDelegate(IssueCodes.DEPRECATION_IN_DEPRECATED_CODE, COMPILER_PB_DEPRECATION_IN_DEPRECATED_CODE));
	}
