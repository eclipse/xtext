...
public class JvmTypesBuilder {
	...
	protected <T extends JvmTypeReference> T cloneAndAssociate(T original) {
		EcoreUtil.Copier copier = new EcoreUtil.Copier(false) {
			...
			private EStructuralFeature.Setting getTargetSetting(EStructuralFeature eStructuralFeature, EObject copyEObject)
		    {
			...
			protected void copyReference(EReference eReference, EObject eObject, EObject copyEObject)
		    {
		      ...
		      {
		        EStructuralFeature.Setting setting = getTargetSetting(eReference, copyEObject);
		        if (setting != null)
		        {
