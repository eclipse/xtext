...
public final class BytecodeGen {
  ...
  static final net.sf.cglib.core.NamingPolicy NAMING_POLICY
	...
	public String getClassName(String prefix, String source, Object key, net.sf.cglib.core.Predicate names) {
		// change the package name to allow Guice to be used in signed environments such as Eclipse
		// the behaviour is similar to the Guice version without AOP but we still benefit from improved 
		// error messages
