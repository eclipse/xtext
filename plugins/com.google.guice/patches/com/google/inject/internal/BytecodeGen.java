 ...
 * com.google.inject.cglib.reflect.FastClass faster reflection}, {@link com.google.inject.cglib.proxy.Enhancer method
...
public final class BytecodeGen {
  ...
  /*if[AOP]*/
  /** either "com.google.inject.cglib", or "com.google.inject.internal.cglib" */
  private static final String CGLIB_PACKAGE
      = com.google.inject.cglib.proxy.Enhancer.class.getName().replaceFirst("\\.cglib\\..*$", ".cglib");

  static final com.google.inject.cglib.core.NamingPolicy NAMING_POLICY
      = new com.google.inject.cglib.core.DefaultNamingPolicy() {
	@Override
	public String getClassName(String prefix, String source, Object key, com.google.inject.cglib.core.Predicate names) {
  ...
  public static com.google.inject.cglib.reflect.FastClass newFastClass(Class<?> type, Visibility visibility) {
    com.google.inject.cglib.reflect.FastClass.Generator generator
        = new com.google.inject.cglib.reflect.FastClass.Generator();
  ...
  public static com.google.inject.cglib.proxy.Enhancer newEnhancer(Class<?> type, Visibility visibility) {
    com.google.inject.cglib.proxy.Enhancer enhancer = new com.google.inject.cglib.proxy.Enhancer();
