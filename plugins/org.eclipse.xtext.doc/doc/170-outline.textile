...
* implement ${org.eclipse.xtext.ui.common/src/org.eclipse.xtext.ui.common.editor.outline.actions.IContentOutlineNodeAdapterFactory} which will translate ${org.eclipse.xtext.ui.common/src/org.eclipse.xtext.ui.common.editor.outline.ContentOutlineNode}s to their underlying node type
...
The Xtext code generator creates a subclass of ${org.eclipse.xtext.ui.common/src/org.eclipse.xtext.ui.common.editor.outline.actions.DefaultContentOutlineNodeAdapterFactory}. All we need to do is specify a list of types that we later want to bind context menu contributions to. 
...
p. If you want to bind context menu actions to nodes representing @Attribute@ and @Entity@, you need to change the declaration of @type@ as follows:
