...
This requires minor changes (namely the namespaces to be imported are now the qualfied name of the generated Java classes). We changed this in order to allow use of any Java API , such as IScopeProvider, from within Check and Xtend.
