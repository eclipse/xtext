...
* Xtext will register an EMF @ResourceFatory@, so resources with the file extension you entered when generating the Xtext plug-ins will be automatically loaded in an @XtextResource@ when you use EMF's @ResourceSet@ API to load it.
