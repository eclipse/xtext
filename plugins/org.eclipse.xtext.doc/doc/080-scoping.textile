...
As always there is an implementation that allows to specify scoping in a declarative way (extend ${org.eclipse.xtext/src/org.eclipse.xtext.scoping.impl.AbstractDeclarativeScopeProvider} for this purpose). It looks up methods which have either of the following two signatures:
