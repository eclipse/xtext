...
In those cases URIs are used, which are made up of a part identifying the resource. Each @EObject@ contained in a Resource can be identified by a so called 'fragment'.
