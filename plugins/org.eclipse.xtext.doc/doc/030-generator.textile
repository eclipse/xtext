...
*Important*
__Due to "IP-Problems":#antlr_ip_issue with the code generator shipped with ANTLR 3 we're not allowed to ship this fragment at Eclipse. Therefore you'll have to download it separately from http://download.itemis.com or use the update site at *http://download.itemis.com/updates/*.__
