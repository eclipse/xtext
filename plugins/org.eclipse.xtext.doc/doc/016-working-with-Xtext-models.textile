...
dynamically. We'll later talk about code generation. In this chapter we want to see how to interact with Xtext models programmatically. 
...
p. Note that you'll find a lot of convenience API in EMF's EcoreUtil and Xtext's EcoreUtil2. 
...
The super type of both node types is _AbstractNode_. One can find a couple of convenience methods in _NodeUtil_ and _ParseTreeUtil_.
