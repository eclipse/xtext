...
The declarative implementation of the label itself is pretty straightforward. The image in turn is expected to be found in a file named @icons/<result of image-method>@ in your plugin. This path is actually configurable by google guice. Have a look at the ${org.eclipse.xtext.ui.core/src/org.eclipse.xtext.ui.core.PluginImageHelper} to learn about the customizing possibilities.
