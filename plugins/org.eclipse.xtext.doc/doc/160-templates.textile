...
the generated ui-plugin. This file contains templates in a format as described in the 
...
_templates.xml_-file and put this one into the _templates_ folder of your ui-plugin. However, these 
...
down filled with the literal values as defined in the Visibility _EEnumeration_. Also, 'name' and 'type' 
