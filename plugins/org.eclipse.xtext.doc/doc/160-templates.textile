...
p. yields the text @visibility op name@ where the display text 'visibility' is replaced with a drop down filled with the literal values as defined in the Visibility @EENumeration@.
