...
!{width:75%}images/templates_crossref.png!
...
which are assignment-compatible to the enumeration type declared as the first parameter of the the <em>Enum</em> @TemplateVariable@. 
...
!{width:75%}images/templates_enum.png!