...
p. Last but not least, the ${org.eclipse.xtext.generator/src/org/eclipse/xtext/generator/types/TypesGeneratorFragment} has to be added to the workflow. The safest way is 
...
The ${org.eclipse.xtext.ui/src/org/eclipse/xtext/ui/editor/contentassist/ITemplateProposalProvider} can be
