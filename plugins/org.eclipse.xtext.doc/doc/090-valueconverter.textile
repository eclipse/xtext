...
The primary hook is called ${org.eclipse.xtext/src/org.eclipse.xtext.conversion.IValueConverterService} and the concrete implementation can be registered via the runtime "Guice module"#guicemanualmodules.

h3. Annotation based value converters

The most simple way to register additional value converters is to make use of ${org.eclipse.xtext/src/org.eclipse.xtext.conversion.impl.AbstractAnnotationBasedValueConverterService}, which allows to
