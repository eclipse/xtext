...
${org.eclipse.xtext.example.domainmodel/src/org.eclipse.xtext.example.validation.DomainmodelJavaValidator}) 
the diagnostic's _code_ is given by the last argument to the _warning()_ method and it is a reference 
...
the problem can be fixed (see also 
${org.eclipse.xtext.example.domainmodel.ui/src/org.eclipse.xtext.example.quickfix.DomainmodelQuickfixProvider}):
...
${org.eclipse.xtext.ui/src/org.eclipse.xtext.ui.editor.model.edit.ISemanticModification.java} instead. 
