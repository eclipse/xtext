...
p. Each of the mentioned implementation is rather simple and can be done in a couple of minutes. 
This is true for many tedious tasks that developers face in their daily work. MWE2 can be used to
minimize the effort for them to a minimum by means of automati
