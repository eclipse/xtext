...
public class ServiceRegistry {
	...
	@SuppressWarnings("unchecked")
	private static void findAndInjectService(ILanguageDescriptor languageDescriptor, ILanguageService service,
			Class<?> type, Method setter, Map<Class<?>, ILanguageService> cachedServices)
		...
		if (injectedService == null) {
			injectedService = ServiceRegistry.internalGetService(languageDescriptor,
					(Class<? extends ILanguageService>) type, cachedServices);
			if (injectedService == null) {
