...
public class SimpleExpressionsStandaloneSetupGenerated implements ISetup {
	...
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.itemis.de/xtext/antlr/simpleExpressions")) {
		EPackage.Registry.INSTANCE.put("http://www.itemis.de/xtext/antlr/simpleExpressions", org.eclipse.xtext.generator.parser.antlr.splitting.simpleExpressions.SimpleExpressionsPackage.eINSTANCE);
	}
