...
public class SimpleExpressionsFactoryImpl extends EFactoryImpl implements SimpleExpressionsFactory
{
  ...
  public static SimpleExpressionsFactory init()
  {
    try
    {
      SimpleExpressionsFactory theSimpleExpressionsFactory = (SimpleExpressionsFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.itemis.de/xtext/antlr/simpleExpressions"); 
