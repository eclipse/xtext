		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getFunctionAccess().getGroup_6_1(), "rule__Function__Group_6_1__0");
					...
					put(grammarAccess.getDeclaredDependencyAccess().getNameAssignment_3(), "rule__DeclaredDependency__NameAssignment_3");
					...
					put(grammarAccess.getFunctionAccess().getCreateExtensionInfoAssignment_3(), "rule__Function__CreateExtensionInfoAssignment_3");
					put(grammarAccess.getFunctionAccess().getNameAssignment_4(), "rule__Function__NameAssignment_4");
					put(grammarAccess.getFunctionAccess().getParametersAssignment_6_0(), "rule__Function__ParametersAssignment_6_0");
					put(grammarAccess.getFunctionAccess().getParametersAssignment_6_1_1(), "rule__Function__ParametersAssignment_6_1_1");
					put(grammarAccess.getFunctionAccess().getExpressionAssignment_8_0(), "rule__Function__ExpressionAssignment_8_0");
