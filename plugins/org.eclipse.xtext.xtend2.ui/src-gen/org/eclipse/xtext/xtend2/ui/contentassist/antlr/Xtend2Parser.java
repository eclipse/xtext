	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getFunctionAccess().getAlternatives_6(), "rule__Function__Alternatives_6");
					...
					put(grammarAccess.getInternalRichStringAccess().getAlternatives(), "rule__InternalRichString__Alternatives");
					...
					put(grammarAccess.getRichStringAccess().getGroup_0(), "rule__RichString__Group_0__0");
					...
					put(grammarAccess.getInternalRichStringAccess().getGroup_0(), "rule__InternalRichString__Group_0__0");
					put(grammarAccess.getInternalRichStringAccess().getGroup_1(), "rule__InternalRichString__Group_1__0");
					put(grammarAccess.getInternalRichStringAccess().getGroup_1_2(), "rule__InternalRichString__Group_1_2__0");
					...
					put(grammarAccess.getXSwitchExpressionAccess().getGroup_5_2_0(), "rule__XSwitchExpression__Group_5_2_0__0");
					...
					put(grammarAccess.getFileAccess().getClassesAssignment_2(), "rule__File__ClassesAssignment_2");
					...
					put(grammarAccess.getFunctionAccess().getExpressionAssignment_6_0(), "rule__Function__ExpressionAssignment_6_0");
					put(grammarAccess.getXStringLiteralAccess().getValueAssignment_0_1(), "rule__XStringLiteral__ValueAssignment_0_1");
					put(grammarAccess.getRichStringAccess().getValueAssignment_0_1(), "rule__RichString__ValueAssignment_0_1");
					put(grammarAccess.getRichStringAccess().getElementsAssignment_1_1(), "rule__RichString__ElementsAssignment_1_1");
					put(grammarAccess.getRichStringAccess().getElementsAssignment_1_2_0(), "rule__RichString__ElementsAssignment_1_2_0");
					put(grammarAccess.getRichStringAccess().getElementsAssignment_1_2_1(), "rule__RichString__ElementsAssignment_1_2_1");
					put(grammarAccess.getRichStringAccess().getElementsAssignment_1_3(), "rule__RichString__ElementsAssignment_1_3");
					put(grammarAccess.getRichStringAccess().getElementsAssignment_1_4(), "rule__RichString__ElementsAssignment_1_4");
					...
					put(grammarAccess.getInternalRichStringAccess().getValueAssignment_0_1(), "rule__InternalRichString__ValueAssignment_0_1");
					put(grammarAccess.getInternalRichStringAccess().getElementsAssignment_1_1(), "rule__InternalRichString__ElementsAssignment_1_1");
					put(grammarAccess.getInternalRichStringAccess().getElementsAssignment_1_2_0(), "rule__InternalRichString__ElementsAssignment_1_2_0");
					put(grammarAccess.getInternalRichStringAccess().getElementsAssignment_1_2_1(), "rule__InternalRichString__ElementsAssignment_1_2_1");
					...
					put(grammarAccess.getXAndExpressionAccess().getRightOperandAssignment_1_2(), "rule__XAndExpression__RightOperandAssignment_1_2");
					put(grammarAccess.getXEqualityExpressionAccess().getFeatureAssignment_1_1(), "rule__XEqualityExpression__FeatureAssignment_1_1");
					put(grammarAccess.getXEqualityExpressionAccess().getRightOperandAssignment_1_2(), "rule__XEqualityExpression__RightOperandAssignment_1_2");
					...
					put(grammarAccess.getXRelationalExpressionAccess().getRightOperandAssignment_1_1_2(), "rule__XRelationalExpression__RightOperandAssignment_1_1_2");
					...
					put(grammarAccess.getXOtherOperatorExpressionAccess().getRightOperandAssignment_1_2(), "rule__XOtherOperatorExpression__RightOperandAssignment_1_2");
					put(grammarAccess.getXAdditiveExpressionAccess().getFeatureAssignment_1_1(), "rule__XAdditiveExpression__FeatureAssignment_1_1");
					put(grammarAccess.getXAdditiveExpressionAccess().getRightOperandAssignment_1_2(), "rule__XAdditiveExpression__RightOperandAssignment_1_2");
					...
					put(grammarAccess.getXCastedExpressionAccess().getTypeAssignment_2(), "rule__XCastedExpression__TypeAssignment_2");
					put(grammarAccess.getXCastedExpressionAccess().getTargetAssignment_4(), "rule__XCastedExpression__TargetAssignment_4");
					...
					put(grammarAccess.getXSwitchExpressionAccess().getDefaultAssignment_5_2_0_0(), "rule__XSwitchExpression__DefaultAssignment_5_2_0_0");
					put(grammarAccess.getXSwitchExpressionAccess().getDefaultAssignment_5_2_1(), "rule__XSwitchExpression__DefaultAssignment_5_2_1");
					...
					put(grammarAccess.getXVariableDeclarationAccess().getTypeAssignment_2(), "rule__XVariableDeclaration__TypeAssignment_2");
					put(grammarAccess.getXVariableDeclarationAccess().getNameAssignment_3(), "rule__XVariableDeclaration__NameAssignment_3");
					put(grammarAccess.getXVariableDeclarationAccess().getRightAssignment_5(), "rule__XVariableDeclaration__RightAssignment_5");
					...
					put(grammarAccess.getXTypeLiteralAccess().getTypeAssignment_1(), "rule__XTypeLiteral__TypeAssignment_1");
