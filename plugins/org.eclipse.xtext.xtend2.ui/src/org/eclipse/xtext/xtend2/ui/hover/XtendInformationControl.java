...
public class XtendInformationControl extends AbstractInformationControl implements IInformationControlExtension2,
	 ...
	 * Xtend Modifications
	 */
	private XtendInformationControlInput fInput;
	...
	/**
	 * Xtend - modification Added XtendHoverConfiguration because we do not have DI here
	 */
	public XtendInformationControl(Shell parent, String symbolicFontName, String statusFieldText,
			XtendHoverConfiguration xtendHoverConfiguration) {
		super(parent, statusFieldText);
		fSymbolicFontName = symbolicFontName;
		this.xtendHoverConfiguration = xtendHoverConfiguration;
		create();
	}
	 ...
	 * Xtend - modification Added XtendHoverConfiguration because we do not have DI here
	 */
	public XtendInformationControl(Shell parent, String symbolicFontName, ToolBarManager toolBarManager,
			XtendHoverConfiguration xtendHoverConfiguration) {
	...
	/**
	 * Xtend - modification+ added detailPane
	 */
	@Override
	protected void createContent(Composite parent) {
		...
		embeddedEditor = xtendHoverConfiguration.getEditorFactory().newEditor(resourceProvider).readOnly()
	...
	public void setInput(Object input) {
		Assert.isLegal(input == null || input instanceof String || input instanceof XtendInformationControlInput);

		if (input instanceof String) {
			setInformation((String) input);
			return;
		}
		if (input instanceof XtendInformationControlInput)
			fInput = (XtendInformationControlInput) input;
		...
		if (fInput != null) {
			...
			xtendHoverConfiguration.getHighlightingHelper().install(embeddedEditor.getConfiguration(),embeddedEditor.getViewer());
		}
	...
	/**
	 * Xtend - modification added some space for the detailPane
	 */
	@Override
	public Point computeSizeHint() {
		...
		Rectangle detailBounds = computeBounds(sizeConstraints, trim, null, fInput.getUnsugaredExpression());
	 ...
	 * Xtend - modification
	 */
	public XtendInformationControlInput getInput() {
		return fInput;
	}
