...
public class XtextBracePairProvider extends DefaultBracePairProvider {
  public XtextBracePairProvider() {
    super(
      Collections.<BracePair>unmodifiableList(CollectionLiterals.<BracePair>newArrayList(new BracePair(":", ";", false), new BracePair("(", ")", false), new BracePair("{", "}", true), new BracePair("[", "]", false))));
  }
}
