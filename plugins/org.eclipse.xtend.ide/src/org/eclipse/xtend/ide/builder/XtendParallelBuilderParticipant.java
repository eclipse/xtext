...
public class XtendParallelBuilderParticipant extends ParallelBuilderParticipant {
	...
	protected Runnable createRunnable(
			...
			final BlockingQueue<org.eclipse.xtext.xbase.lib.Pair<Delta, Procedure2<? super IFileSystemAccess, ? super IProgressMonitor>>> requestQueue,
		...
		return createRunnable(delta, file, resource, context, outputConfigurations, generatorMarkers, requestQueue, delegate);
	}
