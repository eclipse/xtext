...
class EclipseFileSystemAccessImpl implements FileSystemAccessImpl {
	...
	override getSourceFolder(CompilationUnitImpl it) {
	...
	override getRootFolder(CompilationUnitImpl it) {
		val file = file
		if (file == null) {
			return null
		}
	...
	override getTargetFolder(CompilationUnitImpl it) {
		val file = file
