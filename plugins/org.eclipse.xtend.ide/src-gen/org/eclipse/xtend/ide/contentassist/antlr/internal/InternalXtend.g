...
:
(
{ before(grammarAccess.getTypeAccess().getMembersAnnotationMemberParserRuleCall_2_1_4_0()); }
	ruleAnnotationMember{ after(grammarAccess.getTypeAccess().getMembersAnnotationMemberParserRuleCall_2_1_4_0()); }
)
