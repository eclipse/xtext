		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getXConstructorCallAccess().getAnonymousClassAssignment_5_0(), "rule__XConstructorCall__AnonymousClassAssignment_5_0");
					put(grammarAccess.getXConstructorCallAccess().getArgumentsAssignment_5_1(), "rule__XConstructorCall__ArgumentsAssignment_5_1");
					put(grammarAccess.getAnonymousClassAccess().getMembersAssignment_2(), "rule__AnonymousClass__MembersAssignment_2");
