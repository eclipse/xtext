		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getXConstructorCallAccess().getAlternatives(), "rule__XConstructorCall__Alternatives");
					put(grammarAccess.getAnonymousClassConstructorCallAccess().getAlternatives_4_1(), "rule__AnonymousClassConstructorCall__Alternatives_4_1");
					...
					put(grammarAccess.getAnonymousClassConstructorCallAccess().getGroup(), "rule__AnonymousClassConstructorCall__Group__0");
					put(grammarAccess.getAnonymousClassConstructorCallAccess().getGroup_3(), "rule__AnonymousClassConstructorCall__Group_3__0");
					put(grammarAccess.getAnonymousClassConstructorCallAccess().getGroup_3_2(), "rule__AnonymousClassConstructorCall__Group_3_2__0");
					put(grammarAccess.getAnonymousClassConstructorCallAccess().getGroup_4(), "rule__AnonymousClassConstructorCall__Group_4__0");
					put(grammarAccess.getAnonymousClassConstructorCallAccess().getGroup_4_1_1(), "rule__AnonymousClassConstructorCall__Group_4_1_1__0");
					put(grammarAccess.getAnonymousClassConstructorCallAccess().getGroup_4_1_1_1(), "rule__AnonymousClassConstructorCall__Group_4_1_1_1__0");
					...
					put(grammarAccess.getAnonymousClassAccess().getGroup(), "rule__AnonymousClass__Group__0");
					put(grammarAccess.getAnonymousClassAccess().getGroup_0(), "rule__AnonymousClass__Group_0__0");
					put(grammarAccess.getAnonymousClassAccess().getGroup_0_0(), "rule__AnonymousClass__Group_0_0__0");
					...
					put(grammarAccess.getAnnotationFieldAccess().getModifiersAssignment_2_0_0(), "rule__AnnotationField__ModifiersAssignment_2_0_0");
					put(grammarAccess.getAnnotationFieldAccess().getModifiersAssignment_2_0_1(), "rule__AnnotationField__ModifiersAssignment_2_0_1");
					put(grammarAccess.getAnnotationFieldAccess().getTypeAssignment_2_0_2(), "rule__AnnotationField__TypeAssignment_2_0_2");
					put(grammarAccess.getAnnotationFieldAccess().getNameAssignment_2_0_3(), "rule__AnnotationField__NameAssignment_2_0_3");
					put(grammarAccess.getAnnotationFieldAccess().getTypeAssignment_2_1_0(), "rule__AnnotationField__TypeAssignment_2_1_0");
					put(grammarAccess.getAnnotationFieldAccess().getNameAssignment_2_1_1(), "rule__AnnotationField__NameAssignment_2_1_1");
					...
					put(grammarAccess.getAnonymousClassConstructorCallAccess().getConstructorAssignment_2(), "rule__AnonymousClassConstructorCall__ConstructorAssignment_2");
					put(grammarAccess.getAnonymousClassConstructorCallAccess().getTypeArgumentsAssignment_3_1(), "rule__AnonymousClassConstructorCall__TypeArgumentsAssignment_3_1");
					put(grammarAccess.getAnonymousClassConstructorCallAccess().getTypeArgumentsAssignment_3_2_1(), "rule__AnonymousClassConstructorCall__TypeArgumentsAssignment_3_2_1");
					put(grammarAccess.getAnonymousClassConstructorCallAccess().getArgumentsAssignment_4_1_0(), "rule__AnonymousClassConstructorCall__ArgumentsAssignment_4_1_0");
					put(grammarAccess.getAnonymousClassConstructorCallAccess().getArgumentsAssignment_4_1_1_0(), "rule__AnonymousClassConstructorCall__ArgumentsAssignment_4_1_1_0");
					put(grammarAccess.getAnonymousClassConstructorCallAccess().getArgumentsAssignment_4_1_1_1_1(), "rule__AnonymousClassConstructorCall__ArgumentsAssignment_4_1_1_1_1");
					put(grammarAccess.getAnonymousClassConstructorCallAccess().getAnonymousClassAssignment_5(), "rule__AnonymousClassConstructorCall__AnonymousClassAssignment_5");
					...
					put(grammarAccess.getAnonymousClassAccess().getMembersAssignment_1(), "rule__AnonymousClass__MembersAssignment_1");
