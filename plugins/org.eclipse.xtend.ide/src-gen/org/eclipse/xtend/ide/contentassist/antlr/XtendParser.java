		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getXAnnotationUnaryOperationAccess().getAlternatives(), "rule__XAnnotationUnaryOperation__Alternatives");
					put(grammarAccess.getXAnnotationPrimaryExpressionAccess().getAlternatives(), "rule__XAnnotationPrimaryExpression__Alternatives");
					...
					put(grammarAccess.getXAnnotationElementValueNoListAccess().getGroup(), "rule__XAnnotationElementValueNoList__Group__0");
					put(grammarAccess.getXAnnotationElementValueNoListAccess().getGroup_1(), "rule__XAnnotationElementValueNoList__Group_1__0");
					put(grammarAccess.getXAnnotationElementValueNoListAccess().getGroup_1_0(), "rule__XAnnotationElementValueNoList__Group_1_0__0");
					put(grammarAccess.getXAnnotationElementValueNoListAccess().getGroup_1_0_0(), "rule__XAnnotationElementValueNoList__Group_1_0_0__0");
					put(grammarAccess.getXAnnotationMultiplicativeExpressionAccess().getGroup(), "rule__XAnnotationMultiplicativeExpression__Group__0");
					put(grammarAccess.getXAnnotationMultiplicativeExpressionAccess().getGroup_1(), "rule__XAnnotationMultiplicativeExpression__Group_1__0");
					put(grammarAccess.getXAnnotationMultiplicativeExpressionAccess().getGroup_1_0(), "rule__XAnnotationMultiplicativeExpression__Group_1_0__0");
					put(grammarAccess.getXAnnotationMultiplicativeExpressionAccess().getGroup_1_0_0(), "rule__XAnnotationMultiplicativeExpression__Group_1_0_0__0");
					put(grammarAccess.getXAnnotationUnaryOperationAccess().getGroup_0(), "rule__XAnnotationUnaryOperation__Group_0__0");
					put(grammarAccess.getXAnnotationParameterizedExpressionAccess().getGroup(), "rule__XAnnotationParameterizedExpression__Group__0");
					put(grammarAccess.getXAnnotationListLiteralAccess().getGroup(), "rule__XAnnotationListLiteral__Group__0");
					put(grammarAccess.getXAnnotationListLiteralAccess().getGroup_3(), "rule__XAnnotationListLiteral__Group_3__0");
					put(grammarAccess.getXAnnotationListLiteralAccess().getGroup_3_1(), "rule__XAnnotationListLiteral__Group_3_1__0");
					...
					put(grammarAccess.getMemberAccess().getCreateExtensionInfoAssignment_2_1_5_2_0_0(), "rule__Member__CreateExtensionInfoAssignment_2_1_5_2_0_0");
					put(grammarAccess.getMemberAccess().getNameAssignment_2_1_5_2_0_1(), "rule__Member__NameAssignment_2_1_5_2_0_1");
					put(grammarAccess.getMemberAccess().getNameAssignment_2_1_5_3_0(), "rule__Member__NameAssignment_2_1_5_3_0");
					...
					put(grammarAccess.getXAnnotationElementValueNoListAccess().getFeatureAssignment_1_0_0_1(), "rule__XAnnotationElementValueNoList__FeatureAssignment_1_0_0_1");
					put(grammarAccess.getXAnnotationElementValueNoListAccess().getRightOperandAssignment_1_1(), "rule__XAnnotationElementValueNoList__RightOperandAssignment_1_1");
					put(grammarAccess.getXAnnotationMultiplicativeExpressionAccess().getFeatureAssignment_1_0_0_1(), "rule__XAnnotationMultiplicativeExpression__FeatureAssignment_1_0_0_1");
					put(grammarAccess.getXAnnotationMultiplicativeExpressionAccess().getRightOperandAssignment_1_1(), "rule__XAnnotationMultiplicativeExpression__RightOperandAssignment_1_1");
					put(grammarAccess.getXAnnotationUnaryOperationAccess().getFeatureAssignment_0_1(), "rule__XAnnotationUnaryOperation__FeatureAssignment_0_1");
					put(grammarAccess.getXAnnotationUnaryOperationAccess().getOperandAssignment_0_2(), "rule__XAnnotationUnaryOperation__OperandAssignment_0_2");
					put(grammarAccess.getXAnnotationListLiteralAccess().getElementsAssignment_3_0(), "rule__XAnnotationListLiteral__ElementsAssignment_3_0");
					put(grammarAccess.getXAnnotationListLiteralAccess().getElementsAssignment_3_1_1(), "rule__XAnnotationListLiteral__ElementsAssignment_3_1_1");
