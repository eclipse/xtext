...
public class XtendInterfaceBuilder extends AbstractInterfaceBuilder implements Xtend {
  @Inject
  ...
  public boolean isValid() {
    ...
    if (!_isValid) {
      ...
      boolean _notEquals = ObjectExtensions.operator_notEquals(_interfaceName, null);
  ...
  public IAppendable build(final IAppendable appendable) {
    IAppendable _append = appendable.append("interface ");
    String _interfaceName = this.getInterfaceName();
    IAppendable _append_1 = _append.append(_interfaceName);
