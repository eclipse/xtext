...
public class GenericTab extends AbstractModifyDialogTab {
  ...
  public GenericTab(final IModificationListener modifyListener, final Map<String,String> workingValues, final Category category) {
    ...
    CharSequence _previewText = FormatterPreferenceInfra.previewText(category);
  ...
  public void doCreatePreferences(final Composite composite, final int numColumns) {
    ...
    XtendFormatterConfig _xtendFormatterConfig = new XtendFormatterConfig(this.fWorkingValues);
    Iterable<FormatterSetting> _settingsByCategory = FormatterPreferenceInfra.settingsByCategory(this.category, _xtendFormatterConfig);
