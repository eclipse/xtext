 ...
 * <ul>
 *   <li>{@link org.eclipse.xtext.common.types.impl.SimpleTypeReferenceImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SimpleTypeReferenceImpl extends TypeReferenceImpl implements SimpleTypeReference {
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TypesPackage.SIMPLE_TYPE_REFERENCE__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(Type newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypesPackage.SIMPLE_TYPE_REFERENCE__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case TypesPackage.SIMPLE_TYPE_REFERENCE__TYPE:
