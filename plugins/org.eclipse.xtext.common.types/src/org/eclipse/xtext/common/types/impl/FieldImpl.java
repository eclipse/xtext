...
public class FieldImpl extends MemberImpl implements Field {
	...
	public void setStatic(boolean newStatic) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypesPackage.FIELD__STATIC, oldStatic, static_));
	}
	...
	public void setFinal(boolean newFinal) {
		...
		final_ = newFinal;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypesPackage.FIELD__FINAL, oldFinal, final_));
	}
