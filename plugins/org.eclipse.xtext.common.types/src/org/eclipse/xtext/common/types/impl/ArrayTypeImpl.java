...
public class ArrayTypeImpl extends ComponentTypeImpl implements ArrayType {
	...
	public ComponentType getComponentType() {
		if (eContainerFeatureID() != TypesPackage.ARRAY_TYPE__COMPONENT_TYPE) return null;
	...
	public NotificationChain basicSetComponentType(ComponentType newComponentType, NotificationChain msgs) {
		msgs = eBasicSetContainer((InternalEObject)newComponentType, TypesPackage.ARRAY_TYPE__COMPONENT_TYPE, msgs);
		return msgs;
	}
	...
	public void setComponentType(ComponentType newComponentType) {
		if (newComponentType != eInternalContainer() || (eContainerFeatureID() != TypesPackage.ARRAY_TYPE__COMPONENT_TYPE && newComponentType != null)) {
			...
			if (newComponentType != null)
				msgs = ((InternalEObject)newComponentType).eInverseAdd(this, TypesPackage.COMPONENT_TYPE__ARRAY_TYPE, ComponentType.class, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case TypesPackage.ARRAY_TYPE__COMPONENT_TYPE:
				return eInternalContainer().eInverseRemove(this, TypesPackage.COMPONENT_TYPE__ARRAY_TYPE, ComponentType.class, msgs);
		}
