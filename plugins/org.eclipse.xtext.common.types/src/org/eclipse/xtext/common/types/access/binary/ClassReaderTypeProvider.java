...
public class ClassReaderTypeProvider extends AbstractRuntimeJvmTypeProvider {
	...
	public ClassReaderTypeProvider(ClassLoader classLoader, ResourceSet resourceSet, IndexedJvmTypeAccess indexedJvmTypeAccess) {
		...
		typeFactory = createClassReaderTypeFactory(readerAccess, classLoader);
	...
	protected ITypeFactory<BinaryClass> createClassReaderTypeFactory(ClassFileReaderAccess readerAccess, ClassLoader classLoader) {
		return new ClassReaderTypeFactory(readerAccess, classLoader);
	}
