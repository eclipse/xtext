 ...
 * <ul>
 *   <li>{@link org.eclipse.xtext.common.types.impl.FormalParameterImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.xtext.common.types.impl.FormalParameterImpl#getParameterType <em>Parameter Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class FormalParameterImpl extends IdentifyableElementImpl implements FormalParameter {
	/**
	...
	protected EClass eStaticClass() {
		return TypesPackage.Literals.FORMAL_PARAMETER;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TypesPackage.FORMAL_PARAMETER__NAME, oldName, name));
	}
