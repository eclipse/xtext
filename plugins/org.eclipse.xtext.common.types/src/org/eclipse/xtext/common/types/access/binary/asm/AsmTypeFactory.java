...
/**
 * Internal implementation that allows to convert the bytes of Java top-level classes to {@link JvmType types} via 
 * asm.
 * 
...
public class AsmTypeFactory implements ITypeFactory<BinaryClass, JvmDeclaredType> {
	...
	@Inject
	public AsmTypeFactory(ClassFileBytesAccess bytesAccess, ClassLoader loader) {
