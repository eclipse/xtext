...
import org.eclipse.xtext.ide.tests.testlanguage.renameTestLanguage.RenameTestLanguageFactory;
 ...
 * @generated
 */
public class RenameTestLanguagePackageImpl extends EPackageImpl implements RenameTestLanguagePackage
{
  /**
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.eclipse.xtext.ide.tests.testlanguage.renameTestLanguage.RenameTestLanguagePackage#eNS_URI
   * @see #init()
   * @generated
   */
  private RenameTestLanguagePackageImpl()
  {
    super(eNS_URI, RenameTestLanguageFactory.eINSTANCE);
  }
   ...
   * @generated
   */
  public static RenameTestLanguagePackage init()
  {
    ...
    theRenameTestLanguagePackage.createPackageContents();

    // Initialize created meta-data
    theRenameTestLanguagePackage.initializePackageContents();
