 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.xtext.ide.tests.testlanguage.partialSerializationTestLanguage.impl.ModelImpl#getClazz <em>Clazz</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ModelImpl extends MinimalEObjectImpl.Container implements Model
{
  ...
  {
    return PartialSerializationTestLanguagePackage.Literals.MODEL;
  }
  ...
  public EList<EClass> getClazz()
  {
    if (clazz == null)
    {
      clazz = new EObjectContainmentEList<EClass>(EClass.class, this, PartialSerializationTestLanguagePackage.MODEL__CLAZZ);
    }
    return clazz;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case PartialSerializationTestLanguagePackage.MODEL__CLAZZ:
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      case PartialSerializationTestLanguagePackage.MODEL__CLAZZ:
        getClazz().clear();
        getClazz().addAll((Collection<? extends EClass>)newValue);
        return;
    }
