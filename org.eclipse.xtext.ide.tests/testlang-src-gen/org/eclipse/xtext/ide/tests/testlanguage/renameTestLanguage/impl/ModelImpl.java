 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.xtext.ide.tests.testlanguage.renameTestLanguage.impl.ModelImpl#getTypes <em>Types</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ModelImpl extends MinimalEObjectImpl.Container implements Model
{
  ...
  {
    return RenameTestLanguagePackage.Literals.MODEL;
  }
  ...
  public EList<TypeDeclaration> getTypes()
  {
    if (types == null)
    {
      types = new EObjectContainmentEList<TypeDeclaration>(TypeDeclaration.class, this, RenameTestLanguagePackage.MODEL__TYPES);
    }
    return types;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case RenameTestLanguagePackage.MODEL__TYPES:
