 ...
 * </p>
 * <ul>
 *   <li>{@link org.eclipse.xtext.ide.tests.testlanguage.indentationAwareUiTestLanguage.impl.TreeNodeImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.xtext.ide.tests.testlanguage.indentationAwareUiTestLanguage.impl.TreeNodeImpl#getChildren <em>Children</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TreeNodeImpl extends MinimalEObjectImpl.Container implements TreeNode
{
  ...
  public EList<TreeNode> getChildren()
  {
    if (children == null)
    {
      children = new EObjectContainmentEList<TreeNode>(TreeNode.class, this, IndentationAwareUiTestLanguagePackage.TREE_NODE__CHILDREN);
    }
    return children;
  }
